...
<?php
	...
	file_put_contents("../work_sheet_ichinoe/log/$work_file","$in_data"); /* 配列としてではなくカンマ・改行付きの文字列として保存（CSV形式なので問題無し） */
	/* 作業一覧ファイル */
	...
	/* 最終更新日時の更新 */
	file_put_contents("../work_sheet_ichinoe/ymd.dat","$date");
?>
...
<?php
	...
	/* 件名 */
	$subject = mb_encode_mimeheader("【KTS一之江店】アライメント予約");
	
	/* 宛先 */
	$to = $mail;
	
	/* headers */
	$headers = "From: alignment-ichinoe@kts-web.com\n";
	/* $headers = "From: sugawara@kts-web.com\n"; */
	$headers .= "BCC: sugawara@kts-web.com,k.hanaki@kts-web.com,alignment-ichinoe@kts-web.com\n";
	...
	$body .= "KTS一之江店" . "\n";
	$body .= "TEL：03-3674-2006" . "\n";

	/* Return-Path */
	$mparameter = "-f alignment-ichinoe@kts-web.com";
	/* メール送信 */
