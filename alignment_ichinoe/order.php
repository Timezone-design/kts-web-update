			...
			<tr>
				<td>
					...
					<table width="98%" align="center">
						...
						<tr><td></td><td><input type="checkbox" name="wagon_check" value="1"><b><font color="#FF0000">※ワゴン・ミニバン車輌に該当する場合はチェックして下さい</td></tr>
						<tr><td></td></tr>
