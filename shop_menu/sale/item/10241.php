<html>
<head>
<meta name="description" content="純正形状・ハイパフォーマンスショック<br>きっと感じることのできるパフォーマンス技術<br>BILSTEIN B8のダンプトロニックに対応したハイパフォーマンス仕様。一般道からサーキットまでをテストし、ファイン・チューニング済みです。">
...
<title>KTS-web 商品ラインナップ BILSTEIN B8 DampTronic</title>
...
<div class="swiper-slide"><img src="../../item_img/10241_1.jpg" alt="B8 DampTronic"></div>
<div class="swiper-slide"><img src="../../item_img/10241_2.jpg" alt="B8 DampTronic"></div>
<div class="swiper-slide"><img src="../../item_img/10241_3.jpg" alt="B8 DampTronic"></div>
</div>
...
<p>純正形状・ハイパフォーマンスショック<br>きっと感じることのできるパフォーマンス技術<br>BILSTEIN B8のダンプトロニックに対応したハイパフォーマンス仕様。一般道からサーキットまでをテストし、ファイン・チューニング済みです。</p>
</div>
...
<!--ココまでSP-->
<tr>
<p class="search_category">**********【適合検索】**********&nbsp;&nbsp;<a class="change_button" href="../../set/item/10241.php"><img src="../../img/set_button.jpg" alt="工賃セットの価格表はコチラ"></a></p>
</tr>
<tr>
<td>
<!-- 車両メーカー検索ココから -->
<p class="search_category">【自動車メーカー】</p>
<form method="post" action="10241.php">
...
if($data[0] == '10241') $position = explode(";", $data[1]);
}
array_pop($position);
fclose($fp_position);
...
<form name="make" method="post" action="10241.php">
