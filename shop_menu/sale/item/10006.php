...
<title>KTS-web 商品ラインナップ Aragosta TYPE-E</title>
...
<div class="mc_nav">
<a class="link" href="https://www.kts-web.com/">HOME</a> &gt; <a class="link" href="../../index.html">SHOP MENU</a> &gt; <a class="link" href="../../set/index.html">商品ラインナップ</a> &gt; <a class="link" href="../../set/cat/100.html">足回り</a> &gt; <a class="link" href="../../set/cat/116.html">車高調/セッティングパーツ</a> &gt; <a class="link" href="../../set/br/1010-116.html">Aragosta</a> &gt; <a class="link" href="10006.php">TYPE-E</a></div>
<div class="space3px"></div>
<div class="set_sale_back">
<div class="space3px"></div>
<div class="set_menu_n">
<div class="set_menu_n_330">
<div><img src="../../brand/img/1010.gif" alt="TYPE-E"></div></div>
...
<div class="swiper-slide"><img src="../../item_img/10006_1.jpg" alt="TYPE-E"></div>
<div class="swiper-slide"><img src="../../item_img/10006_2.jpg" alt="TYPE-E"></div>
<div class="swiper-slide"><img src="../../item_img/10006_3.jpg" alt="TYPE-E"></div>
</div>
...
<p>TYPE-E[コンフォートコンセプト]はストリート性能を優先した信頼の乗り味のベーシックモデルです。街乗りからワインディングをターゲットに乗り心地とスポーツ性を高次元両立。専用パーツが初期減衰特性を向上させ路面の轍、舗装の繋ぎ目も包み込むようなフラット性能を実現しました。ローダウン派にも最適です。</p>
</div>
<div id="panel2" class="tab_panel">
<p>・Φ40/Φ46高剛性スティールシリンダー+カチオン塗装<br>・Φ46正立ストラット<br>・ピロ/ラバー/純正アッパーマウント<br>・全長調整機能/20段減衰力調整機能<br>・rana spring<br><br>※車種によりTYPEそれぞれの仕様は異なります。詳しくは詳細ページをご確認ください。</p>
</div>
</div>
</div>
</div>
...
<!--ココまでSP-->
<tr>
<p class="search_category">**********【適合検索】**********&nbsp;&nbsp;<a class="change_button" href="../../set/item/10006.php"><img src="../../img/set_button.jpg" alt="工賃セットの価格表はコチラ"></a></p>
</tr>
<tr>
<td>
<!-- 車両メーカー検索ココから -->
<p class="search_category">【自動車メーカー】</p>
<form method="post" action="10006.php">
...
if($data[0] == '10006') $position = explode(";", $data[1]);
}
array_pop($position);
fclose($fp_position);
...
<form name="make" method="post" action="10006.php">
