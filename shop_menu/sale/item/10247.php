...
<title>KTS-web 商品ラインナップ BILSTEIN B16</title>
...
<div class="swiper-slide"><img src="../../item_img/10247_1.jpg" alt="B16"></div>
<div class="swiper-slide"><img src="../../item_img/10247_2.jpg" alt="B16"></div>
<div class="swiper-slide"><img src="../../item_img/10247_3.jpg" alt="B16"></div>
</div>
...
<p>ドライビングの楽しみはセッティング次第<br>ビルシュタインのエンジニアたちによって開発されるハイパワークラスの製品は、究極のドライビングプレジャーを成し遂げるべく作られています。スポーティなセッティングから極上のコンフォータブルなセッテングまで調整可能です。</p>
</div>
<div id="panel2" class="tab_panel">
<p>・減衰力を10段階に調整可能<br>・スポーティからコンフォータブルまで調整可能<br>・前後ともに約30〜50mmのローダウン化<br>・サーキットレベルのテストを繰り返してファインチューン実施<br>・スプリングプレートとロックナットはいずれもアルミ製<br>・装着時に前後車軸それぞれに20mmの調整範囲を設定<br>・トリプルCテクノロジー（三層コーティング）による高い防錆性を実現<br>・調整が容易なラウンドスレッド<br>・耐久性の高いスポーツ・スプリング<br>・ビルシュタインならではのドイツ製モノチューブ倒立式サス<br>・TV（ドイツの技術検査機関）が認める性能</p>
</div>
</div>
</div>
</div>
...
<!--ココまでSP-->
<tr>
<p class="search_category">**********【適合検索】**********&nbsp;&nbsp;<a class="change_button" href="../../set/item/10247.php"><img src="../../img/set_button.jpg" alt="工賃セットの価格表はコチラ"></a></p>
</tr>
<tr>
<td>
<!-- 車両メーカー検索ココから -->
<p class="search_category">【自動車メーカー】</p>
<form method="post" action="10247.php">
...
if($data[0] == '10247') $position = explode(";", $data[1]);
}
array_pop($position);
fclose($fp_position);
...
<form name="make" method="post" action="10247.php">
