...
<title>KTS-web 商品ラインナップ RS★R Super☆i</title>
...
<div class="mc_nav">
<a class="link" href="https://www.kts-web.com/">HOME</a> &gt; <a class="link" href="../../index.html">SHOP MENU</a> &gt; <a class="link" href="../../set/index.html">商品ラインナップ</a> &gt; <a class="link" href="../../set/cat/100.html">足回り</a> &gt; <a class="link" href="../../set/cat/116.html">車高調/セッティングパーツ</a> &gt; <a class="link" href="../../set/br/1001-116.html">RS★R</a> &gt; <a class="link" href="10138.php">Super☆i</a></div>
<div class="space3px"></div>
<div class="set_sale_back">
<div class="space3px"></div>
<div class="set_menu_n">
<div class="set_menu_n_330">
<div><img src="../../brand/img/1001.gif" alt="Super☆i"></div></div>
<div class="set_menu_n_cell">
<div class="item_info_text_middle">
<p>RS★R[アールエスアール]</p></div>
<div class="item_info_text_middle_b">
<p>Super☆i[スーパーアイ]</p></div>
</div></div>
...
<div class="swiper-slide"><img src="../../item_img/10138_1.jpg" alt="Super☆i"></div>
<div class="swiper-slide"><img src="../../item_img/10138_2.jpg" alt="Super☆i"></div>
<div class="swiper-slide"><img src="../../item_img/10138_3.jpg" alt="Super☆i"></div>
</div>
...
<p>「美しいローフォルムと快適な乗り心地を両立させ、誰もがノーマルとは一味違った乗り味と軽快なハンドリング特性でドライビングが楽しくなる。｣ そんなショックアブソーバーを理想として開発されています。スタイリングにこだわり、インチアップ・ローダウンを施されても、快適で上質な走りを求められる。"既存の製品では物足りない、 もうワンランク上のサスペンションを"と望まれていたユーザー様にも必ず満足いただける仕上がり。</p>
</div>
<div id="panel2" class="tab_panel">
<p>・全長調整式<br>・減衰力40段調整<br>・単筒式内径Φ40スチールボディ<br>・Ti2000スプリング採用<br>・アルミアッパーマウント※一部車種除く<br>・1年間又は1万キロ保証<br>・オーバーホール可</p>
</div>
</div>
</div>
</div>
...
<!--ココまでSP-->
<tr>
<p class="search_category">**********【適合検索】**********&nbsp;&nbsp;<a class="change_button" href="../../set/item/10138.php"><img src="../../img/set_button.jpg" alt="工賃セットの価格表はコチラ"></a></p>
</tr>
<tr>
<td>
<!-- 車両メーカー検索ココから -->
<p class="search_category">【自動車メーカー】</p>
<form method="post" action="10138.php">
...
if($data[0] == '10138') $position = explode(";", $data[1]);
}
array_pop($position);
fclose($fp_position);
...
<form name="make" method="post" action="10138.php">
