...
<title>KTS-web 商品ラインナップ SHOWA SPORTS EVOLUTION 極</title>
...
<div class="mc_nav">
<a class="link" href="https://www.kts-web.com/">HOME</a> &gt; <a class="link" href="../../index.html">SHOP MENU</a> &gt; <a class="link" href="../../set/index.html">商品ラインナップ</a> &gt; <a class="link" href="../../set/cat/100.html">足回り</a> &gt; <a class="link" href="../../set/cat/119.html">サスペンションキット</a> &gt; <a class="link" href="../../set/br/1086-119.html">SHOWA</a> &gt; <a class="link" href="10154.php">SPORTS EVOLUTION 極</a></div>
<div class="space3px"></div>
<div class="set_sale_back">
<div class="space3px"></div>
<div class="set_menu_n">
<div class="set_menu_n_330">
<div><img src="../../brand/img/1086.gif" alt="SPORTS EVOLUTION 極"></div></div>
<div class="set_menu_n_cell">
<div class="item_info_text_middle">
<p>SHOWA[ショーワ]</p></div>
<div class="item_info_text_middle_b">
<p>商品名：SPORTS EVOLUTION 極[スポーツエボリューション 極]</p></div>
</div></div>
...
<div class="swiper-slide"><img src="../../item_img/10154_1.jpg" alt="SPORTS EVOLUTION 極"></div>
<div class="swiper-slide"><img src="../../item_img/10154_2.jpg" alt="SPORTS EVOLUTION 極"></div>
<div class="swiper-slide"><img src="../../item_img/10154_3.jpg" alt="SPORTS EVOLUTION 極"></div>
</div>
...
<p>「ストリート～ワインディング」の枠を超え、“しなやかな乗り心地”は犠牲にすることなく、サーキット走行にも対応するスペックに仕上げたハイエンドモデル。その「EVOLUTION」を、ノーマル形状ダンパーの極限の姿…「極（きわみ）」という漢字でイメージ。</p>
</div>
<div id="panel2" class="tab_panel">
<p>・ノーマル形状ダンパー<br>・SFRDダンパー採用<br>・スプリングセット<br>・NEW DAMPER OIL採用<br>・SASC Technology</p>
</div>
</div>
</div>
</div>
...
<div class="item_info_text_middle_b">
<p>SPORTS EVOLUTION 極 [スポーツエボリューション 極]</p>
</div>
<div class="tab_wrap">
...
<!--ココまでSP-->
<tr>
<p class="search_category">**********【適合検索】**********&nbsp;&nbsp;<a class="change_button" href="../../set/item/10154.php"><img src="../../img/set_button.jpg" alt="工賃セットの価格表はコチラ"></a></p>
</tr>
<tr>
<td>
<!-- 車両メーカー検索ココから -->
<p class="search_category">【自動車メーカー】</p>
<form method="post" action="10154.php">
...
if($data[0] == '10154') $position = explode(";", $data[1]);
}
array_pop($position);
fclose($fp_position);
...
<form name="make" method="post" action="10154.php">
