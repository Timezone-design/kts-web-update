	              ...
	              <div class="set_sale_back">
	                ...
	                <div class="set_menu_n row">
	                  <div class="set_menu_n_330 col-md-6 col-sm-12 col-xs-12">
	                    <div><img alt="EXAS POWER CATALYZER" src="../../brand/img/1077.gif"/></div>
	                  </div>
	                  <div class="set_menu_n_cell col-md-6 col-sm-12 col-xs-12">
	                    <div class="item_info_text_middle"><p>GP SPORT[ジーピースポーツ]</p></div><div class="item_info_text_middle_b"><p>EXAS POWER CATALYZER[エグザスパワーキャタライザー]</p></div>
	                  </div>
	                </div>
	                <div class="set_menu_n row">
	                  <div class="set_menu_n_330 col-md-6 col-sm-12 col-xs-12">
	                    <div>
	                      <div class="swiper-container"><div class="swiper-wrapper"><div class="swiper-slide"><img alt="EXAS POWER CATALYZER" src="../../item_img/10809_1.jpg"/></div><div class="swiper-slide"><img alt="EXAS POWER CATALYZER" src="../../item_img/10809_2.jpg"/></div><div class="swiper-slide"><img alt="EXAS POWER CATALYZER" src="../../item_img/10809_3.jpg"/></div></div><div class="swiper-button-prev"></div><div class="swiper-button-next"></div></div>
	                    </div>
	                    ...
	                    <div class="tab_wrap">
	                      ...
	                      <div class="tab-content">
	                        <div id="home" class="tab-pane fade in active show">
	                          <p>触媒部分を純正のセラミック素材からメタル素材へと変更する事で同じセル数における通路の面積を拡大すると共にコーティング表面積を拡大し、排気効率と浄化作用の両立を実現。また、セラミック素材よりも耐熱性が大幅にアップしているので、熱量が高いチューニング車両にも余裕を持って対応可能。</p>
	                        </div>
	                ...
	                <table style="table-layout:fixed;" width="100%">
	                  <!--ココまでSP-->
	                  <tr>
	                    <p class="search_category">**********【商品検索】**********&nbsp;&nbsp;<a class="change_button" href="../../sale/item/10809.php"><img src="../../img/sale_button.jpg" alt="単品販売の価格表はコチラ"></a></p>
	                  </tr>
	                </table>
	                  <?php
	                  	$root_dir = __DIR__.'/../../..';
