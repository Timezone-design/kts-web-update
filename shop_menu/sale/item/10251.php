...
<title>KTS-web 商品ラインナップ BILSTEIN EVO SE</title>
...
<div class="swiper-slide"><img src="../../item_img/10251_1.jpg" alt="EVO SE"></div>
<div class="swiper-slide"><img src="../../item_img/10251_2.jpg" alt="EVO SE"></div>
<div class="swiper-slide"><img src="../../item_img/10251_3.jpg" alt="EVO SE"></div>
</div>
...
<p>純正で電子制御サスペンションシステム搭載されている車両に対応したモデルです。純正電子制御サスペンションの完璧なアップグレードとして、純正以上に満足できる優れたパフォーマンスを発揮します。また、車高を簡単に最大70mm下げることができます。</p>
</div>
<div id="panel2" class="tab_panel">
<p>・車高調整：車高を最大70mmダウン<br>・電子制御サスペンション対応<br>・スポーティなダンパーセッティング</p>
</div>
</div>
</div>
</div>
...
<!--ココまでSP-->
<tr>
<p class="search_category">**********【適合検索】**********&nbsp;&nbsp;<a class="change_button" href="../../set/item/10251.php"><img src="../../img/set_button.jpg" alt="工賃セットの価格表はコチラ"></a></p>
</tr>
<tr>
<td>
<!-- 車両メーカー検索ココから -->
<p class="search_category">【自動車メーカー】</p>
<form method="post" action="10251.php">
...
if($data[0] == '10251') $position = explode(";", $data[1]);
}
array_pop($position);
fclose($fp_position);
...
<form name="make" method="post" action="10251.php">
