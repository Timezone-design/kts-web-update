<html>
<head>
<meta name="description" content="ボタンひと押しで貴方をクルマをスポーツカーに<br>ビルシュタインのエンジニアたちはこの新製品を開発するため、彼らのもつモータースポーツでの経験のすべてを注ぎ込みました。貴方のクルマのセッティングにきっと役立ちます。ドライビング・ダイナミクスを向上させる「スポーツモード」を採用しつつあらゆるシチュエーションを想定し、「コンフォートモード」は不整路でのスムーズな乗り心地を実現。">
...
<title>KTS-web 商品ラインナップ BILSTEIN B16 ridecontrol</title>
...
<div class="mc_nav">
<a class="link" href="https://www.kts-web.com/">HOME</a> &gt; <a class="link" href="../../index.html">SHOP MENU</a> &gt; <a class="link" href="../../set/index.html">商品ラインナップ</a> &gt; <a class="link" href="../../set/cat/100.html">足回り</a> &gt; <a class="link" href="../../set/cat/119.html">サスペンションキット</a> &gt; <a class="link" href="../../set/br/1136-119.html">BILSTEIN</a> &gt; <a class="link" href="10248.php">B16 ridecontrol</a></div>
<div class="space3px"></div>
<div class="set_sale_back">
<div class="space3px"></div>
<div class="set_menu_n">
<div class="set_menu_n_330">
<div><img src="../../brand/img/1136.gif" alt="B16 ridecontrol"></div></div>
<div class="set_menu_n_cell">
<div class="item_info_text_middle">
<p>BILSTEIN[ビルシュタイン]</p></div>
<div class="item_info_text_middle_b">
<p>商品名：B16 ridecontrol[B16ライドコントロール]</p></div>
</div></div>
...
<div class="swiper-slide"><img src="../../item_img/10248_1.jpg" alt="B16 ridecontrol"></div>
<div class="swiper-slide"><img src="../../item_img/10248_2.jpg" alt="B16 ridecontrol"></div>
<div class="swiper-slide"><img src="../../item_img/10248_3.jpg" alt="B16 ridecontrol"></div>
</div>
...
<p>ボタンひと押しで貴方をクルマをスポーツカーに<br>ビルシュタインのエンジニアたちはこの新製品を開発するため、彼らのもつモータースポーツでの経験のすべてを注ぎ込みました。貴方のクルマのセッティングにきっと役立ちます。ドライビング・ダイナミクスを向上させる「スポーツモード」を採用しつつあらゆるシチュエーションを想定し、「コンフォートモード」は不整路でのスムーズな乗り心地を実現。</p>
</div>
<div id="panel2" class="tab_panel">
<p>・「スポーツモード」を採用<br>・「コンフォートモード」は不整路でのスムーズな乗り心地<br>・イルミネーション付きボタンによるモード切り替え<br>・装着時に前後車軸それぞれに20mmの調整範囲を設定<br>・前後ともに約30〜50mmのローダウン化<br>・サーキットレベルでのテストを繰り返してのファインチューン実施<br>・トリプルCテクノロジー（三層コーティング）による高い防錆性を実現<br>・耐久性の高いスポーツ・スプリング<br>・ビルシュタインならではのドイツ製モノチューブ倒立式サス<br>・TV（ドイツの技術検査機関）が認める性能</p>
</div>
</div>
</div>
</div>
...
<div class="item_info_text_middle">
<p>BILSTEIN [ビルシュタイン]</p>
</div>
<div class="item_info_text_middle_b">
<p>B16 ridecontrol [B16ライドコントロール]</p>
</div>
<div class="tab_wrap">
...
<!--ココまでSP-->
<tr>
<p class="search_category">**********【適合検索】**********&nbsp;&nbsp;<a class="change_button" href="../../set/item/10248.php"><img src="../../img/set_button.jpg" alt="工賃セットの価格表はコチラ"></a></p>
</tr>
<tr>
<td>
<!-- 車両メーカー検索ココから -->
<p class="search_category">【自動車メーカー】</p>
<form method="post" action="10248.php">
...
if($data[0] == '10248') $position = explode(";", $data[1]);
}
array_pop($position);
fclose($fp_position);
...
<form name="make" method="post" action="10248.php">
