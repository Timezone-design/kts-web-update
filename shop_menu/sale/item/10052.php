<html>
<head>
<meta name="description" content="手軽にリフトアップ！”車検対応アップサス”<br>雪、雨、潮風、凍結防止剤などによるスプリングの錆を極力防ぐため、アップサスにはパーカー処理いわゆる「リン酸鉄被膜処理」加工後に紛体塗装する事で耐久性が向上！">
...
<title>KTS-web 商品ラインナップ FINAL KONNEXION EAGER LIFT UP SUS</title>
...
<div class="mc_nav">
<a class="link" href="https://www.kts-web.com/">HOME</a> &gt; <a class="link" href="../../index.html">SHOP MENU</a> &gt; <a class="link" href="../../set/index.html">商品ラインナップ</a> &gt; <a class="link" href="../../set/cat/100.html">足回り</a> &gt; <a class="link" href="../../set/cat/117.html">ダウンサス/アップサス</a> &gt; <a class="link" href="../../set/br/1138-117.html">FINAL KONNEXION</a> &gt; <a class="link" href="10052.php">EAGER LIFT UP SUS</a></div>
<div class="space3px"></div>
<div class="set_sale_back">
<div class="space3px"></div>
<div class="set_menu_n">
<div class="set_menu_n_330">
<div><img src="../../brand/img/1138.gif" alt="EAGER LIFT UP SUS"></div></div>
...
<p>商品名：EAGER LIFT UP SUS[イエーガーリフトアップサス]</p></div>
</div></div>
...
<div class="swiper-slide"><img src="../../item_img/10052_1.jpg" alt="EAGER LIFT UP SUS"></div>
<div class="swiper-slide"><img src="../../item_img/10052_2.jpg" alt="EAGER LIFT UP SUS"></div>
<div class="swiper-slide"><img src="../../item_img/10052_3.jpg" alt="EAGER LIFT UP SUS"></div>
</div>
...
<p>手軽にリフトアップ！”車検対応アップサス”<br>雪、雨、潮風、凍結防止剤などによるスプリングの錆を極力防ぐため、アップサスにはパーカー処理いわゆる「リン酸鉄被膜処理」加工後に紛体塗装する事で耐久性が向上！</p>
</div>
<div id="panel2" class="tab_panel">
<p>・ノーマルショック対応<br>・25mm～35mm リフトアップ<br>・パーカー処理済み<br>・車検対応</p>
</div>
</div>
</div>
</div>
...
<div class="item_info_text_middle_b">
<p>EAGER LIFT UP SUS [イエーガーリフトアップサス]</p>
</div>
<div class="tab_wrap">
...
<!--ココまでSP-->
<tr>
<p class="search_category">**********【適合検索】**********&nbsp;&nbsp;<a class="change_button" href="../../set/item/10052.php"><img src="../../img/set_button.jpg" alt="工賃セットの価格表はコチラ"></a></p>
</tr>
<tr>
<td>
<!-- 車両メーカー検索ココから -->
<p class="search_category">【自動車メーカー】</p>
<form method="post" action="10052.php">
...
if($data[0] == '10052') $position = explode(";", $data[1]);
}
array_pop($position);
fclose($fp_position);
...
<form name="make" method="post" action="10052.php">
