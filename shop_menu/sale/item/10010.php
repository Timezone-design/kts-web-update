...
<title>KTS-web 商品ラインナップ Aragosta Aragosta-CUP</title>
...
<div class="mc_nav">
<a class="link" href="https://www.kts-web.com/">HOME</a> &gt; <a class="link" href="../../index.html">SHOP MENU</a> &gt; <a class="link" href="../../set/index.html">商品ラインナップ</a> &gt; <a class="link" href="../../set/cat/100.html">足回り</a> &gt; <a class="link" href="../../set/cat/116.html">車高調/セッティングパーツ</a> &gt; <a class="link" href="../../set/br/1010-116.html">Aragosta</a> &gt; <a class="link" href="10010.php">Aragosta-CUP</a></div>
<div class="space3px"></div>
<div class="set_sale_back">
<div class="space3px"></div>
<div class="set_menu_n">
<div class="set_menu_n_330">
<div><img src="../../brand/img/1010.gif" alt="Aragosta-CUP"></div></div>
<div class="set_menu_n_cell">
<div class="item_info_text_middle">
<p>Aragosta[アラゴスタ]</p></div>
<div class="item_info_text_middle_b">
<p>Aragosta-CUP[アラゴスタカップ]</p></div>
</div></div>
...
<div class="swiper-slide"><img src="../../item_img/10010_1.jpg" alt="Aragosta-CUP"></div>
<div class="swiper-slide"><img src="../../item_img/10010_2.jpg" alt="Aragosta-CUP"></div>
<div class="swiper-slide"><img src="../../item_img/10010_3.jpg" alt="Aragosta-CUP"></div>
</div>
...
<p>傾斜のきついスロープや駐車場の出入口など、ローダウン時に懸念されるボディと路面との干渉を未然に回避可能にする画期的なシステムです。アッパー部のCUP機能によりスイッチ1つで短時間に車高をUP。走行中はCUP機能に依存しないため、回避後に車高を戻すことで本来のスタイルおよびアラゴスタの性能を維持します。<br>●スイッチはコンパクト設計で設置場所を選ばず、コンソール内など目立たない場所に取り付けることも可能。<br>●コンプレッサーおよびエアタンクはアラゴスタカップ専用の最小サイズ設計とし、トランクやスペアタイヤスペース等へスマートに設置可能。ラゲッジ容量を大幅に削る心配もありません。</p>
</div>
<div id="panel2" class="tab_panel">
<p>・CUP機能がわずか2秒・秒で約40～70mmの車高UPを実現・<br>・信頼性に優れたロベルタリフターシステム採用<br>・ダンパー1台分ほか取付に必要なCUPユニットをフルキット化<br>・通常走行時は従来のアラゴスタ性能のまま<br>・オーバーホール/車検対応<br>・CUP本体3年、コンプレッサー1年の保証付き<br>・様々な車種、TYPEに対応（詳しくは車種適合表をご覧ください）<br><br>※車高を上げた状態で通常走行はできません。</p>
</div>
</div>
</div>
</div>
...
<!--ココまでSP-->
<tr>
<p class="search_category">**********【適合検索】**********&nbsp;&nbsp;<a class="change_button" href="../../set/item/10010.php"><img src="../../img/set_button.jpg" alt="工賃セットの価格表はコチラ"></a></p>
</tr>
<tr>
<td>
<!-- 車両メーカー検索ココから -->
<p class="search_category">【自動車メーカー】</p>
<form method="post" action="10010.php">
...
if($data[0] == '10010') $position = explode(";", $data[1]);
}
array_pop($position);
fclose($fp_position);
...
<form name="make" method="post" action="10010.php">
