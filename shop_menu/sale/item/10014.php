...
<title>KTS-web 商品ラインナップ BLITZ DAMPER ZZ-R</title>
...
<div class="mc_nav">
<a class="link" href="https://www.kts-web.com/">HOME</a> &gt; <a class="link" href="../../index.html">SHOP MENU</a> &gt; <a class="link" href="../../set/index.html">商品ラインナップ</a> &gt; <a class="link" href="../../set/cat/100.html">足回り</a> &gt; <a class="link" href="../../set/cat/116.html">車高調/セッティングパーツ</a> &gt; <a class="link" href="../../set/br/1144-116.html">BLITZ</a> &gt; <a class="link" href="10014.php">DAMPER ZZ-R</a></div>
<div class="space3px"></div>
<div class="set_sale_back">
<div class="space3px"></div>
<div class="set_menu_n">
<div class="set_menu_n_330">
<div><img src="../../brand/img/1144.gif" alt="DAMPER ZZ-R"></div></div>
<div class="set_menu_n_cell">
<div class="item_info_text_middle">
<p>BLITZ[ブリッツ]</p></div>
<div class="item_info_text_middle_b">
<p>DAMPER ZZ-R[ダンパーZZ-R]</p></div>
</div></div>
...
<div class="swiper-slide"><img src="../../item_img/10014_1.jpg" alt="DAMPER ZZ-R"></div>
<div class="swiper-slide"><img src="../../item_img/10014_2.jpg" alt="DAMPER ZZ-R"></div>
<div class="swiper-slide"><img src="../../item_img/10014_3.jpg" alt="DAMPER ZZ-R"></div>
</div>
...
<p>リーズナブルな価格ながら、全調整式/32段減衰力調整。アルミ製パーツを採用したサスペンションキットフロントストラット車にはキャンバー調整式ピロボールアッパーマウントを採用しダイレクトな操舵感とコントロールを実現しています。フロントストラット式以外の車種とリアには全社強化ゴムアッパーマウントを採用することで走行時の不快な異音を低減します(一部車種を除く)。</p>
</div>
<div id="panel2" class="tab_panel">
<p>・単筒式(モノチューブ)構造採用<br>・全長調整式車高調キット<br>・32段減衰力調整機構を採用<br>・アルミ製アッパーマウント/ロックシート/ブラケット(一部)を採用<br>・単筒式ならではのφ44大径ピストンを採用(一部車種除く)<br>・カートリッジ先出しのオーバーホールに対応。</p>
</div>
</div>
</div>
</div>
...
<!--ココまでSP-->
<tr>
<p class="search_category">**********【適合検索】**********&nbsp;&nbsp;<a class="change_button" href="../../set/item/10014.php"><img src="../../img/set_button.jpg" alt="工賃セットの価格表はコチラ"></a></p>
</tr>
<tr>
<td>
<!-- 車両メーカー検索ココから -->
<p class="search_category">【自動車メーカー】</p>
<form method="post" action="10014.php">
...
if($data[0] == '10014') $position = explode(";", $data[1]);
}
array_pop($position);
fclose($fp_position);
...
<form name="make" method="post" action="10014.php">
