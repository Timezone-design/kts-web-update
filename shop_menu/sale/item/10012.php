...
<title>KTS-web 商品ラインナップ AXIS STYLING PERFECT DAMPER 3</title>
...
<div class="mc_nav">
<a class="link" href="https://www.kts-web.com/">HOME</a> &gt; <a class="link" href="../../index.html">SHOP MENU</a> &gt; <a class="link" href="../../set/index.html">商品ラインナップ</a> &gt; <a class="link" href="../../set/cat/100.html">足回り</a> &gt; <a class="link" href="../../set/cat/116.html">車高調/セッティングパーツ</a> &gt; <a class="link" href="../../set/br/1163-116.html">AXIS STYLING</a> &gt; <a class="link" href="10012.php">PERFECT DAMPER 3</a></div>
<div class="space3px"></div>
<div class="set_sale_back">
<div class="space3px"></div>
<div class="set_menu_n">
<div class="set_menu_n_330">
<div><img src="../../brand/img/1163.gif" alt="PERFECT DAMPER 3"></div></div>
<div class="set_menu_n_cell">
<div class="item_info_text_middle">
<p>AXIS STYLING[アクシススタイリング]</p></div>
<div class="item_info_text_middle_b">
<p>PERFECT DAMPER 3[パーフェクトダンパー3]</p></div>
</div></div>
...
<div class="swiper-slide"><img src="../../item_img/10012_1.jpg" alt="PERFECT DAMPER 3"></div>
<div class="swiper-slide"><img src="../../item_img/10012_2.jpg" alt="PERFECT DAMPER 3"></div>
<div class="swiper-slide"><img src="../../item_img/10012_3.jpg" alt="PERFECT DAMPER 3"></div>
</div>
...
<p>ストロークが確保しやすく反発力が少ないので、荒れた路面では凹凸をしっかり捉えて低速ではしなやかに、高速では安定感のある走りを実現。高性能ダンパーオイルにより低温から高温まで安定した減衰力を発生しスムーズなストロークで全てにおいて快適な乗り心地です。また、全長調整式フルタップショックなので車高を上下しても乗り心地に影響がありません。</p>
</div>
<div id="panel2" class="tab_panel">
<p>・全長調整式フルタップショック<br>・フロントアッパーマウントは強化ゴムタイプ<br>・減衰調整は前後とも15段ダイヤル調整式<br>・ショックには錆に強い特殊メッキコーティング<br>・フロントは複筒式正立ショック。<br>・リアは単筒式正立ショック<br>・NEWタイプのバルブでより安定した減衰力を発揮</p>
</div>
</div>
</div>
</div>
...
<div class="item_info_text_middle_b">
<p>PERFECT DAMPER 3 [パーフェクトダンパー3]</p>
</div>
<div class="tab_wrap">
...
<!--ココまでSP-->
<tr>
<p class="search_category">**********【適合検索】**********&nbsp;&nbsp;<a class="change_button" href="../../set/item/10012.php"><img src="../../img/set_button.jpg" alt="工賃セットの価格表はコチラ"></a></p>
</tr>
<tr>
<td>
<!-- 車両メーカー検索ココから -->
<p class="search_category">【自動車メーカー】</p>
<form method="post" action="10012.php">
...
if($data[0] == '10012') $position = explode(";", $data[1]);
}
array_pop($position);
fclose($fp_position);
...
<form name="make" method="post" action="10012.php">
