...
<title>KTS-web 商品ラインナップ CUSCO SPORT TN_S</title>
...
<div class="mc_nav">
<a class="link" href="https://www.kts-web.com/">HOME</a> &gt; <a class="link" href="../../index.html">SHOP MENU</a> &gt; <a class="link" href="../../set/index.html">商品ラインナップ</a> &gt; <a class="link" href="../../set/cat/100.html">足回り</a> &gt; <a class="link" href="../../set/cat/116.html">車高調/セッティングパーツ</a> &gt; <a class="link" href="../../set/br/1059-116.html">CUSCO</a> &gt; <a class="link" href="10021.php">SPORT TN_S</a></div>
<div class="space3px"></div>
<div class="set_sale_back">
<div class="space3px"></div>
<div class="set_menu_n">
<div class="set_menu_n_330">
<div><img src="../../brand/img/1059.gif" alt="SPORT TN_S"></div></div>
<div class="set_menu_n_cell">
<div class="item_info_text_middle">
<p>CUSCO[クスコ]</p></div>
<div class="item_info_text_middle_b">
<p>SPORT TN_S[スポーツTN_S]</p></div>
</div></div>
...
<div class="swiper-slide"><img src="../../item_img/10021_1.jpg" alt="SPORT TN_S"></div>
<div class="swiper-slide"><img src="../../item_img/10021_2.jpg" alt="SPORT TN_S"></div>
<div class="swiper-slide"><img src="../../item_img/10021_3.jpg" alt="SPORT TN_S"></div>
</div>
...
<p>SPORT Rの設計思想・スペックをそのままに、より多くのユーザーを対象とするストリート向けに減衰力・バネレート・ストロークをセッティング。スポーツラジアルタイヤでのスポーツ走行をターゲットとしたセットアップ。さらに伸側24段、圧側24段の減衰力完全独立制御により、コーナー進入時、旋回時、立ち上がり時のアンダーステア、オーバーステアの修正や、スプリングレート変更時の細かなセットアップを可能としています。ストリートでの使用を考慮し(音、乗り心地など)リヤアッパーマウントには強化ゴムアッパーマウントを採用(ウイッシュボーン車は前後共に採用)。大きな入力にもしっかり対応する為、大口径ピストンを使用し安定した減衰力を発生。</p>
</div>
<div id="panel2" class="tab_panel">
<p>・単筒式ショックアブソーバー<br>・減衰力24段調整<br>・新開発『T.N.S(Twin Needle System)』により伸側、圧側の減衰力を完全独立制御<br>・新開発CUSCO SPORT「Blue spring」採用<br>・全長調整式車高調整<br>・ラム式(倒立式)ショックアブソーバー※フロントストラット式のみ<br>・ハイグリップラジアルタイヤ対応</p>
</div>
</div>
</div>
</div>
...
<!--ココまでSP-->
<tr>
<p class="search_category">**********【適合検索】**********&nbsp;&nbsp;<a class="change_button" href="../../set/item/10021.php"><img src="../../img/set_button.jpg" alt="工賃セットの価格表はコチラ"></a></p>
</tr>
<tr>
<td>
<!-- 車両メーカー検索ココから -->
<p class="search_category">【自動車メーカー】</p>
<form method="post" action="10021.php">
...
if($data[0] == '10021') $position = explode(";", $data[1]);
}
array_pop($position);
fclose($fp_position);
...
<form name="make" method="post" action="10021.php">
