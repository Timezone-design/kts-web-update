	              ...
	              <div class="set_sale_back">
	                ...
	                <div class="set_menu_n row">
	                  <div class="set_menu_n_330 col-md-6 col-sm-12 col-xs-12">
	                    <div><img alt="Hi-POWER409マフラー" src="../../brand/img/1032.gif"/></div>
	                  </div>
	                  <div class="set_menu_n_cell col-md-6 col-sm-12 col-xs-12">
	                    <div class="item_info_text_middle"><p>HKS[エッチケーエス]</p></div><div class="item_info_text_middle_b"><p>Hi-POWER409マフラー[ハイパワー409]</p></div>
	                  </div>
	                </div>
	                <div class="set_menu_n row">
	                  <div class="set_menu_n_330 col-md-6 col-sm-12 col-xs-12">
	                    <div>
	                      <div class="swiper-container"><div class="swiper-wrapper"><div class="swiper-slide"><img alt="Hi-POWER409マフラー" src="../../item_img/10811_1.jpg"/></div><div class="swiper-slide"><img alt="Hi-POWER409マフラー" src="../../item_img/10811_2.jpg"/></div><div class="swiper-slide"><img alt="Hi-POWER409マフラー" src="../../item_img/10811_3.jpg"/></div></div><div class="swiper-button-prev"></div><div class="swiper-button-next"></div></div>
	                    </div>
	                    ...
	                    <div class="tab_wrap">
	                      ...
	                      <div class="tab-content">
	                        <div id="home" class="tab-pane fade in active show">
	                          <p>独自に蓄積してきたデータ・技術をもとに保安基準、材質等様々な課題をクリアしてきたHKSが、改めてストリートでの存在感を意識し作られたスポーツマフラー。<br/>一世を風靡した「Hipowerマフラー」の血を脈々と受け、迫力とサウンドとスタイル、そして破格の性能を武装したハイコストパフォーマンスモデルです。</p>
	                        </div>
	                        <div id="menu2" class="tab-pane fade">
	                          <p>・JASMA基準認定品<br/>・2年3万km保証</p>
	                        </div>
	                      </div>
	                      <script>
	                ...
	                <table style="table-layout:fixed;" width="100%">
	                  <!--ココまでSP-->
	                  <tr>
	                    <p class="search_category">**********【商品検索】**********&nbsp;&nbsp;<a class="change_button" href="../../sale/item/10811.php"><img src="../../img/sale_button.jpg" alt="単品販売の価格表はコチラ"></a></p>
	                  </tr>
	                </table>
	                  <?php
	                  	$root_dir = __DIR__.'/../../..';
