<html>
<head>
<meta name="description" content="高性能はそのままに、高いレベルの乗り心地と美しいローダウンフォルムを実現。ストリートで求められる乗り心地と走行性能を両立しながらもリーズナブルな価格を可能としたサスペンションシステムです。+ α は1年間、2万キロの製品保証付き！">
...
<title>KTS-web 商品ラインナップ FINAL KONNEXION STEALTH Mini + α PROSHOP VERSION</title>
...
{
@id: "/item/10067.php",
name: "STEALTH Mini + α PROSHOP VERSION"
}
}
]
}
...
<p>STEALTH Mini + α PROSHOP VERSION[ステルスミニ+α プロショップバージョン]</p></div>
</div></div>
...
<div class="swiper-slide"><img src="../../item_img/10067_1.jpg" alt="STEALTH Mini + α PROSHOP VERSION"></div>
<div class="swiper-slide"><img src="../../item_img/10067_2.jpg" alt="STEALTH Mini + α PROSHOP VERSION"></div>
<div class="swiper-slide"><img src="../../item_img/10067_3.jpg" alt="STEALTH Mini + α PROSHOP VERSION"></div>
</div>
...
<p>高性能はそのままに、高いレベルの乗り心地と美しいローダウンフォルムを実現。ストリートで求められる乗り心地と走行性能を両立しながらもリーズナブルな価格を可能としたサスペンションシステムです。+ α は1年間、2万キロの製品保証付き！</p>
</div>
<div id="panel2" class="tab_panel">
<p>・全長調整式<br>・単筒式<br>・減衰力 25 段調整機能付<br>・オーバーホール可能<br>・車高調レンチ、製品証明書、オリジナルステッカー付属<br>・1年間、2万Km製品保証付き<br>・サビ止めスプレー付属<br>・オリジナル メジャー付属</p>
</div>
</div>
</div>
</div>
...
<div class="item_info_text_middle_b">
<p>STEALTH Mini + α PROSHOP VERSION [ステルスミニ+α プロショップバージョン]</p>
</div>
<div class="tab_wrap">
...
<!--ココまでSP-->
<tr>
<p class="search_category">**********【適合検索】**********&nbsp;&nbsp;<a class="change_button" href="../../set/item/10067.php"><img src="../../img/set_button.jpg" alt="工賃セットの価格表はコチラ"></a></p>
</tr>
<tr>
<td>
<!-- 車両メーカー検索ココから -->
<p class="search_category">【自動車メーカー】</p>
<form method="post" action="10067.php">
...
if($data[0] == '10067') $position = explode(";", $data[1]);
}
array_pop($position);
fclose($fp_position);
...
<form name="make" method="post" action="10067.php">
