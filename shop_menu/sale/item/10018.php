...
<title>KTS-web 商品ラインナップ CUSCO SPORT R</title>
...
<div class="mc_nav">
<a class="link" href="https://www.kts-web.com/">HOME</a> &gt; <a class="link" href="../../index.html">SHOP MENU</a> &gt; <a class="link" href="../../set/index.html">商品ラインナップ</a> &gt; <a class="link" href="../../set/cat/100.html">足回り</a> &gt; <a class="link" href="../../set/cat/116.html">車高調/セッティングパーツ</a> &gt; <a class="link" href="../../set/br/1059-116.html">CUSCO</a> &gt; <a class="link" href="10018.php">SPORT R</a></div>
<div class="space3px"></div>
<div class="set_sale_back">
<div class="space3px"></div>
<div class="set_menu_n">
<div class="set_menu_n_330">
<div><img src="../../brand/img/1059.gif" alt="SPORT R"></div></div>
<div class="set_menu_n_cell">
<div class="item_info_text_middle">
<p>CUSCO[クスコ]</p></div>
<div class="item_info_text_middle_b">
<p>SPORT R[スポーツR]</p></div>
</div></div>
...
<div class="swiper-slide"><img src="../../item_img/10018_1.jpg" alt="SPORT R"></div>
<div class="swiper-slide"><img src="../../item_img/10018_2.jpg" alt="SPORT R"></div>
<div class="swiper-slide"><img src="../../item_img/10018_3.jpg" alt="SPORT R"></div>
</div>
...
<p>Sタイヤやハイグリップスポーツラジアルで本気でタイムを削る為のセッティング。一般のスポーツサスキットよりも更にスポーツ性の高い車高調を求めるハードユーザー向けです。本格的なレース・タイムアタック・競技への使用に対応。各種サーキットやワインディングなどの走行ステージやマシンの仕様に合わせ仕様変更が可能(変更内容により有料)。ハイレートスプリングにも対応する減衰力セットアップを実現。※乗り心地や快適性を求めるユーザーは SPORT S / SPORT TN_S やストリートシリーズをおすすめします。</p>
</div>
<div id="panel2" class="tab_panel">
<p>・単筒式ショックアブソーバー<br>・減衰力24段調整<br>・新開発CUSCO SPORT「Blue spring」採用<br>・全長調整式車高調整<br>・ピロボールアッパーマウント付※一部車種除く<br>・ラム式（倒立式）ショックアブソーバー※フロントストラット式のみ<br>・Sタイヤに対応</p>
</div>
</div>
</div>
</div>
...
<!--ココまでSP-->
<tr>
<p class="search_category">**********【適合検索】**********&nbsp;&nbsp;<a class="change_button" href="../../set/item/10018.php"><img src="../../img/set_button.jpg" alt="工賃セットの価格表はコチラ"></a></p>
</tr>
<tr>
<td>
<!-- 車両メーカー検索ココから -->
<p class="search_category">【自動車メーカー】</p>
<form method="post" action="10018.php">
...
if($data[0] == '10018') $position = explode(";", $data[1]);
}
array_pop($position);
fclose($fp_position);
...
<form name="make" method="post" action="10018.php">
