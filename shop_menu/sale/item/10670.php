<html>
<head>
<meta name="description" content="電子制御サスペンション装着車両の純正ショックアブソーバーを取り外した際に起きるエラー表示消去用のキャンセラーキットです。車両側の純正コネクターにカプラオン接続できます。正確な作動と高い耐久性を誇ります。">
...
<div class="mc_nav">
<a class="link" href="https://www.kts-web.com/">HOME</a> &gt; <a class="link" href="../../index.html">SHOP MENU</a> &gt; <a class="link" href="../../set/index.html">商品ラインナップ</a> &gt; <a class="link" href="../../set/cat/100.html">足回り</a> &gt; <a class="link" href="../../set/cat/116.html">車高調/セッティングパーツ</a> &gt; <a class="link" href="../../set/br/1046-116.html">OHLINS</a> &gt; <a class="link" href="10670.php">キャンセレーションキット</a></div>
<div class="space3px"></div>
<div class="set_sale_back">
<div class="space3px"></div>
<div class="set_menu_n">
<div class="set_menu_n_330">
<div><img src="../../brand/img/1046.gif" alt="キャンセレーションキット"></div></div>
<div class="set_menu_n_cell">
<div class="item_info_text_middle">
<p>OHLINS[オーリンズ]</p></div>
<div class="item_info_text_middle_b">
<p>キャンセレーションキット</p></div>
</div></div>
...
<div class="swiper-slide"><img src="../../item_img/10670_1.jpg" alt="キャンセレーションキット"></div>
<div class="swiper-slide"><img src="../../item_img/10670_2.jpg" alt="キャンセレーションキット"></div>
<div class="swiper-slide"><img src="../../item_img/10670_3.jpg" alt="キャンセレーションキット"></div>
</div>
...
<p>電子制御サスペンション装着車両の純正ショックアブソーバーを取り外した際に起きるエラー表示消去用のキャンセラーキットです。車両側の純正コネクターにカプラオン接続できます。正確な作動と高い耐久性を誇ります。</p>
</div>
<div id="panel2" class="tab_panel">
<p>・エラー表示消去用<br>・カプラーオン</p>
</div>
</div>
</div>
</div>
...
<!--ココまでSP-->
<tr>
<p class="search_category">**********【適合検索】**********&nbsp;&nbsp;<a class="change_button" href="../../set/item/10670.php"><img src="../../img/set_button.jpg" alt="工賃セットの価格表はコチラ"></a></p>
</tr>
<tr>
<td>
<!-- 車両メーカー検索ココから -->
<p class="search_category">【自動車メーカー】</p>
<form method="post" action="10670.php">
...
if($data[0] == '10670') $position = explode(";", $data[1]);
}
array_pop($position);
fclose($fp_position);
...
<form name="make" method="post" action="10670.php">
