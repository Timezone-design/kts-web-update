<html>
<head>
<meta name="description" content="これまでの強化クラッチの概念をくつがえす!!より繊細に、よりスムーズな操作が可能になる新感覚強化クラッチ。<br>これまでのメタルクラッチの特性を活かしつつ、半クラッチ量を増やし、扱いやすい強化クラッチとなりました。ストリートからドリフトユーザーまで幅広いユーザー層に対応します。">
...
<div class="mc_nav">
<a class="link" href="https://www.kts-web.com/">HOME</a> &gt; <a class="link" href="../../index.html">SHOP MENU</a> &gt; <a class="link" href="../../set/index.html">商品ラインナップ</a> &gt; <a class="link" href="../../set/cat/101.html">駆動系</a> &gt; <a class="link" href="../../set/cat/124.html">クラッチ/フライホイール</a> &gt; <a class="link" href="../../set/br/1039-124.html">ORC</a> &gt; <a class="link" href="10529.php">SE Clutch</a></div>
<div class="space3px"></div>
<div class="set_sale_back">
<div class="space3px"></div>
<div class="set_menu_n">
<div class="set_menu_n_330">
<div><img src="../../brand/img/1039.gif" alt="SE Clutch"></div></div>
<div class="set_menu_n_cell">
<div class="item_info_text_middle">
<p>ORC[オーアールシー]</p></div>
<div class="item_info_text_middle_b">
<p>SE Clutch[SEクラッチ]</p></div>
</div></div>
...
<div class="swiper-slide"><img src="../../item_img/10529_1.jpg" alt="SE Clutch"></div>
<div class="swiper-slide"><img src="../../item_img/10529_2.jpg" alt="SE Clutch"></div>
<div class="swiper-slide"><img src="../../item_img/10529_3.jpg" alt="SE Clutch"></div>
</div>
...
<p>これまでの強化クラッチの概念をくつがえす!!より繊細に、よりスムーズな操作が可能になる新感覚強化クラッチ。<br>これまでのメタルクラッチの特性を活かしつつ、半クラッチ量を増やし、扱いやすい強化クラッチとなりました。ストリートからドリフトユーザーまで幅広いユーザー層に対応します。</p>
</div>
<div id="panel2" class="tab_panel">
<p>・扱いやすい強化クラッチ<br>・クッショニング機構搭載<br>・衝撃トルク低減により駆動系の保護</p>
</div>
</div>
</div>
</div>
...
<!--ココまでSP-->
<tr>
<p class="search_category">**********【適合検索】**********&nbsp;&nbsp;<a class="change_button" href="../../set/item/10529.php"><img src="../../img/set_button.jpg" alt="工賃セットの価格表はコチラ"></a></p>
</tr>
<tr>
<td>
<!-- 車両メーカー検索ココから -->
<p class="search_category">【自動車メーカー】</p>
<form method="post" action="10529.php">
...
if($data[0] == '10529') $position = explode(";", $data[1]);
}
array_pop($position);
fclose($fp_position);
...
<form name="make" method="post" action="10529.php">
