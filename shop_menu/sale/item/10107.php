...
<title>KTS-web 商品ラインナップ KYB SUPER SPECIAL FOR STREET</title>
...
<div class="mc_nav">
<a class="link" href="https://www.kts-web.com/">HOME</a> &gt; <a class="link" href="../../index.html">SHOP MENU</a> &gt; <a class="link" href="../../set/index.html">商品ラインナップ</a> &gt; <a class="link" href="../../set/cat/100.html">足回り</a> &gt; <a class="link" href="../../set/cat/118.html">ショックアブソーバー</a> &gt; <a class="link" href="../../set/br/1054-118.html">KYB</a> &gt; <a class="link" href="10107.php">SUPER SPECIAL FOR STREET</a></div>
<div class="space3px"></div>
<div class="set_sale_back">
<div class="space3px"></div>
<div class="set_menu_n">
<div class="set_menu_n_330">
<div><img src="../../brand/img/1054.gif" alt="SUPER SPECIAL FOR STREET"></div></div>
<div class="set_menu_n_cell">
<div class="item_info_text_middle">
<p>KYB[カヤバ]</p></div>
<div class="item_info_text_middle_b">
<p>商品名：SUPER SPECIAL FOR STREET[スーパースペシャル FOR ストリート]</p></div>
</div></div>
...
<div class="swiper-slide"><img src="../../item_img/10107_1.jpg" alt="SUPER SPECIAL FOR STREET"></div>
<div class="swiper-slide"><img src="../../item_img/10107_2.jpg" alt="SUPER SPECIAL FOR STREET"></div>
<div class="swiper-slide"><img src="../../item_img/10107_3.jpg" alt="SUPER SPECIAL FOR STREET"></div>
</div>
...
<p>SUPER SPECIAL FOR STREETは、前後ともノーマルから若干高められた減衰力設定からハード方向へ4段階調整が可能。ワインディングから高速走行まで、ノーマルに近い走りから、スポーティな走りまで、ストリートにおけるあらゆる条件でのお好みのセッティングが可能。</p>
</div>
<div id="panel2" class="tab_panel">
<p>・純正形状<br>・減衰力4段階調整</p>
</div>
</div>
</div>
</div>
...
<div class="item_info_text_middle_b">
<p>SUPER SPECIAL FOR STREET [スーパースペシャル FOR ストリート]</p>
</div>
<div class="tab_wrap">
...
<!--ココまでSP-->
<tr>
<p class="search_category">**********【適合検索】**********&nbsp;&nbsp;<a class="change_button" href="../../set/item/10107.php"><img src="../../img/set_button.jpg" alt="工賃セットの価格表はコチラ"></a></p>
</tr>
<tr>
<td>
<!-- 車両メーカー検索ココから -->
<p class="search_category">【自動車メーカー】</p>
<form method="post" action="10107.php">
...
if($data[0] == '10107') $position = explode(";", $data[1]);
}
array_pop($position);
fclose($fp_position);
...
<form name="make" method="post" action="10107.php">
