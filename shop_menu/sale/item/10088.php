...
<title>KTS-web 商品ラインナップ IDEAL TRUEVA</title>
...
<div class="mc_nav">
<a class="link" href="https://www.kts-web.com/">HOME</a> &gt; <a class="link" href="../../index.html">SHOP MENU</a> &gt; <a class="link" href="../../set/index.html">商品ラインナップ</a> &gt; <a class="link" href="../../set/cat/100.html">足回り</a> &gt; <a class="link" href="../../set/cat/116.html">車高調/セッティングパーツ</a> &gt; <a class="link" href="../../set/br/1012-116.html">IDEAL</a> &gt; <a class="link" href="10088.php">TRUEVA</a></div>
<div class="space3px"></div>
<div class="set_sale_back">
<div class="space3px"></div>
<div class="set_menu_n">
<div class="set_menu_n_330">
<div><img src="../../brand/img/1012.gif" alt="TRUEVA"></div></div>
<div class="set_menu_n_cell">
<div class="item_info_text_middle">
<p>IDEAL[イデアル]</p></div>
<div class="item_info_text_middle_b">
<p>TRUEVA[トゥルーヴァ]</p></div>
</div></div>
...
<div class="swiper-slide"><img src="../../item_img/10088_1.jpg" alt="TRUEVA"></div>
<div class="swiper-slide"><img src="../../item_img/10088_2.jpg" alt="TRUEVA"></div>
<div class="swiper-slide"><img src="../../item_img/10088_3.jpg" alt="TRUEVA"></div>
</div>
...
<p>全長調整式や減衰力など、車高調としての基本的な性能をおさえたベーシックモデル。 軽量かつ高強度のアルミ製アッパーマウントや車種専用に設計されたスプリングなど、 素材へのこだわりはエントリークラス随一。ロースタイルを実現しつつ、快適な乗り心地も確保。 減衰力は36段階調節が可能。しなやか乗り心地から、踏ん張りの効いたスポーティな走りまでシーンに合わせた走りを楽しめます。</p>
</div>
<div id="panel2" class="tab_panel">
<p>・全長調整式<br>・36段階減衰力調整機能<br>・アルミピロアッパーマウント<br>・専用バネ設計<br>・ダストブーツ付属</p>
</div>
</div>
</div>
</div>
...
<!--ココまでSP-->
<tr>
<p class="search_category">**********【適合検索】**********&nbsp;&nbsp;<a class="change_button" href="../../set/item/10088.php"><img src="../../img/set_button.jpg" alt="工賃セットの価格表はコチラ"></a></p>
</tr>
<tr>
<td>
<!-- 車両メーカー検索ココから -->
<p class="search_category">【自動車メーカー】</p>
<form method="post" action="10088.php">
...
if($data[0] == '10088') $position = explode(";", $data[1]);
}
array_pop($position);
fclose($fp_position);
...
<form name="make" method="post" action="10088.php">
