...
<title>KTS-web 商品ラインナップ ENDLESS Function Xプラス</title>
...
<div class="mc_nav">
<a class="link" href="https://www.kts-web.com/">HOME</a> &gt; <a class="link" href="../../index.html">SHOP MENU</a> &gt; <a class="link" href="../../set/index.html">商品ラインナップ</a> &gt; <a class="link" href="../../set/cat/100.html">足回り</a> &gt; <a class="link" href="../../set/cat/116.html">車高調/セッティングパーツ</a> &gt; <a class="link" href="../../set/br/1038-116.html">ENDLESS</a> &gt; <a class="link" href="10042.php">Function Xプラス</a></div>
<div class="space3px"></div>
<div class="set_sale_back">
<div class="space3px"></div>
<div class="set_menu_n">
<div class="set_menu_n_330">
<div><img src="../../brand/img/1038.gif" alt="Function Xプラス"></div></div>
<div class="set_menu_n_cell">
<div class="item_info_text_middle">
<p>ENDLESS[エンドレス]</p></div>
<div class="item_info_text_middle_b">
<p>Function Xプラス[ファンクション Xプラス]</p></div>
</div></div>
...
<div class="swiper-slide"><img src="../../item_img/10042_1.jpg" alt="Function Xプラス"></div>
<div class="swiper-slide"><img src="../../item_img/10042_2.jpg" alt="Function Xプラス"></div>
<div class="swiper-slide"><img src="../../item_img/10042_3.jpg" alt="Function Xプラス"></div>
</div>
...
<p>ストリートからスポーツ走行まで対応するマルチプレイヤー。20段階の減衰調整システムを採用し、ストリートからワインディング、サーキットまで幅広く対応するマルチプレーヤーとして開発されました。リニアな特性をもつ専用ピストンバルブを採用し、剛性感のある走りが楽しめます。スプリングレートは走行フィールドにあわせ、「SOFT」「HARD」からお選びいただけます。防錆に優れる特殊メッキを施したシェルケースを採用すると同時に、軽量化と腐食性の強化のため、アルマイト処理を施したアルミ製パーツも随所に採用しております。</p>
</div>
<div id="panel2" class="tab_panel">
<p>・全長調整式<br>・減衰力20段調整<br>・単筒正立式※ストラットタイプは単筒倒立式<br>・オーバーホールOK<br>・シェルケース材質：スチール(特殊メッキ処理)</p>
</div>
</div>
</div>
</div>
...
<div class="item_info_text_middle_b">
<p>Function Xプラス [ファンクション Xプラス]</p>
</div>
<div class="tab_wrap">
...
<!--ココまでSP-->
<tr>
<p class="search_category">**********【適合検索】**********&nbsp;&nbsp;<a class="change_button" href="../../set/item/10042.php"><img src="../../img/set_button.jpg" alt="工賃セットの価格表はコチラ"></a></p>
</tr>
<tr>
<td>
<!-- 車両メーカー検索ココから -->
<p class="search_category">【自動車メーカー】</p>
<form method="post" action="10042.php">
...
if($data[0] == '10042') $position = explode(";", $data[1]);
}
array_pop($position);
fclose($fp_position);
...
<form name="make" method="post" action="10042.php">
