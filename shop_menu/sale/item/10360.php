...
<div class="swiper-slide"><img src="../../item_img/10360_1.jpg" alt="Specom-β"></div>
<div class="swiper-slide"><img src="../../item_img/10360_2.jpg" alt="Specom-β"></div>
<div class="swiper-slide"><img src="../../item_img/10360_3.jpg" alt="Specom-β"></div>
</div>
...
<p>国内耐久レースで使用されているスペシャルコンパウンドをベースに開発<br>耐久レースでも十分に戦える特筆すべき高い耐摩耗性！<br>長時間走行でも変わらない効力，ペダルタッチにより安定したラップタイムを刻むことが可能<br>踏力コントロールしやすいフラットなμ特性</p>
</div>
<div id="panel2" class="tab_panel">
<p>・材質:カーボンセミメタル<br>・適正温度:200～900℃<br>・初期μ:0.48<br>・平均μ:0.40～0.43</p>
</div>
</div>
</div>
</div>
...
<!--ココまでSP-->
<tr>
<p class="search_category">**********【適合検索】**********&nbsp;&nbsp;<a class="change_button" href="../../set/item/10360.php"><img src="../../img/set_button.jpg" alt="工賃セットの価格表はコチラ"></a></p>
</tr>
<tr>
<td>
<!-- 車両メーカー検索ココから -->
<p class="search_category">【自動車メーカー】</p>
<form method="post" action="10360.php">
...
if($data[0] == '10360') $position = explode(";", $data[1]);
}
array_pop($position);
fclose($fp_position);
...
<form name="make" method="post" action="10360.php">
