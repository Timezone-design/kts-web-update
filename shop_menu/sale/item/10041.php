...
<title>KTS-web 商品ラインナップ ENDLESS Function プラス10</title>
...
<div class="mc_nav">
<a class="link" href="https://www.kts-web.com/">HOME</a> &gt; <a class="link" href="../../index.html">SHOP MENU</a> &gt; <a class="link" href="../../set/index.html">商品ラインナップ</a> &gt; <a class="link" href="../../set/cat/100.html">足回り</a> &gt; <a class="link" href="../../set/cat/116.html">車高調/セッティングパーツ</a> &gt; <a class="link" href="../../set/br/1038-116.html">ENDLESS</a> &gt; <a class="link" href="10041.php">Function プラス10</a></div>
<div class="space3px"></div>
<div class="set_sale_back">
<div class="space3px"></div>
<div class="set_menu_n">
<div class="set_menu_n_330">
<div><img src="../../brand/img/1038.gif" alt="Function プラス10"></div></div>
<div class="set_menu_n_cell">
<div class="item_info_text_middle">
<p>ENDLESS[エンドレス]</p></div>
<div class="item_info_text_middle_b">
<p>Function プラス10[ファンクション プラス10]</p></div>
</div></div>
...
<div class="swiper-slide"><img src="../../item_img/10041_1.jpg" alt="Function プラス10"></div>
<div class="swiper-slide"><img src="../../item_img/10041_2.jpg" alt="Function プラス10"></div>
<div class="swiper-slide"><img src="../../item_img/10041_3.jpg" alt="Function プラス10"></div>
</div>
...
<p>特殊ラバースプリングシートが振動を吸収し快適性を追求。ストリートからワインディング、走行会まで幅広く対応するマルチプレイヤーサスペンション「ファンクション-X プラス」の性能をベースに、よりストリートの快適性を追求したサスペンションです。プラス7は7mm、プラス10には10mmの特殊ラバースプリングシートを採用することで不快な振動や異音を解消しています。また、専用のバルブを採用することで剛性感と上質な乗り心地を両立しています。</p>
</div>
<div id="panel2" class="tab_panel">
<p>・全長調整式<br>・減衰力20段調整<br>・単筒式<br>・オーバーホールOK<br>・シェルケース材質：スチール(特殊メッキ処理)<br>・特殊ラバースプリングシート：10mm</p>
</div>
</div>
</div>
</div>
...
<div class="item_info_text_middle_b">
<p>Function プラス10 [ファンクション プラス10]</p>
</div>
<div class="tab_wrap">
...
<!--ココまでSP-->
<tr>
<p class="search_category">**********【適合検索】**********&nbsp;&nbsp;<a class="change_button" href="../../set/item/10041.php"><img src="../../img/set_button.jpg" alt="工賃セットの価格表はコチラ"></a></p>
</tr>
<tr>
<td>
<!-- 車両メーカー検索ココから -->
<p class="search_category">【自動車メーカー】</p>
<form method="post" action="10041.php">
...
if($data[0] == '10041') $position = explode(";", $data[1]);
}
array_pop($position);
fclose($fp_position);
...
<form name="make" method="post" action="10041.php">
