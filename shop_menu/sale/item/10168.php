...
<title>KTS-web 商品ラインナップ Spiegel プロスペック ライントレース</title>
...
<div class="mc_nav">
<a class="link" href="https://www.kts-web.com/">HOME</a> &gt; <a class="link" href="../../index.html">SHOP MENU</a> &gt; <a class="link" href="../../set/index.html">商品ラインナップ</a> &gt; <a class="link" href="../../set/cat/100.html">足回り</a> &gt; <a class="link" href="../../set/cat/116.html">車高調/セッティングパーツ</a> &gt; <a class="link" href="../../set/br/1082-116.html">Spiegel</a> &gt; <a class="link" href="10168.php">プロスペック ライントレース</a></div>
<div class="space3px"></div>
<div class="set_sale_back">
<div class="space3px"></div>
<div class="set_menu_n">
<div class="set_menu_n_330">
<div><img src="../../brand/img/1082.gif" alt="プロスペック ライントレース"></div></div>
<div class="set_menu_n_cell">
<div class="item_info_text_middle">
<p>Spiegel[シュピーゲル]</p></div>
<div class="item_info_text_middle_b">
<p>プロスペック ライントレース</p></div>
</div></div>
...
<div class="swiper-slide"><img src="../../item_img/10168_1.jpg" alt="プロスペック ライントレース"></div>
<div class="swiper-slide"><img src="../../item_img/10168_2.jpg" alt="プロスペック ライントレース"></div>
<div class="swiper-slide"><img src="../../item_img/10168_3.jpg" alt="プロスペック ライントレース"></div>
</div>
...
<p>特殊な立体形状のアッパーマウント構造によりステージⅡ以上のハイキャンバーを実現。リアブラケットのオフセット貫通構造により、ショックアブソーバーの調整幅が格段に増え、ダウン量の増加や細かいプリロードの設定ができるので、セッティングの幅が広がります。サーキットのハードな走行に耐えられるようにフロント10kg、リア8kgの高いバネレートを設定。もちろんバネレートが高いだけでなく、不要な沈み込みを抑えつつもしっかりと動く、サーキット専用のハイパフォーマンスサスペンションキットです。</p>
</div>
<div id="panel2" class="tab_panel">
<p>レース仕様<br>・リアショックロアブラケットはオフセットタイプ採用※ダイハツ車のみ<br>・貫通タイプ採用で全長の調整が広範囲に可能<br>・フロント可動式ピロアッパーマウント<br>・通常の仕様よりハイキャンバー仕様<br>・オーバーホール対応</p>
</div>
</div>
</div>
</div>
...
<!--ココまでSP-->
<tr>
<p class="search_category">**********【適合検索】**********&nbsp;&nbsp;<a class="change_button" href="../../set/item/10168.php"><img src="../../img/set_button.jpg" alt="工賃セットの価格表はコチラ"></a></p>
</tr>
<tr>
<td>
<!-- 車両メーカー検索ココから -->
<p class="search_category">【自動車メーカー】</p>
<form method="post" action="10168.php">
...
if($data[0] == '10168') $position = explode(";", $data[1]);
}
array_pop($position);
fclose($fp_position);
...
<form name="make" method="post" action="10168.php">
