...
<title>KTS-web 商品ラインナップ KONI SPECIAL</title>
...
<div class="mc_nav">
<a class="link" href="https://www.kts-web.com/">HOME</a> &gt; <a class="link" href="../../index.html">SHOP MENU</a> &gt; <a class="link" href="../../set/index.html">商品ラインナップ</a> &gt; <a class="link" href="../../set/cat/100.html">足回り</a> &gt; <a class="link" href="../../set/cat/118.html">ショックアブソーバー</a> &gt; <a class="link" href="../../set/br/1164-118.html">KONI</a> &gt; <a class="link" href="10222.php">SPECIAL</a></div>
<div class="space3px"></div>
<div class="set_sale_back">
<div class="space3px"></div>
<div class="set_menu_n">
<div class="set_menu_n_330">
<div><img src="../../brand/img/1164.gif" alt="SPECIAL"></div></div>
<div class="set_menu_n_cell">
<div class="item_info_text_middle">
<p>KONI[コニー]</p></div>
<div class="item_info_text_middle_b">
<p>商品名：SPECIAL[スペシャル]</p></div>
</div></div>
...
<div class="swiper-slide"><img src="../../item_img/10222_1.jpg" alt="SPECIAL"></div>
<div class="swiper-slide"><img src="../../item_img/10222_2.jpg" alt="SPECIAL"></div>
<div class="swiper-slide"><img src="../../item_img/10222_3.jpg" alt="SPECIAL"></div>
</div>
...
<p>ハンドリング性と快適性を重視した、コンフォートタイプのショックアブソーバーです。快適性を重視しながらも路面追従性が高く、安定感のある乗りあじが特徴。突き上げ感や硬さが気になる方にはおすすめです。純正交換（リプレイスメント）用としても定評があります。</p>
</div>
...
<!--ココまでSP-->
<tr>
<p class="search_category">**********【適合検索】**********&nbsp;&nbsp;<a class="change_button" href="../../set/item/10222.php"><img src="../../img/set_button.jpg" alt="工賃セットの価格表はコチラ"></a></p>
</tr>
<tr>
<td>
<!-- 車両メーカー検索ココから -->
<p class="search_category">【自動車メーカー】</p>
<form method="post" action="10222.php">
...
if($data[0] == '10222') $position = explode(";", $data[1]);
}
array_pop($position);
fclose($fp_position);
...
<form name="make" method="post" action="10222.php">
