<html>
<head>
<meta name="description" content="純正同等タイプのエアコンフィルターです。<br>たかがエアコンフィルターですが、汚れているとエアコン風量だけでなく、エンジン出力・燃費にまで影響しますので、こまめな清掃・交換をお勧めします。">
...
<div class="swiper-slide"><img src="../../item_img/10667_1.jpg" alt="エアコンフィルター"></div>
<div class="swiper-slide"><img src="../../item_img/10667_2.jpg" alt="エアコンフィルター"></div>
<div class="swiper-slide"><img src="../../item_img/10667_3.jpg" alt="エアコンフィルター"></div>
</div>
...
<p>純正同等タイプのエアコンフィルターです。<br>たかがエアコンフィルターですが、汚れているとエアコン風量だけでなく、エンジン出力・燃費にまで影響しますので、こまめな清掃・交換をお勧めします。</p>
</div>
...
<!--ココまでSP-->
<tr>
<p class="search_category">**********【適合検索】**********&nbsp;&nbsp;<a class="change_button" href="../../set/item/10667.php"><img src="../../img/set_button.jpg" alt="工賃セットの価格表はコチラ"></a></p>
</tr>
<tr>
<td>
<!-- 車両メーカー検索ココから -->
<p class="search_category">【自動車メーカー】</p>
<form method="post" action="10667.php">
...
if($data[0] == '10667') $position = explode(";", $data[1]);
}
array_pop($position);
fclose($fp_position);
...
<form name="make" method="post" action="10667.php">
