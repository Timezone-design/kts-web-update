<html>
<head>
<meta name="description" content="スーパーローダウンを実現しながら実走行可能な調整範囲を確保。ショート化されたロアブラケットとショックアブソーバー、ハイレートなショートスプリングなどの専用部品を用いて、従来の車高調では不可能なダウン量を確保しています。全下げ状態にすることで迫力のローダウンを実現し、全長を調整する事で自走する事も可能。">
...
<title>KTS-web 商品ラインナップ LARGUS SpecD</title>
...
<div class="mc_nav">
<a class="link" href="https://www.kts-web.com/">HOME</a> &gt; <a class="link" href="../../index.html">SHOP MENU</a> &gt; <a class="link" href="../../set/index.html">商品ラインナップ</a> &gt; <a class="link" href="../../set/cat/100.html">足回り</a> &gt; <a class="link" href="../../set/cat/116.html">車高調/セッティングパーツ</a> &gt; <a class="link" href="../../set/br/1156-116.html">LARGUS</a> &gt; <a class="link" href="10111.php">SpecD</a></div>
<div class="space3px"></div>
<div class="set_sale_back">
<div class="space3px"></div>
<div class="set_menu_n">
<div class="set_menu_n_330">
<div><img src="../../brand/img/1156.gif" alt="SpecD"></div></div>
...
<div class="swiper-slide"><img src="../../item_img/10111_1.jpg" alt="SpecD"></div>
<div class="swiper-slide"><img src="../../item_img/10111_2.jpg" alt="SpecD"></div>
<div class="swiper-slide"><img src="../../item_img/10111_3.jpg" alt="SpecD"></div>
</div>
...
<p>スーパーローダウンを実現しながら実走行可能な調整範囲を確保。ショート化されたロアブラケットとショックアブソーバー、ハイレートなショートスプリングなどの専用部品を用いて、従来の車高調では不可能なダウン量を確保しています。全下げ状態にすることで迫力のローダウンを実現し、全長を調整する事で自走する事も可能。</p>
</div>
...
<!--ココまでSP-->
<tr>
<p class="search_category">**********【適合検索】**********&nbsp;&nbsp;<a class="change_button" href="../../set/item/10111.php"><img src="../../img/set_button.jpg" alt="工賃セットの価格表はコチラ"></a></p>
</tr>
<tr>
<td>
<!-- 車両メーカー検索ココから -->
<p class="search_category">【自動車メーカー】</p>
<form method="post" action="10111.php">
...
if($data[0] == '10111') $position = explode(";", $data[1]);
}
array_pop($position);
fclose($fp_position);
...
<form name="make" method="post" action="10111.php">
