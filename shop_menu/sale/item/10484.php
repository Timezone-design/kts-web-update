<html>
<head>
<meta name="description" content="KTSは独自にBrake Quip製部材を輸入し、国内の指定工場にて車種専用に組み立て出荷いたします。クラッチラインは全て組付後、3,000psiにて耐圧テストを行い合格後の出荷となりますので安心して御使用頂けます。">
...
<div class="mc_nav">
<a class="link" href="https://www.kts-web.com/">HOME</a> &gt; <a class="link" href="../../index.html">SHOP MENU</a> &gt; <a class="link" href="../../set/index.html">商品ラインナップ</a> &gt; <a class="link" href="../../set/cat/101.html">駆動系</a> &gt; <a class="link" href="../../set/cat/124.html">クラッチ/フライホイール</a> &gt; <a class="link" href="../../set/br/1168-124.html">Brake Quip</a> &gt; <a class="link" href="10484.php">ステンメッシュクラッチライン</a></div>
<div class="space3px"></div>
<div class="set_sale_back">
<div class="space3px"></div>
<div class="set_menu_n">
<div class="set_menu_n_330">
<div><img src="../../brand/img/1168.gif" alt="ステンメッシュクラッチライン"></div></div>
<div class="set_menu_n_cell">
<div class="item_info_text_middle">
<p>Brake Quip[ブレーキクイップ]</p></div>
<div class="item_info_text_middle_b">
<p>ステンメッシュクラッチライン</p></div>
</div></div>
...
<div class="swiper-slide"><img src="../../item_img/10484_1.jpg" alt="ステンメッシュクラッチライン"></div>
<div class="swiper-slide"><img src="../../item_img/10484_2.jpg" alt="ステンメッシュクラッチライン"></div>
<div class="swiper-slide"><img src="../../item_img/10484_3.jpg" alt="ステンメッシュクラッチライン"></div>
</div>
...
<p>KTSは独自にBrake Quip製部材を輸入し、国内の指定工場にて車種専用に組み立て出荷いたします。クラッチラインは全て組付後、3,000psiにて耐圧テストを行い合格後の出荷となりますので安心して御使用頂けます。</p>
</div>
<div id="panel2" class="tab_panel">
<p>・ホース中心部材質:PTFEホース<br>・中心ホースの周りを覆う層材質:304ステンレス材<br>・外装部材質:PVCホース</p>
</div>
</div>
</div>
</div>
...
<!--ココまでSP-->
<tr>
<p class="search_category">**********【適合検索】**********&nbsp;&nbsp;<a class="change_button" href="../../set/item/10484.php"><img src="../../img/set_button.jpg" alt="工賃セットの価格表はコチラ"></a></p>
</tr>
<tr>
<td>
<!-- 車両メーカー検索ココから -->
<p class="search_category">【自動車メーカー】</p>
<form method="post" action="10484.php">
...
if($data[0] == '10484') $position = explode(";", $data[1]);
}
array_pop($position);
fclose($fp_position);
...
<form name="make" method="post" action="10484.php">
