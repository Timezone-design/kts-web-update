...
<title>KTS-web 商品ラインナップ GP SPORT G-MASTER Premium</title>
...
<div class="mc_nav">
<a class="link" href="https://www.kts-web.com/">HOME</a> &gt; <a class="link" href="../../index.html">SHOP MENU</a> &gt; <a class="link" href="../../set/index.html">商品ラインナップ</a> &gt; <a class="link" href="../../set/cat/100.html">足回り</a> &gt; <a class="link" href="../../set/cat/116.html">車高調/セッティングパーツ</a> &gt; <a class="link" href="../../set/br/1077-116.html">GP SPORT</a> &gt; <a class="link" href="10075.php">G-MASTER Premium</a></div>
<div class="space3px"></div>
<div class="set_sale_back">
<div class="space3px"></div>
<div class="set_menu_n">
<div class="set_menu_n_330">
<div><img src="../../brand/img/1077.gif" alt="G-MASTER Premium"></div></div>
<div class="set_menu_n_cell">
<div class="item_info_text_middle">
<p>GP SPORT[ジーピースポーツ]</p></div>
<div class="item_info_text_middle_b">
<p>商品名：G-MASTER Premium[ジーマスター プレミアム]</p></div>
</div></div>
...
<div class="swiper-slide"><img src="../../item_img/10075_1.jpg" alt="G-MASTER Premium"></div>
<div class="swiper-slide"><img src="../../item_img/10075_2.jpg" alt="G-MASTER Premium"></div>
<div class="swiper-slide"><img src="../../item_img/10075_3.jpg" alt="G-MASTER Premium"></div>
</div>
...
<p>究極のサスペンションを目指し、土屋圭市氏がプロデュースするDG-5と再びタッグを組み、お互いのノウハウと拘りを注ぎ込んで完成させた最高傑作。それがG-MASTER PREMIUM サスペンション。極太60φショックとSWIFTスプリングの組み合わせは、しなやかでいながらも路面に確実にトラクションを伝え、乗り心地とスポーツ性能を両立させます。</p>
</div>
<div id="panel2" class="tab_panel">
<p>・ネジ式・全長調整式<br>・極太60φショック<br>・単筒式<br>・減衰力32段調整 <br>・Swift製スプリング<br>・アッパーマウント ピロボール仕様(一部車種は強力ゴムアッパー)<br>・オーダー時スプリングレート変更可能<br>・オーバーホール可能</p>
</div>
</div>
</div>
</div>
...
<div class="item_info_text_middle">
<p>GP SPORT [ジーピースポーツ]</p>
</div>
<div class="item_info_text_middle_b">
<p>G-MASTER Premium [ジーマスター プレミアム]</p>
</div>
<div class="tab_wrap">
...
<!--ココまでSP-->
<tr>
<p class="search_category">**********【適合検索】**********&nbsp;&nbsp;<a class="change_button" href="../../set/item/10075.php"><img src="../../img/set_button.jpg" alt="工賃セットの価格表はコチラ"></a></p>
</tr>
<tr>
<td>
<!-- 車両メーカー検索ココから -->
<p class="search_category">【自動車メーカー】</p>
<form method="post" action="10075.php">
...
if($data[0] == '10075') $position = explode(";", $data[1]);
}
array_pop($position);
fclose($fp_position);
...
<form name="make" method="post" action="10075.php">
