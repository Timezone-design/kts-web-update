...
<title>KTS-web 商品ラインナップ RS★R Best☆i Active</title>
...
<div class="mc_nav">
<a class="link" href="https://www.kts-web.com/">HOME</a> &gt; <a class="link" href="../../index.html">SHOP MENU</a> &gt; <a class="link" href="../../set/index.html">商品ラインナップ</a> &gt; <a class="link" href="../../set/cat/100.html">足回り</a> &gt; <a class="link" href="../../set/cat/116.html">車高調/セッティングパーツ</a> &gt; <a class="link" href="../../set/br/1001-116.html">RS★R</a> &gt; <a class="link" href="10132.php">Best☆i Active</a></div>
<div class="space3px"></div>
<div class="set_sale_back">
<div class="space3px"></div>
<div class="set_menu_n">
<div class="set_menu_n_330">
<div><img src="../../brand/img/1001.gif" alt="Best☆i Active"></div></div>
<div class="set_menu_n_cell">
<div class="item_info_text_middle">
<p>RS★R[アールエスアール]</p></div>
<div class="item_info_text_middle_b">
<p>Best☆i Active[ベストアイ アクティブ]</p></div>
</div></div>
...
<div class="swiper-slide"><img src="../../item_img/10132_2.jpg" alt="Best☆i Active"></div>
<div class="swiper-slide"><img src="../../item_img/10132_3.jpg" alt="Best☆i Active"></div>
</div>
...
<p>・全長調整式<br>・減衰力36段調整<br>・単筒式<br>・Ti2000スプリング採用<br>・スチールアッパーマウント(一部車種を除く)<br>・ストリートユース向けオイル採用<br>・純正電子制御システムによる減衰力調整<br>・乗り心地保証<br>・製品保証</p>
</div>
</div>
</div>
</div>
...
<!--ココまでSP-->
<tr>
<p class="search_category">**********【適合検索】**********&nbsp;&nbsp;<a class="change_button" href="../../set/item/10132.php"><img src="../../img/set_button.jpg" alt="工賃セットの価格表はコチラ"></a></p>
</tr>
<tr>
<td>
<!-- 車両メーカー検索ココから -->
<p class="search_category">【自動車メーカー】</p>
<form method="post" action="10132.php">
...
if($data[0] == '10132') $position = explode(";", $data[1]);
}
array_pop($position);
fclose($fp_position);
...
<form name="make" method="post" action="10132.php">
