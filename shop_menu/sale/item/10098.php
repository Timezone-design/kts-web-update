...
<title>KTS-web 商品ラインナップ KONI HEAVY TRACK</title>
...
<div class="mc_nav">
<a class="link" href="https://www.kts-web.com/">HOME</a> &gt; <a class="link" href="../../index.html">SHOP MENU</a> &gt; <a class="link" href="../../set/index.html">商品ラインナップ</a> &gt; <a class="link" href="../../set/cat/100.html">足回り</a> &gt; <a class="link" href="../../set/cat/118.html">ショックアブソーバー</a> &gt; <a class="link" href="../../set/br/1164-118.html">KONI</a> &gt; <a class="link" href="10098.php">HEAVY TRACK</a></div>
<div class="space3px"></div>
<div class="set_sale_back">
<div class="space3px"></div>
<div class="set_menu_n">
<div class="set_menu_n_330">
<div><img src="../../brand/img/1164.gif" alt="HEAVY TRACK"></div></div>
<div class="set_menu_n_cell">
<div class="item_info_text_middle">
<p>KONI[コニー]</p></div>
<div class="item_info_text_middle_b">
<p>商品名：HEAVY TRACK[ヘビートラック]</p></div>
</div></div>
...
<div class="swiper-slide"><img src="../../item_img/10098_1.jpg" alt="HEAVY TRACK"></div>
<div class="swiper-slide"><img src="../../item_img/10098_2.jpg" alt="HEAVY TRACK"></div>
<div class="swiper-slide"><img src="../../item_img/10098_3.jpg" alt="HEAVY TRACK"></div>
</div>
...
<p>4WD車、SUVのために専用設計されたショックアブソーバー。市街地から悪路、未舗装路までオールコンディションで優れた快適性と安定性をもたらします。悪路での使用時には優れたグリップ力と抜群の耐久性を発揮。そして、市街地を走行する際には、路面追従性が高く、乗りあじと安定感を大幅に改善。快適性、安全性などトータルに性能が向上します。</p>
</div>
<div id="panel2" class="tab_panel">
<p>・減衰力調整機能<br>・4WD/SUV専用設計</p>
</div>
</div>
</div>
</div>
...
<!--ココまでSP-->
<tr>
<p class="search_category">**********【適合検索】**********&nbsp;&nbsp;<a class="change_button" href="../../set/item/10098.php"><img src="../../img/set_button.jpg" alt="工賃セットの価格表はコチラ"></a></p>
</tr>
<tr>
<td>
<!-- 車両メーカー検索ココから -->
<p class="search_category">【自動車メーカー】</p>
<form method="post" action="10098.php">
...
if($data[0] == '10098') $position = explode(";", $data[1]);
}
array_pop($position);
fclose($fp_position);
...
<form name="make" method="post" action="10098.php">
