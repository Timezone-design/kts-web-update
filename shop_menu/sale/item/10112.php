...
<title>KTS-web 商品ラインナップ LARGUS SpecRS</title>
...
<div class="mc_nav">
<a class="link" href="https://www.kts-web.com/">HOME</a> &gt; <a class="link" href="../../index.html">SHOP MENU</a> &gt; <a class="link" href="../../set/index.html">商品ラインナップ</a> &gt; <a class="link" href="../../set/cat/100.html">足回り</a> &gt; <a class="link" href="../../set/cat/116.html">車高調/セッティングパーツ</a> &gt; <a class="link" href="../../set/br/1156-116.html">LARGUS</a> &gt; <a class="link" href="10112.php">SpecRS</a></div>
<div class="space3px"></div>
<div class="set_sale_back">
<div class="space3px"></div>
<div class="set_menu_n">
<div class="set_menu_n_330">
<div><img src="../../brand/img/1156.gif" alt="SpecRS"></div></div>
<div class="set_menu_n_cell">
<div class="item_info_text_middle">
<p>LARGUS[ラルグス]</p></div>
<div class="item_info_text_middle_b">
<p>SpecRS[スペックRS]</p></div>
</div></div>
...
<div class="swiper-slide"><img src="../../item_img/10112_1.jpg" alt="SpecRS"></div>
<div class="swiper-slide"><img src="../../item_img/10112_2.jpg" alt="SpecRS"></div>
<div class="swiper-slide"><img src="../../item_img/10112_3.jpg" alt="SpecRS"></div>
</div>
...
<p>伸び側・縮み側の減衰力を2wayで独立調整が可能。別体タンク式にすることでストローク量とオイル量を増やし、従来の単筒式では実現不可能だったガスの低圧化を実現。伸び側と縮み側でそれぞれ32段階の調整を行う事が出来るため、より細かなセッティングが可能。</p>
</div>
<div id="panel2" class="tab_panel">
<p>・全長調整式<br>・減衰力32段階調整<br>伸び縮み独立2way調整<br>・別体タンク式<br>・単筒式<br>・防錆塗装<br>・2年保証<br>・オーバーホール対応<br>・ID62スプリング</p>
</div>
</div>
</div>
</div>
...
<!--ココまでSP-->
<tr>
<p class="search_category">**********【適合検索】**********&nbsp;&nbsp;<a class="change_button" href="../../set/item/10112.php"><img src="../../img/set_button.jpg" alt="工賃セットの価格表はコチラ"></a></p>
</tr>
<tr>
<td>
<!-- 車両メーカー検索ココから -->
<p class="search_category">【自動車メーカー】</p>
<form method="post" action="10112.php">
...
if($data[0] == '10112') $position = explode(";", $data[1]);
}
array_pop($position);
fclose($fp_position);
...
<form name="make" method="post" action="10112.php">
