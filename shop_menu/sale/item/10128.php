...
<title>KTS-web 商品ラインナップ OVER TECH STREET TUNING DAMPER for SPORTS</title>
...
{
@id: "/item/10128.php",
name: "STREET TUNING DAMPER for SPORTS"
}
}
]
}
...
<div class="mc_nav">
<a class="link" href="https://www.kts-web.com/">HOME</a> &gt; <a class="link" href="../../index.html">SHOP MENU</a> &gt; <a class="link" href="../../set/index.html">商品ラインナップ</a> &gt; <a class="link" href="../../set/cat/100.html">足回り</a> &gt; <a class="link" href="../../set/cat/116.html">車高調/セッティングパーツ</a> &gt; <a class="link" href="../../set/br/1045-116.html">OVER TECH</a> &gt; <a class="link" href="10128.php">STREET TUNING DAMPER for SPORTS</a></div>
<div class="space3px"></div>
<div class="set_sale_back">
<div class="space3px"></div>
<div class="set_menu_n">
<div class="set_menu_n_330">
<div><img src="../../brand/img/1045.gif" alt="STREET TUNING DAMPER for SPORTS"></div></div>
<div class="set_menu_n_cell">
<div class="item_info_text_middle">
<p>OVER TECH[オーバーテック]</p></div>
<div class="item_info_text_middle_b">
<p>STREET TUNING DAMPER for SPORTS[ストリートチューニングダンパー FOR スポーツ]</p></div>
</div></div>
...
<div class="swiper-slide"><img src="../../item_img/10128_1.jpg" alt="STREET TUNING DAMPER for SPORTS"></div>
<div class="swiper-slide"><img src="../../item_img/10128_2.jpg" alt="STREET TUNING DAMPER for SPORTS"></div>
<div class="swiper-slide"><img src="../../item_img/10128_3.jpg" alt="STREET TUNING DAMPER for SPORTS"></div>
</div>
...
<p>減衰力15段階調整/全長調整（フルタップ）式のコストパーフォマンスに優れた車高調整キット、ストリートチューニングダンパー（S.T.D）。町乗りセッティングからハードな走りまで対応。</p>
</div>
...
<div class="item_info_text_middle_b">
<p>STREET TUNING DAMPER for SPORTS [ストリートチューニングダンパー FOR スポーツ]</p>
</div>
<div class="tab_wrap">
...
<!--ココまでSP-->
<tr>
<p class="search_category">**********【適合検索】**********&nbsp;&nbsp;<a class="change_button" href="../../set/item/10128.php"><img src="../../img/set_button.jpg" alt="工賃セットの価格表はコチラ"></a></p>
</tr>
<tr>
<td>
<!-- 車両メーカー検索ココから -->
<p class="search_category">【自動車メーカー】</p>
<form method="post" action="10128.php">
...
if($data[0] == '10128') $position = explode(";", $data[1]);
}
array_pop($position);
fclose($fp_position);
...
<form name="make" method="post" action="10128.php">
