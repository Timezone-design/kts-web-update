...
<title>KTS-web 商品ラインナップ Spiegel プロスペック ステージⅡ</title>
...
<div class="mc_nav">
<a class="link" href="https://www.kts-web.com/">HOME</a> &gt; <a class="link" href="../../index.html">SHOP MENU</a> &gt; <a class="link" href="../../set/index.html">商品ラインナップ</a> &gt; <a class="link" href="../../set/cat/100.html">足回り</a> &gt; <a class="link" href="../../set/cat/116.html">車高調/セッティングパーツ</a> &gt; <a class="link" href="../../set/br/1082-116.html">Spiegel</a> &gt; <a class="link" href="10167.php">プロスペック ステージⅡ</a></div>
<div class="space3px"></div>
<div class="set_sale_back">
<div class="space3px"></div>
<div class="set_menu_n">
<div class="set_menu_n_330">
<div><img src="../../brand/img/1082.gif" alt="プロスペック ステージⅡ"></div></div>
<div class="set_menu_n_cell">
<div class="item_info_text_middle">
<p>Spiegel[シュピーゲル]</p></div>
<div class="item_info_text_middle_b">
<p>プロスペック ステージⅡ</p></div>
</div></div>
...
<div class="swiper-slide"><img src="../../item_img/10167_1.jpg" alt="プロスペック ステージⅡ"></div>
<div class="swiper-slide"><img src="../../item_img/10167_2.jpg" alt="プロスペック ステージⅡ"></div>
<div class="swiper-slide"><img src="../../item_img/10167_3.jpg" alt="プロスペック ステージⅡ"></div>
</div>
...
<p>ネオ・ワゴンの良さはそのままに、ベアリング付きスプリングシートを標準装備し、リアの減衰力の幅を広げています。スムーズなスプリングの動きにすることで、スプリング本来の性能を引き出し、スムーズなコーナーリングに繋げます。また、バネ鳴りを低減させる効果もあります。</p>
</div>
<div id="panel2" class="tab_panel">
<p>・4輪共に全長調整式車高調整機能を採用<br>・減衰力30段調整式<br>・ベアリングアッパーシート<br>・単筒正立式ショックアブソーバー<br>・可動式ピロアッパーマウントを採用※一部車種除く<br>・オーバーホール対応<br>・ダストブーツ付属・バンプラバー内蔵<br>・車高調レンチ2本付属・防錆加工済み</p>
</div>
</div>
</div>
</div>
...
<!--ココまでSP-->
<tr>
<p class="search_category">**********【適合検索】**********&nbsp;&nbsp;<a class="change_button" href="../../set/item/10167.php"><img src="../../img/set_button.jpg" alt="工賃セットの価格表はコチラ"></a></p>
</tr>
<tr>
<td>
<!-- 車両メーカー検索ココから -->
<p class="search_category">【自動車メーカー】</p>
<form method="post" action="10167.php">
...
if($data[0] == '10167') $position = explode(";", $data[1]);
}
array_pop($position);
fclose($fp_position);
...
<form name="make" method="post" action="10167.php">
