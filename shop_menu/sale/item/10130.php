...
<title>KTS-web 商品ラインナップ OVER TECH MAX40 リフトアップブロックキット</title>
...
<div class="mc_nav">
<a class="link" href="https://www.kts-web.com/">HOME</a> &gt; <a class="link" href="../../index.html">SHOP MENU</a> &gt; <a class="link" href="../../set/index.html">商品ラインナップ</a> &gt; <a class="link" href="../../set/cat/100.html">足回り</a> &gt; <a class="link" href="../../set/cat/116.html">車高調/セッティングパーツ</a> &gt; <a class="link" href="../../set/br/1045-116.html">OVER TECH</a> &gt; <a class="link" href="10130.php">MAX40 リフトアップブロックキット</a></div>
<div class="space3px"></div>
<div class="set_sale_back">
<div class="space3px"></div>
<div class="set_menu_n">
<div class="set_menu_n_330">
<div><img src="../../brand/img/1045.gif" alt="MAX40 リフトアップブロックキット"></div></div>
<div class="set_menu_n_cell">
<div class="item_info_text_middle">
<p>OVER TECH[オーバーテック]</p></div>
<div class="item_info_text_middle_b">
<p>MAX40 リフトアップブロックキット[マックス40 リフトアップブロックキット]</p></div>
</div></div>
...
<div class="swiper-slide"><img src="../../item_img/10130_1.jpg" alt="MAX40 リフトアップブロックキット"></div>
<div class="swiper-slide"><img src="../../item_img/10130_2.jpg" alt="MAX40 リフトアップブロックキット"></div>
<div class="swiper-slide"><img src="../../item_img/10130_3.jpg" alt="MAX40 リフトアップブロックキット"></div>
</div>
...
<p>保安基準上、構造変更を必要としない～40mmを最大上げ幅に設定した『リフトアップブロックキット』です。車種により若干構造や付属品は違いますが基本はフロントストラットソーサー、キャンバー補正ボルト、リアスプリングソーサー、リアショック延長アダプターの4点で車高を上げますので取り付けが簡単で、純正ショック＆スプリングのストロークを活かし乗り心地変化が少ないのが特徴です。</p>
</div>
<div id="panel2" class="tab_panel">
<p>・車高上げ幅～40mm<br>・純正ショックアブソーバー＆純正スプリング対応<br>・構造変更不要(2020年現在の保安基準上)</p>
</div>
</div>
</div>
</div>
...
<div class="item_info_text_middle_b">
<p>MAX40 リフトアップブロックキット [マックス40 リフトアップブロックキット]</p>
</div>
<div class="tab_wrap">
...
<!--ココまでSP-->
<tr>
<p class="search_category">**********【適合検索】**********&nbsp;&nbsp;<a class="change_button" href="../../set/item/10130.php"><img src="../../img/set_button.jpg" alt="工賃セットの価格表はコチラ"></a></p>
</tr>
<tr>
<td>
<!-- 車両メーカー検索ココから -->
<p class="search_category">【自動車メーカー】</p>
<form method="post" action="10130.php">
...
if($data[0] == '10130') $position = explode(";", $data[1]);
}
array_pop($position);
fclose($fp_position);
...
<form name="make" method="post" action="10130.php">
