...
<div class="swiper-slide"><img src="../../item_img/10783_1.jpg" alt="ストリートスポーツ ブレーキパッド"></div>
<div class="swiper-slide"><img src="../../item_img/10783_2.jpg" alt="ストリートスポーツ ブレーキパッド"></div>
<div class="swiper-slide"><img src="../../item_img/10783_3.jpg" alt="ストリートスポーツ ブレーキパッド"></div>
</div>
...
<p>狙いは｢意のままの減速｣。単に止まるための性能ではなく、連続したブレーキング時の安定した効きと、コーナリングでの繊細な荷重移動や車速の自在なコントロールを重視した設計。踏力や速度、温度などの諸条件により常に変化する摩擦係数（μ）の変化量や変化のさせ方に着目。スポーツ志向のドライバーが求める｢μの過渡特性｣により、感性にシンクロした効き味を実現する。</p>
</div>
<div id="panel2" class="tab_panel">
<p>・ノンアスベスト摩材<br>・ローター適正温度：0～400℃</p>
</div>
</div>
</div>
</div>
...
<!--ココまでSP-->
<tr>
<p class="search_category">**********【適合検索】**********&nbsp;&nbsp;<a class="change_button" href="../../set/item/10783.php"><img src="../../img/set_button.jpg" alt="工賃セットの価格表はコチラ"></a></p>
</tr>
<tr>
<td>
<!-- 車両メーカー検索ココから -->
<p class="search_category">【自動車メーカー】</p>
<form method="post" action="10783.php">
...
if($data[0] == '10783') $position = explode(";", $data[1]);
}
array_pop($position);
fclose($fp_position);
...
<form name="make" method="post" action="10783.php">
