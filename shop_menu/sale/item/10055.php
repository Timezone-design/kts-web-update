...
<title>KTS-web 商品ラインナップ FINAL KONNEXION STEALTH Basic Type-1</title>
...
<p>STEALTH Basic Type-1[ステルスベーシック タイプ1]</p></div>
</div></div>
...
<div class="swiper-slide"><img src="../../item_img/10055_1.jpg" alt="STEALTH Basic Type-1"></div>
<div class="swiper-slide"><img src="../../item_img/10055_2.jpg" alt="STEALTH Basic Type-1"></div>
<div class="swiper-slide"><img src="../../item_img/10055_3.jpg" alt="STEALTH Basic Type-1"></div>
</div>
...
<p>・フルタップ・全長調整式<br>・倒立式ショック(ストラットサス)<br>・ピロアッパーマウント<br>・減衰力25段調整機能付<br>・単筒式ショック<br>・ダストブーツ付<br>・オーバーホール可能</p>
</div>
</div>
</div>
</div>
...
<div class="item_info_text_middle_b">
<p>STEALTH Basic Type-1 [ステルスベーシック タイプ1]</p>
</div>
<div class="tab_wrap">
...
<!--ココまでSP-->
<tr>
<p class="search_category">**********【適合検索】**********&nbsp;&nbsp;<a class="change_button" href="../../set/item/10055.php"><img src="../../img/set_button.jpg" alt="工賃セットの価格表はコチラ"></a></p>
</tr>
<tr>
<td>
<!-- 車両メーカー検索ココから -->
<p class="search_category">【自動車メーカー】</p>
<form method="post" action="10055.php">
...
if($data[0] == '10055') $position = explode(";", $data[1]);
}
array_pop($position);
fclose($fp_position);
...
<form name="make" method="post" action="10055.php">
