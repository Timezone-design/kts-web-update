...
<title>KTS-web 商品ラインナップ BILSTEIN B14</title>
...
<div class="swiper-slide"><img src="../../item_img/10246_1.jpg" alt="B14"></div>
<div class="swiper-slide"><img src="../../item_img/10246_2.jpg" alt="B14"></div>
<div class="swiper-slide"><img src="../../item_img/10246_3.jpg" alt="B14"></div>
</div>
...
<p>スポーツが貴方を万能にする<br>サーキットや一般道で鍛えられた車高調整機能付きB14。サーキットレベルでのテストを繰り返してのファインチューン実施。ビルシュタインならではのドイツ製モノチューブ倒立式サスを採用し、TV（ドイツの技術検査機関）が認める性能を実現しています。</p>
</div>
<div id="panel2" class="tab_panel">
<p>・装着時に前後車軸それぞれに20mmの調整範囲を設定<br>・前後ともに約30〜50mmのローダウン化<br>・サーキットレベルでのテストを繰り返してのファインチューン実施<br>・スプリングプレートとロックナットはいずれもアルミ製<br>・トリプルCテクノロジー(三層コーティング)による高い防錆性を実現<br>・調整が容易なラウンドスレッド<br>・耐久性の高いスポーツ・スプリング<br>・ビルシュタインならではのガス封入技術<br>・ビルシュタインならではのドイツ製モノチューブ倒立式サス<br>・TV(ドイツの技術検査機関)が認める性能</p>
</div>
</div>
</div>
</div>
...
<!--ココまでSP-->
<tr>
<p class="search_category">**********【適合検索】**********&nbsp;&nbsp;<a class="change_button" href="../../set/item/10246.php"><img src="../../img/set_button.jpg" alt="工賃セットの価格表はコチラ"></a></p>
</tr>
<tr>
<td>
<!-- 車両メーカー検索ココから -->
<p class="search_category">【自動車メーカー】</p>
<form method="post" action="10246.php">
...
if($data[0] == '10246') $position = explode(";", $data[1]);
}
array_pop($position);
fclose($fp_position);
...
<form name="make" method="post" action="10246.php">
