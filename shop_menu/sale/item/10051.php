...
<title>KTS-web 商品ラインナップ FINAL KONNEXION EAGER SUSPENSION KIT FOR K-CAR</title>
...
{
@id: "/item/10051.php",
name: "EAGER SUSPENSION KIT FOR K-CAR"
}
}
]
}
...
<p>EAGER SUSPENSION KIT FOR K-CAR[イエーガーサスペンションキット FOR Kカー]</p></div>
</div></div>
...
<div class="swiper-slide"><img src="../../item_img/10051_1.jpg" alt="EAGER SUSPENSION KIT FOR K-CAR"></div>
<div class="swiper-slide"><img src="../../item_img/10051_2.jpg" alt="EAGER SUSPENSION KIT FOR K-CAR"></div>
<div class="swiper-slide"><img src="../../item_img/10051_3.jpg" alt="EAGER SUSPENSION KIT FOR K-CAR"></div>
</div>
...
<p>イエガー車高調キットはオーダー後に部品１つ１つを組み立てするハンドメイド車高調です！機能、性能、走行パフォーマンス！『ビシっと』した足回りを体感せよ！！The Sports Mind K-car Suspension Kit 単筒倒立式ショックアブソーバ仕様！</p>
</div>
<div id="panel2" class="tab_panel">
<p>・フロントキャンバー調整式ピロアッパーマウント（車種により一部ノーマルアッパー再利用）<br>・フロント全長調整式、単筒倒立式ショックアブソーバ<br>・リア全長調整式、復筒正立式ショックアブソーバ<br>・リア車高調整スプリングアジャスタータイプ（車種により一部、アダプター式）<br>・フロント、リア、ショックアブソーバ減衰力20段調整式</p>
</div>
</div>
</div>
</div>
...
<div class="item_info_text_middle_b">
<p>EAGER SUSPENSION KIT FOR K-CAR [イエーガーサスペンションキット FOR Kカー]</p>
</div>
<div class="tab_wrap">
...
<!--ココまでSP-->
<tr>
<p class="search_category">**********【適合検索】**********&nbsp;&nbsp;<a class="change_button" href="../../set/item/10051.php"><img src="../../img/set_button.jpg" alt="工賃セットの価格表はコチラ"></a></p>
</tr>
<tr>
<td>
<!-- 車両メーカー検索ココから -->
<p class="search_category">【自動車メーカー】</p>
<form method="post" action="10051.php">
...
if($data[0] == '10051') $position = explode(";", $data[1]);
}
array_pop($position);
fclose($fp_position);
...
<form name="make" method="post" action="10051.php">
