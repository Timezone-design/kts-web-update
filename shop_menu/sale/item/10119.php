...
<title>KTS-web 商品ラインナップ nismo SPORTS SUSPENSION KIT</title>
...
<div class="mc_nav">
<a class="link" href="https://www.kts-web.com/">HOME</a> &gt; <a class="link" href="../../index.html">SHOP MENU</a> &gt; <a class="link" href="../../set/index.html">商品ラインナップ</a> &gt; <a class="link" href="../../set/cat/100.html">足回り</a> &gt; <a class="link" href="../../set/cat/119.html">サスペンションキット</a> &gt; <a class="link" href="../../set/br/1122-119.html">nismo</a> &gt; <a class="link" href="10119.php">SPORTS SUSPENSION KIT</a></div>
<div class="space3px"></div>
<div class="set_sale_back">
<div class="space3px"></div>
<div class="set_menu_n">
<div class="set_menu_n_330">
<div><img src="../../brand/img/1122.gif" alt="SPORTS SUSPENSION KIT"></div></div>
<div class="set_menu_n_cell">
<div class="item_info_text_middle">
<p>nismo[ニスモ]</p></div>
<div class="item_info_text_middle_b">
<p>商品名：SPORTS SUSPENSION KIT[スポーツサスペンションキット]</p></div>
</div></div>
...
<div class="swiper-slide"><img src="../../item_img/10119_1.jpg" alt="SPORTS SUSPENSION KIT"></div>
<div class="swiper-slide"><img src="../../item_img/10119_2.jpg" alt="SPORTS SUSPENSION KIT"></div>
<div class="swiper-slide"><img src="../../item_img/10119_3.jpg" alt="SPORTS SUSPENSION KIT"></div>
</div>
...
<p>高速道路やワインディングでのスポーツ性能を向上させたラジアルタイヤ用サスペンション。NISMOサスペンションのコンセプトは、「車両が有するストローク量を最大限に活かしたスポーツサスペンションであること」です。</p>
</div>
<div id="panel2" class="tab_panel">
<p>・全車種専用設計<br>・走行性能を重視した車高(およそ20mm前後のローダウン)</p>
</div>
</div>
</div>
</div>
...
<div class="item_info_text_middle_b">
<p>SPORTS SUSPENSION KIT [スポーツサスペンションキット]</p>
</div>
<div class="tab_wrap">
...
<!--ココまでSP-->
<tr>
<p class="search_category">**********【適合検索】**********&nbsp;&nbsp;<a class="change_button" href="../../set/item/10119.php"><img src="../../img/set_button.jpg" alt="工賃セットの価格表はコチラ"></a></p>
</tr>
<tr>
<td>
<!-- 車両メーカー検索ココから -->
<p class="search_category">【自動車メーカー】</p>
<form method="post" action="10119.php">
...
if($data[0] == '10119') $position = explode(";", $data[1]);
}
array_pop($position);
fclose($fp_position);
...
<form name="make" method="post" action="10119.php">
