...
<title>KTS-web 商品ラインナップ FINAL KONNEXION STEALTH Complete Type-2 Swift Springs Ver.</title>
...
{
@id: "/item/10064.php",
name: "STEALTH Complete Type-2 Swift Springs Ver."
}
}
]
}
...
<p>STEALTH Complete Type-2 Swift Springs Ver.[ステルスコンプリート タイプ2 スイフトスプリングバージョン]</p></div>
</div></div>
...
<div class="swiper-slide"><img src="../../item_img/10064_1.jpg" alt="STEALTH Complete Type-2 Swift Springs Ver."></div>
<div class="swiper-slide"><img src="../../item_img/10064_2.jpg" alt="STEALTH Complete Type-2 Swift Springs Ver."></div>
<div class="swiper-slide"><img src="../../item_img/10064_3.jpg" alt="STEALTH Complete Type-2 Swift Springs Ver."></div>
</div>
...
<p>・全長調整式<br>・直巻スプリング<br>・Swiftスプリング仕様<br>・リジットマウントタイプ （TYPE-2のみ）<br>・ピロアッパーマウントタイプ（ピロボールは拘りの日本製）<br>・単筒式<br>・減衰力 30 段調整機能付<br>・オーバーホール可能<br>・車高調レンチ、製品証明書、オリジナルステッカー付属</p>
</div>
</div>
</div>
</div>
...
<div class="item_info_text_middle_b">
<p>STEALTH Complete Type-2 Swift Springs Ver. [ステルスコンプリート タイプ2 スイフトスプリングバージョン]</p>
</div>
<div class="tab_wrap">
...
<!--ココまでSP-->
<tr>
<p class="search_category">**********【適合検索】**********&nbsp;&nbsp;<a class="change_button" href="../../set/item/10064.php"><img src="../../img/set_button.jpg" alt="工賃セットの価格表はコチラ"></a></p>
</tr>
<tr>
<td>
<!-- 車両メーカー検索ココから -->
<p class="search_category">【自動車メーカー】</p>
<form method="post" action="10064.php">
...
if($data[0] == '10064') $position = explode(";", $data[1]);
}
array_pop($position);
fclose($fp_position);
...
<form name="make" method="post" action="10064.php">
