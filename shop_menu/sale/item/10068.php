<html>
<head>
<meta name="description" content="高いレベルの乗り心地と美しいローダウンフォルムを実現。高性能はそのままに、高いレベルの乗り心地と美しいローダウンフォルムを実現。ストリートで求められる乗り心地と走行性能を両立したワゴン用ベーシックモデルです。">
...
<title>KTS-web 商品ラインナップ FINAL KONNEXION STEALTH Wagon</title>
...
<div class="swiper-slide"><img src="../../item_img/10068_1.jpg" alt="STEALTH Wagon"></div>
<div class="swiper-slide"><img src="../../item_img/10068_2.jpg" alt="STEALTH Wagon"></div>
<div class="swiper-slide"><img src="../../item_img/10068_3.jpg" alt="STEALTH Wagon"></div>
</div>
...
<p>高いレベルの乗り心地と美しいローダウンフォルムを実現。高性能はそのままに、高いレベルの乗り心地と美しいローダウンフォルムを実現。ストリートで求められる乗り心地と走行性能を両立したワゴン用ベーシックモデルです。</p>
</div>
<div id="panel2" class="tab_panel">
<p>・フルタップ車高調・全長調整式<br>・単筒式ショック<br>・減衰力 25 段調整機能付<br>・ダストブーツ付<br>・オーバーホール可能<br>・車高調レンチ、製品証明書、オリジナルステッカー付属</p>
</div>
</div>
</div>
</div>
...
<!--ココまでSP-->
<tr>
<p class="search_category">**********【適合検索】**********&nbsp;&nbsp;<a class="change_button" href="../../set/item/10068.php"><img src="../../img/set_button.jpg" alt="工賃セットの価格表はコチラ"></a></p>
</tr>
<tr>
<td>
<!-- 車両メーカー検索ココから -->
<p class="search_category">【自動車メーカー】</p>
<form method="post" action="10068.php">
...
if($data[0] == '10068') $position = explode(";", $data[1]);
}
array_pop($position);
fclose($fp_position);
...
<form name="make" method="post" action="10068.php">
