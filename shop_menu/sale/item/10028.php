<html>
<head>
<meta name="description" content="車種別専用設計でローダウンしても十分なバンプストロークを確保し、ローダウンの乗り心地も静音性もトップレベル。「減衰力40段調整」と「全長調整式車高調整」でローダウン量にかかわらず最適な乗り心地と、きめ細やかな車高調整が可能なstreetシリーズのハイエンドモデル">
...
<title>KTS-web 商品ラインナップ CUSCO 青のStreet ZERO A</title>
...
<div class="mc_nav">
<a class="link" href="https://www.kts-web.com/">HOME</a> &gt; <a class="link" href="../../index.html">SHOP MENU</a> &gt; <a class="link" href="../../set/index.html">商品ラインナップ</a> &gt; <a class="link" href="../../set/cat/100.html">足回り</a> &gt; <a class="link" href="../../set/cat/116.html">車高調/セッティングパーツ</a> &gt; <a class="link" href="../../set/br/1059-116.html">CUSCO</a> &gt; <a class="link" href="10028.php">青のStreet ZERO A</a></div>
<div class="space3px"></div>
<div class="set_sale_back">
<div class="space3px"></div>
<div class="set_menu_n">
<div class="set_menu_n_330">
<div><img src="../../brand/img/1059.gif" alt="青のStreet ZERO A"></div></div>
<div class="set_menu_n_cell">
<div class="item_info_text_middle">
<p>CUSCO[クスコ]</p></div>
<div class="item_info_text_middle_b">
<p>青のStreet ZERO A[青のストリートゼロA]</p></div>
</div></div>
...
<div class="swiper-slide"><img src="../../item_img/10028_1.jpg" alt="青のStreet ZERO A"></div>
<div class="swiper-slide"><img src="../../item_img/10028_2.jpg" alt="青のStreet ZERO A"></div>
<div class="swiper-slide"><img src="../../item_img/10028_3.jpg" alt="青のStreet ZERO A"></div>
</div>
...
<p>車種別専用設計でローダウンしても十分なバンプストロークを確保し、ローダウンの乗り心地も静音性もトップレベル。「減衰力40段調整」と「全長調整式車高調整」でローダウン量にかかわらず最適な乗り心地と、きめ細やかな車高調整が可能なstreetシリーズのハイエンドモデル</p>
</div>
<div id="panel2" class="tab_panel">
<p>・減衰力40段調整<br>・全長調整式車高調整<br>・アッパーマウント標準装備<br>・（アッパーマウントレス構造車種は除く）<br>・ミニバンは静音性の高い純正形状ゴム製アッパーマウントを標準装備<br>・CPRV（圧力適正化バルブ）を採用<br>・減衰調整式ショックの作動音（クシュクシュ音）を抑える静音設計<br>・e-con2対応<br>・（適合車種のみ）</p>
</div>
</div>
</div>
</div>
...
<div class="item_info_text_middle_b">
<p>青のStreet ZERO A [青のストリートゼロA]</p>
</div>
<div class="tab_wrap">
...
<!--ココまでSP-->
<tr>
<p class="search_category">**********【適合検索】**********&nbsp;&nbsp;<a class="change_button" href="../../set/item/10028.php"><img src="../../img/set_button.jpg" alt="工賃セットの価格表はコチラ"></a></p>
</tr>
<tr>
<td>
<!-- 車両メーカー検索ココから -->
<p class="search_category">【自動車メーカー】</p>
<form method="post" action="10028.php">
...
if($data[0] == '10028') $position = explode(";", $data[1]);
}
array_pop($position);
fclose($fp_position);
...
<form name="make" method="post" action="10028.php">
