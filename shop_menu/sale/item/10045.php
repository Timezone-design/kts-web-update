...
<title>KTS-web 商品ラインナップ ESPELIR DOWNSUS Plus</title>
...
<div class="mc_nav">
<a class="link" href="https://www.kts-web.com/">HOME</a> &gt; <a class="link" href="../../index.html">SHOP MENU</a> &gt; <a class="link" href="../../set/index.html">商品ラインナップ</a> &gt; <a class="link" href="../../set/cat/100.html">足回り</a> &gt; <a class="link" href="../../set/cat/117.html">ダウンサス/アップサス</a> &gt; <a class="link" href="../../set/br/1030-117.html">ESPELIR</a> &gt; <a class="link" href="10045.php">DOWNSUS Plus</a></div>
<div class="space3px"></div>
<div class="set_sale_back">
<div class="space3px"></div>
<div class="set_menu_n">
<div class="set_menu_n_330">
<div><img src="../../brand/img/1030.gif" alt="DOWNSUS Plus"></div></div>
<div class="set_menu_n_cell">
<div class="item_info_text_middle">
<p>ESPELIR[エスペリア]</p></div>
<div class="item_info_text_middle_b">
<p>商品名：DOWNSUS Plus[ダウンサスプラス]</p></div>
</div></div>
...
<div class="swiper-slide"><img src="../../item_img/10045_1.jpg" alt="DOWNSUS Plus"></div>
<div class="swiper-slide"><img src="../../item_img/10045_2.jpg" alt="DOWNSUS Plus"></div>
<div class="swiper-slide"><img src="../../item_img/10045_3.jpg" alt="DOWNSUS Plus"></div>
</div>
...
<p>最もダウン量を少なくしたローダウンスプリング。DOWNSUS Plusは、各種ダウン量の中で、最も落ち幅をおさえた製品です。 極端に車高を落したくない、インチアップした時にフェンダーに当たる、インチダウンした時に地上高が保てない、エアロパーツに当たる等の気になる症状の緩和を考慮しています。</p>
</div>
<div id="panel2" class="tab_panel">
<p>・保安基準適合製品<br>・国産車カラー：ブルー/イエロー(クロスカントリー車)<br>・輸入車カラー：シルバー</p>
</div>
</div>
</div>
</div>
...
<!--ココまでSP-->
<tr>
<p class="search_category">**********【適合検索】**********&nbsp;&nbsp;<a class="change_button" href="../../set/item/10045.php"><img src="../../img/set_button.jpg" alt="工賃セットの価格表はコチラ"></a></p>
</tr>
<tr>
<td>
<!-- 車両メーカー検索ココから -->
<p class="search_category">【自動車メーカー】</p>
<form method="post" action="10045.php">
...
if($data[0] == '10045') $position = explode(";", $data[1]);
}
array_pop($position);
fclose($fp_position);
...
<form name="make" method="post" action="10045.php">
