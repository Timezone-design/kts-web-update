<html>
<head>
<meta name="description" content="気軽にローダウン。緑のスプリングが足元を鮮やかに演出<br>スプリングの遊びを排除し保安基準に適合するローダウンスタイルに設定で完全車検対応。車種のジャンルを問わず豊富なラインナップとし、スタイルアップ重視から、スポーツドライビング重視派まで納得のベストセッティングを実現しています。">
...
<title>KTS-web 商品ラインナップ TEIN S.TECH</title>
...
<div class="mc_nav">
<a class="link" href="https://www.kts-web.com/">HOME</a> &gt; <a class="link" href="../../index.html">SHOP MENU</a> &gt; <a class="link" href="../../set/index.html">商品ラインナップ</a> &gt; <a class="link" href="../../set/cat/100.html">足回り</a> &gt; <a class="link" href="../../set/cat/117.html">ダウンサス/アップサス</a> &gt; <a class="link" href="../../set/br/1104-117.html">TEIN</a> &gt; <a class="link" href="10200.php">S.TECH</a></div>
<div class="space3px"></div>
<div class="set_sale_back">
<div class="space3px"></div>
<div class="set_menu_n">
<div class="set_menu_n_330">
<div><img src="../../brand/img/1104.gif" alt="S.TECH"></div></div>
<div class="set_menu_n_cell">
<div class="item_info_text_middle">
<p>TEIN[テイン]</p></div>
<div class="item_info_text_middle_b">
<p>商品名：S.TECH[エステク]</p></div>
</div></div>
...
<div class="swiper-slide"><img src="../../item_img/10200_1.jpg" alt="S.TECH"></div>
<div class="swiper-slide"><img src="../../item_img/10200_2.jpg" alt="S.TECH"></div>
<div class="swiper-slide"><img src="../../item_img/10200_3.jpg" alt="S.TECH"></div>
</div>
...
<p>気軽にローダウン。緑のスプリングが足元を鮮やかに演出<br>スプリングの遊びを排除し保安基準に適合するローダウンスタイルに設定で完全車検対応。車種のジャンルを問わず豊富なラインナップとし、スタイルアップ重視から、スポーツドライビング重視派まで納得のベストセッティングを実現しています。</p>
</div>
<div id="panel2" class="tab_panel">
<p>・サスペンションチューニングの入門用として最適<br>・最低地上高90mmを確保し、完全車検対応<br>・リーズナブルプライスを実現</p>
</div>
</div>
</div>
</div>
...
<!--ココまでSP-->
<tr>
<p class="search_category">**********【適合検索】**********&nbsp;&nbsp;<a class="change_button" href="../../set/item/10200.php"><img src="../../img/set_button.jpg" alt="工賃セットの価格表はコチラ"></a></p>
</tr>
<tr>
<td>
<!-- 車両メーカー検索ココから -->
<p class="search_category">【自動車メーカー】</p>
<form method="post" action="10200.php">
...
if($data[0] == '10200') $position = explode(";", $data[1]);
}
array_pop($position);
fclose($fp_position);
...
<form name="make" method="post" action="10200.php">
