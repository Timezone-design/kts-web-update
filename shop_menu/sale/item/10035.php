...
<title>KTS-web 商品ラインナップ D2JAPAN SUSPENSION SYSTEM スーパースポーツ</title>
...
{
@id: "/item/10035.php",
name: "SUSPENSION SYSTEM スーパースポーツ"
}
}
]
}
...
<div class="mc_nav">
<a class="link" href="https://www.kts-web.com/">HOME</a> &gt; <a class="link" href="../../index.html">SHOP MENU</a> &gt; <a class="link" href="../../set/index.html">商品ラインナップ</a> &gt; <a class="link" href="../../set/cat/100.html">足回り</a> &gt; <a class="link" href="../../set/cat/116.html">車高調/セッティングパーツ</a> &gt; <a class="link" href="../../set/br/1100-116.html">D2JAPAN</a> &gt; <a class="link" href="10035.php">SUSPENSION SYSTEM スーパースポーツ</a></div>
<div class="space3px"></div>
<div class="set_sale_back">
<div class="space3px"></div>
<div class="set_menu_n">
<div class="set_menu_n_330">
<div><img src="../../brand/img/1100.gif" alt="SUSPENSION SYSTEM スーパースポーツ"></div></div>
<div class="set_menu_n_cell">
<div class="item_info_text_middle">
<p>D2JAPAN[ディーツージャパン]</p></div>
<div class="item_info_text_middle_b">
<p>SUSPENSION SYSTEM スーパースポーツ[サスペンションシステム スーパースポーツ]</p></div>
</div></div>
...
<div class="swiper-slide"><img src="../../item_img/10035_1.jpg" alt="SUSPENSION SYSTEM スーパースポーツ"></div>
<div class="swiper-slide"><img src="../../item_img/10035_2.jpg" alt="SUSPENSION SYSTEM スーパースポーツ"></div>
<div class="swiper-slide"><img src="../../item_img/10035_3.jpg" alt="SUSPENSION SYSTEM スーパースポーツ"></div>
</div>
...
<div class="item_info_text_middle_b">
<p>SUSPENSION SYSTEM スーパースポーツ [サスペンションシステム スーパースポーツ]</p>
</div>
<div class="tab_wrap">
...
<!--ココまでSP-->
<tr>
<p class="search_category">**********【適合検索】**********&nbsp;&nbsp;<a class="change_button" href="../../set/item/10035.php"><img src="../../img/set_button.jpg" alt="工賃セットの価格表はコチラ"></a></p>
</tr>
<tr>
<td>
<!-- 車両メーカー検索ココから -->
<p class="search_category">【自動車メーカー】</p>
<form method="post" action="10035.php">
...
if($data[0] == '10035') $position = explode(";", $data[1]);
}
array_pop($position);
fclose($fp_position);
...
<form name="make" method="post" action="10035.php">
