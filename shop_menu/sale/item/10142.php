<html>
<head>
<meta name="description" content="スーパー耐久やオーナーズカップで実績を残した仕様をそのままに商品化。サーキットでの開発走行テストを行い、専用品としてチューニングされた商品。">
...
<title>KTS-web 商品ラインナップ RS★R Racing☆i</title>
...
<div class="mc_nav">
<a class="link" href="https://www.kts-web.com/">HOME</a> &gt; <a class="link" href="../../index.html">SHOP MENU</a> &gt; <a class="link" href="../../set/index.html">商品ラインナップ</a> &gt; <a class="link" href="../../set/cat/100.html">足回り</a> &gt; <a class="link" href="../../set/cat/116.html">車高調/セッティングパーツ</a> &gt; <a class="link" href="../../set/br/1001-116.html">RS★R</a> &gt; <a class="link" href="10142.php">Racing☆i</a></div>
<div class="space3px"></div>
<div class="set_sale_back">
<div class="space3px"></div>
<div class="set_menu_n">
<div class="set_menu_n_330">
<div><img src="../../brand/img/1001.gif" alt="Racing☆i"></div></div>
<div class="set_menu_n_cell">
<div class="item_info_text_middle">
<p>RS★R[アールエスアール]</p></div>
<div class="item_info_text_middle_b">
<p>Racing☆i[レーシングアイ]</p></div>
</div></div>
...
<div class="swiper-slide"><img src="../../item_img/10142_1.jpg" alt="Racing☆i"></div>
<div class="swiper-slide"><img src="../../item_img/10142_2.jpg" alt="Racing☆i"></div>
<div class="swiper-slide"><img src="../../item_img/10142_3.jpg" alt="Racing☆i"></div>
</div>
...
<p>スーパー耐久やオーナーズカップで実績を残した仕様をそのままに商品化。サーキットでの開発走行テストを行い、専用品としてチューニングされた商品。</p>
</div>
<div id="panel2" class="tab_panel">
<p>・サーキット専用チューニング<br>・オーバーホール可能<br>・詳細は商品個別ページをご覧ください。</p>
</div>
</div>
</div>
</div>
...
<!--ココまでSP-->
<tr>
<p class="search_category">**********【適合検索】**********&nbsp;&nbsp;<a class="change_button" href="../../set/item/10142.php"><img src="../../img/set_button.jpg" alt="工賃セットの価格表はコチラ"></a></p>
</tr>
<tr>
<td>
<!-- 車両メーカー検索ココから -->
<p class="search_category">【自動車メーカー】</p>
<form method="post" action="10142.php">
...
if($data[0] == '10142') $position = explode(";", $data[1]);
}
array_pop($position);
fclose($fp_position);
...
<form name="make" method="post" action="10142.php">
