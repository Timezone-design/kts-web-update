...
<title>KTS-web 商品ラインナップ TEIN S.TECH K-SPECIAL</title>
...
<div class="mc_nav">
<a class="link" href="https://www.kts-web.com/">HOME</a> &gt; <a class="link" href="../../index.html">SHOP MENU</a> &gt; <a class="link" href="../../set/index.html">商品ラインナップ</a> &gt; <a class="link" href="../../set/cat/100.html">足回り</a> &gt; <a class="link" href="../../set/cat/117.html">ダウンサス/アップサス</a> &gt; <a class="link" href="../../set/br/1104-117.html">TEIN</a> &gt; <a class="link" href="10201.php">S.TECH K-SPECIAL</a></div>
<div class="space3px"></div>
<div class="set_sale_back">
<div class="space3px"></div>
<div class="set_menu_n">
<div class="set_menu_n_330">
<div><img src="../../brand/img/1104.gif" alt="S.TECH K-SPECIAL"></div></div>
<div class="set_menu_n_cell">
<div class="item_info_text_middle">
<p>TEIN[テイン]</p></div>
<div class="item_info_text_middle_b">
<p>商品名：S.TECH K-SPECIAL[エステク Kスペシャル]</p></div>
</div></div>
...
<div class="swiper-slide"><img src="../../item_img/10201_1.jpg" alt="S.TECH K-SPECIAL"></div>
<div class="swiper-slide"><img src="../../item_img/10201_2.jpg" alt="S.TECH K-SPECIAL"></div>
<div class="swiper-slide"><img src="../../item_img/10201_3.jpg" alt="S.TECH K-SPECIAL"></div>
</div>
...
<p>手軽にスタイリッシュ 軽カー専用ローダウンスプリング<br>軽カーを精悍なイメージに変身させるローダウンフォルムを実現。スプリング同士が密着した際に発生する不快な密着音、スプリング取付部から発生する音排除するため、サイレンサーラバーを標準装着(一部車種を除く)。</p>
</div>
<div id="panel2" class="tab_panel">
<p>・軽カーを精悍なイメージに変身させるローダウンフォルムを実現<br>・最低地上高90mmを確保し、完全車検対応<br>・リーズナブルプライスを実現<br>・スプリングからの不快な音を排除するサイレンサーラバーを標準装備<br>・3年5万キロのへたり保証を導入</p>
</div>
</div>
</div>
</div>
...
<div class="item_info_text_middle_b">
<p>S.TECH K-SPECIAL [エステク Kスペシャル]</p>
</div>
<div class="tab_wrap">
...
<!--ココまでSP-->
<tr>
<p class="search_category">**********【適合検索】**********&nbsp;&nbsp;<a class="change_button" href="../../set/item/10201.php"><img src="../../img/set_button.jpg" alt="工賃セットの価格表はコチラ"></a></p>
</tr>
<tr>
<td>
<!-- 車両メーカー検索ココから -->
<p class="search_category">【自動車メーカー】</p>
<form method="post" action="10201.php">
...
if($data[0] == '10201') $position = explode(";", $data[1]);
}
array_pop($position);
fclose($fp_position);
...
<form name="make" method="post" action="10201.php">
