...
<title>KTS-web 商品ラインナップ IDEAL TRUEVA極</title>
...
<div class="mc_nav">
<a class="link" href="https://www.kts-web.com/">HOME</a> &gt; <a class="link" href="../../index.html">SHOP MENU</a> &gt; <a class="link" href="../../set/index.html">商品ラインナップ</a> &gt; <a class="link" href="../../set/cat/100.html">足回り</a> &gt; <a class="link" href="../../set/cat/116.html">車高調/セッティングパーツ</a> &gt; <a class="link" href="../../set/br/1012-116.html">IDEAL</a> &gt; <a class="link" href="10089.php">TRUEVA極</a></div>
<div class="space3px"></div>
<div class="set_sale_back">
<div class="space3px"></div>
<div class="set_menu_n">
<div class="set_menu_n_330">
<div><img src="../../brand/img/1012.gif" alt="TRUEVA極"></div></div>
<div class="set_menu_n_cell">
<div class="item_info_text_middle">
<p>IDEAL[イデアル]</p></div>
<div class="item_info_text_middle_b">
<p>TRUEVA極[トゥルーヴァきわみ]</p></div>
</div></div>
...
<div class="swiper-slide"><img src="../../item_img/10089_1.jpg" alt="TRUEVA極"></div>
<div class="swiper-slide"><img src="../../item_img/10089_2.jpg" alt="TRUEVA極"></div>
<div class="swiper-slide"><img src="../../item_img/10089_3.jpg" alt="TRUEVA極"></div>
</div>
...
<p>トゥルーヴァの機能を継承しつつ、ショックとスプリングをショート設計に仕上げたトゥルーヴァ極。 車種専用設計のスプリングはキビキビとした走りを楽しめるハイレートタイプ。 もちろん車高調自体の底つきも防ぎます。 アルミアッパーマウントは一部車種ではスライド調整式を採用しており、キャンバーを効かせることも可能です。</p>
</div>
<div id="panel2" class="tab_panel">
<p>・全長調整式<br>・36段階減衰力調整機能<br>・アルミピロアッパーマウント<br>・ハイレートスプリング<br>・ダストブーツ付属<br>・アルミスプリングシート&ロックシート</p>
</div>
</div>
</div>
</div>
...
<!--ココまでSP-->
<tr>
<p class="search_category">**********【適合検索】**********&nbsp;&nbsp;<a class="change_button" href="../../set/item/10089.php"><img src="../../img/set_button.jpg" alt="工賃セットの価格表はコチラ"></a></p>
</tr>
<tr>
<td>
<!-- 車両メーカー検索ココから -->
<p class="search_category">【自動車メーカー】</p>
<form method="post" action="10089.php">
...
if($data[0] == '10089') $position = explode(";", $data[1]);
}
array_pop($position);
fclose($fp_position);
...
<form name="make" method="post" action="10089.php">
