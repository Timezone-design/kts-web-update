...
<meta content="text/html; charset=utf-8" http-equiv="Content-Type"/><title>KTS-web 商品ラインナップ D2JAPAN SUSPENSION SYSTEM サーキット</title><script type="application/ld+json">{@context: "http://schema.org",@type: "BreadcrumbList",itemListElement:[{@type: "ListItem",position: 1,item:{@id: "/shop_menu/",name: "SHOP MENU"}},{@type: "ListItem",position: 2,item:{@id: "/set/",name: "商品ラインナップ"}},{@type: "ListItem",position: 3,item:{@id: "/item/10034.php",name: "SUSPENSION SYSTEM サーキット"}}]}</script>
...
<div class="set_menu_n_cell col-md-6 col-sm-12 col-xs-12">
<a class="set-sale-switch" href="../../set/item/10034.php">取付へのリンク</a>
</div>
</div>
<div class="clearfix"></div>
