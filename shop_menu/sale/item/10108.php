...
<title>KTS-web 商品ラインナップ LARGUS SpecS</title>
...
<div class="mc_nav">
<a class="link" href="https://www.kts-web.com/">HOME</a> &gt; <a class="link" href="../../index.html">SHOP MENU</a> &gt; <a class="link" href="../../set/index.html">商品ラインナップ</a> &gt; <a class="link" href="../../set/cat/100.html">足回り</a> &gt; <a class="link" href="../../set/cat/116.html">車高調/セッティングパーツ</a> &gt; <a class="link" href="../../set/br/1156-116.html">LARGUS</a> &gt; <a class="link" href="10108.php">SpecS</a></div>
<div class="space3px"></div>
<div class="set_sale_back">
<div class="space3px"></div>
<div class="set_menu_n">
<div class="set_menu_n_330">
<div><img src="../../brand/img/1156.gif" alt="SpecS"></div></div>
...
<div class="swiper-slide"><img src="../../item_img/10108_1.jpg" alt="SpecS"></div>
<div class="swiper-slide"><img src="../../item_img/10108_2.jpg" alt="SpecS"></div>
<div class="swiper-slide"><img src="../../item_img/10108_3.jpg" alt="SpecS"></div>
</div>
...
<p>街乗りからスポーツ走行まで対応する万能モデル。スタンダードモデルとして、それぞれの車種が持つ特性に合わせて最適なセッティングで開発。全長調整式のフルスペック車高調として、車高を下げてもストローク量が変化せず、乗り心地の心配をすることなくローダウンを楽しめる車高調です。</p>
</div>
...
<!--ココまでSP-->
<tr>
<p class="search_category">**********【適合検索】**********&nbsp;&nbsp;<a class="change_button" href="../../set/item/10108.php"><img src="../../img/set_button.jpg" alt="工賃セットの価格表はコチラ"></a></p>
</tr>
<tr>
<td>
<!-- 車両メーカー検索ココから -->
<p class="search_category">【自動車メーカー】</p>
<form method="post" action="10108.php">
...
if($data[0] == '10108') $position = explode(";", $data[1]);
}
array_pop($position);
fclose($fp_position);
...
<form name="make" method="post" action="10108.php">
