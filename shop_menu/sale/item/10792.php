...
<div class="swiper-slide"><img src="../../item_img/10792_1.jpg" alt="センターフロアバー"></div>
<div class="swiper-slide"><img src="../../item_img/10792_2.jpg" alt="センターフロアバー"></div>
<div class="swiper-slide"><img src="../../item_img/10792_3.jpg" alt="センターフロアバー"></div>
</div>
...
<p>室内フロアの左右方向を高剛性スチール製パイプで結合し剛性を高める新ボディ補強パーツ。フロアトンネルを跨ぐセンター部までを一体化した溶接1ピース構造により強度を確保。ストラットタワーバーやフロアクロスバーでは補えないボディモノコック中央部付近の歪みを抑制。装着は強度の高いフロントシート後ろ側の取り付け部4点のボルトと共締めし、後席のレッグスペースを極力犠牲にしない低重心レイアウト。</p>
</div>
...
<!--ココまでSP-->
<tr>
<p class="search_category">**********【適合検索】**********&nbsp;&nbsp;<a class="change_button" href="../../set/item/10792.php"><img src="../../img/set_button.jpg" alt="工賃セットの価格表はコチラ"></a></p>
</tr>
<tr>
<td>
<!-- 車両メーカー検索ココから -->
<p class="search_category">【自動車メーカー】</p>
<form method="post" action="10792.php">
...
if($data[0] == '10792') $position = explode(";", $data[1]);
}
array_pop($position);
fclose($fp_position);
...
<form name="make" method="post" action="10792.php">
