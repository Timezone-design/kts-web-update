...
<title>KTS-web 商品ラインナップ KONI SPORT</title>
...
<div class="mc_nav">
<a class="link" href="https://www.kts-web.com/">HOME</a> &gt; <a class="link" href="../../index.html">SHOP MENU</a> &gt; <a class="link" href="../../set/index.html">商品ラインナップ</a> &gt; <a class="link" href="../../set/cat/100.html">足回り</a> &gt; <a class="link" href="../../set/cat/118.html">ショックアブソーバー</a> &gt; <a class="link" href="../../set/br/1164-118.html">KONI</a> &gt; <a class="link" href="10097.php">SPORT</a></div>
<div class="space3px"></div>
<div class="set_sale_back">
<div class="space3px"></div>
<div class="set_menu_n">
<div class="set_menu_n_330">
<div><img src="../../brand/img/1164.gif" alt="SPORT"></div></div>
<div class="set_menu_n_cell">
<div class="item_info_text_middle">
<p>KONI[コニー]</p></div>
<div class="item_info_text_middle_b">
<p>商品名：SPORT[スポーツ]</p></div>
</div></div>
...
<div class="swiper-slide"><img src="../../item_img/10097_1.jpg" alt="SPORT"></div>
<div class="swiper-slide"><img src="../../item_img/10097_2.jpg" alt="SPORT"></div>
<div class="swiper-slide"><img src="../../item_img/10097_3.jpg" alt="SPORT"></div>
</div>
...
<p>路面追従性とステアリングレスポンスを重視した、スポーツタイプのショックアブソーバーです。KONI SPORTは、スポーティーでありながら、市街地での突き上げも適度に抑えたマイルドな乗りあじが特徴。また、ミニバンなどの車高の高い車両では、減衰力特性を活かし、車線変更時のフラつきやロールを緩和、走行に安定感をもたらします。</p>
</div>
<div id="panel2" class="tab_panel">
<p>・減衰力調整機能<br>・ノーマル形状</p>
</div>
</div>
</div>
</div>
...
<!--ココまでSP-->
<tr>
<p class="search_category">**********【適合検索】**********&nbsp;&nbsp;<a class="change_button" href="../../set/item/10097.php"><img src="../../img/set_button.jpg" alt="工賃セットの価格表はコチラ"></a></p>
</tr>
<tr>
<td>
<!-- 車両メーカー検索ココから -->
<p class="search_category">【自動車メーカー】</p>
<form method="post" action="10097.php">
...
if($data[0] == '10097') $position = explode(";", $data[1]);
}
array_pop($position);
fclose($fp_position);
...
<form name="make" method="post" action="10097.php">
