<html>
<head>
<meta name="description" content="活性炭を織り込んだ強力脱臭タイプのエアコンフィルターです。<br>たかがエアコンフィルターですが、汚れているとエアコン風量だけでなく、エンジン出力・燃費にまで影響しますので、こまめな清掃・交換をお勧めします。">
...
<div class="swiper-slide"><img src="../../item_img/10668_1.jpg" alt="エアコンフィルター カーボンタイプ"></div>
<div class="swiper-slide"><img src="../../item_img/10668_2.jpg" alt="エアコンフィルター カーボンタイプ"></div>
<div class="swiper-slide"><img src="../../item_img/10668_3.jpg" alt="エアコンフィルター カーボンタイプ"></div>
</div>
...
<p>活性炭を織り込んだ強力脱臭タイプのエアコンフィルターです。<br>たかがエアコンフィルターですが、汚れているとエアコン風量だけでなく、エンジン出力・燃費にまで影響しますので、こまめな清掃・交換をお勧めします。</p>
</div>
<div id="panel2" class="tab_panel">
<p>タイプ：カーボンタイプ(活性炭織り込みタイプ)</p>
</div>
</div>
</div>
</div>
...
<!--ココまでSP-->
<tr>
<p class="search_category">**********【適合検索】**********&nbsp;&nbsp;<a class="change_button" href="../../set/item/10668.php"><img src="../../img/set_button.jpg" alt="工賃セットの価格表はコチラ"></a></p>
</tr>
<tr>
<td>
<!-- 車両メーカー検索ココから -->
<p class="search_category">【自動車メーカー】</p>
<form method="post" action="10668.php">
...
if($data[0] == '10668') $position = explode(";", $data[1]);
}
array_pop($position);
fclose($fp_position);
...
<form name="make" method="post" action="10668.php">
