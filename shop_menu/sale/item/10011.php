...
<title>KTS-web 商品ラインナップ AXIS STYLING PERFECT DAMPER 5G</title>
...
<div class="mc_nav">
<a class="link" href="https://www.kts-web.com/">HOME</a> &gt; <a class="link" href="../../index.html">SHOP MENU</a> &gt; <a class="link" href="../../set/index.html">商品ラインナップ</a> &gt; <a class="link" href="../../set/cat/100.html">足回り</a> &gt; <a class="link" href="../../set/cat/116.html">車高調/セッティングパーツ</a> &gt; <a class="link" href="../../set/br/1163-116.html">AXIS STYLING</a> &gt; <a class="link" href="10011.php">PERFECT DAMPER 5G</a></div>
<div class="space3px"></div>
<div class="set_sale_back">
<div class="space3px"></div>
<div class="set_menu_n">
<div class="set_menu_n_330">
<div><img src="../../brand/img/1163.gif" alt="PERFECT DAMPER 5G"></div></div>
<div class="set_menu_n_cell">
<div class="item_info_text_middle">
<p>AXIS STYLING[アクシススタイリング]</p></div>
<div class="item_info_text_middle_b">
<p>PERFECT DAMPER 5G[パーフェクトダンパー5G]</p></div>
</div></div>
...
<div class="swiper-slide"><img src="../../item_img/10011_1.jpg" alt="PERFECT DAMPER 5G"></div>
<div class="swiper-slide"><img src="../../item_img/10011_2.jpg" alt="PERFECT DAMPER 5G"></div>
<div class="swiper-slide"><img src="../../item_img/10011_3.jpg" alt="PERFECT DAMPER 5G"></div>
</div>
...
<p>新設計のダンパー及びスプリングの採用で、さらに進化した次世代サスペンション。<br>路面に対して適切な設置圧により静寂性の向上しました。前後の揺れを最小限にすることで視界が安定し疲れづらい。道を選ばない滑らかで安定した乗り心地を実現。せっかくなら消耗品の交換もしたい方へ純正フロントアッパーマウント付もご用意。</p>
</div>
<div id="panel2" class="tab_panel">
<p>・全長調整式フルタップショック<br>・フロントアッパーマウントは純正流用<br>・減衰調整は前後とも15段ダイヤル調整式<br>・ショックには錆に強い特殊メッキコーティング<br>・フロントは複筒式正立ショック。<br>・リアは単筒式正立ショック<br>・NEWタイプのバルブでより安定した減衰力を発揮</p>
</div>
</div>
</div>
</div>
...
<div class="item_info_text_middle">
<p>AXIS STYLING [アクシススタイリング]</p>
</div>
<div class="item_info_text_middle_b">
<p>PERFECT DAMPER 5G [パーフェクトダンパー5G]</p>
</div>
<div class="tab_wrap">
...
<!--ココまでSP-->
<tr>
<p class="search_category">**********【適合検索】**********&nbsp;&nbsp;<a class="change_button" href="../../set/item/10011.php"><img src="../../img/set_button.jpg" alt="工賃セットの価格表はコチラ"></a></p>
</tr>
<tr>
<td>
<!-- 車両メーカー検索ココから -->
<p class="search_category">【自動車メーカー】</p>
<form method="post" action="10011.php">
...
if($data[0] == '10011') $position = explode(";", $data[1]);
}
array_pop($position);
fclose($fp_position);
...
<form name="make" method="post" action="10011.php">
