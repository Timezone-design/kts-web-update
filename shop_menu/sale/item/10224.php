...
<title>KTS-web 商品ラインナップ KYB Extage E-KIT</title>
...
<div class="mc_nav">
<a class="link" href="https://www.kts-web.com/">HOME</a> &gt; <a class="link" href="../../index.html">SHOP MENU</a> &gt; <a class="link" href="../../set/index.html">商品ラインナップ</a> &gt; <a class="link" href="../../set/cat/100.html">足回り</a> &gt; <a class="link" href="../../set/cat/119.html">サスペンションキット</a> &gt; <a class="link" href="../../set/br/1054-119.html">KYB</a> &gt; <a class="link" href="10224.php">Extage E-KIT</a></div>
<div class="space3px"></div>
<div class="set_sale_back">
<div class="space3px"></div>
<div class="set_menu_n">
<div class="set_menu_n_330">
<div><img src="../../brand/img/1054.gif" alt="Extage E-KIT"></div></div>
<div class="set_menu_n_cell">
<div class="item_info_text_middle">
<p>KYB[カヤバ]</p></div>
<div class="item_info_text_middle_b">
<p>商品名：Extage E-KIT[エクステージ Eキット]</p></div>
</div></div>
...
<div class="swiper-slide"><img src="../../item_img/10224_1.jpg" alt="Extage E-KIT"></div>
<div class="swiper-slide"><img src="../../item_img/10224_2.jpg" alt="Extage E-KIT"></div>
<div class="swiper-slide"><img src="../../item_img/10224_3.jpg" alt="Extage E-KIT"></div>
</div>
...
<p>ハイパワー化やボディー剛性の向上、高性能タイヤ装着、そしてサスペンションのチューニングと総合性能の進化が続くスペシャリティーカー。そんな新世代のクルマのためだけに開発されたプレミアムブランド「Extage」。ショックアブソーバだけの交換でも使用できますが、同時開発のExtageスプリングをセットで販売。</p>
</div>
<div id="panel2" class="tab_panel">
<p>・減衰力調整32段階<br>・Extageスプリングセット<br>・ワンランク上の乗り味<br>・車種専用セッティング</p>
</div>
</div>
</div>
</div>
...
<!--ココまでSP-->
<tr>
<p class="search_category">**********【適合検索】**********&nbsp;&nbsp;<a class="change_button" href="../../set/item/10224.php"><img src="../../img/set_button.jpg" alt="工賃セットの価格表はコチラ"></a></p>
</tr>
<tr>
<td>
<!-- 車両メーカー検索ココから -->
<p class="search_category">【自動車メーカー】</p>
<form method="post" action="10224.php">
...
if($data[0] == '10224') $position = explode(";", $data[1]);
}
array_pop($position);
fclose($fp_position);
...
<form name="make" method="post" action="10224.php">
