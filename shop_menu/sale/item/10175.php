...
<title>KTS-web 商品ラインナップ TANABE GT FUNTORIDE SPRING</title>
...
<div class="mc_nav">
<a class="link" href="https://www.kts-web.com/">HOME</a> &gt; <a class="link" href="../../index.html">SHOP MENU</a> &gt; <a class="link" href="../../set/index.html">商品ラインナップ</a> &gt; <a class="link" href="../../set/cat/100.html">足回り</a> &gt; <a class="link" href="../../set/cat/117.html">ダウンサス/アップサス</a> &gt; <a class="link" href="../../set/br/1095-117.html">TANABE</a> &gt; <a class="link" href="10175.php">GT FUNTORIDE SPRING</a></div>
<div class="space3px"></div>
<div class="set_sale_back">
<div class="space3px"></div>
<div class="set_menu_n">
<div class="set_menu_n_330">
<div><img src="../../brand/img/1095.gif" alt="GT FUNTORIDE SPRING"></div></div>
<div class="set_menu_n_cell">
<div class="item_info_text_middle">
<p>TANABE[タナベ]</p></div>
<div class="item_info_text_middle_b">
<p>商品名：GT FUNTORIDE SPRING[GTファントライド SPRING]</p></div>
</div></div>
...
<div class="swiper-slide"><img src="../../item_img/10175_1.jpg" alt="GT FUNTORIDE SPRING"></div>
<div class="swiper-slide"><img src="../../item_img/10175_2.jpg" alt="GT FUNTORIDE SPRING"></div>
<div class="swiper-slide"><img src="../../item_img/10175_3.jpg" alt="GT FUNTORIDE SPRING"></div>
</div>
...
<p>車がもっとキビキビ動く。走ることがこれまで以上に楽しくなる。<br>Super Formula・SUPER GTなどの1/100秒を競うレースに求められる精度は、1/100mm。そのノウハウ・高精度な技術を用いて、より乗り心地の良いスムーズなアシへ。それが「FUNTORIDE スプリング」のコンセプト。スポーツカー・チューニンググレードに向け、最適な「車高」「ストローク量」、そして「バネレート」を設計することで、さらにスポーツカーらしいハンドリングや安定感のあるコーナーリング特性に引き上げます。</p>
</div>
<div id="panel2" class="tab_panel">
<p>・スポーツカー/スポーツグレード専用<br>・へたり永久保証<br>・超軽量・超耐久性・超精密性<br>・引っ張り強度2100N/mm<br>・圧倒的に強い特殊塗装</p>
</div>
</div>
</div>
</div>
...
<div class="item_info_text_middle_b">
<p>GT FUNTORIDE SPRING [GTファントライド SPRING]</p>
</div>
<div class="tab_wrap">
...
<!--ココまでSP-->
<tr>
<p class="search_category">**********【適合検索】**********&nbsp;&nbsp;<a class="change_button" href="../../set/item/10175.php"><img src="../../img/set_button.jpg" alt="工賃セットの価格表はコチラ"></a></p>
</tr>
<tr>
<td>
<!-- 車両メーカー検索ココから -->
<p class="search_category">【自動車メーカー】</p>
<form method="post" action="10175.php">
...
if($data[0] == '10175') $position = explode(";", $data[1]);
}
array_pop($position);
fclose($fp_position);
...
<form name="make" method="post" action="10175.php">
