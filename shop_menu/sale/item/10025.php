...
<title>KTS-web 商品ラインナップ CUSCO 赤のStreet ZERO</title>
...
<div class="mc_nav">
<a class="link" href="https://www.kts-web.com/">HOME</a> &gt; <a class="link" href="../../index.html">SHOP MENU</a> &gt; <a class="link" href="../../set/index.html">商品ラインナップ</a> &gt; <a class="link" href="../../set/cat/100.html">足回り</a> &gt; <a class="link" href="../../set/cat/116.html">車高調/セッティングパーツ</a> &gt; <a class="link" href="../../set/br/1059-116.html">CUSCO</a> &gt; <a class="link" href="10025.php">赤のStreet ZERO</a></div>
<div class="space3px"></div>
<div class="set_sale_back">
<div class="space3px"></div>
<div class="set_menu_n">
<div class="set_menu_n_330">
<div><img src="../../brand/img/1059.gif" alt="赤のStreet ZERO"></div></div>
<div class="set_menu_n_cell">
<div class="item_info_text_middle">
<p>CUSCO[クスコ]</p></div>
<div class="item_info_text_middle_b">
<p>赤のStreet ZERO[赤のストリートゼロ]</p></div>
</div></div>
...
<div class="swiper-slide"><img src="../../item_img/10025_1.jpg" alt="赤のStreet ZERO"></div>
<div class="swiper-slide"><img src="../../item_img/10025_2.jpg" alt="赤のStreet ZERO"></div>
<div class="swiper-slide"><img src="../../item_img/10025_3.jpg" alt="赤のStreet ZERO"></div>
</div>
...
<p>全長調整式で乗り心地と走りのベストバランスを実現。設定車種のキャラクターに合わせ減衰力をベストセッティング。有効ストローク一定の「全長調整式」でローダウン量も思いのまま。複筒式ショックの採用で、マイルドな乗り心地と充分なストローク&車種別専用設計でローダウンしても十分なバンプストロークを確保しています。また、調整ネジ部には「ニッケルクロームメッキ処理」を採用し、サビや砂・ダストからしっかりガード。</p>
</div>
<div id="panel2" class="tab_panel">
<p>・減衰力固定式<br>・全長調整式車高調整<br>・車種ごとに強化ゴムアッパーマウント、アッパーマウントレスキットを設定<br>・フロントストラット形式に、キャンバー調整式ピロアッパーマウントを設定</p>
</div>
</div>
</div>
</div>
...
<!--ココまでSP-->
<tr>
<p class="search_category">**********【適合検索】**********&nbsp;&nbsp;<a class="change_button" href="../../set/item/10025.php"><img src="../../img/set_button.jpg" alt="工賃セットの価格表はコチラ"></a></p>
</tr>
<tr>
<td>
<!-- 車両メーカー検索ココから -->
<p class="search_category">【自動車メーカー】</p>
<form method="post" action="10025.php">
...
if($data[0] == '10025') $position = explode(";", $data[1]);
}
array_pop($position);
fclose($fp_position);
...
<form name="make" method="post" action="10025.php">
