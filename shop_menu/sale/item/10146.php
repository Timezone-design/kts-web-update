<html>
<head>
<meta name="description" content="デモカー、ショーモデル用に設定された超ローダウンサスタイプ(最低地上高を確保していませんので、一般道での走行は出来ません)。">
...
<title>KTS-web 商品ラインナップ RS★R RS☆R SUPER DOWN</title>
...
<div class="mc_nav">
<a class="link" href="https://www.kts-web.com/">HOME</a> &gt; <a class="link" href="../../index.html">SHOP MENU</a> &gt; <a class="link" href="../../set/index.html">商品ラインナップ</a> &gt; <a class="link" href="../../set/cat/100.html">足回り</a> &gt; <a class="link" href="../../set/cat/117.html">ダウンサス/アップサス</a> &gt; <a class="link" href="../../set/br/1001-117.html">RS★R</a> &gt; <a class="link" href="10146.php">RS☆R SUPER DOWN</a></div>
<div class="space3px"></div>
<div class="set_sale_back">
<div class="space3px"></div>
<div class="set_menu_n">
<div class="set_menu_n_330">
<div><img src="../../brand/img/1001.gif" alt="RS☆R SUPER DOWN"></div></div>
<div class="set_menu_n_cell">
<div class="item_info_text_middle">
<p>RS★R[アールエスアール]</p></div>
<div class="item_info_text_middle_b">
<p>商品名：RS☆R SUPER DOWN[RS-R スーパーダウン]</p></div>
</div></div>
...
<div class="swiper-slide"><img src="../../item_img/10146_1.jpg" alt="RS☆R SUPER DOWN"></div>
<div class="swiper-slide"><img src="../../item_img/10146_2.jpg" alt="RS☆R SUPER DOWN"></div>
<div class="swiper-slide"><img src="../../item_img/10146_3.jpg" alt="RS☆R SUPER DOWN"></div>
</div>
...
<p>デモカー、ショーモデル用に設定された超ローダウンサスタイプ(最低地上高を確保していませんので、一般道での走行は出来ません)。</p>
</div>
<div id="panel2" class="tab_panel">
<p>・ローダウンスプリング<br>・超ローダウンタイプ</p>
</div>
</div>
</div>
</div>
...
<div class="item_info_text_middle_b">
<p>RS☆R SUPER DOWN [RS-R スーパーダウン]</p>
</div>
<div class="tab_wrap">
...
<!--ココまでSP-->
<tr>
<p class="search_category">**********【適合検索】**********&nbsp;&nbsp;<a class="change_button" href="../../set/item/10146.php"><img src="../../img/set_button.jpg" alt="工賃セットの価格表はコチラ"></a></p>
</tr>
<tr>
<td>
<!-- 車両メーカー検索ココから -->
<p class="search_category">【自動車メーカー】</p>
<form method="post" action="10146.php">
...
if($data[0] == '10146') $position = explode(";", $data[1]);
}
array_pop($position);
fclose($fp_position);
...
<form name="make" method="post" action="10146.php">
