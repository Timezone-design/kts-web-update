<html>
<head>
<meta name="description" content="本製品はラルグス製車高調の補修部品です。※車種専用となります。">
...
<div class="mc_nav">
<a class="link" href="https://www.kts-web.com/">HOME</a> &gt; <a class="link" href="../../index.html">SHOP MENU</a> &gt; <a class="link" href="../../set/index.html">商品ラインナップ</a> &gt; <a class="link" href="../../set/cat/100.html">足回り</a> &gt; <a class="link" href="../../set/cat/116.html">車高調/セッティングパーツ</a> &gt; <a class="link" href="../../set/br/1156-116.html">LARGUS</a> &gt; <a class="link" href="10673.php">車高調整式直巻スプリングアダプター</a></div>
<div class="space3px"></div>
<div class="set_sale_back">
<div class="space3px"></div>
<div class="set_menu_n">
<div class="set_menu_n_330">
<div><img src="../../brand/img/1156.gif" alt="車高調整式直巻スプリングアダプター"></div></div>
<div class="set_menu_n_cell">
<div class="item_info_text_middle">
<p>LARGUS[ラルグス]</p></div>
<div class="item_info_text_middle_b">
<p>車高調整式直巻スプリングアダプター</p></div>
</div></div>
...
<div class="swiper-slide"><img src="../../item_img/10673_1.jpg" alt="車高調整式直巻スプリングアダプター"></div>
<div class="swiper-slide"><img src="../../item_img/10673_2.jpg" alt="車高調整式直巻スプリングアダプター"></div>
<div class="swiper-slide"><img src="../../item_img/10673_3.jpg" alt="車高調整式直巻スプリングアダプター"></div>
</div>
...
<p>本製品はラルグス製車高調の補修部品です。※車種専用となります。</p>
</div>
...
<!--ココまでSP-->
<tr>
<p class="search_category">**********【適合検索】**********&nbsp;&nbsp;<a class="change_button" href="../../set/item/10673.php"><img src="../../img/set_button.jpg" alt="工賃セットの価格表はコチラ"></a></p>
</tr>
<tr>
<td>
<!-- 車両メーカー検索ココから -->
<p class="search_category">【自動車メーカー】</p>
<form method="post" action="10673.php">
...
if($data[0] == '10673') $position = explode(";", $data[1]);
}
array_pop($position);
fclose($fp_position);
...
<form name="make" method="post" action="10673.php">
