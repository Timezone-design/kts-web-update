<html>
<head>
<meta name="description" content="過激に落ちる新車高調登場！まさに着地系車高調。<br>※フロントのみの販売です。">
...
<div class="mc_nav">
<a class="link" href="https://www.kts-web.com/">HOME</a> &gt; <a class="link" href="../../index.html">SHOP MENU</a> &gt; <a class="link" href="../../set/index.html">商品ラインナップ</a> &gt; <a class="link" href="../../set/cat/100.html">足回り</a> &gt; <a class="link" href="../../set/cat/116.html">車高調/セッティングパーツ</a> &gt; <a class="link" href="../../set/br/1182-116.html">LEON</a> &gt; <a class="link" href="10681.php">SUPER ULTRA MAX車高調</a></div>
<div class="space3px"></div>
<div class="set_sale_back">
<div class="space3px"></div>
<div class="set_menu_n">
<div class="set_menu_n_330">
<div><img src="../../brand/img/1182.gif" alt="SUPER ULTRA MAX車高調"></div></div>
<div class="set_menu_n_cell">
<div class="item_info_text_middle">
<p>LEON[レオン]</p></div>
<div class="item_info_text_middle_b">
<p>SUPER ULTRA MAX車高調</p></div>
</div></div>
...
<div class="swiper-slide"><img src="../../item_img/10681_1.jpg" alt="SUPER ULTRA MAX車高調"></div>
<div class="swiper-slide"><img src="../../item_img/10681_2.jpg" alt="SUPER ULTRA MAX車高調"></div>
<div class="swiper-slide"><img src="../../item_img/10681_3.jpg" alt="SUPER ULTRA MAX車高調"></div>
</div>
...
<p>過激に落ちる新車高調登場！まさに着地系車高調。<br>※フロントのみの販売です。</p>
</div>
<div id="panel2" class="tab_panel">
<p>※車高を極度に落とすために設計をした車高調になります。<br>※車両への装着確認はしていますが、細かいデータはありません。<br>※ノーマル車高にはなりません。 イベント＆競技用品としての販売となります。<br>※装着されているホイールなどによっては、干渉等が起こる場合があります。<br>※ご購入時には、製品の特徴を十分ご理解いただいた上での購入をお願いします。</p>
</div>
</div>
</div>
</div>
...
<!--ココまでSP-->
<tr>
<p class="search_category">**********【適合検索】**********&nbsp;&nbsp;<a class="change_button" href="../../set/item/10681.php"><img src="../../img/set_button.jpg" alt="工賃セットの価格表はコチラ"></a></p>
</tr>
<tr>
<td>
<!-- 車両メーカー検索ココから -->
<p class="search_category">【自動車メーカー】</p>
<form method="post" action="10681.php">
...
if($data[0] == '10681') $position = explode(";", $data[1]);
}
array_pop($position);
fclose($fp_position);
...
<form name="make" method="post" action="10681.php">
