<html>
<head>
<meta name="description" content="リアドラム車の方はブレーキパッドで制動力を変更することができません。エンドレスでは純正よりも効きをアップさせたサイドブレーキインナーシュー"TYPE-NA"をリリースしています。">
...
<div class="swiper-slide"><img src="../../item_img/10306_1.jpg" alt="TYPE-NA"></div>
<div class="swiper-slide"><img src="../../item_img/10306_2.jpg" alt="TYPE-NA"></div>
<div class="swiper-slide"><img src="../../item_img/10306_3.jpg" alt="TYPE-NA"></div>
</div>
...
<p>リアドラム車の方はブレーキパッドで制動力を変更することができません。エンドレスでは純正よりも効きをアップさせたサイドブレーキインナーシュー"TYPE-NA"をリリースしています。</p>
</div>
<div id="panel2" class="tab_panel">
<p>・材質:ノンアスベスト<br>・ドラムブレーキシュー</p>
</div>
</div>
</div>
</div>
...
<!--ココまでSP-->
<tr>
<p class="search_category">**********【適合検索】**********&nbsp;&nbsp;<a class="change_button" href="../../set/item/10306.php"><img src="../../img/set_button.jpg" alt="工賃セットの価格表はコチラ"></a></p>
</tr>
<tr>
<td>
<!-- 車両メーカー検索ココから -->
<p class="search_category">【自動車メーカー】</p>
<form method="post" action="10306.php">
...
if($data[0] == '10306') $position = explode(";", $data[1]);
}
array_pop($position);
fclose($fp_position);
...
<form name="make" method="post" action="10306.php">
