...
<title>KTS-web 商品ラインナップ RS★R Best☆i</title>
...
<div class="mc_nav">
<a class="link" href="https://www.kts-web.com/">HOME</a> &gt; <a class="link" href="../../index.html">SHOP MENU</a> &gt; <a class="link" href="../../set/index.html">商品ラインナップ</a> &gt; <a class="link" href="../../set/cat/100.html">足回り</a> &gt; <a class="link" href="../../set/cat/116.html">車高調/セッティングパーツ</a> &gt; <a class="link" href="../../set/br/1001-116.html">RS★R</a> &gt; <a class="link" href="10131.php">Best☆i</a></div>
<div class="space3px"></div>
<div class="set_sale_back">
<div class="space3px"></div>
<div class="set_menu_n">
<div class="set_menu_n_330">
<div><img src="../../brand/img/1001.gif" alt="Best☆i"></div></div>
<div class="set_menu_n_cell">
<div class="item_info_text_middle">
<p>RS★R[アールエスアール]</p></div>
<div class="item_info_text_middle_b">
<p>Best☆i[ベストアイ]</p></div>
</div></div>
...
<div class="swiper-slide"><img src="../../item_img/10131_1.jpg" alt="Best☆i"></div>
<div class="swiper-slide"><img src="../../item_img/10131_2.jpg" alt="Best☆i"></div>
<div class="swiper-slide"><img src="../../item_img/10131_3.jpg" alt="Best☆i"></div>
</div>
...
<p>フラッグシップモデルであるSuper☆iの開発で得られたノウハウや基本スペックを惜しみなく注ぎ込み開発された車高調。基本コンセプトやスペックはSuper☆iと同等としながらも、使用部品に量産品を用い、オイルもストリートユースで十分耐えうるレベルの物へと見直すなど、高品質を保ちつつ、よりお求め安い価格帯の製品となっています。</p>
</div>
<div id="panel2" class="tab_panel">
<p>・全長調整式<br>・減衰力36段調整<br>・単筒式<br>・Ti2000スプリング採用<br>・スチールアッパーマウント(一部車種を除く)<br>・ストリートユース向けオイル採用</p>
</div>
</div>
</div>
</div>
...
<!--ココまでSP-->
<tr>
<p class="search_category">**********【適合検索】**********&nbsp;&nbsp;<a class="change_button" href="../../set/item/10131.php"><img src="../../img/set_button.jpg" alt="工賃セットの価格表はコチラ"></a></p>
</tr>
<tr>
<td>
<!-- 車両メーカー検索ココから -->
<p class="search_category">【自動車メーカー】</p>
<form method="post" action="10131.php">
...
if($data[0] == '10131') $position = explode(";", $data[1]);
}
array_pop($position);
fclose($fp_position);
...
<form name="make" method="post" action="10131.php">
