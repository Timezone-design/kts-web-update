<html>
<head>
<meta name="description" content="【スポーツクラッチキット】<br>クラッチディスクと強化クラッチカバー、軽量フライホイール、レリーズベアリングまたは、CSC(コンセントリックスレーブシリンダー)をキット化したベーシックモデル。<br>スポーツクラッチディスク及びスポーツクラッチカバーの単品販売も行っています。">
...
<div class="mc_nav">
<a class="link" href="https://www.kts-web.com/">HOME</a> &gt; <a class="link" href="../../index.html">SHOP MENU</a> &gt; <a class="link" href="../../set/index.html">商品ラインナップ</a> &gt; <a class="link" href="../../set/cat/101.html">駆動系</a> &gt; <a class="link" href="../../set/cat/124.html">クラッチ/フライホイール</a> &gt; <a class="link" href="../../set/br/1122-124.html">nismo</a> &gt; <a class="link" href="10474.php">スポーツクラッチキット</a></div>
<div class="space3px"></div>
<div class="set_sale_back">
<div class="space3px"></div>
<div class="set_menu_n">
<div class="set_menu_n_330">
<div><img src="../../brand/img/1122.gif" alt="スポーツクラッチキット"></div></div>
...
<div class="swiper-slide"><img src="../../item_img/10474_1.jpg" alt="スポーツクラッチキット"></div>
<div class="swiper-slide"><img src="../../item_img/10474_2.jpg" alt="スポーツクラッチキット"></div>
<div class="swiper-slide"><img src="../../item_img/10474_3.jpg" alt="スポーツクラッチキット"></div>
</div>
...
<p>【スポーツクラッチキット】<br>クラッチディスクと強化クラッチカバー、軽量フライホイール、レリーズベアリングまたは、CSC(コンセントリックスレーブシリンダー)をキット化したベーシックモデル。<br>スポーツクラッチディスク及びスポーツクラッチカバーの単品販売も行っています。</p>
</div>
<div id="panel2" class="tab_panel">
<p>・スポーツクラッチディスク(カッパーミックス/ノンアス)<br>・スポーツクラッチカバー<br>・軽量フライホイール<br>・フライホイールボルト<br>・レリーズベアリング(日産純正部品)<br>・CSC(日産純正品)<br>※上記はキットのセット内容です。</p>
</div>
</div>
</div>
</div>
...
<!--ココまでSP-->
<tr>
<p class="search_category">**********【適合検索】**********&nbsp;&nbsp;<a class="change_button" href="../../set/item/10474.php"><img src="../../img/set_button.jpg" alt="工賃セットの価格表はコチラ"></a></p>
</tr>
<tr>
<td>
<!-- 車両メーカー検索ココから -->
<p class="search_category">【自動車メーカー】</p>
<form method="post" action="10474.php">
...
if($data[0] == '10474') $position = explode(";", $data[1]);
}
array_pop($position);
fclose($fp_position);
...
<form name="make" method="post" action="10474.php">
