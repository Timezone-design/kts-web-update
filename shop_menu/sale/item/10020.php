...
<title>KTS-web 商品ラインナップ CUSCO SPORT G</title>
...
<div class="mc_nav">
<a class="link" href="https://www.kts-web.com/">HOME</a> &gt; <a class="link" href="../../index.html">SHOP MENU</a> &gt; <a class="link" href="../../set/index.html">商品ラインナップ</a> &gt; <a class="link" href="../../set/cat/100.html">足回り</a> &gt; <a class="link" href="../../set/cat/116.html">車高調/セッティングパーツ</a> &gt; <a class="link" href="../../set/br/1059-116.html">CUSCO</a> &gt; <a class="link" href="10020.php">SPORT G</a></div>
<div class="space3px"></div>
<div class="set_sale_back">
<div class="space3px"></div>
<div class="set_menu_n">
<div class="set_menu_n_330">
<div><img src="../../brand/img/1059.gif" alt="SPORT G"></div></div>
<div class="set_menu_n_cell">
<div class="item_info_text_middle">
<p>CUSCO[クスコ]</p></div>
<div class="item_info_text_middle_b">
<p>SPORT G[スポーツG]</p></div>
</div></div>
...
<div class="swiper-slide"><img src="../../item_img/10020_1.jpg" alt="SPORT G"></div>
<div class="swiper-slide"><img src="../../item_img/10020_2.jpg" alt="SPORT G"></div>
<div class="swiper-slide"><img src="../../item_img/10020_3.jpg" alt="SPORT G"></div>
</div>
...
<p>ラリー・ダートラ・ジムカーナ等の競技専用完全受注生産モデル。ターマック競技用とグラベル競技用(ラリーはミックスやスノーも対応)の2種類を設定。各カテゴリーやレギュレーションに対応できるよう、ベースキットはアッパーマウント及びスプリングレス仕様。CUSCO製ピロアッパーマウントはもちろん、純正形状アッパーマウントやグラベル用ピロアッパーマウント等の選択が可能。各種競技や路面状況に合わせ、減衰力・ストローク等仕様変更可能なセミオーダーモデル。(変更内容により有料)<br>※この製品は競技専用品の為保証対象外となります。</p>
</div>
<div id="panel2" class="tab_panel">
<p>・新開発・全長調整式車高調整 単筒式大容量ショックアブソーバー。・新開発・高性能ニードルバルブ式 減衰力24段調整。・ラム式構造(ストラットタイプ)。・横G、ブレーキング時のGに威力を発揮する、高剛性ナックルブラケット。<br>※アッパーマウント、スプリングはキットに含まれません。<br>※JAF公認競技Nクラス向けに純正形状アッパーマウントに対応<br>※ピロアッパーマウントにも対応</p>
</div>
</div>
</div>
</div>
...
<!--ココまでSP-->
<tr>
<p class="search_category">**********【適合検索】**********&nbsp;&nbsp;<a class="change_button" href="../../set/item/10020.php"><img src="../../img/set_button.jpg" alt="工賃セットの価格表はコチラ"></a></p>
</tr>
<tr>
<td>
<!-- 車両メーカー検索ココから -->
<p class="search_category">【自動車メーカー】</p>
<form method="post" action="10020.php">
...
if($data[0] == '10020') $position = explode(";", $data[1]);
}
array_pop($position);
fclose($fp_position);
...
<form name="make" method="post" action="10020.php">
