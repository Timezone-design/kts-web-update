...
<title>KTS-web 商品ラインナップ TEIN HIGH.TECH</title>
...
<div class="mc_nav">
<a class="link" href="https://www.kts-web.com/">HOME</a> &gt; <a class="link" href="../../index.html">SHOP MENU</a> &gt; <a class="link" href="../../set/index.html">商品ラインナップ</a> &gt; <a class="link" href="../../set/cat/100.html">足回り</a> &gt; <a class="link" href="../../set/cat/117.html">ダウンサス/アップサス</a> &gt; <a class="link" href="../../set/br/1104-117.html">TEIN</a> &gt; <a class="link" href="10202.php">HIGH.TECH</a></div>
<div class="space3px"></div>
<div class="set_sale_back">
<div class="space3px"></div>
<div class="set_menu_n">
<div class="set_menu_n_330">
<div><img src="../../brand/img/1104.gif" alt="HIGH.TECH"></div></div>
<div class="set_menu_n_cell">
<div class="item_info_text_middle">
<p>TEIN[テイン]</p></div>
<div class="item_info_text_middle_b">
<p>商品名：HIGH.TECH[ハイテク]</p></div>
</div></div>
...
<div class="swiper-slide"><img src="../../item_img/10202_1.jpg" alt="HIGH.TECH"></div>
<div class="swiper-slide"><img src="../../item_img/10202_2.jpg" alt="HIGH.TECH"></div>
<div class="swiper-slide"><img src="../../item_img/10202_3.jpg" alt="HIGH.TECH"></div>
</div>
...
<p>ローダウンスプリングの決定版!!スタイリッシュ&コンフォータブル<br>後部座席評価を含めた実走行テストにて納得のいくまでセッティング。Gセンサー、ストロークセンサーといった計測器を使用し、あらゆる角度から快適性を追求。<br>※突き上げ感を低減するため、車種により純正バンプラバーの加工が必要な場合があります。</p>
</div>
<div id="panel2" class="tab_panel">
<p>・乗り心地保証<br>・異音保証<br>・へたり保証</p>
</div>
</div>
</div>
</div>
...
<!--ココまでSP-->
<tr>
<p class="search_category">**********【適合検索】**********&nbsp;&nbsp;<a class="change_button" href="../../set/item/10202.php"><img src="../../img/set_button.jpg" alt="工賃セットの価格表はコチラ"></a></p>
</tr>
<tr>
<td>
<!-- 車両メーカー検索ココから -->
<p class="search_category">【自動車メーカー】</p>
<form method="post" action="10202.php">
...
if($data[0] == '10202') $position = explode(";", $data[1]);
}
array_pop($position);
fclose($fp_position);
...
<form name="make" method="post" action="10202.php">
