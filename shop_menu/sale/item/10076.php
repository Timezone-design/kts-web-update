<html>
<head>
<meta name="description" content="ワインディングを気持ちよく走るスポーツモデル。ハイグリップラジアルタイヤを想定したスポーツの真骨頂ともいえるモデル。スポーツ走行で刻々と変化するタイヤインフォメーション、路面状況、トラクションを的確に補足し、ドライバーの直感に訴えるストレートなフィーリング。走りの本能を掻き立てる気持ちよさを追求したストリートスポーツモデルです。">
...
<title>KTS-web 商品ラインナップ HKS HIPERMAX IV SP</title>
...
<div class="mc_nav">
<a class="link" href="https://www.kts-web.com/">HOME</a> &gt; <a class="link" href="../../index.html">SHOP MENU</a> &gt; <a class="link" href="../../set/index.html">商品ラインナップ</a> &gt; <a class="link" href="../../set/cat/100.html">足回り</a> &gt; <a class="link" href="../../set/cat/116.html">車高調/セッティングパーツ</a> &gt; <a class="link" href="../../set/br/1032-116.html">HKS</a> &gt; <a class="link" href="10076.php">HIPERMAX IV SP</a></div>
<div class="space3px"></div>
<div class="set_sale_back">
<div class="space3px"></div>
<div class="set_menu_n">
<div class="set_menu_n_330">
<div><img src="../../brand/img/1032.gif" alt="HIPERMAX IV SP"></div></div>
<div class="set_menu_n_cell">
<div class="item_info_text_middle">
<p>HKS[エッチケーエス]</p></div>
<div class="item_info_text_middle_b">
<p>HIPERMAX IV SP[ハイパーマックス4 SP]</p></div>
</div></div>
...
<div class="swiper-slide"><img src="../../item_img/10076_1.jpg" alt="HIPERMAX IV SP"></div>
<div class="swiper-slide"><img src="../../item_img/10076_2.jpg" alt="HIPERMAX IV SP"></div>
<div class="swiper-slide"><img src="../../item_img/10076_3.jpg" alt="HIPERMAX IV SP"></div>
</div>
...
<p>ワインディングを気持ちよく走るスポーツモデル。ハイグリップラジアルタイヤを想定したスポーツの真骨頂ともいえるモデル。スポーツ走行で刻々と変化するタイヤインフォメーション、路面状況、トラクションを的確に補足し、ドライバーの直感に訴えるストレートなフィーリング。走りの本能を掻き立てる気持ちよさを追求したストリートスポーツモデルです。</p>
</div>
<div id="panel2" class="tab_panel">
<p>・単筒式<br>・減衰力30段階調整<br>・全長調整式<br>・専用スペシャルオイル<br>・PNEコート<br>・Mシャフト※正立式のみ<br>・アルミブラケット※一部車種除く<br>・ピロアッパーマウント<br>・倒立タイプ※ストラットタイプのみ<br>・オーバーホール可能<br>・2年4万キロ保証</p>
</div>
</div>
</div>
</div>
...
<div class="item_info_text_middle_b">
<p>HIPERMAX IV SP [ハイパーマックス4 SP]</p>
</div>
<div class="tab_wrap">
...
<!--ココまでSP-->
<tr>
<p class="search_category">**********【適合検索】**********&nbsp;&nbsp;<a class="change_button" href="../../set/item/10076.php"><img src="../../img/set_button.jpg" alt="工賃セットの価格表はコチラ"></a></p>
</tr>
<tr>
<td>
<!-- 車両メーカー検索ココから -->
<p class="search_category">【自動車メーカー】</p>
<form method="post" action="10076.php">
...
if($data[0] == '10076') $position = explode(";", $data[1]);
}
array_pop($position);
fclose($fp_position);
...
<form name="make" method="post" action="10076.php">
