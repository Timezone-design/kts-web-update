<html>
<head>
<meta name="description" content="STREETシリーズはストリートからサーキット走行向けへのアップグレード車高調ダンパーになり、運動性能を求める方にお勧めなモデル！価格もお客様がお求めやすい設定に。<br>街乗りからサーキット走行まで幅広く対応。日本の路面事情を考慮しスパイスを加えたMEGAN RACING車高調シリーズのベーシックモデルです。">
...
<title>KTS-web 商品ラインナップ MEGAN RACING Street</title>
...
<div class="mc_nav">
<a class="link" href="https://www.kts-web.com/">HOME</a> &gt; <a class="link" href="../../index.html">SHOP MENU</a> &gt; <a class="link" href="../../set/index.html">商品ラインナップ</a> &gt; <a class="link" href="../../set/cat/100.html">足回り</a> &gt; <a class="link" href="../../set/cat/116.html">車高調/セッティングパーツ</a> &gt; <a class="link" href="../../set/br/1181-116.html">MEGAN RACING</a> &gt; <a class="link" href="10678.php">Street</a></div>
<div class="space3px"></div>
<div class="set_sale_back">
<div class="space3px"></div>
<div class="set_menu_n">
<div class="set_menu_n_330">
<div><img src="../../brand/img/1181.gif" alt="Street"></div></div>
<div class="set_menu_n_cell">
<div class="item_info_text_middle">
<p>MEGAN RACING[メーガンレーシング]</p></div>
...
<div class="swiper-slide"><img src="../../item_img/10678_1.jpg" alt="Street"></div>
<div class="swiper-slide"><img src="../../item_img/10678_2.jpg" alt="Street"></div>
<div class="swiper-slide"><img src="../../item_img/10678_3.jpg" alt="Street"></div>
</div>
...
<p>STREETシリーズはストリートからサーキット走行向けへのアップグレード車高調ダンパーになり、運動性能を求める方にお勧めなモデル！価格もお客様がお求めやすい設定に。<br>街乗りからサーキット走行まで幅広く対応。日本の路面事情を考慮しスパイスを加えたMEGAN RACING車高調シリーズのベーシックモデルです。</p>
</div>
<div id="panel2" class="tab_panel">
<p>・全長調整(フルタップ)式<br>・減衰力32段調整<br>・アッパーマウント標準装備(一部車両を除く)<br>・ダストブーツ標準装備<br>・アルミ製ブラケット標準装備<br>・安心の1年保証<br>・単筒式(モノチューブ)ショックアブソーバー採用</p>
</div>
</div>
</div>
</div>
...
<!--ココまでSP-->
<tr>
<p class="search_category">**********【適合検索】**********&nbsp;&nbsp;<a class="change_button" href="../../set/item/10678.php"><img src="../../img/set_button.jpg" alt="工賃セットの価格表はコチラ"></a></p>
</tr>
<tr>
<td>
<!-- 車両メーカー検索ココから -->
<p class="search_category">【自動車メーカー】</p>
<form method="post" action="10678.php">
...
if($data[0] == '10678') $position = explode(";", $data[1]);
}
array_pop($position);
fclose($fp_position);
...
<form name="make" method="post" action="10678.php">
