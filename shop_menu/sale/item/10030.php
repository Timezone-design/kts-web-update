...
<title>KTS-web 商品ラインナップ CUSCO touring A</title>
...
<div class="mc_nav">
<a class="link" href="https://www.kts-web.com/">HOME</a> &gt; <a class="link" href="../../index.html">SHOP MENU</a> &gt; <a class="link" href="../../set/index.html">商品ラインナップ</a> &gt; <a class="link" href="../../set/cat/100.html">足回り</a> &gt; <a class="link" href="../../set/cat/118.html">ショックアブソーバー</a> &gt; <a class="link" href="../../set/br/1059-118.html">CUSCO</a> &gt; <a class="link" href="10030.php">touring A</a></div>
<div class="space3px"></div>
<div class="set_sale_back">
<div class="space3px"></div>
<div class="set_menu_n">
<div class="set_menu_n_330">
<div><img src="../../brand/img/1059.gif" alt="touring A"></div></div>
<div class="set_menu_n_cell">
<div class="item_info_text_middle">
<p>CUSCO[クスコ]</p></div>
<div class="item_info_text_middle_b">
<p>商品名：touring A[ツーリングA]</p></div>
</div></div>
...
<div class="swiper-slide"><img src="../../item_img/10030_1.jpg" alt="touring A"></div>
<div class="swiper-slide"><img src="../../item_img/10030_2.jpg" alt="touring A"></div>
<div class="swiper-slide"><img src="../../item_img/10030_3.jpg" alt="touring A"></div>
</div>
...
<p>純正形状 減衰力調整式ショックアブソーバー。乗車人数や状況に合わせ快適な乗り心地と乗り味のセッティングを可能になりますので、車高はそのままでシチュエーションに応じた乗り心地や乗り味を楽しみたい、純正ショックアブソーバーに物足りなさを感じる方にオススメです。</p>
</div>
<div id="panel2" class="tab_panel">
<p>・減衰力調整<br>・純正アッパーマウント・純正形状スプリング対応(一部車種除く)<br>・1年または1万㎞保障※ユーザー登録が必要です。</p>
</div>
</div>
</div>
</div>
...
<!--ココまでSP-->
<tr>
<p class="search_category">**********【適合検索】**********&nbsp;&nbsp;<a class="change_button" href="../../set/item/10030.php"><img src="../../img/set_button.jpg" alt="工賃セットの価格表はコチラ"></a></p>
</tr>
<tr>
<td>
<!-- 車両メーカー検索ココから -->
<p class="search_category">【自動車メーカー】</p>
<form method="post" action="10030.php">
...
if($data[0] == '10030') $position = explode(";", $data[1]);
}
array_pop($position);
fclose($fp_position);
...
<form name="make" method="post" action="10030.php">
