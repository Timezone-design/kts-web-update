...
<title>KTS-web 商品ラインナップ SHOWA COMFORT</title>
...
<div class="swiper-slide"><img src="../../item_img/10155_1.jpg" alt="COMFORT"></div>
<div class="swiper-slide"><img src="../../item_img/10155_2.jpg" alt="COMFORT"></div>
<div class="swiper-slide"><img src="../../item_img/10155_3.jpg" alt="COMFORT"></div>
</div>
...
<p>「猫脚」のように路面の突き上げをソフトに吸収しつつ、レーンチェンジでの不安感を取り除くことを目指しました。1つのサスペンションで、すべてのドライバーを満足させるサスペンションを造ることは困難ですが、ノーマルに対し「もっとソフトに、もっとしなやかに」と思っている人も多いはず。快適で、しかも応答性のいい、キビキビした走りを両立しています。</p>
</div>
...
<!--ココまでSP-->
<tr>
<p class="search_category">**********【適合検索】**********&nbsp;&nbsp;<a class="change_button" href="../../set/item/10155.php"><img src="../../img/set_button.jpg" alt="工賃セットの価格表はコチラ"></a></p>
</tr>
<tr>
<td>
<!-- 車両メーカー検索ココから -->
<p class="search_category">【自動車メーカー】</p>
<form method="post" action="10155.php">
...
if($data[0] == '10155') $position = explode(";", $data[1]);
}
array_pop($position);
fclose($fp_position);
...
<form name="make" method="post" action="10155.php">
