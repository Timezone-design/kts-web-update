...
<title>KTS-web 商品ラインナップ IDEAL ANY ONE</title>
...
<div class="mc_nav">
<a class="link" href="https://www.kts-web.com/">HOME</a> &gt; <a class="link" href="../../index.html">SHOP MENU</a> &gt; <a class="link" href="../../set/index.html">商品ラインナップ</a> &gt; <a class="link" href="../../set/cat/100.html">足回り</a> &gt; <a class="link" href="../../set/cat/116.html">車高調/セッティングパーツ</a> &gt; <a class="link" href="../../set/br/1012-116.html">IDEAL</a> &gt; <a class="link" href="10091.php">ANY ONE</a></div>
<div class="space3px"></div>
<div class="set_sale_back">
<div class="space3px"></div>
<div class="set_menu_n">
<div class="set_menu_n_330">
<div><img src="../../brand/img/1012.gif" alt="ANY ONE"></div></div>
<div class="set_menu_n_cell">
<div class="item_info_text_middle">
<p>IDEAL[イデアル]</p></div>
<div class="item_info_text_middle_b">
<p>ANY ONE[エニーワン]</p></div>
</div></div>
...
<div class="swiper-slide"><img src="../../item_img/10091_1.jpg" alt="ANY ONE"></div>
<div class="swiper-slide"><img src="../../item_img/10091_2.jpg" alt="ANY ONE"></div>
<div class="swiper-slide"><img src="../../item_img/10091_3.jpg" alt="ANY ONE"></div>
</div>
...
<p>24段階の減衰力調整を可能にし、コストパフォーマンスと機能を両立させた サスペンションキット。（一部リア26段階使用にしております。） 初めて車高調に挑戦するエントリーユーザーも 「ANY ONE」で間違いなし。そこにはIDEALの培った技術と経験が宿る。</p>
</div>
<div id="panel2" class="tab_panel">
<p>・全長調整式<br>・24段階減衰力調整機能<br>・アルミアッパーマウント<br>・ダストブーツ付属<br>・ハイレートスプリング仕様<br>・アルミスプリングシート&ロックシート</p>
</div>
</div>
</div>
</div>
...
<!--ココまでSP-->
<tr>
<p class="search_category">**********【適合検索】**********&nbsp;&nbsp;<a class="change_button" href="../../set/item/10091.php"><img src="../../img/set_button.jpg" alt="工賃セットの価格表はコチラ"></a></p>
</tr>
<tr>
<td>
<!-- 車両メーカー検索ココから -->
<p class="search_category">【自動車メーカー】</p>
<form method="post" action="10091.php">
...
if($data[0] == '10091') $position = explode(";", $data[1]);
}
array_pop($position);
fclose($fp_position);
...
<form name="make" method="post" action="10091.php">
