<html>
<head>
<meta name="description" content="「STEALTH 最上級モデル」単筒式の優れた放熱機能と大型ピストンを採用さまざまなシーンで安定した走行を可能とし、更に耐久性に優れたモデルです。ハイレートスプリングをセットしスーパーローダウンを可能としました。">
...
<title>KTS-web 商品ラインナップ FINAL KONNEXION STEALTH Complete Super Short Version</title>
...
{
@id: "/item/10065.php",
name: "STEALTH Complete Super Short Version"
}
}
]
}
...
<p>STEALTH Complete Super Short Version[ステルスコンプリート スーパーショートバージョン]</p></div>
</div></div>
...
<div class="swiper-slide"><img src="../../item_img/10065_1.jpg" alt="STEALTH Complete Super Short Version"></div>
<div class="swiper-slide"><img src="../../item_img/10065_2.jpg" alt="STEALTH Complete Super Short Version"></div>
<div class="swiper-slide"><img src="../../item_img/10065_3.jpg" alt="STEALTH Complete Super Short Version"></div>
</div>
...
<p>「STEALTH 最上級モデル」単筒式の優れた放熱機能と大型ピストンを採用さまざまなシーンで安定した走行を可能とし、更に耐久性に優れたモデルです。ハイレートスプリングをセットしスーパーローダウンを可能としました。</p>
</div>
<div id="panel2" class="tab_panel">
<p>・特別仕様<br>・減衰力30段調整式<br>・ピロボールアッパーマウント仕様<br>・スーパーショートストロークショック仕様<br>・ハイレートスプリング仕様<br>・スーパーローダウン仕様<br>・シリコン製 ダストブーツ<br>・車高調レンチ、製品証明書、オリジナルステッカー付属</p>
</div>
</div>
</div>
</div>
...
<div class="item_info_text_middle_b">
<p>STEALTH Complete Super Short Version [ステルスコンプリート スーパーショートバージョン]</p>
</div>
<div class="tab_wrap">
...
<!--ココまでSP-->
<tr>
<p class="search_category">**********【適合検索】**********&nbsp;&nbsp;<a class="change_button" href="../../set/item/10065.php"><img src="../../img/set_button.jpg" alt="工賃セットの価格表はコチラ"></a></p>
</tr>
<tr>
<td>
<!-- 車両メーカー検索ココから -->
<p class="search_category">【自動車メーカー】</p>
<form method="post" action="10065.php">
...
if($data[0] == '10065') $position = explode(";", $data[1]);
}
array_pop($position);
fclose($fp_position);
...
<form name="make" method="post" action="10065.php">
