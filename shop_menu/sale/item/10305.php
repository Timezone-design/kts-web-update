...
<div class="swiper-slide"><img src="../../item_img/10305_1.jpg" alt="Premium Compound"></div>
<div class="swiper-slide"><img src="../../item_img/10305_2.jpg" alt="Premium Compound"></div>
<div class="swiper-slide"><img src="../../item_img/10305_3.jpg" alt="Premium Compound"></div>
</div>
...
<div class="item_info_text_middle_b">
<p>Premium Compound [プレミアムコンパウンド]</p>
</div>
<div class="tab_wrap">
...
<!--ココまでSP-->
<tr>
<p class="search_category">**********【適合検索】**********&nbsp;&nbsp;<a class="change_button" href="../../set/item/10305.php"><img src="../../img/set_button.jpg" alt="工賃セットの価格表はコチラ"></a></p>
</tr>
<tr>
<td>
<!-- 車両メーカー検索ココから -->
<p class="search_category">【自動車メーカー】</p>
<form method="post" action="10305.php">
...
if($data[0] == '10305') $position = explode(";", $data[1]);
}
array_pop($position);
fclose($fp_position);
...
<form name="make" method="post" action="10305.php">
