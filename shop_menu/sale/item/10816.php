	              ...
	              <div class="set_sale_back">
	                ...
	                <div class="set_menu_n row">
	                  <div class="set_menu_n_330 col-md-6 col-sm-12 col-xs-12">
	                    <div><img alt="Super Turboマフラー" src="../../brand/img/1032.gif"/></div>
	                  </div>
	                  <div class="set_menu_n_cell col-md-6 col-sm-12 col-xs-12">
	                    <div class="item_info_text_middle"><p>HKS[エッチケーエス]</p></div><div class="item_info_text_middle_b"><p>Super Turboマフラー[スーパーターボ]</p></div>
	                  </div>
	                </div>
	                <div class="set_menu_n row">
	                  <div class="set_menu_n_330 col-md-6 col-sm-12 col-xs-12">
	                    <div>
	                      <div class="swiper-container"><div class="swiper-wrapper"><div class="swiper-slide"><img alt="Super Turboマフラー" src="../../item_img/10816_1.jpg"/></div><div class="swiper-slide"><img alt="Super Turboマフラー" src="../../item_img/10816_2.jpg"/></div><div class="swiper-slide"><img alt="Super Turboマフラー" src="../../item_img/10816_3.jpg"/></div></div><div class="swiper-button-prev"></div><div class="swiper-button-next"></div></div>
	                    </div>
	                    ...
	                    <div class="tab_wrap">
	                      ...
	                      <div class="tab-content">
	                        <div id="home" class="tab-pane fade in active show">
	                          <p>ターボエンジンを知り尽くしたHKSが挑んだ【低排圧】【静粛性】【エンジンを活かす】という3つのテーマ。<br/>ノーマルからアップグレードタービン仕様のハイパワー車輌まで対応可能。JASMA基準をクリアする街中での快適な静粛性<br/>・アクセルを踏み込むと搭載エンジンが持つ独特のサウンドを発生</p>
	                        </div>
	                ...
	                <table style="table-layout:fixed;" width="100%">
	                  <!--ココまでSP-->
	                  <tr>
	                    <p class="search_category">**********【商品検索】**********&nbsp;&nbsp;<a class="change_button" href="../../sale/item/10816.php"><img src="../../img/sale_button.jpg" alt="単品販売の価格表はコチラ"></a></p>
	                  </tr>
	                </table>
	                  <?php
	                  	$root_dir = __DIR__.'/../../..';
