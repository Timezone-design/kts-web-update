...
<div class="mc_nav">
<a class="link" href="https://www.kts-web.com/">HOME</a> &gt; <a class="link" href="../../index.html">SHOP MENU</a> &gt; <a class="link" href="../../set/index.html">商品ラインナップ</a> &gt; <a class="link" href="../../set/cat/100.html">足回り</a> &gt; <a class="link" href="../../set/cat/116.html">車高調/セッティングパーツ</a> &gt; <a class="link" href="../../set/br/1067-116.html">Genb(玄武)</a> &gt; <a class="link" href="10072.php">Height down block kit</a></div>
<div class="space3px"></div>
<div class="set_sale_back">
<div class="space3px"></div>
<div class="set_menu_n">
<div class="set_menu_n_330">
<div><img src="../../brand/img/1067.gif" alt="Height down block kit"></div></div>
<div class="set_menu_n_cell">
<div class="item_info_text_middle">
<p>Genb(玄武)[ゲンブ]</p></div>
<div class="item_info_text_middle_b">
<p>Height down block kit[ハイトダウンブロックキット]</p></div>
</div></div>
...
<div class="swiper-slide"><img src="../../item_img/10072_1.jpg" alt="Height down block kit"></div>
<div class="swiper-slide"><img src="../../item_img/10072_2.jpg" alt="Height down block kit"></div>
<div class="swiper-slide"><img src="../../item_img/10072_3.jpg" alt="Height down block kit"></div>
</div>
...
<p>多彩な機能を備えた、進化系ローダウンブロック!“ハイトダウンブロックキット”は、ハイエースをローダウンするうえで必要となるダウンブロックとUボルトのキットです。ブロック本体を多機能化することにより、従来製品では補えなかった欠点を完全に克服しました。​</p>
</div>
<div id="panel2" class="tab_panel">
<p>・ブロック本体：A6061アルミ押出材(切削加工後ショットブラスト+ブラックアルマイト)<br>・新開発「フィッティングコーン」<br>・強烈な保持力を誇る“サーフェスロックUボルト”<br>・アクスルガイドで正確に路面をトレース<br>・センタリング機能搭載<br>・0.5インチごとに7種類のサイズを設定</p>
</div>
</div>
</div>
</div>
...
<div class="item_info_text_middle_b">
<p>Height down block kit [ハイトダウンブロックキット]</p>
</div>
<div class="tab_wrap">
...
<!--ココまでSP-->
<tr>
<p class="search_category">**********【適合検索】**********&nbsp;&nbsp;<a class="change_button" href="../../set/item/10072.php"><img src="../../img/set_button.jpg" alt="工賃セットの価格表はコチラ"></a></p>
</tr>
<tr>
<td>
<!-- 車両メーカー検索ココから -->
<p class="search_category">【自動車メーカー】</p>
<form method="post" action="10072.php">
...
if($data[0] == '10072') $position = explode(";", $data[1]);
}
array_pop($position);
fclose($fp_position);
...
<form name="make" method="post" action="10072.php">
