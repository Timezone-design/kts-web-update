...
<title>KTS-web 商品ラインナップ RS★R Best☆i C&K</title>
...
<div class="mc_nav">
<a class="link" href="https://www.kts-web.com/">HOME</a> &gt; <a class="link" href="../../index.html">SHOP MENU</a> &gt; <a class="link" href="../../set/index.html">商品ラインナップ</a> &gt; <a class="link" href="../../set/cat/100.html">足回り</a> &gt; <a class="link" href="../../set/cat/116.html">車高調/セッティングパーツ</a> &gt; <a class="link" href="../../set/br/1001-116.html">RS★R</a> &gt; <a class="link" href="10135.php">Best☆i C&K</a></div>
<div class="space3px"></div>
<div class="set_sale_back">
<div class="space3px"></div>
<div class="set_menu_n">
<div class="set_menu_n_330">
<div><img src="../../brand/img/1001.gif" alt="Best☆i C&K"></div></div>
<div class="set_menu_n_cell">
<div class="item_info_text_middle">
<p>RS★R[アールエスアール]</p></div>
<div class="item_info_text_middle_b">
<p>Best☆i C&K[ベストアイ コンパクトカー＆Kカー]</p></div>
</div></div>
...
<div class="swiper-slide"><img src="../../item_img/10135_1.jpg" alt="Best☆i C&K"></div>
<div class="swiper-slide"><img src="../../item_img/10135_2.jpg" alt="Best☆i C&K"></div>
<div class="swiper-slide"><img src="../../item_img/10135_3.jpg" alt="Best☆i C&K"></div>
</div>
...
<p>「進化から生まれた『らしさ』へのこだわり」を開発コンセプトに、コンパクト&Kカー向けに専用設計された軽量でコンパクトなNewモデルです。 Best☆iで長年蓄積したノウハウをもとに、各構成パーツの改良や適正化を図り、新形状パーツを採用することにより、コンパクト&Kカーらしいハンドリング特性とスマートな乗り心地を実現。</p>
</div>
<div id="panel2" class="tab_panel">
<p>・全長調整式<br>・単筒式<br>・減衰力36段調整<br>・Ti2000スプリング採用<br>・スチールアッパーマウント(一部車種を除く)<br>・ストリートユース向けオイル採用<br>・乗り心地保証<br>・製品保証</p>
</div>
</div>
</div>
</div>
...
<div class="item_info_text_middle_b">
<p>Best☆i C&K [ベストアイ コンパクトカー＆Kカー]</p>
</div>
<div class="tab_wrap">
...
<!--ココまでSP-->
<tr>
<p class="search_category">**********【適合検索】**********&nbsp;&nbsp;<a class="change_button" href="../../set/item/10135.php"><img src="../../img/set_button.jpg" alt="工賃セットの価格表はコチラ"></a></p>
</tr>
<tr>
<td>
<!-- 車両メーカー検索ココから -->
<p class="search_category">【自動車メーカー】</p>
<form method="post" action="10135.php">
...
if($data[0] == '10135') $position = explode(";", $data[1]);
}
array_pop($position);
fclose($fp_position);
...
<form name="make" method="post" action="10135.php">
