<html>
<head>
<meta name="description" content="”走ることが楽しくなる”スーパーストリートスポーツモデル<br>街乗りではゴツゴツ感・フワフワ感を抑え、スポーツ走行時には、優れたステアリングレスポンスを発揮。">
...
<title>KTS-web 商品ラインナップ RACING GEAR ZX DAMPER</title>
...
<div class="mc_nav">
<a class="link" href="https://www.kts-web.com/">HOME</a> &gt; <a class="link" href="../../index.html">SHOP MENU</a> &gt; <a class="link" href="../../set/index.html">商品ラインナップ</a> &gt; <a class="link" href="../../set/cat/100.html">足回り</a> &gt; <a class="link" href="../../set/cat/116.html">車高調/セッティングパーツ</a> &gt; <a class="link" href="../../set/br/1159-116.html">RACING GEAR</a> &gt; <a class="link" href="10233.php">ZX DAMPER</a></div>
<div class="space3px"></div>
<div class="set_sale_back">
<div class="space3px"></div>
<div class="set_menu_n">
<div class="set_menu_n_330">
<div><img src="../../brand/img/1159.gif" alt="ZX DAMPER"></div></div>
<div class="set_menu_n_cell">
<div class="item_info_text_middle">
<p>RACING GEAR[レーシングギア]</p></div>
<div class="item_info_text_middle_b">
<p>商品名：ZX DAMPER[ZXダンパー]</p></div>
</div></div>
...
<div class="swiper-slide"><img src="../../item_img/10233_1.jpg" alt="ZX DAMPER"></div>
<div class="swiper-slide"><img src="../../item_img/10233_2.jpg" alt="ZX DAMPER"></div>
<div class="swiper-slide"><img src="../../item_img/10233_3.jpg" alt="ZX DAMPER"></div>
</div>
...
<p>”走ることが楽しくなる”スーパーストリートスポーツモデル<br>街乗りではゴツゴツ感・フワフワ感を抑え、スポーツ走行時には、優れたステアリングレスポンスを発揮。</p>
</div>
<div id="panel2" class="tab_panel">
<p>・単筒式<br>・倒立式(ストラットタイプのみ)<br>・減衰力16段調整式<br>・全長調整式<br>・ピロアッパーマウント(一部車種の除く)<br>・1年且つ2万キロ保証</p>
</div>
</div>
</div>
</div>
...
<div class="item_info_text_middle">
<p>RACING GEAR [レーシングギア]</p>
</div>
<div class="item_info_text_middle_b">
<p>ZX DAMPER [ZXダンパー]</p>
</div>
<div class="tab_wrap">
...
<!--ココまでSP-->
<tr>
<p class="search_category">**********【適合検索】**********&nbsp;&nbsp;<a class="change_button" href="../../set/item/10233.php"><img src="../../img/set_button.jpg" alt="工賃セットの価格表はコチラ"></a></p>
</tr>
<tr>
<td>
<!-- 車両メーカー検索ココから -->
<p class="search_category">【自動車メーカー】</p>
<form method="post" action="10233.php">
...
if($data[0] == '10233') $position = explode(";", $data[1]);
}
array_pop($position);
fclose($fp_position);
...
<form name="make" method="post" action="10233.php">
