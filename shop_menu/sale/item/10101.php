<html>
<head>
<meta name="description" content="ハイパワー化やボディー剛性の向上、高性能タイヤ装着、そしてサスペンションのチューニングと総合性能の進化が続くスペシャリティーカー。そんな新世代のクルマのためだけに開発されたプレミアムブランド「Extage」。クルマそれぞれの持つ性格とオーナーのかたがたの思いを想像しながら一車種ごと先進の技術と匠の技を注ぎ込み開発。">
...
<title>KTS-web 商品ラインナップ KYB Extage</title>
...
<div class="mc_nav">
<a class="link" href="https://www.kts-web.com/">HOME</a> &gt; <a class="link" href="../../index.html">SHOP MENU</a> &gt; <a class="link" href="../../set/index.html">商品ラインナップ</a> &gt; <a class="link" href="../../set/cat/100.html">足回り</a> &gt; <a class="link" href="../../set/cat/118.html">ショックアブソーバー</a> &gt; <a class="link" href="../../set/br/1054-118.html">KYB</a> &gt; <a class="link" href="10101.php">Extage</a></div>
<div class="space3px"></div>
<div class="set_sale_back">
<div class="space3px"></div>
<div class="set_menu_n">
<div class="set_menu_n_330">
<div><img src="../../brand/img/1054.gif" alt="Extage"></div></div>
<div class="set_menu_n_cell">
<div class="item_info_text_middle">
<p>KYB[カヤバ]</p></div>
<div class="item_info_text_middle_b">
<p>商品名：Extage[エクステージ]</p></div>
</div></div>
...
<div class="swiper-slide"><img src="../../item_img/10101_1.jpg" alt="Extage"></div>
<div class="swiper-slide"><img src="../../item_img/10101_2.jpg" alt="Extage"></div>
<div class="swiper-slide"><img src="../../item_img/10101_3.jpg" alt="Extage"></div>
</div>
...
<p>ハイパワー化やボディー剛性の向上、高性能タイヤ装着、そしてサスペンションのチューニングと総合性能の進化が続くスペシャリティーカー。そんな新世代のクルマのためだけに開発されたプレミアムブランド「Extage」。クルマそれぞれの持つ性格とオーナーのかたがたの思いを想像しながら一車種ごと先進の技術と匠の技を注ぎ込み開発。</p>
</div>
<div id="panel2" class="tab_panel">
<p>・減衰力調整32段階<br>・ワンランク上の乗り味<br>・車種専用セッティング</p>
</div>
</div>
</div>
</div>
...
<!--ココまでSP-->
<tr>
<p class="search_category">**********【適合検索】**********&nbsp;&nbsp;<a class="change_button" href="../../set/item/10101.php"><img src="../../img/set_button.jpg" alt="工賃セットの価格表はコチラ"></a></p>
</tr>
<tr>
<td>
<!-- 車両メーカー検索ココから -->
<p class="search_category">【自動車メーカー】</p>
<form method="post" action="10101.php">
...
if($data[0] == '10101') $position = explode(";", $data[1]);
}
array_pop($position);
fclose($fp_position);
...
<form name="make" method="post" action="10101.php">
