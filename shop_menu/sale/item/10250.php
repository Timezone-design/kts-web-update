<html>
<head>
<meta name="description" content="EVO Sサスペンションはあなたが望むスタンスを与えるだけでなく、ダイナミックでスポーティなハンドリング品質も提供します。車高を最大70mm下げることができ、純正ショックと比較して大幅なパフォーマンスアップを実現します。">
...
<title>KTS-web 商品ラインナップ BILSTEIN EVO S</title>
...
<div class="mc_nav">
<a class="link" href="https://www.kts-web.com/">HOME</a> &gt; <a class="link" href="../../index.html">SHOP MENU</a> &gt; <a class="link" href="../../set/index.html">商品ラインナップ</a> &gt; <a class="link" href="../../set/cat/100.html">足回り</a> &gt; <a class="link" href="../../set/cat/116.html">車高調/セッティングパーツ</a> &gt; <a class="link" href="../../set/br/1136-116.html">BILSTEIN</a> &gt; <a class="link" href="10250.php">EVO S</a></div>
<div class="space3px"></div>
<div class="set_sale_back">
<div class="space3px"></div>
<div class="set_menu_n">
<div class="set_menu_n_330">
<div><img src="../../brand/img/1136.gif" alt="EVO S"></div></div>
<div class="set_menu_n_cell">
<div class="item_info_text_middle">
<p>BILSTEIN[ビルシュタイン]</p></div>
<div class="item_info_text_middle_b">
<p>商品名：EVO S[エヴォS]</p></div>
</div></div>
...
<div class="swiper-slide"><img src="../../item_img/10250_1.jpg" alt="EVO S"></div>
<div class="swiper-slide"><img src="../../item_img/10250_2.jpg" alt="EVO S"></div>
<div class="swiper-slide"><img src="../../item_img/10250_3.jpg" alt="EVO S"></div>
</div>
...
<p>EVO Sサスペンションはあなたが望むスタンスを与えるだけでなく、ダイナミックでスポーティなハンドリング品質も提供します。車高を最大70mm下げることができ、純正ショックと比較して大幅なパフォーマンスアップを実現します。</p>
</div>
<div id="panel2" class="tab_panel">
<p>・車高調整：車高を最大70mmダウン<br>・スポーティなダンパーセッティング</p>
</div>
</div>
</div>
</div>
...
<!--ココまでSP-->
<tr>
<p class="search_category">**********【適合検索】**********&nbsp;&nbsp;<a class="change_button" href="../../set/item/10250.php"><img src="../../img/set_button.jpg" alt="工賃セットの価格表はコチラ"></a></p>
</tr>
<tr>
<td>
<!-- 車両メーカー検索ココから -->
<p class="search_category">【自動車メーカー】</p>
<form method="post" action="10250.php">
...
if($data[0] == '10250') $position = explode(";", $data[1]);
}
array_pop($position);
fclose($fp_position);
...
<form name="make" method="post" action="10250.php">
