...
<div class="swiper-slide"><img src="../../item_img/10570_1.jpg" alt="ルームバー"></div>
<div class="swiper-slide"><img src="../../item_img/10570_2.jpg" alt="ルームバー"></div>
<div class="swiper-slide"><img src="../../item_img/10570_3.jpg" alt="ルームバー"></div>
</div>
...
<!--ココまでSP-->
<tr>
<p class="search_category">**********【適合検索】**********&nbsp;&nbsp;<a class="change_button" href="../../set/item/10570.php"><img src="../../img/set_button.jpg" alt="工賃セットの価格表はコチラ"></a></p>
</tr>
<tr>
<td>
<!-- 車両メーカー検索ココから -->
<p class="search_category">【自動車メーカー】</p>
<form method="post" action="10570.php">
...
if($data[0] == '10570') $position = explode(";", $data[1]);
}
array_pop($position);
fclose($fp_position);
...
<form name="make" method="post" action="10570.php">
