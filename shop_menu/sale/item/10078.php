...
<title>KTS-web 商品ラインナップ HKS HIPERMAX IV GT 20 SPEC</title>
...
<div class="mc_nav">
<a class="link" href="https://www.kts-web.com/">HOME</a> &gt; <a class="link" href="../../index.html">SHOP MENU</a> &gt; <a class="link" href="../../set/index.html">商品ラインナップ</a> &gt; <a class="link" href="../../set/cat/100.html">足回り</a> &gt; <a class="link" href="../../set/cat/116.html">車高調/セッティングパーツ</a> &gt; <a class="link" href="../../set/br/1032-116.html">HKS</a> &gt; <a class="link" href="10078.php">HIPERMAX IV GT 20 SPEC</a></div>
<div class="space3px"></div>
<div class="set_sale_back">
<div class="space3px"></div>
<div class="set_menu_n">
<div class="set_menu_n_330">
<div><img src="../../brand/img/1032.gif" alt="HIPERMAX IV GT 20 SPEC"></div></div>
<div class="set_menu_n_cell">
<div class="item_info_text_middle">
<p>HKS[エッチケーエス]</p></div>
<div class="item_info_text_middle_b">
<p>HIPERMAX IV GT 20 SPEC[ハイパーマックス4 GT 20スペック]</p></div>
</div></div>
...
<div class="swiper-slide"><img src="../../item_img/10078_1.jpg" alt="HIPERMAX IV GT 20 SPEC"></div>
<div class="swiper-slide"><img src="../../item_img/10078_2.jpg" alt="HIPERMAX IV GT 20 SPEC"></div>
<div class="swiper-slide"><img src="../../item_img/10078_3.jpg" alt="HIPERMAX IV GT 20 SPEC"></div>
</div>
...
<p>ハンドリング性能やストリートでの乗り心地のバランスに優れたMAX IV GTを最新技術でリセッティング。MAX IV GTをベースに最新のセッティング技術を投入。安定性と快適性をさらに向上させ走りの質感を進化させました。ストリートでの走る楽しさやスポーツ性と乗り心地の高次元での両立を追求される方にお薦めのサスペンションキットです。</p>
</div>
<div id="panel2" class="tab_panel">
<p>・単筒式<br>・減衰力30段階調整<br>・全長調整式<br>・専用スペシャルオイル<br>・PNEコート<br>・M4P<br>・プリロードバルブシステム<br>・アルミブラケット※一部車種除く<br>・強化ゴムアッパーマウント<br>・倒立タイプ※ストラットタイプのみ<br>・オーバーホール可能<br>・2年4万キロ保証</p>
</div>
</div>
</div>
</div>
...
<div class="item_info_text_middle_b">
<p>HIPERMAX IV GT 20 SPEC [ハイパーマックス4 GT 20スペック]</p>
</div>
<div class="tab_wrap">
...
<!--ココまでSP-->
<tr>
<p class="search_category">**********【適合検索】**********&nbsp;&nbsp;<a class="change_button" href="../../set/item/10078.php"><img src="../../img/set_button.jpg" alt="工賃セットの価格表はコチラ"></a></p>
</tr>
<tr>
<td>
<!-- 車両メーカー検索ココから -->
<p class="search_category">【自動車メーカー】</p>
<form method="post" action="10078.php">
...
if($data[0] == '10078') $position = explode(";", $data[1]);
}
array_pop($position);
fclose($fp_position);
...
<form name="make" method="post" action="10078.php">
