<html>
<head>
<meta name="description" content="トーアウトの発生による走行抵抗を抑え、直進性の向上<br>コーナー進入時のトー変化を抑え、ステアリングレスポンス大幅アップ。ハードブレーキング時のタイヤブレーク防止。">
...
<div class="mc_nav">
<a class="link" href="https://www.kts-web.com/">HOME</a> &gt; <a class="link" href="../../index.html">SHOP MENU</a> &gt; <a class="link" href="../../set/index.html">商品ラインナップ</a> &gt; <a class="link" href="../../set/cat/100.html">足回り</a> &gt; <a class="link" href="../../set/cat/120.html">ロッド/アーム/リンク類</a> &gt; <a class="link" href="../../set/br/1059-120.html">CUSCO</a> &gt; <a class="link" href="10536.php">ピロボールテンションロッド</a></div>
<div class="space3px"></div>
<div class="set_sale_back">
<div class="space3px"></div>
<div class="set_menu_n">
<div class="set_menu_n_330">
<div><img src="../../brand/img/1059.gif" alt="ピロボールテンションロッド"></div></div>
<div class="set_menu_n_cell">
<div class="item_info_text_middle">
<p>CUSCO[クスコ]</p></div>
<div class="item_info_text_middle_b">
<p>ピロボールテンションロッド</p></div>
</div></div>
...
<div class="swiper-slide"><img src="../../item_img/10536_1.jpg" alt="ピロボールテンションロッド"></div>
<div class="swiper-slide"><img src="../../item_img/10536_2.jpg" alt="ピロボールテンションロッド"></div>
<div class="swiper-slide"><img src="../../item_img/10536_3.jpg" alt="ピロボールテンションロッド"></div>
</div>
...
<p>トーアウトの発生による走行抵抗を抑え、直進性の向上<br>コーナー進入時のトー変化を抑え、ステアリングレスポンス大幅アップ。ハードブレーキング時のタイヤブレーク防止。</p>
</div>
<div id="panel2" class="tab_panel">
<p>・ボディ側ピロボール<br>・ターンバックル式<br>・設定：フロント<br>ボルトオン装着</p>
</div>
</div>
</div>
</div>
...
<!--ココまでSP-->
<tr>
<p class="search_category">**********【適合検索】**********&nbsp;&nbsp;<a class="change_button" href="../../set/item/10536.php"><img src="../../img/set_button.jpg" alt="工賃セットの価格表はコチラ"></a></p>
</tr>
<tr>
<td>
<!-- 車両メーカー検索ココから -->
<p class="search_category">【自動車メーカー】</p>
<form method="post" action="10536.php">
...
if($data[0] == '10536') $position = explode(";", $data[1]);
}
array_pop($position);
fclose($fp_position);
...
<form name="make" method="post" action="10536.php">
