<html>
<head>
<meta name="description" content="Lowfer Sportsは純正形状ローダウンスプリングと組み合わせ使用できるよう専用設計されたショックアブソーバです。純正形状、減衰力固定式採用、ローダウンスプリングと専用チューニングのショックアブソーバにより快適で安定したフットワークとスタイリッシュなローダウンフォルムを演出します。">
...
<title>KTS-web 商品ラインナップ KYB Lowfer Sports L-KIT</title>
...
<div class="mc_nav">
<a class="link" href="https://www.kts-web.com/">HOME</a> &gt; <a class="link" href="../../index.html">SHOP MENU</a> &gt; <a class="link" href="../../set/index.html">商品ラインナップ</a> &gt; <a class="link" href="../../set/cat/100.html">足回り</a> &gt; <a class="link" href="../../set/cat/119.html">サスペンションキット</a> &gt; <a class="link" href="../../set/br/1054-119.html">KYB</a> &gt; <a class="link" href="10103.php">Lowfer Sports L-KIT</a></div>
<div class="space3px"></div>
<div class="set_sale_back">
<div class="space3px"></div>
<div class="set_menu_n">
<div class="set_menu_n_330">
<div><img src="../../brand/img/1054.gif" alt="Lowfer Sports L-KIT"></div></div>
<div class="set_menu_n_cell">
<div class="item_info_text_middle">
<p>KYB[カヤバ]</p></div>
<div class="item_info_text_middle_b">
<p>商品名：Lowfer Sports L-KIT[ローファースポーツ Lキット]</p></div>
</div></div>
...
<div class="swiper-slide"><img src="../../item_img/10103_1.jpg" alt="Lowfer Sports L-KIT"></div>
<div class="swiper-slide"><img src="../../item_img/10103_2.jpg" alt="Lowfer Sports L-KIT"></div>
<div class="swiper-slide"><img src="../../item_img/10103_3.jpg" alt="Lowfer Sports L-KIT"></div>
</div>
...
<p>Lowfer Sportsは純正形状ローダウンスプリングと組み合わせ使用できるよう専用設計されたショックアブソーバです。純正形状、減衰力固定式採用、ローダウンスプリングと専用チューニングのショックアブソーバにより快適で安定したフットワークとスタイリッシュなローダウンフォルムを演出します。</p>
</div>
<div id="panel2" class="tab_panel">
<p>・純正形状<br>・ローダウンストローク専用設計<br>・減衰力固定式<br>・スプリングセット</p>
</div>
</div>
</div>
</div>
...
<div class="item_info_text_middle_b">
<p>Lowfer Sports L-KIT [ローファースポーツ Lキット]</p>
</div>
<div class="tab_wrap">
...
<!--ココまでSP-->
<tr>
<p class="search_category">**********【適合検索】**********&nbsp;&nbsp;<a class="change_button" href="../../set/item/10103.php"><img src="../../img/set_button.jpg" alt="工賃セットの価格表はコチラ"></a></p>
</tr>
<tr>
<td>
<!-- 車両メーカー検索ココから -->
<p class="search_category">【自動車メーカー】</p>
<form method="post" action="10103.php">
...
if($data[0] == '10103') $position = explode(";", $data[1]);
}
array_pop($position);
fclose($fp_position);
...
<form name="make" method="post" action="10103.php">
