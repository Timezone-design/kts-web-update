...
<title>KTS-web 商品ラインナップ HKS HIPERMAX S-style X</title>
...
<div class="mc_nav">
<a class="link" href="https://www.kts-web.com/">HOME</a> &gt; <a class="link" href="../../index.html">SHOP MENU</a> &gt; <a class="link" href="../../set/index.html">商品ラインナップ</a> &gt; <a class="link" href="../../set/cat/100.html">足回り</a> &gt; <a class="link" href="../../set/cat/116.html">車高調/セッティングパーツ</a> &gt; <a class="link" href="../../set/br/1032-116.html">HKS</a> &gt; <a class="link" href="10084.php">HIPERMAX S-style X</a></div>
<div class="space3px"></div>
<div class="set_sale_back">
<div class="space3px"></div>
<div class="set_menu_n">
<div class="set_menu_n_330">
<div><img src="../../brand/img/1032.gif" alt="HIPERMAX S-style X"></div></div>
<div class="set_menu_n_cell">
<div class="item_info_text_middle">
<p>HKS[エッチケーエス]</p></div>
<div class="item_info_text_middle_b">
<p>HIPERMAX S-style X[ハイパーマックス Sスタイル X]</p></div>
</div></div>
...
<div class="swiper-slide"><img src="../../item_img/10084_1.jpg" alt="HIPERMAX S-style X"></div>
<div class="swiper-slide"><img src="../../item_img/10084_2.jpg" alt="HIPERMAX S-style X"></div>
<div class="swiper-slide"><img src="../../item_img/10084_3.jpg" alt="HIPERMAX S-style X"></div>
</div>
...
<p>ただ低いだけではない。安定した走りをも実現する熟成のスーパーローダウンモデル。究極までスタイルを追求したこのモデルは、「人と同じではつまらないしライバルにも差を付けたい」といった、カスタム上級者やドレスアップコンテストで上位を狙うような方をターゲットとして開発を行いました。もちろんただ低いだけのサスペンションキットではなく、HIPERMAXシリーズ伝統の安定した走りを実現します。</p>
</div>
<div id="panel2" class="tab_panel">
<p>・単筒式<br>・減衰力30段階調整<br>・全長調整式<br>・専用スペシャルオイル<br>・PNEコート<br>・直巻きショートスプリング<br>・倒立タイプ※ストラットタイプのみ<br>・仕様変更可<br>・オーバーホール可<br>・1年2万キロ保証</p>
</div>
</div>
</div>
</div>
...
<div class="item_info_text_middle_b">
<p>HIPERMAX S-style X [ハイパーマックス Sスタイル X]</p>
</div>
<div class="tab_wrap">
...
<!--ココまでSP-->
<tr>
<p class="search_category">**********【適合検索】**********&nbsp;&nbsp;<a class="change_button" href="../../set/item/10084.php"><img src="../../img/set_button.jpg" alt="工賃セットの価格表はコチラ"></a></p>
</tr>
<tr>
<td>
<!-- 車両メーカー検索ココから -->
<p class="search_category">【自動車メーカー】</p>
<form method="post" action="10084.php">
...
if($data[0] == '10084') $position = explode(";", $data[1]);
}
array_pop($position);
fclose($fp_position);
...
<form name="make" method="post" action="10084.php">
