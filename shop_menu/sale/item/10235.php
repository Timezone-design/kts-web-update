...
<title>KTS-web 商品ラインナップ RACING GEAR LOWFORM REVOLUTION</title>
...
<div class="mc_nav">
<a class="link" href="https://www.kts-web.com/">HOME</a> &gt; <a class="link" href="../../index.html">SHOP MENU</a> &gt; <a class="link" href="../../set/index.html">商品ラインナップ</a> &gt; <a class="link" href="../../set/cat/100.html">足回り</a> &gt; <a class="link" href="../../set/cat/117.html">ダウンサス/アップサス</a> &gt; <a class="link" href="../../set/br/1159-117.html">RACING GEAR</a> &gt; <a class="link" href="10235.php">LOWFORM REVOLUTION</a></div>
<div class="space3px"></div>
<div class="set_sale_back">
<div class="space3px"></div>
<div class="set_menu_n">
<div class="set_menu_n_330">
<div><img src="../../brand/img/1159.gif" alt="LOWFORM REVOLUTION"></div></div>
<div class="set_menu_n_cell">
<div class="item_info_text_middle">
<p>RACING GEAR[レーシングギア]</p></div>
<div class="item_info_text_middle_b">
<p>商品名：LOWFORM REVOLUTION[ローフォルムレボリューション]</p></div>
</div></div>
...
<div class="swiper-slide"><img src="../../item_img/10235_1.jpg" alt="LOWFORM REVOLUTION"></div>
<div class="swiper-slide"><img src="../../item_img/10235_2.jpg" alt="LOWFORM REVOLUTION"></div>
<div class="swiper-slide"><img src="../../item_img/10235_3.jpg" alt="LOWFORM REVOLUTION"></div>
</div>
...
<p>セダンやミニバン、軽自動車それぞれにハンドリング性能を高めつつ、乗り心地を最重視するセッティングを施しています。また、バネレートはノーマルに比べ15％アップまでに抑え、乗り心地に反映させています。スポーツ系はハンドリングのシャープさを、フォーマル系では乗り心地を重視しました。フロント、リア共に荷重に応じた最適なバネレートセッティングを施しています。 </p>
</div>
<div id="panel2" class="tab_panel">
<p>・最高級素材(SAE9254及びSWOSC-B)使用<br>・3年間5万キロ保証</p>
</div>
</div>
</div>
</div>
...
<div class="item_info_text_middle_b">
<p>LOWFORM REVOLUTION [ローフォルムレボリューション]</p>
</div>
<div class="tab_wrap">
...
<!--ココまでSP-->
<tr>
<p class="search_category">**********【適合検索】**********&nbsp;&nbsp;<a class="change_button" href="../../set/item/10235.php"><img src="../../img/set_button.jpg" alt="工賃セットの価格表はコチラ"></a></p>
</tr>
<tr>
<td>
<!-- 車両メーカー検索ココから -->
<p class="search_category">【自動車メーカー】</p>
<form method="post" action="10235.php">
...
if($data[0] == '10235') $position = explode(";", $data[1]);
}
array_pop($position);
fclose($fp_position);
...
<form name="make" method="post" action="10235.php">
