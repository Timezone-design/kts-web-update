...
<div class="mc_nav">
<a class="link" href="https://www.kts-web.com/">HOME</a> &gt; <a class="link" href="../../index.html">SHOP MENU</a> &gt; <a class="link" href="../../set/index.html">商品ラインナップ</a> &gt; <a class="link" href="../../set/cat/100.html">足回り</a> &gt; <a class="link" href="../../set/cat/117.html">ダウンサス/アップサス</a> &gt; <a class="link" href="../../set/br/1078-117.html">JIC MAGIC</a> &gt; <a class="link" href="10093.php">Area35-Black</a></div>
<div class="space3px"></div>
<div class="set_sale_back">
<div class="space3px"></div>
<div class="set_menu_n">
<div class="set_menu_n_330">
<div><img src="../../brand/img/1078.gif" alt="Area35-Black"></div></div>
<div class="set_menu_n_cell">
<div class="item_info_text_middle">
<p>JIC MAGIC[ジェイアイシーマジック]</p></div>
<div class="item_info_text_middle_b">
<p>商品名：Area35-Black[エリア35 ブラック]</p></div>
</div></div>
...
<div class="swiper-slide"><img src="../../item_img/10093_1.jpg" alt="Area35-Black"></div>
<div class="swiper-slide"><img src="../../item_img/10093_2.jpg" alt="Area35-Black"></div>
<div class="swiper-slide"><img src="../../item_img/10093_3.jpg" alt="Area35-Black"></div>
</div>
...
<p>「Area35 リフトアップサス」に降雪/海沿い仕様として「Area35-Black」を追加。<br>冬季に、凍結防止剤/融雪剤等を使用する雪国や沿岸地域からのご要望に、錆び・腐食対策として新しく導入。<br>一般塗装の1.5倍(当社仕様塗装比)の防腐・耐久性を持つパーカー処理塗装(腐食防止塗装)を施し、塗装剥がれ・錆び・腐食折れをより長期間防ぐことができます。</p>
</div>
<div id="panel2" class="tab_panel">
<p>・リフトアップサスペンション<br>・上げ幅：30-45mm(車種により異なります)<br>・パーカー処理塗装(腐食防止塗装)</p>
</div>
</div>
</div>
</div>
...
<!--ココまでSP-->
<tr>
<p class="search_category">**********【適合検索】**********&nbsp;&nbsp;<a class="change_button" href="../../set/item/10093.php"><img src="../../img/set_button.jpg" alt="工賃セットの価格表はコチラ"></a></p>
</tr>
<tr>
<td>
<!-- 車両メーカー検索ココから -->
<p class="search_category">【自動車メーカー】</p>
<form method="post" action="10093.php">
...
if($data[0] == '10093') $position = explode(";", $data[1]);
}
array_pop($position);
fclose($fp_position);
...
<form name="make" method="post" action="10093.php">
