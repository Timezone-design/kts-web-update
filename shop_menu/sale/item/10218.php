<html>
<head>
<meta name="description" content="XYZレーシング史上最高峰に位置する「サーキットマスター」はレース・ドリフト・ターマックラリーのコンペティションモデルとして長い時間をかけて開発されました。レースシーンでのあらゆるニーズにこたえることが出来ます。ストリートでの使用には適していません。">
...
<title>KTS-web 商品ラインナップ XYZ JAPAN CM</title>
...
<div class="mc_nav">
<a class="link" href="https://www.kts-web.com/">HOME</a> &gt; <a class="link" href="../../index.html">SHOP MENU</a> &gt; <a class="link" href="../../set/index.html">商品ラインナップ</a> &gt; <a class="link" href="../../set/cat/100.html">足回り</a> &gt; <a class="link" href="../../set/cat/116.html">車高調/セッティングパーツ</a> &gt; <a class="link" href="../../set/br/1031-116.html">XYZ JAPAN</a> &gt; <a class="link" href="10218.php">CM</a></div>
<div class="space3px"></div>
<div class="set_sale_back">
<div class="space3px"></div>
<div class="set_menu_n">
<div class="set_menu_n_330">
<div><img src="../../brand/img/1031.gif" alt="CM"></div></div>
<div class="set_menu_n_cell">
<div class="item_info_text_middle">
<p>XYZ JAPAN[エックスワイゼット]</p></div>
<div class="item_info_text_middle_b">
<p>CM[サーキットマスター]</p></div>
</div></div>
...
<div class="swiper-slide"><img src="../../item_img/10218_1.jpg" alt="CM"></div>
<div class="swiper-slide"><img src="../../item_img/10218_2.jpg" alt="CM"></div>
<div class="swiper-slide"><img src="../../item_img/10218_3.jpg" alt="CM"></div>
</div>
...
<p>XYZレーシング史上最高峰に位置する「サーキットマスター」はレース・ドリフト・ターマックラリーのコンペティションモデルとして長い時間をかけて開発されました。レースシーンでのあらゆるニーズにこたえることが出来ます。ストリートでの使用には適していません。</p>
</div>
<div id="panel2" class="tab_panel">
<p>・競技専用の最高峰モデル<br>・フルタップ全長調整式<br>・減衰力3way調整<br>・単筒式モノチューブ構造<br>・ダブルダンピングピストン<br>・耐食・防錆フッ素コーティング</p>
</div>
</div>
</div>
</div>
...
<!--ココまでSP-->
<tr>
<p class="search_category">**********【適合検索】**********&nbsp;&nbsp;<a class="change_button" href="../../set/item/10218.php"><img src="../../img/set_button.jpg" alt="工賃セットの価格表はコチラ"></a></p>
</tr>
<tr>
<td>
<!-- 車両メーカー検索ココから -->
<p class="search_category">【自動車メーカー】</p>
<form method="post" action="10218.php">
...
if($data[0] == '10218') $position = explode(";", $data[1]);
}
array_pop($position);
fclose($fp_position);
...
<form name="make" method="post" action="10218.php">
