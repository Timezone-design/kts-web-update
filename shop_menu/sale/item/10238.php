<html>
<head>
<meta name="description" content="貴方が今のクルマにさらなるダンピング能力を期待するなら、スポーツモデルに乗り換える前に、ビルシュタイン B6を試してみてください。車内に多くの荷物を積んだりトレーラーを牽引する時でも不満のない余力と耐久性。 日々のドライブでも極限の状態でも味わえる最適なグリップ力とレーンチェンジスタビリティを実現しています。">
...
<title>KTS-web 商品ラインナップ BILSTEIN B6</title>
...
<div class="mc_nav">
<a class="link" href="https://www.kts-web.com/">HOME</a> &gt; <a class="link" href="../../index.html">SHOP MENU</a> &gt; <a class="link" href="../../set/index.html">商品ラインナップ</a> &gt; <a class="link" href="../../set/cat/100.html">足回り</a> &gt; <a class="link" href="../../set/cat/118.html">ショックアブソーバー</a> &gt; <a class="link" href="../../set/br/1136-118.html">BILSTEIN</a> &gt; <a class="link" href="10238.php">B6</a></div>
<div class="space3px"></div>
<div class="set_sale_back">
<div class="space3px"></div>
<div class="set_menu_n">
<div class="set_menu_n_330">
<div><img src="../../brand/img/1136.gif" alt="B6"></div></div>
...
<div class="swiper-slide"><img src="../../item_img/10238_1.jpg" alt="B6"></div>
<div class="swiper-slide"><img src="../../item_img/10238_2.jpg" alt="B6"></div>
<div class="swiper-slide"><img src="../../item_img/10238_3.jpg" alt="B6"></div>
</div>
...
<p>貴方が今のクルマにさらなるダンピング能力を期待するなら、スポーツモデルに乗り換える前に、ビルシュタイン B6を試してみてください。車内に多くの荷物を積んだりトレーラーを牽引する時でも不満のない余力と耐久性。 日々のドライブでも極限の状態でも味わえる最適なグリップ力とレーンチェンジスタビリティを実現しています。</p>
</div>
<div id="panel2" class="tab_panel">
<p>・純正スプリングをそのままでも味わえる安全性とパフォーマンスの改善<br>・ビルシュタインならではのガス封入技術<br>・ビルシュタインならではのドイツ製モノチューブ倒立式サス<br>・一般道からサーキットまでをテストし、ファイン・チューニング済み<br>・TV（ドイツの技術検査機関）が認める性能</p>
</div>
</div>
</div>
</div>
...
<!--ココまでSP-->
<tr>
<p class="search_category">**********【適合検索】**********&nbsp;&nbsp;<a class="change_button" href="../../set/item/10238.php"><img src="../../img/set_button.jpg" alt="工賃セットの価格表はコチラ"></a></p>
</tr>
<tr>
<td>
<!-- 車両メーカー検索ココから -->
<p class="search_category">【自動車メーカー】</p>
<form method="post" action="10238.php">
...
if($data[0] == '10238') $position = explode(";", $data[1]);
}
array_pop($position);
fclose($fp_position);
...
<form name="make" method="post" action="10238.php">
