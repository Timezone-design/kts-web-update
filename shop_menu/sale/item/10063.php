...
<title>KTS-web 商品ラインナップ FINAL KONNEXION STEALTH Complete Type-1 Swift Springs Ver.</title>
...
{
@id: "/item/10063.php",
name: "STEALTH Complete Type-1 Swift Springs Ver."
}
}
]
}
...
<p>STEALTH Complete Type-1 Swift Springs Ver.[ステルスコンプリート タイプ1 スイフトスプリングバージョン]</p></div>
</div></div>
...
<div class="swiper-slide"><img src="../../item_img/10063_1.jpg" alt="STEALTH Complete Type-1 Swift Springs Ver."></div>
<div class="swiper-slide"><img src="../../item_img/10063_2.jpg" alt="STEALTH Complete Type-1 Swift Springs Ver."></div>
<div class="swiper-slide"><img src="../../item_img/10063_3.jpg" alt="STEALTH Complete Type-1 Swift Springs Ver."></div>
</div>
...
<p>レースシーンで築かれた確固たる実績と自信の「Swift スプリング」、そしてハイクオリティサスペンション「Finalkonnexion STEALTH」のコラボレーションで、さらなる高品質・高性能へ。「STEALTH 最上級モデル」単筒式の優れた放熱機能と大型ピストンを採用さまざまなシーンで安定した走行を可能とし、更に耐久性に優れたモデルです。</p>
</div>
<div id="panel2" class="tab_panel">
<p>・全長調整式<br>・直巻スプリング<br>・Swiftスプリング仕様<br>・高機能ピロアッパーマウント（TYPE-1のみ）<br>・ピロアッパーマウントタイプ（ピロボールは拘りの日本製）<br>・単筒式<br>・減衰力 30 段調整機能付<br>・オーバーホール可能<br>・車高調レンチ、製品証明書、オリジナルステッカー付属</p>
</div>
</div>
</div>
</div>
...
<div class="item_info_text_middle_b">
<p>STEALTH Complete Type-1 Swift Springs Ver. [ステルスコンプリート タイプ1 スイフトスプリングバージョン]</p>
</div>
<div class="tab_wrap">
...
<!--ココまでSP-->
<tr>
<p class="search_category">**********【適合検索】**********&nbsp;&nbsp;<a class="change_button" href="../../set/item/10063.php"><img src="../../img/set_button.jpg" alt="工賃セットの価格表はコチラ"></a></p>
</tr>
<tr>
<td>
<!-- 車両メーカー検索ココから -->
<p class="search_category">【自動車メーカー】</p>
<form method="post" action="10063.php">
...
if($data[0] == '10063') $position = explode(";", $data[1]);
}
array_pop($position);
fclose($fp_position);
...
<form name="make" method="post" action="10063.php">
