...
<title>KTS-web 商品ラインナップ AXIS STYLING PERFECT PREMIUM</title>
...
<div class="mc_nav">
<a class="link" href="https://www.kts-web.com/">HOME</a> &gt; <a class="link" href="../../index.html">SHOP MENU</a> &gt; <a class="link" href="../../set/index.html">商品ラインナップ</a> &gt; <a class="link" href="../../set/cat/100.html">足回り</a> &gt; <a class="link" href="../../set/cat/116.html">車高調/セッティングパーツ</a> &gt; <a class="link" href="../../set/br/1163-116.html">AXIS STYLING</a> &gt; <a class="link" href="10013.php">PERFECT PREMIUM</a></div>
<div class="space3px"></div>
<div class="set_sale_back">
<div class="space3px"></div>
<div class="set_menu_n">
<div class="set_menu_n_330">
<div><img src="../../brand/img/1163.gif" alt="PERFECT PREMIUM"></div></div>
<div class="set_menu_n_cell">
<div class="item_info_text_middle">
<p>AXIS STYLING[アクシススタイリング]</p></div>
<div class="item_info_text_middle_b">
<p>PERFECT PREMIUM[パーフェクトプレミアム]</p></div>
</div></div>
...
<div class="swiper-slide"><img src="../../item_img/10013_1.jpg" alt="PERFECT PREMIUM"></div>
<div class="swiper-slide"><img src="../../item_img/10013_2.jpg" alt="PERFECT PREMIUM"></div>
<div class="swiper-slide"><img src="../../item_img/10013_3.jpg" alt="PERFECT PREMIUM"></div>
</div>
...
<p>高級車にふさわしい乗り心地を徹底追及した特別なサスペンション。「純正の乗り心地を改善したい。」との多くの要望により開発。従来品パーフェクトダンパーに比べ、ローダウン量を抑え、さらに上質な乗り心地を実現しました。車はグレードや色を選ぶのに、なぜ乗り心地は選ばないのでしょうか？「パーフェクトダンパー プレミアム」は乗り心地15段調整式で好みに調整可能。</p>
</div>
<div id="panel2" class="tab_panel">
<p>・フロントアッパーマウントTOYOTA純正品をセット済み<br>・フロントは複筒式正立ショック。<br>・リアは単筒式正立ショック<br>・車検対応<br>・、車高調整用レンチ/取付説明書付属。</p>
</div>
</div>
</div>
</div>
...
<div class="item_info_text_middle_b">
<p>PERFECT PREMIUM [パーフェクトプレミアム]</p>
</div>
<div class="tab_wrap">
...
<!--ココまでSP-->
<tr>
<p class="search_category">**********【適合検索】**********&nbsp;&nbsp;<a class="change_button" href="../../set/item/10013.php"><img src="../../img/set_button.jpg" alt="工賃セットの価格表はコチラ"></a></p>
</tr>
<tr>
<td>
<!-- 車両メーカー検索ココから -->
<p class="search_category">【自動車メーカー】</p>
<form method="post" action="10013.php">
...
if($data[0] == '10013') $position = explode(";", $data[1]);
}
array_pop($position);
fclose($fp_position);
...
<form name="make" method="post" action="10013.php">
