...
<title>KTS-web 商品ラインナップ IDEAL HYPER FOOT</title>
...
<div class="mc_nav">
<a class="link" href="https://www.kts-web.com/">HOME</a> &gt; <a class="link" href="../../index.html">SHOP MENU</a> &gt; <a class="link" href="../../set/index.html">商品ラインナップ</a> &gt; <a class="link" href="../../set/cat/100.html">足回り</a> &gt; <a class="link" href="../../set/cat/116.html">車高調/セッティングパーツ</a> &gt; <a class="link" href="../../set/br/1012-116.html">IDEAL</a> &gt; <a class="link" href="10090.php">HYPER FOOT</a></div>
<div class="space3px"></div>
<div class="set_sale_back">
<div class="space3px"></div>
<div class="set_menu_n">
<div class="set_menu_n_330">
<div><img src="../../brand/img/1012.gif" alt="HYPER FOOT"></div></div>
<div class="set_menu_n_cell">
<div class="item_info_text_middle">
<p>IDEAL[イデアル]</p></div>
<div class="item_info_text_middle_b">
<p>HYPER FOOT[ハイパーフット]</p></div>
</div></div>
...
<div class="swiper-slide"><img src="../../item_img/10090_1.jpg" alt="HYPER FOOT"></div>
<div class="swiper-slide"><img src="../../item_img/10090_2.jpg" alt="HYPER FOOT"></div>
<div class="swiper-slide"><img src="../../item_img/10090_3.jpg" alt="HYPER FOOT"></div>
</div>
...
<p>車高調シリーズのハイエンドモデルとして位置づけられるハイパーフット。 36段階の減衰力調整機能に加えて、クイックなハンドリングを楽しめるピロアッパーマウントを全車に標準装備。 またスライド調整機構も採用しているため、ショートナックルを装着した際に発生しがちなスプリングとの干渉を防げます。 ショックの全長を短くし、スプリングも低車高での走行を想定したハイレート＆超ショートタイプ。</p>
</div>
<div id="panel2" class="tab_panel">
<p>全長調整式<br>・36段階減衰力調整機能<br>・スライド調整式ピロアッパーマウント<br>・ダストブーツ付属<br>・防錆コーティング</p>
</div>
</div>
</div>
</div>
...
<!--ココまでSP-->
<tr>
<p class="search_category">**********【適合検索】**********&nbsp;&nbsp;<a class="change_button" href="../../set/item/10090.php"><img src="../../img/set_button.jpg" alt="工賃セットの価格表はコチラ"></a></p>
</tr>
<tr>
<td>
<!-- 車両メーカー検索ココから -->
<p class="search_category">【自動車メーカー】</p>
<form method="post" action="10090.php">
...
if($data[0] == '10090') $position = explode(";", $data[1]);
}
array_pop($position);
fclose($fp_position);
...
<form name="make" method="post" action="10090.php">
