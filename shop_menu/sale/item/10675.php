<html>
<head>
<meta name="description" content="STREETシリーズの欧州車専用モデル。ストリートからサーキットまで幅広く対応できるサスペンションです。ハイセンスな欧州車のローアングルをターゲット。贅沢な機能性＆耐久性を重視しながらもプライスは日本車用並みのハイスペックモデルです。">
...
<title>KTS-web 商品ラインナップ MEGAN RACING Euro Street</title>
...
<div class="mc_nav">
<a class="link" href="https://www.kts-web.com/">HOME</a> &gt; <a class="link" href="../../index.html">SHOP MENU</a> &gt; <a class="link" href="../../set/index.html">商品ラインナップ</a> &gt; <a class="link" href="../../set/cat/100.html">足回り</a> &gt; <a class="link" href="../../set/cat/116.html">車高調/セッティングパーツ</a> &gt; <a class="link" href="../../set/br/1181-116.html">MEGAN RACING</a> &gt; <a class="link" href="10675.php">Euro Street</a></div>
<div class="space3px"></div>
<div class="set_sale_back">
<div class="space3px"></div>
<div class="set_menu_n">
<div class="set_menu_n_330">
<div><img src="../../brand/img/1181.gif" alt="Euro Street"></div></div>
<div class="set_menu_n_cell">
<div class="item_info_text_middle">
<p>MEGAN RACING[メーガンレーシング]</p></div>
<div class="item_info_text_middle_b">
<p>Euro Street[ユーロストリート]</p></div>
</div></div>
...
<div class="swiper-slide"><img src="../../item_img/10675_1.jpg" alt="Euro Street"></div>
<div class="swiper-slide"><img src="../../item_img/10675_2.jpg" alt="Euro Street"></div>
<div class="swiper-slide"><img src="../../item_img/10675_3.jpg" alt="Euro Street"></div>
</div>
...
<p>STREETシリーズの欧州車専用モデル。ストリートからサーキットまで幅広く対応できるサスペンションです。ハイセンスな欧州車のローアングルをターゲット。贅沢な機能性＆耐久性を重視しながらもプライスは日本車用並みのハイスペックモデルです。</p>
</div>
...
<!--ココまでSP-->
<tr>
<p class="search_category">**********【適合検索】**********&nbsp;&nbsp;<a class="change_button" href="../../set/item/10675.php"><img src="../../img/set_button.jpg" alt="工賃セットの価格表はコチラ"></a></p>
</tr>
<tr>
<td>
<!-- 車両メーカー検索ココから -->
<p class="search_category">【自動車メーカー】</p>
<form method="post" action="10675.php">
...
if($data[0] == '10675') $position = explode(";", $data[1]);
}
array_pop($position);
fclose($fp_position);
...
<form name="make" method="post" action="10675.php">
