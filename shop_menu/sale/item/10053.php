...
<title>KTS-web 商品ラインナップ FINAL KONNEXION LIMITEDⅡ</title>
...
<div class="swiper-slide"><img src="../../item_img/10053_1.jpg" alt="LIMITEDⅡ"></div>
<div class="swiper-slide"><img src="../../item_img/10053_2.jpg" alt="LIMITEDⅡ"></div>
<div class="swiper-slide"><img src="../../item_img/10053_3.jpg" alt="LIMITEDⅡ"></div>
</div>
...
<p>低価格はそのままに乗り心地と耐久性を追求！LIMITEDⅡは従来のLIMITED同様の機能を持ちさらにリニューアル。オイルシールやショックオイルなど消耗品を中心にステルス車高調と同等の部品を使用する事で性能、耐久性などさらに品質向上させました。</p>
</div>
...
<!--ココまでSP-->
<tr>
<p class="search_category">**********【適合検索】**********&nbsp;&nbsp;<a class="change_button" href="../../set/item/10053.php"><img src="../../img/set_button.jpg" alt="工賃セットの価格表はコチラ"></a></p>
</tr>
<tr>
<td>
<!-- 車両メーカー検索ココから -->
<p class="search_category">【自動車メーカー】</p>
<form method="post" action="10053.php">
...
if($data[0] == '10053') $position = explode(";", $data[1]);
}
array_pop($position);
fclose($fp_position);
...
<form name="make" method="post" action="10053.php">
