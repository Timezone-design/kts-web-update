...
<title>KTS-web 商品ラインナップ A'PEXi N1 evolution DAMPER</title>
...
<div class="mc_nav">
<a class="link" href="https://www.kts-web.com/">HOME</a> &gt; <a class="link" href="../../index.html">SHOP MENU</a> &gt; <a class="link" href="../../set/index.html">商品ラインナップ</a> &gt; <a class="link" href="../../set/cat/100.html">足回り</a> &gt; <a class="link" href="../../set/cat/116.html">車高調/セッティングパーツ</a> &gt; <a class="link" href="../../set/br/1008-116.html">A'PEXi</a> &gt; <a class="link" href="10002.php">N1 evolution DAMPER</a></div>
<div class="space3px"></div>
<div class="set_sale_back">
<div class="space3px"></div>
<div class="set_menu_n">
<div class="set_menu_n_330">
<div><img src="../../brand/img/1008.gif" alt="N1 evolution DAMPER"></div></div>
<div class="set_menu_n_cell">
<div class="item_info_text_middle">
<p>A'PEXi[アペックス]</p></div>
<div class="item_info_text_middle_b">
<p>N1 evolution DAMPER[N1エボリューションダンパー]</p></div>
</div></div>
...
<div class="swiper-slide"><img src="../../item_img/10002_1.jpg" alt="N1 evolution DAMPER"></div>
<div class="swiper-slide"><img src="../../item_img/10002_2.jpg" alt="N1 evolution DAMPER"></div>
<div class="swiper-slide"><img src="../../item_img/10002_3.jpg" alt="N1 evolution DAMPER"></div>
</div>
...
<p>サーキットと公道、その異なるドライビングスタイルとステージにおける最適な特性とフィーリングを実現するためにパーツ1点1点に至るまで妥協無く設計が行われた、A'PEXi究極のフットワークがN1エボリューションダンパーです。リニアなコントロール性、静粛性、しなやかな乗り心地。時に相反するこれらの要素を高度な次元で成立させています。</p>
</div>
<div id="panel2" class="tab_panel">
<p>・特殊樹脂圧着φ46ピストンがフリクションロスと静粛性を向上 <br>・アッパーマウントは超剛性ピロボールマウントを使用 <br>・劣化に強い専用ダンパーフルードが安定した減衰力を維持 <br>・25段階の減衰力調整と全長調整機能を全タイプに搭載 <br>・軽量でしなやかなN1スプリングIIを使用 <br>・O/H及び減衰力リセッティングに完全対応</p>
</div>
</div>
</div>
</div>
...
<div class="item_info_text_middle_b">
<p>N1 evolution DAMPER [N1エボリューションダンパー]</p>
</div>
<div class="tab_wrap">
...
<!--ココまでSP-->
<tr>
<p class="search_category">**********【適合検索】**********&nbsp;&nbsp;<a class="change_button" href="../../set/item/10002.php"><img src="../../img/set_button.jpg" alt="工賃セットの価格表はコチラ"></a></p>
</tr>
<tr>
<td>
<!-- 車両メーカー検索ココから -->
<p class="search_category">【自動車メーカー】</p>
<form method="post" action="10002.php">
...
if($data[0] == '10002') $position = explode(";", $data[1]);
}
array_pop($position);
fclose($fp_position);
...
<form name="make" method="post" action="10002.php">
