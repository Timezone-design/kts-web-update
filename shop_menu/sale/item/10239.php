<html>
<head>
<meta name="description" content="貴方が今のクルマにさらなるダンピング能力を期待するなら、スポーツモデルに乗り換える前に、ビルシュタイン B6を試してみてください。BILSTEIN B6のダンプトロニックに対応したハイパフォーマンス仕様。一般道からサーキットまでをテストし、ファイン・チューニング済みです。">
...
<title>KTS-web 商品ラインナップ BILSTEIN B6 DampTronic</title>
...
<div class="swiper-slide"><img src="../../item_img/10239_1.jpg" alt="B6 DampTronic"></div>
<div class="swiper-slide"><img src="../../item_img/10239_2.jpg" alt="B6 DampTronic"></div>
<div class="swiper-slide"><img src="../../item_img/10239_3.jpg" alt="B6 DampTronic"></div>
</div>
...
<p>貴方が今のクルマにさらなるダンピング能力を期待するなら、スポーツモデルに乗り換える前に、ビルシュタイン B6を試してみてください。BILSTEIN B6のダンプトロニックに対応したハイパフォーマンス仕様。一般道からサーキットまでをテストし、ファイン・チューニング済みです。</p>
</div>
<div id="panel2" class="tab_panel">
<p>・純正形状ハイパフォーマンスモデル<br>・ダンプトロニック対応</p>
</div>
</div>
</div>
</div>
...
<!--ココまでSP-->
<tr>
<p class="search_category">**********【適合検索】**********&nbsp;&nbsp;<a class="change_button" href="../../set/item/10239.php"><img src="../../img/set_button.jpg" alt="工賃セットの価格表はコチラ"></a></p>
</tr>
<tr>
<td>
<!-- 車両メーカー検索ココから -->
<p class="search_category">【自動車メーカー】</p>
<form method="post" action="10239.php">
...
if($data[0] == '10239') $position = explode(";", $data[1]);
}
array_pop($position);
fclose($fp_position);
...
<form name="make" method="post" action="10239.php">
