...
<title>KTS-web 商品ラインナップ HKS HIPERMAX S-style L</title>
...
<div class="mc_nav">
<a class="link" href="https://www.kts-web.com/">HOME</a> &gt; <a class="link" href="../../index.html">SHOP MENU</a> &gt; <a class="link" href="../../set/index.html">商品ラインナップ</a> &gt; <a class="link" href="../../set/cat/100.html">足回り</a> &gt; <a class="link" href="../../set/cat/116.html">車高調/セッティングパーツ</a> &gt; <a class="link" href="../../set/br/1032-116.html">HKS</a> &gt; <a class="link" href="10082.php">HIPERMAX S-style L</a></div>
<div class="space3px"></div>
<div class="set_sale_back">
<div class="space3px"></div>
<div class="set_menu_n">
<div class="set_menu_n_330">
<div><img src="../../brand/img/1032.gif" alt="HIPERMAX S-style L"></div></div>
<div class="set_menu_n_cell">
<div class="item_info_text_middle">
<p>HKS[エッチケーエス]</p></div>
<div class="item_info_text_middle_b">
<p>HIPERMAX S-style L[ハイパーマックス Sスタイル L]</p></div>
</div></div>
...
<div class="swiper-slide"><img src="../../item_img/10082_1.jpg" alt="HIPERMAX S-style L"></div>
<div class="swiper-slide"><img src="../../item_img/10082_2.jpg" alt="HIPERMAX S-style L"></div>
<div class="swiper-slide"><img src="../../item_img/10082_3.jpg" alt="HIPERMAX S-style L"></div>
</div>
...
<p>プリロードバルブシステムとM4Pが究極の弾力性を発揮！ローダウンユーザーの為の理想な走りを実現！！「タイヤをインチアップしたらフェンダーとの隙間が気になり、乗り心地が悪くなった」「ローダウンはしたいけど乗り心地はそんなに悪くしたくないし、できればより上質なものにしたい」「自分の好みの乗り味にしたい…」そんな様々なリクエストやあらゆるフィールドでの使用に対して高いレベルで対応するサスペンションキットです。</p>
</div>
<div id="panel2" class="tab_panel">
<p>・単筒式<br>・減衰力30段階調整<br>・全長調整式<br>・専用スペシャルオイル<br>・PNEコート<br>・PVS<br>・M4P<br>・倒立タイプ※ストラットタイプのみ<br>・強化ゴムアッパーマウント<br>・仕様変更可<br>・オーバーホール可<br>・3年6万キロ保証</p>
</div>
</div>
</div>
</div>
...
<div class="item_info_text_middle_b">
<p>HIPERMAX S-style L [ハイパーマックス Sスタイル L]</p>
</div>
<div class="tab_wrap">
...
<!--ココまでSP-->
<tr>
<p class="search_category">**********【適合検索】**********&nbsp;&nbsp;<a class="change_button" href="../../set/item/10082.php"><img src="../../img/set_button.jpg" alt="工賃セットの価格表はコチラ"></a></p>
</tr>
<tr>
<td>
<!-- 車両メーカー検索ココから -->
<p class="search_category">【自動車メーカー】</p>
<form method="post" action="10082.php">
...
if($data[0] == '10082') $position = explode(";", $data[1]);
}
array_pop($position);
fclose($fp_position);
...
<form name="make" method="post" action="10082.php">
