<html>
<head>
<meta name="description" content="リジカラは、アルミ調質材の特殊形状の小さなパーツです。世界中のカーメーカーは量産性を高めるためボディとサブフレームを締結するボルト穴をボルトに対して大きく開口させ、組み立てやすくしています。「リジカラ」はボルト穴とその周辺の「スキマ」を埋めることでクルマを確実に剛体化します。">
...
<div class="mc_nav">
<a class="link" href="https://www.kts-web.com/">HOME</a> &gt; <a class="link" href="../../index.html">SHOP MENU</a> &gt; <a class="link" href="../../set/index.html">商品ラインナップ</a> &gt; <a class="link" href="../../set/cat/100.html">足回り</a> &gt; <a class="link" href="../../set/cat/121.html">その他足回り関連</a> &gt; <a class="link" href="../../set/br/1092-121.html">SPOON</a> &gt; <a class="link" href="10275.php">リジカラ</a></div>
<div class="space3px"></div>
<div class="set_sale_back">
<div class="space3px"></div>
<div class="set_menu_n">
<div class="set_menu_n_330">
<div><img src="../../brand/img/1092.gif" alt="リジカラ"></div></div>
...
<div class="swiper-slide"><img src="../../item_img/10275_1.jpg" alt="リジカラ"></div>
<div class="swiper-slide"><img src="../../item_img/10275_2.jpg" alt="リジカラ"></div>
<div class="swiper-slide"><img src="../../item_img/10275_3.jpg" alt="リジカラ"></div>
</div>
...
<p>リジカラは、アルミ調質材の特殊形状の小さなパーツです。世界中のカーメーカーは量産性を高めるためボディとサブフレームを締結するボルト穴をボルトに対して大きく開口させ、組み立てやすくしています。「リジカラ」はボルト穴とその周辺の「スキマ」を埋めることでクルマを確実に剛体化します。</p>
</div>
<div id="panel2" class="tab_panel">
<p>・本体：アルミ調質材<br>※商品や取付のみの販売も行っておりますが、アライメントの同時施工を強くお勧めします。</p>
</div>
</div>
</div>
</div>
...
<!--ココまでSP-->
<tr>
<p class="search_category">**********【適合検索】**********&nbsp;&nbsp;<a class="change_button" href="../../set/item/10275.php"><img src="../../img/set_button.jpg" alt="工賃セットの価格表はコチラ"></a></p>
</tr>
<tr>
<td>
<!-- 車両メーカー検索ココから -->
<p class="search_category">【自動車メーカー】</p>
<form method="post" action="10275.php">
...
if($data[0] == '10275') $position = explode(";", $data[1]);
}
array_pop($position);
fclose($fp_position);
...
<form name="make" method="post" action="10275.php">
