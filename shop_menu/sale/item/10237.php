<html>
<head>
<meta name="description" content="オリジナルにして最高。B4はまさにビルシュタイン・オリジナルのガス封入モノチューブ・ショックアブソーバーです。50年以上の歴史を持つビルシュタインの創設時から受け継がれたアイデアによって成り立っています。昨今のほとんどあらゆる市販車に採用されています。">
...
<title>KTS-web 商品ラインナップ BILSTEIN B4</title>
...
<div class="swiper-slide"><img src="../../item_img/10237_1.jpg" alt="B4"></div>
<div class="swiper-slide"><img src="../../item_img/10237_2.jpg" alt="B4"></div>
<div class="swiper-slide"><img src="../../item_img/10237_3.jpg" alt="B4"></div>
</div>
...
<p>オリジナルにして最高。B4はまさにビルシュタイン・オリジナルのガス封入モノチューブ・ショックアブソーバーです。50年以上の歴史を持つビルシュタインの創設時から受け継がれたアイデアによって成り立っています。昨今のほとんどあらゆる市販車に採用されています。</p>
</div>
<div id="panel2" class="tab_panel">
<p>・負荷の大小にかかわらないコンスタントなダンピング<br>・最大限の安全のための余力<br>・乗るたびに思い出す、初めて乗った時の新鮮味<br>・高いOEM品質<br>・ビルシュタインならではのガス封入技術</p>
</div>
</div>
</div>
</div>
...
<!--ココまでSP-->
<tr>
<p class="search_category">**********【適合検索】**********&nbsp;&nbsp;<a class="change_button" href="../../set/item/10237.php"><img src="../../img/set_button.jpg" alt="工賃セットの価格表はコチラ"></a></p>
</tr>
<tr>
<td>
<!-- 車両メーカー検索ココから -->
<p class="search_category">【自動車メーカー】</p>
<form method="post" action="10237.php">
...
if($data[0] == '10237') $position = explode(";", $data[1]);
}
array_pop($position);
fclose($fp_position);
...
<form name="make" method="post" action="10237.php">
