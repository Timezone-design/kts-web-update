<html>
<head>
<meta name="description" content="イニシャルトルク内圧式可変機能付きのプロモデル。LSD本体を分解せずにイニシャルトルクを3段階に切り替える機能が付いています。基本性能はGT LSDと同一ですが、イニシャルトルクが低下した時もイニシャルトルクを切り替えることにより、LOWで使用なら2回、MIDDLEなら1回分のオーバーホール費用を節約できます。">
...
<title>KTS-web 商品ラインナップ nismo GT L.S.D. Pro</title>
...
<div class="mc_nav">
<a class="link" href="https://www.kts-web.com/">HOME</a> &gt; <a class="link" href="../../index.html">SHOP MENU</a> &gt; <a class="link" href="../../set/index.html">商品ラインナップ</a> &gt; <a class="link" href="../../set/cat/101.html">駆動系</a> &gt; <a class="link" href="../../set/cat/122.html">LSD</a> &gt; <a class="link" href="../../set/br/1122-122.html">nismo</a> &gt; <a class="link" href="10456.php">GT L.S.D. Pro</a></div>
<div class="space3px"></div>
<div class="set_sale_back">
<div class="space3px"></div>
<div class="set_menu_n">
<div class="set_menu_n_330">
<div><img src="../../brand/img/1122.gif" alt="GT L.S.D. Pro"></div></div>
<div class="set_menu_n_cell">
<div class="item_info_text_middle">
<p>nismo[ニスモ]</p></div>
<div class="item_info_text_middle_b">
<p>GT L.S.D. Pro[GT LSD プロ]</p></div>
</div></div>
...
<div class="swiper-slide"><img src="../../item_img/10456_1.jpg" alt="GT L.S.D. Pro"></div>
<div class="swiper-slide"><img src="../../item_img/10456_2.jpg" alt="GT L.S.D. Pro"></div>
<div class="swiper-slide"><img src="../../item_img/10456_3.jpg" alt="GT L.S.D. Pro"></div>
</div>
...
<p>イニシャルトルク内圧式可変機能付きのプロモデル。LSD本体を分解せずにイニシャルトルクを3段階に切り替える機能が付いています。基本性能はGT LSDと同一ですが、イニシャルトルクが低下した時もイニシャルトルクを切り替えることにより、LOWで使用なら2回、MIDDLEなら1回分のオーバーホール費用を節約できます。</p>
</div>
<div id="panel2" class="tab_panel">
<p>・イニシャルトルク内圧式可変機能付き<br>・設定[LOW-MIDDLE-HIGH:6.5-8.5-14.0kgf・m ]<br>・大径プレート20枚仕様<br>・2WAY/1.5WAY選択・組み替え可能<br>・高品質プレートの採用<br>・高いコントロール性</p>
</div>
</div>
</div>
</div>
...
<!--ココまでSP-->
<tr>
<p class="search_category">**********【適合検索】**********&nbsp;&nbsp;<a class="change_button" href="../../set/item/10456.php"><img src="../../img/set_button.jpg" alt="工賃セットの価格表はコチラ"></a></p>
</tr>
<tr>
<td>
<!-- 車両メーカー検索ココから -->
<p class="search_category">【自動車メーカー】</p>
<form method="post" action="10456.php">
...
if($data[0] == '10456') $position = explode(";", $data[1]);
}
array_pop($position);
fclose($fp_position);
...
<form name="make" method="post" action="10456.php">
