...
<title>KTS-web 商品ラインナップ CUSCO 青のStreet A</title>
...
<div class="mc_nav">
<a class="link" href="https://www.kts-web.com/">HOME</a> &gt; <a class="link" href="../../index.html">SHOP MENU</a> &gt; <a class="link" href="../../set/index.html">商品ラインナップ</a> &gt; <a class="link" href="../../set/cat/100.html">足回り</a> &gt; <a class="link" href="../../set/cat/116.html">車高調/セッティングパーツ</a> &gt; <a class="link" href="../../set/br/1059-116.html">CUSCO</a> &gt; <a class="link" href="10026.php">青のStreet A</a></div>
<div class="space3px"></div>
<div class="set_sale_back">
<div class="space3px"></div>
<div class="set_menu_n">
<div class="set_menu_n_330">
<div><img src="../../brand/img/1059.gif" alt="青のStreet A"></div></div>
<div class="set_menu_n_cell">
<div class="item_info_text_middle">
<p>CUSCO[クスコ]</p></div>
<div class="item_info_text_middle_b">
<p>青のStreet A[青のストリートA]</p></div>
</div></div>
...
<div class="swiper-slide"><img src="../../item_img/10026_1.jpg" alt="青のStreet A"></div>
<div class="swiper-slide"><img src="../../item_img/10026_2.jpg" alt="青のStreet A"></div>
<div class="swiper-slide"><img src="../../item_img/10026_3.jpg" alt="青のStreet A"></div>
</div>
...
<p>手軽にローダウンしながらも車種別専用設計のため十分なバンプストロークを確保乗り心地も自由自在。走行シーンにあわせて違いがハッキリわかる減衰力(乗り心地)40段調整式であなた好みの乗り味に調整可能です。出荷時にしっかりストロークを確保した「ベストローダウン設計」。1年、または10,000kmの安心保証つき。</p>
</div>
<div id="panel2" class="tab_panel">
<p>・減衰力40段調整（一部車種はリヤ減衰力8段調整）<br>・ネジ式(全長固定)車高調整<br>・アッパーマウントレスキット<br>・減衰調整式ショックの作動音を抑える静音設計<br>・e-con2対応（適合車種のみ）</p>
</div>
</div>
</div>
</div>
...
<!--ココまでSP-->
<tr>
<p class="search_category">**********【適合検索】**********&nbsp;&nbsp;<a class="change_button" href="../../set/item/10026.php"><img src="../../img/set_button.jpg" alt="工賃セットの価格表はコチラ"></a></p>
</tr>
<tr>
<td>
<!-- 車両メーカー検索ココから -->
<p class="search_category">【自動車メーカー】</p>
<form method="post" action="10026.php">
...
if($data[0] == '10026') $position = explode(";", $data[1]);
}
array_pop($position);
fclose($fp_position);
...
<form name="make" method="post" action="10026.php">
