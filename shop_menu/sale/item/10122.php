...
<title>KTS-web 商品ラインナップ OHLINS Type HA</title>
...
<div class="mc_nav">
<a class="link" href="https://www.kts-web.com/">HOME</a> &gt; <a class="link" href="../../index.html">SHOP MENU</a> &gt; <a class="link" href="../../set/index.html">商品ラインナップ</a> &gt; <a class="link" href="../../set/cat/100.html">足回り</a> &gt; <a class="link" href="../../set/cat/116.html">車高調/セッティングパーツ</a> &gt; <a class="link" href="../../set/br/1046-116.html">OHLINS</a> &gt; <a class="link" href="10122.php">Type HA</a></div>
<div class="space3px"></div>
<div class="set_sale_back">
<div class="space3px"></div>
<div class="set_menu_n">
<div class="set_menu_n_330">
<div><img src="../../brand/img/1046.gif" alt="Type HA"></div></div>
<div class="set_menu_n_cell">
<div class="item_info_text_middle">
<p>OHLINS[オーリンズ]</p></div>
<div class="item_info_text_middle_b">
<p>Type HA[タイプHA]</p></div>
</div></div>
...
<div class="swiper-slide"><img src="../../item_img/10122_1.jpg" alt="Type HA"></div>
<div class="swiper-slide"><img src="../../item_img/10122_2.jpg" alt="Type HA"></div>
<div class="swiper-slide"><img src="../../item_img/10122_3.jpg" alt="Type HA"></div>
</div>
...
<p>クルマとの一体感を保ちながら地を這うような安定感に満ちたコーナリング。オーリンズ専用のハイテンション直巻スプリングと高精度ショックアブソーバーの組み合わせが、あらゆる走行ステージに異次元の走りをもたらします。車高を微調整できることで、伝統の20段調整はさらに能力を高めます。</p>
</div>
<div id="panel2" class="tab_panel">
<p>・ネジ式車高調整モデル<br>・専用ハイテンション直巻きスプリング<br>・減衰力20段階調整</p>
</div>
</div>
</div>
</div>
...
<!--ココまでSP-->
<tr>
<p class="search_category">**********【適合検索】**********&nbsp;&nbsp;<a class="change_button" href="../../set/item/10122.php"><img src="../../img/set_button.jpg" alt="工賃セットの価格表はコチラ"></a></p>
</tr>
<tr>
<td>
<!-- 車両メーカー検索ココから -->
<p class="search_category">【自動車メーカー】</p>
<form method="post" action="10122.php">
...
if($data[0] == '10122') $position = explode(";", $data[1]);
}
array_pop($position);
fclose($fp_position);
...
<form name="make" method="post" action="10122.php">
