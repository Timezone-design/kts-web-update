...
<title>KTS-web 商品ラインナップ SHOWA COMFORT EVOLUTION 柔</title>
...
<div class="swiper-slide"><img src="../../item_img/10156_1.jpg" alt="COMFORT EVOLUTION 柔"></div>
<div class="swiper-slide"><img src="../../item_img/10156_2.jpg" alt="COMFORT EVOLUTION 柔"></div>
<div class="swiper-slide"><img src="../../item_img/10156_3.jpg" alt="COMFORT EVOLUTION 柔"></div>
</div>
...
<p>SPORTSシリーズのハイエンドモデル -極- の技術を活かし、ストリート〜ワインディングでのハンドリング、安定感、乗り心地を極限まで追求した、SHOWA TUNING COMFORTシリーズの史上最高モデルです。そのノーマル形状ダンパーの極限の姿を「柔（やわら）」という感じでイメージ。</p>
</div>
<div id="panel2" class="tab_panel">
<p>・ノーマル形状ダンパー<br>・スプリングセット</p>
</div>
</div>
</div>
</div>
...
<div class="item_info_text_middle_b">
<p>COMFORT EVOLUTION 柔 [コンフォートエボリューション 柔]</p>
</div>
<div class="tab_wrap">
...
<!--ココまでSP-->
<tr>
<p class="search_category">**********【適合検索】**********&nbsp;&nbsp;<a class="change_button" href="../../set/item/10156.php"><img src="../../img/set_button.jpg" alt="工賃セットの価格表はコチラ"></a></p>
</tr>
<tr>
<td>
<!-- 車両メーカー検索ココから -->
<p class="search_category">【自動車メーカー】</p>
<form method="post" action="10156.php">
...
if($data[0] == '10156') $position = explode(";", $data[1]);
}
array_pop($position);
fclose($fp_position);
...
<form name="make" method="post" action="10156.php">
