...
<title>KTS-web 商品ラインナップ FINAL KONNEXION STYLE KIDS DAMPER</title>
...
<p>STYLE KIDS DAMPER[スタイルキッズダンパー]</p></div>
</div></div>
...
<div class="swiper-slide"><img src="../../item_img/10070_1.jpg" alt="STYLE KIDS DAMPER"></div>
<div class="swiper-slide"><img src="../../item_img/10070_2.jpg" alt="STYLE KIDS DAMPER"></div>
<div class="swiper-slide"><img src="../../item_img/10070_3.jpg" alt="STYLE KIDS DAMPER"></div>
</div>
...
<p>機能性も重視したビギナーズモデル！街乗りでの快適な乗り心地を楽しめ減衰力20段階調整の機能性も重視したビギナーズモデルもちろん価格もロープライスです。</p>
</div>
<div id="panel2" class="tab_panel">
<p>・全長調整式<br>・単筒式<br>・減衰力 20 段調整機能付<br>・オーバーホール可能<br>・車高調レンチ、製品証明書、オリジナルステッカー付属</p>
</div>
</div>
</div>
</div>
...
<div class="item_info_text_middle_b">
<p>STYLE KIDS DAMPER [スタイルキッズダンパー]</p>
</div>
<div class="tab_wrap">
...
<!--ココまでSP-->
<tr>
<p class="search_category">**********【適合検索】**********&nbsp;&nbsp;<a class="change_button" href="../../set/item/10070.php"><img src="../../img/set_button.jpg" alt="工賃セットの価格表はコチラ"></a></p>
</tr>
<tr>
<td>
<!-- 車両メーカー検索ココから -->
<p class="search_category">【自動車メーカー】</p>
<form method="post" action="10070.php">
...
if($data[0] == '10070') $position = explode(";", $data[1]);
}
array_pop($position);
fclose($fp_position);
...
<form name="make" method="post" action="10070.php">
