<html>
<head>
<meta name="description" content="レーシングスペックダンパーは、完全にレース専用として開発され、ショック自体の構造が他のモデルとは異なります。快適性を犠牲にし、走るための性能を重視したモデルです。ストリートでの使用にはお勧めできません。">
...
<title>KTS-web 商品ラインナップ XYZ JAPAN RS</title>
...
<div class="mc_nav">
<a class="link" href="https://www.kts-web.com/">HOME</a> &gt; <a class="link" href="../../index.html">SHOP MENU</a> &gt; <a class="link" href="../../set/index.html">商品ラインナップ</a> &gt; <a class="link" href="../../set/cat/100.html">足回り</a> &gt; <a class="link" href="../../set/cat/116.html">車高調/セッティングパーツ</a> &gt; <a class="link" href="../../set/br/1031-116.html">XYZ JAPAN</a> &gt; <a class="link" href="10217.php">RS</a></div>
<div class="space3px"></div>
<div class="set_sale_back">
<div class="space3px"></div>
<div class="set_menu_n">
<div class="set_menu_n_330">
<div><img src="../../brand/img/1031.gif" alt="RS"></div></div>
<div class="set_menu_n_cell">
<div class="item_info_text_middle">
<p>XYZ JAPAN[エックスワイゼット]</p></div>
<div class="item_info_text_middle_b">
<p>RS[レーシングスペック]</p></div>
</div></div>
...
<div class="swiper-slide"><img src="../../item_img/10217_1.jpg" alt="RS"></div>
<div class="swiper-slide"><img src="../../item_img/10217_2.jpg" alt="RS"></div>
<div class="swiper-slide"><img src="../../item_img/10217_3.jpg" alt="RS"></div>
</div>
...
<p>レーシングスペックダンパーは、完全にレース専用として開発され、ショック自体の構造が他のモデルとは異なります。快適性を犠牲にし、走るための性能を重視したモデルです。ストリートでの使用にはお勧めできません。</p>
</div>
<div id="panel2" class="tab_panel">
<p>・サーキット仕様<br>・ショートストローク・ハイレート仕様<br>・フルタップ全長調整式<br>・減衰力30段調整<br>・調整式ピロアッパー※一部車種除く<br>・単筒式モノチューブ構造<br>・耐食・防錆フッ素コーティング</p>
</div>
</div>
</div>
</div>
...
<!--ココまでSP-->
<tr>
<p class="search_category">**********【適合検索】**********&nbsp;&nbsp;<a class="change_button" href="../../set/item/10217.php"><img src="../../img/set_button.jpg" alt="工賃セットの価格表はコチラ"></a></p>
</tr>
<tr>
<td>
<!-- 車両メーカー検索ココから -->
<p class="search_category">【自動車メーカー】</p>
<form method="post" action="10217.php">
...
if($data[0] == '10217') $position = explode(";", $data[1]);
}
array_pop($position);
fclose($fp_position);
...
<form name="make" method="post" action="10217.php">
