...
<title>KTS-web 商品ラインナップ Street Ride TYPE-WAGON</title>
...
<div class="mc_nav">
<a class="link" href="https://www.kts-web.com/">HOME</a> &gt; <a class="link" href="../../index.html">SHOP MENU</a> &gt; <a class="link" href="../../set/index.html">商品ラインナップ</a> &gt; <a class="link" href="../../set/cat/100.html">足回り</a> &gt; <a class="link" href="../../set/cat/116.html">車高調/セッティングパーツ</a> &gt; <a class="link" href="../../set/br/1090-116.html">Street Ride</a> &gt; <a class="link" href="10162.php">TYPE-WAGON</a></div>
<div class="space3px"></div>
<div class="set_sale_back">
<div class="space3px"></div>
<div class="set_menu_n">
<div class="set_menu_n_330">
<div><img src="../../brand/img/1090.gif" alt="TYPE-WAGON"></div></div>
<div class="set_menu_n_cell">
<div class="item_info_text_middle">
<p>Street Ride[ストリートライド]</p></div>
<div class="item_info_text_middle_b">
<p>TYPE-WAGON[タイプワゴン]</p></div>
</div></div>
...
<div class="swiper-slide"><img src="../../item_img/10162_1.jpg" alt="TYPE-WAGON"></div>
<div class="swiper-slide"><img src="../../item_img/10162_2.jpg" alt="TYPE-WAGON"></div>
<div class="swiper-slide"><img src="../../item_img/10162_3.jpg" alt="TYPE-WAGON"></div>
</div>
...
<p>シリンダーには単筒式を採用。ストリート走行の乗り心地を確保しながらレスポンスの良いハンドリングを実現。アッパーマウント付属モデル。</p>
</div>
<div id="panel2" class="tab_panel">
<p>・全長調整式<br>・強化ゴムアッパーマウント<br>・単筒式<br>・倒立式※ストラットタイプのみ<br>・減衰力固定式<br>・オーバーホール対応<br>・1年2万キロ保証</p>
</div>
</div>
</div>
</div>
...
<!--ココまでSP-->
<tr>
<p class="search_category">**********【適合検索】**********&nbsp;&nbsp;<a class="change_button" href="../../set/item/10162.php"><img src="../../img/set_button.jpg" alt="工賃セットの価格表はコチラ"></a></p>
</tr>
<tr>
<td>
<!-- 車両メーカー検索ココから -->
<p class="search_category">【自動車メーカー】</p>
<form method="post" action="10162.php">
...
if($data[0] == '10162') $position = explode(";", $data[1]);
}
array_pop($position);
fclose($fp_position);
...
<form name="make" method="post" action="10162.php">
