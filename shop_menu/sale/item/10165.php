<html>
<head>
<meta name="description" content="スポーツ系の車種用に減衰力などをスポーティー寄りの仕様。全長調整式、可動式ピロアッパーマウント、減衰力調整機構の全てを兼ね備えています。可動式ピロアッパーの採用でダイレクトなハンドリングと2度以上のキャンバー角を実現しました。街乗りからサーキット走行まで幅広く楽しみたい方に最適です。">
...
<title>KTS-web 商品ラインナップ Spiegel プロスペック ネオ</title>
...
<div class="mc_nav">
<a class="link" href="https://www.kts-web.com/">HOME</a> &gt; <a class="link" href="../../index.html">SHOP MENU</a> &gt; <a class="link" href="../../set/index.html">商品ラインナップ</a> &gt; <a class="link" href="../../set/cat/100.html">足回り</a> &gt; <a class="link" href="../../set/cat/116.html">車高調/セッティングパーツ</a> &gt; <a class="link" href="../../set/br/1082-116.html">Spiegel</a> &gt; <a class="link" href="10165.php">プロスペック ネオ</a></div>
<div class="space3px"></div>
<div class="set_sale_back">
<div class="space3px"></div>
<div class="set_menu_n">
<div class="set_menu_n_330">
<div><img src="../../brand/img/1082.gif" alt="プロスペック ネオ"></div></div>
<div class="set_menu_n_cell">
<div class="item_info_text_middle">
<p>Spiegel[シュピーゲル]</p></div>
...
<div class="swiper-slide"><img src="../../item_img/10165_1.jpg" alt="プロスペック ネオ"></div>
<div class="swiper-slide"><img src="../../item_img/10165_2.jpg" alt="プロスペック ネオ"></div>
<div class="swiper-slide"><img src="../../item_img/10165_3.jpg" alt="プロスペック ネオ"></div>
</div>
...
<p>スポーツ系の車種用に減衰力などをスポーティー寄りの仕様。全長調整式、可動式ピロアッパーマウント、減衰力調整機構の全てを兼ね備えています。可動式ピロアッパーの採用でダイレクトなハンドリングと2度以上のキャンバー角を実現しました。街乗りからサーキット走行まで幅広く楽しみたい方に最適です。</p>
</div>
<div id="panel2" class="tab_panel">
<p>・4輪共に全長調整式車高調整機能<br>・単筒正立式ショックアブソーバー<br>・減衰力調整機能付<br>・ピロアッパーマウント<br>・オーバーホール対応<br>・ダストブーツ付属・バンプラバー内蔵<br>・純正アッパーマウント使用<br>・車高レンチ2本付属・防錆加工済</p>
</div>
</div>
</div>
</div>
...
<!--ココまでSP-->
<tr>
<p class="search_category">**********【適合検索】**********&nbsp;&nbsp;<a class="change_button" href="../../set/item/10165.php"><img src="../../img/set_button.jpg" alt="工賃セットの価格表はコチラ"></a></p>
</tr>
<tr>
<td>
<!-- 車両メーカー検索ココから -->
<p class="search_category">【自動車メーカー】</p>
<form method="post" action="10165.php">
...
if($data[0] == '10165') $position = explode(";", $data[1]);
}
array_pop($position);
fclose($fp_position);
...
<form name="make" method="post" action="10165.php">
