...
<title>KTS-web 商品ラインナップ RS★R Ti2000 SUPER DOWN</title>
...
<div class="mc_nav">
<a class="link" href="https://www.kts-web.com/">HOME</a> &gt; <a class="link" href="../../index.html">SHOP MENU</a> &gt; <a class="link" href="../../set/index.html">商品ラインナップ</a> &gt; <a class="link" href="../../set/cat/100.html">足回り</a> &gt; <a class="link" href="../../set/cat/117.html">ダウンサス/アップサス</a> &gt; <a class="link" href="../../set/br/1001-117.html">RS★R</a> &gt; <a class="link" href="10148.php">Ti2000 SUPER DOWN</a></div>
<div class="space3px"></div>
<div class="set_sale_back">
<div class="space3px"></div>
<div class="set_menu_n">
<div class="set_menu_n_330">
<div><img src="../../brand/img/1001.gif" alt="Ti2000 SUPER DOWN"></div></div>
<div class="set_menu_n_cell">
<div class="item_info_text_middle">
<p>RS★R[アールエスアール]</p></div>
<div class="item_info_text_middle_b">
<p>商品名：Ti2000 SUPER DOWN[Ti2000 スーパーダウン]</p></div>
</div></div>
...
<div class="swiper-slide"><img src="../../item_img/10148_1.jpg" alt="Ti2000 SUPER DOWN"></div>
<div class="swiper-slide"><img src="../../item_img/10148_2.jpg" alt="Ti2000 SUPER DOWN"></div>
<div class="swiper-slide"><img src="../../item_img/10148_3.jpg" alt="Ti2000 SUPER DOWN"></div>
</div>
...
<p>デモカー、ショーモデル用に設定した超ローダウンサスタイプ(最低地上高を確保していませんので、一般道での走行は出来ません)。Ti2000スプリングはチタン配合の新素材が耐ヘタリ性をはじめ、あらゆる面でダントツの性能を発揮。 最高峰だからこそできる「ヘタリ永久保証」付きです。</p>
</div>
<div id="panel2" class="tab_panel">
<p>・ローダウンスプリング<br>・超ローダウンタイプ<br>・Ti2000スプリング<br>ヘタリ永久保証制度</p>
</div>
</div>
</div>
</div>
...
<div class="item_info_text_middle_b">
<p>Ti2000 SUPER DOWN [Ti2000 スーパーダウン]</p>
</div>
<div class="tab_wrap">
...
<!--ココまでSP-->
<tr>
<p class="search_category">**********【適合検索】**********&nbsp;&nbsp;<a class="change_button" href="../../set/item/10148.php"><img src="../../img/set_button.jpg" alt="工賃セットの価格表はコチラ"></a></p>
</tr>
<tr>
<td>
<!-- 車両メーカー検索ココから -->
<p class="search_category">【自動車メーカー】</p>
<form method="post" action="10148.php">
...
if($data[0] == '10148') $position = explode(";", $data[1]);
}
array_pop($position);
fclose($fp_position);
...
<form name="make" method="post" action="10148.php">
