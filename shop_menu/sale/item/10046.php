...
<title>KTS-web 商品ラインナップ ESPELIR Super DOWNSUS</title>
...
<div class="mc_nav">
<a class="link" href="https://www.kts-web.com/">HOME</a> &gt; <a class="link" href="../../index.html">SHOP MENU</a> &gt; <a class="link" href="../../set/index.html">商品ラインナップ</a> &gt; <a class="link" href="../../set/cat/100.html">足回り</a> &gt; <a class="link" href="../../set/cat/117.html">ダウンサス/アップサス</a> &gt; <a class="link" href="../../set/br/1030-117.html">ESPELIR</a> &gt; <a class="link" href="10046.php">Super DOWNSUS</a></div>
<div class="space3px"></div>
<div class="set_sale_back">
<div class="space3px"></div>
<div class="set_menu_n">
<div class="set_menu_n_330">
<div><img src="../../brand/img/1030.gif" alt="Super DOWNSUS"></div></div>
<div class="set_menu_n_cell">
<div class="item_info_text_middle">
<p>ESPELIR[エスペリア]</p></div>
<div class="item_info_text_middle_b">
<p>商品名：Super DOWNSUS[スーパーダウンサス]</p></div>
</div></div>
...
<div class="swiper-slide"><img src="../../item_img/10046_1.jpg" alt="Super DOWNSUS"></div>
<div class="swiper-slide"><img src="../../item_img/10046_2.jpg" alt="Super DOWNSUS"></div>
<div class="swiper-slide"><img src="../../item_img/10046_3.jpg" alt="Super DOWNSUS"></div>
</div>
...
<p>多種多様化している車に幅広く対応し、それぞれの車をベストなフォルムになるようダウン量を設定。同時に乗り心地を決定付けるストローク量を正確に算出し、反比例しがちなローダウンと乗り心地を両立させるよう設計開発しています。またスプリングの最大荷重時の高さを車種ごとに把握し、応力計算に反映することでへたりの無い耐久性に優れた製品になっています。</p>
</div>
...
<!--ココまでSP-->
<tr>
<p class="search_category">**********【適合検索】**********&nbsp;&nbsp;<a class="change_button" href="../../set/item/10046.php"><img src="../../img/set_button.jpg" alt="工賃セットの価格表はコチラ"></a></p>
</tr>
<tr>
<td>
<!-- 車両メーカー検索ココから -->
<p class="search_category">【自動車メーカー】</p>
<form method="post" action="10046.php">
...
if($data[0] == '10046') $position = explode(";", $data[1]);
}
array_pop($position);
fclose($fp_position);
...
<form name="make" method="post" action="10046.php">
