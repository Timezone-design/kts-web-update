...
<title>KTS-web 商品ラインナップ ENDLESS Super Function</title>
...
<div class="mc_nav">
<a class="link" href="https://www.kts-web.com/">HOME</a> &gt; <a class="link" href="../../index.html">SHOP MENU</a> &gt; <a class="link" href="../../set/index.html">商品ラインナップ</a> &gt; <a class="link" href="../../set/cat/100.html">足回り</a> &gt; <a class="link" href="../../set/cat/116.html">車高調/セッティングパーツ</a> &gt; <a class="link" href="../../set/br/1038-116.html">ENDLESS</a> &gt; <a class="link" href="10043.php">Super Function</a></div>
<div class="space3px"></div>
<div class="set_sale_back">
<div class="space3px"></div>
<div class="set_menu_n">
<div class="set_menu_n_330">
<div><img src="../../brand/img/1038.gif" alt="Super Function"></div></div>
<div class="set_menu_n_cell">
<div class="item_info_text_middle">
<p>ENDLESS[エンドレス]</p></div>
<div class="item_info_text_middle_b">
<p>Super Function[スーパーファンクション]</p></div>
</div></div>
...
<div class="swiper-slide"><img src="../../item_img/10043_1.jpg" alt="Super Function"></div>
<div class="swiper-slide"><img src="../../item_img/10043_2.jpg" alt="Super Function"></div>
<div class="swiper-slide"><img src="../../item_img/10043_3.jpg" alt="Super Function"></div>
</div>
...
<p>「Super Function」は、グリップ力の高いタイヤの装着を前提とした、サーキットスペックモデルです。本体を20段調整とし、より細かな減衰設定ができるようになりました。アッパーマウントにはピロボールを標準採用。シェルケースには軽量で放熱性に優れるアルミ素材を採用しております。ダイレクトなドライブフィールとバネ下重量の軽減を実現する。まさにタイムアタックマシン御用達のサスペンションキットです。</p>
</div>
<div id="panel2" class="tab_panel">
<p>・全長調整式<br>・減衰力20段調整<br>・単筒正立式※ストラットタイプは単筒倒立式<br>・オーバーホールOK<br>・リザーブタンク追加可能<br>・アルミシェルケース※ストラットタイプはスチールシェルケース</p>
</div>
</div>
</div>
</div>
...
<div class="item_info_text_middle_b">
<p>Super Function [スーパーファンクション]</p>
</div>
<div class="tab_wrap">
...
<!--ココまでSP-->
<tr>
<p class="search_category">**********【適合検索】**********&nbsp;&nbsp;<a class="change_button" href="../../set/item/10043.php"><img src="../../img/set_button.jpg" alt="工賃セットの価格表はコチラ"></a></p>
</tr>
<tr>
<td>
<!-- 車両メーカー検索ココから -->
<p class="search_category">【自動車メーカー】</p>
<form method="post" action="10043.php">
...
if($data[0] == '10043') $position = explode(";", $data[1]);
}
array_pop($position);
fclose($fp_position);
...
<form name="make" method="post" action="10043.php">
