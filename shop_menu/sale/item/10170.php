...
<title>KTS-web 商品ラインナップ TANABE GT FUNTORIDE DAMPER</title>
...
<div class="mc_nav">
<a class="link" href="https://www.kts-web.com/">HOME</a> &gt; <a class="link" href="../../index.html">SHOP MENU</a> &gt; <a class="link" href="../../set/index.html">商品ラインナップ</a> &gt; <a class="link" href="../../set/cat/100.html">足回り</a> &gt; <a class="link" href="../../set/cat/116.html">車高調/セッティングパーツ</a> &gt; <a class="link" href="../../set/br/1095-116.html">TANABE</a> &gt; <a class="link" href="10170.php">GT FUNTORIDE DAMPER</a></div>
<div class="space3px"></div>
<div class="set_sale_back">
<div class="space3px"></div>
<div class="set_menu_n">
<div class="set_menu_n_330">
<div><img src="../../brand/img/1095.gif" alt="GT FUNTORIDE DAMPER"></div></div>
<div class="set_menu_n_cell">
<div class="item_info_text_middle">
<p>TANABE[タナベ]</p></div>
<div class="item_info_text_middle_b">
<p>GT FUNTORIDE DAMPER[GTファントライド ダンパー]</p></div>
</div></div>
...
<div class="swiper-slide"><img src="../../item_img/10170_1.jpg" alt="GT FUNTORIDE DAMPER"></div>
<div class="swiper-slide"><img src="../../item_img/10170_2.jpg" alt="GT FUNTORIDE DAMPER"></div>
<div class="swiper-slide"><img src="../../item_img/10170_3.jpg" alt="GT FUNTORIDE DAMPER"></div>
</div>
...
<p>セッティングテーマは「妥協なき、しなやかさ」。運動性能を高めつつも、スポーツタイプのダンパーに見られがちな「不快な硬さ」を徹底して抑え込んでいます。そのフィーリングは、アスファルトをランニングシューズで駆けるような感触。さらに、ハンドリングやライド感は、搭載する多彩なアジャスト機能によって、自由にコントロール可能。走りの性能を高めつつ大切な人とのドライブも、気持ちよく楽しく＝FUN TOにこなせます。</p>
</div>
<div id="panel2" class="tab_panel">
<p>・フルタップ(全長調整)式<br>・スポーツカー・スポーツグレード専用ダンパー<br>・40段減衰力調整機能<br>・大容量ベアリング＋スラストシート<br>・グリップ性能を引き出す高い剛性感<br>・PRO210スプリング<br>・テーパー型ブラケットロック<br>・車種別専用設計<br>・ツイン防錆コーティング<br>・1年間・走行距離10,000kmの保証</p>
</div>
</div>
</div>
</div>
...
<div class="item_info_text_middle_b">
<p>GT FUNTORIDE DAMPER [GTファントライド ダンパー]</p>
</div>
<div class="tab_wrap">
...
<!--ココまでSP-->
<tr>
<p class="search_category">**********【適合検索】**********&nbsp;&nbsp;<a class="change_button" href="../../set/item/10170.php"><img src="../../img/set_button.jpg" alt="工賃セットの価格表はコチラ"></a></p>
</tr>
<tr>
<td>
<!-- 車両メーカー検索ココから -->
<p class="search_category">【自動車メーカー】</p>
<form method="post" action="10170.php">
...
if($data[0] == '10170') $position = explode(";", $data[1]);
}
array_pop($position);
fclose($fp_position);
...
<form name="make" method="post" action="10170.php">
