<html>
<head>
<meta name="description" content="オールラウンドの名が示す通り、ストリートのスポーツ走行からサーキット走行までこなす超ワイドレンジモデル<br>ストリートスポーツパッドに不可欠な低温域でのリニアな効き、そしてマイルドなローター攻撃性<br>サーキットでの高温域でも安定した効力、高い耐フェード性<br>ハイグリップラジアルタイヤにベストマッチ">
...
<div class="swiper-slide"><img src="../../item_img/10350_1.jpg" alt="Z type"></div>
<div class="swiper-slide"><img src="../../item_img/10350_2.jpg" alt="Z type"></div>
<div class="swiper-slide"><img src="../../item_img/10350_3.jpg" alt="Z type"></div>
</div>
...
<p>オールラウンドの名が示す通り、ストリートのスポーツ走行からサーキット走行までこなす超ワイドレンジモデル<br>ストリートスポーツパッドに不可欠な低温域でのリニアな効き、そしてマイルドなローター攻撃性<br>サーキットでの高温域でも安定した効力、高い耐フェード性<br>ハイグリップラジアルタイヤにベストマッチ</p>
</div>
<div id="panel2" class="tab_panel">
<p>・材質:グラファイト メタリック<br>・適正温度:0～850℃<br>・Max μ:0.67<br>・Ave μ:0.57<br>・Min μ:0.50<br>・ステージ:ストリート/ワインディング(ノーマル)/ワインディング(ハード)/サーキット/ジムカーナ</p>
</div>
</div>
</div>
</div>
...
<!--ココまでSP-->
<tr>
<p class="search_category">**********【適合検索】**********&nbsp;&nbsp;<a class="change_button" href="../../set/item/10350.php"><img src="../../img/set_button.jpg" alt="工賃セットの価格表はコチラ"></a></p>
</tr>
<tr>
<td>
<!-- 車両メーカー検索ココから -->
<p class="search_category">【自動車メーカー】</p>
<form method="post" action="10350.php">
...
if($data[0] == '10350') $position = explode(";", $data[1]);
}
array_pop($position);
fclose($fp_position);
...
<form name="make" method="post" action="10350.php">
