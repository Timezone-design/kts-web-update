...
<title>KTS-web 商品ラインナップ Spiegel プロスペック ベーシック</title>
...
<div class="mc_nav">
<a class="link" href="https://www.kts-web.com/">HOME</a> &gt; <a class="link" href="../../index.html">SHOP MENU</a> &gt; <a class="link" href="../../set/index.html">商品ラインナップ</a> &gt; <a class="link" href="../../set/cat/100.html">足回り</a> &gt; <a class="link" href="../../set/cat/116.html">車高調/セッティングパーツ</a> &gt; <a class="link" href="../../set/br/1082-116.html">Spiegel</a> &gt; <a class="link" href="10164.php">プロスペック ベーシック</a></div>
<div class="space3px"></div>
<div class="set_sale_back">
<div class="space3px"></div>
<div class="set_menu_n">
<div class="set_menu_n_330">
<div><img src="../../brand/img/1082.gif" alt="プロスペック ベーシック"></div></div>
<div class="set_menu_n_cell">
<div class="item_info_text_middle">
<p>Spiegel[シュピーゲル]</p></div>
<div class="item_info_text_middle_b">
<p>プロスペック ベーシック</p></div>
</div></div>
...
<div class="swiper-slide"><img src="../../item_img/10164_1.jpg" alt="プロスペック ベーシック"></div>
<div class="swiper-slide"><img src="../../item_img/10164_2.jpg" alt="プロスペック ベーシック"></div>
<div class="swiper-slide"><img src="../../item_img/10164_3.jpg" alt="プロスペック ベーシック"></div>
</div>
...
<p>純正アッパーマウントを使用するので、静粛性や乗り心地をそこなわずに車高の上下が可能です。ロアブラケットで若干のキャンバー角をつけることも可能で、高速安定性が増しワインディングでも快適なドライブが楽しめます。静粛性と乗り心地を両立し、スポーツ走行を楽しみたい方や初めて車高調をご使用される方におすすめ。</p>
</div>
<div id="panel2" class="tab_panel">
<p>・4輪共に全長調整式車高調整機能<br>・単筒正立式ショックアブソーバー<br>・減衰力調整機能付<br>・オーバーホール対応<br>・ダストブーツ付属・バンプラバー内蔵<br>・純正アッパーマウント使用<br>・車高レンチ2本付属・防錆加工済</p>
</div>
</div>
</div>
</div>
...
<!--ココまでSP-->
<tr>
<p class="search_category">**********【適合検索】**********&nbsp;&nbsp;<a class="change_button" href="../../set/item/10164.php"><img src="../../img/set_button.jpg" alt="工賃セットの価格表はコチラ"></a></p>
</tr>
<tr>
<td>
<!-- 車両メーカー検索ココから -->
<p class="search_category">【自動車メーカー】</p>
<form method="post" action="10164.php">
...
if($data[0] == '10164') $position = explode(";", $data[1]);
}
array_pop($position);
fclose($fp_position);
...
<form name="make" method="post" action="10164.php">
