...
<title>KTS-web 商品ラインナップ OHLINS Type NS</title>
...
<div class="mc_nav">
<a class="link" href="https://www.kts-web.com/">HOME</a> &gt; <a class="link" href="../../index.html">SHOP MENU</a> &gt; <a class="link" href="../../set/index.html">商品ラインナップ</a> &gt; <a class="link" href="../../set/cat/100.html">足回り</a> &gt; <a class="link" href="../../set/cat/118.html">ショックアブソーバー</a> &gt; <a class="link" href="../../set/br/1046-118.html">OHLINS</a> &gt; <a class="link" href="10121.php">Type NS</a></div>
<div class="space3px"></div>
<div class="set_sale_back">
<div class="space3px"></div>
<div class="set_menu_n">
<div class="set_menu_n_330">
<div><img src="../../brand/img/1046.gif" alt="Type NS"></div></div>
<div class="set_menu_n_cell">
<div class="item_info_text_middle">
<p>OHLINS[オーリンズ]</p></div>
<div class="item_info_text_middle_b">
<p>商品名：Type NS[タイプNS]</p></div>
</div></div>
...
<div class="swiper-slide"><img src="../../item_img/10121_1.jpg" alt="Type NS"></div>
<div class="swiper-slide"><img src="../../item_img/10121_2.jpg" alt="Type NS"></div>
<div class="swiper-slide"><img src="../../item_img/10121_3.jpg" alt="Type NS"></div>
</div>
...
<p>レースカーを見るまでもなく、運動性能を高めようとすると、クルマの重心は低い方が有利。しかし、公道を走るクルマがやみくもに車高を下げるわけにはいきません。オーリンズのショートモデルは、十分なストロークを確保しながら、精悍な姿勢と実用に足りるロードクリアランスを絶妙なバランスで実現しています。</p>
</div>
...
<!--ココまでSP-->
<tr>
<p class="search_category">**********【適合検索】**********&nbsp;&nbsp;<a class="change_button" href="../../set/item/10121.php"><img src="../../img/set_button.jpg" alt="工賃セットの価格表はコチラ"></a></p>
</tr>
<tr>
<td>
<!-- 車両メーカー検索ココから -->
<p class="search_category">【自動車メーカー】</p>
<form method="post" action="10121.php">
...
if($data[0] == '10121') $position = explode(";", $data[1]);
}
array_pop($position);
fclose($fp_position);
...
<form name="make" method="post" action="10121.php">
