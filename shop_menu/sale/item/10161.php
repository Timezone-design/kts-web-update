...
<title>KTS-web 商品ラインナップ Street Ride TYPE-SEDAN MODEL COMFORT</title>
...
<div class="mc_nav">
<a class="link" href="https://www.kts-web.com/">HOME</a> &gt; <a class="link" href="../../index.html">SHOP MENU</a> &gt; <a class="link" href="../../set/index.html">商品ラインナップ</a> &gt; <a class="link" href="../../set/cat/100.html">足回り</a> &gt; <a class="link" href="../../set/cat/116.html">車高調/セッティングパーツ</a> &gt; <a class="link" href="../../set/br/1090-116.html">Street Ride</a> &gt; <a class="link" href="10161.php">TYPE-SEDAN MODEL COMFORT</a></div>
<div class="space3px"></div>
<div class="set_sale_back">
<div class="space3px"></div>
<div class="set_menu_n">
<div class="set_menu_n_330">
<div><img src="../../brand/img/1090.gif" alt="TYPE-SEDAN MODEL COMFORT"></div></div>
<div class="set_menu_n_cell">
<div class="item_info_text_middle">
<p>Street Ride[ストリートライド]</p></div>
<div class="item_info_text_middle_b">
<p>TYPE-SEDAN MODEL COMFORT[タイプセダン モデル コンフォート]</p></div>
</div></div>
...
<div class="swiper-slide"><img src="../../item_img/10161_1.jpg" alt="TYPE-SEDAN MODEL COMFORT"></div>
<div class="swiper-slide"><img src="../../item_img/10161_2.jpg" alt="TYPE-SEDAN MODEL COMFORT"></div>
<div class="swiper-slide"><img src="../../item_img/10161_3.jpg" alt="TYPE-SEDAN MODEL COMFORT"></div>
</div>
...
<p>純正相当の乗り心地を追求。フロントにプライマリースプリングを採用。乗り心地に特化した商品。</p>
</div>
<div id="panel2" class="tab_panel">
<p>・全長調整式<br>・強化ゴムアッパーマウント<br>・正立式<br>・ツインスプリングシステム<br>・減衰力15段調整式<br>・オーバーホール対応<br>・1年2万キロ保証</p>
</div>
</div>
</div>
</div>
...
<div class="item_info_text_middle">
<p>Street Ride [ストリートライド]</p>
</div>
<div class="item_info_text_middle_b">
<p>TYPE-SEDAN MODEL COMFORT [タイプセダン モデル コンフォート]</p>
</div>
<div class="tab_wrap">
...
<!--ココまでSP-->
<tr>
<p class="search_category">**********【適合検索】**********&nbsp;&nbsp;<a class="change_button" href="../../set/item/10161.php"><img src="../../img/set_button.jpg" alt="工賃セットの価格表はコチラ"></a></p>
</tr>
<tr>
<td>
<!-- 車両メーカー検索ココから -->
<p class="search_category">【自動車メーカー】</p>
<form method="post" action="10161.php">
...
if($data[0] == '10161') $position = explode(";", $data[1]);
}
array_pop($position);
fclose($fp_position);
...
<form name="make" method="post" action="10161.php">
