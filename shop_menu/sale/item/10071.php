<html>
<head>
<meta name="description" content="機能性も重視したビギナーズモデル！街乗りでの快適な乗り心地を楽しめ減衰力20段階調整の機能性も重視したビギナーズモデルもちろん価格もロープライスです。+ α は1年間、2万キロの製品保証付き！">
...
<title>KTS-web 商品ラインナップ FINAL KONNEXION STYLE KIDS + α PROSHOP VERSION</title>
...
{
@id: "/item/10071.php",
name: "STYLE KIDS + α PROSHOP VERSION"
}
}
]
}
...
<p>STYLE KIDS + α PROSHOP VERSION[スタイルキッズダンパー+α プロショップバージョン]</p></div>
</div></div>
...
<div class="swiper-slide"><img src="../../item_img/10071_1.jpg" alt="STYLE KIDS + α PROSHOP VERSION"></div>
<div class="swiper-slide"><img src="../../item_img/10071_2.jpg" alt="STYLE KIDS + α PROSHOP VERSION"></div>
<div class="swiper-slide"><img src="../../item_img/10071_3.jpg" alt="STYLE KIDS + α PROSHOP VERSION"></div>
</div>
...
<p>機能性も重視したビギナーズモデル！街乗りでの快適な乗り心地を楽しめ減衰力20段階調整の機能性も重視したビギナーズモデルもちろん価格もロープライスです。+ α は1年間、2万キロの製品保証付き！</p>
</div>
<div id="panel2" class="tab_panel">
<p>・全長調整式<br>・単筒式<br>・減衰力 20 段調整機能付<br>・オーバーホール可能<br>・車高調レンチ、製品証明書、オリジナルステッカー付属<br>・1年間、2万Km製品保証付き</p>
</div>
</div>
</div>
</div>
...
<div class="item_info_text_middle_b">
<p>STYLE KIDS + α PROSHOP VERSION [スタイルキッズダンパー+α プロショップバージョン]</p>
</div>
<div class="tab_wrap">
...
<!--ココまでSP-->
<tr>
<p class="search_category">**********【適合検索】**********&nbsp;&nbsp;<a class="change_button" href="../../set/item/10071.php"><img src="../../img/set_button.jpg" alt="工賃セットの価格表はコチラ"></a></p>
</tr>
<tr>
<td>
<!-- 車両メーカー検索ココから -->
<p class="search_category">【自動車メーカー】</p>
<form method="post" action="10071.php">
...
if($data[0] == '10071') $position = explode(";", $data[1]);
}
array_pop($position);
fclose($fp_position);
...
<form name="make" method="post" action="10071.php">
