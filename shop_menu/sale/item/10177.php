...
<title>KTS-web 商品ラインナップ TANABE SUSTEC NF210</title>
...
<div class="mc_nav">
<a class="link" href="https://www.kts-web.com/">HOME</a> &gt; <a class="link" href="../../index.html">SHOP MENU</a> &gt; <a class="link" href="../../set/index.html">商品ラインナップ</a> &gt; <a class="link" href="../../set/cat/100.html">足回り</a> &gt; <a class="link" href="../../set/cat/117.html">ダウンサス/アップサス</a> &gt; <a class="link" href="../../set/br/1095-117.html">TANABE</a> &gt; <a class="link" href="10177.php">SUSTEC NF210</a></div>
<div class="space3px"></div>
<div class="set_sale_back">
<div class="space3px"></div>
<div class="set_menu_n">
<div class="set_menu_n_330">
<div><img src="../../brand/img/1095.gif" alt="SUSTEC NF210"></div></div>
<div class="set_menu_n_cell">
<div class="item_info_text_middle">
<p>TANABE[タナベ]</p></div>
<div class="item_info_text_middle_b">
<p>商品名：SUSTEC NF210[サステック NF210]</p></div>
</div></div>
...
<div class="swiper-slide"><img src="../../item_img/10177_1.jpg" alt="SUSTEC NF210"></div>
<div class="swiper-slide"><img src="../../item_img/10177_2.jpg" alt="SUSTEC NF210"></div>
<div class="swiper-slide"><img src="../../item_img/10177_3.jpg" alt="SUSTEC NF210"></div>
</div>
...
<p>ノーマルフィーリングをリアルに再現。ほどよくナチュラルなダウン量です。<br>ローダウン=硬いという方程式を見事に覆し、乗り心地を損なうことなくスタイリッシュなローダウンを可能にした柔軟設計、それがサステックNF210。30〜40mmものローダウンを実現しているにもかかわらず、バネレートは10%未満（ノーマル比）という数値は純正とほぼ同等の乗り心地を再現してくれます。快適でスムーズなドライブフィーリングを大切にしたい方にお奨めのサスペンションです。</p>
</div>
<div id="panel2" class="tab_panel">
<p>・へたり永久保証<br>・超軽量・超耐久性・超精密性<br>・引っ張り強度2100N/mm<br>・圧倒的に強い特殊塗装</p>
</div>
</div>
</div>
</div>
...
<!--ココまでSP-->
<tr>
<p class="search_category">**********【適合検索】**********&nbsp;&nbsp;<a class="change_button" href="../../set/item/10177.php"><img src="../../img/set_button.jpg" alt="工賃セットの価格表はコチラ"></a></p>
</tr>
<tr>
<td>
<!-- 車両メーカー検索ココから -->
<p class="search_category">【自動車メーカー】</p>
<form method="post" action="10177.php">
...
if($data[0] == '10177') $position = explode(";", $data[1]);
}
array_pop($position);
fclose($fp_position);
...
<form name="make" method="post" action="10177.php">
