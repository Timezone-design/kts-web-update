<html>
<head>
<meta name="description" content="このRDもRの名が示すとおり他のRシリーズ同様にコンペティション用として開発されました。サイドブレーキやフットブレーキでのリヤロックを容易にし、スピンターンやドリフトのきっかけつくりには最適なリヤ専用コンペティションパッドです。 ジムカーナ、ダートトライアル、ラリー、ドリフトなどの競技に参戦しようと考えている方に是非、選んで頂きたいアイテムです。">
...
<div class="swiper-slide"><img src="../../item_img/10356_1.jpg" alt="RD type"></div>
<div class="swiper-slide"><img src="../../item_img/10356_2.jpg" alt="RD type"></div>
<div class="swiper-slide"><img src="../../item_img/10356_3.jpg" alt="RD type"></div>
</div>
...
<p>このRDもRの名が示すとおり他のRシリーズ同様にコンペティション用として開発されました。サイドブレーキやフットブレーキでのリヤロックを容易にし、スピンターンやドリフトのきっかけつくりには最適なリヤ専用コンペティションパッドです。 ジムカーナ、ダートトライアル、ラリー、ドリフトなどの競技に参戦しようと考えている方に是非、選んで頂きたいアイテムです。</p>
</div>
<div id="panel2" class="tab_panel">
<p>・材質:シンタードメタリック<br>・有効温度内<br>・平均摩擦係数:0.55～0.60<br>・ステージ:ジムカーナ/ドリフト/ラリー/ダートトライアル</p>
</div>
</div>
</div>
</div>
...
<!--ココまでSP-->
<tr>
<p class="search_category">**********【適合検索】**********&nbsp;&nbsp;<a class="change_button" href="../../set/item/10356.php"><img src="../../img/set_button.jpg" alt="工賃セットの価格表はコチラ"></a></p>
</tr>
<tr>
<td>
<!-- 車両メーカー検索ココから -->
<p class="search_category">【自動車メーカー】</p>
<form method="post" action="10356.php">
...
if($data[0] == '10356') $position = explode(";", $data[1]);
}
array_pop($position);
fclose($fp_position);
...
<form name="make" method="post" action="10356.php">
