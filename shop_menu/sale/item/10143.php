...
<title>KTS-web 商品ラインナップ RS★R Best☆i上下</title>
...
<div class="mc_nav">
<a class="link" href="https://www.kts-web.com/">HOME</a> &gt; <a class="link" href="../../index.html">SHOP MENU</a> &gt; <a class="link" href="../../set/index.html">商品ラインナップ</a> &gt; <a class="link" href="../../set/cat/100.html">足回り</a> &gt; <a class="link" href="../../set/cat/116.html">車高調/セッティングパーツ</a> &gt; <a class="link" href="../../set/br/1001-116.html">RS★R</a> &gt; <a class="link" href="10143.php">Best☆i上下</a></div>
<div class="space3px"></div>
<div class="set_sale_back">
<div class="space3px"></div>
<div class="set_menu_n">
<div class="set_menu_n_330">
<div><img src="../../brand/img/1001.gif" alt="Best☆i上下"></div></div>
<div class="set_menu_n_cell">
<div class="item_info_text_middle">
<p>RS★R[アールエスアール]</p></div>
<div class="item_info_text_middle_b">
<p>Best☆i上下[ベストアイ 上下]</p></div>
</div></div>
...
<div class="swiper-slide"><img src="../../item_img/10143_1.jpg" alt="Best☆i上下"></div>
<div class="swiper-slide"><img src="../../item_img/10143_2.jpg" alt="Best☆i上下"></div>
<div class="swiper-slide"><img src="../../item_img/10143_3.jpg" alt="Best☆i上下"></div>
</div>
...
<p>「車高アップを可能にし、ワイルドな存在感をアピールできる車高調」を開発コンセプトとしてオンロード・オフロードを問わず安定した走りを実現するため専用設計。車高を上げ下げしてもしっかりストロークを確保しているので、お気に入りのフォルムで納得の走りを演出。あらゆるシチュエーションで機能性と見た目を兼ね備えた車高調です</p>
</div>
<div id="panel2" class="tab_panel">
<p>・全長調整式<br>・減衰力36段調整※一部車種除く<br>・単筒式<br>・ストリートユース向けオイル採用<br>・Ti2000スプリング採用<br>・スチールアッパーマウント(一部車種を除く)<br>・充実の製品保証制度</p>
</div>
</div>
</div>
</div>
...
<!--ココまでSP-->
<tr>
<p class="search_category">**********【適合検索】**********&nbsp;&nbsp;<a class="change_button" href="../../set/item/10143.php"><img src="../../img/set_button.jpg" alt="工賃セットの価格表はコチラ"></a></p>
</tr>
<tr>
<td>
<!-- 車両メーカー検索ココから -->
<p class="search_category">【自動車メーカー】</p>
<form method="post" action="10143.php">
...
if($data[0] == '10143') $position = explode(";", $data[1]);
}
array_pop($position);
fclose($fp_position);
...
<form name="make" method="post" action="10143.php">
