...
<title>KTS-web 商品ラインナップ KYB NEW SR SPECIAL</title>
...
<div class="mc_nav">
<a class="link" href="https://www.kts-web.com/">HOME</a> &gt; <a class="link" href="../../index.html">SHOP MENU</a> &gt; <a class="link" href="../../set/index.html">商品ラインナップ</a> &gt; <a class="link" href="../../set/cat/100.html">足回り</a> &gt; <a class="link" href="../../set/cat/118.html">ショックアブソーバー</a> &gt; <a class="link" href="../../set/br/1054-118.html">KYB</a> &gt; <a class="link" href="10106.php">NEW SR SPECIAL</a></div>
<div class="space3px"></div>
<div class="set_sale_back">
<div class="space3px"></div>
<div class="set_menu_n">
<div class="set_menu_n_330">
<div><img src="../../brand/img/1054.gif" alt="NEW SR SPECIAL"></div></div>
<div class="set_menu_n_cell">
<div class="item_info_text_middle">
<p>KYB[カヤバ]</p></div>
<div class="item_info_text_middle_b">
<p>商品名：NEW SR SPECIAL[ニューSR スペシャル]</p></div>
</div></div>
...
<div class="swiper-slide"><img src="../../item_img/10106_1.jpg" alt="NEW SR SPECIAL"></div>
<div class="swiper-slide"><img src="../../item_img/10106_2.jpg" alt="NEW SR SPECIAL"></div>
<div class="swiper-slide"><img src="../../item_img/10106_3.jpg" alt="NEW SR SPECIAL"></div>
</div>
...
<p>NEW SR SPECIALは純正ショックアブソーバと同等の形状を採用、耐久性など品質はそのままに減衰力特性を最適化することで、「硬くないけどシッカリ！」普段使いの軽快なカジュアルシューズを履いた感覚で安心して走れる、なんか運転がうまくなった？と思わせるショックアブソーバに仕上げられています。</p>
</div>
<div id="panel2" class="tab_panel">
<p>・純正形状<br>・減衰力固定式<br>・適応車種 国内 No1</p>
</div>
</div>
</div>
</div>
...
<div class="item_info_text_middle_b">
<p>NEW SR SPECIAL [ニューSR スペシャル]</p>
</div>
<div class="tab_wrap">
...
<!--ココまでSP-->
<tr>
<p class="search_category">**********【適合検索】**********&nbsp;&nbsp;<a class="change_button" href="../../set/item/10106.php"><img src="../../img/set_button.jpg" alt="工賃セットの価格表はコチラ"></a></p>
</tr>
<tr>
<td>
<!-- 車両メーカー検索ココから -->
<p class="search_category">【自動車メーカー】</p>
<form method="post" action="10106.php">
...
if($data[0] == '10106') $position = explode(";", $data[1]);
}
array_pop($position);
fclose($fp_position);
...
<form name="make" method="post" action="10106.php">
