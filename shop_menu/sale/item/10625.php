...
<div class="set_menu_n_cell col-md-6 col-sm-12 col-xs-12">
<a class="set-sale-switch" href="../../set/item/10625.php"><img alt="取付へのリンク" src="../../img/itemlead_to_tori.jpg"/></a>
</div>
</div>
<div class="clearfix">
</div>
...
<?php	                  	$root_dir = __DIR__.'/../../..';						$uri = 'shop_menu/sale/item/'.basename(__FILE__).'#search-block';						include(__DIR__.'/../../../_partials/product_search41.php');						?>
</div>
</div>
