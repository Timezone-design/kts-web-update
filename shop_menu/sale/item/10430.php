<html>
<head>
<meta name="description" content="KTSは独自にBrake Quip製ブレーキ部材を輸入し、国内の指定工場にて車種専用に組み立て出荷いたします。ブレーキラインは全て組付後、3,000psiにて耐圧テストを行い合格後の出荷となりますので安心して御使用頂けます。">
...
<title>KTS-web 商品ラインナップ Brake Quip ステンメッシュブレーキライン</title>
...
<div class="mc_nav">
<a class="link" href="https://www.kts-web.com/">HOME</a> &gt; <a class="link" href="../../index.html">SHOP MENU</a> &gt; <a class="link" href="../../set/index.html">商品ラインナップ</a> &gt; <a class="link" href="../../set/cat/103.html">ブレーキ</a> &gt; <a class="link" href="../../set/cat/132.html">ブレーキホース</a> &gt; <a class="link" href="../../set/br/1168-132.html">Brake Quip</a> &gt; <a class="link" href="10430.php">ステンメッシュブレーキライン</a></div>
<div class="space3px"></div>
<div class="set_sale_back">
<div class="space3px"></div>
<div class="set_menu_n">
<div class="set_menu_n_330">
<div><img src="../../brand/img/1168.gif" alt="ステンメッシュブレーキライン"></div></div>
<div class="set_menu_n_cell">
<div class="item_info_text_middle">
<p>Brake Quip[ブレーキクイップ]</p></div>
<div class="item_info_text_middle_b">
<p>ステンメッシュブレーキライン</p></div>
</div></div>
...
<div class="swiper-slide"><img src="../../item_img/10430_1.jpg" alt="ステンメッシュブレーキライン"></div>
<div class="swiper-slide"><img src="../../item_img/10430_2.jpg" alt="ステンメッシュブレーキライン"></div>
<div class="swiper-slide"><img src="../../item_img/10430_3.jpg" alt="ステンメッシュブレーキライン"></div>
</div>
...
<p>KTSは独自にBrake Quip製ブレーキ部材を輸入し、国内の指定工場にて車種専用に組み立て出荷いたします。ブレーキラインは全て組付後、3,000psiにて耐圧テストを行い合格後の出荷となりますので安心して御使用頂けます。<br>詳細は<a href="https://www.kts-web.com/brake_quip/index.html">コチラ</a></p>
</div>
<div id="panel2" class="tab_panel">
<p>・ステンレスメッシュブレーキホース<br>・全品耐圧テスト済<br>・オプションカラー有り<br>・長さオーダー可能</p>
</div>
</div>
</div>
</div>
...
<!--ココまでSP-->
<tr>
<p class="search_category">**********【適合検索】**********&nbsp;&nbsp;<a class="change_button" href="../../set/item/10430.php"><img src="../../img/set_button.jpg" alt="工賃セットの価格表はコチラ"></a></p>
</tr>
<tr>
<td>
<!-- 車両メーカー検索ココから -->
<p class="search_category">【自動車メーカー】</p>
<form method="post" action="10430.php">
...
if($data[0] == '10430') $position = explode(";", $data[1]);
}
array_pop($position);
fclose($fp_position);
...
<form name="make" method="post" action="10430.php">
...
print_r('<th>セット内容</th>');
print_r('<th>タイプ</th>');
print_r('<th>ホースカラー</th>');
print_r('<th>ジャケットカラー</th>');
print_r('<th>備考</th></tr>');
