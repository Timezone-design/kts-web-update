<html>
<head>
<meta name="description" content="増大したパワーとトルクをドライバーのコントロールの範囲に過不足無く適応されたクラッチキット<br>は純正品よりも大容量で、ディスク径、レバー比等の再設計により、踏力が同じで半クラッチのオン/オフの感覚が判りやすく、ギヤボックスに負担を掛けない、更に大人の左足に負担を掛けない、「特別な日」を必要としない快適なクラッチキットです。ただし大出力には適応しません。">
...
<div class="mc_nav">
<a class="link" href="https://www.kts-web.com/">HOME</a> &gt; <a class="link" href="../../index.html">SHOP MENU</a> &gt; <a class="link" href="../../set/index.html">商品ラインナップ</a> &gt; <a class="link" href="../../set/cat/101.html">駆動系</a> &gt; <a class="link" href="../../set/cat/124.html">クラッチ/フライホイール</a> &gt; <a class="link" href="../../set/br/1111-124.html">戸田レーシング</a> &gt; <a class="link" href="10477.php">OJISAMAスポーツクラッチKIT</a></div>
<div class="space3px"></div>
<div class="set_sale_back">
<div class="space3px"></div>
<div class="set_menu_n">
<div class="set_menu_n_330">
<div><img src="../../brand/img/1111.gif" alt="OJISAMAスポーツクラッチKIT"></div></div>
<div class="set_menu_n_cell">
<div class="item_info_text_middle">
<p>戸田レーシング[トダレーシング]</p></div>
<div class="item_info_text_middle_b">
<p>OJISAMAスポーツクラッチKIT</p></div>
</div></div>
...
<div class="swiper-slide"><img src="../../item_img/10477_1.jpg" alt="OJISAMAスポーツクラッチKIT"></div>
<div class="swiper-slide"><img src="../../item_img/10477_2.jpg" alt="OJISAMAスポーツクラッチKIT"></div>
<div class="swiper-slide"><img src="../../item_img/10477_3.jpg" alt="OJISAMAスポーツクラッチKIT"></div>
</div>
...
<p>増大したパワーとトルクをドライバーのコントロールの範囲に過不足無く適応されたクラッチキット<br>は純正品よりも大容量で、ディスク径、レバー比等の再設計により、踏力が同じで半クラッチのオン/オフの感覚が判りやすく、ギヤボックスに負担を掛けない、更に大人の左足に負担を掛けない、「特別な日」を必要としない快適なクラッチキットです。ただし大出力には適応しません。</p>
</div>
<div id="panel2" class="tab_panel">
<p>・クラッチ応答性の向上<br>・ハイクオリティ クロモリフライホイール<br>・大径ディスクを採用</p>
</div>
</div>
</div>
</div>
...
<!--ココまでSP-->
<tr>
<p class="search_category">**********【適合検索】**********&nbsp;&nbsp;<a class="change_button" href="../../set/item/10477.php"><img src="../../img/set_button.jpg" alt="工賃セットの価格表はコチラ"></a></p>
</tr>
<tr>
<td>
<!-- 車両メーカー検索ココから -->
<p class="search_category">【自動車メーカー】</p>
<form method="post" action="10477.php">
...
if($data[0] == '10477') $position = explode(";", $data[1]);
}
array_pop($position);
fclose($fp_position);
...
<form name="make" method="post" action="10477.php">
