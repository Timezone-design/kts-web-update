...
<meta content="text/html; charset=utf-8" http-equiv="Content-Type"/> <title>KTS-web 商品ラインナップ KTS SC DAMPER SYSTEM β</title><script src="https://ajax.googleapis.com/ajax/libs/jquery/3.1.1/jquery.min.js"></script><script type="text/javascript">        $(function(){                $("#toggle").click(function(){                        $("#menu").slideToggle();                        return false;                });                $(window).resize(function(){                        var win = $(window).width();                        var p = 480 ;                        if(win > p){                                $("#menu").show();                        }                        else {                                $("#menu").hide();                        }                });        });</script><script>        (function(i,s,o,g,r,a,m){i['GoogleAnalyticsObject']=r;i[r]=i[r]||function(){                (i[r].q=i[r].q||[]).push(arguments)},i[r].l=1*new                Date();a=s.createElement(o),                m=s.getElementsByTagName(o)[0];a.async=1;a.src=g;m.parentNode.insertBefore(a,m)        })(window,document,'script','//www.google-analytics.com/analytics.js','ga');        ga('create', 'UA-73570160-3', 'auto');        ga('send', 'pageview');</script><!-- 行ごとリンクココから --><script type="text/javascript">jQuery(function($) {	$('tr[data-href]').addClass('clickable')		.click(function(e) {			if(!$(e.target).is('a')){				let href=$(e.target).closest('tr').data('href');				window.open(href, "_blank");			};		});});</script><!-- 行ごとリンクココまで -->
...
<li class="nav-item"><a class="nav-link" href="https://www.kts-web.com/blog/">
...
<div class="item_info_text_middle"> <p>KTS [ケーティーエス]</p> </div> <div class="item_info_text_middle_b"> <p>SC DAMPER SYSTEM β [SCダンパーシステムβ]</p> </div>
</div>
</div>
<div class="set_menu_n row">
<div class="set_menu_n_330 col-md-6 col-sm-12 col-xs-12">
<div>
<div class="swiper-container"> <div class="swiper-wrapper"> <div class="swiper-slide"><img alt="SC DAMPER SYSTEM β" src="../../item_img/10000_1.jpg"/></div> <div class="swiper-slide"><img alt="SC DAMPER SYSTEM β" src="../../item_img/10000_2.jpg"/></div> <div class="swiper-slide"><img alt="SC DAMPER SYSTEM β" src="../../item_img/10000_3.jpg"/></div> </div> <div class="swiper-button-prev"></div> <div class="swiper-button-next"></div> </div>
</div>
