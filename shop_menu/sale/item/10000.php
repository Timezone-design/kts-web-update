 			...
 			<div class="section-container">
 				<div id="content-wrapper">
 					...
 					<header class="site-header">
 						<nav class="navbar navbar-expand-lg navbar-dark"> <a class="navbar-brand" href="/"><img id="header-logo"
 									class="logo" src="/img/opg.png" alt="Company Logo" srcset=""></a> <button class="navbar-toggler"
 							...
 							<div class="collapse navbar-collapse" id="navbarText">
 								<ul class="navbar-nav ml-auto">
 									...
 									<li class="nav-item"> <a class="nav-link" href="/shop_menu/sale/index.html">
 											<div class="ja">ショップメニュー</div>
 											<div class="en">SHOP MENU</div>
 										</a> </li>
 									<li class="nav-item"> <a class="nav-link" href="/product/index.html">
 							...
 							<div class="header-banner-wrapper">
 								<div class="row">
 									...
 									<div class="col-md-3 col-sm-6 col-xs-6"><a
 											href="/shop_menu/sale/ch_ma/liqui_moly_dpf.html"><span>詳しく見る</span><img
 												src="/assets/img/home/liqui_moly_dpf_480.png"></a></div>
 									<div class="col-md-3 col-sm-6 col-xs-6"><a
 											href="/shop_menu/sale/ch_ma/10674.html"><span>詳しく見る</span><img
 												src="/assets/img/home/mahle_ozone_pro_480.png"></a></div>
 									<div class="col-md-3 col-sm-6 col-xs-6"><a href="/tire_wheel/tire/index.html"><span>詳しく見る</span><img
 						...
 						<div class="set_sale_back">
 							...
 							<div class="set_menu_n row">
 								<div class="set_menu_n_330 col-md-6 col-sm-12 col-xs-12">
 									<div><img alt="メーカーロゴ" src="../../brand/img/1162.gif" /></div>
 								</div>
 									...
 									<div>
 										<div class="swiper-container">
 											<div class="swiper-wrapper">
 												<div class="swiper-slide"><img alt="SC DAMPER SYSTEM β" src="../../item_img/10000_1.jpg" />
 												</div>
 												<div class="swiper-slide"><img alt="SC DAMPER SYSTEM β" src="../../item_img/10000_2.jpg" />
 												</div>
 												<div class="swiper-slide"><img alt="SC DAMPER SYSTEM β" src="../../item_img/10000_3.jpg" />
 												</div>
 											</div>
 									...
 									<div class="tab_wrap">
 										...
 										<div class="tab-content">
 											<div id="home" class="tab-pane fade in active show">
 												<p>
 													走る、曲がる、止まる。車の基本となる3大要素を大きく左右するダンパーシステム。<br />常に一定ではない路面状況に対応すべく、開発・販売実績に基づくデータを分析し、より優れたダンパーシステムの開発に成功しました。高性能・多機能・低価格を実現した車高調です。ストリートからサーキットまで幅広くセッティングが可能!!
 												</p>
 											</div>
 											<div id="menu2" class="tab-pane fade">
 												<p>
 													・車高調整：フルタップ(全長調整式)<br />・減衰力調整：15段<br />・ボディ：スチールボディ設計(防錆加工済)<br />・車種別設計ピロアッパーマウント(一部車種を除く)<br />・バンプラバー付属(正立式)<br />・オーバーホール可能<br />・専用車高調レンチ2本付属
 												</p>
 											</div>
 										</div>
 										<script>
 										...
 										<!-- <input id="tab1" type="radio" name="tab_btn" checked>          						<input id="tab2" type="radio" name="tab_btn">          						<div class="tab_area">          							<label class="tab1_label" for="tab1">【商品説明】</label>          							<label class="tab2_label" for="tab2">【主な仕様】</label>          						</div>          						<div class="panel_area">          							<div id="panel1" class="tab_panel">          								<p>専用材高強度鋼線の採用により、耐疲労・耐へたり性に優れているほか、大幅な軽量化を実現しています。独自の加工により、高応力域での使用を実現。柔軟かつ強剛な特性が得られます。また、スプリングの軽量化により復帰速度（回復性）を従来に比べ約10％向上。路面に対する追従性、コーナリング時のより早い車体の安定性、スムーズな操舵性を実現します。<br>取付詳細は<a          										href="../damper/hyperco_swift.html">コチラ</a></p>          							</div>          							<div id="panel2" class="tab_panel">          								<p>・材質:専用材高強度鋼線H5S・TW<br>・運動性能:復帰速度(回復性)を従来比約10％向上<br>・ID:60/65/70/75(LONG)mm          								</p>          							</div>          						</div> -->
 									</div>
 								</div>
 							</div>
 							<div class="clearfix"></div>
							 <?php 
									...
									include(__DIR__.'/../../../_partials/product_search3.php'); ?>
 							...
 							<footer>
 								...
 								<div class="footer-places row">
 									<div class="footer-showbox row col-md-4 col-sm-12">
 										<div class="footer-showbox-img"> <img src="/assets/img/factory.png" alt="factory" srcset=""> </div>
 										<div class="footer-factory-info">
 											<div class="footer-showbox-title"> <span class="showbox-title">FACTORY</span> </div>
 										...
 										<div class="showbox-bottom"> <a class="arrowed-link"
 												href="/shop_menu/tenpo/factory.html"><span>詳しく見る</span><img src="/assets/img/black_arrow.svg"
 													alt="Header Link"></a> </div>
 									</div>
 									<div class="footer-showbox row col-md-4 col-sm-12">
 										<div class="footer-showbox-img"> <img src="/assets/img/heiwajima.png" alt="factory" srcset="">
 										</div>
 										<div class="footer-factory-info">
 											<div class="footer-showbox-title"> <span class="showbox-title">HEIWAJIMA</span> </div>
 											<table class="showbox-content">
 												<tr id="footer-showbox-address" class="footer-showbox-text">
 										...
 										<div class="showbox-bottom"> <a class="arrowed-link"
 												href="/shop_menu/tenpo/heiwajima.html"><span>詳しく見る</span><img src="/assets/img/black_arrow.svg"
 													alt="Header Link"></a> </div>
 									</div>
 									<div class="footer-showbox row col-md-4 col-sm-12">
 										<div class="footer-showbox-img"> <img src="/assets/img/ichinoe.png" alt="factory" srcset=""> </div>
 										<div class="footer-factory-info">
 											<div class="footer-showbox-title"> <span class="showbox-title">ICHINOE</span> </div>
 											<table class="showbox-content">
 												<tr id="footer-showbox-address" class="footer-showbox-text">
 										...
 										<div class="showbox-bottom"> <a class="arrowed-link" href="/shop_menu/tenpo/ichinoe.html"><span
 													class="ja">詳しく見る</span><img src="/assets/img/black_arrow.svg" alt="Header Link"></a> </div>
 									</div>
 								</div>
 								<div class="footer-bottom row">
 									<div class="col-md-4 col-sm-4 col-xs-4">
 										<div class="col-md-6 col-sm-1 col-xs-1"></div>
 										<div id="footer-logo-wrap" class="col-md-6 col-sm-11 col-xs-11"> <img id="footer-logo" class="logo"
 												src="/assets/img/opg.png" alt="Company Logo" srcset=""> </div>
 									</div>
