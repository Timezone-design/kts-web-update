...
<img src="../../brand/img/1162.gif" alt="メーカーロゴ">
</div>
...
<p>走る、曲がる、止まる。車の基本となる3大要素を大きく左右するダンパーシステム。<br>常に一定ではない路面状況に対応すべく、開発・販売実績に基づくデータを分析し、より優れたダンパーシステムの開発に成功しました。高性能・多機能・低価格を実現した車高調です。ストリートからサーキットまで幅広くセッティングが可能!!</p>
</div>
...
<tr>
<p class="search_category">**********【適合検索】**********&nbsp;&nbsp;&nbsp;&nbsp;<a class="change_button" href="../../set/item/10000.php"><img src="../../img/set_button.jpg" alt="工賃セットの価格表はコチラ"></a></p>
</tr>
<tr>
<td>
<!-- 車両メーカー検索ココから -->
<p class="search_category">【自動車メーカー】</p>
<form name="manufacture" method="post" action="10000.php">
...
<div class="item_info_text_small">▼ご希望の車種をタップすると詳細・購入ページに遷移します。</div>
<!-- 適合表出力--> 
<div class="scroll">
...
//メーカーが未選択の場合
if(isset($manufacture_select) == FALSE || $manufacture_select == ""){print_r('<div class="noselect_car"><br>車両情報を選択してください</div>');}
...
print_r('<th>スプリング仕様</th>');
print_r('<th>ダウン量(-mm)</th>');
print_r('<th>調整範囲(mm)ダウン量から+/-</th>');
print_r('<th>備考</th>');
print_r('<th>販売価格(税抜)</th></tr>');
...
print_r('<td>' . $line[10] . '</td>');
$price = number_format($line[12]);
echo('<td class="matching_table_price">￥' . $price . '</td></tr>');
}   
}
...
<div class="footer">Copyright (C) Kind Techno Structure Corporation. All Rights Reserved.</div></div>
</body>
</html>