...
<title>KTS-web 商品ラインナップ D2JAPAN SUSPENSION SYSTEM ラリーグラベル/ラリースノー</title>
...
{
@id: "/item/10038.php",
name: "SUSPENSION SYSTEM ラリーグラベル/ラリースノー"
}
}
]
}
...
<div class="mc_nav">
<a class="link" href="https://www.kts-web.com/">HOME</a> &gt; <a class="link" href="../../index.html">SHOP MENU</a> &gt; <a class="link" href="../../set/index.html">商品ラインナップ</a> &gt; <a class="link" href="../../set/cat/100.html">足回り</a> &gt; <a class="link" href="../../set/cat/116.html">車高調/セッティングパーツ</a> &gt; <a class="link" href="../../set/br/1100-116.html">D2JAPAN</a> &gt; <a class="link" href="10038.php">SUSPENSION SYSTEM ラリーグラベル/ラリースノー</a></div>
<div class="space3px"></div>
<div class="set_sale_back">
<div class="space3px"></div>
<div class="set_menu_n">
<div class="set_menu_n_330">
<div><img src="../../brand/img/1100.gif" alt="SUSPENSION SYSTEM ラリーグラベル/ラリースノー"></div></div>
<div class="set_menu_n_cell">
<div class="item_info_text_middle">
<p>D2JAPAN[ディーツージャパン]</p></div>
<div class="item_info_text_middle_b">
<p>SUSPENSION SYSTEM ラリーグラベル/ラリースノー[サスペンションシステム ラリーグラベル/ラリースノー]</p></div>
</div></div>
...
<div class="swiper-slide"><img src="../../item_img/10038_1.jpg" alt="SUSPENSION SYSTEM ラリーグラベル/ラリースノー"></div>
<div class="swiper-slide"><img src="../../item_img/10038_2.jpg" alt="SUSPENSION SYSTEM ラリーグラベル/ラリースノー"></div>
<div class="swiper-slide"><img src="../../item_img/10038_3.jpg" alt="SUSPENSION SYSTEM ラリーグラベル/ラリースノー"></div>
</div>
...
<p>D2ジャパンの車高調は走行シーンに合わせて多彩なラインナップを誇っています。また、ISO認可を受けたメーカー品質管理プログラムの厳しい検査を受け製造され、購入後1年間の保証(ストリート用のみ)が付いています。ピロボールラバートップマウントを初めてとした様々な特許パーツによりD2ジャパン独自のクオリティも特徴です。</p>
</div>
<div id="panel2" class="tab_panel">
<p>・36段減衰力調整機能<br>・アルミ鍛造製アッパーマウント<br>・フルタップ/全長調整式※一部車種除く<br>・モノチューブ/単筒式<br>・軽量アルミマウントボディ<br>・高張力スプリング(直巻きはID62)<br>・アルミ鍛造 スプリングシート＆ロックシート</p>
</div>
</div>
</div>
</div>
...
<div class="item_info_text_middle">
<p>D2JAPAN [ディーツージャパン]</p>
</div>
<div class="item_info_text_middle_b">
<p>SUSPENSION SYSTEM ラリーグラベル/ラリースノー [サスペンションシステム ラリーグラベル/ラリースノー]</p>
</div>
<div class="tab_wrap">
...
<!--ココまでSP-->
<tr>
<p class="search_category">**********【適合検索】**********&nbsp;&nbsp;<a class="change_button" href="../../set/item/10038.php"><img src="../../img/set_button.jpg" alt="工賃セットの価格表はコチラ"></a></p>
</tr>
<tr>
<td>
<!-- 車両メーカー検索ココから -->
<p class="search_category">【自動車メーカー】</p>
<form method="post" action="10038.php">
...
if($data[0] == '10038') $position = explode(";", $data[1]);
}
array_pop($position);
fclose($fp_position);
...
<form name="make" method="post" action="10038.php">
