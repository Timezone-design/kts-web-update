...
<title>KTS-web 商品ラインナップ HKS HIPERMAX-D' NOB SPEC</title>
...
<div class="mc_nav">
<a class="link" href="https://www.kts-web.com/">HOME</a> &gt; <a class="link" href="../../index.html">SHOP MENU</a> &gt; <a class="link" href="../../set/index.html">商品ラインナップ</a> &gt; <a class="link" href="../../set/cat/100.html">足回り</a> &gt; <a class="link" href="../../set/cat/116.html">車高調/セッティングパーツ</a> &gt; <a class="link" href="../../set/br/1032-116.html">HKS</a> &gt; <a class="link" href="10081.php">HIPERMAX-D' NOB SPEC</a></div>
<div class="space3px"></div>
<div class="set_sale_back">
<div class="space3px"></div>
<div class="set_menu_n">
<div class="set_menu_n_330">
<div><img src="../../brand/img/1032.gif" alt="HIPERMAX-D' NOB SPEC"></div></div>
<div class="set_menu_n_cell">
<div class="item_info_text_middle">
<p>HKS[エッチケーエス]</p></div>
<div class="item_info_text_middle_b">
<p>HIPERMAX-D' NOB SPEC[ハイパーマックスD ノブスペック]</p></div>
</div></div>
...
<div class="swiper-slide"><img src="../../item_img/10081_1.jpg" alt="HIPERMAX-D' NOB SPEC"></div>
<div class="swiper-slide"><img src="../../item_img/10081_2.jpg" alt="HIPERMAX-D' NOB SPEC"></div>
<div class="swiper-slide"><img src="../../item_img/10081_3.jpg" alt="HIPERMAX-D' NOB SPEC"></div>
</div>
...
<p>D1初代チャンプ 谷口信輝氏監修。「ハイパーマックスD' NOB SPEC」のコンセプトは、誰もがドリフトしやすい足。谷口選手を起用し、とことん煮詰めた、まさに『誰もがドリフトしやすい足!!』。硬いだけがドリフト足ではありません。ドリフトのきっかけ作りでの荷重移動・立ち上がりでのトラクションetc、サーキット走行を繰り返し、初級者から上級者までレベルの違うドリフトユーザーと共に谷口選手が最終的に誰もがドリフトしやすい足に仕上げ、納得いくまで煮詰めた仕様に仕上げています。この『HIPERMAX D' NOBspec.』で、もう一度皆様にドリフトを楽しんでいただきたいです。</p>
</div>
<div id="panel2" class="tab_panel">
<p>・単筒式<br>・減衰力30段階調整<br>・全長調整式<br>・専用スペシャルオイル<br>・PNEコート<br>・直巻きスプリング<br>・ピロアッパーマウント<br>・2Wayピロアッパーマウント<br>・仕様変更可<br>・オーバーホール可<br>・1年2万キロ保証</p>
</div>
</div>
</div>
</div>
...
<div class="item_info_text_middle_b">
<p>HIPERMAX-D' NOB SPEC [ハイパーマックスD ノブスペック]</p>
</div>
<div class="tab_wrap">
...
<!--ココまでSP-->
<tr>
<p class="search_category">**********【適合検索】**********&nbsp;&nbsp;<a class="change_button" href="../../set/item/10081.php"><img src="../../img/set_button.jpg" alt="工賃セットの価格表はコチラ"></a></p>
</tr>
<tr>
<td>
<!-- 車両メーカー検索ココから -->
<p class="search_category">【自動車メーカー】</p>
<form method="post" action="10081.php">
...
if($data[0] == '10081') $position = explode(";", $data[1]);
}
array_pop($position);
fclose($fp_position);
...
<form name="make" method="post" action="10081.php">
