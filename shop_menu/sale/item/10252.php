<html>
<head>
<meta name="description" content="ロードスターパーティーレース用に開発されたサスペンションキット。日常的に使える乗り心地と全開アタックもOKという願ってもない仕様となっています。">
...
<title>KTS-web 商品ラインナップ BILSTEIN Clubman PACK</title>
...
<div class="swiper-slide"><img src="../../item_img/10252_1.jpg" alt="Clubman PACK"></div>
<div class="swiper-slide"><img src="../../item_img/10252_2.jpg" alt="Clubman PACK"></div>
<div class="swiper-slide"><img src="../../item_img/10252_3.jpg" alt="Clubman PACK"></div>
</div>
...
<p>ロードスターパーティーレース用に開発されたサスペンションキット。日常的に使える乗り心地と全開アタックもOKという願ってもない仕様となっています。</p>
</div>
...
<!--ココまでSP-->
<tr>
<p class="search_category">**********【適合検索】**********&nbsp;&nbsp;<a class="change_button" href="../../set/item/10252.php"><img src="../../img/set_button.jpg" alt="工賃セットの価格表はコチラ"></a></p>
</tr>
<tr>
<td>
<!-- 車両メーカー検索ココから -->
<p class="search_category">【自動車メーカー】</p>
<form method="post" action="10252.php">
...
if($data[0] == '10252') $position = explode(";", $data[1]);
}
array_pop($position);
fclose($fp_position);
...
<form name="make" method="post" action="10252.php">
