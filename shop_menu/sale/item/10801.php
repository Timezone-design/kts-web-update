...
<div class="swiper-slide"><img src="../../item_img/10801_1.jpg" alt="ロアアームバー"></div>
<div class="swiper-slide"><img src="../../item_img/10801_2.jpg" alt="ロアアームバー"></div>
<div class="swiper-slide"><img src="../../item_img/10801_3.jpg" alt="ロアアームバー"></div>
</div>
...
<p>サスペンション下側支点の変形を抑制するロアアームバー。量産車ではオープン構造のサスペンション取付け基点である左右ロアアームの付け根を剛性の高いパイプで結合することにより、無用なアライメント変化を抑制し、正確なハンドリングを支援する。取付け面にはガセットなどを配置し圧力を均一化。最高レベルの高剛性を確保。最低地上高への影響は、最大で15ｍｍ程度の低下に抑えているので実用面への影響も少ない。</p>
</div>
...
<!--ココまでSP-->
<tr>
<p class="search_category">**********【適合検索】**********&nbsp;&nbsp;<a class="change_button" href="../../set/item/10801.php"><img src="../../img/set_button.jpg" alt="工賃セットの価格表はコチラ"></a></p>
</tr>
<tr>
<td>
<!-- 車両メーカー検索ココから -->
<p class="search_category">【自動車メーカー】</p>
<form method="post" action="10801.php">
...
if($data[0] == '10801') $position = explode(";", $data[1]);
}
array_pop($position);
fclose($fp_position);
...
<form name="make" method="post" action="10801.php">
