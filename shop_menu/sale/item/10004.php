...
<title>KTS-web 商品ラインナップ Aragosta TYPE-P</title>
...
<div class="mc_nav">
<a class="link" href="https://www.kts-web.com/">HOME</a> &gt; <a class="link" href="../../index.html">SHOP MENU</a> &gt; <a class="link" href="../../set/index.html">商品ラインナップ</a> &gt; <a class="link" href="../../set/cat/100.html">足回り</a> &gt; <a class="link" href="../../set/cat/116.html">車高調/セッティングパーツ</a> &gt; <a class="link" href="../../set/br/1010-116.html">Aragosta</a> &gt; <a class="link" href="10004.php">TYPE-P</a></div>
<div class="space3px"></div>
<div class="set_sale_back">
<div class="space3px"></div>
<div class="set_menu_n">
<div class="set_menu_n_330">
<div><img src="../../brand/img/1010.gif" alt="TYPE-P"></div></div>
...
<div class="swiper-slide"><img src="../../item_img/10004_1.jpg" alt="TYPE-P"></div>
<div class="swiper-slide"><img src="../../item_img/10004_2.jpg" alt="TYPE-P"></div>
<div class="swiper-slide"><img src="../../item_img/10004_3.jpg" alt="TYPE-P"></div>
</div>
...
<p>ローダウン＆クルージング性能に優れたラグジュアリー専用モデル。TYPE-Pの『P』はプレミアムコンセプトの『P』です。最上のスペックを活用しウエイト、ボディサイズ、ホイールベース等に適したコンフォート性、ハイスピードクルージング特性を実現しています。ローダウンスタイルでの高トラクション性能、フラットライドが堪能できます。</p>
</div>
...
<!--ココまでSP-->
<tr>
<p class="search_category">**********【適合検索】**********&nbsp;&nbsp;<a class="change_button" href="../../set/item/10004.php"><img src="../../img/set_button.jpg" alt="工賃セットの価格表はコチラ"></a></p>
</tr>
<tr>
<td>
<!-- 車両メーカー検索ココから -->
<p class="search_category">【自動車メーカー】</p>
<form method="post" action="10004.php">
...
if($data[0] == '10004') $position = explode(";", $data[1]);
}
array_pop($position);
fclose($fp_position);
...
<form name="make" method="post" action="10004.php">
