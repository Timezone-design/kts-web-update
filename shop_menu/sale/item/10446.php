<html>
<head>
<meta name="description" content="用途が広く使う人の個性が生きるトヨタ・ハイエースに、より力強い走破性を実現するため専用設定したLSDです。未舗装路、雪道、ウェット路面などの低ミュー路や、登り勾配のカーブなどの走破性を飛躍的にアップさせます。登り勾配のコーナリング中に、イン側のタイヤが空転するのを抑え、安定したトラクションが得られ走破性が向上します">
...
<div class="mc_nav">
<a class="link" href="https://www.kts-web.com/">HOME</a> &gt; <a class="link" href="../../index.html">SHOP MENU</a> &gt; <a class="link" href="../../set/index.html">商品ラインナップ</a> &gt; <a class="link" href="../../set/cat/101.html">駆動系</a> &gt; <a class="link" href="../../set/cat/122.html">LSD</a> &gt; <a class="link" href="../../set/br/1059-122.html">CUSCO</a> &gt; <a class="link" href="10446.php">ハイエース専用LSD</a></div>
<div class="space3px"></div>
<div class="set_sale_back">
<div class="space3px"></div>
<div class="set_menu_n">
<div class="set_menu_n_330">
<div><img src="../../brand/img/1059.gif" alt="ハイエース専用LSD"></div></div>
...
<div class="swiper-slide"><img src="../../item_img/10446_1.jpg" alt="ハイエース専用LSD"></div>
<div class="swiper-slide"><img src="../../item_img/10446_2.jpg" alt="ハイエース専用LSD"></div>
<div class="swiper-slide"><img src="../../item_img/10446_3.jpg" alt="ハイエース専用LSD"></div>
</div>
...
<p>用途が広く使う人の個性が生きるトヨタ・ハイエースに、より力強い走破性を実現するため専用設定したLSDです。未舗装路、雪道、ウェット路面などの低ミュー路や、登り勾配のカーブなどの走破性を飛躍的にアップさせます。登り勾配のコーナリング中に、イン側のタイヤが空転するのを抑え、安定したトラクションが得られ走破性が向上します</p>
</div>
<div id="panel2" class="tab_panel">
<p>・AT車に機械式LSDを装着したい方へ<br>・雪道や滑りやすい道の走行が多い方へ<br>・高速道路などでふらつきが気になる方へ<br>・ワインディングで安定したトラクションを求める方へ</p>
</div>
</div>
</div>
</div>
...
<!--ココまでSP-->
<tr>
<p class="search_category">**********【適合検索】**********&nbsp;&nbsp;<a class="change_button" href="../../set/item/10446.php"><img src="../../img/set_button.jpg" alt="工賃セットの価格表はコチラ"></a></p>
</tr>
<tr>
<td>
<!-- 車両メーカー検索ココから -->
<p class="search_category">【自動車メーカー】</p>
<form method="post" action="10446.php">
...
if($data[0] == '10446') $position = explode(";", $data[1]);
}
array_pop($position);
fclose($fp_position);
...
<form name="make" method="post" action="10446.php">
