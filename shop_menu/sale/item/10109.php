<html>
<head>
<meta name="description" content="輸入車向けの街乗りからスポーツ走行まで対応する万能モデル。スタンダードモデルとして、それぞれの車種が持つ特性に合わせて最適なセッティングで開発。全長調整式のフルスペック車高調として、車高を下げてもストローク量が変化せず、乗り心地の心配をすることなくローダウンを楽しめる車高調です。">
...
<title>KTS-web 商品ラインナップ LARGUS SpecSI</title>
...
<div class="mc_nav">
<a class="link" href="https://www.kts-web.com/">HOME</a> &gt; <a class="link" href="../../index.html">SHOP MENU</a> &gt; <a class="link" href="../../set/index.html">商品ラインナップ</a> &gt; <a class="link" href="../../set/cat/100.html">足回り</a> &gt; <a class="link" href="../../set/cat/116.html">車高調/セッティングパーツ</a> &gt; <a class="link" href="../../set/br/1156-116.html">LARGUS</a> &gt; <a class="link" href="10109.php">SpecSI</a></div>
<div class="space3px"></div>
<div class="set_sale_back">
<div class="space3px"></div>
<div class="set_menu_n">
<div class="set_menu_n_330">
<div><img src="../../brand/img/1156.gif" alt="SpecSI"></div></div>
<div class="set_menu_n_cell">
<div class="item_info_text_middle">
<p>LARGUS[ラルグス]</p></div>
<div class="item_info_text_middle_b">
<p>SpecSI[スペックSi]</p></div>
</div></div>
...
<div class="swiper-slide"><img src="../../item_img/10109_1.jpg" alt="SpecSI"></div>
<div class="swiper-slide"><img src="../../item_img/10109_2.jpg" alt="SpecSI"></div>
<div class="swiper-slide"><img src="../../item_img/10109_3.jpg" alt="SpecSI"></div>
</div>
...
<p>輸入車向けの街乗りからスポーツ走行まで対応する万能モデル。スタンダードモデルとして、それぞれの車種が持つ特性に合わせて最適なセッティングで開発。全長調整式のフルスペック車高調として、車高を下げてもストローク量が変化せず、乗り心地の心配をすることなくローダウンを楽しめる車高調です。</p>
</div>
<div id="panel2" class="tab_panel">
<p>・全長調整式<br>・減衰力32段階調整<br>・単筒正立式<br>・防錆塗装<br>・2年保証<br>・オーバーホール対応<br>・ID62スプリング</p>
</div>
</div>
</div>
</div>
...
<!--ココまでSP-->
<tr>
<p class="search_category">**********【適合検索】**********&nbsp;&nbsp;<a class="change_button" href="../../set/item/10109.php"><img src="../../img/set_button.jpg" alt="工賃セットの価格表はコチラ"></a></p>
</tr>
<tr>
<td>
<!-- 車両メーカー検索ココから -->
<p class="search_category">【自動車メーカー】</p>
<form method="post" action="10109.php">
...
if($data[0] == '10109') $position = explode(";", $data[1]);
}
array_pop($position);
fclose($fp_position);
...
<form name="make" method="post" action="10109.php">
