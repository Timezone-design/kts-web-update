<html>
<head>
<meta name="description" content="ダイナミクスと素晴らしいルックスの完璧なコンビネーションが貴方をサーキットで輝かせる。ロードテストを重ね、完璧なハーモニーを奏でるスプリングとショックアブソーバー。ビルシュタインならではのドイツ製モノチューブ倒立式サスを採用し、TV（ドイツの技術検査機関）が認める性能を実現しています。">
...
<title>KTS-web 商品ラインナップ BILSTEIN B12 PRO-KIT</title>
...
<div class="swiper-slide"><img src="../../item_img/10244_1.jpg" alt="B12 PRO-KIT"></div>
<div class="swiper-slide"><img src="../../item_img/10244_2.jpg" alt="B12 PRO-KIT"></div>
<div class="swiper-slide"><img src="../../item_img/10244_3.jpg" alt="B12 PRO-KIT"></div>
</div>
...
<p>ダイナミクスと素晴らしいルックスの完璧なコンビネーションが貴方をサーキットで輝かせる。ロードテストを重ね、完璧なハーモニーを奏でるスプリングとショックアブソーバー。ビルシュタインならではのドイツ製モノチューブ倒立式サスを採用し、TV（ドイツの技術検査機関）が認める性能を実現しています。</p>
</div>
<div id="panel2" class="tab_panel">
<p>・プロフェッショナル・コーナリング・システムを採用<br>・正確な反応と素晴らしいドライビングパフォーマンス、安全性の向上<br>・アイバッハ製プロキット・スプリングを採用<br>・ビルシュタインならではのガス封入技術<br>・ビルシュタインならではのドイツ製モノチューブ倒立式サス<br>・TV（ドイツの技術検査機関）が認める性能<br>・信頼のドイツ国内生産</p>
</div>
</div>
</div>
</div>
...
<!--ココまでSP-->
<tr>
<p class="search_category">**********【適合検索】**********&nbsp;&nbsp;<a class="change_button" href="../../set/item/10244.php"><img src="../../img/set_button.jpg" alt="工賃セットの価格表はコチラ"></a></p>
</tr>
<tr>
<td>
<!-- 車両メーカー検索ココから -->
<p class="search_category">【自動車メーカー】</p>
<form method="post" action="10244.php">
...
if($data[0] == '10244') $position = explode(";", $data[1]);
}
array_pop($position);
fclose($fp_position);
...
<form name="make" method="post" action="10244.php">
