<html>
<head>
<meta name="description" content="最低地上高を確保し、最適なローダウンを実現。乗り心地とダウン量をうまくマッチングさせたサスペンション。減衰力15段調整機構を装備させたことにより、ショックアブソーバーの特性を変更することが出来ます。様々な条件に答える全長調整式車高調です。">
...
<title>KTS-web 商品ラインナップ JIC MAGIC TT-Four</title>
...
<div class="mc_nav">
<a class="link" href="https://www.kts-web.com/">HOME</a> &gt; <a class="link" href="../../index.html">SHOP MENU</a> &gt; <a class="link" href="../../set/index.html">商品ラインナップ</a> &gt; <a class="link" href="../../set/cat/100.html">足回り</a> &gt; <a class="link" href="../../set/cat/116.html">車高調/セッティングパーツ</a> &gt; <a class="link" href="../../set/br/1078-116.html">JIC MAGIC</a> &gt; <a class="link" href="10095.php">TT-Four</a></div>
<div class="space3px"></div>
<div class="set_sale_back">
<div class="space3px"></div>
<div class="set_menu_n">
<div class="set_menu_n_330">
<div><img src="../../brand/img/1078.gif" alt="TT-Four"></div></div>
<div class="set_menu_n_cell">
<div class="item_info_text_middle">
<p>JIC MAGIC[ジェイアイシーマジック]</p></div>
<div class="item_info_text_middle_b">
<p>TT-Four[タウン・ツーリング・フォア]</p></div>
</div></div>
...
<div class="swiper-slide"><img src="../../item_img/10095_1.jpg" alt="TT-Four"></div>
<div class="swiper-slide"><img src="../../item_img/10095_2.jpg" alt="TT-Four"></div>
<div class="swiper-slide"><img src="../../item_img/10095_3.jpg" alt="TT-Four"></div>
</div>
...
<p>最低地上高を確保し、最適なローダウンを実現。乗り心地とダウン量をうまくマッチングさせたサスペンション。減衰力15段調整機構を装備させたことにより、ショックアブソーバーの特性を変更することが出来ます。様々な条件に答える全長調整式車高調です。</p>
</div>
<div id="panel2" class="tab_panel">
<p>・全長調整式<br>・減衰力15段調整式<br>・単筒式</p>
</div>
</div>
</div>
</div>
...
<div class="item_info_text_middle">
<p>JIC MAGIC [ジェイアイシーマジック]</p>
</div>
<div class="item_info_text_middle_b">
<p>TT-Four [タウン・ツーリング・フォア]</p>
</div>
<div class="tab_wrap">
...
<!--ココまでSP-->
<tr>
<p class="search_category">**********【適合検索】**********&nbsp;&nbsp;<a class="change_button" href="../../set/item/10095.php"><img src="../../img/set_button.jpg" alt="工賃セットの価格表はコチラ"></a></p>
</tr>
<tr>
<td>
<!-- 車両メーカー検索ココから -->
<p class="search_category">【自動車メーカー】</p>
<form method="post" action="10095.php">
...
if($data[0] == '10095') $position = explode(";", $data[1]);
}
array_pop($position);
fclose($fp_position);
...
<form name="make" method="post" action="10095.php">
