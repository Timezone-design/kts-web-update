<html>
<head>
<meta name="description" content="低価格はそのままに乗り心地と耐久性を追求！LIMITEDⅡは従来のLIMITED同様の機能を持ちさらにリニューアル。オイルシールやショックオイルなど消耗品を中心にステルス車高調と同等の部品を使用する事で性能、耐久性などさらに品質向上させました。+ α は1年間、2万キロの製品保証付き！">
...
<title>KTS-web 商品ラインナップ FINAL KONNEXION LIMITEDⅡ + α PROSHOP VERSION</title>
...
{
@id: "/item/10054.php",
name: "LIMITEDⅡ + α PROSHOP VERSION"
}
}
]
}
...
<p>LIMITEDⅡ + α PROSHOP VERSION[リミテッド2+α プロショップバージョン]</p></div>
</div></div>
...
<div class="swiper-slide"><img src="../../item_img/10054_1.jpg" alt="LIMITEDⅡ + α PROSHOP VERSION"></div>
<div class="swiper-slide"><img src="../../item_img/10054_2.jpg" alt="LIMITEDⅡ + α PROSHOP VERSION"></div>
<div class="swiper-slide"><img src="../../item_img/10054_3.jpg" alt="LIMITEDⅡ + α PROSHOP VERSION"></div>
</div>
...
<p>低価格はそのままに乗り心地と耐久性を追求！LIMITEDⅡは従来のLIMITED同様の機能を持ちさらにリニューアル。オイルシールやショックオイルなど消耗品を中心にステルス車高調と同等の部品を使用する事で性能、耐久性などさらに品質向上させました。+ α は1年間、2万キロの製品保証付き！</p>
</div>
<div id="panel2" class="tab_panel">
<p>・フルタップ全長調整式 (全車対応)<br>・単筒正立、単筒倒立式 (車種により)<br>・減衰力 20 段調整機能付 (全車対応)<br>・ピロアッパーマウント調整式 (車種により)<br>・リジットアッパーマウント (車種により)<br>・スラストベアリングアッパーシート採用 (車種により)<br>・オーバーホール可能 (全車対応)<br>・車高調レンチ、製品証明書、オリジナルステッカー付属</p>
</div>
</div>
</div>
</div>
...
<div class="item_info_text_middle_b">
<p>LIMITEDⅡ + α PROSHOP VERSION [リミテッド2+α プロショップバージョン]</p>
</div>
<div class="tab_wrap">
...
<!--ココまでSP-->
<tr>
<p class="search_category">**********【適合検索】**********&nbsp;&nbsp;<a class="change_button" href="../../set/item/10054.php"><img src="../../img/set_button.jpg" alt="工賃セットの価格表はコチラ"></a></p>
</tr>
<tr>
<td>
<!-- 車両メーカー検索ココから -->
<p class="search_category">【自動車メーカー】</p>
<form method="post" action="10054.php">
...
if($data[0] == '10054') $position = explode(";", $data[1]);
}
array_pop($position);
fclose($fp_position);
...
<form name="make" method="post" action="10054.php">
