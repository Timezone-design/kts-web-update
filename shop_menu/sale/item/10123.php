...
<title>KTS-web 商品ラインナップ OHLINS Type HAL</title>
...
<div class="mc_nav">
<a class="link" href="https://www.kts-web.com/">HOME</a> &gt; <a class="link" href="../../index.html">SHOP MENU</a> &gt; <a class="link" href="../../set/index.html">商品ラインナップ</a> &gt; <a class="link" href="../../set/cat/100.html">足回り</a> &gt; <a class="link" href="../../set/cat/116.html">車高調/セッティングパーツ</a> &gt; <a class="link" href="../../set/br/1046-116.html">OHLINS</a> &gt; <a class="link" href="10123.php">Type HAL</a></div>
<div class="space3px"></div>
<div class="set_sale_back">
<div class="space3px"></div>
<div class="set_menu_n">
<div class="set_menu_n_330">
<div><img src="../../brand/img/1046.gif" alt="Type HAL"></div></div>
<div class="set_menu_n_cell">
<div class="item_info_text_middle">
<p>OHLINS[オーリンズ]</p></div>
<div class="item_info_text_middle_b">
<p>Type HAL[タイプHAL]</p></div>
</div></div>
...
<div class="swiper-slide"><img src="../../item_img/10123_1.jpg" alt="Type HAL"></div>
<div class="swiper-slide"><img src="../../item_img/10123_2.jpg" alt="Type HAL"></div>
<div class="swiper-slide"><img src="../../item_img/10123_3.jpg" alt="Type HAL"></div>
</div>
...
<p>ストロークとスプリング・プリロード量を変更することなく車高調整が可能な全長調整機構とさらなる軽量化を目指したアルミシリンダー採用モデル（※一部車種を除く）。そのシリンダーにはゴールドアルマイト処理を施し、この上なく美しいアピアランスを実現。アイバッハ社との共同開発したオーリンズ専用の新開発軽量スプリング。定評の20段調整搭載。</p>
</div>
<div id="panel2" class="tab_panel">
<p>・ネジ式車高・全長調整モデル<br>・減衰力20段階調整<br>・アイバッハ社共同開発軽量スプリング<br>・アルミシリンダー採用(ゴールドアルマイト)</p>
</div>
</div>
</div>
</div>
...
<!--ココまでSP-->
<tr>
<p class="search_category">**********【適合検索】**********&nbsp;&nbsp;<a class="change_button" href="../../set/item/10123.php"><img src="../../img/set_button.jpg" alt="工賃セットの価格表はコチラ"></a></p>
</tr>
<tr>
<td>
<!-- 車両メーカー検索ココから -->
<p class="search_category">【自動車メーカー】</p>
<form method="post" action="10123.php">
...
if($data[0] == '10123') $position = explode(";", $data[1]);
}
array_pop($position);
fclose($fp_position);
...
<form name="make" method="post" action="10123.php">
