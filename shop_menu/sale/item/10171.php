...
<title>KTS-web 商品ラインナップ TANABE SUSTEC PRO ZT40</title>
...
<div class="mc_nav">
<a class="link" href="https://www.kts-web.com/">HOME</a> &gt; <a class="link" href="../../index.html">SHOP MENU</a> &gt; <a class="link" href="../../set/index.html">商品ラインナップ</a> &gt; <a class="link" href="../../set/cat/100.html">足回り</a> &gt; <a class="link" href="../../set/cat/116.html">車高調/セッティングパーツ</a> &gt; <a class="link" href="../../set/br/1095-116.html">TANABE</a> &gt; <a class="link" href="10171.php">SUSTEC PRO ZT40</a></div>
<div class="space3px"></div>
<div class="set_sale_back">
<div class="space3px"></div>
<div class="set_menu_n">
<div class="set_menu_n_330">
<div><img src="../../brand/img/1095.gif" alt="SUSTEC PRO ZT40"></div></div>
<div class="set_menu_n_cell">
<div class="item_info_text_middle">
<p>TANABE[タナベ]</p></div>
<div class="item_info_text_middle_b">
<p>SUSTEC PRO ZT40[サステックプロ ZT40]</p></div>
</div></div>
...
<div class="swiper-slide"><img src="../../item_img/10171_1.jpg" alt="SUSTEC PRO ZT40"></div>
<div class="swiper-slide"><img src="../../item_img/10171_2.jpg" alt="SUSTEC PRO ZT40"></div>
<div class="swiper-slide"><img src="../../item_img/10171_3.jpg" alt="SUSTEC PRO ZT40"></div>
</div>
...
<p>超微低速域にまでこわだったシリーズ最高峰モデル。発進や停止時といった極微低速域で見られる、実際のダンパーの動きとドライバーが受ける作動感のズレを同調させる『TVS』を搭載。 レクサスの足を手がけるKYB 社の高度なテクノロジーがフルに活かされた究極のサスペンション性能を手中にしてください。</p>
</div>
<div id="panel2" class="tab_panel">
<p>・フルタップ(全長調整)式<br>・TVS(ツインバルブシステム)<br>・40段減衰力調整機能<br>・大容量ベアリング＋スラストシート<br>・専用ゴムアッパーマウント<br>・PRO210スプリング<br>・テーパー型ブラケットロック<br>・車種別専用設計<br>・ツイン防錆コーティング<br>・1年間・走行距離10,000kmの保証</p>
</div>
</div>
</div>
</div>
...
<div class="item_info_text_middle_b">
<p>SUSTEC PRO ZT40 [サステックプロ ZT40]</p>
</div>
<div class="tab_wrap">
...
<!--ココまでSP-->
<tr>
<p class="search_category">**********【適合検索】**********&nbsp;&nbsp;<a class="change_button" href="../../set/item/10171.php"><img src="../../img/set_button.jpg" alt="工賃セットの価格表はコチラ"></a></p>
</tr>
<tr>
<td>
<!-- 車両メーカー検索ココから -->
<p class="search_category">【自動車メーカー】</p>
<form method="post" action="10171.php">
...
if($data[0] == '10171') $position = explode(";", $data[1]);
}
array_pop($position);
fclose($fp_position);
...
<form name="make" method="post" action="10171.php">
