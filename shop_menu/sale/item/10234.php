...
<title>KTS-web 商品ラインナップ RACING GEAR HS DAMPER</title>
...
<div class="mc_nav">
<a class="link" href="https://www.kts-web.com/">HOME</a> &gt; <a class="link" href="../../index.html">SHOP MENU</a> &gt; <a class="link" href="../../set/index.html">商品ラインナップ</a> &gt; <a class="link" href="../../set/cat/100.html">足回り</a> &gt; <a class="link" href="../../set/cat/116.html">車高調/セッティングパーツ</a> &gt; <a class="link" href="../../set/br/1159-116.html">RACING GEAR</a> &gt; <a class="link" href="10234.php">HS DAMPER</a></div>
<div class="space3px"></div>
<div class="set_sale_back">
<div class="space3px"></div>
<div class="set_menu_n">
<div class="set_menu_n_330">
<div><img src="../../brand/img/1159.gif" alt="HS DAMPER"></div></div>
<div class="set_menu_n_cell">
<div class="item_info_text_middle">
<p>RACING GEAR[レーシングギア]</p></div>
<div class="item_info_text_middle_b">
<p>商品名：HS DAMPER[HSダンパー]</p></div>
</div></div>
...
<div class="swiper-slide"><img src="../../item_img/10234_1.jpg" alt="HS DAMPER"></div>
<div class="swiper-slide"><img src="../../item_img/10234_2.jpg" alt="HS DAMPER"></div>
<div class="swiper-slide"><img src="../../item_img/10234_3.jpg" alt="HS DAMPER"></div>
</div>
...
<p>レーシングギアは「街乗り」と「サーキット」両方の走行を楽しむためのダンパーを開発。街乗りとサーキットを両立することが出来るハイブリッドダンパー『HSダンパー』。単筒式・複筒式の二つのショック構造から車両特性に合わせ最適なショック構造を選び採用。</p>
</div>
<div id="panel2" class="tab_panel">
<p>・全長調整式<br>・減衰力15段調整式<br>・アッパーマウント付属<br>・オーバーホール対応<br>・1年2万キロ保証<br>・スプリングレート変更可能</p>
</div>
</div>
</div>
</div>
...
<!--ココまでSP-->
<tr>
<p class="search_category">**********【適合検索】**********&nbsp;&nbsp;<a class="change_button" href="../../set/item/10234.php"><img src="../../img/set_button.jpg" alt="工賃セットの価格表はコチラ"></a></p>
</tr>
<tr>
<td>
<!-- 車両メーカー検索ココから -->
<p class="search_category">【自動車メーカー】</p>
<form method="post" action="10234.php">
...
if($data[0] == '10234') $position = explode(";", $data[1]);
}
array_pop($position);
fclose($fp_position);
...
<form name="make" method="post" action="10234.php">
