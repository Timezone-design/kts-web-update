...
<title>KTS-web 商品ラインナップ HKS HIPERMAX G</title>
...
<div class="mc_nav">
<a class="link" href="https://www.kts-web.com/">HOME</a> &gt; <a class="link" href="../../index.html">SHOP MENU</a> &gt; <a class="link" href="../../set/index.html">商品ラインナップ</a> &gt; <a class="link" href="../../set/cat/100.html">足回り</a> &gt; <a class="link" href="../../set/cat/119.html">サスペンションキット</a> &gt; <a class="link" href="../../set/br/1032-119.html">HKS</a> &gt; <a class="link" href="10085.php">HIPERMAX G</a></div>
<div class="space3px"></div>
<div class="set_sale_back">
<div class="space3px"></div>
<div class="set_menu_n">
<div class="set_menu_n_330">
<div><img src="../../brand/img/1032.gif" alt="HIPERMAX G"></div></div>
<div class="set_menu_n_cell">
<div class="item_info_text_middle">
<p>HKS[エッチケーエス]</p></div>
<div class="item_info_text_middle_b">
<p>商品名：HIPERMAX G[ハイパーマックスG]</p></div>
</div></div>
...
<div class="swiper-slide"><img src="../../item_img/10085_1.jpg" alt="HIPERMAX G"></div>
<div class="swiper-slide"><img src="../../item_img/10085_2.jpg" alt="HIPERMAX G"></div>
<div class="swiper-slide"><img src="../../item_img/10085_3.jpg" alt="HIPERMAX G"></div>
</div>
...
<p>上質を追い求める人のために。チューニングパーツの意義「性能＞コスト」と車両の素性を生かす設計「純正形状」の融合。これまでの純正形状アフター サスペンションの概念とは全く異なる「乗り心地」「スタイル」「安定感」全てにおいて「上質」を徹底追及したHKSの答えが、今ここに具現化しました。</p>
</div>
<div id="panel2" class="tab_panel">
<p>・単筒式<br>・専用スプリング(ローダウン仕様)※アッパーマウントは純正を使用します。<br>・ブラケットおよびケース強度を大幅にアップ<br>・PNEコート<br>・made in JAPAN</p>
</div>
</div>
</div>
</div>
...
<!--ココまでSP-->
<tr>
<p class="search_category">**********【適合検索】**********&nbsp;&nbsp;<a class="change_button" href="../../set/item/10085.php"><img src="../../img/set_button.jpg" alt="工賃セットの価格表はコチラ"></a></p>
</tr>
<tr>
<td>
<!-- 車両メーカー検索ココから -->
<p class="search_category">【自動車メーカー】</p>
<form method="post" action="10085.php">
...
if($data[0] == '10085') $position = explode(";", $data[1]);
}
array_pop($position);
fclose($fp_position);
...
<form name="make" method="post" action="10085.php">
