...
<title>KTS-web 商品ラインナップ ESPELIR DOWNSUS</title>
...
<div class="mc_nav">
<a class="link" href="https://www.kts-web.com/">HOME</a> &gt; <a class="link" href="../../index.html">SHOP MENU</a> &gt; <a class="link" href="../../set/index.html">商品ラインナップ</a> &gt; <a class="link" href="../../set/cat/100.html">足回り</a> &gt; <a class="link" href="../../set/cat/117.html">ダウンサス/アップサス</a> &gt; <a class="link" href="../../set/br/1030-117.html">ESPELIR</a> &gt; <a class="link" href="10044.php">DOWNSUS</a></div>
<div class="space3px"></div>
<div class="set_sale_back">
<div class="space3px"></div>
<div class="set_menu_n">
<div class="set_menu_n_330">
<div><img src="../../brand/img/1030.gif" alt="DOWNSUS"></div></div>
<div class="set_menu_n_cell">
<div class="item_info_text_middle">
<p>ESPELIR[エスペリア]</p></div>
<div class="item_info_text_middle_b">
<p>商品名：DOWNSUS[ダウンサス]</p></div>
</div></div>
...
<div class="swiper-slide"><img src="../../item_img/10044_1.jpg" alt="DOWNSUS"></div>
<div class="swiper-slide"><img src="../../item_img/10044_2.jpg" alt="DOWNSUS"></div>
<div class="swiper-slide"><img src="../../item_img/10044_3.jpg" alt="DOWNSUS"></div>
</div>
...
<p>大幅な車高ダウンを避けたい方への控えめなローダウンスプリング。インチアップしたホイール装着車で車高を下げ過ぎるとインナーフェンダーなどに当たってしまうことがあり、大幅に車高を落とせないケースがあります。同様に、エアロパーツが地面に当たってしまったり、ダウンサスを装着したいが仕事上荷物を載せるのであまり低く出来ない場合など、控えめなダウン量をお望みの方におすすめ致します。</p>
</div>
...
<!--ココまでSP-->
<tr>
<p class="search_category">**********【適合検索】**********&nbsp;&nbsp;<a class="change_button" href="../../set/item/10044.php"><img src="../../img/set_button.jpg" alt="工賃セットの価格表はコチラ"></a></p>
</tr>
<tr>
<td>
<!-- 車両メーカー検索ココから -->
<p class="search_category">【自動車メーカー】</p>
<form method="post" action="10044.php">
...
if($data[0] == '10044') $position = explode(";", $data[1]);
}
array_pop($position);
fclose($fp_position);
...
<form name="make" method="post" action="10044.php">
