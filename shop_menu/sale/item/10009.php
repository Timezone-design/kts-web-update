...
<title>KTS-web 商品ラインナップ Aragosta TYPE-SA</title>
...
<div class="mc_nav">
<a class="link" href="https://www.kts-web.com/">HOME</a> &gt; <a class="link" href="../../index.html">SHOP MENU</a> &gt; <a class="link" href="../../set/index.html">商品ラインナップ</a> &gt; <a class="link" href="../../set/cat/100.html">足回り</a> &gt; <a class="link" href="../../set/cat/116.html">車高調/セッティングパーツ</a> &gt; <a class="link" href="../../set/br/1010-116.html">Aragosta</a> &gt; <a class="link" href="10009.php">TYPE-SA</a></div>
<div class="space3px"></div>
<div class="set_sale_back">
<div class="space3px"></div>
<div class="set_menu_n">
<div class="set_menu_n_330">
<div><img src="../../brand/img/1010.gif" alt="TYPE-SA"></div></div>
<div class="set_menu_n_cell">
<div class="item_info_text_middle">
<p>Aragosta[アラゴスタ]</p></div>
<div class="item_info_text_middle_b">
<p>TYPE-SA[タイプSA]</p></div>
</div></div>
...
<div class="swiper-slide"><img src="../../item_img/10009_1.jpg" alt="TYPE-SA"></div>
<div class="swiper-slide"><img src="../../item_img/10009_2.jpg" alt="TYPE-SA"></div>
<div class="swiper-slide"><img src="../../item_img/10009_3.jpg" alt="TYPE-SA"></div>
</div>
...
<p>1000分の1秒単位まで減衰力の可変速度にこだわり、内部パーツ全てを独自設計。刻々と変化する路面状況や車両姿勢にも純正では成し得ないアクティブ制御を実現します。純正の電子制御式ショック機能に対応しているため、プラグイン接続のみの手軽さでコクピットのショックコントロールスイッチもそのまま使用可能。各モードで最適化したアラゴスタフィールが体感可能です。R35 GT-R専用PnPモデルでは純正の[コンフォート]、[ノーマル]、[R]スイッチに対応。手軽に純正を凌ぐアクティブ制御が体感出来ます。</p>
</div>
<div id="panel2" class="tab_panel">
<p>・完全オリジナル設計<br>・セミアクティブサスペンション<br>・プラグイン接続で純正の3段階モードスイッチに対応（R35 GT-Rの場合）<br>・純正3Gセンサー情報を基に、瞬時に減衰力をアクティブ制御<br>・独自の内部構造によりノーマルを上回る反応速度を実現<br>・全長調整機能/ranaスプリング標準装備<br>・リセッティング、オーバーホール対応</p>
</div>
</div>
</div>
</div>
...
<!--ココまでSP-->
<tr>
<p class="search_category">**********【適合検索】**********&nbsp;&nbsp;<a class="change_button" href="../../set/item/10009.php"><img src="../../img/set_button.jpg" alt="工賃セットの価格表はコチラ"></a></p>
</tr>
<tr>
<td>
<!-- 車両メーカー検索ココから -->
<p class="search_category">【自動車メーカー】</p>
<form method="post" action="10009.php">
...
if($data[0] == '10009') $position = explode(";", $data[1]);
}
array_pop($position);
fclose($fp_position);
...
<form name="make" method="post" action="10009.php">
