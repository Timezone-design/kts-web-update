...
<div class="mc_nav">
<a class="link" href="https://www.kts-web.com/">HOME</a> &gt; <a class="link" href="../../index.html">SHOP MENU</a> &gt; <a class="link" href="../../set/index.html">商品ラインナップ</a> &gt; <a class="link" href="../../set/cat/100.html">足回り</a> &gt; <a class="link" href="../../set/cat/118.html">ショックアブソーバー</a> &gt; <a class="link" href="../../set/br/1054-118.html">KYB</a> &gt; <a class="link" href="10672.php">補修用ショック</a></div>
<div class="space3px"></div>
<div class="set_sale_back">
<div class="space3px"></div>
<div class="set_menu_n">
<div class="set_menu_n_330">
<div><img src="../../brand/img/1054.gif" alt="補修用ショック"></div></div>
...
<div class="swiper-slide"><img src="../../item_img/10672_1.jpg" alt="補修用ショック"></div>
<div class="swiper-slide"><img src="../../item_img/10672_2.jpg" alt="補修用ショック"></div>
<div class="swiper-slide"><img src="../../item_img/10672_3.jpg" alt="補修用ショック"></div>
</div>
...
<p>車検・点検時が交換のチャンス！ 新車から5年・5万キロ以上なら交換をオススメします。また、ショックアブソーバは、1台分(4本)または、左右(2本)同時での交換をおすすめします。1本だけの交換は交換していない部分の消耗・劣化を早める原因となります。</p>
</div>
...
<!--ココまでSP-->
<tr>
<p class="search_category">**********【適合検索】**********&nbsp;&nbsp;<a class="change_button" href="../../set/item/10672.php"><img src="../../img/set_button.jpg" alt="工賃セットの価格表はコチラ"></a></p>
</tr>
<tr>
<td>
<!-- 車両メーカー検索ココから -->
<p class="search_category">【自動車メーカー】</p>
<form method="post" action="10672.php">
...
if($data[0] == '10672') $position = explode(";", $data[1]);
}
array_pop($position);
fclose($fp_position);
...
<form name="make" method="post" action="10672.php">
