...
<title>KTS-web 商品ラインナップ RS★R Ti2000 DOWN</title>
...
<div class="mc_nav">
<a class="link" href="https://www.kts-web.com/">HOME</a> &gt; <a class="link" href="../../index.html">SHOP MENU</a> &gt; <a class="link" href="../../set/index.html">商品ラインナップ</a> &gt; <a class="link" href="../../set/cat/100.html">足回り</a> &gt; <a class="link" href="../../set/cat/117.html">ダウンサス/アップサス</a> &gt; <a class="link" href="../../set/br/1001-117.html">RS★R</a> &gt; <a class="link" href="10147.php">Ti2000 DOWN</a></div>
<div class="space3px"></div>
<div class="set_sale_back">
<div class="space3px"></div>
<div class="set_menu_n">
<div class="set_menu_n_330">
<div><img src="../../brand/img/1001.gif" alt="Ti2000 DOWN"></div></div>
<div class="set_menu_n_cell">
<div class="item_info_text_middle">
<p>RS★R[アールエスアール]</p></div>
<div class="item_info_text_middle_b">
<p>商品名：Ti2000 DOWN[Ti2000 ダウン]</p></div>
</div></div>
...
<div class="swiper-slide"><img src="../../item_img/10147_1.jpg" alt="Ti2000 DOWN"></div>
<div class="swiper-slide"><img src="../../item_img/10147_2.jpg" alt="Ti2000 DOWN"></div>
<div class="swiper-slide"><img src="../../item_img/10147_3.jpg" alt="Ti2000 DOWN"></div>
</div>
...
<p>保安基準を満たすレベルでの大幅なローダウンと30～50％のバネレートアップにより走行性能を向上させる、ＲＳ☆Ｒの主力製品です。 優れた直進安定性・コーナリング性能だけでなく、レーシーなフォルムがクルマの存在感をさらに高めます。 また、ミニバン・ワゴンのフォルムを最大限に生かすローダウン量を設定。 コーナリング時のロールも抑え、シャープな走りを実現します。Ti2000スプリングはチタン配合の新素材が耐ヘタリ性をはじめ、あらゆる面でダントツの性能を発揮。 最高峰だからこそできる「ヘタリ永久保証」付きです。</p>
</div>
<div id="panel2" class="tab_panel">
<p>・ローダウンスプリング<br>・車検対応<br>・Ti2000スプリング<br>ヘタリ永久保証制度</p>
</div>
</div>
</div>
</div>
...
<!--ココまでSP-->
<tr>
<p class="search_category">**********【適合検索】**********&nbsp;&nbsp;<a class="change_button" href="../../set/item/10147.php"><img src="../../img/set_button.jpg" alt="工賃セットの価格表はコチラ"></a></p>
</tr>
<tr>
<td>
<!-- 車両メーカー検索ココから -->
<p class="search_category">【自動車メーカー】</p>
<form method="post" action="10147.php">
...
if($data[0] == '10147') $position = explode(";", $data[1]);
}
array_pop($position);
fclose($fp_position);
...
<form name="make" method="post" action="10147.php">
