       ...
       <div class="set_sale_back">
        ...
        <div class="set_menu_n row">
         <div class="set_menu_n_330 col-md-6 col-sm-12 col-xs-12">
          <div>
           <img alt="DAMPER ZZ-R Spec-C" src="../../brand/img/1144.gif"/>
          </div>
         </div>
         <div class="set_menu_n_cell col-md-6 col-sm-12 col-xs-12">
          ...
          <div class="item_info_text_middle_b">
           <p>
            DAMPER ZZ-R Spec-C[ダンパーZZ-R スペックC]
           </p>
          </div>
         </div>
        </div>
           ...
           <div class="swiper-container">
            <div class="swiper-wrapper">
             <div class="swiper-slide">
              <img alt="DAMPER ZZ-R Spec-C" src="../../item_img/10016_1.jpg"/>
             </div>
             <div class="swiper-slide">
              <img alt="DAMPER ZZ-R Spec-C" src="../../item_img/10016_2.jpg"/>
             </div>
             <div class="swiper-slide">
              <img alt="DAMPER ZZ-R Spec-C" src="../../item_img/10016_3.jpg"/>
             </div>
            </div>
          ...
          <div class="tab_wrap">
           ...
           <div class="tab-content">
            <div class="tab-pane fade in active show" id="home">
             <p>
              別タンクによるオイルの大容量化と、伸側・縮側をそれぞれ32段に独立して減衰力調整を実現する2WAY減衰力調整機構を採用。従来よりもさらにハイスペックな車高調キットとなっており、減衰力をより高次元でバランスさせることで、サーキットに特化せずストリートを含めた幅広いシチュエーションに対応します。
             </p>
            </div>
            <div class="tab-pane fade" id="menu2">
             <p>
              ・全ラインナップ単筒式(モノチューブ)採用の、全長調整式車高調キット。
              <br/>
              ・伸側・縮側をそれぞれ独立して調整可能な2WAY 32段減衰力調整機構を採用。
              <br/>
              ・別タンク式構造を採用し、オイル量を増大することで微低速域からでも十分に減衰力を発揮。
              <br/>
              ・別タンク式特有のホースライン構造を廃止し、取り付け時のトラブルを軽減。
              <br/>
              ・アルミ製アッパーマウント、ロックシート、ブラケット(一部)などを採用。高い強度と軽量化を両立します。
              <br/>
              ・単筒式ならではのφ46大径ピストンを採用し、しなやかな乗り心地と確かな追従性を実現します(一部車種除く)。
              <br/>
              ・オーバーホールにも対応。「新品カートリッジ先出し対応」とすることで、スムーズな対応とダンパー本来の性能を発揮。
             </p>
            </div>
           </div>
           <script>
        ...
        <table style="table-layout:fixed;" width="100%">
         <tr>
           ...
           **********【商品検索】**********
           <a class="change_button" href="../../set/item/10016.php">
            <img alt="単品販売の価格表はコチラ" src="../../img/sale_button.jpg"/>
           </a>
          </p>
         </tr>
        </table>
