...
<div class="left_menu_2">・<a href="../../set/cat/../../../Error_msg/404.html" page-origin="shop_menu/set/cat/110.html">タイヤ・ホイール</a></div>
...
<div class="mc_nav">
<a class="link" href="https://www.kts-web.com/">HOME</a> &gt; <a class="link" href="../../index.html">SHOP MENU</a> &gt; <a class="link" href="../../set/index.html">商品ラインナップ</a> &gt; <a class="link" href="../../set/cat/100.html">足回り</a> &gt; <a class="link" href="../../set/cat/116.html">車高調/セッティングパーツ</a> &gt; <a class="link" href="../../set/br/1144-116.html">BLITZ</a> &gt; <a class="link" href="10016.php">DAMPER ZZ-R Spec-C</a></div>
<div class="space3px"></div>
<div class="set_sale_back">
<div class="space3px"></div>
<div class="set_menu_n">
<div class="set_menu_n_330">
<div><img src="../../brand/img/1144.gif" alt="DAMPER ZZ-R Spec-C"></div></div>
<div class="set_menu_n_cell">
<div class="item_info_text_middle">
<p>BLITZ[ブリッツ]</p></div>
<div class="item_info_text_middle_b">
<p>DAMPER ZZ-R Spec-C[ダンパーZZ-R スペックC]</p></div>
</div></div>
...
<div class="swiper-slide"><img src="../../item_img/10016_1.jpg" alt="DAMPER ZZ-R Spec-C"></div>
<div class="swiper-slide"><img src="../../item_img/10016_2.jpg" alt="DAMPER ZZ-R Spec-C"></div>
<div class="swiper-slide"><img src="../../item_img/10016_3.jpg" alt="DAMPER ZZ-R Spec-C"></div>
</div>
...
<p>別タンクによるオイルの大容量化と、伸側・縮側をそれぞれ32段に独立して減衰力調整を実現する2WAY減衰力調整機構を採用。従来よりもさらにハイスペックな車高調キットとなっており、減衰力をより高次元でバランスさせることで、サーキットに特化せずストリートを含めた幅広いシチュエーションに対応します。</p>
</div>
<div id="panel2" class="tab_panel">
<p>・全ラインナップ単筒式(モノチューブ)採用の、全長調整式車高調キット。<br>・伸側・縮側をそれぞれ独立して調整可能な2WAY 32段減衰力調整機構を採用。<br>・別タンク式構造を採用し、オイル量を増大することで微低速域からでも十分に減衰力を発揮。<br>・別タンク式特有のホースライン構造を廃止し、取り付け時のトラブルを軽減。<br>・アルミ製アッパーマウント、ロックシート、ブラケット(一部)などを採用。高い強度と軽量化を両立します。<br>・単筒式ならではのφ46大径ピストンを採用し、しなやかな乗り心地と確かな追従性を実現します(一部車種除く)。<br>・オーバーホールにも対応。「新品カートリッジ先出し対応」とすることで、スムーズな対応とダンパー本来の性能を発揮。</p>
</div>
</div>
</div>
</div>
...
<div class="item_info_text_middle_b">
<p>DAMPER ZZ-R Spec-C [ダンパーZZ-R スペックC]</p>
</div>
<div class="tab_wrap">
...
<!--ココまでSP-->
<tr>
<p class="search_category">**********【適合検索】**********&nbsp;&nbsp;<a class="change_button" href="../../set/item/10016.php"><img src="../../img/set_button.jpg" alt="工賃セットの価格表はコチラ"></a></p>
</tr>
<tr>
<td>
<!-- 車両メーカー検索ココから -->
<p class="search_category">【自動車メーカー】</p>
<form method="post" action="10016.php">
...
if($data[0] == '10016') $position = explode(";", $data[1]);
}
array_pop($position);
fclose($fp_position);
...
<form name="make" method="post" action="10016.php">
