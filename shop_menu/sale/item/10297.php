<html>
<head>
<meta name="description" content="「ブレーキパッドがドライバーを選ぶ」というアグレッシブなコンセプトから生まれるCC-Rgは、強力な踏力によってタイヤを路面に押し付けることが出来るユーザーに向け開発されました。踏力を加えた後のコントロール性は素晴らしく、ビルドアップによる機器の変化もありません。">
...
<div class="swiper-slide"><img src="../../item_img/10297_1.jpg" alt="CC-Rg"></div>
<div class="swiper-slide"><img src="../../item_img/10297_2.jpg" alt="CC-Rg"></div>
<div class="swiper-slide"><img src="../../item_img/10297_3.jpg" alt="CC-Rg"></div>
</div>
...
<p>「ブレーキパッドがドライバーを選ぶ」というアグレッシブなコンセプトから生まれるCC-Rgは、強力な踏力によってタイヤを路面に押し付けることが出来るユーザーに向け開発されました。踏力を加えた後のコントロール性は素晴らしく、ビルドアップによる機器の変化もありません。</p>
</div>
<div id="panel2" class="tab_panel">
<p>・ローター適正温度域：50-800℃<br>・平均摩擦係数：0.38-0.45<br>・材質：セラミックカーボンメタル<br>・フィールド：ワインディング-サーキット</p>
</div>
</div>
</div>
</div>
...
<!--ココまでSP-->
<tr>
<p class="search_category">**********【適合検索】**********&nbsp;&nbsp;<a class="change_button" href="../../set/item/10297.php"><img src="../../img/set_button.jpg" alt="工賃セットの価格表はコチラ"></a></p>
</tr>
<tr>
<td>
<!-- 車両メーカー検索ココから -->
<p class="search_category">【自動車メーカー】</p>
<form method="post" action="10297.php">
...
if($data[0] == '10297') $position = explode(";", $data[1]);
}
array_pop($position);
fclose($fp_position);
...
<form name="make" method="post" action="10297.php">
