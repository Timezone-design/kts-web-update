...
<title>KTS-web 商品ラインナップ HKS HIPERMAX S-style C</title>
...
<div class="mc_nav">
<a class="link" href="https://www.kts-web.com/">HOME</a> &gt; <a class="link" href="../../index.html">SHOP MENU</a> &gt; <a class="link" href="../../set/index.html">商品ラインナップ</a> &gt; <a class="link" href="../../set/cat/100.html">足回り</a> &gt; <a class="link" href="../../set/cat/116.html">車高調/セッティングパーツ</a> &gt; <a class="link" href="../../set/br/1032-116.html">HKS</a> &gt; <a class="link" href="10083.php">HIPERMAX S-style C</a></div>
<div class="space3px"></div>
<div class="set_sale_back">
<div class="space3px"></div>
<div class="set_menu_n">
<div class="set_menu_n_330">
<div><img src="../../brand/img/1032.gif" alt="HIPERMAX S-style C"></div></div>
<div class="set_menu_n_cell">
<div class="item_info_text_middle">
<p>HKS[エッチケーエス]</p></div>
<div class="item_info_text_middle_b">
<p>HIPERMAX S-style C[ハイパーマックス Sスタイル C]</p></div>
</div></div>
...
<div class="swiper-slide"><img src="../../item_img/10083_1.jpg" alt="HIPERMAX S-style C"></div>
<div class="swiper-slide"><img src="../../item_img/10083_2.jpg" alt="HIPERMAX S-style C"></div>
<div class="swiper-slide"><img src="../../item_img/10083_3.jpg" alt="HIPERMAX S-style C"></div>
</div>
...
<p>ベストセラー「S-style」の最高傑作登場！硬くもなく、柔らかくもない、快適な走りを実現！！家族や仲間たちで快適なドライブを楽しみつつ、カッコよくカスタマイズもしたい。長距離ドライブでも疲れない乗り味にしたい。そんな普段使いでのリクエストを考慮し、ローダウンしていることすら忘れさせる乗り味を実現しました。</p>
</div>
<div id="panel2" class="tab_panel">
<p>・単筒式<br>・減衰力固定式<br>・全長調整式<br>・専用スペシャルオイル<br>・PNEコート<br>・PVS<br>・M4P<br>・倒立タイプ※ストラットタイプのみ<br>・強化ゴムアッパーマウント<br>・仕様変更可<br>・オーバーホール可<br>・3年6万キロ保証</p>
</div>
</div>
</div>
</div>
...
<div class="item_info_text_middle_b">
<p>HIPERMAX S-style C [ハイパーマックス Sスタイル C]</p>
</div>
<div class="tab_wrap">
...
<!--ココまでSP-->
<tr>
<p class="search_category">**********【適合検索】**********&nbsp;&nbsp;<a class="change_button" href="../../set/item/10083.php"><img src="../../img/set_button.jpg" alt="工賃セットの価格表はコチラ"></a></p>
</tr>
<tr>
<td>
<!-- 車両メーカー検索ココから -->
<p class="search_category">【自動車メーカー】</p>
<form method="post" action="10083.php">
...
if($data[0] == '10083') $position = explode(";", $data[1]);
}
array_pop($position);
fclose($fp_position);
...
<form name="make" method="post" action="10083.php">
