<html>
<head>
<meta name="description" content="JICだからこそ出来るアゲバネ！純正ショックとのマッチングを考えた設計により車高も乗り心地もアップ↑<br>アゲのサスチューンの面白さ、是非お試しください！！">
...
<title>KTS-web 商品ラインナップ JIC MAGIC Area35</title>
...
<div class="swiper-slide"><img src="../../item_img/10092_1.jpg" alt="Area35"></div>
<div class="swiper-slide"><img src="../../item_img/10092_2.jpg" alt="Area35"></div>
<div class="swiper-slide"><img src="../../item_img/10092_3.jpg" alt="Area35"></div>
</div>
...
<p>JICだからこそ出来るアゲバネ！純正ショックとのマッチングを考えた設計により車高も乗り心地もアップ↑<br>アゲのサスチューンの面白さ、是非お試しください！！</p>
</div>
<div id="panel2" class="tab_panel">
<p>・リフトアップサスペンション<br>・上げ幅：30-45mm(車種により異なります)</p>
</div>
</div>
</div>
</div>
...
<!--ココまでSP-->
<tr>
<p class="search_category">**********【適合検索】**********&nbsp;&nbsp;<a class="change_button" href="../../set/item/10092.php"><img src="../../img/set_button.jpg" alt="工賃セットの価格表はコチラ"></a></p>
</tr>
<tr>
<td>
<!-- 車両メーカー検索ココから -->
<p class="search_category">【自動車メーカー】</p>
<form method="post" action="10092.php">
...
if($data[0] == '10092') $position = explode(";", $data[1]);
}
array_pop($position);
fclose($fp_position);
...
<form name="make" method="post" action="10092.php">
