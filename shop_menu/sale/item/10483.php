<html>
<head>
<meta name="description" content="スーパーレスポンス。さらに制動距離の短縮によるサーキットでのラップタイムアップを可能にするアイテムです。<br>軽量クロモリフライホイール+強化クラッチカバー&クラッチディスクのセット品ならバランス加工済。<br>レスポンスと操作性を高次元でバランスしています。<br>フライホイールのみの交換も可能です。">
...
<title>KTS-web 商品ラインナップ 戸田レーシング 超軽量クロモリフライホイール&クラッチKIT</title>
...
<div class="mc_nav">
<a class="link" href="https://www.kts-web.com/">HOME</a> &gt; <a class="link" href="../../index.html">SHOP MENU</a> &gt; <a class="link" href="../../set/index.html">商品ラインナップ</a> &gt; <a class="link" href="../../set/cat/101.html">駆動系</a> &gt; <a class="link" href="../../set/cat/124.html">クラッチ/フライホイール</a> &gt; <a class="link" href="../../set/br/1111-124.html">戸田レーシング</a> &gt; <a class="link" href="10483.php">超軽量クロモリフライホイール&クラッチKIT</a></div>
<div class="space3px"></div>
<div class="set_sale_back">
<div class="space3px"></div>
<div class="set_menu_n">
<div class="set_menu_n_330">
<div><img src="../../brand/img/1111.gif" alt="超軽量クロモリフライホイール&クラッチKIT"></div></div>
<div class="set_menu_n_cell">
<div class="item_info_text_middle">
<p>戸田レーシング[トダレーシング]</p></div>
<div class="item_info_text_middle_b">
<p>超軽量クロモリフライホイール&クラッチKIT</p></div>
</div></div>
...
<div class="swiper-slide"><img src="../../item_img/10483_1.jpg" alt="超軽量クロモリフライホイール&クラッチKIT"></div>
<div class="swiper-slide"><img src="../../item_img/10483_2.jpg" alt="超軽量クロモリフライホイール&クラッチKIT"></div>
<div class="swiper-slide"><img src="../../item_img/10483_3.jpg" alt="超軽量クロモリフライホイール&クラッチKIT"></div>
</div>
...
<p>スーパーレスポンス。さらに制動距離の短縮によるサーキットでのラップタイムアップを可能にするアイテムです。<br>軽量クロモリフライホイール+強化クラッチカバー&クラッチディスクのセット品ならバランス加工済。<br>レスポンスと操作性を高次元でバランスしています。<br>フライホイールのみの交換も可能です。</p>
</div>
<div id="panel2" class="tab_panel">
<p>【スポーツディスク付KIT(バランス調整済)】<br>・超軽量クロモリフライホイール<br>・強化クラッチカバー<br>・スポーツフェーシングディスク(ノンアスベスト)<br><br>【メタルディスク付KIT(バランス調整済) 】<br>・超軽量クロモリフライホイール<br>・強化クラッチカバー<br>・メタルディスク</p>
</div>
</div>
</div>
</div>
...
<!--ココまでSP-->
<tr>
<p class="search_category">**********【適合検索】**********&nbsp;&nbsp;<a class="change_button" href="../../set/item/10483.php"><img src="../../img/set_button.jpg" alt="工賃セットの価格表はコチラ"></a></p>
</tr>
<tr>
<td>
<!-- 車両メーカー検索ココから -->
<p class="search_category">【自動車メーカー】</p>
<form method="post" action="10483.php">
...
if($data[0] == '10483') $position = explode(";", $data[1]);
}
array_pop($position);
fclose($fp_position);
...
<form name="make" method="post" action="10483.php">
