...
<title>KTS-web 商品ラインナップ CUSCO 赤のStreet ZERO A</title>
...
<div class="mc_nav">
<a class="link" href="https://www.kts-web.com/">HOME</a> &gt; <a class="link" href="../../index.html">SHOP MENU</a> &gt; <a class="link" href="../../set/index.html">商品ラインナップ</a> &gt; <a class="link" href="../../set/cat/100.html">足回り</a> &gt; <a class="link" href="../../set/cat/116.html">車高調/セッティングパーツ</a> &gt; <a class="link" href="../../set/br/1059-116.html">CUSCO</a> &gt; <a class="link" href="10029.php">赤のStreet ZERO A</a></div>
<div class="space3px"></div>
<div class="set_sale_back">
<div class="space3px"></div>
<div class="set_menu_n">
<div class="set_menu_n_330">
<div><img src="../../brand/img/1059.gif" alt="赤のStreet ZERO A"></div></div>
<div class="set_menu_n_cell">
<div class="item_info_text_middle">
<p>CUSCO[クスコ]</p></div>
<div class="item_info_text_middle_b">
<p>赤のStreet ZERO A[赤のストリートゼロA]</p></div>
</div></div>
...
<div class="swiper-slide"><img src="../../item_img/10029_1.jpg" alt="赤のStreet ZERO A"></div>
<div class="swiper-slide"><img src="../../item_img/10029_2.jpg" alt="赤のStreet ZERO A"></div>
<div class="swiper-slide"><img src="../../item_img/10029_3.jpg" alt="赤のStreet ZERO A"></div>
</div>
...
<p>違いがハッキリわかる減衰力（乗り心地）40段調整式で乗り心地もチューニングも走行ステージに合わせて自由自在です。「全長調整式車高調整」と「減衰力40段調整」のCUSCO streetシリーズ最上級モデル。CPRV（圧力適正化バルブ）で乗り心地の質感を向上しました。</p>
</div>
<div id="panel2" class="tab_panel">
<p>・減衰力40段調整<br>・全長調整式車高調整<br>・アッパーマウント標準装備<br>・(アッパーマウントレス構造車種は除く)<br>・強化ゴムアッパーマウントを採用（スポーツ車、セダン）<br>・フロントストラット形式にキャンバー調整式ピロアッパーマウントを設定<br>・CPRV（圧力適正化バルブ）採用<br>・e-con2対応</p>
</div>
</div>
</div>
</div>
...
<div class="item_info_text_middle_b">
<p>赤のStreet ZERO A [赤のストリートゼロA]</p>
</div>
<div class="tab_wrap">
...
<!--ココまでSP-->
<tr>
<p class="search_category">**********【適合検索】**********&nbsp;&nbsp;<a class="change_button" href="../../set/item/10029.php"><img src="../../img/set_button.jpg" alt="工賃セットの価格表はコチラ"></a></p>
</tr>
<tr>
<td>
<!-- 車両メーカー検索ココから -->
<p class="search_category">【自動車メーカー】</p>
<form method="post" action="10029.php">
...
if($data[0] == '10029') $position = explode(";", $data[1]);
}
array_pop($position);
fclose($fp_position);
...
<form name="make" method="post" action="10029.php">
