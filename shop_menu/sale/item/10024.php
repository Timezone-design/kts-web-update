...
<title>KTS-web 商品ラインナップ CUSCO 青のStreet ZERO</title>
...
<div class="mc_nav">
<a class="link" href="https://www.kts-web.com/">HOME</a> &gt; <a class="link" href="../../index.html">SHOP MENU</a> &gt; <a class="link" href="../../set/index.html">商品ラインナップ</a> &gt; <a class="link" href="../../set/cat/100.html">足回り</a> &gt; <a class="link" href="../../set/cat/116.html">車高調/セッティングパーツ</a> &gt; <a class="link" href="../../set/br/1059-116.html">CUSCO</a> &gt; <a class="link" href="10024.php">青のStreet ZERO</a></div>
<div class="space3px"></div>
<div class="set_sale_back">
<div class="space3px"></div>
<div class="set_menu_n">
<div class="set_menu_n_330">
<div><img src="../../brand/img/1059.gif" alt="青のStreet ZERO"></div></div>
<div class="set_menu_n_cell">
<div class="item_info_text_middle">
<p>CUSCO[クスコ]</p></div>
<div class="item_info_text_middle_b">
<p>青のStreet ZERO[青のストリートゼロ]</p></div>
</div></div>
...
<div class="swiper-slide"><img src="../../item_img/10024_1.jpg" alt="青のStreet ZERO"></div>
<div class="swiper-slide"><img src="../../item_img/10024_2.jpg" alt="青のStreet ZERO"></div>
<div class="swiper-slide"><img src="../../item_img/10024_3.jpg" alt="青のStreet ZERO"></div>
</div>
...
<p>「全長調整式車高調整」だから車高を変えても乗り心地はそのままさらにリヤ減衰力14段調整でシーンにあわせたセッティングが可能です。ラインナップする車種ごとに専用設計しているので、十分なバンプストロークを確保。 また1人乗車からフル乗車まで徹底的にテストしており、ミニバンならサードシートまで快適なセッティングを施しました。車種ごとの特性にマッチするトータルバランスに徹底的にこだわったセッティングで、快適でスタイリッシュなローダウンを約束します。</p>
</div>
<div id="panel2" class="tab_panel">
<p>・フロント減衰力固定、リヤに減衰力14段調整を標準装備<br>（一部車種はリヤ減衰力8段、もしくは減衰力固定）<br>・全長調整式車高調整<br>・アッパーマウントレスキット</p>
</div>
</div>
</div>
</div>
...
<!--ココまでSP-->
<tr>
<p class="search_category">**********【適合検索】**********&nbsp;&nbsp;<a class="change_button" href="../../set/item/10024.php"><img src="../../img/set_button.jpg" alt="工賃セットの価格表はコチラ"></a></p>
</tr>
<tr>
<td>
<!-- 車両メーカー検索ココから -->
<p class="search_category">【自動車メーカー】</p>
<form method="post" action="10024.php">
...
if($data[0] == '10024') $position = explode(";", $data[1]);
}
array_pop($position);
fclose($fp_position);
...
<form name="make" method="post" action="10024.php">
