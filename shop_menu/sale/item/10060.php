<html>
<head>
<meta name="description" content="レースシーンで築かれた確固たる実績と自信の「Swift スプリング」、そしてハイクオリティサスペンション「Finalkonnexion STEALTH」のコラボレーションで、さらなる高品質・高性能へ。追求したのはコントロール性と快適な乗り心地。街乗りからサーキット走行まで適応しつつ、ストリートでの快適性を犠牲にしない。反応はリニアでコントロール性を追及したベーシックモデルとしてコストパフォーマンスにも優れ、かつハイオリティを実現した商品です。">
...
<title>KTS-web 商品ラインナップ FINAL KONNEXION STEALTH Basic Type-2 Swift Springs Ver.</title>
...
{
@id: "/item/10060.php",
name: "STEALTH Basic Type-2 Swift Springs Ver."
}
}
]
}
...
<div class="left_menu_2">・<a href="../../set/cat/100.html">足回り関連</a></div>
<div class="left_menu_2">・<a href="../../set/cat/101.html">駆動系</a></div>
<div class="left_menu_2">・<a href="../../set/cat/102.html">冷却系</a></div>
<div class="left_menu_2">・<a href="../../set/cat/103.html">ブレーキ</a></div>
<div class="left_menu_2">・<a href="../../set/cat/104.html">ボディ・シャーシ</a></div>
<div class="left_menu_2">・<a href="../../set/cat/105.html">排気系</a></div>
<div class="left_menu_2">・<a href="../../set/cat/106.html">吸気系</a></div>
<div class="left_menu_2">・<a href="../../set/cat/107.html">過給機</a></div>
<div class="left_menu_2">・<a href="../../set/cat/108.html">燃料系</a></div>
<div class="left_menu_2">・<a href="../../set/cat/109.html">エンジン</a></div>
<div class="left_menu_2">・<a href="../../set/cat/110.html">タイヤ・ホイール</a></div>
<div class="left_menu_2">・<a href="../../set/cat/111.html">電装系</a></div>
<div class="left_menu_2">・<a href="../../set/cat/112.html">ケミカル</a></div>
<div class="left_menu_2">・<a href="../../set/cat/113.html">インテリア</a></div>
...
<div class="mc_nav">
<a class="link" href="https://www.kts-web.com/">HOME</a> &gt; <a class="link" href="../../index.html">SHOP MENU</a> &gt; <a class="link" href="../../set/index.html">商品ラインナップ</a> &gt; <a class="link" href="../../set/cat/100.html">足回り</a> &gt; <a class="link" href="../../set/cat/116.html">車高調/セッティングパーツ</a> &gt; <a class="link" href="../../set/br/1138-116.html">FINAL KONNEXION</a> &gt; <a class="link" href="10060.php">STEALTH Basic Type-2 Swift Springs Ver.</a></div>
<div class="space3px"></div>
<div class="set_sale_back">
<div class="space3px"></div>
<div class="set_menu_n">
<div class="set_menu_n_330">
<div><img src="../../brand/img/1138.gif" alt="STEALTH Basic Type-2 Swift Springs Ver."></div></div>
<div class="set_menu_n_cell">
<div class="item_info_text_middle">
<p>FINAL KONNEXION[ファイナルコネクション]</p></div>
<div class="item_info_text_middle_b">
<p>STEALTH Basic Type-2 Swift Springs Ver.[ステルスベーシンク タイプ2 スイフトスプリングバージョン]</p></div>
</div></div>
...
<div class="swiper-slide"><img src="../../item_img/10060_1.jpg" alt="STEALTH Basic Type-2 Swift Springs Ver."></div>
<div class="swiper-slide"><img src="../../item_img/10060_2.jpg" alt="STEALTH Basic Type-2 Swift Springs Ver."></div>
<div class="swiper-slide"><img src="../../item_img/10060_3.jpg" alt="STEALTH Basic Type-2 Swift Springs Ver."></div>
</div>
...
<p>レースシーンで築かれた確固たる実績と自信の「Swift スプリング」、そしてハイクオリティサスペンション「Finalkonnexion STEALTH」のコラボレーションで、さらなる高品質・高性能へ。追求したのはコントロール性と快適な乗り心地。街乗りからサーキット走行まで適応しつつ、ストリートでの快適性を犠牲にしない。反応はリニアでコントロール性を追及したベーシックモデルとしてコストパフォーマンスにも優れ、かつハイオリティを実現した商品です。</p>
</div>
<div id="panel2" class="tab_panel">
<p>・フルタップ・全長調整式<br>・Swiftスプリング仕様<br>・倒立式ショック(ストラットサス)<br>・リジットマウントタイプ<br>・減衰力25段調整機能付<br>・単筒式ショック<br>・ダストブーツ付<br>・オーバーホール可能</p>
</div>
</div>
</div>
</div>
...
<div class="item_info_text_middle">
<p>FINAL KONNEXION [ファイナルコネクション]</p>
</div>
<div class="item_info_text_middle_b">
<p>STEALTH Basic Type-2 Swift Springs Ver. [ステルスベーシンク タイプ2 スイフトスプリングバージョン]</p>
</div>
<div class="tab_wrap">
...
<!--ココまでSP-->
<tr>
<p class="search_category">**********【適合検索】**********&nbsp;&nbsp;<a class="change_button" href="../../set/item/10060.php"><img src="../../img/set_button.jpg" alt="工賃セットの価格表はコチラ"></a></p>
</tr>
<tr>
<td>
<!-- 車両メーカー検索ココから -->
<p class="search_category">【自動車メーカー】</p>
<form method="post" action="10060.php">
...
if($data[0] == '10060') $position = explode(";", $data[1]);
}
array_pop($position);
fclose($fp_position);
...
<form name="make" method="post" action="10060.php">
...
<div class="item_info_text_small">▼ご希望の車種をタップすると詳細・購入ページに遷移します。<br>※表示価格は税抜です。</div>
<div class="scroll">
