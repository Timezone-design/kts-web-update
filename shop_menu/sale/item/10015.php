...
<title>KTS-web 商品ラインナップ BLITZ DAMPER ZZ-R BB</title>
...
<div class="mc_nav">
<a class="link" href="https://www.kts-web.com/">HOME</a> &gt; <a class="link" href="../../index.html">SHOP MENU</a> &gt; <a class="link" href="../../set/index.html">商品ラインナップ</a> &gt; <a class="link" href="../../set/cat/100.html">足回り</a> &gt; <a class="link" href="../../set/cat/116.html">車高調/セッティングパーツ</a> &gt; <a class="link" href="../../set/br/1144-116.html">BLITZ</a> &gt; <a class="link" href="10015.php">DAMPER ZZ-R BB</a></div>
<div class="space3px"></div>
<div class="set_sale_back">
<div class="space3px"></div>
<div class="set_menu_n">
<div class="set_menu_n_330">
<div><img src="../../brand/img/1144.gif" alt="DAMPER ZZ-R BB"></div></div>
<div class="set_menu_n_cell">
<div class="item_info_text_middle">
<p>BLITZ[ブリッツ]</p></div>
<div class="item_info_text_middle_b">
<p>DAMPER ZZ-R BB[ダンパーZZ-R BB]</p></div>
</div></div>
...
<div class="swiper-slide"><img src="../../item_img/10015_1.jpg" alt="DAMPER ZZ-R BB"></div>
<div class="swiper-slide"><img src="../../item_img/10015_2.jpg" alt="DAMPER ZZ-R BB"></div>
<div class="swiper-slide"><img src="../../item_img/10015_3.jpg" alt="DAMPER ZZ-R BB"></div>
</div>
...
<p>単筒式(モノチューブ)構造、全長調整式、32段減衰力調整機構とDAMPER ZZ-Rのスペックを踏襲しながら、スタイルの幅広さと更なる走行性能を追求したハイスペックモデル。幅広いローダウンのニーズに応えるため、基準車高や調整範囲を新規設定。ローダウン状態でも最高のパフォーマンスを発揮。</p>
</div>
<div id="panel2" class="tab_panel">
<p>・アルミ製のピロボール調整式アッパーマウント、ロックシート、各種ブラケット(一部を除く)を採用<br>・32段減衰力調整機構を採用。また、電子制御で減衰力を調整可能な「SpecDSC」モデルも設定。<br>・車種の特性に合わせ、バネレート及び減衰力の仕様を専用品に変更。<br>・迫力のローフォルムながら最低地上高を確保できる車高から、クローズド向けの究極のローダウンまで対応します。<br>・カートリッジ先出しのオーバーホールに対応。従来とは異なるスムーズな対応で消耗品の交換が可能です。</p>
</div>
</div>
</div>
</div>
...
<div class="item_info_text_middle_b">
<p>DAMPER ZZ-R BB [ダンパーZZ-R BB]</p>
</div>
<div class="tab_wrap">
...
<!--ココまでSP-->
<tr>
<p class="search_category">**********【適合検索】**********&nbsp;&nbsp;<a class="change_button" href="../../set/item/10015.php"><img src="../../img/set_button.jpg" alt="工賃セットの価格表はコチラ"></a></p>
</tr>
<tr>
<td>
<!-- 車両メーカー検索ココから -->
<p class="search_category">【自動車メーカー】</p>
<form method="post" action="10015.php">
...
if($data[0] == '10015') $position = explode(";", $data[1]);
}
array_pop($position);
fclose($fp_position);
...
<form name="make" method="post" action="10015.php">
