...
<title>KTS-web 商品ラインナップ TEIN FLEX AVS</title>
...
<div class="mc_nav">
<a class="link" href="https://www.kts-web.com/">HOME</a> &gt; <a class="link" href="../../index.html">SHOP MENU</a> &gt; <a class="link" href="../../set/index.html">商品ラインナップ</a> &gt; <a class="link" href="../../set/cat/100.html">足回り</a> &gt; <a class="link" href="../../set/cat/116.html">車高調/セッティングパーツ</a> &gt; <a class="link" href="../../set/br/1104-116.html">TEIN</a> &gt; <a class="link" href="10191.php">FLEX AVS</a></div>
<div class="space3px"></div>
<div class="set_sale_back">
<div class="space3px"></div>
<div class="set_menu_n">
<div class="set_menu_n_330">
<div><img src="../../brand/img/1104.gif" alt="FLEX AVS"></div></div>
<div class="set_menu_n_cell">
<div class="item_info_text_middle">
<p>TEIN[テイン]</p></div>
<div class="item_info_text_middle_b">
<p>FLEX AVS[フレックスAVS]</p></div>
</div></div>
...
<div class="swiper-slide"><img src="../../item_img/10191_1.jpg" alt="FLEX AVS"></div>
<div class="swiper-slide"><img src="../../item_img/10191_2.jpg" alt="FLEX AVS"></div>
<div class="swiper-slide"><img src="../../item_img/10191_3.jpg" alt="FLEX AVS"></div>
</div>
...
<p>純正AVS(アダプティブ・バリアブル・サスペンション・システム)機能に対応したフルスペック車高調。トヨタやレクサスの一部車種に採用されているAVSはサスペンションをアフターパーツに交換すると、機能が失われていましたがFLEX AVSは純正のAVS機能は活かしたままローダウンが可能。</p>
</div>
<div id="panel2" class="tab_panel">
<p>・全長調整式<br>・AVS機能対応<br>・複筒式<br>・H.B.S.搭載<br>・防錆コーティング<br>・3年6万キロ+固着保証<br>・リプレイスメントサービス</p>
</div>
</div>
</div>
</div>
...
<!--ココまでSP-->
<tr>
<p class="search_category">**********【適合検索】**********&nbsp;&nbsp;<a class="change_button" href="../../set/item/10191.php"><img src="../../img/set_button.jpg" alt="工賃セットの価格表はコチラ"></a></p>
</tr>
<tr>
<td>
<!-- 車両メーカー検索ココから -->
<p class="search_category">【自動車メーカー】</p>
<form method="post" action="10191.php">
...
if($data[0] == '10191') $position = explode(";", $data[1]);
}
array_pop($position);
fclose($fp_position);
...
<form name="make" method="post" action="10191.php">
