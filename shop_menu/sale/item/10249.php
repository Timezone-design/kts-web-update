...
<title>KTS-web 商品ラインナップ BILSTEIN B16 DampTronic</title>
...
<div class="swiper-slide"><img src="../../item_img/10249_1.jpg" alt="B16 DampTronic"></div>
<div class="swiper-slide"><img src="../../item_img/10249_2.jpg" alt="B16 DampTronic"></div>
<div class="swiper-slide"><img src="../../item_img/10249_3.jpg" alt="B16 DampTronic"></div>
</div>
...
<p>妥協なきダイナミクス<br>比類なきエクスクルーシブカー、ポルシェや日産GT-Rのオーナーの足まわりの好みをさらに細かく設定させることができます。通勤や気ままなカントリードライブからクラブレーサーのレーシング・セッティングに至るまで、素早く最適なモードに切り替えことが可能です。</p>
</div>
<div id="panel2" class="tab_panel">
<p>・電子制御システムに完璧に適合<br>・素早く最適なモードに切り替え<br>・前後ともに約30〜50mmのローダウン化<br>・装着時に前後それぞれに20mmの調整範囲を設定<br>・サーキットレベルのテストを繰り返してファインチューン実施<br>・トリプルCテクノロジー（三層コーティング）による高い防錆性を実現<br>・耐久性の高いスポーツ・スプリング<br>・ビルシュタインならではのドイツ製モノチューブ倒立式サス<br>・TV（ドイツの技術検査機関）が認める性能</p>
</div>
</div>
</div>
</div>
...
<div class="item_info_text_middle_b">
<p>B16 DampTronic [B16ダンプトロニック]</p>
</div>
<div class="tab_wrap">
...
<!--ココまでSP-->
<tr>
<p class="search_category">**********【適合検索】**********&nbsp;&nbsp;<a class="change_button" href="../../set/item/10249.php"><img src="../../img/set_button.jpg" alt="工賃セットの価格表はコチラ"></a></p>
</tr>
<tr>
<td>
<!-- 車両メーカー検索ココから -->
<p class="search_category">【自動車メーカー】</p>
<form method="post" action="10249.php">
...
if($data[0] == '10249') $position = explode(";", $data[1]);
}
array_pop($position);
fclose($fp_position);
...
<form name="make" method="post" action="10249.php">
