<html>
<head>
<meta name="description" content="トップスポーツはスポーツ走行に最適なセッティングを施し、ワインディングロードからサーキットまで走る楽しさを追求したスポーツモデルです。">
...
<title>KTS-web 商品ラインナップ XYZ JAPAN TS IMP</title>
...
<div class="mc_nav">
<a class="link" href="https://www.kts-web.com/">HOME</a> &gt; <a class="link" href="../../index.html">SHOP MENU</a> &gt; <a class="link" href="../../set/index.html">商品ラインナップ</a> &gt; <a class="link" href="../../set/cat/100.html">足回り</a> &gt; <a class="link" href="../../set/cat/116.html">車高調/セッティングパーツ</a> &gt; <a class="link" href="../../set/br/1031-116.html">XYZ JAPAN</a> &gt; <a class="link" href="10216.php">TS IMP</a></div>
<div class="space3px"></div>
<div class="set_sale_back">
<div class="space3px"></div>
<div class="set_menu_n">
<div class="set_menu_n_330">
<div><img src="../../brand/img/1031.gif" alt="TS IMP"></div></div>
<div class="set_menu_n_cell">
<div class="item_info_text_middle">
<p>XYZ JAPAN[エックスワイゼット]</p></div>
<div class="item_info_text_middle_b">
<p>TS IMP[トップスポーツ インポート]</p></div>
</div></div>
...
<div class="swiper-slide"><img src="../../item_img/10216_1.jpg" alt="TS IMP"></div>
<div class="swiper-slide"><img src="../../item_img/10216_2.jpg" alt="TS IMP"></div>
<div class="swiper-slide"><img src="../../item_img/10216_3.jpg" alt="TS IMP"></div>
</div>
...
<p>トップスポーツはスポーツ走行に最適なセッティングを施し、ワインディングロードからサーキットまで走る楽しさを追求したスポーツモデルです。</p>
</div>
<div id="panel2" class="tab_panel">
<p>・サーキット仕様<br>・フルタップ全長調整式<br>・減衰力30段調整<br>・調整式ピロアッパー※一部車種除く<br>・単筒式モノチューブ構造<br>・耐食・防錆フッ素コーティング</p>
</div>
</div>
</div>
</div>
...
<!--ココまでSP-->
<tr>
<p class="search_category">**********【適合検索】**********&nbsp;&nbsp;<a class="change_button" href="../../set/item/10216.php"><img src="../../img/set_button.jpg" alt="工賃セットの価格表はコチラ"></a></p>
</tr>
<tr>
<td>
<!-- 車両メーカー検索ココから -->
<p class="search_category">【自動車メーカー】</p>
<form method="post" action="10216.php">
...
if($data[0] == '10216') $position = explode(";", $data[1]);
}
array_pop($position);
fclose($fp_position);
...
<form name="make" method="post" action="10216.php">
