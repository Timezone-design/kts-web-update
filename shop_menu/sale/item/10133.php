...
<title>KTS-web 商品ラインナップ RS★R Basic☆i</title>
...
<div class="mc_nav">
<a class="link" href="https://www.kts-web.com/">HOME</a> &gt; <a class="link" href="../../index.html">SHOP MENU</a> &gt; <a class="link" href="../../set/index.html">商品ラインナップ</a> &gt; <a class="link" href="../../set/cat/100.html">足回り</a> &gt; <a class="link" href="../../set/cat/116.html">車高調/セッティングパーツ</a> &gt; <a class="link" href="../../set/br/1001-116.html">RS★R</a> &gt; <a class="link" href="10133.php">Basic☆i</a></div>
<div class="space3px"></div>
<div class="set_sale_back">
<div class="space3px"></div>
<div class="set_menu_n">
<div class="set_menu_n_330">
<div><img src="../../brand/img/1001.gif" alt="Basic☆i"></div></div>
<div class="set_menu_n_cell">
<div class="item_info_text_middle">
<p>RS★R[アールエスアール]</p></div>
<div class="item_info_text_middle_b">
<p>Basic☆i[ベーシックアイ]</p></div>
</div></div>
...
<div class="swiper-slide"><img src="../../item_img/10133_1.jpg" alt="Basic☆i"></div>
<div class="swiper-slide"><img src="../../item_img/10133_2.jpg" alt="Basic☆i"></div>
<div class="swiper-slide"><img src="../../item_img/10133_3.jpg" alt="Basic☆i"></div>
</div>
...
<p>減衰力固定でありながら快適性を追求したセッティング。Best☆ⅰを基準として、シンプルな機構(機能)でリーズナブルな仕様となっています。きっちり車高を落としてもしっかりストロークを確保して乗り心地を損なわない、全長調整式・単筒式を採用。 また異音に対しても徹底的に対策し、あらゆる面で快適さを追求しています。乗り心地を追求したセッティングを維持し、安定した走りで疲れを感じさせない引き締まった走りをお約束します。</p>
</div>
<div id="panel2" class="tab_panel">
<p>・全長調整式<br>・単筒式<br>・Ti2000スプリング採用<br>・スチールアッパーマウント(一部車種を除く)<br>・ストリートユース向けオイル採用</p>
</div>
</div>
</div>
</div>
...
<!--ココまでSP-->
<tr>
<p class="search_category">**********【適合検索】**********&nbsp;&nbsp;<a class="change_button" href="../../set/item/10133.php"><img src="../../img/set_button.jpg" alt="工賃セットの価格表はコチラ"></a></p>
</tr>
<tr>
<td>
<!-- 車両メーカー検索ココから -->
<p class="search_category">【自動車メーカー】</p>
<form method="post" action="10133.php">
...
if($data[0] == '10133') $position = explode(";", $data[1]);
}
array_pop($position);
fclose($fp_position);
...
<form name="make" method="post" action="10133.php">
