<html>
<head>
<meta name="description" content="アラゴスタの原点となる最上級スペック搭載のスポーツ性能を有するモデル。TYPE-Sの『S』はスポーツコンセプトの『S』です。ワインディングからサーキット走行まで最適な乗り味を実現します。リニアなハンドリングや切れ目のないトラクション性能も秀逸。しなやかにして適度な硬さが生む爽快性をマキシマムに体感できるキットです。">
...
<title>KTS-web 商品ラインナップ Aragosta TYPE-S</title>
...
<div class="mc_nav">
<a class="link" href="https://www.kts-web.com/">HOME</a> &gt; <a class="link" href="../../index.html">SHOP MENU</a> &gt; <a class="link" href="../../set/index.html">商品ラインナップ</a> &gt; <a class="link" href="../../set/cat/100.html">足回り</a> &gt; <a class="link" href="../../set/cat/116.html">車高調/セッティングパーツ</a> &gt; <a class="link" href="../../set/br/1010-116.html">Aragosta</a> &gt; <a class="link" href="10003.php">TYPE-S</a></div>
<div class="space3px"></div>
<div class="set_sale_back">
<div class="space3px"></div>
<div class="set_menu_n">
<div class="set_menu_n_330">
<div><img src="../../brand/img/1010.gif" alt="TYPE-S"></div></div>
...
<div class="swiper-slide"><img src="../../item_img/10003_1.jpg" alt="TYPE-S"></div>
<div class="swiper-slide"><img src="../../item_img/10003_2.jpg" alt="TYPE-S"></div>
<div class="swiper-slide"><img src="../../item_img/10003_3.jpg" alt="TYPE-S"></div>
</div>
...
<p>アラゴスタの原点となる最上級スペック搭載のスポーツ性能を有するモデル。TYPE-Sの『S』はスポーツコンセプトの『S』です。ワインディングからサーキット走行まで最適な乗り味を実現します。リニアなハンドリングや切れ目のないトラクション性能も秀逸。しなやかにして適度な硬さが生む爽快性をマキシマムに体感できるキットです。</p>
</div>
<div id="panel2" class="tab_panel">
<p>・鍛造アルミシリンダー+カシマコーティング<br>・Φ40/Φ46倒立ストラット+WPC加工<br>・高剛性スティールシリンダー+カチオン塗装<br>・ピロアッパーマウント/ラバーアッパーマウント<br>・全長調整機能/20段減衰力調整機能<br>・rana spring<br><br>※車種によりTYPEそれぞれの仕様は異なります。詳しくは詳細ページをご確認ください。</p>
</div>
</div>
</div>
</div>
...
<!--ココまでSP-->
<tr>
<p class="search_category">**********【適合検索】**********&nbsp;&nbsp;<a class="change_button" href="../../set/item/10003.php"><img src="../../img/set_button.jpg" alt="工賃セットの価格表はコチラ"></a></p>
</tr>
<tr>
<td>
<!-- 車両メーカー検索ココから -->
<p class="search_category">【自動車メーカー】</p>
<form method="post" action="10003.php">
...
if($data[0] == '10003') $position = explode(";", $data[1]);
}
array_pop($position);
fclose($fp_position);
...
<form name="make" method="post" action="10003.php">
