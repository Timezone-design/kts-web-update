...
<title>KTS-web 商品ラインナップ ESPELIR Super DOWNSUS Type-2</title>
...
<div class="mc_nav">
<a class="link" href="https://www.kts-web.com/">HOME</a> &gt; <a class="link" href="../../index.html">SHOP MENU</a> &gt; <a class="link" href="../../set/index.html">商品ラインナップ</a> &gt; <a class="link" href="../../set/cat/100.html">足回り</a> &gt; <a class="link" href="../../set/cat/117.html">ダウンサス/アップサス</a> &gt; <a class="link" href="../../set/br/1030-117.html">ESPELIR</a> &gt; <a class="link" href="10047.php">Super DOWNSUS Type-2</a></div>
<div class="space3px"></div>
<div class="set_sale_back">
<div class="space3px"></div>
<div class="set_menu_n">
<div class="set_menu_n_330">
<div><img src="../../brand/img/1030.gif" alt="Super DOWNSUS Type-2"></div></div>
<div class="set_menu_n_cell">
<div class="item_info_text_middle">
<p>ESPELIR[エスペリア]</p></div>
<div class="item_info_text_middle_b">
<p>商品名：Super DOWNSUS Type-2[スーパーダウンサス タイプ2]</p></div>
</div></div>
...
<div class="swiper-slide"><img src="../../item_img/10047_1.jpg" alt="Super DOWNSUS Type-2"></div>
<div class="swiper-slide"><img src="../../item_img/10047_2.jpg" alt="Super DOWNSUS Type-2"></div>
<div class="swiper-slide"><img src="../../item_img/10047_3.jpg" alt="Super DOWNSUS Type-2"></div>
</div>
...
<p>SuperDOWNSUS Type-2はSuperDOWNSUSよりさらにローダウンしたタイプで極限のローフォルムを実現します。ストローク幅がさらに少なくなるので別売の「スーパーダウンサスラバー」を同時装着するこ事でストローク量が増し乗り心地が大幅に改善します。<br>※灯火類の高さ及び最低地上高に余裕がある車両に設定していますが、一部例外の車両もあります。</p>
</div>
<div id="panel2" class="tab_panel">
<p>・保安基準適合製品<br>・国産車カラー：ブルー/イエロー(クロスカントリー車)</p>
</div>
</div>
</div>
</div>
...
<div class="item_info_text_middle_b">
<p>Super DOWNSUS Type-2 [スーパーダウンサス タイプ2]</p>
</div>
<div class="tab_wrap">
...
<!--ココまでSP-->
<tr>
<p class="search_category">**********【適合検索】**********&nbsp;&nbsp;<a class="change_button" href="../../set/item/10047.php"><img src="../../img/set_button.jpg" alt="工賃セットの価格表はコチラ"></a></p>
</tr>
<tr>
<td>
<!-- 車両メーカー検索ココから -->
<p class="search_category">【自動車メーカー】</p>
<form method="post" action="10047.php">
...
if($data[0] == '10047') $position = explode(";", $data[1]);
}
array_pop($position);
fclose($fp_position);
...
<form name="make" method="post" action="10047.php">
