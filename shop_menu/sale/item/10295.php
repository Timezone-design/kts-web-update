<html>
<head>
<meta name="description" content="フローティングディスクは、特殊鋳鉄のブレーキ面とアルミ合金のハブで構成されており、この2つをフローティングピンで繋いでいます。このタイプの手法は、ディスク面が変形することなく拡熱膨張することができ、重量の大幅な削減にもなるため、パフォーマンスに重点をおく車両には非常に重要なポイントです。">
...
<div class="swiper-slide"><img src="../../item_img/10295_1.jpg" alt="フローティングブレーキディスク"></div>
<div class="swiper-slide"><img src="../../item_img/10295_2.jpg" alt="フローティングブレーキディスク"></div>
<div class="swiper-slide"><img src="../../item_img/10295_3.jpg" alt="フローティングブレーキディスク"></div>
</div>
...
<p>フローティングディスクは、特殊鋳鉄のブレーキ面とアルミ合金のハブで構成されており、この2つをフローティングピンで繋いでいます。このタイプの手法は、ディスク面が変形することなく拡熱膨張することができ、重量の大幅な削減にもなるため、パフォーマンスに重点をおく車両には非常に重要なポイントです。</p>
</div>
<div id="panel2" class="tab_panel">
<p>・フローティングディスク<br>・ピラーベンチレーションディスク(PVT)<br>・UVコーティング<br>・ハイカーボン<br>※一部車種を除く</p>
</div>
</div>
</div>
</div>
...
<!--ココまでSP-->
<tr>
<p class="search_category">**********【適合検索】**********&nbsp;&nbsp;<a class="change_button" href="../../set/item/10295.php"><img src="../../img/set_button.jpg" alt="工賃セットの価格表はコチラ"></a></p>
</tr>
<tr>
<td>
<!-- 車両メーカー検索ココから -->
<p class="search_category">【自動車メーカー】</p>
<form method="post" action="10295.php">
...
if($data[0] == '10295') $position = explode(";", $data[1]);
}
array_pop($position);
fclose($fp_position);
...
<form name="make" method="post" action="10295.php">
