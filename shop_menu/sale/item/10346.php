<html>
<head>
<meta name="description" content="ノーマルパッドよりワンランク上の制動力と耐摩耗性（寿命）<br>鳴きが少なく快適！また、ローターへの負担も少ないので経済的<br>スコーチ（パッド表面焼付）により初期なじみも抜群<br>ノーマルパッドと同様に、「機械式センサー」装着済（一部品番を除く）">
...
<title>KTS-web 商品ラインナップ DIXCEL EC</title>
...
<div class="swiper-slide"><img src="../../item_img/10346_1.jpg" alt="EC"></div>
<div class="swiper-slide"><img src="../../item_img/10346_2.jpg" alt="EC"></div>
<div class="swiper-slide"><img src="../../item_img/10346_3.jpg" alt="EC"></div>
</div>
...
<p>ノーマルパッドよりワンランク上の制動力と耐摩耗性（寿命）<br>鳴きが少なく快適！また、ローターへの負担も少ないので経済的<br>スコーチ（パッド表面焼付）により初期なじみも抜群<br>ノーマルパッドと同様に、「機械式センサー」装着済（一部品番を除く）</p>
</div>
<div id="panel2" class="tab_panel">
<p>・材質:NAO<br>・適正温度:0～450℃<br>・Max μ:0.50<br>・Ave μ:0.41<br>・Min μ:0.35<br>・ステージ:ストリート/ワインディング(ノーマル)</p>
</div>
</div>
</div>
</div>
...
<!--ココまでSP-->
<tr>
<p class="search_category">**********【適合検索】**********&nbsp;&nbsp;<a class="change_button" href="../../set/item/10346.php"><img src="../../img/set_button.jpg" alt="工賃セットの価格表はコチラ"></a></p>
</tr>
<tr>
<td>
<!-- 車両メーカー検索ココから -->
<p class="search_category">【自動車メーカー】</p>
<form method="post" action="10346.php">
...
if($data[0] == '10346') $position = explode(";", $data[1]);
}
array_pop($position);
fclose($fp_position);
...
<form name="make" method="post" action="10346.php">
