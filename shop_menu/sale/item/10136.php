...
<title>KTS-web 商品ラインナップ RS★R Black☆i</title>
...
<div class="mc_nav">
<a class="link" href="https://www.kts-web.com/">HOME</a> &gt; <a class="link" href="../../index.html">SHOP MENU</a> &gt; <a class="link" href="../../set/index.html">商品ラインナップ</a> &gt; <a class="link" href="../../set/cat/100.html">足回り</a> &gt; <a class="link" href="../../set/cat/116.html">車高調/セッティングパーツ</a> &gt; <a class="link" href="../../set/br/1001-116.html">RS★R</a> &gt; <a class="link" href="10136.php">Black☆i</a></div>
<div class="space3px"></div>
<div class="set_sale_back">
<div class="space3px"></div>
<div class="set_menu_n">
<div class="set_menu_n_330">
<div><img src="../../brand/img/1001.gif" alt="Black☆i"></div></div>
<div class="set_menu_n_cell">
<div class="item_info_text_middle">
<p>RS★R[アールエスアール]</p></div>
<div class="item_info_text_middle_b">
<p>Black☆i[ブラックアイ]</p></div>
</div></div>
...
<div class="swiper-slide"><img src="../../item_img/10136_1.jpg" alt="Black☆i"></div>
<div class="swiper-slide"><img src="../../item_img/10136_2.jpg" alt="Black☆i"></div>
<div class="swiper-slide"><img src="../../item_img/10136_3.jpg" alt="Black☆i"></div>
</div>
...
<p>各車種の初期出荷時は、最低地上高90mm～100mmを確保する設計としながらも、ダウン量に関しては従来のi☆SHOCKシリーズを超えるダウン領域のセッティングが可能。また、Black☆i専用となる超ショートストローク&超ショートケース仕様のショックを各車種毎設計。 減衰力、スプリングレートと共にハード仕様を採用する事により、車体の無駄な動きを抑制して 迫力のダウンフォルムとシャープな走りを実現します。</p>
</div>
<div id="panel2" class="tab_panel">
<p>・減衰力36段調整<br>・単筒式<br>・全長調整式<br>・スチールアッパーマウント(専用のブラック仕様)<br>・ストリートユース向けオイル採用</p>
</div>
</div>
</div>
</div>
...
<!--ココまでSP-->
<tr>
<p class="search_category">**********【適合検索】**********&nbsp;&nbsp;<a class="change_button" href="../../set/item/10136.php"><img src="../../img/set_button.jpg" alt="工賃セットの価格表はコチラ"></a></p>
</tr>
<tr>
<td>
<!-- 車両メーカー検索ココから -->
<p class="search_category">【自動車メーカー】</p>
<form method="post" action="10136.php">
...
if($data[0] == '10136') $position = explode(";", $data[1]);
}
array_pop($position);
fclose($fp_position);
...
<form name="make" method="post" action="10136.php">
