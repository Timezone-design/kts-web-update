<html>
<head>
<meta name="description" content="追求したのはコントロール性と快適な乗り心地。街乗りからサーキット走行まで適応しつつ、ストリートでの快適性を犠牲にしない。反応はリニアでコントロール性を追及したベーシックモデルとしてコストパフォーマンスにも優れ、かつハイオリティを実現した商品です。">
...
<title>KTS-web 商品ラインナップ FINAL KONNEXION STEALTH Basic Type-2</title>
...
<p>STEALTH Basic Type-2[ステルスベーシック タイプ2]</p></div>
</div></div>
...
<div class="swiper-slide"><img src="../../item_img/10056_1.jpg" alt="STEALTH Basic Type-2"></div>
<div class="swiper-slide"><img src="../../item_img/10056_2.jpg" alt="STEALTH Basic Type-2"></div>
<div class="swiper-slide"><img src="../../item_img/10056_3.jpg" alt="STEALTH Basic Type-2"></div>
</div>
...
<p>追求したのはコントロール性と快適な乗り心地。街乗りからサーキット走行まで適応しつつ、ストリートでの快適性を犠牲にしない。反応はリニアでコントロール性を追及したベーシックモデルとしてコストパフォーマンスにも優れ、かつハイオリティを実現した商品です。</p>
</div>
<div id="panel2" class="tab_panel">
<p>・フルタップ・全長調整式<br>・倒立式ショック(ストラットサス)<br>・リジットマウントタイプ<br>・減衰力25段調整機能付<br>・単筒式ショック<br>・ダストブーツ付<br>・オーバーホール可能</p>
</div>
</div>
</div>
</div>
...
<div class="item_info_text_middle_b">
<p>STEALTH Basic Type-2 [ステルスベーシック タイプ2]</p>
</div>
<div class="tab_wrap">
...
<!--ココまでSP-->
<tr>
<p class="search_category">**********【適合検索】**********&nbsp;&nbsp;<a class="change_button" href="../../set/item/10056.php"><img src="../../img/set_button.jpg" alt="工賃セットの価格表はコチラ"></a></p>
</tr>
<tr>
<td>
<!-- 車両メーカー検索ココから -->
<p class="search_category">【自動車メーカー】</p>
<form method="post" action="10056.php">
...
if($data[0] == '10056') $position = explode(";", $data[1]);
}
array_pop($position);
fclose($fp_position);
...
<form name="make" method="post" action="10056.php">
