<html>
<head>
<meta name="description" content="活性炭を織り込み、更に特殊6層構造でPM2.5まで徹底ブロックするエアコンフィルターです。<br>たかがエアコンフィルターですが、汚れているとエアコン風量だけでなく、エンジン出力・燃費にまで影響しますので、こまめな清掃・交換をお勧めします。">
...
{
@id: "/item/10669.php",
name: "エアコンフィルター カーボンタイプ PM2.5cut ver."
}
}
]
}
...
<div class="mc_nav">
<a class="link" href="https://www.kts-web.com/">HOME</a> &gt; <a class="link" href="../../index.html">SHOP MENU</a> &gt; <a class="link" href="../../set/index.html">商品ラインナップ</a> &gt; <a class="link" href="../../set/cat/113.html">インテリア</a> &gt; <a class="link" href="../../set/cat/179.html">その他インテリア系</a> &gt; <a class="link" href="../../set/br/1180-179.html">STRIKE</a> &gt; <a class="link" href="10669.php">エアコンフィルター カーボンタイプ PM2.5cut ver.</a></div>
<div class="space3px"></div>
<div class="set_sale_back">
<div class="space3px"></div>
<div class="set_menu_n">
<div class="set_menu_n_330">
<div><img src="../../brand/img/1180.gif" alt="エアコンフィルター カーボンタイプ PM2.5cut ver."></div></div>
<div class="set_menu_n_cell">
<div class="item_info_text_middle">
<p>STRIKE[ストライク]</p></div>
<div class="item_info_text_middle_b">
<p>エアコンフィルター カーボンタイプ PM2.5cut ver.</p></div>
</div></div>
...
<div class="swiper-slide"><img src="../../item_img/10669_1.jpg" alt="エアコンフィルター カーボンタイプ PM2.5cut ver."></div>
<div class="swiper-slide"><img src="../../item_img/10669_2.jpg" alt="エアコンフィルター カーボンタイプ PM2.5cut ver."></div>
<div class="swiper-slide"><img src="../../item_img/10669_3.jpg" alt="エアコンフィルター カーボンタイプ PM2.5cut ver."></div>
</div>
...
<p>活性炭を織り込み、更に特殊6層構造でPM2.5まで徹底ブロックするエアコンフィルターです。<br>たかがエアコンフィルターですが、汚れているとエアコン風量だけでなく、エンジン出力・燃費にまで影響しますので、こまめな清掃・交換をお勧めします。</p>
</div>
<div id="panel2" class="tab_panel">
<p>タイプ：カーボンタイプ PM2.5カットバージョン</p>
</div>
</div>
</div>
</div>
...
<div class="item_info_text_middle_b">
<p>エアコンフィルター カーボンタイプ PM2.5cut ver.</p>
</div>
<div class="tab_wrap">
...
<!--ココまでSP-->
<tr>
<p class="search_category">**********【適合検索】**********&nbsp;&nbsp;<a class="change_button" href="../../set/item/10669.php"><img src="../../img/set_button.jpg" alt="工賃セットの価格表はコチラ"></a></p>
</tr>
<tr>
<td>
<!-- 車両メーカー検索ココから -->
<p class="search_category">【自動車メーカー】</p>
<form method="post" action="10669.php">
...
if($data[0] == '10669') $position = explode(";", $data[1]);
}
array_pop($position);
fclose($fp_position);
...
<form name="make" method="post" action="10669.php">
