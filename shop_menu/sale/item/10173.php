...
<title>KTS-web 商品ラインナップ TANABE SUSTEC PRO CR</title>
...
<div class="mc_nav">
<a class="link" href="https://www.kts-web.com/">HOME</a> &gt; <a class="link" href="../../index.html">SHOP MENU</a> &gt; <a class="link" href="../../set/index.html">商品ラインナップ</a> &gt; <a class="link" href="../../set/cat/100.html">足回り</a> &gt; <a class="link" href="../../set/cat/116.html">車高調/セッティングパーツ</a> &gt; <a class="link" href="../../set/br/1095-116.html">TANABE</a> &gt; <a class="link" href="10173.php">SUSTEC PRO CR</a></div>
<div class="space3px"></div>
<div class="set_sale_back">
<div class="space3px"></div>
<div class="set_menu_n">
<div class="set_menu_n_330">
<div><img src="../../brand/img/1095.gif" alt="SUSTEC PRO CR"></div></div>
<div class="set_menu_n_cell">
<div class="item_info_text_middle">
<p>TANABE[タナベ]</p></div>
<div class="item_info_text_middle_b">
<p>SUSTEC PRO CR[サステックプロ CR]</p></div>
</div></div>
...
<div class="swiper-slide"><img src="../../item_img/10173_1.jpg" alt="SUSTEC PRO CR"></div>
<div class="swiper-slide"><img src="../../item_img/10173_2.jpg" alt="SUSTEC PRO CR"></div>
<div class="swiper-slide"><img src="../../item_img/10173_3.jpg" alt="SUSTEC PRO CR"></div>
</div>
...
<p>至上の乗り心地性能を身近にする減衰力プリセットモデル。実走テストは様々な路面状況を再現した専用のテストコースで実施。乗り心地検証は実際にローダウンセッティングして、フル乗車でのライド感もしっかりチェック。満足いただける性能を確認できたものだけをお届け。</p>
</div>
<div id="panel2" class="tab_panel">
<p>・不快なゴツゴツ感を大幅に軽減するノンプリロードバルブ<br>・自然で安心感のあるロール感バレルフォルム<br>・走行中の異音を防止するダブルシートリング<br>・特殊メッキ＆A6061アルミ材<br>・車種別専用設計<br>・ロングライフな高性能を約束 10万キロ100万回耐久テスト<br>・不満のない乗り心地を確約 実走テイスティング<br>・1年間・走行距離10,000kmの保証</p>
</div>
</div>
</div>
</div>
...
<!--ココまでSP-->
<tr>
<p class="search_category">**********【適合検索】**********&nbsp;&nbsp;<a class="change_button" href="../../set/item/10173.php"><img src="../../img/set_button.jpg" alt="工賃セットの価格表はコチラ"></a></p>
</tr>
<tr>
<td>
<!-- 車両メーカー検索ココから -->
<p class="search_category">【自動車メーカー】</p>
<form method="post" action="10173.php">
...
if($data[0] == '10173') $position = explode(";", $data[1]);
}
array_pop($position);
fclose($fp_position);
...
<form name="make" method="post" action="10173.php">
