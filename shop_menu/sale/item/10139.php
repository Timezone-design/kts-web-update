...
<title>KTS-web 商品ラインナップ RS★R Sports☆i</title>
...
<div class="mc_nav">
<a class="link" href="https://www.kts-web.com/">HOME</a> &gt; <a class="link" href="../../index.html">SHOP MENU</a> &gt; <a class="link" href="../../set/index.html">商品ラインナップ</a> &gt; <a class="link" href="../../set/cat/100.html">足回り</a> &gt; <a class="link" href="../../set/cat/116.html">車高調/セッティングパーツ</a> &gt; <a class="link" href="../../set/br/1001-116.html">RS★R</a> &gt; <a class="link" href="10139.php">Sports☆i</a></div>
<div class="space3px"></div>
<div class="set_sale_back">
<div class="space3px"></div>
<div class="set_menu_n">
<div class="set_menu_n_330">
<div><img src="../../brand/img/1001.gif" alt="Sports☆i"></div></div>
<div class="set_menu_n_cell">
<div class="item_info_text_middle">
<p>RS★R[アールエスアール]</p></div>
<div class="item_info_text_middle_b">
<p>Sports☆i[スポーツアイ]</p></div>
</div></div>
...
<div class="swiper-slide"><img src="../../item_img/10139_1.jpg" alt="Sports☆i"></div>
<div class="swiper-slide"><img src="../../item_img/10139_2.jpg" alt="Sports☆i"></div>
<div class="swiper-slide"><img src="../../item_img/10139_3.jpg" alt="Sports☆i"></div>
</div>
...
<p>ワインディングやサーキットでしっかりとした乗り味が得られることをコンセプトに開発されたスポーツ走行向け車高調。スポーツ走行にふさわしいシャープなハンドリング特性と優れたコーナリング特性が得られ、ステージに合わせた幅広いセッティング範囲と 基本性能を持ち合わせています。また、オプション設定にてピロボールアッパーマウント仕様も用意(一部車種除く)。</p>
</div>
<div id="panel2" class="tab_panel">
<p>・減衰力36段調整<br>・単筒式Φ40ボディ(ストラット式はΦ46)<br>・Ti2000スプリング採用<br>・一部車種にヘルパースプリングを設定<br>・スチールアッパーマウント(一部車種を除く)<br>・ピロボールアッパーマウント仕様を設定(一部車種を除く)<br>・充実の製品保証制度</p>
</div>
</div>
</div>
</div>
...
<!--ココまでSP-->
<tr>
<p class="search_category">**********【適合検索】**********&nbsp;&nbsp;<a class="change_button" href="../../set/item/10139.php"><img src="../../img/set_button.jpg" alt="工賃セットの価格表はコチラ"></a></p>
</tr>
<tr>
<td>
<!-- 車両メーカー検索ココから -->
<p class="search_category">【自動車メーカー】</p>
<form method="post" action="10139.php">
...
if($data[0] == '10139') $position = explode(";", $data[1]);
}
array_pop($position);
fclose($fp_position);
...
<form name="make" method="post" action="10139.php">
