<html>
<head>
<meta name="description" content="ストッピングパワーを犠牲にすることなく、ダストは大幅に低減！<br>高いコントロール性により、ワンランク上のブレーキングコントロールが可能に！<br>唐突に効くのではなく、踏力に応じて効きが上がるビルドアップ型のため、同乗者も快適<br>ローター攻撃性も驚くほど低く、ローターのロングライフ化にも大きく貢献">
...
<div class="swiper-slide"><img src="../../item_img/10344_1.jpg" alt="M type"></div>
<div class="swiper-slide"><img src="../../item_img/10344_2.jpg" alt="M type"></div>
<div class="swiper-slide"><img src="../../item_img/10344_3.jpg" alt="M type"></div>
</div>
...
<p>ストッピングパワーを犠牲にすることなく、ダストは大幅に低減！<br>高いコントロール性により、ワンランク上のブレーキングコントロールが可能に！<br>唐突に効くのではなく、踏力に応じて効きが上がるビルドアップ型のため、同乗者も快適<br>ローター攻撃性も驚くほど低く、ローターのロングライフ化にも大きく貢献</p>
</div>
<div id="panel2" class="tab_panel">
<p>・材質:NAO/銅フリー 2021規制対応など<br>・適正温度:0～500℃<br>・Max μ:0.52<br>・Ave μ:0.40<br>・Min μ:0.39<br>・ステージ:ストリート/ワインディング(ノーマル)</p>
</div>
</div>
</div>
</div>
...
<!--ココまでSP-->
<tr>
<p class="search_category">**********【適合検索】**********&nbsp;&nbsp;<a class="change_button" href="../../set/item/10344.php"><img src="../../img/set_button.jpg" alt="工賃セットの価格表はコチラ"></a></p>
</tr>
<tr>
<td>
<!-- 車両メーカー検索ココから -->
<p class="search_category">【自動車メーカー】</p>
<form method="post" action="10344.php">
...
if($data[0] == '10344') $position = explode(";", $data[1]);
}
array_pop($position);
fclose($fp_position);
...
<form name="make" method="post" action="10344.php">
