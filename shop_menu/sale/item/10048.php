...
<title>KTS-web 商品ラインナップ ESPELIR Super DOWNSUS GT</title>
...
<div class="mc_nav">
<a class="link" href="https://www.kts-web.com/">HOME</a> &gt; <a class="link" href="../../index.html">SHOP MENU</a> &gt; <a class="link" href="../../set/index.html">商品ラインナップ</a> &gt; <a class="link" href="../../set/cat/100.html">足回り</a> &gt; <a class="link" href="../../set/cat/117.html">ダウンサス/アップサス</a> &gt; <a class="link" href="../../set/br/1030-117.html">ESPELIR</a> &gt; <a class="link" href="10048.php">Super DOWNSUS GT</a></div>
<div class="space3px"></div>
<div class="set_sale_back">
<div class="space3px"></div>
<div class="set_menu_n">
<div class="set_menu_n_330">
<div><img src="../../brand/img/1030.gif" alt="Super DOWNSUS GT"></div></div>
<div class="set_menu_n_cell">
<div class="item_info_text_middle">
<p>ESPELIR[エスペリア]</p></div>
<div class="item_info_text_middle_b">
<p>商品名：Super DOWNSUS GT[スーパーダウンサスGT]</p></div>
</div></div>
...
<div class="swiper-slide"><img src="../../item_img/10048_1.jpg" alt="Super DOWNSUS GT"></div>
<div class="swiper-slide"><img src="../../item_img/10048_2.jpg" alt="Super DOWNSUS GT"></div>
<div class="swiper-slide"><img src="../../item_img/10048_3.jpg" alt="Super DOWNSUS GT"></div>
</div>
...
<p>1台1台テストを重ね、ベストセッティングを追求するという基本概念を踏襲し、スーパーダウンサスよりもバネレートを高く設定しストローク幅を30%アップさせたスプリングです。ストリートはもちろん、峠やサーキットまで見据えたハードサスペンションです。</p>
</div>
<div id="panel2" class="tab_panel">
<p>・カラー：レッド(1部の車種にブルー有り）<br>レースシーンからのフィードバック</p>
</div>
</div>
</div>
</div>
...
<div class="item_info_text_middle_b">
<p>Super DOWNSUS GT [スーパーダウンサスGT]</p>
</div>
<div class="tab_wrap">
...
<!--ココまでSP-->
<tr>
<p class="search_category">**********【適合検索】**********&nbsp;&nbsp;<a class="change_button" href="../../set/item/10048.php"><img src="../../img/set_button.jpg" alt="工賃セットの価格表はコチラ"></a></p>
</tr>
<tr>
<td>
<!-- 車両メーカー検索ココから -->
<p class="search_category">【自動車メーカー】</p>
<form method="post" action="10048.php">
...
if($data[0] == '10048') $position = explode(";", $data[1]);
}
array_pop($position);
fclose($fp_position);
...
<form name="make" method="post" action="10048.php">
