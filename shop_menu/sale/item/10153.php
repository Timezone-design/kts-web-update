...
<title>KTS-web 商品ラインナップ SHOWA SPORTS</title>
...
<div class="swiper-slide"><img src="../../item_img/10153_1.jpg" alt="SPORTS"></div>
<div class="swiper-slide"><img src="../../item_img/10153_2.jpg" alt="SPORTS"></div>
<div class="swiper-slide"><img src="../../item_img/10153_3.jpg" alt="SPORTS"></div>
</div>
...
<p>サーキットではなく、時として条件がより過酷な高速道路、峠道を気持ちよく走ることを目指し開発。減衰力の応答性を最大限に引き出す大口径ピストンの採用(一部車種を除く)。タイヤの浮き上がりを抑えるリバウンドスプリングを装備。ショックアブソーバのチューニングに合わせ、スプリングも最適値に設定。必要な時に瞬時に減衰力を発生し、ゴツゴツとした乗り心地を解消するとともにキビキビ感を両立しています。</p>
</div>
<div id="panel2" class="tab_panel">
<p>・ノーマル形状ダンパー<br>・大口径ピストンの採用(一部車種を除く)<br>・スプリングセット</p>
</div>
</div>
</div>
</div>
...
<!--ココまでSP-->
<tr>
<p class="search_category">**********【適合検索】**********&nbsp;&nbsp;<a class="change_button" href="../../set/item/10153.php"><img src="../../img/set_button.jpg" alt="工賃セットの価格表はコチラ"></a></p>
</tr>
<tr>
<td>
<!-- 車両メーカー検索ココから -->
<p class="search_category">【自動車メーカー】</p>
<form method="post" action="10153.php">
...
if($data[0] == '10153') $position = explode(";", $data[1]);
}
array_pop($position);
fclose($fp_position);
...
<form name="make" method="post" action="10153.php">
