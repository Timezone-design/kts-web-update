<html>
<head>
<meta name="description" content="日産車の電動ハイキャスにカッチリしたダイレクトな操縦性を実現。<br>電動ハイキャス装着車のハイキャスユニットを取り外し、リアタイヤの不要で不快な動きをカット。<br>ダイレクトなコントロール性とトラクション性能を向上。">
...
<div class="mc_nav">
<a class="link" href="https://www.kts-web.com/">HOME</a> &gt; <a class="link" href="../../index.html">SHOP MENU</a> &gt; <a class="link" href="../../set/index.html">商品ラインナップ</a> &gt; <a class="link" href="../../set/cat/100.html">足回り</a> &gt; <a class="link" href="../../set/cat/120.html">ロッド/アーム/リンク類</a> &gt; <a class="link" href="../../set/br/1059-120.html">CUSCO</a> &gt; <a class="link" href="10534.php">ドラッグロッド</a></div>
<div class="space3px"></div>
<div class="set_sale_back">
<div class="space3px"></div>
<div class="set_menu_n">
<div class="set_menu_n_330">
<div><img src="../../brand/img/1059.gif" alt="ドラッグロッド"></div></div>
...
<div class="swiper-slide"><img src="../../item_img/10534_1.jpg" alt="ドラッグロッド"></div>
<div class="swiper-slide"><img src="../../item_img/10534_2.jpg" alt="ドラッグロッド"></div>
<div class="swiper-slide"><img src="../../item_img/10534_3.jpg" alt="ドラッグロッド"></div>
</div>
...
<p>日産車の電動ハイキャスにカッチリしたダイレクトな操縦性を実現。<br>電動ハイキャス装着車のハイキャスユニットを取り外し、リアタイヤの不要で不快な動きをカット。<br>ダイレクトなコントロール性とトラクション性能を向上。</p>
</div>
...
<!--ココまでSP-->
<tr>
<p class="search_category">**********【適合検索】**********&nbsp;&nbsp;<a class="change_button" href="../../set/item/10534.php"><img src="../../img/set_button.jpg" alt="工賃セットの価格表はコチラ"></a></p>
</tr>
<tr>
<td>
<!-- 車両メーカー検索ココから -->
<p class="search_category">【自動車メーカー】</p>
<form method="post" action="10534.php">
...
if($data[0] == '10534') $position = explode(";", $data[1]);
}
array_pop($position);
fclose($fp_position);
...
<form name="make" method="post" action="10534.php">
