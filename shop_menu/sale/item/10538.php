...
<div class="mc_nav">
<a class="link" href="https://www.kts-web.com/">HOME</a> &gt; <a class="link" href="../../index.html">SHOP MENU</a> &gt; <a class="link" href="../../set/index.html">商品ラインナップ</a> &gt; <a class="link" href="../../set/cat/100.html">足回り</a> &gt; <a class="link" href="../../set/cat/120.html">ロッド/アーム/リンク類</a> &gt; <a class="link" href="../../set/br/1059-120.html">CUSCO</a> &gt; <a class="link" href="10538.php">リアトレーリングロッド</a></div>
<div class="space3px"></div>
<div class="set_sale_back">
<div class="space3px"></div>
<div class="set_menu_n">
<div class="set_menu_n_330">
<div><img src="../../brand/img/1059.gif" alt="リアトレーリングロッド"></div></div>
...
<div class="swiper-slide"><img src="../../item_img/10538_1.jpg" alt="リアトレーリングロッド"></div>
<div class="swiper-slide"><img src="../../item_img/10538_2.jpg" alt="リアトレーリングロッド"></div>
<div class="swiper-slide"><img src="../../item_img/10538_3.jpg" alt="リアトレーリングロッド"></div>
</div>
...
<p>加減速時にブレを抑えるピロボールパーツ。大きな負荷がかかるときに真価を発揮。<br>加速時、減速時にタイヤが暴れるジャダーを防止。リヤタイヤの前後の動き、アライメント変化を抑制。サスペンションの動きをスムーズにしてタイヤの接地性が向上。</p>
</div>
<div id="panel2" class="tab_panel">
<p>・ターンバックル式<br>・高強度ピロボールエンド採用<br>・構造変更対応書類付き</p>
</div>
</div>
</div>
</div>
...
<!--ココまでSP-->
<tr>
<p class="search_category">**********【適合検索】**********&nbsp;&nbsp;<a class="change_button" href="../../set/item/10538.php"><img src="../../img/set_button.jpg" alt="工賃セットの価格表はコチラ"></a></p>
</tr>
<tr>
<td>
<!-- 車両メーカー検索ココから -->
<p class="search_category">【自動車メーカー】</p>
<form method="post" action="10538.php">
...
if($data[0] == '10538') $position = explode(";", $data[1]);
}
array_pop($position);
fclose($fp_position);
...
<form name="make" method="post" action="10538.php">
