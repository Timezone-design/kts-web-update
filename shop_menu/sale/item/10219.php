...
<p>EAGER SUSPENSION KIT FOR K-CAR[イエーガーサスペンションキット FOR 軽トラ]</p></div>
</div></div>
...
<div class="swiper-slide"><img src="../../item_img/10219_1.jpg" alt="EAGER SUSPENSION KIT FOR K-CAR"></div>
<div class="swiper-slide"><img src="../../item_img/10219_2.jpg" alt="EAGER SUSPENSION KIT FOR K-CAR"></div>
<div class="swiper-slide"><img src="../../item_img/10219_3.jpg" alt="EAGER SUSPENSION KIT FOR K-CAR"></div>
</div>
...
<p>乗り心地、回頭性、機能性、はたらく車もパフォーマンス向上！ フロント車高調はキャンバー固定式ピロアッパーマウント車内への雨水、泥などの浸水を防ぐよう、敢えてピロ固定 マウントを使用！そして純正リアリーフ特有の不快な反発力を抑えしなやかで低振動な乗り心地に仕上げました！ また、リアリーフスプリングは強度検討書付きにより車検にも対応します。</p>
</div>
<div id="panel2" class="tab_panel">
<p>・フロント車高調キット<br>リアリーフスプリング(強度計算書付属)<br>フロント：固定式ピロアッパーマウント</p>
</div>
</div>
</div>
</div>
...
<div class="item_info_text_middle_b">
<p>EAGER SUSPENSION KIT FOR K-CAR [イエーガーサスペンションキット FOR 軽トラ]</p>
</div>
<div class="tab_wrap">
...
<!--ココまでSP-->
<tr>
<p class="search_category">**********【適合検索】**********&nbsp;&nbsp;<a class="change_button" href="../../set/item/10219.php"><img src="../../img/set_button.jpg" alt="工賃セットの価格表はコチラ"></a></p>
</tr>
<tr>
<td>
<!-- 車両メーカー検索ココから -->
<p class="search_category">【自動車メーカー】</p>
<form method="post" action="10219.php">
...
if($data[0] == '10219') $position = explode(";", $data[1]);
}
array_pop($position);
fclose($fp_position);
...
<form name="make" method="post" action="10219.php">
