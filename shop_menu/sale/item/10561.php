<html>
<head>
<meta name="description" content="車は走行を続けると、ロールや路面からの振動などのストレスによりボディが捻じれ、気付かないうちに歪みが生じてきます。<br>ウルトラレーシングのミドルメンバーブレースは中央のフロアトンネルを前後左右に補強し、ボディ中心部の剛性を高める。中心部を補強することで、ボディ中心から捻じれ歪みを抑制し、バランスを保つ効果があります。">
...
<div class="swiper-slide"><img src="../../item_img/10561_1.jpg" alt="ミドルメンバーブレース"></div>
<div class="swiper-slide"><img src="../../item_img/10561_2.jpg" alt="ミドルメンバーブレース"></div>
<div class="swiper-slide"><img src="../../item_img/10561_3.jpg" alt="ミドルメンバーブレース"></div>
</div>
...
<p>車は走行を続けると、ロールや路面からの振動などのストレスによりボディが捻じれ、気付かないうちに歪みが生じてきます。<br>ウルトラレーシングのミドルメンバーブレースは中央のフロアトンネルを前後左右に補強し、ボディ中心部の剛性を高める。中心部を補強することで、ボディ中心から捻じれ歪みを抑制し、バランスを保つ効果があります。</p>
</div>
...
<!--ココまでSP-->
<tr>
<p class="search_category">**********【適合検索】**********&nbsp;&nbsp;<a class="change_button" href="../../set/item/10561.php"><img src="../../img/set_button.jpg" alt="工賃セットの価格表はコチラ"></a></p>
</tr>
<tr>
<td>
<!-- 車両メーカー検索ココから -->
<p class="search_category">【自動車メーカー】</p>
<form method="post" action="10561.php">
...
if($data[0] == '10561') $position = explode(";", $data[1]);
}
array_pop($position);
fclose($fp_position);
...
<form name="make" method="post" action="10561.php">
