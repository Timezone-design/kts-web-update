<html>
<head>
<meta name="description" content="ダイナミクスと素晴らしいルックスの完璧なコンビネーションが貴方をサーキットで輝かせる。ダイレクトな反応、優れたドライビング・パフォーマンス、スポーティなルックスのすべてを実現しています。ロードテストを重ね、完璧なハーモニーを奏でるスプリングとショックアブソーバーです。">
...
<title>KTS-web 商品ラインナップ BILSTEIN B12 Sports line</title>
...
<div class="swiper-slide"><img src="../../item_img/10245_1.jpg" alt="B12 Sports line"></div>
<div class="swiper-slide"><img src="../../item_img/10245_2.jpg" alt="B12 Sports line"></div>
<div class="swiper-slide"><img src="../../item_img/10245_3.jpg" alt="B12 Sports line"></div>
</div>
...
<p>ダイナミクスと素晴らしいルックスの完璧なコンビネーションが貴方をサーキットで輝かせる。ダイレクトな反応、優れたドライビング・パフォーマンス、スポーティなルックスのすべてを実現しています。ロードテストを重ね、完璧なハーモニーを奏でるスプリングとショックアブソーバーです。</p>
</div>
<div id="panel2" class="tab_panel">
<p>・スポーティバージョンのプロフェッショナル・コーナリング・システムを採用<br>・最大50mmのローダウンが可能<br>・アイバッハ製スポーツライン・パフォーマンス・スポーツ・スプリングを採用<br>・ビルシュタインならではのガス封入技術<br>・ビルシュタインならではのドイツ製モノチューブ倒立式サス<br>・TV（ドイツの技術検査機関）が認める性能<br>・信頼のドイツ国内生産</p>
</div>
</div>
</div>
</div>
...
<div class="item_info_text_middle_b">
<p>B12 Sports line [B12スポーツライン]</p>
</div>
<div class="tab_wrap">
...
<!--ココまでSP-->
<tr>
<p class="search_category">**********【適合検索】**********&nbsp;&nbsp;<a class="change_button" href="../../set/item/10245.php"><img src="../../img/set_button.jpg" alt="工賃セットの価格表はコチラ"></a></p>
</tr>
<tr>
<td>
<!-- 車両メーカー検索ココから -->
<p class="search_category">【自動車メーカー】</p>
<form method="post" action="10245.php">
...
if($data[0] == '10245') $position = explode(";", $data[1]);
}
array_pop($position);
fclose($fp_position);
...
<form name="make" method="post" action="10245.php">
