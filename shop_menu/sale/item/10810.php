	              ...
	              <div class="set_sale_back">
	                ...
	                <div class="set_menu_n row">
	                  <div class="set_menu_n_330 col-md-6 col-sm-12 col-xs-12">
	                    <div><img alt="FULL DUALマフラー" src="../../brand/img/1032.gif"/></div>
	                  </div>
	                  <div class="set_menu_n_cell col-md-6 col-sm-12 col-xs-12">
	                    <div class="item_info_text_middle"><p>HKS[エッチケーエス]</p></div><div class="item_info_text_middle_b"><p>FULL DUALマフラー[フルデュアル]</p></div>
	                  </div>
	                </div>
	                <div class="set_menu_n row">
	                  <div class="set_menu_n_330 col-md-6 col-sm-12 col-xs-12">
	                    <div>
	                      <div class="swiper-container"><div class="swiper-wrapper"><div class="swiper-slide"><img alt="FULL DUALマフラー" src="../../item_img/10810_1.jpg"/></div><div class="swiper-slide"><img alt="FULL DUALマフラー" src="../../item_img/10810_2.jpg"/></div><div class="swiper-slide"><img alt="FULL DUALマフラー" src="../../item_img/10810_3.jpg"/></div></div><div class="swiper-button-prev"></div><div class="swiper-button-next"></div></div>
	                    </div>
	                    ...
	                    <div class="tab_wrap">
	                      ...
	                      <div class="tab-content">
	                        <div id="home" class="tab-pane fade in active show">
	                          <p>HKSマフラーテクノロジーの粋を結集させたフラッグシップモデル<br/>V型エンジンの左右バンクの排気ガスを、純正レイアウトのような2-1集合部分をなくし、完全独立させたフルデュアルレイアウトモデル。排気干渉による出力低下を抑え高回転までストレスなく吹け上がります。</p>
	                        </div>
	                        <div id="menu2" class="tab-pane fade">
	                          <p>・パイプ/シェル部：ステンレスSUS304<br/>・テール部：チタン<br/>・JASMA基準認定品</p>
	                        </div>
	                      </div>
	                      <script>
	                ...
	                <table style="table-layout:fixed;" width="100%">
	                  <!--ココまでSP-->
	                  <tr>
	                    <p class="search_category">**********【商品検索】**********&nbsp;&nbsp;<a class="change_button" href="../../sale/item/10810.php"><img src="../../img/sale_button.jpg" alt="単品販売の価格表はコチラ"></a></p>
	                  </tr>
	                </table>
	                  <?php
	                  	$root_dir = __DIR__.'/../../..';
