<html>
<head>
<meta name="description" content="サスペンションにおけるスプリングの重要性を知り尽くしたJICならではのサゲバネ！美しいスタイリングとスポーティな走り、そのふたつの要素を高度にバランス。他とは違うパフォーマンスを体感ください！！">
...
<title>KTS-web 商品ラインナップ JIC MAGIC X-MAGIC</title>
...
<div class="swiper-slide"><img src="../../item_img/10094_1.jpg" alt="X-MAGIC"></div>
<div class="swiper-slide"><img src="../../item_img/10094_2.jpg" alt="X-MAGIC"></div>
<div class="swiper-slide"><img src="../../item_img/10094_3.jpg" alt="X-MAGIC"></div>
</div>
...
<p>サスペンションにおけるスプリングの重要性を知り尽くしたJICならではのサゲバネ！美しいスタイリングとスポーティな走り、そのふたつの要素を高度にバランス。他とは違うパフォーマンスを体感ください！！</p>
</div>
...
<!--ココまでSP-->
<tr>
<p class="search_category">**********【適合検索】**********&nbsp;&nbsp;<a class="change_button" href="../../set/item/10094.php"><img src="../../img/set_button.jpg" alt="工賃セットの価格表はコチラ"></a></p>
</tr>
<tr>
<td>
<!-- 車両メーカー検索ココから -->
<p class="search_category">【自動車メーカー】</p>
<form method="post" action="10094.php">
...
if($data[0] == '10094') $position = explode(";", $data[1]);
}
array_pop($position);
fclose($fp_position);
...
<form name="make" method="post" action="10094.php">
