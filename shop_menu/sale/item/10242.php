...
<title>KTS-web 商品ラインナップ BILSTEIN Executive Tuning</title>
...
<div class="swiper-slide"><img src="../../item_img/10242_1.jpg" alt="Executive Tuning"></div>
<div class="swiper-slide"><img src="../../item_img/10242_2.jpg" alt="Executive Tuning"></div>
<div class="swiper-slide"><img src="../../item_img/10242_3.jpg" alt="Executive Tuning"></div>
</div>
...
<p>BMW Mスポーツ及びBMWミニを操る喜びと「大人の選択」を満足させるスペシャルチューニングダンパーです。BMWの優れたハンドリングはそのままに上質な乗り味を完成させています。ジャズが似合いそうな心地の良い移動空間は操る喜びとスタイルだけにとらわれない「大人の選択」を満足させるに違いがありません。</p>
</div>
<div id="panel2" class="tab_panel">
<p>・ノーマル車高設定。<br>・スペシャルチューニングダンパー</p>
</div>
</div>
</div>
</div>
...
<div class="item_info_text_middle_b">
<p>Executive Tuning [エグゼクティブチューニング]</p>
</div>
<div class="tab_wrap">
...
<!--ココまでSP-->
<tr>
<p class="search_category">**********【適合検索】**********&nbsp;&nbsp;<a class="change_button" href="../../set/item/10242.php"><img src="../../img/set_button.jpg" alt="工賃セットの価格表はコチラ"></a></p>
</tr>
<tr>
<td>
<!-- 車両メーカー検索ココから -->
<p class="search_category">【自動車メーカー】</p>
<form method="post" action="10242.php">
...
if($data[0] == '10242') $position = explode(";", $data[1]);
}
array_pop($position);
fclose($fp_position);
...
<form name="make" method="post" action="10242.php">
