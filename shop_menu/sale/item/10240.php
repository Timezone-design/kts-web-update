<html>
<head>
<meta name="description" content="誰もが納得する性能。B8はパフォーマンスそのもの<br>一般道からサーキットまでをテストし、ファイン・チューニング済みでローダウンカーやスポーツカー向けのハイパフォーマンス・ショックアブソーバーです。">
...
<title>KTS-web 商品ラインナップ BILSTEIN B8</title>
...
<div class="swiper-slide"><img src="../../item_img/10240_1.jpg" alt="B8"></div>
<div class="swiper-slide"><img src="../../item_img/10240_2.jpg" alt="B8"></div>
<div class="swiper-slide"><img src="../../item_img/10240_3.jpg" alt="B8"></div>
</div>
...
<p>誰もが納得する性能。B8はパフォーマンスそのもの<br>一般道からサーキットまでをテストし、ファイン・チューニング済みでローダウンカーやスポーツカー向けのハイパフォーマンス・ショックアブソーバーです。</p>
</div>
<div id="panel2" class="tab_panel">
<p>・スポーツセッティングとコンフォートの両立<br>・スプリングと合わせて交換することでさらなるパフォーマンスアップ<br>・正確なハンドリングとコントロール性の改善<br>・ビルシュタインならではのガス封入技術<br>・ビルシュタインならではのドイツ製モノチューブ倒立式サス</p>
</div>
</div>
</div>
</div>
...
<!--ココまでSP-->
<tr>
<p class="search_category">**********【適合検索】**********&nbsp;&nbsp;<a class="change_button" href="../../set/item/10240.php"><img src="../../img/set_button.jpg" alt="工賃セットの価格表はコチラ"></a></p>
</tr>
<tr>
<td>
<!-- 車両メーカー検索ココから -->
<p class="search_category">【自動車メーカー】</p>
<form method="post" action="10240.php">
...
if($data[0] == '10240') $position = explode(";", $data[1]);
}
array_pop($position);
fclose($fp_position);
...
<form name="make" method="post" action="10240.php">
