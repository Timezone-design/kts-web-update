...
<title>KTS-web 商品ラインナップ HKS HIPERMAX IV SP DRAG</title>
...
<div class="mc_nav">
<a class="link" href="https://www.kts-web.com/">HOME</a> &gt; <a class="link" href="../../index.html">SHOP MENU</a> &gt; <a class="link" href="../../set/index.html">商品ラインナップ</a> &gt; <a class="link" href="../../set/cat/100.html">足回り</a> &gt; <a class="link" href="../../set/cat/116.html">車高調/セッティングパーツ</a> &gt; <a class="link" href="../../set/br/1032-116.html">HKS</a> &gt; <a class="link" href="10080.php">HIPERMAX IV SP DRAG</a></div>
<div class="space3px"></div>
<div class="set_sale_back">
<div class="space3px"></div>
<div class="set_menu_n">
<div class="set_menu_n_330">
<div><img src="../../brand/img/1032.gif" alt="HIPERMAX IV SP DRAG"></div></div>
<div class="set_menu_n_cell">
<div class="item_info_text_middle">
<p>HKS[エッチケーエス]</p></div>
<div class="item_info_text_middle_b">
<p>HIPERMAX IV SP DRAG[ハイパーマックス4 SP ドラッグ]</p></div>
</div></div>
...
<div class="swiper-slide"><img src="../../item_img/10080_1.jpg" alt="HIPERMAX IV SP DRAG"></div>
<div class="swiper-slide"><img src="../../item_img/10080_2.jpg" alt="HIPERMAX IV SP DRAG"></div>
<div class="swiper-slide"><img src="../../item_img/10080_3.jpg" alt="HIPERMAX IV SP DRAG"></div>
</div>
...
<p>DRAG専用のサスペンション登場。HIPERMAX II DRAGサスペンションをベースに現代の技術を投入した最新のDRAG専用サスペンション。車種ごとに300mmのロングスプリングやヘルパースプリングを採用するなどパーツを厳選し、十分なストローク量とトラクションを確保しました。また、全長調整式を採用し、ストローク配分や車高調整のセッティング幅を確保しました。DRAG専用サスペンションとして新たに設定しましたので、是非その走りをご堪能ください。</p>
</div>
<div id="panel2" class="tab_panel">
<p>・単筒式<br>・減衰力30段階調整<br>・全長調整式<br>・専用スペシャルオイル<br>・PNEコート<br>・Mシャフト※正立式のみ<br>・M4P<br>・可変ポートシステム<br>・アルミブラケット※一部車種除く<br>・強化ゴムアッパーマウント※一部車種除く<br>・倒立タイプ※ストラットタイプのみ<br>・オーバーホール可<br>・2年4万キロ保証</p>
</div>
</div>
</div>
</div>
...
<div class="item_info_text_middle_b">
<p>HIPERMAX IV SP DRAG [ハイパーマックス4 SP ドラッグ]</p>
</div>
<div class="tab_wrap">
...
<!--ココまでSP-->
<tr>
<p class="search_category">**********【適合検索】**********&nbsp;&nbsp;<a class="change_button" href="../../set/item/10080.php"><img src="../../img/set_button.jpg" alt="工賃セットの価格表はコチラ"></a></p>
</tr>
<tr>
<td>
<!-- 車両メーカー検索ココから -->
<p class="search_category">【自動車メーカー】</p>
<form method="post" action="10080.php">
...
if($data[0] == '10080') $position = explode(";", $data[1]);
}
array_pop($position);
fclose($fp_position);
...
<form name="make" method="post" action="10080.php">
