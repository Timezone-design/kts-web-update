<html>
<head>
<meta name="description" content="至上の乗り心地を追求したスーパーコンフォートモデル。スタイリッシュなローダウンフォルムと、ドライビングやライド感をスポイルしないフレキシブルなサスペンション機能を追求したCR40。減衰力調整機能を活用することで、走りのフィーリングはさらにあなた好みに。もう何一つ妥協する必要はありません。">
...
<title>KTS-web 商品ラインナップ TANABE SUSTEC PRO CR40</title>
...
<div class="mc_nav">
<a class="link" href="https://www.kts-web.com/">HOME</a> &gt; <a class="link" href="../../index.html">SHOP MENU</a> &gt; <a class="link" href="../../set/index.html">商品ラインナップ</a> &gt; <a class="link" href="../../set/cat/100.html">足回り</a> &gt; <a class="link" href="../../set/cat/116.html">車高調/セッティングパーツ</a> &gt; <a class="link" href="../../set/br/1095-116.html">TANABE</a> &gt; <a class="link" href="10172.php">SUSTEC PRO CR40</a></div>
<div class="space3px"></div>
<div class="set_sale_back">
<div class="space3px"></div>
<div class="set_menu_n">
<div class="set_menu_n_330">
<div><img src="../../brand/img/1095.gif" alt="SUSTEC PRO CR40"></div></div>
<div class="set_menu_n_cell">
<div class="item_info_text_middle">
<p>TANABE[タナベ]</p></div>
<div class="item_info_text_middle_b">
<p>SUSTEC PRO CR40[サステックプロ CR40]</p></div>
</div></div>
...
<div class="swiper-slide"><img src="../../item_img/10172_1.jpg" alt="SUSTEC PRO CR40"></div>
<div class="swiper-slide"><img src="../../item_img/10172_2.jpg" alt="SUSTEC PRO CR40"></div>
<div class="swiper-slide"><img src="../../item_img/10172_3.jpg" alt="SUSTEC PRO CR40"></div>
</div>
...
<p>至上の乗り心地を追求したスーパーコンフォートモデル。スタイリッシュなローダウンフォルムと、ドライビングやライド感をスポイルしないフレキシブルなサスペンション機能を追求したCR40。減衰力調整機能を活用することで、走りのフィーリングはさらにあなた好みに。もう何一つ妥協する必要はありません。</p>
</div>
<div id="panel2" class="tab_panel">
<p>・ノンプリロードバルブ<br>・バレルフォルムスプリング<br>・40段減衰力調整機能<br>・ダブルシートリング<br>・特殊メッキ＆アルミ製シートリング<br>・車種別専用ブラケット<br>・1年間・走行距離10,000kmの保証</p>
</div>
</div>
</div>
</div>
...
<div class="item_info_text_middle_b">
<p>SUSTEC PRO CR40 [サステックプロ CR40]</p>
</div>
<div class="tab_wrap">
...
<!--ココまでSP-->
<tr>
<p class="search_category">**********【適合検索】**********&nbsp;&nbsp;<a class="change_button" href="../../set/item/10172.php"><img src="../../img/set_button.jpg" alt="工賃セットの価格表はコチラ"></a></p>
</tr>
<tr>
<td>
<!-- 車両メーカー検索ココから -->
<p class="search_category">【自動車メーカー】</p>
<form method="post" action="10172.php">
...
if($data[0] == '10172') $position = explode(";", $data[1]);
}
array_pop($position);
fclose($fp_position);
...
<form name="make" method="post" action="10172.php">
