...
<title>KTS-web 商品ラインナップ KONI Special ACTIVE</title>
...
<div class="mc_nav">
<a class="link" href="https://www.kts-web.com/">HOME</a> &gt; <a class="link" href="../../index.html">SHOP MENU</a> &gt; <a class="link" href="../../set/index.html">商品ラインナップ</a> &gt; <a class="link" href="../../set/cat/100.html">足回り</a> &gt; <a class="link" href="../../set/cat/118.html">ショックアブソーバー</a> &gt; <a class="link" href="../../set/br/1164-118.html">KONI</a> &gt; <a class="link" href="10096.php">Special ACTIVE</a></div>
<div class="space3px"></div>
<div class="set_sale_back">
<div class="space3px"></div>
<div class="set_menu_n">
<div class="set_menu_n_330">
<div><img src="../../brand/img/1164.gif" alt="Special ACTIVE"></div></div>
<div class="set_menu_n_cell">
<div class="item_info_text_middle">
<p>KONI[コニー]</p></div>
<div class="item_info_text_middle_b">
<p>商品名：Special ACTIVE[スペシャルアクティブ]</p></div>
</div></div>
...
<div class="swiper-slide"><img src="../../item_img/10096_1.jpg" alt="Special ACTIVE"></div>
<div class="swiper-slide"><img src="../../item_img/10096_2.jpg" alt="Special ACTIVE"></div>
<div class="swiper-slide"><img src="../../item_img/10096_3.jpg" alt="Special ACTIVE"></div>
</div>
...
<p>KONI Special ACTIVEは、妥協のない優れたハンドリングを提供する次世代のショックアブソーバです。 KONIの特許技術であるFrequency Selective Damping（FSD）技術を用いたツインチューブ構造は、充分なストロークと伸び側に重点を置いた独自の設計で、コーナーでのロールを最小限に抑え、高速での安定したハンドリングを実現。</p>
</div>
<div id="panel2" class="tab_panel">
<p>・ツインチューブ構造<br>・FSDバルブ搭載</p>
</div>
</div>
</div>
</div>
...
<!--ココまでSP-->
<tr>
<p class="search_category">**********【適合検索】**********&nbsp;&nbsp;<a class="change_button" href="../../set/item/10096.php"><img src="../../img/set_button.jpg" alt="工賃セットの価格表はコチラ"></a></p>
</tr>
<tr>
<td>
<!-- 車両メーカー検索ココから -->
<p class="search_category">【自動車メーカー】</p>
<form method="post" action="10096.php">
...
if($data[0] == '10096') $position = explode(";", $data[1]);
}
array_pop($position);
fclose($fp_position);
...
<form name="make" method="post" action="10096.php">
