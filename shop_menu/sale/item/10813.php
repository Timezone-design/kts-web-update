	              ...
	              <div class="set_sale_back">
	                ...
	                <div class="set_menu_n row">
	                  <div class="set_menu_n_330 col-md-6 col-sm-12 col-xs-12">
	                    <div><img alt="LEGAMAX PREMIUMマフラー" src="../../brand/img/1032.gif"/></div>
	                  </div>
	                  <div class="set_menu_n_cell col-md-6 col-sm-12 col-xs-12">
	                    <div class="item_info_text_middle"><p>HKS[エッチケーエス]</p></div><div class="item_info_text_middle_b"><p>LEGAMAX PREMIUMマフラー[レガマックスプレミアム]</p></div>
	                  </div>
	                </div>
	                <div class="set_menu_n row">
	                  <div class="set_menu_n_330 col-md-6 col-sm-12 col-xs-12">
	                    <div>
	                      <div class="swiper-container"><div class="swiper-wrapper"><div class="swiper-slide"><img alt="LEGAMAX PREMIUMマフラー" src="../../item_img/10813_1.jpg"/></div><div class="swiper-slide"><img alt="LEGAMAX PREMIUMマフラー" src="../../item_img/10813_2.jpg"/></div><div class="swiper-slide"><img alt="LEGAMAX PREMIUMマフラー" src="../../item_img/10813_3.jpg"/></div></div><div class="swiper-button-prev"></div><div class="swiper-button-next"></div></div>
	                    </div>
	                    ...
	                    <div class="tab_wrap">
	                      ...
	                      <div class="tab-content">
	                        <div id="home" class="tab-pane fade in active show">
	                          <p>各車ごとに、インパクトを与えつつもバランスのとれた最適なテールデザインを施しました。主要素材はテール/サイレンサー/パイプ部にSUS304、消音材には業界初の「Advantexグラスウール」を採用。上質の存在感とスポーツ性能を合せ持つ持つ、新たな「ドレスアップ・スタンダード」です。</p>
	                        </div>
	                        <div id="menu2" class="tab-pane fade">
	                          <p>・ステンレスSUS304材採用(一部車種除く)<br/>・JASMA基準<br/>・2年3万km保証</p>
	                        </div>
	                      </div>
	                      <script>
	                ...
	                <table style="table-layout:fixed;" width="100%">
	                  <!--ココまでSP-->
	                  <tr>
	                    <p class="search_category">**********【商品検索】**********&nbsp;&nbsp;<a class="change_button" href="../../sale/item/10813.php"><img src="../../img/sale_button.jpg" alt="単品販売の価格表はコチラ"></a></p>
	                  </tr>
	                </table>
	                  <?php
	                  	$root_dir = __DIR__.'/../../..';
