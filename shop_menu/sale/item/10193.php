...
<title>KTS-web 商品ラインナップ TEIN STREET ADVANCE</title>
...
<div class="mc_nav">
<a class="link" href="https://www.kts-web.com/">HOME</a> &gt; <a class="link" href="../../index.html">SHOP MENU</a> &gt; <a class="link" href="../../set/index.html">商品ラインナップ</a> &gt; <a class="link" href="../../set/cat/100.html">足回り</a> &gt; <a class="link" href="../../set/cat/116.html">車高調/セッティングパーツ</a> &gt; <a class="link" href="../../set/br/1104-116.html">TEIN</a> &gt; <a class="link" href="10193.php">STREET ADVANCE</a></div>
<div class="space3px"></div>
<div class="set_sale_back">
<div class="space3px"></div>
<div class="set_menu_n">
<div class="set_menu_n_330">
<div><img src="../../brand/img/1104.gif" alt="STREET ADVANCE"></div></div>
<div class="set_menu_n_cell">
<div class="item_info_text_middle">
<p>TEIN[テイン]</p></div>
<div class="item_info_text_middle_b">
<p>STREET ADVANCE[ストリートアドバンス]</p></div>
</div></div>
...
<div class="swiper-slide"><img src="../../item_img/10193_1.jpg" alt="STREET ADVANCE"></div>
<div class="swiper-slide"><img src="../../item_img/10193_2.jpg" alt="STREET ADVANCE"></div>
<div class="swiper-slide"><img src="../../item_img/10193_3.jpg" alt="STREET ADVANCE"></div>
</div>
...
<p>インチアップ&ローダウンを前提にストリートでの乗り心地を追求し、 複筒式構造のショックアブソーバを採用。スムーズにストロークすることで荒れた路面や凹凸をしっかりと捉え、低速ではしなやかに、高速ではフラットで安定感ある走りをもたらします。</p>
</div>
<div id="panel2" class="tab_panel">
<p>・ねじ式車高調整機構<br>・減衰力16段調整式<br>・複筒式<br>・純正マウント対応<br>・3年6万キロ+固着保証<br>・オーバーホール/仕様変更可能</p>
</div>
</div>
</div>
</div>
...
<!--ココまでSP-->
<tr>
<p class="search_category">**********【適合検索】**********&nbsp;&nbsp;<a class="change_button" href="../../set/item/10193.php"><img src="../../img/set_button.jpg" alt="工賃セットの価格表はコチラ"></a></p>
</tr>
<tr>
<td>
<!-- 車両メーカー検索ココから -->
<p class="search_category">【自動車メーカー】</p>
<form method="post" action="10193.php">
...
if($data[0] == '10193') $position = explode(";", $data[1]);
}
array_pop($position);
fclose($fp_position);
...
<form name="make" method="post" action="10193.php">
