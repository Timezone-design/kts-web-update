<html>
<head>
<meta name="description" content="ノーマルに比べバネレートを15%以内に設定。快適な乗り心地と、ハンドリング性能を追求したサスペンション。セダン・ワゴン・Kカーのフォルムを最大限に生かすローダウン量。">
...
<title>KTS-web 商品ラインナップ FINAL KONNEXION BLACK SUS</title>
...
<div class="swiper-slide"><img src="../../item_img/10050_1.jpg" alt="BLACK SUS"></div>
<div class="swiper-slide"><img src="../../item_img/10050_2.jpg" alt="BLACK SUS"></div>
<div class="swiper-slide"><img src="../../item_img/10050_3.jpg" alt="BLACK SUS"></div>
</div>
...
<p>ノーマルに比べバネレートを15%以内に設定。快適な乗り心地と、ハンドリング性能を追求したサスペンション。セダン・ワゴン・Kカーのフォルムを最大限に生かすローダウン量。</p>
</div>
<div id="panel2" class="tab_panel">
<p>・保安基準適合品<br>・スプリング素材 SAE9254 / SWOSC-B</p>
</div>
</div>
</div>
</div>
...
<!--ココまでSP-->
<tr>
<p class="search_category">**********【適合検索】**********&nbsp;&nbsp;<a class="change_button" href="../../set/item/10050.php"><img src="../../img/set_button.jpg" alt="工賃セットの価格表はコチラ"></a></p>
</tr>
<tr>
<td>
<!-- 車両メーカー検索ココから -->
<p class="search_category">【自動車メーカー】</p>
<form method="post" action="10050.php">
...
if($data[0] == '10050') $position = explode(";", $data[1]);
}
array_pop($position);
fclose($fp_position);
...
<form name="make" method="post" action="10050.php">
