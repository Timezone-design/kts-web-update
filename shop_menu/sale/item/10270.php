<html>
<head>
<meta name="description" content="ラテラルロッドとは、リアアクスルと車体を結ぶロッドを指し、サスペンションの横方向の位置と入力を受け止めるパーツです。LARGUSの調整式ラテラルロッドは本体にスチールを使用し、重量の増加を抑えつつ、ハードな走りに対応する強度を確保しています。">
...
<div class="mc_nav">
<a class="link" href="https://www.kts-web.com/">HOME</a> &gt; <a class="link" href="../../index.html">SHOP MENU</a> &gt; <a class="link" href="../../set/index.html">商品ラインナップ</a> &gt; <a class="link" href="../../set/cat/100.html">足回り</a> &gt; <a class="link" href="../../set/cat/120.html">ロッド/アーム/リンク類</a> &gt; <a class="link" href="../../set/br/1156-120.html">LARGUS</a> &gt; <a class="link" href="10270.php">調整式ラテラルロッド</a></div>
<div class="space3px"></div>
<div class="set_sale_back">
<div class="space3px"></div>
<div class="set_menu_n">
<div class="set_menu_n_330">
<div><img src="../../brand/img/1156.gif" alt="調整式ラテラルロッド"></div></div>
...
<div class="swiper-slide"><img src="../../item_img/10270_1.jpg" alt="調整式ラテラルロッド"></div>
<div class="swiper-slide"><img src="../../item_img/10270_2.jpg" alt="調整式ラテラルロッド"></div>
<div class="swiper-slide"><img src="../../item_img/10270_3.jpg" alt="調整式ラテラルロッド"></div>
</div>
...
<p>ラテラルロッドとは、リアアクスルと車体を結ぶロッドを指し、サスペンションの横方向の位置と入力を受け止めるパーツです。LARGUSの調整式ラテラルロッドは本体にスチールを使用し、重量の増加を抑えつつ、ハードな走りに対応する強度を確保しています。</p>
</div>
<div id="panel2" class="tab_panel">
<p>・ターンバックル式<br>・ロッド本体：スチール<br>・取り付け部：強化ウレタンブッシュ</p>
</div>
</div>
</div>
</div>
...
<!--ココまでSP-->
<tr>
<p class="search_category">**********【適合検索】**********&nbsp;&nbsp;<a class="change_button" href="../../set/item/10270.php"><img src="../../img/set_button.jpg" alt="工賃セットの価格表はコチラ"></a></p>
</tr>
<tr>
<td>
<!-- 車両メーカー検索ココから -->
<p class="search_category">【自動車メーカー】</p>
<form method="post" action="10270.php">
...
if($data[0] == '10270') $position = explode(";", $data[1]);
}
array_pop($position);
fclose($fp_position);
...
<form name="make" method="post" action="10270.php">
