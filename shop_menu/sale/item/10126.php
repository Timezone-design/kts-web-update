<html>
<head>
<meta name="description" content="減衰力15段階調整/全長調整（フルタップ）式のコストパーフォマンスに優れた車高調整キット、ストリートチューニングダンパー（S.T.D）。町乗りセッティングからハードな走りまで対応。段付きゴムシートの採用でボディ剛性の高い車両に発生する車高調装着時の異音を軽減。">
...
<title>KTS-web 商品ラインナップ OVER TECH STREET TUNING DAMPER for MINIVAN</title>
...
{
@id: "/item/10126.php",
name: "STREET TUNING DAMPER for MINIVAN"
}
}
]
}
...
<div class="mc_nav">
<a class="link" href="https://www.kts-web.com/">HOME</a> &gt; <a class="link" href="../../index.html">SHOP MENU</a> &gt; <a class="link" href="../../set/index.html">商品ラインナップ</a> &gt; <a class="link" href="../../set/cat/100.html">足回り</a> &gt; <a class="link" href="../../set/cat/116.html">車高調/セッティングパーツ</a> &gt; <a class="link" href="../../set/br/1045-116.html">OVER TECH</a> &gt; <a class="link" href="10126.php">STREET TUNING DAMPER for MINIVAN</a></div>
<div class="space3px"></div>
<div class="set_sale_back">
<div class="space3px"></div>
<div class="set_menu_n">
<div class="set_menu_n_330">
<div><img src="../../brand/img/1045.gif" alt="STREET TUNING DAMPER for MINIVAN"></div></div>
<div class="set_menu_n_cell">
<div class="item_info_text_middle">
<p>OVER TECH[オーバーテック]</p></div>
<div class="item_info_text_middle_b">
<p>STREET TUNING DAMPER for MINIVAN[ストリートチューニングダンパー FOR ミニバン]</p></div>
</div></div>
...
<div class="swiper-slide"><img src="../../item_img/10126_1.jpg" alt="STREET TUNING DAMPER for MINIVAN"></div>
<div class="swiper-slide"><img src="../../item_img/10126_2.jpg" alt="STREET TUNING DAMPER for MINIVAN"></div>
<div class="swiper-slide"><img src="../../item_img/10126_3.jpg" alt="STREET TUNING DAMPER for MINIVAN"></div>
</div>
...
<p>減衰力15段階調整/全長調整（フルタップ）式のコストパーフォマンスに優れた車高調整キット、ストリートチューニングダンパー（S.T.D）。町乗りセッティングからハードな走りまで対応。段付きゴムシートの採用でボディ剛性の高い車両に発生する車高調装着時の異音を軽減。</p>
</div>
<div id="panel2" class="tab_panel">
<p>・減衰力15段調整<br>・複筒式<br>・フルタップ全長調整式<br>・車種専用ブレーキホースブラケット装備<br>・特殊防錆コート<br>・異音防止スラストシート</p>
</div>
</div>
</div>
</div>
...
<div class="item_info_text_middle">
<p>OVER TECH [オーバーテック]</p>
</div>
<div class="item_info_text_middle_b">
<p>STREET TUNING DAMPER for MINIVAN [ストリートチューニングダンパー FOR ミニバン]</p>
</div>
<div class="tab_wrap">
...
<!--ココまでSP-->
<tr>
<p class="search_category">**********【適合検索】**********&nbsp;&nbsp;<a class="change_button" href="../../set/item/10126.php"><img src="../../img/set_button.jpg" alt="工賃セットの価格表はコチラ"></a></p>
</tr>
<tr>
<td>
<!-- 車両メーカー検索ココから -->
<p class="search_category">【自動車メーカー】</p>
<form method="post" action="10126.php">
...
if($data[0] == '10126') $position = explode(";", $data[1]);
}
array_pop($position);
fclose($fp_position);
...
<form name="make" method="post" action="10126.php">
