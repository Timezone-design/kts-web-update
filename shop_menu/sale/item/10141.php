<html>
<head>
<meta name="description" content="減衰力固定でありながら、TP Best☆iの乗り心地、しっかり感をそのままにシンプルな機構（機能）でリーズナブルな仕様となっています。">
...
<title>KTS-web 商品ラインナップ RS★R TP Basic☆i</title>
...
<div class="mc_nav">
<a class="link" href="https://www.kts-web.com/">HOME</a> &gt; <a class="link" href="../../index.html">SHOP MENU</a> &gt; <a class="link" href="../../set/index.html">商品ラインナップ</a> &gt; <a class="link" href="../../set/cat/100.html">足回り</a> &gt; <a class="link" href="../../set/cat/116.html">車高調/セッティングパーツ</a> &gt; <a class="link" href="../../set/br/1001-116.html">RS★R</a> &gt; <a class="link" href="10141.php">TP Basic☆i</a></div>
<div class="space3px"></div>
<div class="set_sale_back">
<div class="space3px"></div>
<div class="set_menu_n">
<div class="set_menu_n_330">
<div><img src="../../brand/img/1001.gif" alt="TP Basic☆i"></div></div>
<div class="set_menu_n_cell">
<div class="item_info_text_middle">
<p>RS★R[アールエスアール]</p></div>
<div class="item_info_text_middle_b">
<p>TP Basic☆i[トランポ ベーシックアイ]</p></div>
</div></div>
...
<div class="swiper-slide"><img src="../../item_img/10141_1.jpg" alt="TP Basic☆i"></div>
<div class="swiper-slide"><img src="../../item_img/10141_2.jpg" alt="TP Basic☆i"></div>
<div class="swiper-slide"><img src="../../item_img/10141_3.jpg" alt="TP Basic☆i"></div>
</div>
...
<p>減衰力固定でありながら、TP Best☆iの乗り心地、しっかり感をそのままにシンプルな機構（機能）でリーズナブルな仕様となっています。</p>
</div>
<div id="panel2" class="tab_panel">
<p>・単筒式φ40スチールボディ<br>・強化トーションバーを採用<br>・ハイエース専用ローダウンリーフスプリング<br>・リア車高調整スペーサー</p>
</div>
</div>
</div>
</div>
...
<!--ココまでSP-->
<tr>
<p class="search_category">**********【適合検索】**********&nbsp;&nbsp;<a class="change_button" href="../../set/item/10141.php"><img src="../../img/set_button.jpg" alt="工賃セットの価格表はコチラ"></a></p>
</tr>
<tr>
<td>
<!-- 車両メーカー検索ココから -->
<p class="search_category">【自動車メーカー】</p>
<form method="post" action="10141.php">
...
if($data[0] == '10141') $position = explode(";", $data[1]);
}
array_pop($position);
fclose($fp_position);
...
<form name="make" method="post" action="10141.php">
