...
<title>KTS-web 商品ラインナップ Aragosta TYPE-SS</title>
...
<div class="mc_nav">
<a class="link" href="https://www.kts-web.com/">HOME</a> &gt; <a class="link" href="../../index.html">SHOP MENU</a> &gt; <a class="link" href="../../set/index.html">商品ラインナップ</a> &gt; <a class="link" href="../../set/cat/100.html">足回り</a> &gt; <a class="link" href="../../set/cat/116.html">車高調/セッティングパーツ</a> &gt; <a class="link" href="../../set/br/1010-116.html">Aragosta</a> &gt; <a class="link" href="10005.php">TYPE-SS</a></div>
<div class="space3px"></div>
<div class="set_sale_back">
<div class="space3px"></div>
<div class="set_menu_n">
<div class="set_menu_n_330">
<div><img src="../../brand/img/1010.gif" alt="TYPE-SS"></div></div>
<div class="set_menu_n_cell">
<div class="item_info_text_middle">
<p>Aragosta[アラゴスタ]</p></div>
<div class="item_info_text_middle_b">
<p>TYPE-SS[タイプSS]</p></div>
</div></div>
...
<div class="swiper-slide"><img src="../../item_img/10005_1.jpg" alt="TYPE-SS"></div>
<div class="swiper-slide"><img src="../../item_img/10005_2.jpg" alt="TYPE-SS"></div>
<div class="swiper-slide"><img src="../../item_img/10005_3.jpg" alt="TYPE-SS"></div>
</div>
...
<p>TYPE-SS[スーパースポーツコンセプト]は走りの可能性を拡げるサブタンク仕様です。TYPE-Sをベースに減衰力の伸び側/縮み側を個別に調整可能な2WAYサブタンクを搭載。あらゆるフィールドでよりキメの細かいセッティングを実現。用途、減衰力、スプリング等、完全フルオーダーに対応します。</p>
</div>
<div id="panel2" class="tab_panel">
<p>・TYPE-S＋2WAYサブタンク<br>・ピロアッパーマウント<br>・2WAY：伸び側/縮み側個別の減衰力調整機構（伸び側20段/縮み側11段すべてで減衰力が低速からリニアに変化）<br>・3WAY：オプション（+￥30,000・税込）にて2WAYに微低速域の縮み側減衰力調整機構を追加（12段調整）<br><br>※車種によりTYPEそれぞれの仕様は異なります。詳しくは詳細ページをご確認ください。</p>
</div>
</div>
</div>
</div>
...
<!--ココまでSP-->
<tr>
<p class="search_category">**********【適合検索】**********&nbsp;&nbsp;<a class="change_button" href="../../set/item/10005.php"><img src="../../img/set_button.jpg" alt="工賃セットの価格表はコチラ"></a></p>
</tr>
<tr>
<td>
<!-- 車両メーカー検索ココから -->
<p class="search_category">【自動車メーカー】</p>
<form method="post" action="10005.php">
...
if($data[0] == '10005') $position = explode(";", $data[1]);
}
array_pop($position);
fclose($fp_position);
...
<form name="make" method="post" action="10005.php">
