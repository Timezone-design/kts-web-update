<html>
<head>
<meta name="description" content="リアリジットサスペンション車の車高を下げた時に起こるボディとサスペンションのずれを補正。<br>タイヤとボディの干渉を防ぎタイヤの変摩耗を防止します。">
...
<div class="mc_nav">
<a class="link" href="https://www.kts-web.com/">HOME</a> &gt; <a class="link" href="../../index.html">SHOP MENU</a> &gt; <a class="link" href="../../set/index.html">商品ラインナップ</a> &gt; <a class="link" href="../../set/cat/100.html">足回り</a> &gt; <a class="link" href="../../set/cat/120.html">ロッド/アーム/リンク類</a> &gt; <a class="link" href="../../set/br/1059-120.html">CUSCO</a> &gt; <a class="link" href="10543.php">調整式ラテラルロッド</a></div>
<div class="space3px"></div>
<div class="set_sale_back">
<div class="space3px"></div>
<div class="set_menu_n">
<div class="set_menu_n_330">
<div><img src="../../brand/img/1059.gif" alt="調整式ラテラルロッド"></div></div>
...
<div class="swiper-slide"><img src="../../item_img/10543_1.jpg" alt="調整式ラテラルロッド"></div>
<div class="swiper-slide"><img src="../../item_img/10543_2.jpg" alt="調整式ラテラルロッド"></div>
<div class="swiper-slide"><img src="../../item_img/10543_3.jpg" alt="調整式ラテラルロッド"></div>
</div>
...
<p>リアリジットサスペンション車の車高を下げた時に起こるボディとサスペンションのずれを補正。<br>タイヤとボディの干渉を防ぎタイヤの変摩耗を防止します。</p>
</div>
<div id="panel2" class="tab_panel">
<p>・ターンバックル式<br>・設定：リア<br>・ボルトオン装着</p>
</div>
</div>
</div>
</div>
...
<!--ココまでSP-->
<tr>
<p class="search_category">**********【適合検索】**********&nbsp;&nbsp;<a class="change_button" href="../../set/item/10543.php"><img src="../../img/set_button.jpg" alt="工賃セットの価格表はコチラ"></a></p>
</tr>
<tr>
<td>
<!-- 車両メーカー検索ココから -->
<p class="search_category">【自動車メーカー】</p>
<form method="post" action="10543.php">
...
if($data[0] == '10543') $position = explode(";", $data[1]);
}
array_pop($position);
fclose($fp_position);
...
<form name="make" method="post" action="10543.php">
