...
<title>KTS-web 商品ラインナップ BILSTEIN B12</title>
...
<div class="swiper-slide"><img src="../../item_img/10243_1.jpg" alt="B12"></div>
<div class="swiper-slide"><img src="../../item_img/10243_2.jpg" alt="B12"></div>
<div class="swiper-slide"><img src="../../item_img/10243_3.jpg" alt="B12"></div>
</div>
...
<p>従来BTSキットとして販売されていたB12。純正形状ローダウンサスペンションキットながらビルシュタインならではの技術で素晴らしいドライビングパフォーマンスを実現しています。</p>
</div>
...
<!--ココまでSP-->
<tr>
<p class="search_category">**********【適合検索】**********&nbsp;&nbsp;<a class="change_button" href="../../set/item/10243.php"><img src="../../img/set_button.jpg" alt="工賃セットの価格表はコチラ"></a></p>
</tr>
<tr>
<td>
<!-- 車両メーカー検索ココから -->
<p class="search_category">【自動車メーカー】</p>
<form method="post" action="10243.php">
...
if($data[0] == '10243') $position = explode(";", $data[1]);
}
array_pop($position);
fclose($fp_position);
...
<form name="make" method="post" action="10243.php">
