...
<title>KTS-web 工賃セットメニュー TEIN EnduraPro PLUS</title>
...
<div class="mc_nav">
<a class="link" href="https://www.kts-web.com/">HOME</a> &gt; <a class="link" href="../../index.html">SHOP MENU</a> &gt; <a class="link" href="../index.html">工賃セットメニュー</a> &gt; <a class="link" href="../cat/100.html">足回り</a> &gt; <a class="link" href="../cat/118.html">ショックアブソーバー</a> &gt; <a class="link" href="../br/1104-118.html">TEIN</a> &gt; <a class="link" href="10184.php">EnduraPro PLUS</a></div>
<div class="space3px"></div>
<div class="set_sale_back">
<div class="space3px"></div>
<div class="set_menu_n">
<div class="set_menu_n_330">
<div><img src="../../brand/img/1104.gif" alt="EnduraPro PLUS"></div></div>
<div class="set_menu_n_cell">
<div class="item_info_text_middle">
<p>TEIN[テイン]</p></div>
<div class="item_info_text_middle_b">
<p>EnduraPro PLUS[エンデュラプロプラス]</p></div>
</div></div>
...
<div class="swiper-slide"><img src="../../item_img/10184_1.jpg" alt="EnduraPro PLUS"></div>
<div class="swiper-slide"><img src="../../item_img/10184_2.jpg" alt="EnduraPro PLUS"></div>
<div class="swiper-slide"><img src="../../item_img/10184_3.jpg" alt="EnduraPro PLUS"></div>
</div>
...
<p>EnduraPro/ EnduraPro PLUSは純正形状の高性能ショックアブソーバです。純正ショックアブソーバと同形状のロアスプリングシートを備え、純正スプリングと純正アッパーマウントの使用を前提とした設計となっています。補修交換用としてだけでなく、スプリングは純正のままノーマル車高を維持しながら乗り心地やハンドリングを向上させたいという方にも最適なアイテムです。</p>
</div>
<div id="panel2" class="tab_panel">
<p>・ノーマル形状<br>・減衰力調整式<br>・EDFCシリーズ対応<br>・高耐久/高品質<br>・H.B.S.搭載<br>・複筒式<br>・3年6万キロ保証</p>
</div>
</div>
</div>
</div>
...
<p class="search_category">**********【適合検索】**********&nbsp;&nbsp;<a class="change_button" href="../../sale/item/10184.php"><img src="../../img/sale_button.jpg" alt="単品販売の価格表はコチラ"></a></p>
</tr>
<tr>
<td>
<!-- 車両メーカー検索ココから -->
<p class="search_category">【自動車メーカー】</p>
<form method="post" action="10184.php">
...
if($data[0] == '10184') $position = explode(";", $data[1]);
}
array_pop($position);
fclose($fp_position);
...
<form name="make" method="post" action="10184.php">
