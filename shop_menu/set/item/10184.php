 <html>
<head>
<meta content="EnduraPro/ EnduraPro PLUSは純正形状の高性能ショックアブソーバです。純正ショックアブソーバと同形状のロアスプリングシートを備え、純正スプリングと純正アッパーマウントの使用を前提とした設計となっています。補修交換用としてだけでなく、スプリングは純正のままノーマル車高を維持しながら乗り心地やハンドリングを向上させたいという方にも最適なアイテムです。" name="description"/>
<meta content="text/html; charset=utf-8" http-equiv="Content-Type"/><meta content="width=device-width, user-scalable=yes, initial-scale=1, maximum-scale=1" name="viewport"><meta content="width=device-width" name="viewport"/><title>KTS-web 工賃セットメニュー TEIN EnduraPro PLUS</title><script type="application/ld+json">{@context: "http://schema.org",@type: "BreadcrumbList",itemListElement:[{@type: "ListItem",position: 1,item:{@id: "/shop_menu/",name: "SHOP MENU"}},{@type: "ListItem",position: 2,item:{@id: "/set/",name: "工賃セットメニュー"}},{@type: "ListItem",position: 3,item:{@id: "/item/10184.php",name: "EnduraPro PLUS"}}]}</script><script src="https://ajax.googleapis.com/ajax/libs/jquery/3.1.1/jquery.min.js"></script>
...
<div><img alt="EnduraPro PLUS" src="../../brand/img/1104.gif"/></div>
</div>
<div class="set_menu_n_cell col-md-6 col-sm-12 col-xs-12">
<div class="item_info_text_middle"><p>TEIN[テイン]</p></div><div class="item_info_text_middle_b"><p>EnduraPro PLUS[エンデュラプロプラス]</p></div>
</div>
</div>
<div class="set_menu_n row">
<div class="set_menu_n_330 col-md-6 col-sm-12 col-xs-12">
<div>
<div class="swiper-container"><div class="swiper-wrapper"><div class="swiper-slide"><img alt="EnduraPro PLUS" src="../../item_img/10184_1.jpg"/></div><div class="swiper-slide"><img alt="EnduraPro PLUS" src="../../item_img/10184_2.jpg"/></div><div class="swiper-slide"><img alt="EnduraPro PLUS" src="../../item_img/10184_3.jpg"/></div></div><div class="swiper-button-prev"></div><div class="swiper-button-next"></div></div>
</div>
<div class="item_caution"><p>※写真はイメージ・代表画像です。 </p><p>※実際の商品とカラーやイメージが異なる場合がございます。</p></div>
</div>
<div class="set_menu_n_cell col-md-6 col-sm-12 col-xs-12">
<a class="set-sale-switch" href="../../sale/item/10184.php">メニュー内容・物販へのリンク</a><div class="tab_wrap">
