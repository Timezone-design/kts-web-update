	              ...
	              <div class="set_sale_back">
	                    ...
	                    <div class="tab_wrap">
	                      ...
	                      <div class="tab-content">
	                        <div id="home" class="tab-pane fade in active show">
	                          <p>AT車に新しい走りの魅力を引き出す！！<br/>オートマチック車に専用開発したデフが気持ちいいドライビングの魅力を創り出します。<br/>超低イニシャル、1Wayタイプでオートマ車との相性は抜群。また、オーバーホールなしでも長期間安定した性能を持続します。</p>
	                        </div>
	                        <div id="menu2" class="tab-pane fade">
	                          <p>・AT車専用設計<br/>・1Wayタイプ<br/>・超低イニシャル仕様<br/>・快適さはそのまま</p>
	                        </div>
	                      </div>
	                      <script>
	                ...
	                <table style="table-layout:fixed;" width="100%">
	                  ...
	                  <tr>
	                    ...
	                    <p class="search_category">**********【商品検索】**********&nbsp;&nbsp;<a class="change_button" href="../../sale/item/10447.php"><img src="../../img/sale_button.jpg" alt="単品販売の価格表はコチラ"></a></p>
	                  </tr>
	                </table>
	                  <?php
	                  	$root_dir = __DIR__.'/../../..';
