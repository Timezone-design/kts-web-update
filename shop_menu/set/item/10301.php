 <html>
							<head>
							<meta content="ブレーキダストが少ない/音鳴きが出づらい＝あまり効かない…今までのスポーツパッドの常識を覆すべく開発。&lt;br&gt;効きを上げるには摩擦係数を高くすることが従来の常識でした。&lt;br&gt;エンドレスでは、初期制動の定義を細分化し「初期レスポンス」を高めることで”効き”の体感を強く引き出し、車を止める”扱いやすさ”として程よいバランスを手に入れました。" name="description"/>
<meta content="text/html; charset=utf-8" http-equiv="Content-Type"/>
<meta content="width=device-width, user-scalable=yes, initial-scale=1, maximum-scale=1" name="viewport"/>
<meta content="width=device-width" name="viewport"/>
<title>KTS-web 工賃セットメニュー ENDLESS SSM</title>
              ...
              <div class="set_sale_back">
                ...
                <div class="set_menu_n row">
                  <div class="set_menu_n_330 col-md-6 col-sm-12 col-xs-12">
                    <div><img alt="SSM" src="../../brand/img/1038.gif"/></div>
                  </div>
                  <div class="set_menu_n_cell col-md-6 col-sm-12 col-xs-12">
                    <div class="item_info_text_middle"><p>ENDLESS[エンドレス]</p></div><div class="item_info_text_middle_b"><p>SSM[スーパーストリート Mスポーツ]</p></div>
                  </div>
                </div>
                <div class="set_menu_n row">
                  <div class="set_menu_n_330 col-md-6 col-sm-12 col-xs-12">
                    <div>
                      <div class="swiper-container"><div class="swiper-wrapper"><div class="swiper-slide"><img alt="SSM" src="../../item_img/10301_1.jpg"/></div><div class="swiper-slide"><img alt="SSM" src="../../item_img/10301_2.jpg"/></div><div class="swiper-slide"><img alt="SSM" src="../../item_img/10301_3.jpg"/></div></div><div class="swiper-button-prev"></div><div class="swiper-button-next"></div></div>
                    </div>
                    ...
                    <div class="tab_wrap">
                      ...
                      <div class="tab-content">
                        <div id="home" class="tab-pane fade in active show">
                          <p>ブレーキダストが少ない/音鳴きが出づらい＝あまり効かない…今までのスポーツパッドの常識を覆すべく開発。<br/>効きを上げるには摩擦係数を高くすることが従来の常識でした。<br/>エンドレスでは、初期制動の定義を細分化し「初期レスポンス」を高めることで”効き”の体感を強く引き出し、車を止める”扱いやすさ”として程よいバランスを手に入れました。</p>
                        </div>
                        <div id="menu2" class="tab-pane fade">
                          <p>・ローター適正温度域：0～530℃<br/>・平均摩擦係数：0.30～0.40<br/>・材質：ノンアスベスト<br/>・フィールド：ストリート-ワインディング</p>
                        </div>
                      </div>
                      <script>
