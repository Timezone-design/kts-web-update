	              ...
	              <div class="set_sale_back">
	                    ...
	                    <div class="tab_wrap">
	                      ...
	                      <div class="tab-content">
	                        <div id="home" class="tab-pane fade in active show">
	                          <p>SSM PLUSは、SSMで培った経験から更に摩材改良し、初期レスポンス、摩擦係数の最適化に成功しました。従来通りの低ダスト性・低異音性を保ち、ストリートでの抜群のコントロール性能を持ったスポーツモデルのブレーキパッドです。スポーツセダンのみならず、ハイブリッド車両やドレスアップカー等、ホイールを汚したくない方におすすめです。</p>
	                        </div>
	                        <div id="menu2" class="tab-pane fade">
	                          <p>・ローター適正温度域：0～550℃<br/>・平均摩擦係数：0.33～0.40<br/>・材質：ノンアスベスト<br/>・フィールド：ストリート-ワインディング</p>
	                        </div>
	                      </div>
	                      <script>
	                ...
	                <table style="table-layout:fixed;" width="100%">
	                  ...
	                  <tr>
	                    ...
	                    <p class="search_category">**********【商品検索】**********&nbsp;&nbsp;<a class="change_button" href="../../sale/item/10301.php"><img src="../../img/sale_button.jpg" alt="単品販売の価格表はコチラ"></a></p>
	                  </tr>
	                </table>
	                  <?php
	                  	$root_dir = __DIR__.'/../../..';
