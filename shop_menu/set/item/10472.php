	              ...
	              <div class="set_sale_back">
	                    ...
	                    <div class="tab_wrap">
	                      ...
	                      <div class="tab-content">
	                        <div id="home" class="tab-pane fade in active show">
	                          <p>誰もが普通に使えるスポーツクラッチ<br/>カッパーミックスとはメタルとノンアスという異なるフェーシングを特殊製法により高次元で結合させた全く新しいフェーシングで、純正クラッチ並みの操作性とスポーツ走行時の高い伝達性能を併せ持つクラッチです。<br/>カッパーミックスツインは扱いやすさと許容出力600ps以上を両立した最強のツインプレートクラッチです。</p>
	                        </div>
	                        <div id="menu2" class="tab-pane fade">
	                          <p>・カッパーミックスフェーシング<br/>・優れたμコントロール性<br/>・優れた耐バースト性能<br/>・想定許容出力670ps対応<br/>※カッパーミックツイン</p>
	                        </div>
	                      </div>
	                      <script>
	                ...
	                <table style="table-layout:fixed;" width="100%">
	                  ...
	                  <tr>
	                    ...
	                    <p class="search_category">**********【商品検索】**********&nbsp;&nbsp;<a class="change_button" href="../../sale/item/10472.php"><img src="../../img/sale_button.jpg" alt="単品販売の価格表はコチラ"></a></p>
	                  </tr>
	                </table>
	                  <?php
	                  	$root_dir = __DIR__.'/../../..';
