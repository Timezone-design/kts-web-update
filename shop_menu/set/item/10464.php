	              ...
	              <div class="set_sale_back">
	                    ...
	                    <div class="tab_wrap">
	                      ...
	                      <div class="tab-content">
	                        <div id="home" class="tab-pane fade in active show">
	                          <p>クスコ・クラッチカバーとメタルディスクのセット。<br/>純正サイズでノーマルエンジン車にも安心。耐熱性、耐久性に優れた強化メタルディスク<br/>耐摩耗性に優れたメタルフェーシングによって、過酷な使用条件下での滑りを解消。強化品にもかかわらず、半クラッチでも純正品に近いコントロール性能を発揮。</p>
	                        </div>
	                        <div id="menu2" class="tab-pane fade">
	                          <p>・メタルフェーシング<br/>・純正品に近いコントロール性能<br/>・GT-R/ランサーEvo10用などの4枚羽仕様も有</p>
	                        </div>
	                      </div>
	                      <script>
	                ...
	                <table style="table-layout:fixed;" width="100%">
	                  ...
	                  <tr>
	                    ...
	                    <p class="search_category">**********【商品検索】**********&nbsp;&nbsp;<a class="change_button" href="../../sale/item/10464.php"><img src="../../img/sale_button.jpg" alt="単品販売の価格表はコチラ"></a></p>
	                  </tr>
	                </table>
	                  <?php
	                  	$root_dir = __DIR__.'/../../..';
