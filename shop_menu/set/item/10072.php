<html>
 <head>
  ...
  <title>
   KTS-web 工賃セットメニュー Genb(玄武) Height down block kit
  </title>
  <script type="application/ld+json">
   {@context: "http://schema.org",@type: "BreadcrumbList",itemListElement:[{@type: "ListItem",position: 1,item:{@id: "/shop_menu/",name: "SHOP MENU"}},{@type: "ListItem",position: 2,item:{@id: "/set/",name: "工賃セットメニュー"}},{@type: "ListItem",position: 3,item:{@id: "/item/10072.php",name: "Height down block kit"}}]}
  </script>
...
<!-- <header class="site-header">
      ...
      <div class="main_c row grey-wrapper">
       <div class="mc_nav">
        ...
        &gt;
        <a class="link" href="../br/1067-116.html">
         Genb(玄武)
        </a>
        &gt;
        <a class="link" href="10072.php">
         Height down block kit
        </a>
       </div>
       <div class="clearfix">
       </div>
       <div class="set_sale_back">
        ...
        <div class="set_menu_n row">
         <div class="set_menu_n_330 col-md-6 col-sm-12 col-xs-12">
          <div>
           <img alt="Height down block kit" src="../../brand/img/1067.gif"/>
          </div>
         </div>
         <div class="set_menu_n_cell col-md-6 col-sm-12 col-xs-12">
          ...
          <div class="item_info_text_middle_b">
           <p>
            Height down block kit[ハイトダウンブロックキット]
           </p>
          </div>
         </div>
        </div>
           ...
           <div class="swiper-container">
            <div class="swiper-wrapper">
             <div class="swiper-slide">
              <img alt="Height down block kit" src="../../item_img/10072_1.jpg"/>
             </div>
             <div class="swiper-slide">
              <img alt="Height down block kit" src="../../item_img/10072_2.jpg"/>
             </div>
             <div class="swiper-slide">
              <img alt="Height down block kit" src="../../item_img/10072_3.jpg"/>
             </div>
            </div>
