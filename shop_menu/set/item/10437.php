	              ...
	              <div class="set_sale_back">
	                    ...
	                    <div class="tab_wrap">
	                      ...
	                      <div class="tab-content">
	                        <div id="home" class="tab-pane fade in active show">
	                          <p>KAAZ LSDには、クラッチプレートとプレッシャーリングが内蔵されており、プレッシャーリングがクラッチプレートを加圧する事によって作動し、非常に強力なロック性能と、優れたドライビング・レスポンスを提供します。プレッシャーリングに2種類の異なるカム溝を設定し、加速時と減速時で異なる効きを選択する事が可能です。</p>
	                        </div>
	                ...
	                <table style="table-layout:fixed;" width="100%">
	                  ...
	                  <tr>
	                    ...
	                    <p class="search_category">**********【商品検索】**********&nbsp;&nbsp;<a class="change_button" href="../../sale/item/10437.php"><img src="../../img/sale_button.jpg" alt="単品販売の価格表はコチラ"></a></p>
	                  </tr>
	                </table>
	                  <?php
	                  	$root_dir = __DIR__.'/../../..';
