 <html>
<head>
<meta content="ハイパワー化やボディー剛性の向上、高性能タイヤ装着、そしてサスペンションのチューニングと総合性能の進化が続くスペシャリティーカー。そんな新世代のクルマのためだけに開発されたプレミアムブランド「Extage」。クルマそれぞれの持つ性格とオーナーのかたがたの思いを想像しながら一車種ごと先進の技術と匠の技を注ぎ込み開発。" name="description"/>
<meta content="text/html; charset=utf-8" http-equiv="Content-Type"/><meta content="width=device-width, user-scalable=yes, initial-scale=1, maximum-scale=1" name="viewport"><meta content="width=device-width" name="viewport"/><title>KTS-web 工賃セットメニュー KYB Extage</title><script type="application/ld+json">{@context: "http://schema.org",@type: "BreadcrumbList",itemListElement:[{@type: "ListItem",position: 1,item:{@id: "/shop_menu/",name: "SHOP MENU"}},{@type: "ListItem",position: 2,item:{@id: "/set/",name: "工賃セットメニュー"}},{@type: "ListItem",position: 3,item:{@id: "/item/10101.php",name: "Extage"}}]}</script><script src="https://ajax.googleapis.com/ajax/libs/jquery/3.1.1/jquery.min.js"></script>
<meta content="width=device-width, user-scalable=yes, initial-scale=1, maximum-scale=1" name="viewport"/>
<meta content="width=device-width" name="viewport"/>
<title>KTS-web 工賃セットメニュー KYB Extage</title>
...
<div><img alt="Extage" src="../../brand/img/1054.gif"/></div>
</div>
<div class="set_menu_n_cell col-md-6 col-sm-12 col-xs-12">
<div class="item_info_text_middle"><p>KYB[カヤバ]</p></div><div class="item_info_text_middle_b"><p>Extage[エクステージ]</p></div>
</div>
</div>
<div class="set_menu_n row">
<div class="set_menu_n_330 col-md-6 col-sm-12 col-xs-12">
<div>
<div class="swiper-container"><div class="swiper-wrapper"><div class="swiper-slide"><img alt="Extage" src="../../item_img/10101_1.jpg"/></div><div class="swiper-slide"><img alt="Extage" src="../../item_img/10101_2.jpg"/></div><div class="swiper-slide"><img alt="Extage" src="../../item_img/10101_3.jpg"/></div></div><div class="swiper-button-prev"></div><div class="swiper-button-next"></div></div>
</div>
<div class="item_caution"><p>※写真はイメージ・代表画像です。 </p><p>※実際の商品とカラーやイメージが異なる場合がございます。</p></div>
</div>
<div class="set_menu_n_cell col-md-6 col-sm-12 col-xs-12">
<a class="set-sale-switch" href="../../sale/item/10101.php">メニュー内容・物販へのリンク</a><div class="tab_wrap">
