 <html>
<head>
<meta content="ダイナミクスと素晴らしいルックスの完璧なコンビネーションが貴方をサーキットで輝かせる。ダイレクトな反応、優れたドライビング・パフォーマンス、スポーティなルックスのすべてを実現しています。ロードテストを重ね、完璧なハーモニーを奏でるスプリングとショックアブソーバーです。" name="description"/>
<meta content="text/html; charset=utf-8" http-equiv="Content-Type"/><meta content="width=device-width, user-scalable=yes, initial-scale=1, maximum-scale=1" name="viewport"><meta content="width=device-width" name="viewport"/><title>KTS-web 工賃セットメニュー BILSTEIN B12 Sports line</title><script type="application/ld+json">{@context: "http://schema.org",@type: "BreadcrumbList",itemListElement:[{@type: "ListItem",position: 1,item:{@id: "/shop_menu/",name: "SHOP MENU"}},{@type: "ListItem",position: 2,item:{@id: "/set/",name: "工賃セットメニュー"}},{@type: "ListItem",position: 3,item:{@id: "/item/10245.php",name: "B12 Sports line"}}]}</script><script src="https://ajax.googleapis.com/ajax/libs/jquery/3.1.1/jquery.min.js"></script>
...
<div><img alt="B12 Sports line" src="../../brand/img/1136.gif"/></div>
</div>
<div class="set_menu_n_cell col-md-6 col-sm-12 col-xs-12">
<div class="item_info_text_middle"><p>BILSTEIN[ビルシュタイン]</p></div><div class="item_info_text_middle_b"><p>B12 Sports line[B12スポーツライン]</p></div>
</div>
</div>
<div class="set_menu_n row">
<div class="set_menu_n_330 col-md-6 col-sm-12 col-xs-12">
<div>
<div class="swiper-container"><div class="swiper-wrapper"><div class="swiper-slide"><img alt="B12 Sports line" src="../../item_img/10245_1.jpg"/></div><div class="swiper-slide"><img alt="B12 Sports line" src="../../item_img/10245_2.jpg"/></div><div class="swiper-slide"><img alt="B12 Sports line" src="../../item_img/10245_3.jpg"/></div></div><div class="swiper-button-prev"></div><div class="swiper-button-next"></div></div>
</div>
<div class="item_caution"><p>※写真はイメージ・代表画像です。 </p><p>※実際の商品とカラーやイメージが異なる場合がございます。</p></div>
</div>
<div class="set_menu_n_cell col-md-6 col-sm-12 col-xs-12">
<a class="set-sale-switch" href="../../sale/item/10245.php">メニュー内容・物販へのリンク</a><div class="tab_wrap">
