<html>
 <head>
  ...
  <title>
   KTS-web 工賃セットメニュー GP SPORT G-MASTER Premium
  </title>
  <script type="application/ld+json">
   {@context: "http://schema.org",@type: "BreadcrumbList",itemListElement:[{@type: "ListItem",position: 1,item:{@id: "/shop_menu/",name: "SHOP MENU"}},{@type: "ListItem",position: 2,item:{@id: "/set/",name: "工賃セットメニュー"}},{@type: "ListItem",position: 3,item:{@id: "/item/10075.php",name: "G-MASTER Premium"}}]}
  </script>
     ...
     <div id="content-wrapper">
      ...
      <div class="main_c row grey-wrapper">
       <div class="mc_nav">
        ...
        &gt;
        <a class="link" href="../br/1077-116.html">
         GP SPORT
        </a>
        &gt;
        <a class="link" href="10075.php">
         G-MASTER Premium
        </a>
       </div>
       <div class="clearfix">
       ...
       <div class="set_sale_back">
        ...
        <div class="set_menu_n row">
         <div class="set_menu_n_330 col-md-6 col-sm-12 col-xs-12">
          <div>
           <img alt="G-MASTER Premium" src="../../brand/img/1077.gif"/>
          </div>
         </div>
         <div class="set_menu_n_cell col-md-6 col-sm-12 col-xs-12">
          ...
          <div class="item_info_text_middle_b">
           <p>
            商品名：G-MASTER Premium[ジーマスター プレミアム]
           </p>
          </div>
         </div>
        </div>
           ...
           <div class="swiper-container">
            <div class="swiper-wrapper">
             <div class="swiper-slide">
              <img alt="G-MASTER Premium" src="../../item_img/10075_1.jpg"/>
             </div>
             <div class="swiper-slide">
              <img alt="G-MASTER Premium" src="../../item_img/10075_2.jpg"/>
             </div>
             <div class="swiper-slide">
              <img alt="G-MASTER Premium" src="../../item_img/10075_3.jpg"/>
             </div>
            </div>
