 <html>
<head>
<meta content="アラゴスタの原点となる最上級スペック搭載のスポーツ性能を有するモデル。TYPE-Sの『S』はスポーツコンセプトの『S』です。ワインディングからサーキット走行まで最適な乗り味を実現します。リニアなハンドリングや切れ目のないトラクション性能も秀逸。しなやかにして適度な硬さが生む爽快性をマキシマムに体感できるキットです。" name="description"/>
<meta content="text/html; charset=utf-8" http-equiv="Content-Type"/><meta content="width=device-width, user-scalable=yes, initial-scale=1, maximum-scale=1" name="viewport"><meta content="width=device-width" name="viewport"/><title>KTS-web 工賃セットメニュー Aragosta TYPE-S</title><script type="application/ld+json">{@context: "http://schema.org",@type: "BreadcrumbList",itemListElement:[{@type: "ListItem",position: 1,item:{@id: "/shop_menu/",name: "SHOP MENU"}},{@type: "ListItem",position: 2,item:{@id: "/set/",name: "工賃セットメニュー"}},{@type: "ListItem",position: 3,item:{@id: "/item/10003.php",name: "TYPE-S"}}]}</script><script src="https://ajax.googleapis.com/ajax/libs/jquery/3.1.1/jquery.min.js"></script>
...
<div><img alt="TYPE-S" src="../../brand/img/1010.gif"/></div>
</div>
<div class="set_menu_n_cell col-md-6 col-sm-12 col-xs-12">
<div class="item_info_text_middle"><p>Aragosta[アラゴスタ]</p></div><div class="item_info_text_middle_b"><p>TYPE-S[タイプS]</p></div>
</div>
</div>
<div class="set_menu_n row">
<div class="set_menu_n_330 col-md-6 col-sm-12 col-xs-12">
<div>
<div class="swiper-container"><div class="swiper-wrapper"><div class="swiper-slide"><img alt="TYPE-S" src="../../item_img/10003_1.jpg"/></div><div class="swiper-slide"><img alt="TYPE-S" src="../../item_img/10003_2.jpg"/></div><div class="swiper-slide"><img alt="TYPE-S" src="../../item_img/10003_3.jpg"/></div></div><div class="swiper-button-prev"></div><div class="swiper-button-next"></div></div>
</div>
<div class="item_caution"><p>※写真はイメージ・代表画像です。 </p><p>※実際の商品とカラーやイメージが異なる場合がございます。</p></div>
</div>
<div class="set_menu_n_cell col-md-6 col-sm-12 col-xs-12">
<a class="set-sale-switch" href="../../sale/item/10003.php">メニュー内容・物販へのリンク</a><div class="tab_wrap">
