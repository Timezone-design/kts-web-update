 <html>
<head>
<meta content="デモカー、ショーモデル用に設定した超ローダウンサスタイプ(最低地上高を確保していませんので、一般道での走行は出来ません)。Ti2000スプリングはチタン配合の新素材が耐ヘタリ性をはじめ、あらゆる面でダントツの性能を発揮。 最高峰だからこそできる「ヘタリ永久保証」付きです。" name="description"/>
<meta content="text/html; charset=utf-8" http-equiv="Content-Type"/><meta content="width=device-width, user-scalable=yes, initial-scale=1, maximum-scale=1" name="viewport"><meta content="width=device-width" name="viewport"/><title>KTS-web 工賃セットメニュー RS★R Ti2000 SUPER DOWN</title><script type="application/ld+json">{@context: "http://schema.org",@type: "BreadcrumbList",itemListElement:[{@type: "ListItem",position: 1,item:{@id: "/shop_menu/",name: "SHOP MENU"}},{@type: "ListItem",position: 2,item:{@id: "/set/",name: "工賃セットメニュー"}},{@type: "ListItem",position: 3,item:{@id: "/item/10148.php",name: "Ti2000 SUPER DOWN"}}]}</script><script src="https://ajax.googleapis.com/ajax/libs/jquery/3.1.1/jquery.min.js"></script>
<meta content="width=device-width, user-scalable=yes, initial-scale=1, maximum-scale=1" name="viewport"/>
<meta content="width=device-width" name="viewport"/>
<title>KTS-web 工賃セットメニュー RS★R Ti2000 SUPER DOWN</title>
...
<div><img alt="Ti2000 SUPER DOWN" src="../../brand/img/1001.gif"/></div>
</div>
<div class="set_menu_n_cell col-md-6 col-sm-12 col-xs-12">
<div class="item_info_text_middle"><p>RS★R[アールエスアール]</p></div><div class="item_info_text_middle_b"><p>Ti2000 SUPER DOWN[Ti2000 スーパーダウン]</p></div>
</div>
</div>
<div class="set_menu_n row">
<div class="set_menu_n_330 col-md-6 col-sm-12 col-xs-12">
<div>
<div class="swiper-container"><div class="swiper-wrapper"><div class="swiper-slide"><img alt="Ti2000 SUPER DOWN" src="../../item_img/10148_1.jpg"/></div><div class="swiper-slide"><img alt="Ti2000 SUPER DOWN" src="../../item_img/10148_2.jpg"/></div><div class="swiper-slide"><img alt="Ti2000 SUPER DOWN" src="../../item_img/10148_3.jpg"/></div></div><div class="swiper-button-prev"></div><div class="swiper-button-next"></div></div>
</div>
<div class="item_caution"><p>※写真はイメージ・代表画像です。 </p><p>※実際の商品とカラーやイメージが異なる場合がございます。</p></div>
</div>
<div class="set_menu_n_cell col-md-6 col-sm-12 col-xs-12">
<a class="set-sale-switch" href="../../sale/item/10148.php">メニュー内容・物販へのリンク</a><div class="tab_wrap">
