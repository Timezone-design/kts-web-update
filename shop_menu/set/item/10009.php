 <html>
<head>
<meta content="1000分の1秒単位まで減衰力の可変速度にこだわり、内部パーツ全てを独自設計。刻々と変化する路面状況や車両姿勢にも純正では成し得ないアクティブ制御を実現します。純正の電子制御式ショック機能に対応しているため、プラグイン接続のみの手軽さでコクピットのショックコントロールスイッチもそのまま使用可能。各モードで最適化したアラゴスタフィールが体感可能です。R35 GT-R専用PnPモデルでは純正の[コンフォート]、[ノーマル]、[R]スイッチに対応。手軽に純正を凌ぐアクティブ制御が体感出来ます。" name="description"/>
<meta content="text/html; charset=utf-8" http-equiv="Content-Type"/><meta content="width=device-width, user-scalable=yes, initial-scale=1, maximum-scale=1" name="viewport"><meta content="width=device-width" name="viewport"/><title>KTS-web 工賃セットメニュー Aragosta TYPE-SA</title><script type="application/ld+json">{@context: "http://schema.org",@type: "BreadcrumbList",itemListElement:[{@type: "ListItem",position: 1,item:{@id: "/shop_menu/",name: "SHOP MENU"}},{@type: "ListItem",position: 2,item:{@id: "/set/",name: "工賃セットメニュー"}},{@type: "ListItem",position: 3,item:{@id: "/item/10009.php",name: "TYPE-SA"}}]}</script><script src="https://ajax.googleapis.com/ajax/libs/jquery/3.1.1/jquery.min.js"></script>
<meta content="width=device-width, user-scalable=yes, initial-scale=1, maximum-scale=1" name="viewport"/>
<meta content="width=device-width" name="viewport"/>
<title>KTS-web 工賃セットメニュー Aragosta TYPE-SA</title>
...
<div><img alt="TYPE-SA" src="../../brand/img/1010.gif"/></div>
</div>
<div class="set_menu_n_cell col-md-6 col-sm-12 col-xs-12">
<div class="item_info_text_middle"><p>Aragosta[アラゴスタ]</p></div><div class="item_info_text_middle_b"><p>TYPE-SA[タイプSA]</p></div>
</div>
</div>
<div class="set_menu_n row">
<div class="set_menu_n_330 col-md-6 col-sm-12 col-xs-12">
<div>
<div class="swiper-container"><div class="swiper-wrapper"><div class="swiper-slide"><img alt="TYPE-SA" src="../../item_img/10009_1.jpg"/></div><div class="swiper-slide"><img alt="TYPE-SA" src="../../item_img/10009_2.jpg"/></div><div class="swiper-slide"><img alt="TYPE-SA" src="../../item_img/10009_3.jpg"/></div></div><div class="swiper-button-prev"></div><div class="swiper-button-next"></div></div>
</div>
<div class="item_caution"><p>※写真はイメージ・代表画像です。 </p><p>※実際の商品とカラーやイメージが異なる場合がございます。</p></div>
</div>
<div class="set_menu_n_cell col-md-6 col-sm-12 col-xs-12">
<a class="set-sale-switch" href="../../sale/item/10009.php">メニュー内容・物販へのリンク</a><div class="tab_wrap">
