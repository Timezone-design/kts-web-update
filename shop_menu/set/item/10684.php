              ...
              <div class="set_sale_back">
                    ...
                    <div class="tab_wrap">
                      ...
                      <div class="tab-content">
                        <div id="home" class="tab-pane fade in active show">
                          <p>過激に落ちる低王車高調シリーズに、市販最高レベルのバネレートが新登場！<br/>低車高でも当たりにくく、ドレスアップカーのスタイルにぴったり。<br/>極限のツライチ、ツラウチ、あなただけの最高のスタイルを！<br/>更に、ほんの少し見えるピンクのスプリングがドレスアップ効果を高めます。</p>
                        </div>
                        <div id="menu2" class="tab-pane fade">
                          <p>・減衰力：F30段/R24段<br/>・フロントのみ可動式ピロアッパー（一部純正アッパーマウント使用）<br/>・落ち幅：F：データ取り中 / Ｒ：スプリングカットで下げていく<br/>・バネレート：F：20k / R：20k</p>
                        </div>
                      </div>
                      <script>
                ...
                <table style="table-layout:fixed;" width="100%">
                  ...
                  <tr>
                    ...
                    <p class="search_category">**********【商品検索】**********&nbsp;&nbsp;<a class="change_button" href="../../sale/item/10684.php"><img src="../../img/sale_button.jpg" alt="単品販売の価格表はコチラ"></a></p>
                  </tr>
                </table>
                  <?php
    							$root_dir = __DIR__.'/../../..';
