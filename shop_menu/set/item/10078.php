 <html>
								<head>
								<meta content="ハンドリング性能やストリートでの乗り心地のバランスに優れたMAX IV GTを最新技術でリセッティング。MAX IV GTをベースに最新のセッティング技術を投入。安定性と快適性をさらに向上させ走りの質感を進化させました。ストリートでの走る楽しさやスポーツ性と乗り心地の高次元での両立を追求される方にお薦めのサスペンションキットです。" name="description"/>
<meta content="text/html; charset=utf-8" http-equiv="Content-Type"><meta content="width=device-width, user-scalable=yes, initial-scale=1, maximum-scale=1" name="viewport"/><meta content="width=device-width" name="viewport"/><title>KTS-web 工賃セットメニュー HKS HIPERMAX IV GT 20 SPEC</title><script type="application/ld+json">{@context: "http://schema.org",@type: "BreadcrumbList",itemListElement:[{@type: "ListItem",position: 1,item:{@id: "/shop_menu/",name: "SHOP MENU"}},{@type: "ListItem",position: 2,item:{@id: "/set/",name: "工賃セットメニュー"}},{@type: "ListItem",position: 3,item:{@id: "/item/10078.php",name: "HIPERMAX IV GT 20 SPEC"}}]}</script><script src="https://ajax.googleapis.com/ajax/libs/jquery/3.1.1/jquery.min.js"></script>
<meta content="width=device-width, user-scalable=yes, initial-scale=1, maximum-scale=1" name="viewport"/>
<meta content="width=device-width" name="viewport"/>
<title>KTS-web 工賃セットメニュー HKS HIPERMAX IV GT 20 SPEC</title>
	              ...
	              <div class="set_sale_back">
	                ...
	                <div class="set_menu_n row">
	                  <div class="set_menu_n_330 col-md-6 col-sm-12 col-xs-12">
	                    <div><img alt="HIPERMAX IV GT 20 SPEC" src="../../brand/img/1032.gif"/></div>
	                  </div>
	                  <div class="set_menu_n_cell col-md-6 col-sm-12 col-xs-12">
	                    <div class="item_info_text_middle"><p>HKS[エッチケーエス]</p></div><div class="item_info_text_middle_b"><p>HIPERMAX IV GT 20 SPEC[ハイパーマックス4 GT 20スペック]</p></div>
	                  </div>
	                </div>
	                <div class="set_menu_n row">
	                  <div class="set_menu_n_330 col-md-6 col-sm-12 col-xs-12">
	                    <div>
	                      <div class="swiper-container"><div class="swiper-wrapper"><div class="swiper-slide"><img alt="HIPERMAX IV GT 20 SPEC" src="../../item_img/10078_1.jpg"/></div><div class="swiper-slide"><img alt="HIPERMAX IV GT 20 SPEC" src="../../item_img/10078_2.jpg"/></div><div class="swiper-slide"><img alt="HIPERMAX IV GT 20 SPEC" src="../../item_img/10078_3.jpg"/></div></div><div class="swiper-button-prev"></div><div class="swiper-button-next"></div></div>
	                    </div>
	                ...
	                <table style="table-layout:fixed;" width="100%">
	                  ...
	                  <tr>
	                    ...
	                    <p class="search_category">**********【商品検索】**********&nbsp;&nbsp;<a class="change_button" href="../../sale/item/10078.php"><img src="../../img/sale_button.jpg" alt="単品販売の価格表はコチラ"></a></p>
	                  </tr>
	                </table>
	                  <?php
	                  	$root_dir = __DIR__.'/../../..';
