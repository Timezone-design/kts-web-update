 <html>
<head>
<meta content="多種多様化している車に幅広く対応し、それぞれの車をベストなフォルムになるようダウン量を設定。同時に乗り心地を決定付けるストローク量を正確に算出し、反比例しがちなローダウンと乗り心地を両立させるよう設計開発しています。またスプリングの最大荷重時の高さを車種ごとに把握し、応力計算に反映することでへたりの無い耐久性に優れた製品になっています。" name="description"/>
<meta content="text/html; charset=utf-8" http-equiv="Content-Type"/><meta content="width=device-width, user-scalable=yes, initial-scale=1, maximum-scale=1" name="viewport"><meta content="width=device-width" name="viewport"/><title>KTS-web 工賃セットメニュー ESPELIR Super DOWNSUS</title><script type="application/ld+json">{@context: "http://schema.org",@type: "BreadcrumbList",itemListElement:[{@type: "ListItem",position: 1,item:{@id: "/shop_menu/",name: "SHOP MENU"}},{@type: "ListItem",position: 2,item:{@id: "/set/",name: "工賃セットメニュー"}},{@type: "ListItem",position: 3,item:{@id: "/item/10046.php",name: "Super DOWNSUS"}}]}</script><script src="https://ajax.googleapis.com/ajax/libs/jquery/3.1.1/jquery.min.js"></script>
<meta content="width=device-width, user-scalable=yes, initial-scale=1, maximum-scale=1" name="viewport"/>
<meta content="width=device-width" name="viewport"/>
<title>KTS-web 工賃セットメニュー ESPELIR Super DOWNSUS</title>
...
<div><img alt="Super DOWNSUS" src="../../brand/img/1030.gif"/></div>
</div>
<div class="set_menu_n_cell col-md-6 col-sm-12 col-xs-12">
<div class="item_info_text_middle"><p>ESPELIR[エスペリア]</p></div><div class="item_info_text_middle_b"><p>Super DOWNSUS[スーパーダウンサス]</p></div>
</div>
</div>
<div class="set_menu_n row">
<div class="set_menu_n_330 col-md-6 col-sm-12 col-xs-12">
<div>
<div class="swiper-container"><div class="swiper-wrapper"><div class="swiper-slide"><img alt="Super DOWNSUS" src="../../item_img/10046_1.jpg"/></div><div class="swiper-slide"><img alt="Super DOWNSUS" src="../../item_img/10046_2.jpg"/></div><div class="swiper-slide"><img alt="Super DOWNSUS" src="../../item_img/10046_3.jpg"/></div></div><div class="swiper-button-prev"></div><div class="swiper-button-next"></div></div>
</div>
<div class="item_caution"><p>※写真はイメージ・代表画像です。 </p><p>※実際の商品とカラーやイメージが異なる場合がございます。</p></div>
</div>
<div class="set_menu_n_cell col-md-6 col-sm-12 col-xs-12">
<a class="set-sale-switch" href="../../sale/item/10046.php">メニュー内容・物販へのリンク</a><div class="tab_wrap">
