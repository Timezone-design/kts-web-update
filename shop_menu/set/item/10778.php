              ...
              <div class="set_sale_back">
                ...
                <div class="set_menu_n row">
                  <div class="set_menu_n_330 col-md-6 col-sm-12 col-xs-12">
                    <div><img alt="クラブスポーツ サスキット" src="../../brand/img/1042.gif"/></div>
                  </div>
                  <div class="set_menu_n_cell col-md-6 col-sm-12 col-xs-12">
                    <div class="item_info_text_middle"><p>AutoExe[オートエグゼ]</p></div><div class="item_info_text_middle_b"><p>クラブスポーツ サスキット</p></div>
                  </div>
                </div>
                <div class="set_menu_n row">
                  <div class="set_menu_n_330 col-md-6 col-sm-12 col-xs-12">
                    <div>
                      <div class="swiper-container"><div class="swiper-wrapper"><div class="swiper-slide"><img alt="クラブスポーツ サスキット" src="../../item_img/10778_1.jpg"/></div><div class="swiper-slide"><img alt="クラブスポーツ サスキット" src="../../item_img/10778_2.jpg"/></div><div class="swiper-slide"><img alt="クラブスポーツ サスキット" src="../../item_img/10778_3.jpg"/></div></div><div class="swiper-button-prev"></div><div class="swiper-button-next"></div></div>
                    </div>
                    ...
                    <div class="tab_wrap">
                      ...
                      <div class="tab-content">
                        <div id="home" class="tab-pane fade in active show">
                          <p>快適性を削ぎ落しそのマージンを運動性能へ転化したFRスポーツカー専用モデル。ワインディングやサーキットをフルスロットルで駆け抜けるといったハードな状況下においても正確な操作性を保つべく鍛え上げた。基準車高は-30mm、ダンパーは高負荷時の熱変換能力に秀で、減衰特性の変化が少ないモノチューブ式。スプリングは、バネ定数がリニアに立ち上がる直巻きタイプを採用。可能な限り高ロール剛性なスペック。</p>
                        </div>
                        <div id="menu2" class="tab-pane fade">
                          <p>・全長車高調整式<br/>・減衰力調整式モノチューブダンパー<br/>・直巻きスプリング<br/>※RX-8のリア除く<br/>・強化ラバーアッパーマウント</p>
                        </div>
                      </div>
                      <script>
                ...
                <table style="table-layout:fixed;" width="100%">
                  ...
                  <tr>
                    ...
                    <p class="search_category">**********【商品検索】**********&nbsp;&nbsp;<a class="change_button" href="../../sale/item/10778.php"><img src="../../img/sale_button.jpg" alt="単品販売の価格表はコチラ"></a></p>
                  </tr>
                </table>
                  <?php
    							$root_dir = __DIR__.'/../../..';
