...
<title>KTS-web 工賃セットメニュー TEIN TYPE HT DAMPER</title>
...
<div class="mc_nav">
<a class="link" href="https://www.kts-web.com/">HOME</a> &gt; <a class="link" href="../../../../index.html">SHOP MENU</a> &gt; <a class="link" href="../../../index.html">工賃セットメニュー</a> &gt; <a class="link" href="../cat/100.html">足回り</a> &gt; <a class="link" href="../cat/116.html">車高調/セッティングパーツ</a> &gt; <a class="link" href="../br/1104-116.html">TEIN</a> &gt; <a class="link" href="10210.php">TYPE HT DAMPER</a></div>
<div class="space3px"></div>
<div class="set_sale_back">
<div class="space3px"></div>
<div class="set_menu_n">
<div class="set_menu_n_330">
<div><img src="../../brand/img/1104.gif" alt="TYPE HT DAMPER"></div></div>
<div class="set_menu_n_cell">
<div class="item_info_text_middle">
<p>TEIN[テイン]</p></div>
<div class="item_info_text_middle_b">
<p>TYPE HT DAMPER[タイプHT ダンパー]</p></div>
</div></div>
...
<div class="swiper-slide"><img src="../../item_img/10210_1.jpg" alt="TYPE HT DAMPER"></div>
<div class="swiper-slide"><img src="../../item_img/10210_2.jpg" alt="TYPE HT DAMPER"></div>
<div class="swiper-slide"><img src="../../item_img/10210_3.jpg" alt="TYPE HT DAMPER"></div>
</div>
...
<p>数々のモータースポーツ参戦から得たノウハウを全てフィードバックした競技専用モデル。JAFのレギュレーションに準拠。そのまま競技に参戦可能、国内トップドライバーによりセッティング済。</p>
</div>
<div id="panel2" class="tab_panel">
<p>・単筒式構造<br>・伸/縮別減衰力16段調整<br>・JAF規定に準拠した材質を採用<br>・倒立式(ストラット以外は正立)<br>・正立タイプには別タンクを採用<br>・減衰力仕様変更可能</p>
</div>
</div>
</div>
</div>
...
<p class="search_category">**********【適合検索】**********&nbsp;&nbsp;<a class="change_button" href="../../sale/item/10210.php"><img src="../../img/sale_button.jpg" alt="工賃セットの価格表はコチラ"></a></p>
</tr>
<tr>
<td>
<!-- 車両メーカー検索ココから -->
<p class="search_category">【自動車メーカー】</p>
<form method="post" action="10210.php">
...
if($data[0] == '10210') $position = explode(";", $data[1]);
}
array_pop($position);
fclose($fp_position);
...
<form name="make" method="post" action="10210.php">
