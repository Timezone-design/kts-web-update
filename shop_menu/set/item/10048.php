 <html>
<head>
<meta content="1台1台テストを重ね、ベストセッティングを追求するという基本概念を踏襲し、スーパーダウンサスよりもバネレートを高く設定しストローク幅を30%アップさせたスプリングです。ストリートはもちろん、峠やサーキットまで見据えたハードサスペンションです。" name="description"/>
<meta content="text/html; charset=utf-8" http-equiv="Content-Type"/><meta content="width=device-width, user-scalable=yes, initial-scale=1, maximum-scale=1" name="viewport"><meta content="width=device-width" name="viewport"/><title>KTS-web 工賃セットメニュー ESPELIR Super DOWNSUS GT</title><script type="application/ld+json">{@context: "http://schema.org",@type: "BreadcrumbList",itemListElement:[{@type: "ListItem",position: 1,item:{@id: "/shop_menu/",name: "SHOP MENU"}},{@type: "ListItem",position: 2,item:{@id: "/set/",name: "工賃セットメニュー"}},{@type: "ListItem",position: 3,item:{@id: "/item/10048.php",name: "Super DOWNSUS GT"}}]}</script><script src="https://ajax.googleapis.com/ajax/libs/jquery/3.1.1/jquery.min.js"></script>
<meta content="width=device-width, user-scalable=yes, initial-scale=1, maximum-scale=1" name="viewport"/>
<meta content="width=device-width" name="viewport"/>
<title>KTS-web 工賃セットメニュー ESPELIR Super DOWNSUS GT</title>
...
<div><img alt="Super DOWNSUS GT" src="../../brand/img/1030.gif"/></div>
</div>
<div class="set_menu_n_cell col-md-6 col-sm-12 col-xs-12">
<div class="item_info_text_middle"><p>ESPELIR[エスペリア]</p></div><div class="item_info_text_middle_b"><p>Super DOWNSUS GT[スーパーダウンサスGT]</p></div>
</div>
</div>
<div class="set_menu_n row">
<div class="set_menu_n_330 col-md-6 col-sm-12 col-xs-12">
<div>
<div class="swiper-container"><div class="swiper-wrapper"><div class="swiper-slide"><img alt="Super DOWNSUS GT" src="../../item_img/10048_1.jpg"/></div><div class="swiper-slide"><img alt="Super DOWNSUS GT" src="../../item_img/10048_2.jpg"/></div><div class="swiper-slide"><img alt="Super DOWNSUS GT" src="../../item_img/10048_3.jpg"/></div></div><div class="swiper-button-prev"></div><div class="swiper-button-next"></div></div>
</div>
<div class="item_caution"><p>※写真はイメージ・代表画像です。 </p><p>※実際の商品とカラーやイメージが異なる場合がございます。</p></div>
</div>
<div class="set_menu_n_cell col-md-6 col-sm-12 col-xs-12">
<a class="set-sale-switch" href="../../sale/item/10048.php">メニュー内容・物販へのリンク</a><div class="tab_wrap">
