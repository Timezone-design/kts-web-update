	              ...
	              <div class="set_sale_back">
	                    ...
	                    <div class="tab_wrap">
	                      ...
	                      <div class="tab-content">
	                        <div id="home" class="tab-pane fade in active show">
	                          <p>リアルレーシングパッドの定番!<br/>踏み始めから突出した高い効力を発揮。ハイパワー車両のタイムアタックに最適!<br/>温度や速度の変化にも影響を受けにくい抜群の安定感<br/>リリース性に優れ、ブレーキング後半のコントロール性も抜群!</p>
	                        </div>
	                        <div id="menu2" class="tab-pane fade">
	                          <p>・材質:カーボンセミメタル<br/>・適正温度:200～900℃<br/>・初期μ:0.55<br/>・平均μ:0.43～0.48</p>
	                        </div>
	                      </div>
	                      <script>
	                ...
	                <table style="table-layout:fixed;" width="100%">
	                  ...
	                  <tr>
	                    ...
	                    <p class="search_category">**********【商品検索】**********&nbsp;&nbsp;<a class="change_button" href="../../sale/item/10359.php"><img src="../../img/sale_button.jpg" alt="単品販売の価格表はコチラ"></a></p>
	                  </tr>
	                </table>
	                  <?php
	                  	$root_dir = __DIR__.'/../../..';
