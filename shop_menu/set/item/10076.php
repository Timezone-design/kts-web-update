 <html>
<head>
<meta content="ワインディングを気持ちよく走るスポーツモデル。ハイグリップラジアルタイヤを想定したスポーツの真骨頂ともいえるモデル。スポーツ走行で刻々と変化するタイヤインフォメーション、路面状況、トラクションを的確に補足し、ドライバーの直感に訴えるストレートなフィーリング。走りの本能を掻き立てる気持ちよさを追求したストリートスポーツモデルです。" name="description"/>
<meta content="text/html; charset=utf-8" http-equiv="Content-Type"/><meta content="width=device-width, user-scalable=yes, initial-scale=1, maximum-scale=1" name="viewport"><meta content="width=device-width" name="viewport"/><title>KTS-web 工賃セットメニュー HKS HIPERMAX IV SP</title><script type="application/ld+json">{@context: "http://schema.org",@type: "BreadcrumbList",itemListElement:[{@type: "ListItem",position: 1,item:{@id: "/shop_menu/",name: "SHOP MENU"}},{@type: "ListItem",position: 2,item:{@id: "/set/",name: "工賃セットメニュー"}},{@type: "ListItem",position: 3,item:{@id: "/item/10076.php",name: "HIPERMAX IV SP"}}]}</script><script src="https://ajax.googleapis.com/ajax/libs/jquery/3.1.1/jquery.min.js"></script>
...
<div><img alt="HIPERMAX IV SP" src="../../brand/img/1032.gif"/></div>
</div>
<div class="set_menu_n_cell col-md-6 col-sm-12 col-xs-12">
<div class="item_info_text_middle"><p>HKS[エッチケーエス]</p></div><div class="item_info_text_middle_b"><p>HIPERMAX IV SP[ハイパーマックス4 SP]</p></div>
</div>
</div>
<div class="set_menu_n row">
<div class="set_menu_n_330 col-md-6 col-sm-12 col-xs-12">
<div>
<div class="swiper-container"><div class="swiper-wrapper"><div class="swiper-slide"><img alt="HIPERMAX IV SP" src="../../item_img/10076_1.jpg"/></div><div class="swiper-slide"><img alt="HIPERMAX IV SP" src="../../item_img/10076_2.jpg"/></div><div class="swiper-slide"><img alt="HIPERMAX IV SP" src="../../item_img/10076_3.jpg"/></div></div><div class="swiper-button-prev"></div><div class="swiper-button-next"></div></div>
</div>
<div class="item_caution"><p>※写真はイメージ・代表画像です。 </p><p>※実際の商品とカラーやイメージが異なる場合がございます。</p></div>
</div>
<div class="set_menu_n_cell col-md-6 col-sm-12 col-xs-12">
<a class="set-sale-switch" href="../../sale/item/10076.php">メニュー内容・物販へのリンク</a><div class="tab_wrap">
