 <html>
<head>
<meta content="車がもっとキビキビ動く。走ることがこれまで以上に楽しくなる。&lt;br&gt;Super Formula・SUPER GTなどの1/100秒を競うレースに求められる精度は、1/100mm。そのノウハウ・高精度な技術を用いて、より乗り心地の良いスムーズなアシへ。それが「FUNTORIDE スプリング」のコンセプト。スポーツカー・チューニンググレードに向け、最適な「車高」「ストローク量」、そして「バネレート」を設計することで、さらにスポーツカーらしいハンドリングや安定感のあるコーナーリング特性に引き上げます。" name="description"/>
<meta content="text/html; charset=utf-8" http-equiv="Content-Type"/><meta content="width=device-width, user-scalable=yes, initial-scale=1, maximum-scale=1" name="viewport"><meta content="width=device-width" name="viewport"/><title>KTS-web 工賃セットメニュー TANABE GT FUNTORIDE SPRING</title><script type="application/ld+json">{@context: "http://schema.org",@type: "BreadcrumbList",itemListElement:[{@type: "ListItem",position: 1,item:{@id: "/shop_menu/",name: "SHOP MENU"}},{@type: "ListItem",position: 2,item:{@id: "/set/",name: "工賃セットメニュー"}},{@type: "ListItem",position: 3,item:{@id: "/item/10175.php",name: "GT FUNTORIDE SPRING"}}]}</script><script src="https://ajax.googleapis.com/ajax/libs/jquery/3.1.1/jquery.min.js"></script>
<meta content="width=device-width, user-scalable=yes, initial-scale=1, maximum-scale=1" name="viewport"/>
<meta content="width=device-width" name="viewport"/>
<title>KTS-web 工賃セットメニュー TANABE GT FUNTORIDE SPRING</title>
...
<div><img alt="GT FUNTORIDE SPRING" src="../../brand/img/1095.gif"/></div>
</div>
<div class="set_menu_n_cell col-md-6 col-sm-12 col-xs-12">
<div class="item_info_text_middle"><p>TANABE[タナベ]</p></div><div class="item_info_text_middle_b"><p>GT FUNTORIDE SPRING[GTファントライド SPRING]</p></div>
</div>
</div>
<div class="set_menu_n row">
<div class="set_menu_n_330 col-md-6 col-sm-12 col-xs-12">
<div>
<div class="swiper-container"><div class="swiper-wrapper"><div class="swiper-slide"><img alt="GT FUNTORIDE SPRING" src="../../item_img/10175_1.jpg"/></div><div class="swiper-slide"><img alt="GT FUNTORIDE SPRING" src="../../item_img/10175_2.jpg"/></div><div class="swiper-slide"><img alt="GT FUNTORIDE SPRING" src="../../item_img/10175_3.jpg"/></div></div><div class="swiper-button-prev"></div><div class="swiper-button-next"></div></div>
</div>
<div class="item_caution"><p>※写真はイメージ・代表画像です。 </p><p>※実際の商品とカラーやイメージが異なる場合がございます。</p></div>
</div>
<div class="set_menu_n_cell col-md-6 col-sm-12 col-xs-12">
<a class="set-sale-switch" href="../../sale/item/10175.php">メニュー内容・物販へのリンク</a><div class="tab_wrap">
