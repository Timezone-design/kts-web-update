 <html>
								<head>
								<meta content="AutoExeロゴ入りアルミ製エンドキャップを配した小径ホイールナット。装着に専用アダプターレンチを必要とする異形ヘプタゴン（7角形）デザインの採用で、ホイールの盗難を抑制する機能も兼ね備えている。素材には、高温時に緩みにくい高強度なクロームバナジウム鋼を採用。" name="description"/>
<meta content="text/html; charset=utf-8" http-equiv="Content-Type"><meta content="width=device-width, user-scalable=yes, initial-scale=1, maximum-scale=1" name="viewport"/><meta content="width=device-width" name="viewport"/><title>KTS-web 工賃セットメニュー AutoExe ホイールナットセット</title><script type="application/ld+json">{@context: "http://schema.org",@type: "BreadcrumbList",itemListElement:[{@type: "ListItem",position: 1,item:{@id: "/shop_menu/",name: "SHOP MENU"}},{@type: "ListItem",position: 2,item:{@id: "/set/",name: "工賃セットメニュー"}},{@type: "ListItem",position: 3,item:{@id: "/item/10798.php",name: "ホイールナットセット"}}]}</script><script src="https://ajax.googleapis.com/ajax/libs/jquery/3.1.1/jquery.min.js"></script>
<meta content="width=device-width, user-scalable=yes, initial-scale=1, maximum-scale=1" name="viewport"/>
<meta content="width=device-width" name="viewport"/>
<title>KTS-web 工賃セットメニュー AutoExe ホイールナットセット</title>
	              ...
	              <div class="set_sale_back">
	                ...
	                <div class="set_menu_n row">
	                  <div class="set_menu_n_330 col-md-6 col-sm-12 col-xs-12">
	                    <div><img alt="ホイールナットセット" src="../../brand/img/1042.gif"/></div>
	                  </div>
	                  <div class="set_menu_n_cell col-md-6 col-sm-12 col-xs-12">
	                    <div class="item_info_text_middle"><p>AutoExe[オートエグゼ]</p></div><div class="item_info_text_middle_b"><p>ホイールナットセット</p></div>
	                  </div>
	                </div>
	                <div class="set_menu_n row">
	                  <div class="set_menu_n_330 col-md-6 col-sm-12 col-xs-12">
	                    <div>
	                      <div class="swiper-container"><div class="swiper-wrapper"><div class="swiper-slide"><img alt="ホイールナットセット" src="../../item_img/10798_1.jpg"/></div><div class="swiper-slide"><img alt="ホイールナットセット" src="../../item_img/10798_2.jpg"/></div><div class="swiper-slide"><img alt="ホイールナットセット" src="../../item_img/10798_3.jpg"/></div></div><div class="swiper-button-prev"></div><div class="swiper-button-next"></div></div>
	                    </div>
	                    ...
	                    <div class="tab_wrap">
	                      ...
	                      <div class="tab-content">
	                        <div id="home" class="tab-pane fade in active show">
	                          <p>AutoExeロゴ入りアルミ製エンドキャップを配した小径ホイールナット。装着に専用アダプターレンチを必要とする異形ヘプタゴン（7角形）デザインの採用で、ホイールの盗難を抑制する機能も兼ね備えている。素材には、高温時に緩みにくい高強度なクロームバナジウム鋼を採用。</p>
	                        </div>
	                        <div id="menu2" class="tab-pane fade">
	                          <p>・本体：クロームバナジウム鋼製<br/>・トップ部：アルミ製エンドキャップ<br/>・トップ部：クリアレッド焼付け塗装<br/>・AutoExeロゴ入り<br/>・異形ヘプタゴン(７角形) タイプ<br/>・Ｍ12×P1.5 L=32mm<br/>・装着用専用アダプターレンチ付属<br/>・1台分20個セット</p>
	                        </div>
	                      </div>
	                      <script>
	                ...
	                <table style="table-layout:fixed;" width="100%">
	                  ...
	                  <tr>
	                    ...
	                    <p class="search_category">**********【商品検索】**********&nbsp;&nbsp;<a class="change_button" href="../../sale/item/10798.php"><img src="../../img/sale_button.jpg" alt="単品販売の価格表はコチラ"></a></p>
	                  </tr>
	                </table>
	                  <?php
	                  	$root_dir = __DIR__.'/../../..';
