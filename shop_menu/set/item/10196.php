...
<title>KTS-web 工賃セットメニュー TEIN MONO SPORT DAMPER</title>
...
<div class="mc_nav">
<a class="link" href="https://www.kts-web.com/">HOME</a> &gt; <a class="link" href="../../index.html">SHOP MENU</a> &gt; <a class="link" href="../index.html">工賃セットメニュー</a> &gt; <a class="link" href="../cat/100.html">足回り</a> &gt; <a class="link" href="../cat/116.html">車高調/セッティングパーツ</a> &gt; <a class="link" href="../br/1104-116.html">TEIN</a> &gt; <a class="link" href="10196.php">MONO SPORT DAMPER</a></div>
<div class="space3px"></div>
<div class="set_sale_back">
<div class="space3px"></div>
<div class="set_menu_n">
<div class="set_menu_n_330">
<div><img src="../../brand/img/1104.gif" alt="MONO SPORT DAMPER"></div></div>
<div class="set_menu_n_cell">
<div class="item_info_text_middle">
<p>TEIN[テイン]</p></div>
<div class="item_info_text_middle_b">
<p>MONO SPORT DAMPER[モノスポーツダンパー]</p></div>
</div></div>
...
<div class="swiper-slide"><img src="../../item_img/10196_1.jpg" alt="MONO SPORT DAMPER"></div>
<div class="swiper-slide"><img src="../../item_img/10196_2.jpg" alt="MONO SPORT DAMPER"></div>
<div class="swiper-slide"><img src="../../item_img/10196_3.jpg" alt="MONO SPORT DAMPER"></div>
</div>
...
<p>MONO SPORTは、すべての人に「走るよろこび」を提供することをコンセプトに開発されています。「走るよろこび」は車種によって異なります。サーキットでのスポーツ走行を楽しむような車種には、スポーツ走行を考慮したセッティングを施し、ドライバーのスポーツマインドを高める正確なステアリングフィールに加え、しなやかさも兼ね揃えています。減衰力の調整により、普段使いの街乗りも問題無く使用して頂けるセッティングとなっています。</p>
</div>
<div id="panel2" class="tab_panel">
<p>・全長調整式<br>・単筒式<br>・減衰力16段調整式<br>・アッパーマウント付き<br>・EDFCシリーズ対応<br>・防錆コーティング<br>・3年6万キロ+固着保証<br>・オーバーホール/仕様変更可能</p>
</div>
</div>
</div>
</div>
...
<div class="item_info_text_middle_b">
<p>MONO SPORT DAMPER [モノスポーツダンパー]</p>
</div>
<div class="tab_wrap">
...
<p class="search_category">**********【適合検索】**********&nbsp;&nbsp;<a class="change_button" href="../../sale/item/10196.php"><img src="../../img/sale_button.jpg" alt="単品販売の価格表はコチラ"></a></p>
</tr>
<tr>
<td>
<!-- 車両メーカー検索ココから -->
<p class="search_category">【自動車メーカー】</p>
<form method="post" action="10196.php">
...
if($data[0] == '10196') $position = explode(";", $data[1]);
}
array_pop($position);
fclose($fp_position);
...
<form name="make" method="post" action="10196.php">
