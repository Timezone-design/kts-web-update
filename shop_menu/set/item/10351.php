	              ...
	              <div class="set_sale_back">
	                    ...
	                    <div class="tab_wrap">
	                      ...
	                      <div class="tab-content">
	                        <div id="home" class="tab-pane fade in active show">
	                          <p>ハイウェイ、ワインディングでのスポーツドライビングで発揮するワンランク上の制動力と耐熱性<br/>ローターに負担を掛けず非常に経済的<br/>スコーチ（パッド表面焼付）により初期なじみも抜群<br/>ノーマルパッドと同様に、「機械式センサー」装着済（一部品番を除く）</p>
	                        </div>
	                        <div id="menu2" class="tab-pane fade">
	                          <p>・材質:NAO<br/>・適正温度:0～600℃<br/>・Max μ:0.48<br/>・Ave μ:0.35<br/>・Min μ:0.34<br/>・ステージ:ストリート/ワインディング(ノーマル)/ワインディング(ハード)/ジムカーナ</p>
	                        </div>
	                      </div>
	                      <script>
	                ...
	                <table style="table-layout:fixed;" width="100%">
	                  ...
	                  <tr>
	                    ...
	                    <p class="search_category">**********【商品検索】**********&nbsp;&nbsp;<a class="change_button" href="../../sale/item/10351.php"><img src="../../img/sale_button.jpg" alt="単品販売の価格表はコチラ"></a></p>
	                  </tr>
	                </table>
	                  <?php
	                  	$root_dir = __DIR__.'/../../..';
