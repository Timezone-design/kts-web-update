              ...
              <div class="set_sale_back">
                ...
                <div class="set_menu_n row">
                  <div class="set_menu_n_330 col-md-6 col-sm-12 col-xs-12">
                    <div><img alt="Specom-K" src="../../brand/img/1103.gif"/></div>
                  </div>
                  <div class="set_menu_n_cell col-md-6 col-sm-12 col-xs-12">
                    <div class="item_info_text_middle"><p>DIXCEL[ディクセル]</p></div><div class="item_info_text_middle_b"><p>Specom-K[スペコンK]</p></div>
                  </div>
                </div>
                <div class="set_menu_n row">
                  <div class="set_menu_n_330 col-md-6 col-sm-12 col-xs-12">
                    <div>
                      <div class="swiper-container"><div class="swiper-wrapper"><div class="swiper-slide"><img alt="Specom-K" src="../../item_img/10361_1.jpg"/></div><div class="swiper-slide"><img alt="Specom-K" src="../../item_img/10361_2.jpg"/></div><div class="swiper-slide"><img alt="Specom-K" src="../../item_img/10361_3.jpg"/></div></div><div class="swiper-button-prev"></div><div class="swiper-button-next"></div></div>
                    </div>
                    ...
                    <div class="tab_wrap">
                      ...
                      <div class="tab-content">
                        <div id="home" class="tab-pane fade in active show">
                          <p>全国各地のサーキットで開催される"軽自動車レース"。高まるニーズに合わせて開発。<br/>車重の軽い軽自動車用に初期制動をマイルドに抑え、ロングライフ(従来のZタイプの1.5～2倍)かつコントロール性を重視。<br/>コントロール性に優れるので、ドライビングに集中出来る<br/>ミニサーキットや国際サーキットでの5時間前後の耐久レースにも有効なアイテム!<br/>従来のZタイプのユーザーにもお薦め</p>
                        </div>
                        <div id="menu2" class="tab-pane fade">
                          <p>・材質:グラファイト メタリック<br/>・適正温度:50～800℃</p>
                        </div>
                      </div>
                      <script>
                ...
                <table style="table-layout:fixed;" width="100%">
                  ...
                  <tr>
                    ...
                    <p class="search_category">**********【商品検索】**********&nbsp;&nbsp;<a class="change_button" href="../../sale/item/10361.php"><img src="../../img/sale_button.jpg" alt="単品販売の価格表はコチラ"></a></p>
                  </tr>
                </table>
                  <?php
    							$root_dir = __DIR__.'/../../..';
