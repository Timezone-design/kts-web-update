              ...
              <div class="set_sale_back">
                    ...
                    <div class="tab_wrap">
                      ...
                      <div class="tab-content">
                        <div id="home" class="tab-pane fade in active show">
                          <p>通常の強化クラッチでは物足りないという方にベストマッチング<br/>ボルトオン装着可能、純正クラッチなみのフィーリングを実現。パワー伝達性能と操作性の良さを高次元でバランス。クラッチカバー、クラッチディスク、フライホイールのすべてをセット交換専用設計。そのため、他の純正形状強化クラッチより高い性能を発揮。材質や寸法の相性も抜群。</p>
                        </div>
                        <div id="menu2" class="tab-pane fade">
                          <p>・切れ応答性の向上<br/>・圧着力:1200kgf(11800N)<br/>※一部車種を除く<br/>・セット交換専用設計<br/>・静粛性:シャラシャラ音が発生しません<br/>・ボルトオンで装着可能。</p>
                        </div>
                      </div>
                      <script>
                ...
                <table style="table-layout:fixed;" width="100%">
                  ...
                  <tr>
                    ...
                    <p class="search_category">**********【商品検索】**********&nbsp;&nbsp;<a class="change_button" href="../../sale/item/10462.php"><img src="../../img/sale_button.jpg" alt="単品販売の価格表はコチラ"></a></p>
                  </tr>
                </table>
                  <?php
    							$root_dir = __DIR__.'/../../..';
