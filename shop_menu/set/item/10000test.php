...
<meta name="description" content="高性能・多機能・低価格を実現したKTSオリジナル車高調の取付SETメニューです。アライメント測定・調整込み！！">
...
<div class="left_menu">
        ...
        <div class="left_menu_2">・<a href="../../set/damper/index.html">車高調 ダウンサス</a></div>
        <div class="left_menu_2">・<a href="../../set/suspension/index.html">サスペンションパーツ</a></div>
        <div class="left_menu_2">・<a href="../../set/drive/index.html">駆動系</a></div>
        <div class="left_menu_2">・<a href="../../set/cooling/index.html">クーリング</a></div>
        <div class="left_menu_2">・<a href="../../set/brake/index.html">ブレーキ</a></div>
        <div class="left_menu_2">・<a href="../../set/arm/index.html">アーム・ロッド</a></div>
        <div class="left_menu_2">・<a href="../../set/body/index.html">ボディ補強</a></div>
        <div class="left_menu_2">・<a href="../../set/ex/index.html">エキゾースト</a></div>
        <div class="left_menu_2">・<a href="../../set/intake/index.html">インテーク</a></div>
        <div class="left_menu_2">・<a href="../../set/engine/index.html">エンジン</a></div>
        <div class="left_menu_2">・<a href="../../set/interior/index.html">インテリア</a></div>
        <div class="left_menu_2">・<a href="../../set/tire_wheel/index.html">タイヤ・ホイール</a></div>
        <div class="left_menu_2">・<a href="../../set/ch_ma/index.html">ケミカル・メンテナンス</a></div>
        <div class="left_menu_2">・<a href="../../set/other/index.html">その他</a></div>
...
<div class="mc_nav">
<a class="link" href="https://www.kts-web.com/">HOME</a> &gt; <a class="link" href="../../../../index.html">SHOP MENU</a> &gt; <a class="link" href="../../../index.html">工賃セットメニュー</a> &gt; <a class="link" href="../cat/100.html">足回り</a> &gt; <a class="link" href="../cat/116.html">車高調/セッティングパーツ</a> &gt; <a class="link" href="1162-116.html">KTS</a></div>
<div class="space3px"></div>
<div class="set_sale_back">
<div class="space3px"></div>
<div class="set_menu_n">
<div class="set_menu_n_330">
<div><img src="../../brand/img/1162.gif" alt="SC DAMPER SYSTEM β"></div></div>
<div class="set_menu_n_cell">
<div class="item_info_text_middle">
<p>KTS[ケーティーエス]</p></div>
<div class="item_info_text_middle_b">
<p>商品名：SC DAMPER SYSTEM β</p></div>
</div></div>
...
<div class="swiper-slide"><img src="../../item_img/10000_1.jpg" alt="SC DAMPER SYSTEM β"></div>
<div class="swiper-slide"><img src="../../item_img/10000_2.jpg" alt="SC DAMPER SYSTEM β"></div>
<div class="swiper-slide"><img src="../../item_img/10000_3.jpg" alt="SC DAMPER SYSTEM β"></div>
</div>
...
<p>走る、曲がる、止まる。車の基本となる3大要素を大きく左右するダンパーシステム。常に一定ではない路面状況に対応すべく、開発・販売実績に基づくデータを分析し、より優れたダンパーシステムの開発に成功しました。高性能・多機能・低価格を実現した車高調です。ストリートからサーキットまで幅広くセッティングが可能！！</p>
</div>
<div id="panel2" class="tab_panel">
<p>・車高調整：フルタップ(全長調整式)<br>・減衰力調整：15段<br>・ボディ：スチールボディ設計(防錆加工済)<br>・車種別設計ピロアッパーマウント(一部車種を除く)<br>・バンプラバー付属(正立式)<br>・オーバーホール可能<br>・専用車高調レンチ2本付属</p>
</div>
</div>
</div>
</div>
...
<!--ココからOP-->
    <div class="space3px"></div>
    <details><summary>オプションメニュー</summary>
        
<div class="set_menu_text"><span class="item_info_text_middle_b">・TEIN EDFC ACTIVE</span></div>
<div class="set_menu_n">
<div class="set_menu_n_200"><img src="../img/tein_edfc_active.jpg" alt="TEIN EDFC ACTIVE"></div>
<div class="set_menu_n_cell">
<div class="option_menu_text">
<div>EDFCの機能に加え、内蔵されたGセンサにより走行中の加減速Gに応じた減衰力の自動調整が可能。</div>
<div>別売りのGPSキットを追加することで車速に応じた減衰力の自動調整も可能とします。</div>
</div>
<div class="set_price_left">取付工賃込み価格：<span class="font_f00">￥73,000</span></div>
<div class="option_caution">※GPSキットの追加はプラス￥10,300</div>
</div>
...
<div class="option_caution">※GPSキットの追加はプラス￥10,300</div>
    ...
    <div class="space3px"></div>
<div class="set_menu_text"><span class="item_info_text_middle_b">・TEIN EDFC ACTIVE PRO</span></div>
<div class="set_menu_n">
<div class="set_menu_n_200"><img src="../img/tein_edfc_active_pro.jpg" alt="TEIN EDFC ACTIVE"></div>
<div class="set_menu_n_cell">
<div class="option_menu_text">
<div>EDFC ACTIVEの機能に加え、4輪独立減衰力調整、旋回G感応調整、車速信号の入力機能など様々な新機能が追加されたハイスペックバージョンです。</div>
<div>別売りのGPSキットを追加することで車速に応じた減衰力の自動調整も可能とします。</div>
</div>
<div class="set_price_left">取付工賃込み価格：<span class="font_f00">￥89,000</span></div>
<div class="option_caution">※GPSキットの追加はプラス￥10,300</div>
</div>
</div>
...
<div class="option_caution">※GPSキットの追加はプラス￥10,300</div>
    ...
    <div class="space5px"></div>
<div class="option_caution">※価格はKTSにて対応のTEIN製品をご購入・お取付のお客様に限ります。</div>
<div class="option_caution">※車種によってエクステンションキットなど別途オプションパーツが必要となり追加料金が発生する場合があります。<br>　該当車種などについてはメーカーHPをご覧頂くか、最寄のKTS店舗までお問合せ下さい。</div>
    </details>
    <div class="space5px"></div>
<tr>
<a class="set_img"><img src="../../img/set.jpg" alt="お得な工賃セット"></a>
    <tr>
    <p class="search_category">**********【適合検索】***&nbsp;<a class="change_button" href="../../sale/item/10000.php"><img src="../../img/sale_button.jpg" alt="工賃セットの価格表はコチラ"></a></p>
        </tr>
    <tr>
...
<!-- 車両メーカー検索ココから -->
 ...
 <p class="search_category">【自動車メーカー】</p>
    <form name="manufacture" method="post" action="10000test.php">
    <select select id="manufacture" name="manufacture" onchange="submit(this.form)" style="width:100%;">
...
while (($data = fgetcsv($fp, 0, ",")) !== FALSE) {
    ...
    rsort($manufacturelist);
        ...
        if(isset($manufacture_select) == FALSE || $manufacture_select == ""){
...
<!-- 車種検索ココから -->
 <p class="search_category">【車種】</p>
        <form name="make" method="post" action="10000test.php">
...
<form method="post" action="10000test.php">
...
<div class="item_info_text_small">▼ご希望の車種をタップすると詳細・購入ページに遷移します。<br>※表示価格は税抜です。<br>※輸入車の取付は平和島店・一之江店のみの対応です。</div>
<!-- 適合表出力-->
<div class="scroll">
...
print_r('<tr class="matching_table" data-href=https://www.kts-web.com/ec_shop/products/detail/' . $line[15] . '>
<td>' . $line[1] . '
</td>');
if( empty($line[13]) ){
echo('<td>お問い合わせ下さい</td>');}
