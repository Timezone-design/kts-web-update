	              ...
	              <div class="set_sale_back">
	                    ...
	                    <div class="tab_wrap">
	                      ...
	                      <div class="tab-content">
	                        <div id="home" class="tab-pane fade in active show">
	                          <p>イニシャルトルク内圧式固定のベーシックモデル。大径プレート20枚仕様によりスリップからロックへの移行が大幅にスムーズになりました。プレートツメ面積を確保することで摺動ジャダーを完全に抑制しています。2WAYと1.5WAYの作動方式を選択可能です。また、プレッシャーリングにそれぞれのカム角を加工してあるため、ご購入後に組み換えも可能です。<br/>※分解整備作業が必要</p>
	                        </div>
	                        <div id="menu2" class="tab-pane fade">
	                          <p>・イニシャルトルク固定式<br/>・大径プレート20枚仕様<br/>・2WAY/1.5WAY選択・組み替え可能<br/>・高品質プレートの採用<br/>・高いコントロール性</p>
	                        </div>
	                      </div>
	                      <script>
	                ...
	                <table style="table-layout:fixed;" width="100%">
	                  ...
	                  <tr>
	                    ...
	                    <p class="search_category">**********【商品検索】**********&nbsp;&nbsp;<a class="change_button" href="../../sale/item/10455.php"><img src="../../img/sale_button.jpg" alt="単品販売の価格表はコチラ"></a></p>
	                  </tr>
	                </table>
	                  <?php
	                  	$root_dir = __DIR__.'/../../..';
