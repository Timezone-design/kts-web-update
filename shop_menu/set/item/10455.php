 <html>
<head>
<meta content="イニシャルトルク内圧式固定のベーシックモデル。大径プレート20枚仕様によりスリップからロックへの移行が大幅にスムーズになりました。プレートツメ面積を確保することで摺動ジャダーを完全に抑制しています。2WAYと1.5WAYの作動方式を選択可能です。また、プレッシャーリングにそれぞれのカム角を加工してあるため、ご購入後に組み換えも可能です。&lt;br&gt;※分解整備作業が必要" name="description"/>
<meta content="text/html; charset=utf-8" http-equiv="Content-Type"/><meta content="width=device-width, user-scalable=yes, initial-scale=1, maximum-scale=1" name="viewport"><meta content="width=device-width" name="viewport"/><title>KTS-web 工賃セットメニュー nismo GT L.S.D.</title><script type="application/ld+json">{@context: "http://schema.org",@type: "BreadcrumbList",itemListElement:[{@type: "ListItem",position: 1,item:{@id: "/shop_menu/",name: "SHOP MENU"}},{@type: "ListItem",position: 2,item:{@id: "/set/",name: "工賃セットメニュー"}},{@type: "ListItem",position: 3,item:{@id: "/item/10455.php",name: "GT L.S.D."}}]}</script><script src="https://ajax.googleapis.com/ajax/libs/jquery/3.1.1/jquery.min.js"></script>
<meta content="width=device-width, user-scalable=yes, initial-scale=1, maximum-scale=1" name="viewport"/>
<meta content="width=device-width" name="viewport"/>
<title>KTS-web 工賃セットメニュー nismo GT L.S.D.</title>
...
<div><img alt="GT L.S.D." src="../../brand/img/1122.gif"/></div>
</div>
<div class="set_menu_n_cell col-md-6 col-sm-12 col-xs-12">
<div class="item_info_text_middle"><p>nismo[ニスモ]</p></div><div class="item_info_text_middle_b"><p>GT L.S.D.[GT LSD]</p></div>
</div>
</div>
<div class="set_menu_n row">
<div class="set_menu_n_330 col-md-6 col-sm-12 col-xs-12">
<div>
<div class="swiper-container"><div class="swiper-wrapper"><div class="swiper-slide"><img alt="GT L.S.D." src="../../item_img/10455_1.jpg"/></div><div class="swiper-slide"><img alt="GT L.S.D." src="../../item_img/10455_2.jpg"/></div><div class="swiper-slide"><img alt="GT L.S.D." src="../../item_img/10455_3.jpg"/></div></div><div class="swiper-button-prev"></div><div class="swiper-button-next"></div></div>
</div>
<div class="item_caution"><p>※写真はイメージ・代表画像です。 </p><p>※実際の商品とカラーやイメージが異なる場合がございます。</p></div>
</div>
<div class="set_menu_n_cell col-md-6 col-sm-12 col-xs-12">
<a class="set-sale-switch" href="../../sale/item/10455.php">メニュー内容・物販へのリンク</a><div class="tab_wrap">
