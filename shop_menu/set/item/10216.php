<html>
 <head>
  ...
  <title>
   KTS-web 工賃セットメニュー XYZ JAPAN TS IMP
  </title>
  <script type="application/ld+json">
   {@context: "http://schema.org",@type: "BreadcrumbList",itemListElement:[{@type: "ListItem",position: 1,item:{@id: "/shop_menu/",name: "SHOP MENU"}},{@type: "ListItem",position: 2,item:{@id: "/set/",name: "工賃セットメニュー"}},{@type: "ListItem",position: 3,item:{@id: "/item/10216.php",name: "TS IMP"}}]}
  </script>
       ...
       <div class="set_sale_back">
        ...
        <div class="set_menu_n row">
         <div class="set_menu_n_330 col-md-6 col-sm-12 col-xs-12">
          <div>
           <img alt="TS IMP" src="../../brand/img/1031.gif"/>
          </div>
         </div>
           ...
           <div class="swiper-container">
            <div class="swiper-wrapper">
             <div class="swiper-slide">
              <img alt="TS IMP" src="../../item_img/10216_1.jpg"/>
             </div>
             <div class="swiper-slide">
              <img alt="TS IMP" src="../../item_img/10216_2.jpg"/>
             </div>
             <div class="swiper-slide">
              <img alt="TS IMP" src="../../item_img/10216_3.jpg"/>
             </div>
            </div>
