<html>
<head>
<meta name="description" content="専用材高強度鋼線の採用により、耐疲労・耐へたり性に優れているほか、大幅な軽量化を実現しています。独自の加工により、高応力域での使用を実現。柔軟かつ強剛な特性が得られます。また、スプリングの軽量化により復帰速度（回復性）を従来に比べ約10％向上。路面に対する追従性、コーナリング時のより早い車体の安定性、スムーズな操舵性を実現します。">
...
<title>KTS-web 工賃セットメニュー Swift 直巻きレーシングサスペンションスプリング</title>
...
<div class="mc_nav">
<a class="link" href="https://www.kts-web.com/">HOME</a> &gt; <a class="link" href="../../index.html">SHOP MENU</a> &gt; <a class="link" href="../index.html">工賃セットメニュー</a> &gt; <a class="link" href="../cat/100.html">足回り</a> &gt; <a class="link" href="../cat/116.html">車高調/セッティングパーツ</a> &gt; <a class="link" href="../br/1088-116.html">Swift</a> &gt; <a class="link" href="10001.php">直巻きレーシングサスペンションスプリング</a></div>
<div class="space3px"></div>
<div class="set_sale_back">
<div class="space3px"></div>
<div class="set_menu_n">
<div class="set_menu_n_330">
<div><img src="../../brand/img/1088.gif" alt="直巻きレーシングサスペンションスプリング"></div></div>
<div class="set_menu_n_cell">
<div class="item_info_text_middle">
<p>Swift[スイフト]</p></div>
<div class="item_info_text_middle_b">
<p>直巻きレーシングサスペンションスプリング</p></div>
</div></div>
...
<div class="swiper-slide"><img src="../../item_img/10001_1.jpg" alt="直巻きレーシングサスペンションスプリング"></div>
<div class="swiper-slide"><img src="../../item_img/10001_2.jpg" alt="直巻きレーシングサスペンションスプリング"></div>
<div class="swiper-slide"><img src="../../item_img/10001_3.jpg" alt="直巻きレーシングサスペンションスプリング"></div>
</div>
...
<p>専用材高強度鋼線の採用により、耐疲労・耐へたり性に優れているほか、大幅な軽量化を実現しています。独自の加工により、高応力域での使用を実現。柔軟かつ強剛な特性が得られます。また、スプリングの軽量化により復帰速度（回復性）を従来に比べ約10％向上。路面に対する追従性、コーナリング時のより早い車体の安定性、スムーズな操舵性を実現します。<br>取付詳細は<a href="../damper/hyperco_swift.html">コチラ</a></p>
</div>
<div id="panel2" class="tab_panel">
<p>・材質:専用材高強度鋼線H5S・TW<br>・運動性能:復帰速度(回復性)を従来比約10％向上<br>・ID:60/65/70/75(LONG)mm</p>
</div>
</div>
</div>
</div>
...
<td>
<!-- スプリング検索ココから -->
<p class="search_category">【ID(内径)】</p>
...
if($data[0] == '10001') $position = explode(";", $data[1]);
}
array_pop($position);
fclose($fp_position);
...
print_r("<option disabled='disabled'>ID(内径)を選択してください</option>");
...
<td>
<p class="search_category">【自由長】</p>
<form name="make" method="post" action="10001.php">
...
print_r("<option disabled='disabled'>自由長を選択してください</option>");
...
<td>
<p class="search_category">【バネレート】</p>
<form method="post" action="10001.php">
...
print_r("<option disabled='disabled'>レートを選択してください</option>");
...
<div class="item_info_text_small">▼ご希望の商品をタップすると詳細・購入ページに遷移します。<br>※表示価格は税抜です。<br>※輸入車は平和島店・一之江店のみの対応です。</div>
<div class="scroll">
