 <html>
								<head>
								<meta content="傾斜のきついスロープや駐車場の出入口など、ローダウン時に懸念されるボディと路面との干渉を未然に回避可能にする画期的なシステムです。アッパー部のCUP機能によりスイッチ1つで短時間に車高をUP。走行中はCUP機能に依存しないため、回避後に車高を戻すことで本来のスタイルおよびアラゴスタの性能を維持します。&lt;br&gt;●スイッチはコンパクト設計で設置場所を選ばず、コンソール内など目立たない場所に取り付けることも可能。&lt;br&gt;●コンプレッサーおよびエアタンクはアラゴスタカップ専用の最小サイズ設計とし、トランクやスペアタイヤスペース等へスマートに設置可能。ラゲッジ容量を大幅に削る心配もありません。" name="description"/>
<meta content="text/html; charset=utf-8" http-equiv="Content-Type"><meta content="width=device-width, user-scalable=yes, initial-scale=1, maximum-scale=1" name="viewport"/><meta content="width=device-width" name="viewport"/><title>KTS-web 工賃セットメニュー Aragosta Aragosta-CUP</title><script type="application/ld+json">{@context: "http://schema.org",@type: "BreadcrumbList",itemListElement:[{@type: "ListItem",position: 1,item:{@id: "/shop_menu/",name: "SHOP MENU"}},{@type: "ListItem",position: 2,item:{@id: "/set/",name: "工賃セットメニュー"}},{@type: "ListItem",position: 3,item:{@id: "/item/10010.php",name: "Aragosta-CUP"}}]}</script><script src="https://ajax.googleapis.com/ajax/libs/jquery/3.1.1/jquery.min.js"></script>
	              ...
	              <div class="set_sale_back">
	                ...
	                <div class="set_menu_n row">
	                  <div class="set_menu_n_330 col-md-6 col-sm-12 col-xs-12">
	                    <div><img alt="Aragosta-CUP" src="../../brand/img/1010.gif"/></div>
	                  </div>
	                  <div class="set_menu_n_cell col-md-6 col-sm-12 col-xs-12">
	                    <div class="item_info_text_middle"><p>Aragosta[アラゴスタ]</p></div><div class="item_info_text_middle_b"><p>Aragosta-CUP[アラゴスタカップ]</p></div>
	                  </div>
	                </div>
	                <div class="set_menu_n row">
	                  <div class="set_menu_n_330 col-md-6 col-sm-12 col-xs-12">
	                    <div>
	                      <div class="swiper-container"><div class="swiper-wrapper"><div class="swiper-slide"><img alt="Aragosta-CUP" src="../../item_img/10010_1.jpg"/></div><div class="swiper-slide"><img alt="Aragosta-CUP" src="../../item_img/10010_2.jpg"/></div><div class="swiper-slide"><img alt="Aragosta-CUP" src="../../item_img/10010_3.jpg"/></div></div><div class="swiper-button-prev"></div><div class="swiper-button-next"></div></div>
	                    </div>
	                ...
	                <table style="table-layout:fixed;" width="100%">
	                  ...
	                  <tr>
	                    ...
	                    <p class="search_category">**********【商品検索】**********&nbsp;&nbsp;<a class="change_button" href="../../sale/item/10010.php"><img src="../../img/sale_button.jpg" alt="単品販売の価格表はコチラ"></a></p>
	                  </tr>
	                </table>
	                  <?php
	                  	$root_dir = __DIR__.'/../../..';
