	              ...
	              <div class="set_sale_back">
	                    ...
	                    <div class="tab_wrap">
	                      ...
	                      <div class="tab-content">
	                        <div id="home" class="tab-pane fade in active show">
	                          <p>Y-sportsは、初期制動・コントロール性といったストリートパッドとして重要な性能に優れ、如何なる状況下でも確実な制動力を発揮するブレーキパッドです。純正からのグレードアップ等、エントリーモデルとして最適なストリートスポーツパッドです。</p>
	                        </div>
	                        <div id="menu2" class="tab-pane fade">
	                          <p>・ローター適正温度域：0～400℃<br/>・平均摩擦係数：0.35～0.45<br/>・材質：ノンアスベスト<br/>・フィールド：ストリート-ワインディング</p>
	                        </div>
	                      </div>
	                      <script>
	                ...
	                <table style="table-layout:fixed;" width="100%">
	                  ...
	                  <tr>
	                    ...
	                    <p class="search_category">**********【商品検索】**********&nbsp;&nbsp;<a class="change_button" href="../../sale/item/10303.php"><img src="../../img/sale_button.jpg" alt="単品販売の価格表はコチラ"></a></p>
	                  </tr>
	                </table>
	                  <?php
	                  	$root_dir = __DIR__.'/../../..';
