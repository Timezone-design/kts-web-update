...
<title>KTS-web 工賃セットメニュー HKS HIPERMAX G+</title>
	              ...
	              <div class="set_sale_back">
	                ...
	                <div class="set_menu_n row">
	                  <div class="set_menu_n_330 col-md-6 col-sm-12 col-xs-12">
	                    <div>
	                      <div class="swiper-container"><div class="swiper-wrapper"><div class="swiper-slide"><img alt="HIPERMAX G+" src="../../item_img/10086_1.jpg"/></div><div class="swiper-slide"><img alt="HIPERMAX G+" src="../../item_img/10086_2.jpg"/></div><div class="swiper-slide"><img alt="HIPERMAX G+" src="../../item_img/10086_3.jpg"/></div></div><div class="swiper-button-prev"></div><div class="swiper-button-next"></div></div>
	                    </div>
	                    ...
	                    <div class="tab_wrap">
	                      ...
	                      <div class="tab-content">
	                        <div id="home" class="tab-pane fade in active show">
	                          <p>上質な乗り味を徹底追及したMAX Gをベースに減衰力の選択肢をもたせた純正形状ストリートサスペンションの決定版。純正形状 + 単筒式構造という構成に加え部品レベルでの精度および強度の向上を図り、安定感としなやかさを両立した極めて質の高い乗り味を実現した「HIPERMAX G」をベースに30段階の減衰力調整機能を追加。あたりのやわらかいコンフォート重視の乗り味からスポーツ系サスペンションキットのような引き締まった乗り味までお好みに合わせてお楽しみいただけます。</p>
	                        </div>
	                        <div id="menu2" class="tab-pane fade">
	                          <p>・単筒式<br/>・減衰力調整式<br/>・全長固定式<br/>・専用スペシャルオイル<br/>・PNEコート<br/>・3年6万キロ保証</p>
	                        </div>
	                      </div>
	                      <script>
	                ...
	                <table style="table-layout:fixed;" width="100%">
	                  ...
	                  <tr>
	                    ...
	                    <p class="search_category">**********【商品検索】**********&nbsp;&nbsp;<a class="change_button" href="../../sale/item/10086.php"><img src="../../img/sale_button.jpg" alt="単品販売の価格表はコチラ"></a></p>
	                  </tr>
	                </table>
	                  <?php
	                  	$root_dir = __DIR__.'/../../..';
