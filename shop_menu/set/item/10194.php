 <html>
								<head>
								<meta content="インチアップ&amp;ローダウンを前提にストリートでの乗り心地を追求し、 複筒式構造のショックアブソーバを採用しました。荒れた路面も存在するストリートにおいて乗り心地を確保するには、十分なストロークと、ローフリクションでスムーズに動くショックアブソーバが必要です。その点、複筒式はオイル室とガス室が直列配置ではないためストロークを確保しやすく、封入ガス圧が低いため、ローフリクション。スムーズにストロークすることで荒れた路面や凹凸をしっかりと捉え、低速ではしなやかに、高速ではフラットで安定感ある走りをもたらします。" name="description"/>
<meta content="text/html; charset=utf-8" http-equiv="Content-Type"><meta content="width=device-width, user-scalable=yes, initial-scale=1, maximum-scale=1" name="viewport"/><meta content="width=device-width" name="viewport"/><title>KTS-web 工賃セットメニュー TEIN STREET BASIS</title><script type="application/ld+json">{@context: "http://schema.org",@type: "BreadcrumbList",itemListElement:[{@type: "ListItem",position: 1,item:{@id: "/shop_menu/",name: "SHOP MENU"}},{@type: "ListItem",position: 2,item:{@id: "/set/",name: "工賃セットメニュー"}},{@type: "ListItem",position: 3,item:{@id: "/item/10194.php",name: "STREET BASIS"}}]}</script><script src="https://ajax.googleapis.com/ajax/libs/jquery/3.1.1/jquery.min.js"></script>
<meta content="width=device-width, user-scalable=yes, initial-scale=1, maximum-scale=1" name="viewport"/>
<meta content="width=device-width" name="viewport"/>
<title>KTS-web 工賃セットメニュー TEIN STREET BASIS</title>
	              ...
	              <div class="set_sale_back">
	                ...
	                <div class="set_menu_n row">
	                  <div class="set_menu_n_330 col-md-6 col-sm-12 col-xs-12">
	                    <div><img alt="STREET BASIS" src="../../brand/img/1104.gif"/></div>
	                  </div>
	                  <div class="set_menu_n_cell col-md-6 col-sm-12 col-xs-12">
	                    <div class="item_info_text_middle"><p>TEIN[テイン]</p></div><div class="item_info_text_middle_b"><p>STREET BASIS[ストリートベイシス]</p></div>
	                  </div>
	                </div>
	                <div class="set_menu_n row">
	                  <div class="set_menu_n_330 col-md-6 col-sm-12 col-xs-12">
	                    <div>
	                      <div class="swiper-container"><div class="swiper-wrapper"><div class="swiper-slide"><img alt="STREET BASIS" src="../../item_img/10194_1.jpg"/></div><div class="swiper-slide"><img alt="STREET BASIS" src="../../item_img/10194_2.jpg"/></div><div class="swiper-slide"><img alt="STREET BASIS" src="../../item_img/10194_3.jpg"/></div></div><div class="swiper-button-prev"></div><div class="swiper-button-next"></div></div>
	                    </div>
	                ...
	                <table style="table-layout:fixed;" width="100%">
	                  ...
	                  <tr>
	                    ...
	                    <p class="search_category">**********【商品検索】**********&nbsp;&nbsp;<a class="change_button" href="../../sale/item/10194.php"><img src="../../img/sale_button.jpg" alt="単品販売の価格表はコチラ"></a></p>
	                  </tr>
	                </table>
	                  <?php
	                  	$root_dir = __DIR__.'/../../..';
