              ...
              <div class="set_sale_back">
                ...
                <div class="set_menu_n row">
                  <div class="set_menu_n_330 col-md-6 col-sm-12 col-xs-12">
                    <div><img alt="スポーツブレーキライン" src="../../brand/img/1042.gif"/></div>
                  </div>
                  <div class="set_menu_n_cell col-md-6 col-sm-12 col-xs-12">
                    <div class="item_info_text_middle"><p>AutoExe[オートエグゼ]</p></div><div class="item_info_text_middle_b"><p>スポーツブレーキライン</p></div>
                  </div>
                </div>
                <div class="set_menu_n row">
                  <div class="set_menu_n_330 col-md-6 col-sm-12 col-xs-12">
                    <div>
                      <div class="swiper-container"><div class="swiper-wrapper"><div class="swiper-slide"><img alt="スポーツブレーキライン" src="../../item_img/10790_1.jpg"/></div><div class="swiper-slide"><img alt="スポーツブレーキライン" src="../../item_img/10790_2.jpg"/></div><div class="swiper-slide"><img alt="スポーツブレーキライン" src="../../item_img/10790_3.jpg"/></div></div><div class="swiper-button-prev"></div><div class="swiper-button-next"></div></div>
                    </div>
                    ...
                    <div class="tab_wrap">
                      ...
                      <div class="tab-content">
                        <div id="home" class="tab-pane fade in active show">
                          <p>量産車で採用されるゴム製と比較して熱や経年による劣化や油圧による膨張が少ないステンレスメッシュPTFE（テフロン）を採用し、踏力に応じたダイレクトなブレーキフィールを維持する。量産同様のホースレイアウトを忠実に再現。飛び石からホースをガードするPVCコーティングなど、安全性に配慮した設計としている。取付けに必要なガスケットなどを付属。</p>
                        </div>
                        <div id="menu2" class="tab-pane fade">
                          <p>・ステンレスメッシュPTFEホース＋PVCコーティング<br/>・1台分のセット</p>
                        </div>
                      </div>
                      <script>
                ...
                <table style="table-layout:fixed;" width="100%">
                  ...
                  <tr>
                    ...
                    <p class="search_category">**********【商品検索】**********&nbsp;&nbsp;<a class="change_button" href="../../sale/item/10790.php"><img src="../../img/sale_button.jpg" alt="単品販売の価格表はコチラ"></a></p>
                  </tr>
                </table>
                  <?php
    							$root_dir = __DIR__.'/../../..';
