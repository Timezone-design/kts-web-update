<html>
<head>
<meta name="description" content="2本のスプリングを直列（シリーズ）にセットすることで、バリアブルなスプリングレートを設定できます。<br>メインスプリングとの接続にはスペーサースプリングシートが必要です。<br>線形はスクエアタイプ（角断面）になります。">
...
<title>KTS-web 工賃セットメニュー TEIN ヘルパースプリング
</title>
...
<div class="mc_nav">
<a class="link" href="https://www.kts-web.com/">HOME</a> &gt; <a class="link" href="../../index.html">SHOP MENU</a> &gt; <a class="link" href="../index.html">工賃セットメニュー</a> &gt; <a class="link" href="../cat/100.html">足回り</a> &gt; <a class="link" href="../cat/116.html">車高調/セッティングパーツ</a> &gt; <a class="link" href="../br/1104-116.html">TEIN</a> &gt; <a class="link" href="10229.php">ヘルパースプリング
</a></div>
<div class="space3px"></div>
...
<div><img src="../../brand/img/1104.gif" alt="ヘルパースプリング
"></div></div>
...
<div class="swiper-slide"><img src="../../item_img/10229_1.jpg" alt="ヘルパースプリング
"></div>
<div class="swiper-slide"><img src="../../item_img/10229_2.jpg" alt="ヘルパースプリング
"></div>
<div class="swiper-slide"><img src="../../item_img/10229_3.jpg" alt="ヘルパースプリング
"></div>
</div>
...
<p>2本のスプリングを直列（シリーズ）にセットすることで、バリアブルなスプリングレートを設定できます。<br>メインスプリングとの接続にはスペーサースプリングシートが必要です。<br>線形はスクエアタイプ（角断面）になります。</p>
</div>
<div id="panel2" class="tab_panel">
<p>・ID(内径)：φ70/φ65/φ58<br>・線形：角断面</p>
</div>
</div>
</div>
</div>
...
<p class="search_category">**********【商品検索】**********&nbsp;&nbsp;<a class="change_button" href="../../sale/item/10229.php"><img src="../../img/sale_button.jpg" alt="単品販売の価格表はコチラ"></a></p>
</tr>
<tr>
<td>
<!-- スプリング検索ココから -->
<p class="search_category">【ID(内径)】</p>
<form method="post" action="10229.php">
...
if($data[0] == '10229') $position = explode(";", $data[1]);
}
array_pop($position);
fclose($fp_position);
...
<form name="make" method="post" action="10229.php">
