...
<title>KTS-web 工賃セットメニュー TEIN TYPE Gr.N STANDARD SPEC</title>
...
<div class="mc_nav">
<a class="link" href="https://www.kts-web.com/">HOME</a> &gt; <a class="link" href="../../../../index.html">SHOP MENU</a> &gt; <a class="link" href="../../../index.html">工賃セットメニュー</a> &gt; <a class="link" href="../cat/100.html">足回り</a> &gt; <a class="link" href="../cat/116.html">車高調/セッティングパーツ</a> &gt; <a class="link" href="../br/1104-116.html">TEIN</a> &gt; <a class="link" href="10205.php">TYPE Gr.N STANDARD SPEC</a></div>
<div class="space3px"></div>
<div class="set_sale_back">
<div class="space3px"></div>
<div class="set_menu_n">
<div class="set_menu_n_330">
<div><img src="../../brand/img/1104.gif" alt="TYPE Gr.N STANDARD SPEC"></div></div>
<div class="set_menu_n_cell">
<div class="item_info_text_middle">
<p>TEIN[テイン]</p></div>
<div class="item_info_text_middle_b">
<p>TYPE Gr.N STANDARD SPEC[タイプ グループN スタンダードスペック]</p></div>
</div></div>
...
<div class="swiper-slide"><img src="../../item_img/10205_1.jpg" alt="TYPE Gr.N STANDARD SPEC"></div>
<div class="swiper-slide"><img src="../../item_img/10205_2.jpg" alt="TYPE Gr.N STANDARD SPEC"></div>
<div class="swiper-slide"><img src="../../item_img/10205_3.jpg" alt="TYPE Gr.N STANDARD SPEC"></div>
</div>
...
<p>P-WRC、APRC、そして各国のラリー選手権などで鍛えられた即戦力競技スペックのラリー専用ショックアブソーバー。高速縮側32段/低速縮側16段/伸側16段の減衰力調整、そしてH.B.S.16段調整の3+1WAY調整を採用した最高峰ショックアブソーバーです。</p>
</div>
<div id="panel2" class="tab_panel">
<p>・3+1WAY 調整機構<br>・単筒式構造<br>・別タンク構造<br>・キャンバー調整機構(ストラット式)<br>・専用スプリング採用<br>・専用ヘルパースプリング(ストラット式)<br>・H.B.S採用<br>・Micro Speed Valve(M.S.V.)採用<br>・T.C.V.(温度補償バルブ)採用</p>
</div>
</div>
</div>
</div>
...
<div class="item_info_text_middle_b">
<p>TYPE Gr.N STANDARD SPEC [タイプ グループN スタンダードスペック]</p>
</div>
<div class="tab_wrap">
...
<p class="search_category">**********【適合検索】**********&nbsp;&nbsp;<a class="change_button" href="../../sale/item/10205.php"><img src="../../img/sale_button.jpg" alt="工賃セットの価格表はコチラ"></a></p>
</tr>
<tr>
<td>
<!-- 車両メーカー検索ココから -->
<p class="search_category">【自動車メーカー】</p>
<form method="post" action="10205.php">
...
if($data[0] == '10205') $position = explode(";", $data[1]);
}
array_pop($position);
fclose($fp_position);
...
<form name="make" method="post" action="10205.php">
