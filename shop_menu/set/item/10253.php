	              ...
	              <div class="set_sale_back">
	                    ...
	                    <div class="tab_wrap">
	                      ...
	                      <div class="tab-content">
	                        <div id="home" class="tab-pane fade in active show">
	                          <p>装着したまま調整可能。強化ウレタン製で耐久性はバツグン！リアサスを安定させて、ストリートでもサーキットでもタイムUP！<br/>アライメントを正確に調整することができるので直進性や回頭性が重要なスポーツ走行にも効果を発揮します。 また、車高を変化させることで左右に偏ってしまったアクスルを補正できるため、シビアなホイールセッティングを必要とされるドレスアップにおいても必需品となっています。</p>
	                        </div>
	                        <div id="menu2" class="tab-pane fade">
	                          <p>・強化ウレタンブッシュを採用<br/>・ターンバックル調整式<br/>・調整幅は+-約20mm<br/>・クロームメッキ仕上げ</p>
	                        </div>
	                      </div>
	                      <script>
	                ...
	                <table style="table-layout:fixed;" width="100%">
	                  ...
	                  <tr>
	                    ...
	                    <p class="search_category">**********【商品検索】**********&nbsp;&nbsp;<a class="change_button" href="../../sale/item/10253.php"><img src="../../img/sale_button.jpg" alt="単品販売の価格表はコチラ"></a></p>
	                  </tr>
	                </table>
	                  <?php
	                  	$root_dir = __DIR__.'/../../..';
