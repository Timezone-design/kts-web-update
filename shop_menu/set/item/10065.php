 <html>
<head>
<meta content="「STEALTH 最上級モデル」単筒式の優れた放熱機能と大型ピストンを採用さまざまなシーンで安定した走行を可能とし、更に耐久性に優れたモデルです。ハイレートスプリングをセットしスーパーローダウンを可能としました。" name="description"/>
<meta content="text/html; charset=utf-8" http-equiv="Content-Type"/><meta content="width=device-width, user-scalable=yes, initial-scale=1, maximum-scale=1" name="viewport"><meta content="width=device-width" name="viewport"/><title>KTS-web 工賃セットメニュー FINAL KONNEXION STEALTH Complete Super Short Version</title><script type="application/ld+json">{@context: "http://schema.org",@type: "BreadcrumbList",itemListElement:[{@type: "ListItem",position: 1,item:{@id: "/shop_menu/",name: "SHOP MENU"}},{@type: "ListItem",position: 2,item:{@id: "/set/",name: "工賃セットメニュー"}},{@type: "ListItem",position: 3,item:{@id: "/item/10065.php",name: "STEALTH Complete Super Short Version"}}]}</script><script src="https://ajax.googleapis.com/ajax/libs/jquery/3.1.1/jquery.min.js"></script>
...
<div><img alt="STEALTH Complete Super Short Version" src="../../brand/img/1138.gif"/></div>
</div>
<div class="set_menu_n_cell col-md-6 col-sm-12 col-xs-12">
<div class="item_info_text_middle"><p>FINAL KONNEXION[ファイナルコネクション]</p></div><div class="item_info_text_middle_b"><p>STEALTH Complete Super Short Version[ステルスコンプリート スーパーショートバージョン]</p></div>
</div>
</div>
<div class="set_menu_n row">
<div class="set_menu_n_330 col-md-6 col-sm-12 col-xs-12">
<div>
<div class="swiper-container"><div class="swiper-wrapper"><div class="swiper-slide"><img alt="STEALTH Complete Super Short Version" src="../../item_img/10065_1.jpg"/></div><div class="swiper-slide"><img alt="STEALTH Complete Super Short Version" src="../../item_img/10065_2.jpg"/></div><div class="swiper-slide"><img alt="STEALTH Complete Super Short Version" src="../../item_img/10065_3.jpg"/></div></div><div class="swiper-button-prev"></div><div class="swiper-button-next"></div></div>
</div>
<div class="item_caution"><p>※写真はイメージ・代表画像です。 </p><p>※実際の商品とカラーやイメージが異なる場合がございます。</p></div>
</div>
<div class="set_menu_n_cell col-md-6 col-sm-12 col-xs-12">
<a class="set-sale-switch" href="../../sale/item/10065.php">メニュー内容・物販へのリンク</a><div class="tab_wrap">
