	              ...
	              <div class="set_sale_back">
	                    ...
	                    <div class="tab_wrap">
	                      ...
	                      <div class="tab-content">
	                        <div id="home" class="tab-pane fade in active show">
	                          <p>JAF N1規定対応のレーシングクラッチ!<br/>ワンメイクレースやジムカーナ、ダートトライアルなどのJAF N1車両規定に適合。レギュレーションによりフライホイールの交換が許されない中で真価を発揮します。3分割のメタル摩擦材を採用することでクラッチディスクのイナーシャを低減し、レーシング感覚あふれるシフトフィーリングを実現（対純正ディスク比78％）。</p>
	                        </div>
	                        <div id="menu2" class="tab-pane fade">
	                          <p>・専用軽量メタルクラッチディスク（純正比78％）<br/>・アルミ製高剛性クラッチカバー(純正比74%)</p>
	                        </div>
	                      </div>
	                      <script>
	                ...
	                <table style="table-layout:fixed;" width="100%">
	                  ...
	                  <tr>
	                    ...
	                    <p class="search_category">**********【商品検索】**********&nbsp;&nbsp;<a class="change_button" href="../../sale/item/10527.php"><img src="../../img/sale_button.jpg" alt="単品販売の価格表はコチラ"></a></p>
	                  </tr>
	                </table>
	                  <?php
	                  	$root_dir = __DIR__.'/../../..';
