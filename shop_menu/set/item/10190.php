...
<title>KTS-web 工賃セットメニュー TEIN FLEX Z</title>
...
<div class="mc_nav">
<a class="link" href="https://www.kts-web.com/">HOME</a> &gt; <a class="link" href="../../index.html">SHOP MENU</a> &gt; <a class="link" href="../index.html">工賃セットメニュー</a> &gt; <a class="link" href="../cat/100.html">足回り</a> &gt; <a class="link" href="../cat/116.html">車高調/セッティングパーツ</a> &gt; <a class="link" href="../br/1104-116.html">TEIN</a> &gt; <a class="link" href="10190.php">FLEX Z</a></div>
<div class="space3px"></div>
<div class="set_sale_back">
<div class="space3px"></div>
<div class="set_menu_n">
<div class="set_menu_n_330">
<div><img src="../../brand/img/1104.gif" alt="FLEX Z"></div></div>
<div class="set_menu_n_cell">
<div class="item_info_text_middle">
<p>TEIN[テイン]</p></div>
<div class="item_info_text_middle_b">
<p>FLEX Z[フレックスZ]</p></div>
</div></div>
...
<div class="swiper-slide"><img src="../../item_img/10190_1.jpg" alt="FLEX Z"></div>
<div class="swiper-slide"><img src="../../item_img/10190_2.jpg" alt="FLEX Z"></div>
<div class="swiper-slide"><img src="../../item_img/10190_3.jpg" alt="FLEX Z"></div>
</div>
...
<p>MADE IN JAPANの高品質!横浜自社工場で仕上げたプライス以上の価値を持つ全長調整式車高調。FLEX Zには複筒式をチョイス。長いストロークと低反発、低フリクションが特徴の複筒式。スムース動作で快適でしなやかな乗り心地を実現します。</p>
</div>
<div id="panel2" class="tab_panel">
<p>・全長調整式<br>・複筒式<br>・減衰力16段調整式<br>・非分解式シールド構造<br>・車種別専用マウント付き<br>・リプレイスメントサービス有り<br>・EDFCシリーズ対応<br>・3年6万キロ+固着保証</p>
</div>
</div>
</div>
</div>
...
<p class="search_category">**********【適合検索】**********&nbsp;&nbsp;<a class="change_button" href="../../sale/item/10190.php"><img src="../../img/sale_button.jpg" alt="単品販売の価格表はコチラ"></a></p>
</tr>
<tr>
<td>
<!-- 車両メーカー検索ココから -->
<p class="search_category">【自動車メーカー】</p>
<form method="post" action="10190.php">
...
if($data[0] == '10190') $position = explode(";", $data[1]);
}
array_pop($position);
fclose($fp_position);
...
<form name="make" method="post" action="10190.php">
