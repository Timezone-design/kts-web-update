...
<title>KTS-web 工賃セットメニュー TEIN STREET ADVANCE Z4</title>
...
<div class="mc_nav">
<a class="link" href="https://www.kts-web.com/">HOME</a> &gt; <a class="link" href="../../index.html">SHOP MENU</a> &gt; <a class="link" href="../index.html">工賃セットメニュー</a> &gt; <a class="link" href="../cat/100.html">足回り</a> &gt; <a class="link" href="../cat/116.html">車高調/セッティングパーツ</a> &gt; <a class="link" href="../br/1104-116.html">TEIN</a> &gt; <a class="link" href="10186.php">STREET ADVANCE Z4</a></div>
<div class="space3px"></div>
<div class="set_sale_back">
<div class="space3px"></div>
<div class="set_menu_n">
<div class="set_menu_n_330">
<div><img src="../../brand/img/1104.gif" alt="STREET ADVANCE Z4"></div></div>
<div class="set_menu_n_cell">
<div class="item_info_text_middle">
<p>TEIN[テイン]</p></div>
<div class="item_info_text_middle_b">
<p>STREET ADVANCE Z4[ストリートアドバンス Z4]</p></div>
</div></div>
...
<div class="swiper-slide"><img src="../../item_img/10186_1.jpg" alt="STREET ADVANCE Z4"></div>
<div class="swiper-slide"><img src="../../item_img/10186_2.jpg" alt="STREET ADVANCE Z4"></div>
<div class="swiper-slide"><img src="../../item_img/10186_3.jpg" alt="STREET ADVANCE Z4"></div>
</div>
...
<p>高品質で高い耐久性を兼ね備えた1インチリフトアップ用車高調。ネジ式車高調整機構を採用し、ロアスプリングシートを上下に移動することで車高調整が可能で、シンプルで扱いやすい構造を採用。基準車高は純正車高から１インチアップ( 約25mm) 前後とすることで、ロードクリアランスを確保。あらゆる路面での走行を想定し市街地からオフロード走行まで様々な走行ステージに対応できる車高設定です。</p>
</div>
<div id="panel2" class="tab_panel">
<p>・リフトアップ<br>・減衰力16段調整式<br>・複筒式<br>・非分解式シールド構造<br>・ハイドロ・バンプ・ストッパー(H.B.S.)搭載<br>・純正マウント使用<br>・耐久性と高品質<br>・テイングリーンの粉体塗装<br>・3年6万キロ保証＋固着保証<br>・EDFCシリーズ対応</p>
</div>
</div>
</div>
</div>
...
<div class="item_info_text_middle_b">
<p>STREET ADVANCE Z4 [ストリートアドバンス Z4]</p>
</div>
<div class="tab_wrap">
...
<p class="search_category">**********【適合検索】**********&nbsp;&nbsp;<a class="change_button" href="../../sale/item/10186.php"><img src="../../img/sale_button.jpg" alt="単品販売の価格表はコチラ"></a></p>
</tr>
<tr>
<td>
<!-- 車両メーカー検索ココから -->
<p class="search_category">【自動車メーカー】</p>
<form method="post" action="10186.php">
...
if($data[0] == '10186') $position = explode(";", $data[1]);
}
array_pop($position);
fclose($fp_position);
...
<form name="make" method="post" action="10186.php">
