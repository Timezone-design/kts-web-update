 <html>
								<head>
								<meta content="REAL SPORTS×TANABEのコラボレーションNEWブランド。SUPER GT、SUPER FORMULAに参戦中のREAL SPORTSとコラボレーションモデル。REAL SPORTSの経験と知識とTANABEの製造技術力、商品へのこだわりを注ぎ込んだ「真」を楽しんでください。" name="description"/>
<meta content="text/html; charset=utf-8" http-equiv="Content-Type"><meta content="width=device-width, user-scalable=yes, initial-scale=1, maximum-scale=1" name="viewport"/><meta content="width=device-width" name="viewport"/><title>KTS-web 工賃セットメニュー TANABE REAL SPORTS×TANABE SUSPENSION SYSTEM</title><script type="application/ld+json">{@context: "http://schema.org",@type: "BreadcrumbList",itemListElement:[{@type: "ListItem",position: 1,item:{@id: "/shop_menu/",name: "SHOP MENU"}},{@type: "ListItem",position: 2,item:{@id: "/set/",name: "工賃セットメニュー"}},{@type: "ListItem",position: 3,item:{@id: "/item/10174.php",name: "REAL SPORTS×TANABE SUSPENSION SYSTEM"}}]}</script><script src="https://ajax.googleapis.com/ajax/libs/jquery/3.1.1/jquery.min.js"></script>
	              ...
	              <div class="set_sale_back">
	                ...
	                <div class="set_menu_n row">
	                  <div class="set_menu_n_330 col-md-6 col-sm-12 col-xs-12">
	                    <div><img alt="REAL SPORTS×TANABE SUSPENSION SYSTEM" src="../../brand/img/1095.gif"/></div>
	                  </div>
	                  <div class="set_menu_n_cell col-md-6 col-sm-12 col-xs-12">
	                    <div class="item_info_text_middle"><p>TANABE[タナベ]</p></div><div class="item_info_text_middle_b"><p>REAL SPORTS×TANABE SUSPENSION SYSTEM[リアルスポーツ×タナベ サスペンションシステム]</p></div>
	                  </div>
	                </div>
	                <div class="set_menu_n row">
	                  <div class="set_menu_n_330 col-md-6 col-sm-12 col-xs-12">
	                    <div>
	                      <div class="swiper-container"><div class="swiper-wrapper"><div class="swiper-slide"><img alt="REAL SPORTS×TANABE SUSPENSION SYSTEM" src="../../item_img/10174_1.jpg"/></div><div class="swiper-slide"><img alt="REAL SPORTS×TANABE SUSPENSION SYSTEM" src="../../item_img/10174_2.jpg"/></div><div class="swiper-slide"><img alt="REAL SPORTS×TANABE SUSPENSION SYSTEM" src="../../item_img/10174_3.jpg"/></div></div><div class="swiper-button-prev"></div><div class="swiper-button-next"></div></div>
	                    </div>
	                ...
	                <table style="table-layout:fixed;" width="100%">
	                  ...
	                  <tr>
	                    ...
	                    <p class="search_category">**********【商品検索】**********&nbsp;&nbsp;<a class="change_button" href="../../sale/item/10174.php"><img src="../../img/sale_button.jpg" alt="単品販売の価格表はコチラ"></a></p>
	                  </tr>
	                </table>
	                  <?php
	                  	$root_dir = __DIR__.'/../../..';
