              ...
              <div class="set_sale_back">
                    ...
                    <div class="tab_wrap">
                      ...
                      <div class="tab-content">
                        <div id="home" class="tab-pane fade in active show">
                          <p>クラッチプレートに表面を強化し、摩擦を低減させる特殊な表面処理であるWPC処理した仕様です。WPC処理によって、金属表面の構造を強化し、より硬く耐久性のある製品に仕上がっています。</p>
                        </div>
                        <div id="menu2" class="tab-pane fade">
                          <p>・1.5WAY or 2WAY<br/>・クラッチプレートWPC処理仕様</p>
                        </div>
                      </div>
                      <script>
                ...
                <table style="table-layout:fixed;" width="100%">
                  ...
                  <tr>
                    ...
                    <p class="search_category">**********【商品検索】**********&nbsp;&nbsp;<a class="change_button" href="../../sale/item/10439.php"><img src="../../img/sale_button.jpg" alt="単品販売の価格表はコチラ"></a></p>
                  </tr>
                </table>
                  <?php
    							$root_dir = __DIR__.'/../../..';
