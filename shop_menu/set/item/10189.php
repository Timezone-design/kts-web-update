...
<title>KTS-web 工賃セットメニュー TEIN FLEX A</title>
...
<div class="mc_nav">
<a class="link" href="https://www.kts-web.com/">HOME</a> &gt; <a class="link" href="../../index.html">SHOP MENU</a> &gt; <a class="link" href="../index.html">工賃セットメニュー</a> &gt; <a class="link" href="../cat/100.html">足回り</a> &gt; <a class="link" href="../cat/116.html">車高調/セッティングパーツ</a> &gt; <a class="link" href="../br/1104-116.html">TEIN</a> &gt; <a class="link" href="10189.php">FLEX A</a></div>
<div class="space3px"></div>
<div class="set_sale_back">
<div class="space3px"></div>
<div class="set_menu_n">
<div class="set_menu_n_330">
<div><img src="../../brand/img/1104.gif" alt="FLEX A"></div></div>
<div class="set_menu_n_cell">
<div class="item_info_text_middle">
<p>TEIN[テイン]</p></div>
<div class="item_info_text_middle_b">
<p>FLEX A[フレックスA]</p></div>
</div></div>
...
<div class="swiper-slide"><img src="../../item_img/10189_1.jpg" alt="FLEX A"></div>
<div class="swiper-slide"><img src="../../item_img/10189_2.jpg" alt="FLEX A"></div>
<div class="swiper-slide"><img src="../../item_img/10189_3.jpg" alt="FLEX A"></div>
</div>
...
<p>フル乗車でも全席快適!ストリートユース車高調。ハイドロ・バンプ・ストッパー（H.B.S.）を使用しているFLEX Aでは、この衝撃をショックアブソーバ内部で熱エネルギーに変換し吸収することで、ギャップを通過する際の不快な衝撃を低減し、全席において快適な乗り心地を保つことができます！</p>
</div>
<div id="panel2" class="tab_panel">
<p>・ハイドロ・バンプ・ストッパー(H.B.S.)搭載<br>・全長調整式<br>・複筒式<br>・減衰力16段調整式<br>・オーバーホール/仕様変更可能<br>・EDFCシリーズ対応<br>・耐久性と高品質<br>・防錆処理<br>・3年6万キロ+固着保証</p>
</div>
</div>
</div>
</div>
...
<p class="search_category">**********【適合検索】**********&nbsp;&nbsp;<a class="change_button" href="../../sale/item/10189.php"><img src="../../img/sale_button.jpg" alt="単品販売の価格表はコチラ"></a></p>
</tr>
<tr>
<td>
<!-- 車両メーカー検索ココから -->
<p class="search_category">【自動車メーカー】</p>
<form method="post" action="10189.php">
...
if($data[0] == '10189') $position = explode(";", $data[1]);
}
array_pop($position);
fclose($fp_position);
...
<form name="make" method="post" action="10189.php">
