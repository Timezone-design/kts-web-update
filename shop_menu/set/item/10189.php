 <html>
<head>
<meta content="フル乗車でも全席快適!ストリートユース車高調。ハイドロ・バンプ・ストッパー（H.B.S.）を使用しているFLEX Aでは、この衝撃をショックアブソーバ内部で熱エネルギーに変換し吸収することで、ギャップを通過する際の不快な衝撃を低減し、全席において快適な乗り心地を保つことができます！" name="description"/>
<meta content="text/html; charset=utf-8" http-equiv="Content-Type"/><meta content="width=device-width, user-scalable=yes, initial-scale=1, maximum-scale=1" name="viewport"><meta content="width=device-width" name="viewport"/><title>KTS-web 工賃セットメニュー TEIN FLEX A</title><script type="application/ld+json">{@context: "http://schema.org",@type: "BreadcrumbList",itemListElement:[{@type: "ListItem",position: 1,item:{@id: "/shop_menu/",name: "SHOP MENU"}},{@type: "ListItem",position: 2,item:{@id: "/set/",name: "工賃セットメニュー"}},{@type: "ListItem",position: 3,item:{@id: "/item/10189.php",name: "FLEX A"}}]}</script><script src="https://ajax.googleapis.com/ajax/libs/jquery/3.1.1/jquery.min.js"></script>
...
<div><img alt="FLEX A" src="../../brand/img/1104.gif"/></div>
</div>
<div class="set_menu_n_cell col-md-6 col-sm-12 col-xs-12">
<div class="item_info_text_middle"><p>TEIN[テイン]</p></div><div class="item_info_text_middle_b"><p>FLEX A[フレックスA]</p></div>
</div>
</div>
<div class="set_menu_n row">
<div class="set_menu_n_330 col-md-6 col-sm-12 col-xs-12">
<div>
<div class="swiper-container"><div class="swiper-wrapper"><div class="swiper-slide"><img alt="FLEX A" src="../../item_img/10189_1.jpg"/></div><div class="swiper-slide"><img alt="FLEX A" src="../../item_img/10189_2.jpg"/></div><div class="swiper-slide"><img alt="FLEX A" src="../../item_img/10189_3.jpg"/></div></div><div class="swiper-button-prev"></div><div class="swiper-button-next"></div></div>
</div>
<div class="item_caution"><p>※写真はイメージ・代表画像です。 </p><p>※実際の商品とカラーやイメージが異なる場合がございます。</p></div>
</div>
<div class="set_menu_n_cell col-md-6 col-sm-12 col-xs-12">
<a class="set-sale-switch" href="../../sale/item/10189.php">メニュー内容・物販へのリンク</a><div class="tab_wrap">
