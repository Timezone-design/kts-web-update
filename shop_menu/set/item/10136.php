 <html>
<head>
<meta content="各車種の初期出荷時は、最低地上高90mm～100mmを確保する設計としながらも、ダウン量に関しては従来のi☆SHOCKシリーズを超えるダウン領域のセッティングが可能。また、Black☆i専用となる超ショートストローク&amp;超ショートケース仕様のショックを各車種毎設計。 減衰力、スプリングレートと共にハード仕様を採用する事により、車体の無駄な動きを抑制して 迫力のダウンフォルムとシャープな走りを実現します。" name="description"/>
<meta content="text/html; charset=utf-8" http-equiv="Content-Type"/><meta content="width=device-width, user-scalable=yes, initial-scale=1, maximum-scale=1" name="viewport"><meta content="width=device-width" name="viewport"/><title>KTS-web 工賃セットメニュー RS★R Black☆i</title><script type="application/ld+json">{@context: "http://schema.org",@type: "BreadcrumbList",itemListElement:[{@type: "ListItem",position: 1,item:{@id: "/shop_menu/",name: "SHOP MENU"}},{@type: "ListItem",position: 2,item:{@id: "/set/",name: "工賃セットメニュー"}},{@type: "ListItem",position: 3,item:{@id: "/item/10136.php",name: "Black☆i"}}]}</script><script src="https://ajax.googleapis.com/ajax/libs/jquery/3.1.1/jquery.min.js"></script>
<meta content="width=device-width, user-scalable=yes, initial-scale=1, maximum-scale=1" name="viewport"/>
<meta content="width=device-width" name="viewport"/>
<title>KTS-web 工賃セットメニュー RS★R Black☆i</title>
...
<div><img alt="Black☆i" src="../../brand/img/1001.gif"/></div>
</div>
<div class="set_menu_n_cell col-md-6 col-sm-12 col-xs-12">
<div class="item_info_text_middle"><p>RS★R[アールエスアール]</p></div><div class="item_info_text_middle_b"><p>Black☆i[ブラックアイ]</p></div>
</div>
</div>
<div class="set_menu_n row">
<div class="set_menu_n_330 col-md-6 col-sm-12 col-xs-12">
<div>
<div class="swiper-container"><div class="swiper-wrapper"><div class="swiper-slide"><img alt="Black☆i" src="../../item_img/10136_1.jpg"/></div><div class="swiper-slide"><img alt="Black☆i" src="../../item_img/10136_2.jpg"/></div><div class="swiper-slide"><img alt="Black☆i" src="../../item_img/10136_3.jpg"/></div></div><div class="swiper-button-prev"></div><div class="swiper-button-next"></div></div>
</div>
<div class="item_caution"><p>※写真はイメージ・代表画像です。 </p><p>※実際の商品とカラーやイメージが異なる場合がございます。</p></div>
</div>
<div class="set_menu_n_cell col-md-6 col-sm-12 col-xs-12">
<a class="set-sale-switch" href="../../sale/item/10136.php">メニュー内容・物販へのリンク</a><div class="tab_wrap">
