	              ...
	              <div class="set_sale_back">
	                    ...
	                    <div class="tab_wrap">
	                      ...
	                      <div class="tab-content">
	                        <div id="home" class="tab-pane fade in active show">
	                          <p>ミニバンやハッチバック、ワゴンタイプの車は、リアの開口部が大きい分、剛性が低い傾向があります。車体の歪みや軋みは、サスペンションの正確な動作を妨げ、直進安定性やコーナリング性能の低下を招きます。<br/>ピラーバーでCピラー（Dピラー）間を繋ぐことによって、ボディの歪みや軋みを抑制してサスペンションがより正確に動作するようになり、走行性能を向上させることができます。</p>
	                        </div>
	                        <div id="menu2" class="tab-pane fade">
	                          <p>・ターンバックル式<br/>・Φ32のアルミ製バー<br/>・DIYで簡単に取り付け可能</p>
	                        </div>
	                      </div>
	                      <script>
	                ...
	                <table style="table-layout:fixed;" width="100%">
	                  ...
	                  <tr>
	                    ...
	                    <p class="search_category">**********【商品検索】**********&nbsp;&nbsp;<a class="change_button" href="../../sale/item/10571.php"><img src="../../img/sale_button.jpg" alt="単品販売の価格表はコチラ"></a></p>
	                  </tr>
	                </table>
	                  <?php
	                  	$root_dir = __DIR__.'/../../..';
