...
<meta content="text/html; charset=utf-8" http-equiv="Content-Type"><meta content="width=device-width, user-scalable=yes, initial-scale=1, maximum-scale=1" name="viewport"/><meta content="width=device-width" name="viewport"/><title>KTS-web 工賃セットメニュー LARGUS REAR ADJUSTER kit SUPER LOWDOWN</title><script type="application/ld+json">{@context: "http://schema.org",@type: "BreadcrumbList",itemListElement:[{@type: "ListItem",position: 1,item:{@id: "/shop_menu/",name: "SHOP MENU"}},{@type: "ListItem",position: 2,item:{@id: "/set/",name: "工賃セットメニュー"}},{@type: "ListItem",position: 3,item:{@id: "/item/10114.php",name: "REAR ADJUSTER kit SUPER LOWDOWN"}}]}</script><script src="https://ajax.googleapis.com/ajax/libs/jquery/3.1.1/jquery.min.js"></script>
<meta content="width=device-width, user-scalable=yes, initial-scale=1, maximum-scale=1" name="viewport"/>
<meta content="width=device-width" name="viewport"/>
<title>KTS-web 工賃セットメニュー LARGUS REAR ADJUSTER kit SUPER LOWDOWN</title>
	              ...
	              <div class="set_sale_back">
	                ...
	                <div class="set_menu_n row">
	                  <div class="set_menu_n_330 col-md-6 col-sm-12 col-xs-12">
	                    <div><img alt="REAR ADJUSTER kit SUPER LOWDOWN" src="../../brand/img/1156.gif"/></div>
	                  </div>
	                  <div class="set_menu_n_cell col-md-6 col-sm-12 col-xs-12">
	                    <div class="item_info_text_middle"><p>LARGUS[ラルグス]</p></div><div class="item_info_text_middle_b"><p>REAR ADJUSTER kit SUPER LOWDOWN[リアアジャスターキット スーパーローダウン]</p></div>
	                  </div>
	                </div>
	                <div class="set_menu_n row">
	                  <div class="set_menu_n_330 col-md-6 col-sm-12 col-xs-12">
	                    <div>
	                      <div class="swiper-container"><div class="swiper-wrapper"><div class="swiper-slide"><img alt="REAR ADJUSTER kit SUPER LOWDOWN" src="../../item_img/10114_1.jpg"/></div><div class="swiper-slide"><img alt="REAR ADJUSTER kit SUPER LOWDOWN" src="../../item_img/10114_2.jpg"/></div><div class="swiper-slide"><img alt="REAR ADJUSTER kit SUPER LOWDOWN" src="../../item_img/10114_3.jpg"/></div></div><div class="swiper-button-prev"></div><div class="swiper-button-next"></div></div>
	                    </div>
	                    ...
	                    <div class="tab_wrap">
	                      ...
	                      <div class="tab-content">
	                        ...
	                        <div id="menu2" class="tab-pane fade">
	                          <p>・無段階調整<br/>・ネジ式アジャスター<br/>・ボルトオンの車種別専用設計<br/>・多種多様な使用環境に耐える防錆塗装<br/>・テスト車両ヴェルファイア(AGH30W)でノーマル比-109mmのダウン量。</p>
	                        </div>
	                      </div>
	                      <script>
	                ...
	                <table style="table-layout:fixed;" width="100%">
	                  ...
	                  <tr>
	                    ...
	                    <p class="search_category">**********【商品検索】**********&nbsp;&nbsp;<a class="change_button" href="../../sale/item/10114.php"><img src="../../img/sale_button.jpg" alt="単品販売の価格表はコチラ"></a></p>
	                  </tr>
	                </table>
	                  <?php
	                  	$root_dir = __DIR__.'/../../..';
