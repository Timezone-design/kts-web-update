              ...
              <div class="set_sale_back">
                ...
                <div class="set_menu_n row">
                  <div class="set_menu_n_330 col-md-6 col-sm-12 col-xs-12">
                    <div><img alt="エグゾーストマニフォールド" src="../../brand/img/1042.gif"/></div>
                  </div>
                  <div class="set_menu_n_cell col-md-6 col-sm-12 col-xs-12">
                    <div class="item_info_text_middle"><p>AutoExe[オートエグゼ]</p></div><div class="item_info_text_middle_b"><p>エグゾーストマニフォールド</p></div>
                  </div>
                </div>
                <div class="set_menu_n row">
                  <div class="set_menu_n_330 col-md-6 col-sm-12 col-xs-12">
                    <div>
                      <div class="swiper-container"><div class="swiper-wrapper"><div class="swiper-slide"><img alt="エグゾーストマニフォールド" src="../../item_img/10777_1.jpg"/></div><div class="swiper-slide"><img alt="エグゾーストマニフォールド" src="../../item_img/10777_2.jpg"/></div><div class="swiper-slide"><img alt="エグゾーストマニフォールド" src="../../item_img/10777_3.jpg"/></div></div><div class="swiper-button-prev"></div><div class="swiper-button-next"></div></div>
                    </div>
                    ...
                    <div class="tab_wrap">
                      ...
                      <div class="tab-content">
                        <div id="home" class="tab-pane fade in active show">
                          <p>個々のエンジンの回転数やオーバーラップ特性を考慮し、集合部分までの距離を量産より長くすると共に等長化。さらには合流部の角度を狭めて高回転時に発生するブローダウン現象（排気逆流）を防止。また、１本部への結合部は放射形状とするなど排気流速を高め、エンジンの素性を伸ばす出力特性を獲得。総削り出しフランジ、バックシールド製法TIG溶接など職人技を駆使したステンレスの機能美も魅力。</p>
                        </div>
                        <div id="menu2" class="tab-pane fade">
                          <p>・完全等長レイアウト<br/>・ステンレス製<br/>・段付き修正済</p>
                        </div>
                      </div>
                      <script>
                ...
                <table style="table-layout:fixed;" width="100%">
                  ...
                  <tr>
                    ...
                    <p class="search_category">**********【商品検索】**********&nbsp;&nbsp;<a class="change_button" href="../../sale/item/10777.php"><img src="../../img/sale_button.jpg" alt="単品販売の価格表はコチラ"></a></p>
                  </tr>
                </table>
                  <?php
    							$root_dir = __DIR__.'/../../..';
