<html>
 <head>
  ...
  <title>
   KTS-web 工賃セットメニュー HKS LA CLUTCHシングルプレート
  </title>
  <script type="application/ld+json">
   {@context: "http://schema.org",@type: "BreadcrumbList",itemListElement:[{@type: "ListItem",position: 1,item:{@id: "/shop_menu/",name: "SHOP MENU"}},{@type: "ListItem",position: 2,item:{@id: "/set/",name: "工賃セットメニュー"}},{@type: "ListItem",position: 3,item:{@id: "/item/10495.php",name: "LA CLUTCHシングルプレート"}}]}
  </script>
...
<!-- <header class="site-header">
      ...
      <div class="main_c row grey-wrapper">
       <div class="mc_nav">
        ...
        &gt;
        <a class="link" href="../br/1032-124.html">
         HKS
        </a>
        &gt;
        <a class="link" href="10495.php">
         LA CLUTCHシングルプレート
        </a>
       </div>
       <div class="clearfix">
       ...
       <div class="set_sale_back">
        ...
        <div class="set_menu_n row">
         <div class="set_menu_n_330 col-md-6 col-sm-12 col-xs-12">
          <div>
           <img alt="LA CLUTCHシングルプレート" src="../../brand/img/1032.gif"/>
          </div>
         </div>
         <div class="set_menu_n_cell col-md-6 col-sm-12 col-xs-12">
          ...
          <div class="item_info_text_middle_b">
           <p>
            LA CLUTCHシングルプレート[LAクラッチシングルプレート]
           </p>
          </div>
         </div>
        </div>
           ...
           <div class="swiper-container">
            <div class="swiper-wrapper">
             <div class="swiper-slide">
              <img alt="LA CLUTCHシングルプレート" src="../../item_img/10495_1.jpg"/>
             </div>
             <div class="swiper-slide">
              <img alt="LA CLUTCHシングルプレート" src="../../item_img/10495_2.jpg"/>
             </div>
             <div class="swiper-slide">
              <img alt="LA CLUTCHシングルプレート" src="../../item_img/10495_3.jpg"/>
             </div>
            </div>
