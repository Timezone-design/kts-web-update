 <html>
<head>
<meta content="保安基準上、構造変更を必要としない～40mmを最大上げ幅に設定した『リフトアップブロックキット』です。車種により若干構造や付属品は違いますが基本はフロントストラットソーサー、キャンバー補正ボルト、リアスプリングソーサー、リアショック延長アダプターの4点で車高を上げますので取り付けが簡単で、純正ショック＆スプリングのストロークを活かし乗り心地変化が少ないのが特徴です。" name="description"/>
<meta content="text/html; charset=utf-8" http-equiv="Content-Type"/><meta content="width=device-width, user-scalable=yes, initial-scale=1, maximum-scale=1" name="viewport"><meta content="width=device-width" name="viewport"/><title>KTS-web 工賃セットメニュー OVER TECH MAX40 リフトアップブロックキット</title><script type="application/ld+json">{@context: "http://schema.org",@type: "BreadcrumbList",itemListElement:[{@type: "ListItem",position: 1,item:{@id: "/shop_menu/",name: "SHOP MENU"}},{@type: "ListItem",position: 2,item:{@id: "/set/",name: "工賃セットメニュー"}},{@type: "ListItem",position: 3,item:{@id: "/item/10130.php",name: "MAX40 リフトアップブロックキット"}}]}</script><script src="https://ajax.googleapis.com/ajax/libs/jquery/3.1.1/jquery.min.js"></script>
<meta content="width=device-width, user-scalable=yes, initial-scale=1, maximum-scale=1" name="viewport"/>
<meta content="width=device-width" name="viewport"/>
<title>KTS-web 工賃セットメニュー OVER TECH MAX40 リフトアップブロックキット</title>
...
<div><img alt="MAX40 リフトアップブロックキット" src="../../brand/img/1045.gif"/></div>
</div>
<div class="set_menu_n_cell col-md-6 col-sm-12 col-xs-12">
<div class="item_info_text_middle"><p>OVER TECH[オーバーテック]</p></div><div class="item_info_text_middle_b"><p>MAX40 リフトアップブロックキット[マックス40 リフトアップブロックキット]</p></div>
</div>
</div>
<div class="set_menu_n row">
<div class="set_menu_n_330 col-md-6 col-sm-12 col-xs-12">
<div>
<div class="swiper-container"><div class="swiper-wrapper"><div class="swiper-slide"><img alt="MAX40 リフトアップブロックキット" src="../../item_img/10130_1.jpg"/></div><div class="swiper-slide"><img alt="MAX40 リフトアップブロックキット" src="../../item_img/10130_2.jpg"/></div><div class="swiper-slide"><img alt="MAX40 リフトアップブロックキット" src="../../item_img/10130_3.jpg"/></div></div><div class="swiper-button-prev"></div><div class="swiper-button-next"></div></div>
</div>
<div class="item_caution"><p>※写真はイメージ・代表画像です。 </p><p>※実際の商品とカラーやイメージが異なる場合がございます。</p></div>
</div>
<div class="set_menu_n_cell col-md-6 col-sm-12 col-xs-12">
<a class="set-sale-switch" href="../../sale/item/10130.php">メニュー内容・物販へのリンク</a><div class="tab_wrap">
