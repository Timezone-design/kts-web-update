<html>
<head>
<meta name="description" content="メインスプリングの上側または下側に取付けてショックアブソーバーに組付けた時のスプリングの遊び防止及びリバンプ側ストロークの確保としての役割をします。ヘルパースプリングの密着荷重は低めに設定されており早めに密着する様になっています。">
...
<title>KTS-web 工賃セットメニュー Swift ヘルパースプリング</title>
...
<div class="mc_nav">
<a class="link" href="https://www.kts-web.com/">HOME</a> &gt; <a class="link" href="../../index.html">SHOP MENU</a> &gt; <a class="link" href="../index.html">工賃セットメニュー</a> &gt; <a class="link" href="../cat/100.html">足回り</a> &gt; <a class="link" href="../cat/116.html">車高調/セッティングパーツ</a> &gt; <a class="link" href="../br/1088-116.html">Swift</a> &gt; <a class="link" href="10228.php">ヘルパースプリング</a></div>
<div class="space3px"></div>
<div class="set_sale_back">
<div class="space3px"></div>
<div class="set_menu_n">
<div class="set_menu_n_330">
<div><img src="../../brand/img/1088.gif" alt="ヘルパースプリング"></div></div>
...
<div class="swiper-slide"><img src="../../item_img/10228_1.jpg" alt="ヘルパースプリング"></div>
<div class="swiper-slide"><img src="../../item_img/10228_2.jpg" alt="ヘルパースプリング"></div>
<div class="swiper-slide"><img src="../../item_img/10228_3.jpg" alt="ヘルパースプリング"></div>
</div>
...
<p>メインスプリングの上側または下側に取付けてショックアブソーバーに組付けた時のスプリングの遊び防止及びリバンプ側ストロークの確保としての役割をします。ヘルパースプリングの密着荷重は低めに設定されており早めに密着する様になっています。</p>
</div>
<div id="panel2" class="tab_panel">
<p>・ID(内径)：60/65/70(mm)<br>・自由長：60/70(mm)<br>・レート：0.8/1.5/3.0(Kgf/mm)</p>
</div>
</div>
</div>
</div>
...
<p class="search_category">**********【商品検索】**********&nbsp;&nbsp;<a class="change_button" href="../../sale/item/10228.php"><img src="../../img/sale_button.jpg" alt="単品販売の価格表はコチラ"></a></p>
</tr>
<tr>
<td>
<!-- スプリング検索ココから -->
<p class="search_category">【ID(内径)】</p>
<form method="post" action="10228.php">
...
if($data[0] == '10228') $position = explode(";", $data[1]);
}
array_pop($position);
fclose($fp_position);
...
<form name="make" method="post" action="10228.php">
