 <html>
<head>
<meta content="メインスプリングの上側または下側に取付けてショックアブソーバーに組付けた時のスプリングの遊び防止及びリバンプ側ストロークの確保としての役割をします。ヘルパースプリングの密着荷重は低めに設定されており早めに密着する様になっています。" name="description"/>
<meta content="text/html; charset=utf-8" http-equiv="Content-Type"/><meta content="width=device-width, user-scalable=yes, initial-scale=1, maximum-scale=1" name="viewport"><meta content="width=device-width" name="viewport"/><title>KTS-web 工賃セットメニュー Swift ヘルパースプリング</title><script type="application/ld+json">{@context: "http://schema.org",@type: "BreadcrumbList",itemListElement:[{@type: "ListItem",position: 1,item:{@id: "/shop_menu/",name: "SHOP MENU"}},{@type: "ListItem",position: 2,item:{@id: "/set/",name: "工賃セットメニュー"}},{@type: "ListItem",position: 3,item:{@id: "/item/10228.php",name: "ヘルパースプリング"}}]}</script><script src="https://ajax.googleapis.com/ajax/libs/jquery/3.1.1/jquery.min.js"></script>
...
<div><img alt="ヘルパースプリング" src="../../brand/img/1088.gif"/></div>
</div>
<div class="set_menu_n_cell col-md-6 col-sm-12 col-xs-12">
<div class="item_info_text_middle"><p>Swift[スイフト]</p></div><div class="item_info_text_middle_b"><p>ヘルパースプリング</p></div>
</div>
</div>
<div class="set_menu_n row">
<div class="set_menu_n_330 col-md-6 col-sm-12 col-xs-12">
<div>
<div class="swiper-container"><div class="swiper-wrapper"><div class="swiper-slide"><img alt="ヘルパースプリング" src="../../item_img/10228_1.jpg"/></div><div class="swiper-slide"><img alt="ヘルパースプリング" src="../../item_img/10228_2.jpg"/></div><div class="swiper-slide"><img alt="ヘルパースプリング" src="../../item_img/10228_3.jpg"/></div></div><div class="swiper-button-prev"></div><div class="swiper-button-next"></div></div>
</div>
<div class="item_caution"><p>※写真はイメージ・代表画像です。 </p><p>※実際の商品とカラーやイメージが異なる場合がございます。</p></div>
</div>
<div class="set_menu_n_cell col-md-6 col-sm-12 col-xs-12">
<a class="set-sale-switch" href="../../sale/item/10228.php">メニュー内容・物販へのリンク</a><div class="tab_wrap">
