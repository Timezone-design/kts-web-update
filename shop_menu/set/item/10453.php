	              ...
	              <div class="set_sale_back">
	                    ...
	                    <div class="tab_wrap">
	                      ...
	                      <div class="tab-content">
	                        <div id="home" class="tab-pane fade in active show">
	                          <p>type-RSは低イニシャルで作動。パワーロスを防ぎ、特にパワーのない車両でもタイムアップが可能です。<br/>異音（チャタリングと呼ばれるバキバキ音）の発生を低減します。<br/><br/>type-MZはLSD効果を引き出すイニシャルトルクの発生がtype-RSと異なり、外側からコーンプレートで行うタイプです。<br/>チューンドカーのハイパワーにも対応する耐久性を備えています。</p>
	                        </div>
	                        <div id="menu2" class="tab-pane fade">
	                          <p>・typeRS:低イニシャルで作動<br/>・typeMZ:ハイパワーに対応<br/>・specF:RSやMZの効き始めをマイルドにセッティング<br/>・コンパクト:コンパクトカー専用に開発<br/>・プロアジャスト:作動カム角を設定できるプロ仕様</p>
	                        </div>
	                      </div>
	                      <script>
	                ...
	                <table style="table-layout:fixed;" width="100%">
	                  ...
	                  <tr>
	                    ...
	                    <p class="search_category">**********【商品検索】**********&nbsp;&nbsp;<a class="change_button" href="../../sale/item/10453.php"><img src="../../img/sale_button.jpg" alt="単品販売の価格表はコチラ"></a></p>
	                  </tr>
	                </table>
	                  <?php
	                  	$root_dir = __DIR__.'/../../..';
