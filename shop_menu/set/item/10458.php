 <html>
<head>
<meta content="銅(銅線)とカーボンを、独自の特殊製法でモールドしたフェーシングを採用。実走行の温度変化に強く優れたコントロール性能を体感できます。従来のメタルディスク特有のジャダーを大幅に低減し、半クラの幅を増やすことで、スムーズな発進とクラッチ操作を可能。ダンパースプリングを採用し、音鳴りやディスク本体、ミッションへの負荷も低減。スポーツ走行に欠かせないギヤのつながり キレがいい強化クラッチカバー。セット荷重をバランスよく高めパワー伝達力を向上。" name="description"/>
<meta content="text/html; charset=utf-8" http-equiv="Content-Type"/><meta content="width=device-width, user-scalable=yes, initial-scale=1, maximum-scale=1" name="viewport"><meta content="width=device-width" name="viewport"/><title>KTS-web 工賃セットメニュー CUSCO カッパーシングルディスク</title><script type="application/ld+json">{@context: "http://schema.org",@type: "BreadcrumbList",itemListElement:[{@type: "ListItem",position: 1,item:{@id: "/shop_menu/",name: "SHOP MENU"}},{@type: "ListItem",position: 2,item:{@id: "/set/",name: "工賃セットメニュー"}},{@type: "ListItem",position: 3,item:{@id: "/item/10458.php",name: "カッパーシングルディスク"}}]}</script><script src="https://ajax.googleapis.com/ajax/libs/jquery/3.1.1/jquery.min.js"></script>
<meta content="width=device-width, user-scalable=yes, initial-scale=1, maximum-scale=1" name="viewport"/>
<meta content="width=device-width" name="viewport"/>
<title>KTS-web 工賃セットメニュー CUSCO カッパーシングルディスク</title>
...
<div><img alt="カッパーシングルディスク" src="../../brand/img/1059.gif"/></div>
</div>
<div class="set_menu_n_cell col-md-6 col-sm-12 col-xs-12">
<div class="item_info_text_middle"><p>CUSCO[クスコ]</p></div><div class="item_info_text_middle_b"><p>カッパーシングルディスク</p></div>
</div>
</div>
<div class="set_menu_n row">
<div class="set_menu_n_330 col-md-6 col-sm-12 col-xs-12">
<div>
<div class="swiper-container"><div class="swiper-wrapper"><div class="swiper-slide"><img alt="カッパーシングルディスク" src="../../item_img/10458_1.jpg"/></div><div class="swiper-slide"><img alt="カッパーシングルディスク" src="../../item_img/10458_2.jpg"/></div><div class="swiper-slide"><img alt="カッパーシングルディスク" src="../../item_img/10458_3.jpg"/></div></div><div class="swiper-button-prev"></div><div class="swiper-button-next"></div></div>
</div>
<div class="item_caution"><p>※写真はイメージ・代表画像です。 </p><p>※実際の商品とカラーやイメージが異なる場合がございます。</p></div>
</div>
<div class="set_menu_n_cell col-md-6 col-sm-12 col-xs-12">
<a class="set-sale-switch" href="../../sale/item/10458.php">メニュー内容・物販へのリンク</a><div class="tab_wrap">
