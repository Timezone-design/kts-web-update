              ...
              <div class="set_sale_back">
                    ...
                    <div class="tab_wrap">
                      ...
                      <div class="tab-content">
                        <div id="home" class="tab-pane fade in active show">
                          <p>銅(銅線)とカーボンを、独自の特殊製法でモールドしたフェーシングを採用。実走行の温度変化に強く優れたコントロール性能を体感できます。従来のメタルディスク特有のジャダーを大幅に低減し、半クラの幅を増やすことで、スムーズな発進とクラッチ操作を可能。ダンパースプリングを採用し、音鳴りやディスク本体、ミッションへの負荷も低減。スポーツ走行に欠かせないギヤのつながり キレがいい強化クラッチカバー。セット荷重をバランスよく高めパワー伝達力を向上。</p>
                        </div>
                        <div id="menu2" class="tab-pane fade">
                          <p>・許容出力:400ps前後(CUSCOクラッチカバー使用時)<br/>※車種により異なります<br/>・バースト強度:12500rpmをクリア<br/>・単体重量:純正品と同等</p>
                        </div>
                      </div>
                      <script>
                ...
                <table style="table-layout:fixed;" width="100%">
                  ...
                  <tr>
                    ...
                    <p class="search_category">**********【商品検索】**********&nbsp;&nbsp;<a class="change_button" href="../../sale/item/10458.php"><img src="../../img/sale_button.jpg" alt="単品販売の価格表はコチラ"></a></p>
                  </tr>
                </table>
                  <?php
    							$root_dir = __DIR__.'/../../..';
