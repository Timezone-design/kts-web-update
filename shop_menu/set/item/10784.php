              ...
              <div class="set_sale_back">
                ...
                <div class="set_menu_n row">
                  <div class="set_menu_n_330 col-md-6 col-sm-12 col-xs-12">
                    <div><img alt="ストリートブレーキローター" src="../../brand/img/1042.gif"/></div>
                  </div>
                  <div class="set_menu_n_cell col-md-6 col-sm-12 col-xs-12">
                    <div class="item_info_text_middle"><p>AutoExe[オートエグゼ]</p></div><div class="item_info_text_middle_b"><p>ストリートブレーキローター</p></div>
                  </div>
                </div>
                <div class="set_menu_n row">
                  <div class="set_menu_n_330 col-md-6 col-sm-12 col-xs-12">
                    <div>
                      <div class="swiper-container"><div class="swiper-wrapper"><div class="swiper-slide"><img alt="ストリートブレーキローター" src="../../item_img/10784_1.jpg"/></div><div class="swiper-slide"><img alt="ストリートブレーキローター" src="../../item_img/10784_2.jpg"/></div><div class="swiper-slide"><img alt="ストリートブレーキローター" src="../../item_img/10784_3.jpg"/></div></div><div class="swiper-button-prev"></div><div class="swiper-button-next"></div></div>
                    </div>
                    ...
                    <div class="tab_wrap">
                      ...
                      <div class="tab-content">
                        <div id="home" class="tab-pane fade in active show">
                          <p>量産同形状のスリット入り1ピースタイプ。<br/>量産品と同形状の１ピース構造FC鋳鉄製ながら、カーボンやシリコンなどの含有率をコントロール。加えて、綿密な熱処理加工を施すことで金属結合組織を安定化させ、熱による歪みを抑制し強度を高めている。耐フェード性を改善し、ブレーキング時の安定感を向上させる。製品は新旧マツダ車に幅広く適合し、リフレッシュユースにも最適。</p>
                        </div>
                        <div id="menu2" class="tab-pane fade">
                          <p>・左右2枚セット<br/>・スリット入り1ピース</p>
                        </div>
                      </div>
                      <script>
                ...
                <table style="table-layout:fixed;" width="100%">
                  ...
                  <tr>
                    ...
                    <p class="search_category">**********【商品検索】**********&nbsp;&nbsp;<a class="change_button" href="../../sale/item/10784.php"><img src="../../img/sale_button.jpg" alt="単品販売の価格表はコチラ"></a></p>
                  </tr>
                </table>
                  <?php
    							$root_dir = __DIR__.'/../../..';
