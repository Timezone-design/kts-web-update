 <html>
<head>
<meta content="レーシングギアは「街乗り」と「サーキット」両方の走行を楽しむためのダンパーを開発。街乗りとサーキットを両立することが出来るハイブリッドダンパー『HSダンパー』。単筒式・複筒式の二つのショック構造から車両特性に合わせ最適なショック構造を選び採用。" name="description"/>
<meta content="text/html; charset=utf-8" http-equiv="Content-Type"/><meta content="width=device-width, user-scalable=yes, initial-scale=1, maximum-scale=1" name="viewport"><meta content="width=device-width" name="viewport"/><title>KTS-web 商品ラインナップ RACING GEAR HS DAMPER</title><script type="application/ld+json">{@context: "http://schema.org",@type: "BreadcrumbList",itemListElement:[{@type: "ListItem",position: 1,item:{@id: "/shop_menu/",name: "SHOP MENU"}},{@type: "ListItem",position: 2,item:{@id: "/set/",name: "工賃セットメニュー"}},{@type: "ListItem",position: 3,item:{@id: "/item/10234.php",name: "HS DAMPER"}}]}</script><script src="https://ajax.googleapis.com/ajax/libs/jquery/3.1.1/jquery.min.js"></script>
...
<div><img alt="HS DAMPER" src="../../brand/img/1159.gif"/></div>
</div>
<div class="set_menu_n_cell col-md-6 col-sm-12 col-xs-12">
<div class="item_info_text_middle"><p>RACING GEAR[レーシングギア]</p></div><div class="item_info_text_middle_b"><p>商品名：HS DAMPER[HSダンパー]</p></div>
</div>
</div>
<div class="set_menu_n row">
<div class="set_menu_n_330 col-md-6 col-sm-12 col-xs-12">
<div>
<div class="swiper-container"><div class="swiper-wrapper"><div class="swiper-slide"><img alt="HS DAMPER" src="../../item_img/10234_1.jpg"/></div><div class="swiper-slide"><img alt="HS DAMPER" src="../../item_img/10234_2.jpg"/></div><div class="swiper-slide"><img alt="HS DAMPER" src="../../item_img/10234_3.jpg"/></div></div><div class="swiper-button-prev"></div><div class="swiper-button-next"></div></div>
</div>
<div class="item_caution"><p>※写真はイメージ・代表画像です。 </p><p>※実際の商品とカラーやイメージが異なる場合がございます。</p></div>
</div>
<div class="set_menu_n_cell col-md-6 col-sm-12 col-xs-12">
<a class="set-sale-switch" href="../../sale/item/10234.php">メニュー内容・物販へのリンク</a><div class="tab_wrap">
