<html>
 <head>
  ...
  <title>
   KTS-web 商品ラインナップ RACING GEAR HS DAMPER
  </title>
  <script type="application/ld+json">
   {@context: "http://schema.org",@type: "BreadcrumbList",itemListElement:[{@type: "ListItem",position: 1,item:{@id: "/shop_menu/",name: "SHOP MENU"}},{@type: "ListItem",position: 2,item:{@id: "/set/",name: "工賃セットメニュー"}},{@type: "ListItem",position: 3,item:{@id: "/item/10234.php",name: "HS DAMPER"}}]}
  </script>
     ...
     <div id="content-wrapper">
      ...
      <div class="main_c row grey-wrapper">
       <div class="mc_nav">
        ...
        &gt;
        <a class="link" href="../br/1159-116.html">
         RACING GEAR
        </a>
        &gt;
        <a class="link" href="10234.php">
         HS DAMPER
        </a>
       </div>
       <div class="clearfix">
       ...
       <div class="set_sale_back">
        ...
        <div class="set_menu_n row">
         <div class="set_menu_n_330 col-md-6 col-sm-12 col-xs-12">
          <div>
           <img alt="HS DAMPER" src="../../brand/img/1159.gif"/>
          </div>
         </div>
           ...
           <div class="swiper-container">
            <div class="swiper-wrapper">
             <div class="swiper-slide">
              <img alt="HS DAMPER" src="../../item_img/10234_1.jpg"/>
             </div>
             <div class="swiper-slide">
              <img alt="HS DAMPER" src="../../item_img/10234_2.jpg"/>
             </div>
             <div class="swiper-slide">
              <img alt="HS DAMPER" src="../../item_img/10234_3.jpg"/>
             </div>
            </div>
