 <html>
								<head>
								<meta content="「車高アップを可能にし、ワイルドな存在感をアピールできる車高調」を開発コンセプトとしてオンロード・オフロードを問わず安定した走りを実現するため専用設計。車高を上げ下げしてもしっかりストロークを確保しているので、お気に入りのフォルムで納得の走りを演出。あらゆるシチュエーションで機能性と見た目を兼ね備えた車高調です" name="description"/>
<meta content="text/html; charset=utf-8" http-equiv="Content-Type"><meta content="width=device-width, user-scalable=yes, initial-scale=1, maximum-scale=1" name="viewport"/><meta content="width=device-width" name="viewport"/><title>KTS-web 工賃セットメニュー RS★R Best☆i上下</title><script type="application/ld+json">{@context: "http://schema.org",@type: "BreadcrumbList",itemListElement:[{@type: "ListItem",position: 1,item:{@id: "/shop_menu/",name: "SHOP MENU"}},{@type: "ListItem",position: 2,item:{@id: "/set/",name: "工賃セットメニュー"}},{@type: "ListItem",position: 3,item:{@id: "/item/10143.php",name: "Best☆i上下"}}]}</script><script src="https://ajax.googleapis.com/ajax/libs/jquery/3.1.1/jquery.min.js"></script>
<meta content="width=device-width, user-scalable=yes, initial-scale=1, maximum-scale=1" name="viewport"/>
<meta content="width=device-width" name="viewport"/>
<title>KTS-web 工賃セットメニュー RS★R Best☆i上下</title>
	              ...
	              <div class="set_sale_back">
	                ...
	                <div class="set_menu_n row">
	                  <div class="set_menu_n_330 col-md-6 col-sm-12 col-xs-12">
	                    <div><img alt="Best☆i上下" src="../../brand/img/1001.gif"/></div>
	                  </div>
	                  <div class="set_menu_n_cell col-md-6 col-sm-12 col-xs-12">
	                    <div class="item_info_text_middle"><p>RS★R[アールエスアール]</p></div><div class="item_info_text_middle_b"><p>Best☆i上下[ベストアイ 上下]</p></div>
	                  </div>
	                </div>
	                <div class="set_menu_n row">
	                  <div class="set_menu_n_330 col-md-6 col-sm-12 col-xs-12">
	                    <div>
	                      <div class="swiper-container"><div class="swiper-wrapper"><div class="swiper-slide"><img alt="Best☆i上下" src="../../item_img/10143_1.jpg"/></div><div class="swiper-slide"><img alt="Best☆i上下" src="../../item_img/10143_2.jpg"/></div><div class="swiper-slide"><img alt="Best☆i上下" src="../../item_img/10143_3.jpg"/></div></div><div class="swiper-button-prev"></div><div class="swiper-button-next"></div></div>
	                    </div>
	                ...
	                <table style="table-layout:fixed;" width="100%">
	                  ...
	                  <tr>
	                    ...
	                    <p class="search_category">**********【商品検索】**********&nbsp;&nbsp;<a class="change_button" href="../../sale/item/10143.php"><img src="../../img/sale_button.jpg" alt="単品販売の価格表はコチラ"></a></p>
	                  </tr>
	                </table>
	                  <?php
	                  	$root_dir = __DIR__.'/../../..';
