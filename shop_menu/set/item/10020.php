	              ...
	              <div class="set_sale_back">
	                    ...
	                    <div class="tab_wrap">
	                      ...
	                      <div class="tab-content">
	                        ...
	                        <div id="menu2" class="tab-pane fade">
	                          <p>・新開発<br/>・全長調整式車高調整<br/>・単筒式大容量ショックアブソーバー<br/>・高性能ニードルバルブ式 減衰力24段調整<br/>・ラム式構造(ストラットタイプ)<br/>※アッパーマウント、スプリングはキットに含まれません。<br/>※JAF公認競技Nクラス向けに純正形状アッパーマウントに対応<br/>※ピロアッパーマウントにも対応</p>
	                        </div>
	                      </div>
	                      <script>
	                ...
	                <table style="table-layout:fixed;" width="100%">
	                  ...
	                  <tr>
	                    ...
	                    <p class="search_category">**********【商品検索】**********&nbsp;&nbsp;<a class="change_button" href="../../sale/item/10020.php"><img src="../../img/sale_button.jpg" alt="単品販売の価格表はコチラ"></a></p>
	                  </tr>
	                </table>
	                  <?php
	                  	$root_dir = __DIR__.'/../../..';
