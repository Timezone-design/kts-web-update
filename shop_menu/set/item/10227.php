...
<div class="mc_nav">
<a class="link" href="https://www.kts-web.com/">HOME</a> &gt; <a class="link" href="../../index.html">SHOP MENU</a> &gt; <a class="link" href="../index.html">工賃セットメニュー</a> &gt; <a class="link" href="../cat/100.html">足回り</a> &gt; <a class="link" href="../cat/116.html">車高調/セッティングパーツ</a> &gt; <a class="link" href="../br/1088-116.html">Swift</a> &gt; <a class="link" href="10227.php">アシストスプリング</a></div>
<div class="space3px"></div>
<div class="set_sale_back">
<div class="space3px"></div>
<div class="set_menu_n">
<div class="set_menu_n_330">
<div><img src="../../brand/img/1088.gif" alt="アシストスプリング"></div></div>
...
<div class="swiper-slide"><img src="../../item_img/10227_1.jpg" alt="アシストスプリング"></div>
<div class="swiper-slide"><img src="../../item_img/10227_2.jpg" alt="アシストスプリング"></div>
<div class="swiper-slide"><img src="../../item_img/10227_3.jpg" alt="アシストスプリング"></div>
</div>
...
<p>全日本ＧＴ選手権・スーパー耐久シリーズで活躍しているドライバー・エンジニアと共同開発。３種類のばね定数設定がありますが、セッティングを容易にするために、自由長及び密着長を同じ高さに設定されています。密着荷重はそれぞれ異なり、その密着荷重点の違いによりばね特性変化を持たせることによりセッティングの幅が広がります。</p>
</div>
<div id="panel2" class="tab_panel">
<p>・ID(内径)：60/65(mm)<br>・バネ定数：4.0/5.0/6.0[Kgf/mm]<br>・自由長及び密着長は共通</p>
</div>
</div>
</div>
</div>
...
<p class="search_category">**********【商品検索】**********&nbsp;&nbsp;<a class="change_button" href="../../sale/item/10227.php"><img src="../../img/sale_button.jpg" alt="単品販売の価格表はコチラ"></a></p>
</tr>
<tr>
<td>
<!-- スプリング検索ココから -->
<p class="search_category">【ID(内径)】</p>
<form method="post" action="10227.php">
...
if($data[0] == '10227') $position = explode(";", $data[1]);
}
array_pop($position);
fclose($fp_position);
...
<form name="make" method="post" action="10227.php">
