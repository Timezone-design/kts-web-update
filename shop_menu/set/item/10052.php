 <html>
<head>
<meta content="手軽にリフトアップ！”車検対応アップサス”&lt;br&gt;雪、雨、潮風、凍結防止剤などによるスプリングの錆を極力防ぐため、アップサスにはパーカー処理いわゆる「リン酸鉄被膜処理」加工後に紛体塗装する事で耐久性が向上！" name="description"/>
<meta content="text/html; charset=utf-8" http-equiv="Content-Type"/><meta content="width=device-width, user-scalable=yes, initial-scale=1, maximum-scale=1" name="viewport"><meta content="width=device-width" name="viewport"/><title>KTS-web 工賃セットメニュー FINAL KONNEXION EAGER LIFT UP SUS</title><script type="application/ld+json">{@context: "http://schema.org",@type: "BreadcrumbList",itemListElement:[{@type: "ListItem",position: 1,item:{@id: "/shop_menu/",name: "SHOP MENU"}},{@type: "ListItem",position: 2,item:{@id: "/set/",name: "工賃セットメニュー"}},{@type: "ListItem",position: 3,item:{@id: "/item/10052.php",name: "EAGER LIFT UP SUS"}}]}</script><script src="https://ajax.googleapis.com/ajax/libs/jquery/3.1.1/jquery.min.js"></script>
<meta content="width=device-width, user-scalable=yes, initial-scale=1, maximum-scale=1" name="viewport"/>
<meta content="width=device-width" name="viewport"/>
<title>KTS-web 工賃セットメニュー FINAL KONNEXION EAGER LIFT UP SUS</title>
...
<div><img alt="EAGER LIFT UP SUS" src="../../brand/img/1138.gif"/></div>
</div>
<div class="set_menu_n_cell col-md-6 col-sm-12 col-xs-12">
<div class="item_info_text_middle"><p>FINAL KONNEXION[ファイナルコネクション]</p></div><div class="item_info_text_middle_b"><p>EAGER LIFT UP SUS[イエーガーリフトアップサス]</p></div>
</div>
</div>
<div class="set_menu_n row">
<div class="set_menu_n_330 col-md-6 col-sm-12 col-xs-12">
<div>
<div class="swiper-container"><div class="swiper-wrapper"><div class="swiper-slide"><img alt="EAGER LIFT UP SUS" src="../../item_img/10052_1.jpg"/></div><div class="swiper-slide"><img alt="EAGER LIFT UP SUS" src="../../item_img/10052_2.jpg"/></div><div class="swiper-slide"><img alt="EAGER LIFT UP SUS" src="../../item_img/10052_3.jpg"/></div></div><div class="swiper-button-prev"></div><div class="swiper-button-next"></div></div>
</div>
<div class="item_caution"><p>※写真はイメージ・代表画像です。 </p><p>※実際の商品とカラーやイメージが異なる場合がございます。</p></div>
</div>
<div class="set_menu_n_cell col-md-6 col-sm-12 col-xs-12">
<a class="set-sale-switch" href="../../sale/item/10052.php">メニュー内容・物販へのリンク</a><div class="tab_wrap">
