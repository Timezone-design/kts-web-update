 <html>
<head>
<meta content="左右のストラットタワーを繋ぎ剛性を高めることで、アライメントの変化、ボディの捻じれ歪みを抑制します。&lt;br&gt;通常2点留めより更に剛性を高くする3点、4点留めのタワーバーもラインナップしています。取り付け部分とバーを一体型の1ピースにすることにより、より高い剛性となっています。" name="description"/>
<meta content="text/html; charset=utf-8" http-equiv="Content-Type"/><meta content="width=device-width, user-scalable=yes, initial-scale=1, maximum-scale=1" name="viewport"><meta content="width=device-width" name="viewport"/><title>KTS-web 工賃セットメニュー ULTRA RACING リアタワーバー</title><script type="application/ld+json">{@context: "http://schema.org",@type: "BreadcrumbList",itemListElement:[{@type: "ListItem",position: 1,item:{@id: "/shop_menu/",name: "SHOP MENU"}},{@type: "ListItem",position: 2,item:{@id: "/set/",name: "工賃セットメニュー"}},{@type: "ListItem",position: 3,item:{@id: "/item/10566.php",name: "リアタワーバー"}}]}</script><script src="https://ajax.googleapis.com/ajax/libs/jquery/3.1.1/jquery.min.js"></script>
<meta content="width=device-width, user-scalable=yes, initial-scale=1, maximum-scale=1" name="viewport"/>
<meta content="width=device-width" name="viewport"/>
<title>KTS-web 工賃セットメニュー ULTRA RACING リアタワーバー</title>
...
<div><img alt="リアタワーバー" src="../../brand/img/1019.gif"/></div>
</div>
<div class="set_menu_n_cell col-md-6 col-sm-12 col-xs-12">
<div class="item_info_text_middle"><p>ULTRA RACING[ウルトラレーシング]</p></div><div class="item_info_text_middle_b"><p>リアタワーバー</p></div>
</div>
</div>
<div class="set_menu_n row">
<div class="set_menu_n_330 col-md-6 col-sm-12 col-xs-12">
<div>
<div class="swiper-container"><div class="swiper-wrapper"><div class="swiper-slide"><img alt="リアタワーバー" src="../../item_img/10566_1.jpg"/></div><div class="swiper-slide"><img alt="リアタワーバー" src="../../item_img/10566_2.jpg"/></div><div class="swiper-slide"><img alt="リアタワーバー" src="../../item_img/10566_3.jpg"/></div></div><div class="swiper-button-prev"></div><div class="swiper-button-next"></div></div>
</div>
<div class="item_caution"><p>※写真はイメージ・代表画像です。 </p><p>※実際の商品とカラーやイメージが異なる場合がございます。</p></div>
</div>
<div class="set_menu_n_cell col-md-6 col-sm-12 col-xs-12">
<a class="set-sale-switch" href="../../sale/item/10566.php">メニュー内容・物販へのリンク</a><div class="tab_wrap">
