	              ...
	              <div class="set_sale_back">
	                    ...
	                    <div class="tab_wrap">
	                      ...
	                      <div class="tab-content">
	                        <div id="home" class="tab-pane fade in active show">
	                          <p>左右のストラットタワーを繋ぎ剛性を高めることで、アライメントの変化、ボディの捻じれ歪みを抑制します。<br/>通常2点留めより更に剛性を高くする3点、4点留めのタワーバーもラインナップしています。取り付け部分とバーを一体型の1ピースにすることにより、より高い剛性となっています。</p>
	                        </div>
	                ...
	                <table style="table-layout:fixed;" width="100%">
	                  ...
	                  <tr>
	                    ...
	                    <p class="search_category">**********【商品検索】**********&nbsp;&nbsp;<a class="change_button" href="../../sale/item/10566.php"><img src="../../img/sale_button.jpg" alt="単品販売の価格表はコチラ"></a></p>
	                  </tr>
	                </table>
	                  <?php
	                  	$root_dir = __DIR__.'/../../..';
