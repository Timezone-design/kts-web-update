<html>
<head>
<meta name="description" content="サーキットアタックに効果的な機能を厳選搭載。フラッグシップのDNAを持つ車高調。MONO RACINGはサーキット走行の頻度の高いユーザー向けに開発。ハイエンドモデル「SUPER RACING」のセッティングをベースに、各種モータースポーツサポートで培った豊富なデータから、スポーツ走行に適した基本スプリングレートの設定や減衰力チューニング。">
...
<title>KTS-web 工賃セットメニュー TEIN MONO RACING</title>
...
<div class="mc_nav">
<a class="link" href="https://www.kts-web.com/">HOME</a> &gt; <a class="link" href="../../index.html">SHOP MENU</a> &gt; <a class="link" href="../index.html">工賃セットメニュー</a> &gt; <a class="link" href="../cat/100.html">足回り</a> &gt; <a class="link" href="../cat/116.html">車高調/セッティングパーツ</a> &gt; <a class="link" href="../br/1104-116.html">TEIN</a> &gt; <a class="link" href="10195.php">MONO RACING</a></div>
<div class="space3px"></div>
<div class="set_sale_back">
<div class="space3px"></div>
<div class="set_menu_n">
<div class="set_menu_n_330">
<div><img src="../../brand/img/1104.gif" alt="MONO RACING"></div></div>
<div class="set_menu_n_cell">
<div class="item_info_text_middle">
<p>TEIN[テイン]</p></div>
<div class="item_info_text_middle_b">
<p>MONO RACING[モノレーシング]</p></div>
</div></div>
...
<div class="swiper-slide"><img src="../../item_img/10195_1.jpg" alt="MONO RACING"></div>
<div class="swiper-slide"><img src="../../item_img/10195_2.jpg" alt="MONO RACING"></div>
<div class="swiper-slide"><img src="../../item_img/10195_3.jpg" alt="MONO RACING"></div>
</div>
...
<p>サーキットアタックに効果的な機能を厳選搭載。フラッグシップのDNAを持つ車高調。MONO RACINGはサーキット走行の頻度の高いユーザー向けに開発。ハイエンドモデル「SUPER RACING」のセッティングをベースに、各種モータースポーツサポートで培った豊富なデータから、スポーツ走行に適した基本スプリングレートの設定や減衰力チューニング。</p>
</div>
<div id="panel2" class="tab_panel">
<p>・全長調整式<br>・減衰調整式<br>・単筒式<br>・スポーツ走行に特化<br>・キャンバー・キャスター調整式ピロボールアッパーマウント<br>・キャンバー調整式ロアブラケット<br>・スプリングレート無償交換システム<br>・ダンピングフォースカスタマイズシステム<br>・ADVANVE M.S.V.<br>・3年6万キロ&固着保証<br>・防錆コーティング</p>
</div>
</div>
</div>
</div>
...
<p class="search_category">**********【適合検索】**********&nbsp;&nbsp;<a class="change_button" href="../../sale/item/10195.php"><img src="../../img/sale_button.jpg" alt="単品販売の価格表はコチラ"></a></p>
</tr>
<tr>
<td>
<!-- 車両メーカー検索ココから -->
<p class="search_category">【自動車メーカー】</p>
<form method="post" action="10195.php">
...
if($data[0] == '10195') $position = explode(";", $data[1]);
}
array_pop($position);
fclose($fp_position);
...
<form name="make" method="post" action="10195.php">
