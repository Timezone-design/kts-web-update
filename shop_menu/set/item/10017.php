 <html>
<head>
<meta content="SPORT Rの設計思想・スペックをそのままに、より多くのユーザーを対象とするストリート向けに減衰力・バネレート・ストロークをセッティング。&lt;br&gt;スポーツラジアルタイヤでのスポーツ走行をターゲットとしたセットアップ。&lt;br&gt;ストリートでの使用を考慮し（音、乗り心地など）リヤアッパーマウントには強化ゴムアッパーマウントを採用(ウイッシュボーン車は前後共に採用)。&lt;br&gt;大きな入力にもしっかり対応する為、大口径ピストンを使用し安定した減衰力を発生します。" name="description"/>
<meta content="text/html; charset=utf-8" http-equiv="Content-Type"/><meta content="width=device-width, user-scalable=yes, initial-scale=1, maximum-scale=1" name="viewport"><meta content="width=device-width" name="viewport"/><title>KTS-web 工賃セットメニュー CUSCO SPORT S</title><script type="application/ld+json">{@context: "http://schema.org",@type: "BreadcrumbList",itemListElement:[{@type: "ListItem",position: 1,item:{@id: "/shop_menu/",name: "SHOP MENU"}},{@type: "ListItem",position: 2,item:{@id: "/set/",name: "工賃セットメニュー"}},{@type: "ListItem",position: 3,item:{@id: "/item/10017.php",name: "SPORT S"}}]}</script><script src="https://ajax.googleapis.com/ajax/libs/jquery/3.1.1/jquery.min.js"></script>
...
<div><img alt="SPORT S" src="../../brand/img/1059.gif"/></div>
</div>
<div class="set_menu_n_cell col-md-6 col-sm-12 col-xs-12">
<div class="item_info_text_middle"><p>CUSCO[クスコ]</p></div><div class="item_info_text_middle_b"><p>SPORT S[スポーツS]</p></div>
</div>
</div>
<div class="set_menu_n row">
<div class="set_menu_n_330 col-md-6 col-sm-12 col-xs-12">
<div>
<div class="swiper-container"><div class="swiper-wrapper"><div class="swiper-slide"><img alt="SPORT S" src="../../item_img/10017_1.jpg"/></div><div class="swiper-slide"><img alt="SPORT S" src="../../item_img/10017_2.jpg"/></div><div class="swiper-slide"><img alt="SPORT S" src="../../item_img/10017_3.jpg"/></div></div><div class="swiper-button-prev"></div><div class="swiper-button-next"></div></div>
</div>
<div class="item_caution"><p>※写真はイメージ・代表画像です。 </p><p>※実際の商品とカラーやイメージが異なる場合がございます。</p></div>
</div>
<div class="set_menu_n_cell col-md-6 col-sm-12 col-xs-12">
<a class="set-sale-switch" href="../../sale/item/10017.php">メニュー内容・物販へのリンク</a><div class="tab_wrap">
