<html>
 <head>
  ...
  <title>
   KTS-web 工賃セットメニュー KONI SPORT KIT 1140
  </title>
  <script type="application/ld+json">
   {@context: "http://schema.org",@type: "BreadcrumbList",itemListElement:[{@type: "ListItem",position: 1,item:{@id: "/shop_menu/",name: "SHOP MENU"}},{@type: "ListItem",position: 2,item:{@id: "/set/",name: "工賃セットメニュー"}},{@type: "ListItem",position: 3,item:{@id: "/item/10100.php",name: "SPORT KIT 1140"}}]}
  </script>
...
<!-- <header class="site-header">
      ...
      <div class="main_c row grey-wrapper">
       <div class="mc_nav">
        ...
        &gt;
        <a class="link" href="../br/1164-119.html">
         KONI
        </a>
        &gt;
        <a class="link" href="10100.php">
         SPORT KIT 1140
        </a>
       </div>
       <div class="clearfix">
       ...
       <div class="set_sale_back">
        ...
        <div class="set_menu_n row">
         <div class="set_menu_n_330 col-md-6 col-sm-12 col-xs-12">
          <div>
           <img alt="SPORT KIT 1140" src="../../brand/img/1164.gif"/>
          </div>
         </div>
           ...
           <div class="swiper-container">
            <div class="swiper-wrapper">
             <div class="swiper-slide">
              <img alt="SPORT KIT 1140" src="../../item_img/10100_1.jpg"/>
             </div>
             <div class="swiper-slide">
              <img alt="SPORT KIT 1140" src="../../item_img/10100_2.jpg"/>
             </div>
             <div class="swiper-slide">
              <img alt="SPORT KIT 1140" src="../../item_img/10100_3.jpg"/>
             </div>
            </div>
