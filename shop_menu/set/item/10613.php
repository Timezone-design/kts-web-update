<html>
 <head>
  ...
  <title>
   KTS-web 工賃セットメニュー HKS S660 GT100R Package
  </title>
  <script type="application/ld+json">
   {@context: "http://schema.org",@type: "BreadcrumbList",itemListElement:[{@type: "ListItem",position: 1,item:{@id: "/shop_menu/",name: "SHOP MENU"}},{@type: "ListItem",position: 2,item:{@id: "/set/",name: "工賃セットメニュー"}},{@type: "ListItem",position: 3,item:{@id: "/item/10613.php",name: "S660 GT100R Package"}}]}
  </script>
...
<!-- <header class="site-header">
      ...
      <div class="main_c row grey-wrapper">
       <div class="mc_nav">
        ...
        &gt;
        <a class="link" href="../cat/149.html">
         タービンキット
        </a>
        &gt;
        <a class="link" href="../br/1032-149.html">
         HKS
        </a>
        &gt;
        <a class="link" href="10613.php">
         S660 GT100R Package
        </a>
       </div>
       <div class="clearfix">
       ...
       <div class="set_sale_back">
        ...
        <div class="set_menu_n row">
         <div class="set_menu_n_330 col-md-6 col-sm-12 col-xs-12">
          <div>
           <img alt="S660 GT100R Package" src="../../brand/img/1032.gif"/>
          </div>
         </div>
         <div class="set_menu_n_cell col-md-6 col-sm-12 col-xs-12">
          ...
          <div class="item_info_text_middle_b">
           <p>
            S660 GT100R Package[GT100Rパッケージ]
           </p>
          </div>
         </div>
        </div>
           ...
           <div class="swiper-container">
            <div class="swiper-wrapper">
             <div class="swiper-slide">
              <img alt="S660 GT100R Package" src="../../item_img/10613_1.jpg"/>
             </div>
             <div class="swiper-slide">
              <img alt="S660 GT100R Package" src="../../item_img/10613_2.jpg"/>
             </div>
             <div class="swiper-slide">
              <img alt="S660 GT100R Package" src="../../item_img/10613_3.jpg"/>
             </div>
            </div>
         ...
         <details>
          <summary>
           <div class="change_button">
            <img alt="Flash Editor取付＆設定" src="../../img/option_button.jpg"/>
           </div>
          </summary>
          ...
          <div class="set_menu_n">
           <div class="set_menu_n_200">
            <img alt="Flash Editor" src="../img/hks_flash_editor.jpg"/>
           </div>
           <div class="set_menu_n_cell">
            <div class="option_menu_text">
             <div>
              スピードリミッター解除のエントリーユーザーから、ハイレベルなプロチューナーまで使用可能。
              <br/>
              車輌の故障診断コネクタ（OBD2コネクタ）より、ECU ReFlashを行うことができるセッティングツールです。
             </div>
            </div>
