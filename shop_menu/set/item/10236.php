 <html>
								<head>
								<meta content="ショックオイルを抜き取り、専用のチューニングオイルを注入することでパフォーマンスを向上させる『ネオチューン』。本来はオーバーホール目的で中古の純正品に施工することが多いですが、それを新品のKYB製純正互換品に施工することで、もう一つ上の性能を提供します。" name="description"/>
<meta content="text/html; charset=utf-8" http-equiv="Content-Type"><meta content="width=device-width, user-scalable=yes, initial-scale=1, maximum-scale=1" name="viewport"/><meta content="width=device-width" name="viewport"/><title>KTS-web 工賃セットメニュー NEO TUNE KYB補修用ショック+ネオチューン施工</title><script type="application/ld+json">{@context: "http://schema.org",@type: "BreadcrumbList",itemListElement:[{@type: "ListItem",position: 1,item:{@id: "/shop_menu/",name: "SHOP MENU"}},{@type: "ListItem",position: 2,item:{@id: "/set/",name: "工賃セットメニュー"}},{@type: "ListItem",position: 3,item:{@id: "/item/10236.php",name: "KYB補修用ショック+ネオチューン施工"}}]}</script><script src="https://ajax.googleapis.com/ajax/libs/jquery/3.1.1/jquery.min.js"></script>
<meta content="width=device-width, user-scalable=yes, initial-scale=1, maximum-scale=1" name="viewport"/>
<meta content="width=device-width" name="viewport"/>
<title>KTS-web 工賃セットメニュー NEO TUNE KYB補修用ショック+ネオチューン施工</title>
	              ...
	              <div class="set_sale_back">
	                ...
	                <div class="set_menu_n row">
	                  <div class="set_menu_n_330 col-md-6 col-sm-12 col-xs-12">
	                    <div><img alt="KYB補修用ショック+ネオチューン施工" src="../../brand/img/1165.gif"/></div>
	                  </div>
	                  <div class="set_menu_n_cell col-md-6 col-sm-12 col-xs-12">
	                    <div class="item_info_text_middle"><p>NEO TUNE[ネオチューン]</p></div><div class="item_info_text_middle_b"><p>KYB補修用ショック+ネオチューン施工</p></div>
	                  </div>
	                </div>
	                <div class="set_menu_n row">
	                  <div class="set_menu_n_330 col-md-6 col-sm-12 col-xs-12">
	                    <div>
	                      <div class="swiper-container"><div class="swiper-wrapper"><div class="swiper-slide"><img alt="KYB補修用ショック+ネオチューン施工" src="../../item_img/10236_1.jpg"/></div><div class="swiper-slide"><img alt="KYB補修用ショック+ネオチューン施工" src="../../item_img/10236_2.jpg"/></div><div class="swiper-slide"><img alt="KYB補修用ショック+ネオチューン施工" src="../../item_img/10236_3.jpg"/></div></div><div class="swiper-button-prev"></div><div class="swiper-button-next"></div></div>
	                    </div>
	                ...
	                <table style="table-layout:fixed;" width="100%">
	                  ...
	                  <tr>
	                    ...
	                    <p class="search_category">**********【商品検索】**********&nbsp;&nbsp;<a class="change_button" href="../../sale/item/10236.php"><img src="../../img/sale_button.jpg" alt="単品販売の価格表はコチラ"></a></p>
	                  </tr>
	                </table>
	                  <?php
	                  	$root_dir = __DIR__.'/../../..';
