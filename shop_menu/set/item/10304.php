	              ...
	              <div class="set_sale_back">
	                    ...
	                    <div class="tab_wrap">
	                      ...
	                      <div class="tab-content">
	                        <div id="home" class="tab-pane fade in active show">
	                          <p>NEW TYPE-RはTYPE-Rを摩擦材や生産方法を見直して性能はそのままに、価格を抑えることに成功しました。高温域でのフィーリング変化が少なく、安定した制動を得られます。踏力に応じたダイレクトな制動感を得ることが可能です。ブレーキで車両を意のままに操るペダルコントロール性を重視したスポーツはユーザーに大変おススメです。</p>
	                        </div>
	                        <div id="menu2" class="tab-pane fade">
	                          <p>・ローター適正温度域：50～650℃<br/>・平均摩擦係数：0.30～0.35<br/>・材質：ロースチール<br/>・フィールド：ワインディング-サーキット<br/>・タイヤ：ラジアル-ハイグリップラジアル</p>
	                        </div>
	                      </div>
	                      <script>
	                ...
	                <table style="table-layout:fixed;" width="100%">
	                  ...
	                  <tr>
	                    ...
	                    <p class="search_category">**********【商品検索】**********&nbsp;&nbsp;<a class="change_button" href="../../sale/item/10304.php"><img src="../../img/sale_button.jpg" alt="単品販売の価格表はコチラ"></a></p>
	                  </tr>
	                </table>
	                  <?php
	                  	$root_dir = __DIR__.'/../../..';
