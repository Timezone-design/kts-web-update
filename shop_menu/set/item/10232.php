 <html>
<head>
<meta content="のスプリング形状がテーパー状（円錐形状）になっており、下部内径はφ70に、上部内径はφ90、φ100の2種類設定してあります。これらは、純正サスペンション形式のダブルウィッシュボーン、マル チリンク化によって、一体化された純正アッパーマウントに対応するように開発された、汎用スプリングです。" name="description"/>
<meta content="text/html; charset=utf-8" http-equiv="Content-Type"/><meta content="width=device-width, user-scalable=yes, initial-scale=1, maximum-scale=1" name="viewport"><meta content="width=device-width" name="viewport"/><title>KTS-web 工賃セットメニュー TEIN テーパータイプ 規格汎用スプリング</title><script type="application/ld+json">{@context: "http://schema.org",@type: "BreadcrumbList",itemListElement:[{@type: "ListItem",position: 1,item:{@id: "/shop_menu/",name: "SHOP MENU"}},{@type: "ListItem",position: 2,item:{@id: "/set/",name: "工賃セットメニュー"}},{@type: "ListItem",position: 3,item:{@id: "/item/10232.php",name: "テーパータイプ 規格汎用スプリング"}}]}</script><script src="https://ajax.googleapis.com/ajax/libs/jquery/3.1.1/jquery.min.js"></script>
<meta content="width=device-width, user-scalable=yes, initial-scale=1, maximum-scale=1" name="viewport"/>
<meta content="width=device-width" name="viewport"/>
<title>KTS-web 工賃セットメニュー TEIN テーパータイプ 規格汎用スプリング</title>
...
<div><img alt="テーパータイプ 規格汎用スプリング" src="../../brand/img/1104.gif"/></div>
</div>
<div class="set_menu_n_cell col-md-6 col-sm-12 col-xs-12">
<div class="item_info_text_middle"><p>TEIN[テイン]</p></div><div class="item_info_text_middle_b"><p>テーパータイプ 規格汎用スプリング</p></div>
</div>
</div>
<div class="set_menu_n row">
<div class="set_menu_n_330 col-md-6 col-sm-12 col-xs-12">
<div>
<div class="swiper-container"><div class="swiper-wrapper"><div class="swiper-slide"><img alt="テーパータイプ 規格汎用スプリング" src="../../item_img/10232_1.jpg"/></div><div class="swiper-slide"><img alt="テーパータイプ 規格汎用スプリング" src="../../item_img/10232_2.jpg"/></div><div class="swiper-slide"><img alt="テーパータイプ 規格汎用スプリング" src="../../item_img/10232_3.jpg"/></div></div><div class="swiper-button-prev"></div><div class="swiper-button-next"></div></div>
</div>
<div class="item_caution"><p>※写真はイメージ・代表画像です。 </p><p>※実際の商品とカラーやイメージが異なる場合がございます。</p></div>
</div>
<div class="set_menu_n_cell col-md-6 col-sm-12 col-xs-12">
<a class="set-sale-switch" href="../../sale/item/10232.php">メニュー内容・物販へのリンク</a><div class="tab_wrap">
