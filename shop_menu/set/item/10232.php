...
<div class="mc_nav">
<a class="link" href="https://www.kts-web.com/">HOME</a> &gt; <a class="link" href="../../index.html">SHOP MENU</a> &gt; <a class="link" href="../index.html">工賃セットメニュー</a> &gt; <a class="link" href="../cat/100.html">足回り</a> &gt; <a class="link" href="../cat/116.html">車高調/セッティングパーツ</a> &gt; <a class="link" href="../br/1104-116.html">TEIN</a> &gt; <a class="link" href="10232.php">テーパータイプ 規格汎用スプリング</a></div>
<div class="space3px"></div>
<div class="set_sale_back">
<div class="space3px"></div>
<div class="set_menu_n">
<div class="set_menu_n_330">
<div><img src="../../brand/img/1104.gif" alt="テーパータイプ 規格汎用スプリング"></div></div>
<div class="set_menu_n_cell">
<div class="item_info_text_middle">
<p>TEIN[テイン]</p></div>
<div class="item_info_text_middle_b">
<p>テーパータイプ 規格汎用スプリング</p></div>
</div></div>
...
<div class="swiper-slide"><img src="../../item_img/10232_1.jpg" alt="テーパータイプ 規格汎用スプリング"></div>
<div class="swiper-slide"><img src="../../item_img/10232_2.jpg" alt="テーパータイプ 規格汎用スプリング"></div>
<div class="swiper-slide"><img src="../../item_img/10232_3.jpg" alt="テーパータイプ 規格汎用スプリング"></div>
</div>
...
<p>のスプリング形状がテーパー状（円錐形状）になっており、下部内径はφ70に、上部内径はφ90、φ100の2種類設定してあります。これらは、純正サスペンション形式のダブルウィッシュボーン、マル チリンク化によって、一体化された純正アッパーマウントに対応するように開発された、汎用スプリングです。</p>
</div>
<div id="panel2" class="tab_panel">
<p>・下部内径：φ70<br>上部内径：φ90/φ100<br>・両端研削</p>
</div>
</div>
</div>
</div>
...
<p class="search_category">**********【商品検索】**********&nbsp;&nbsp;<a class="change_button" href="../../sale/item/10232.php"><img src="../../img/sale_button.jpg" alt="単品販売の価格表はコチラ"></a></p>
</tr>
<tr>
<td>
<!-- スプリング検索ココから -->
<p class="search_category">【ID(内径)】</p>
<form method="post" action="10232.php">
...
if($data[0] == '10232') $position = explode(";", $data[1]);
}
array_pop($position);
fclose($fp_position);
...
<form name="make" method="post" action="10232.php">
