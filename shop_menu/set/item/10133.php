 <html>
<head>
<meta content="減衰力固定でありながら快適性を追求したセッティング。Best☆ⅰを基準として、シンプルな機構(機能)でリーズナブルな仕様となっています。きっちり車高を落としてもしっかりストロークを確保して乗り心地を損なわない、全長調整式・単筒式を採用。 また異音に対しても徹底的に対策し、あらゆる面で快適さを追求しています。乗り心地を追求したセッティングを維持し、安定した走りで疲れを感じさせない引き締まった走りをお約束します。" name="description"/>
<meta content="text/html; charset=utf-8" http-equiv="Content-Type"/><meta content="width=device-width, user-scalable=yes, initial-scale=1, maximum-scale=1" name="viewport"><meta content="width=device-width" name="viewport"/><title>KTS-web 工賃セットメニュー RS★R Basic☆i</title><script type="application/ld+json">{@context: "http://schema.org",@type: "BreadcrumbList",itemListElement:[{@type: "ListItem",position: 1,item:{@id: "/shop_menu/",name: "SHOP MENU"}},{@type: "ListItem",position: 2,item:{@id: "/set/",name: "工賃セットメニュー"}},{@type: "ListItem",position: 3,item:{@id: "/item/10133.php",name: "Basic☆i"}}]}</script><script src="https://ajax.googleapis.com/ajax/libs/jquery/3.1.1/jquery.min.js"></script>
<meta content="width=device-width, user-scalable=yes, initial-scale=1, maximum-scale=1" name="viewport"/>
<meta content="width=device-width" name="viewport"/>
<title>KTS-web 工賃セットメニュー RS★R Basic☆i</title>
...
<div><img alt="Basic☆i" src="../../brand/img/1001.gif"/></div>
</div>
<div class="set_menu_n_cell col-md-6 col-sm-12 col-xs-12">
<div class="item_info_text_middle"><p>RS★R[アールエスアール]</p></div><div class="item_info_text_middle_b"><p>Basic☆i[ベーシックアイ]</p></div>
</div>
</div>
<div class="set_menu_n row">
<div class="set_menu_n_330 col-md-6 col-sm-12 col-xs-12">
<div>
<div class="swiper-container"><div class="swiper-wrapper"><div class="swiper-slide"><img alt="Basic☆i" src="../../item_img/10133_1.jpg"/></div><div class="swiper-slide"><img alt="Basic☆i" src="../../item_img/10133_2.jpg"/></div><div class="swiper-slide"><img alt="Basic☆i" src="../../item_img/10133_3.jpg"/></div></div><div class="swiper-button-prev"></div><div class="swiper-button-next"></div></div>
</div>
<div class="item_caution"><p>※写真はイメージ・代表画像です。 </p><p>※実際の商品とカラーやイメージが異なる場合がございます。</p></div>
</div>
<div class="set_menu_n_cell col-md-6 col-sm-12 col-xs-12">
<a class="set-sale-switch" href="../../sale/item/10133.php">メニュー内容・物販へのリンク</a><div class="tab_wrap">
