              ...
              <div class="set_sale_back">
                ...
                <div class="set_menu_n row">
                  <div class="set_menu_n_330 col-md-6 col-sm-12 col-xs-12">
                    <div><img alt="ラムエアインテークシステム" src="../../brand/img/1042.gif"/></div>
                  </div>
                  <div class="set_menu_n_cell col-md-6 col-sm-12 col-xs-12">
                    <div class="item_info_text_middle"><p>AutoExe[オートエグゼ]</p></div><div class="item_info_text_middle_b"><p>ラムエアインテークシステム</p></div>
                  </div>
                </div>
                <div class="set_menu_n row">
                  <div class="set_menu_n_330 col-md-6 col-sm-12 col-xs-12">
                    <div>
                      <div class="swiper-container"><div class="swiper-wrapper"><div class="swiper-slide"><img alt="ラムエアインテークシステム" src="../../item_img/10800_1.jpg"/></div><div class="swiper-slide"><img alt="ラムエアインテークシステム" src="../../item_img/10800_2.jpg"/></div><div class="swiper-slide"><img alt="ラムエアインテークシステム" src="../../item_img/10800_3.jpg"/></div></div><div class="swiper-button-prev"></div><div class="swiper-button-next"></div></div>
                    </div>
                    ...
                    <div class="tab_wrap">
                      ...
                      <div class="tab-content">
                        <div id="home" class="tab-pane fade in active show">
                          <p>走行風による過給＝ラム圧で空気を押し込む発想で誕生。車速にもよるので、現実に正圧がかかることは稀だが、エンジンの放射熱の影響を受けない酸素密度の高い空気を効率よく取り入れられる効果は大きい。量産ECUのA/F(Air/Fuel空燃比)補正マージン内で、吸入空気量を増やすことにより、燃料の噴射を促して、パワーとトルクの向上を狙った仕様。</p>
                        </div>
                        <div id="menu2" class="tab-pane fade">
                          <p>・本体：カーボン製＋専用K＆N製湿式フィルター<br/>・メインテナンスキット付属</p>
                        </div>
                      </div>
                      <script>
                ...
                <table style="table-layout:fixed;" width="100%">
                  ...
                  <tr>
                    ...
                    <p class="search_category">**********【商品検索】**********&nbsp;&nbsp;<a class="change_button" href="../../sale/item/10800.php"><img src="../../img/sale_button.jpg" alt="単品販売の価格表はコチラ"></a></p>
                  </tr>
                </table>
                  <?php
    							$root_dir = __DIR__.'/../../..';
