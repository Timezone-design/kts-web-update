<html>
 <head>
  ...
  <title>
   KTS-web 工賃セットメニュー Do-Luck FLOOR SUPPORT BAR
  </title>
  <script type="application/ld+json">
   {@context: "http://schema.org",@type: "BreadcrumbList",itemListElement:[{@type: "ListItem",position: 1,item:{@id: "/shop_menu/",name: "SHOP MENU"}},{@type: "ListItem",position: 2,item:{@id: "/set/",name: "工賃セットメニュー"}},{@type: "ListItem",position: 3,item:{@id: "/item/10284.php",name: "FLOOR SUPPORT BAR"}}]}
  </script>
     ...
     <div id="content-wrapper">
      ...
      <div class="main_c row grey-wrapper">
       <div class="mc_nav">
        ...
        &gt;
        <a class="link" href="../br/1110-134.html">
         Do-Luck
        </a>
        &gt;
        <a class="link" href="10284.php">
         FLOOR SUPPORT BAR
        </a>
       </div>
       <div class="clearfix">
       ...
       <div class="set_sale_back">
        ...
        <div class="set_menu_n row">
         <div class="set_menu_n_330 col-md-6 col-sm-12 col-xs-12">
          <div>
           <img alt="FLOOR SUPPORT BAR" src="../../brand/img/1110.gif"/>
          </div>
         </div>
           ...
           <div class="swiper-container">
            <div class="swiper-wrapper">
             <div class="swiper-slide">
              <img alt="FLOOR SUPPORT BAR" src="../../item_img/10284_1.jpg"/>
             </div>
             <div class="swiper-slide">
              <img alt="FLOOR SUPPORT BAR" src="../../item_img/10284_2.jpg"/>
             </div>
             <div class="swiper-slide">
              <img alt="FLOOR SUPPORT BAR" src="../../item_img/10284_3.jpg"/>
             </div>
            </div>
