<html>
 <head>
  ...
  <title>
   KTS-web 工賃セットメニュー A'PEXi パワーインテーク&amp;アルミインダクションボックス
  </title>
  <script type="application/ld+json">
   {@context: "http://schema.org",@type: "BreadcrumbList",itemListElement:[{@type: "ListItem",position: 1,item:{@id: "/shop_menu/",name: "SHOP MENU"}},{@type: "ListItem",position: 2,item:{@id: "/set/",name: "工賃セットメニュー"}},{@type: "ListItem",position: 3,item:{@id: "/item/10626.php",name: "パワーインテーク&アルミインダクションボックス"}}]}
  </script>
...
<!-- <header class="site-header">
      ...
      <div class="main_c row grey-wrapper">
       <div class="mc_nav">
        ...
        &gt;
        <a class="link" href="../br/1008-143.html">
         A'PEXi
        </a>
        &gt;
        <a class="link" href="10626.php">
         パワーインテーク&amp;アルミインダクションボックス
        </a>
       </div>
       <div class="clearfix">
       </div>
       <div class="set_sale_back">
        ...
        <div class="set_menu_n row">
         <div class="set_menu_n_330 col-md-6 col-sm-12 col-xs-12">
          <div>
           <img alt="パワーインテーク&amp;アルミインダクションボックス" src="../../brand/img/1008.gif"/>
          </div>
         </div>
           ...
           <div class="swiper-container">
            <div class="swiper-wrapper">
             <div class="swiper-slide">
              <img alt="パワーインテーク&amp;アルミインダクションボックス" src="../../item_img/10626_1.jpg"/>
             </div>
             <div class="swiper-slide">
              <img alt="パワーインテーク&amp;アルミインダクションボックス" src="../../item_img/10626_2.jpg"/>
             </div>
             <div class="swiper-slide">
              <img alt="パワーインテーク&amp;アルミインダクションボックス" src="../../item_img/10626_3.jpg"/>
             </div>
            </div>
