...
<title>KTS-web 工賃セットメニュー HKS HIPERMAX Touring</title>
...
<div class="mc_nav">
<a class="link" href="https://www.kts-web.com/">HOME</a> &gt; <a class="link" href="../../../../index.html">SHOP MENU</a> &gt; <a class="link" href="../../../index.html">工賃セットメニュー</a> &gt; <a class="link" href="../cat/100.html">足回り</a> &gt; <a class="link" href="../cat/117.html">ダウンサス/アップサス</a> &gt; <a class="link" href="../br/1032-117.html">HKS</a> &gt; <a class="link" href="10087.php">HIPERMAX Touring</a></div>
<div class="space3px"></div>
<div class="set_sale_back">
<div class="space3px"></div>
<div class="set_menu_n">
<div class="set_menu_n_330">
<div><img src="../../brand/img/1032.gif" alt="HIPERMAX Touring"></div></div>
<div class="set_menu_n_cell">
<div class="item_info_text_middle">
<p>HKS[エッチケーエス]</p></div>
<div class="item_info_text_middle_b">
<p>HIPERMAX Touring[ハイパーマックスツーリング]</p></div>
</div></div>
...
<div class="swiper-slide"><img src="../../item_img/10087_1.jpg" alt="HIPERMAX Touring"></div>
<div class="swiper-slide"><img src="../../item_img/10087_2.jpg" alt="HIPERMAX Touring"></div>
<div class="swiper-slide"><img src="../../item_img/10087_3.jpg" alt="HIPERMAX Touring"></div>
</div>
...
<p>純正ショックアブソーバーを使用し、車高調整機能を追加するアジャスタブルスプリングキット。近年、高性能化が顕著な純正電子制御ショックアブソーバーを使用し、車高調整も可能にしたハイブリッドサスペンションキットです。</p>
</div>
<div id="panel2" class="tab_panel">
<p>・純正電子制御システム使用可<br>・車高調整可<br>・専用バンプラバー付属<br>・2年4万キロ保証</p>
</div>
</div>
</div>
</div>
...
<div class="item_info_text_middle_b">
<p>HIPERMAX Touring [ハイパーマックスツーリング]</p>
</div>
<div class="tab_wrap">
...
<p class="search_category">**********【適合検索】**********&nbsp;&nbsp;<a class="change_button" href="../../sale/item/10087.php"><img src="../../img/sale_button.jpg" alt="工賃セットの価格表はコチラ"></a></p>
</tr>
<tr>
<td>
<!-- 車両メーカー検索ココから -->
<p class="search_category">【自動車メーカー】</p>
<form method="post" action="10087.php">
...
if($data[0] == '10087') $position = explode(";", $data[1]);
}
array_pop($position);
fclose($fp_position);
...
<form name="make" method="post" action="10087.php">
