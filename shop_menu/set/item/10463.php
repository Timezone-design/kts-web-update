 <html>
<head>
<meta content="【ツインメタル】&lt;br&gt;高μ・低摩耗・高耐熱性能を向上。ハイパワー、連続使用対応 鋭いレスポンスとダイレクトな伝達能力&lt;br&gt;競技用クラッチの主流、ラグ式ツイン方式でも操作性は抜群。踏力も軽く軽快なペダルワークを実現(現行スポーツクラッチレベル)。&lt;br&gt;&lt;br&gt;【カッパーツイン】&lt;br&gt;扱いやすさとハイパワー対応を両立した、サーキットからストリートまで対応する最強ツインシステム&lt;br&gt;対応トルク700Nm以上と高く、クラッチをつないだ時の駆動ロスを抑え、優れた伝達性能を発揮。&lt;br&gt;低温時から高温時まで安定した摩擦係数と優れた摩耗性能を発揮。" name="description"/>
<meta content="text/html; charset=utf-8" http-equiv="Content-Type"/><meta content="width=device-width, user-scalable=yes, initial-scale=1, maximum-scale=1" name="viewport"><meta content="width=device-width" name="viewport"/><title>KTS-web 工賃セットメニュー CUSCO ツインクラッチシステム</title><script type="application/ld+json">{@context: "http://schema.org",@type: "BreadcrumbList",itemListElement:[{@type: "ListItem",position: 1,item:{@id: "/shop_menu/",name: "SHOP MENU"}},{@type: "ListItem",position: 2,item:{@id: "/set/",name: "工賃セットメニュー"}},{@type: "ListItem",position: 3,item:{@id: "/item/10463.php",name: "ツインクラッチシステム"}}]}</script><script src="https://ajax.googleapis.com/ajax/libs/jquery/3.1.1/jquery.min.js"></script>
<meta content="width=device-width, user-scalable=yes, initial-scale=1, maximum-scale=1" name="viewport"/>
<meta content="width=device-width" name="viewport"/>
<title>KTS-web 工賃セットメニュー CUSCO ツインクラッチシステム</title>
...
<div><img alt="ツインクラッチシステム" src="../../brand/img/1059.gif"/></div>
</div>
<div class="set_menu_n_cell col-md-6 col-sm-12 col-xs-12">
<div class="item_info_text_middle"><p>CUSCO[クスコ]</p></div><div class="item_info_text_middle_b"><p>ツインクラッチシステム</p></div>
</div>
</div>
<div class="set_menu_n row">
<div class="set_menu_n_330 col-md-6 col-sm-12 col-xs-12">
<div>
<div class="swiper-container"><div class="swiper-wrapper"><div class="swiper-slide"><img alt="ツインクラッチシステム" src="../../item_img/10463_1.jpg"/></div><div class="swiper-slide"><img alt="ツインクラッチシステム" src="../../item_img/10463_2.jpg"/></div><div class="swiper-slide"><img alt="ツインクラッチシステム" src="../../item_img/10463_3.jpg"/></div></div><div class="swiper-button-prev"></div><div class="swiper-button-next"></div></div>
</div>
<div class="item_caution"><p>※写真はイメージ・代表画像です。 </p><p>※実際の商品とカラーやイメージが異なる場合がございます。</p></div>
</div>
<div class="set_menu_n_cell col-md-6 col-sm-12 col-xs-12">
<a class="set-sale-switch" href="../../sale/item/10463.php">メニュー内容・物販へのリンク</a><div class="tab_wrap">
