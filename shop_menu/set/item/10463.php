              ...
              <div class="set_sale_back">
                    ...
                    <div class="tab_wrap">
                      ...
                      <div class="tab-content">
                        <div id="home" class="tab-pane fade in active show">
                          <p>【ツインメタル】<br/>高μ・低摩耗・高耐熱性能を向上。ハイパワー、連続使用対応 鋭いレスポンスとダイレクトな伝達能力<br/>競技用クラッチの主流、ラグ式ツイン方式でも操作性は抜群。踏力も軽く軽快なペダルワークを実現(現行スポーツクラッチレベル)。<br/><br/>【カッパーツイン】<br/>扱いやすさとハイパワー対応を両立した、サーキットからストリートまで対応する最強ツインシステム<br/>対応トルク700Nm以上と高く、クラッチをつないだ時の駆動ロスを抑え、優れた伝達性能を発揮。<br/>低温時から高温時まで安定した摩擦係数と優れた摩耗性能を発揮。</p>
                        </div>
                        <div id="menu2" class="tab-pane fade">
                          <p>【ツインメタル】<br/>・クラッチディスク:カーボンリッチフェーシング<br/>・センタープレート:ベンチレーテッドタイプ<br/>・クラッチカバー:軽量アルミ鍛造<br/><br/>【カッパーツイン】<br/>・クラッチディスク:カッパー製<br/>・クラッチカバー:軽量アルミ合金</p>
                        </div>
                      </div>
                      <script>
                ...
                <table style="table-layout:fixed;" width="100%">
                  ...
                  <tr>
                    ...
                    <p class="search_category">**********【商品検索】**********&nbsp;&nbsp;<a class="change_button" href="../../sale/item/10463.php"><img src="../../img/sale_button.jpg" alt="単品販売の価格表はコチラ"></a></p>
                  </tr>
                </table>
                  <?php
    							$root_dir = __DIR__.'/../../..';
