	              ...
	              <div class="set_sale_back">
	                    ...
	                    <div class="tab_wrap">
	                      ...
	                      <div class="tab-content">
	                        <div id="home" class="tab-pane fade in active show">
	                          <p>高性能車からフォードバックされ、新たに幅広い車種に対応すべく研究し生まれた補修用ブレーキディスクです。自社工場での生産、これまでのノウハウを活かした部品設計、それらを最先端技術の活用で開発・生産されることで、コストパフォーマンスを追求しています。<br/>純正の感覚に非常に近く、高性能を実現させたブレーキディスクとなります。</p>
	                        </div>
	                        <div id="menu2" class="tab-pane fade">
	                          <p>・スタンダードディスク<br/>・ピラーベンチレーションディスク(PVT)<br/>・UVコーティング<br/>・ハイカーボン<br/>※一部車種を除く</p>
	                        </div>
	                      </div>
	                      <script>
	                ...
	                <table style="table-layout:fixed;" width="100%">
	                  ...
	                  <tr>
	                    ...
	                    <p class="search_category">**********【商品検索】**********&nbsp;&nbsp;<a class="change_button" href="../../sale/item/10294.php"><img src="../../img/sale_button.jpg" alt="単品販売の価格表はコチラ"></a></p>
	                  </tr>
	                </table>
	                  <?php
	                  	$root_dir = __DIR__.'/../../..';
