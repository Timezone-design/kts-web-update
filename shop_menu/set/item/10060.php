 <html>
<head>
<meta content="レースシーンで築かれた確固たる実績と自信の「Swift スプリング」、そしてハイクオリティサスペンション「Finalkonnexion STEALTH」のコラボレーションで、さらなる高品質・高性能へ。追求したのはコントロール性と快適な乗り心地。街乗りからサーキット走行まで適応しつつ、ストリートでの快適性を犠牲にしない。反応はリニアでコントロール性を追及したベーシックモデルとしてコストパフォーマンスにも優れ、かつハイオリティを実現した商品です。" name="description"/>
<meta content="text/html; charset=utf-8" http-equiv="Content-Type"/><meta content="width=device-width, user-scalable=yes, initial-scale=1, maximum-scale=1" name="viewport"><meta content="width=device-width" name="viewport"/><title>KTS-web 工賃セットメニュー FINAL KONNEXION STEALTH Basic Type-2 Swift Springs Ver.</title><script type="application/ld+json">{@context: "http://schema.org",@type: "BreadcrumbList",itemListElement:[{@type: "ListItem",position: 1,item:{@id: "/shop_menu/",name: "SHOP MENU"}},{@type: "ListItem",position: 2,item:{@id: "/set/",name: "工賃セットメニュー"}},{@type: "ListItem",position: 3,item:{@id: "/item/10060.php",name: "STEALTH Basic Type-2 Swift Springs Ver."}}]}</script><script src="https://ajax.googleapis.com/ajax/libs/jquery/3.1.1/jquery.min.js"></script>
...
<div><img alt="STEALTH Basic Type-2 Swift Springs Ver." src="../../brand/img/1138.gif"/></div>
</div>
<div class="set_menu_n_cell col-md-6 col-sm-12 col-xs-12">
<div class="item_info_text_middle"><p>FINAL KONNEXION[ファイナルコネクション]</p></div><div class="item_info_text_middle_b"><p>STEALTH Basic Type-2 Swift Springs Ver.[ステルスベーシンク タイプ2 スイフトスプリングバージョン]</p></div>
</div>
</div>
<div class="set_menu_n row">
<div class="set_menu_n_330 col-md-6 col-sm-12 col-xs-12">
<div>
<div class="swiper-container"><div class="swiper-wrapper"><div class="swiper-slide"><img alt="STEALTH Basic Type-2 Swift Springs Ver." src="../../item_img/10060_1.jpg"/></div><div class="swiper-slide"><img alt="STEALTH Basic Type-2 Swift Springs Ver." src="../../item_img/10060_2.jpg"/></div><div class="swiper-slide"><img alt="STEALTH Basic Type-2 Swift Springs Ver." src="../../item_img/10060_3.jpg"/></div></div><div class="swiper-button-prev"></div><div class="swiper-button-next"></div></div>
</div>
<div class="item_caution"><p>※写真はイメージ・代表画像です。 </p><p>※実際の商品とカラーやイメージが異なる場合がございます。</p></div>
</div>
<div class="set_menu_n_cell col-md-6 col-sm-12 col-xs-12">
<a class="set-sale-switch" href="../../sale/item/10060.php">メニュー内容・物販へのリンク</a><div class="tab_wrap">
...
<!--ココまでSP-->
<tr>
<a class="set_img"><img alt="お得な工賃セット" src="../../img/set.jpg"/></a>
<div class="search_category">**********【商品検索】**********</div>
</tr>
</table>
<?php
	                  	$root_dir = __DIR__.'/../../..';
