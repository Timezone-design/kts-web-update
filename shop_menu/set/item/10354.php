	              ...
	              <div class="set_sale_back">
	                    ...
	                    <div class="tab_wrap">
	                      ...
	                      <div class="tab-content">
	                        <div id="home" class="tab-pane fade in active show">
	                          <p>特徴的な低熱伝導性がブレーキコンポーネンツへの熱害を抑制<br/>ドライバーが踏力により自在にコントロールが出来るフラットなミュー特性<br/>レース材にもかかわらず、非常にマイルドなローター攻撃性<br/>焼結合金に近い製法により、高密度に摩擦材を成型（高い耐熱性と高強度を実現）</p>
	                        </div>
	                        <div id="menu2" class="tab-pane fade">
	                          <p>・材質:高密度グラファイト メタリック<br/>・適正温度:200～900℃<br/>・初期μ:0.48<br/>・平均μ:0.38～0.43<br/>・ステージ:N1レース/ターマックラリー/サーキット走行</p>
	                        </div>
	                      </div>
	                      <script>
	                ...
	                <table style="table-layout:fixed;" width="100%">
	                  ...
	                  <tr>
	                    ...
	                    <p class="search_category">**********【商品検索】**********&nbsp;&nbsp;<a class="change_button" href="../../sale/item/10354.php"><img src="../../img/sale_button.jpg" alt="単品販売の価格表はコチラ"></a></p>
	                  </tr>
	                </table>
	                  <?php
	                  	$root_dir = __DIR__.'/../../..';
