 <html>
								<head>
								<meta content="専用設計のスプリングとスプリングシートを採用して車高調整機能を付加。一部車種にはオフセットスプリングシートを採用して、フリクションを最小限に。複筒式としては最大級のφ35ピストンバルブを採用。ピストンロッドはストラットタイプφ25、ウィッシュボーン・マルチリンクタイプはφ14を使用。ハードなステージでも安定した減衰力と耐久性を発揮。専用スプリングを新設計。高張力鋼SWOSC-KVを使用しヘタリを完全排除。一部車種にはテーパーコイルスプリングを採用し最大限のストロークを確保。" name="description"/>
<meta content="text/html; charset=utf-8" http-equiv="Content-Type"><meta content="width=device-width, user-scalable=yes, initial-scale=1, maximum-scale=1" name="viewport"/><meta content="width=device-width" name="viewport"/><title>KTS-web 工賃セットメニュー TEIN TYPE HG DAMPER</title><script type="application/ld+json">{@context: "http://schema.org",@type: "BreadcrumbList",itemListElement:[{@type: "ListItem",position: 1,item:{@id: "/shop_menu/",name: "SHOP MENU"}},{@type: "ListItem",position: 2,item:{@id: "/set/",name: "工賃セットメニュー"}},{@type: "ListItem",position: 3,item:{@id: "/item/10206.php",name: "TYPE HG DAMPER"}}]}</script><script src="https://ajax.googleapis.com/ajax/libs/jquery/3.1.1/jquery.min.js"></script>
<meta content="width=device-width, user-scalable=yes, initial-scale=1, maximum-scale=1" name="viewport"/>
<meta content="width=device-width" name="viewport"/>
<title>KTS-web 工賃セットメニュー TEIN TYPE HG DAMPER</title>
	              ...
	              <div class="set_sale_back">
	                ...
	                <div class="set_menu_n row">
	                  <div class="set_menu_n_330 col-md-6 col-sm-12 col-xs-12">
	                    <div><img alt="TYPE HG DAMPER" src="../../brand/img/1104.gif"/></div>
	                  </div>
	                  <div class="set_menu_n_cell col-md-6 col-sm-12 col-xs-12">
	                    <div class="item_info_text_middle"><p>TEIN[テイン]</p></div><div class="item_info_text_middle_b"><p>TYPE HG DAMPER[タイプHGダンパー]</p></div>
	                  </div>
	                </div>
	                <div class="set_menu_n row">
	                  <div class="set_menu_n_330 col-md-6 col-sm-12 col-xs-12">
	                    <div>
	                      <div class="swiper-container"><div class="swiper-wrapper"><div class="swiper-slide"><img alt="TYPE HG DAMPER" src="../../item_img/10206_1.jpg"/></div><div class="swiper-slide"><img alt="TYPE HG DAMPER" src="../../item_img/10206_2.jpg"/></div><div class="swiper-slide"><img alt="TYPE HG DAMPER" src="../../item_img/10206_3.jpg"/></div></div><div class="swiper-button-prev"></div><div class="swiper-button-next"></div></div>
	                    </div>
	                    ...
	                    <div class="tab_wrap">
	                      ...
	                      <div class="tab-content">
	                        <div id="home" class="tab-pane fade in active show">
	                          <p>専用設計のスプリングとスプリングシートを採用して車高調整機能を付加。一部車種にはオフセットスプリングシートを採用して、フリクションを最小限に。複筒式としては最大級のφ35ピストンバルブを採用。ピストンロッドはストラットタイプφ25、ウィッシュボーン・マルチリンクタイプはφ14を使用。ハードなステージでも安定した減衰力と耐久性を発揮。専用スプリングを新設計。高張力鋼SWOSC-KVを使用しヘタリを完全排除。一部車種にはテーパーコイルスプリングを採用し最大限のストロークを確保。</p>
	                        </div>
	                        <div id="menu2" class="tab-pane fade">
	                          <p>・減衰力16段調整<br/>・複筒式構造<br/>・別タンク<br/>・専用設計<br/>・スプリング&amp;スプリングシートを採用<br/>・使用変更可能</p>
	                        </div>
	                      </div>
	                      <script>
	                ...
	                <table style="table-layout:fixed;" width="100%">
	                  ...
	                  <tr>
	                    ...
	                    <p class="search_category">**********【商品検索】**********&nbsp;&nbsp;<a class="change_button" href="../../sale/item/10206.php"><img src="../../img/sale_button.jpg" alt="単品販売の価格表はコチラ"></a></p>
	                  </tr>
	                </table>
	                  <?php
	                  	$root_dir = __DIR__.'/../../..';
