	              ...
	              <div class="set_sale_back">
	                    ...
	                    <div class="tab_wrap">
	                      ...
	                      <div class="tab-content">
	                        <div id="home" class="tab-pane fade in active show">
	                          <p>あらゆる場面（ストリートからサーキットまで）で最高のパフォーマンスを発揮します。<br/>熱処理ローターとスリットローターのメリットを融合することで、スリットの効果で低温時から高い摩擦係数を、サーキットでは比類なき安定性と高温時においても高い摩擦係数を維持します。</p>
	                        </div>
	                        <div id="menu2" class="tab-pane fade">
	                          <p>・サーキット向けモデル<br/>・6本スリットローター<br/>・熱処理加工<br/>・防錆コーティング</p>
	                        </div>
	                      </div>
	                      <script>
	                ...
	                <table style="table-layout:fixed;" width="100%">
	                  ...
	                  <tr>
	                    ...
	                    <p class="search_category">**********【商品検索】**********&nbsp;&nbsp;<a class="change_button" href="../../sale/item/10370.php"><img src="../../img/sale_button.jpg" alt="単品販売の価格表はコチラ"></a></p>
	                  </tr>
	                </table>
	                  <?php
	                  	$root_dir = __DIR__.'/../../..';
