              ...
              <div class="set_sale_back">
                ...
                <div class="set_menu_n row">
                  <div class="set_menu_n_330 col-md-6 col-sm-12 col-xs-12">
                    <div><img alt="エグゾーストフィニッシャー" src="../../brand/img/1042.gif"/></div>
                  </div>
                  <div class="set_menu_n_cell col-md-6 col-sm-12 col-xs-12">
                    <div class="item_info_text_middle"><p>AutoExe[オートエグゼ]</p></div><div class="item_info_text_middle_b"><p>エグゾーストフィニッシャー</p></div>
                  </div>
                </div>
                <div class="set_menu_n row">
                  <div class="set_menu_n_330 col-md-6 col-sm-12 col-xs-12">
                    <div>
                      <div class="swiper-container"><div class="swiper-wrapper"><div class="swiper-slide"><img alt="エグゾーストフィニッシャー" src="../../item_img/10776_1.jpg"/></div><div class="swiper-slide"><img alt="エグゾーストフィニッシャー" src="../../item_img/10776_2.jpg"/></div><div class="swiper-slide"><img alt="エグゾーストフィニッシャー" src="../../item_img/10776_3.jpg"/></div></div><div class="swiper-button-prev"></div><div class="swiper-button-next"></div></div>
                    </div>
                    ...
                    <div class="tab_wrap">
                      ...
                      <div class="tab-content">
                        <div id="home" class="tab-pane fade in active show">
                          <p>量産マフラーのテールエンド部にボルトオン装着。厚みのある美しい曲線で構成されたオーバルシェイプは、汎用マフラーカッターのイメージを一新。マツダ車専用設計ならではのジャストフィット感を実現している。量産マフラーをそのままに、ファッション性のみプラスしたいユーザーに最適</p>
                        </div>
                        <div id="menu2" class="tab-pane fade">
                          <p>ステンレス製 <br/>・純正マフラー装着用<br/>・AutoExeロゴ入り</p>
                        </div>
                      </div>
                      <script>
                ...
                <table style="table-layout:fixed;" width="100%">
                  ...
                  <tr>
                    ...
                    <p class="search_category">**********【商品検索】**********&nbsp;&nbsp;<a class="change_button" href="../../sale/item/10776.php"><img src="../../img/sale_button.jpg" alt="単品販売の価格表はコチラ"></a></p>
                  </tr>
                </table>
                  <?php
    							$root_dir = __DIR__.'/../../..';
