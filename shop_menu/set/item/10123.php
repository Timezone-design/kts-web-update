 <html>
<head>
<meta content="ストロークとスプリング・プリロード量を変更することなく車高調整が可能な全長調整機構とさらなる軽量化を目指したアルミシリンダー採用モデル（※一部車種を除く）。そのシリンダーにはゴールドアルマイト処理を施し、この上なく美しいアピアランスを実現。アイバッハ社との共同開発したオーリンズ専用の新開発軽量スプリング。定評の20段調整搭載。" name="description"/>
<meta content="text/html; charset=utf-8" http-equiv="Content-Type"/><meta content="width=device-width, user-scalable=yes, initial-scale=1, maximum-scale=1" name="viewport"><meta content="width=device-width" name="viewport"/><title>KTS-web 工賃セットメニュー OHLINS Type HAL</title><script type="application/ld+json">{@context: "http://schema.org",@type: "BreadcrumbList",itemListElement:[{@type: "ListItem",position: 1,item:{@id: "/shop_menu/",name: "SHOP MENU"}},{@type: "ListItem",position: 2,item:{@id: "/set/",name: "工賃セットメニュー"}},{@type: "ListItem",position: 3,item:{@id: "/item/10123.php",name: "Type HAL"}}]}</script><script src="https://ajax.googleapis.com/ajax/libs/jquery/3.1.1/jquery.min.js"></script>
<meta content="width=device-width, user-scalable=yes, initial-scale=1, maximum-scale=1" name="viewport"/>
<meta content="width=device-width" name="viewport"/>
<title>KTS-web 工賃セットメニュー OHLINS Type HAL</title>
...
<div><img alt="Type HAL" src="../../brand/img/1046.gif"/></div>
</div>
<div class="set_menu_n_cell col-md-6 col-sm-12 col-xs-12">
<div class="item_info_text_middle"><p>OHLINS[オーリンズ]</p></div><div class="item_info_text_middle_b"><p>Type HAL[タイプHAL]</p></div>
</div>
</div>
<div class="set_menu_n row">
<div class="set_menu_n_330 col-md-6 col-sm-12 col-xs-12">
<div>
<div class="swiper-container"><div class="swiper-wrapper"><div class="swiper-slide"><img alt="Type HAL" src="../../item_img/10123_1.jpg"/></div><div class="swiper-slide"><img alt="Type HAL" src="../../item_img/10123_2.jpg"/></div><div class="swiper-slide"><img alt="Type HAL" src="../../item_img/10123_3.jpg"/></div></div><div class="swiper-button-prev"></div><div class="swiper-button-next"></div></div>
</div>
<div class="item_caution"><p>※写真はイメージ・代表画像です。 </p><p>※実際の商品とカラーやイメージが異なる場合がございます。</p></div>
</div>
<div class="set_menu_n_cell col-md-6 col-sm-12 col-xs-12">
<a class="set-sale-switch" href="../../sale/item/10123.php">メニュー内容・物販へのリンク</a><div class="tab_wrap">
