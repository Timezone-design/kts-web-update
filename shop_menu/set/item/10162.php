 <html>
<head>
<meta content="シリンダーには単筒式を採用。ストリート走行の乗り心地を確保しながらレスポンスの良いハンドリングを実現。アッパーマウント付属モデル。" name="description"/>
<meta content="text/html; charset=utf-8" http-equiv="Content-Type"/><meta content="width=device-width, user-scalable=yes, initial-scale=1, maximum-scale=1" name="viewport"><meta content="width=device-width" name="viewport"/><title>KTS-web 工賃セットメニュー Street Ride TYPE-WAGON</title><script type="application/ld+json">{@context: "http://schema.org",@type: "BreadcrumbList",itemListElement:[{@type: "ListItem",position: 1,item:{@id: "/shop_menu/",name: "SHOP MENU"}},{@type: "ListItem",position: 2,item:{@id: "/set/",name: "工賃セットメニュー"}},{@type: "ListItem",position: 3,item:{@id: "/item/10162.php",name: "TYPE-WAGON"}}]}</script><script src="https://ajax.googleapis.com/ajax/libs/jquery/3.1.1/jquery.min.js"></script>
<meta content="width=device-width, user-scalable=yes, initial-scale=1, maximum-scale=1" name="viewport"/>
<meta content="width=device-width" name="viewport"/>
<title>KTS-web 工賃セットメニュー Street Ride TYPE-WAGON</title>
...
<div><img alt="TYPE-WAGON" src="../../brand/img/1090.gif"/></div>
</div>
<div class="set_menu_n_cell col-md-6 col-sm-12 col-xs-12">
<div class="item_info_text_middle"><p>Street Ride[ストリートライド]</p></div><div class="item_info_text_middle_b"><p>TYPE-WAGON[タイプワゴン]</p></div>
</div>
</div>
<div class="set_menu_n row">
<div class="set_menu_n_330 col-md-6 col-sm-12 col-xs-12">
<div>
<div class="swiper-container"><div class="swiper-wrapper"><div class="swiper-slide"><img alt="TYPE-WAGON" src="../../item_img/10162_1.jpg"/></div><div class="swiper-slide"><img alt="TYPE-WAGON" src="../../item_img/10162_2.jpg"/></div><div class="swiper-slide"><img alt="TYPE-WAGON" src="../../item_img/10162_3.jpg"/></div></div><div class="swiper-button-prev"></div><div class="swiper-button-next"></div></div>
</div>
<div class="item_caution"><p>※写真はイメージ・代表画像です。 </p><p>※実際の商品とカラーやイメージが異なる場合がございます。</p></div>
</div>
<div class="set_menu_n_cell col-md-6 col-sm-12 col-xs-12">
<a class="set-sale-switch" href="../../sale/item/10162.php">メニュー内容・物販へのリンク</a><div class="tab_wrap">
