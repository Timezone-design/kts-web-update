	              ...
	              <div class="set_sale_back">
	                    ...
	                    <div class="tab_wrap">
	                      ...
	                      <div class="tab-content">
	                        <div id="home" class="tab-pane fade in active show">
	                          <p>凹凸のある道路においてセンター部分のシャーシは前後の荷重移動により、あらゆる面でボディの歪みが発生します。<br/>ウルトラレーシングのサイドロアバーを取り付けることにより、フロント、リア間の荷重移動によるボディの歪みを抑えることが可能です。<br/>走行中タイヤと路面の接地が4輪均一になり、トラクションの向上が期待できます。</p>
	                        </div>
	                ...
	                <table style="table-layout:fixed;" width="100%">
	                  ...
	                  <tr>
	                    ...
	                    <p class="search_category">**********【商品検索】**********&nbsp;&nbsp;<a class="change_button" href="../../sale/item/10555.php"><img src="../../img/sale_button.jpg" alt="単品販売の価格表はコチラ"></a></p>
	                  </tr>
	                </table>
	                  <?php
	                  	$root_dir = __DIR__.'/../../..';
