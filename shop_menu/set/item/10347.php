	              ...
	              <div class="set_sale_back">
	                    ...
	                    <div class="tab_wrap">
	                      ...
	                      <div class="tab-content">
	                        <div id="home" class="tab-pane fade in active show">
	                          <p>ノーマルパッド並みの価格とロングライフながら、制動力、ダスト性能に 　優れたスポーツパッド<br/>パッドだけでなく、同時にローターもディクセル製品に交換することにより更に高いパフォーマンスを発揮！<br/>ノーマルパッドと違い、日本人の趣向、日本市場を徹底的にリサーチし、開発</p>
	                        </div>
	                        <div id="menu2" class="tab-pane fade">
	                          <p>・材質:セラミック系複合材/銅フリー 2021規制対応<br/>・適正温度:0～500℃<br/>・Max μ::0.58<br/>・Ave μ:0.40<br/>・Min μ:0.39<br/>・ステージ:ストリート/ワインディング(ワインディング)</p>
	                        </div>
	                      </div>
	                      <script>
	                ...
	                <table style="table-layout:fixed;" width="100%">
	                  ...
	                  <tr>
	                    ...
	                    <p class="search_category">**********【商品検索】**********&nbsp;&nbsp;<a class="change_button" href="../../sale/item/10347.php"><img src="../../img/sale_button.jpg" alt="単品販売の価格表はコチラ"></a></p>
	                  </tr>
	                </table>
	                  <?php
	                  	$root_dir = __DIR__.'/../../..';
