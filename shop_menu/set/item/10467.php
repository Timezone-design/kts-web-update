              ...
              <div class="set_sale_back">
                    ...
                    <div class="tab_wrap">
                      ...
                      <div class="tab-content">
                        <div id="home" class="tab-pane fade in active show">
                          <p>ただ軽いだけでなく、低速域でも回転ムラを起こさない限界設計。<br/>超軽量化によって、吹け上がりも吹け落ちも抜群のレスポンスを発揮。急減速時のエンジンブレーキの効きが抜群。回転のアップ＆ダウンがシャープになって素早いシフト操作が可能。ゼロヨンなどゼロ発進加速はもちろん、中間加速でも確実にタイムアップ。</p>
                        </div>
                        <div id="menu2" class="tab-pane fade">
                          <p>・クロモリ製<br/>・精密加工軽量化</p>
                        </div>
                      </div>
                      <script>
                ...
                <table style="table-layout:fixed;" width="100%">
                  ...
                  <tr>
                    ...
                    <p class="search_category">**********【商品検索】**********&nbsp;&nbsp;<a class="change_button" href="../../sale/item/10467.php"><img src="../../img/sale_button.jpg" alt="単品販売の価格表はコチラ"></a></p>
                  </tr>
                </table>
                  <?php
    							$root_dir = __DIR__.'/../../..';
