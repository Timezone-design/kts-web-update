              ...
              <div class="set_sale_back">
                    ...
                    <div class="tab_wrap">
                      ...
                      <div class="tab-content">
                        <div id="home" class="tab-pane fade in active show">
                          <p>高μ・低摩耗・高耐熱メタル材の採用により、小口径化（ø200）と高伝達容量・超寿命という相反する要素を両立。また専用設計の小型ダンパーディスクを採用し、耐久性も向上。さらにメタルパッドの形状・厚さの最適化を図り標準品以下の低イナーシャを実現。シフトフィーリングとシンクロのダメージを改善。CADソリッドモデルによるシミュレーションで、軽量化と低回転特性を両立した理想のデザインを実現しています。</p>
                        </div>
                        <div id="menu2" class="tab-pane fade">
                          <p>・クラッチ応答性の向上<br/>・ハイクオリティ クロモリフライホイール<br/>・低イナーシャディスクを採用</p>
                        </div>
                      </div>
                      <script>
                ...
                <table style="table-layout:fixed;" width="100%">
                  ...
                  <tr>
                    ...
                    <p class="search_category">**********【商品検索】**********&nbsp;&nbsp;<a class="change_button" href="../../sale/item/10479.php"><img src="../../img/sale_button.jpg" alt="単品販売の価格表はコチラ"></a></p>
                  </tr>
                </table>
                  <?php
    							$root_dir = __DIR__.'/../../..';
