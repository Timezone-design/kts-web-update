 <html>
<head>
<meta content="高μ・低摩耗・高耐熱メタル材の採用により、小口径化（ø200）と高伝達容量・超寿命という相反する要素を両立。また専用設計の小型ダンパーディスクを採用し、耐久性も向上。さらにメタルパッドの形状・厚さの最適化を図り標準品以下の低イナーシャを実現。シフトフィーリングとシンクロのダメージを改善。CADソリッドモデルによるシミュレーションで、軽量化と低回転特性を両立した理想のデザインを実現しています。" name="description"/>
<meta content="text/html; charset=utf-8" http-equiv="Content-Type"/><meta content="width=device-width, user-scalable=yes, initial-scale=1, maximum-scale=1" name="viewport"><meta content="width=device-width" name="viewport"/><title>KTS-web 工賃セットメニュー 戸田レーシング ハイパワーシングルクラッチKIT</title><script type="application/ld+json">{@context: "http://schema.org",@type: "BreadcrumbList",itemListElement:[{@type: "ListItem",position: 1,item:{@id: "/shop_menu/",name: "SHOP MENU"}},{@type: "ListItem",position: 2,item:{@id: "/set/",name: "工賃セットメニュー"}},{@type: "ListItem",position: 3,item:{@id: "/item/10479.php",name: "ハイパワーシングルクラッチKIT"}}]}</script><script src="https://ajax.googleapis.com/ajax/libs/jquery/3.1.1/jquery.min.js"></script>
<meta content="width=device-width, user-scalable=yes, initial-scale=1, maximum-scale=1" name="viewport"/>
<meta content="width=device-width" name="viewport"/>
<title>KTS-web 工賃セットメニュー 戸田レーシング ハイパワーシングルクラッチKIT</title>
...
<div><img alt="ハイパワーシングルクラッチKIT" src="../../brand/img/1111.gif"/></div>
</div>
<div class="set_menu_n_cell col-md-6 col-sm-12 col-xs-12">
<div class="item_info_text_middle"><p>戸田レーシング[トダレーシング]</p></div><div class="item_info_text_middle_b"><p>ハイパワーシングルクラッチKIT</p></div>
</div>
</div>
<div class="set_menu_n row">
<div class="set_menu_n_330 col-md-6 col-sm-12 col-xs-12">
<div>
<div class="swiper-container"><div class="swiper-wrapper"><div class="swiper-slide"><img alt="ハイパワーシングルクラッチKIT" src="../../item_img/10479_1.jpg"/></div><div class="swiper-slide"><img alt="ハイパワーシングルクラッチKIT" src="../../item_img/10479_2.jpg"/></div><div class="swiper-slide"><img alt="ハイパワーシングルクラッチKIT" src="../../item_img/10479_3.jpg"/></div></div><div class="swiper-button-prev"></div><div class="swiper-button-next"></div></div>
</div>
<div class="item_caution"><p>※写真はイメージ・代表画像です。 </p><p>※実際の商品とカラーやイメージが異なる場合がございます。</p></div>
</div>
<div class="set_menu_n_cell col-md-6 col-sm-12 col-xs-12">
<a class="set-sale-switch" href="../../sale/item/10479.php">メニュー内容・物販へのリンク</a><div class="tab_wrap">
