 <html>
<head>
<meta content="全長調整式で乗り心地と走りのベストバランスを実現。設定車種のキャラクターに合わせ減衰力をベストセッティング。有効ストローク一定の「全長調整式」でローダウン量も思いのまま。複筒式ショックの採用で、マイルドな乗り心地と充分なストローク&amp;車種別専用設計でローダウンしても十分なバンプストロークを確保しています。また、調整ネジ部には「ニッケルクロームメッキ処理」を採用し、サビや砂・ダストからしっかりガード。" name="description"/>
<meta content="text/html; charset=utf-8" http-equiv="Content-Type"/><meta content="width=device-width, user-scalable=yes, initial-scale=1, maximum-scale=1" name="viewport"><meta content="width=device-width" name="viewport"/><title>KTS-web 工賃セットメニュー CUSCO 赤のStreet ZERO</title><script type="application/ld+json">{@context: "http://schema.org",@type: "BreadcrumbList",itemListElement:[{@type: "ListItem",position: 1,item:{@id: "/shop_menu/",name: "SHOP MENU"}},{@type: "ListItem",position: 2,item:{@id: "/set/",name: "工賃セットメニュー"}},{@type: "ListItem",position: 3,item:{@id: "/item/10025.php",name: "赤のStreet ZERO"}}]}</script><script src="https://ajax.googleapis.com/ajax/libs/jquery/3.1.1/jquery.min.js"></script>
<meta content="width=device-width, user-scalable=yes, initial-scale=1, maximum-scale=1" name="viewport"/>
<meta content="width=device-width" name="viewport"/>
<title>KTS-web 工賃セットメニュー CUSCO 赤のStreet ZERO</title>
...
<div><img alt="赤のStreet ZERO" src="../../brand/img/1059.gif"/></div>
</div>
<div class="set_menu_n_cell col-md-6 col-sm-12 col-xs-12">
<div class="item_info_text_middle"><p>CUSCO[クスコ]</p></div><div class="item_info_text_middle_b"><p>赤のStreet ZERO[赤のストリートゼロ]</p></div>
</div>
</div>
<div class="set_menu_n row">
<div class="set_menu_n_330 col-md-6 col-sm-12 col-xs-12">
<div>
<div class="swiper-container"><div class="swiper-wrapper"><div class="swiper-slide"><img alt="赤のStreet ZERO" src="../../item_img/10025_1.jpg"/></div><div class="swiper-slide"><img alt="赤のStreet ZERO" src="../../item_img/10025_2.jpg"/></div><div class="swiper-slide"><img alt="赤のStreet ZERO" src="../../item_img/10025_3.jpg"/></div></div><div class="swiper-button-prev"></div><div class="swiper-button-next"></div></div>
</div>
<div class="item_caution"><p>※写真はイメージ・代表画像です。 </p><p>※実際の商品とカラーやイメージが異なる場合がございます。</p></div>
</div>
<div class="set_menu_n_cell col-md-6 col-sm-12 col-xs-12">
<a class="set-sale-switch" href="../../sale/item/10025.php">メニュー内容・物販へのリンク</a><div class="tab_wrap">
