 <html>
<head>
<meta content="ラテラルロッドとは、リアアクスルと車体を結ぶロッドを指し、サスペンションの横方向の位置と入力を受け止めるパーツです。LARGUSの調整式ラテラルロッドは本体にスチールを使用し、重量の増加を抑えつつ、ハードな走りに対応する強度を確保しています。" name="description"/>
<meta content="text/html; charset=utf-8" http-equiv="Content-Type"/><meta content="width=device-width, user-scalable=yes, initial-scale=1, maximum-scale=1" name="viewport"><meta content="width=device-width" name="viewport"/><title>KTS-web 工賃セットメニュー LARGUS 調整式ラテラルロッド</title><script type="application/ld+json">{@context: "http://schema.org",@type: "BreadcrumbList",itemListElement:[{@type: "ListItem",position: 1,item:{@id: "/shop_menu/",name: "SHOP MENU"}},{@type: "ListItem",position: 2,item:{@id: "/set/",name: "工賃セットメニュー"}},{@type: "ListItem",position: 3,item:{@id: "/item/10270.php",name: "調整式ラテラルロッド"}}]}</script><script src="https://ajax.googleapis.com/ajax/libs/jquery/3.1.1/jquery.min.js"></script>
<meta content="width=device-width, user-scalable=yes, initial-scale=1, maximum-scale=1" name="viewport"/>
<meta content="width=device-width" name="viewport"/>
<title>KTS-web 工賃セットメニュー LARGUS 調整式ラテラルロッド</title>
...
<div><img alt="調整式ラテラルロッド" src="../../brand/img/1156.gif"/></div>
</div>
<div class="set_menu_n_cell col-md-6 col-sm-12 col-xs-12">
<div class="item_info_text_middle"><p>LARGUS[ラルグス]</p></div><div class="item_info_text_middle_b"><p>調整式ラテラルロッド</p></div>
</div>
</div>
<div class="set_menu_n row">
<div class="set_menu_n_330 col-md-6 col-sm-12 col-xs-12">
<div>
<div class="swiper-container"><div class="swiper-wrapper"><div class="swiper-slide"><img alt="調整式ラテラルロッド" src="../../item_img/10270_1.jpg"/></div><div class="swiper-slide"><img alt="調整式ラテラルロッド" src="../../item_img/10270_2.jpg"/></div><div class="swiper-slide"><img alt="調整式ラテラルロッド" src="../../item_img/10270_3.jpg"/></div></div><div class="swiper-button-prev"></div><div class="swiper-button-next"></div></div>
</div>
<div class="item_caution"><p>※写真はイメージ・代表画像です。 </p><p>※実際の商品とカラーやイメージが異なる場合がございます。</p></div>
</div>
<div class="set_menu_n_cell col-md-6 col-sm-12 col-xs-12">
<a class="set-sale-switch" href="../../sale/item/10270.php">メニュー内容・物販へのリンク</a><div class="tab_wrap">
