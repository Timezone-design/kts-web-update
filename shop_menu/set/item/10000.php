<html>
 <head>
  ...
  <title>
   KTS-web 工賃セットメニュー KTS SC DAMPER SYSTEM β
  </title>
  <script type="application/ld+json">
   {@context: "http://schema.org",@type: "BreadcrumbList",itemListElement:[{@type: "ListItem",position: 1,item:{@id: "/shop_menu/",name: "SHOP MENU"}},{@type: "ListItem",position: 2,item:{@id: "/set/",name: "工賃セットメニュー"}},{@type: "ListItem",position: 3,item:{@id: "/item/10000.php",name: "SC DAMPER SYSTEM β"}}]}
  </script>
...
<!-- <header class="site-header">
      ...
      <div class="main_c row grey-wrapper">
       <div class="mc_nav">
        ...
        &gt;
        <a class="link" href="../br/1162-116.html">
         KTS
        </a>
        &gt;
        <a class="link" href="10000.php">
         SC DAMPER SYSTEM
                            β
        </a>
       </div>
       ...
       <div class="set_sale_back">
        ...
        <div class="set_menu_n row">
         <div class="set_menu_n_330 col-md-6 col-sm-12 col-xs-12">
          <div>
           <img alt="SC DAMPER SYSTEM β" src="../../brand/img/1162.gif"/>
          </div>
         </div>
         <div class="set_menu_n_cell col-md-6 col-sm-12 col-xs-12">
          ...
          <div class="item_info_text_middle_b">
           <p>
            SC DAMPER SYSTEM β[SCダンパーシステムβ]
           </p>
          </div>
         </div>
        </div>
           ...
           <div class="swiper-container">
            <div class="swiper-wrapper">
             <div class="swiper-slide">
              <img alt="SC DAMPER SYSTEM β" src="../../item_img/10000_1.jpg"/>
             </div>
             <div class="swiper-slide">
              <img alt="SC DAMPER SYSTEM β" src="../../item_img/10000_2.jpg"/>
             </div>
             <div class="swiper-slide">
              <img alt="SC DAMPER SYSTEM β" src="../../item_img/10000_3.jpg"/>
             </div>
            </div>
