<html>
 <head>
  ...
  <title>
   KTS-web 工賃セットメニュー TEIN EnduraPro PLUS SP KIT
  </title>
  <script type="application/ld+json">
   {@context: "http://schema.org",@type: "BreadcrumbList",itemListElement:[{@type: "ListItem",position: 1,item:{@id: "/shop_menu/",name: "SHOP MENU"}},{@type: "ListItem",position: 2,item:{@id: "/set/",name: "工賃セットメニュー"}},{@type: "ListItem",position: 3,item:{@id: "/item/10182.php",name: "EnduraPro PLUS SP KIT"}}]}
  </script>
...
<!-- <header class="site-header">
      ...
      <div class="main_c row grey-wrapper">
       <div class="mc_nav">
        ...
        &gt;
        <a class="link" href="../cat/119.html">
         サスペンションキット
        </a>
        &gt;
        <a class="link" href="../br/1104-119.html">
         TEIN
        </a>
        &gt;
        <a class="link" href="10182.php">
       ...
       <div class="set_sale_back">
        ...
        <div class="set_menu_n row">
         <div class="set_menu_n_330 col-md-6 col-sm-12 col-xs-12">
          <div>
           <img alt="EnduraPro PLUS SP KIT" src="../../brand/img/1104.gif"/>
          </div>
         </div>
         <div class="set_menu_n_cell col-md-6 col-sm-12 col-xs-12">
          ...
          <div class="item_info_text_middle_b">
           <p>
            EnduraPro PLUS SP KIT[エンデュラプロプラス SPキット]
           </p>
          </div>
         </div>
        </div>
           ...
           <div class="swiper-container">
            <div class="swiper-wrapper">
             <div class="swiper-slide">
              <img alt="EnduraPro PLUS SP KIT" src="../../item_img/10182_1.jpg"/>
             </div>
             <div class="swiper-slide">
              <img alt="EnduraPro PLUS SP KIT" src="../../item_img/10182_2.jpg"/>
             </div>
             <div class="swiper-slide">
              <img alt="EnduraPro PLUS SP KIT" src="../../item_img/10182_3.jpg"/>
             </div>
            </div>
