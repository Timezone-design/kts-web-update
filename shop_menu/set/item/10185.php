 <html>
<head>
<meta content="クロスカントリー4WD用40mm(約1.5インチ)リフトアップヘビーデューティーダンパー。ロアスプリングシートを上下に移動することで車高調整が可能。シンプルな構造で扱いやすいのが特徴です。基準車高は純正から40mmアップ(約1.5inch)とすることで、ロードクリアランスを確保して市街地走行からオフロード走行まで様々な走行ステージに対応できる車高設定です。" name="description"/>
<meta content="text/html; charset=utf-8" http-equiv="Content-Type"/><meta content="width=device-width, user-scalable=yes, initial-scale=1, maximum-scale=1" name="viewport"><meta content="width=device-width" name="viewport"/><title>KTS-web 工賃セットメニュー TEIN 4x4 DAMPER SPORT</title><script type="application/ld+json">{@context: "http://schema.org",@type: "BreadcrumbList",itemListElement:[{@type: "ListItem",position: 1,item:{@id: "/shop_menu/",name: "SHOP MENU"}},{@type: "ListItem",position: 2,item:{@id: "/set/",name: "工賃セットメニュー"}},{@type: "ListItem",position: 3,item:{@id: "/item/10185.php",name: "4x4 DAMPER SPORT"}}]}</script><script src="https://ajax.googleapis.com/ajax/libs/jquery/3.1.1/jquery.min.js"></script>
...
<div><img alt="4x4 DAMPER SPORT" src="../../brand/img/1104.gif"/></div>
</div>
<div class="set_menu_n_cell col-md-6 col-sm-12 col-xs-12">
<div class="item_info_text_middle"><p>TEIN[テイン]</p></div><div class="item_info_text_middle_b"><p>4x4 DAMPER SPORT[4×4ダンパースポーツ]</p></div>
</div>
</div>
<div class="set_menu_n row">
<div class="set_menu_n_330 col-md-6 col-sm-12 col-xs-12">
<div>
<div class="swiper-container"><div class="swiper-wrapper"><div class="swiper-slide"><img alt="4x4 DAMPER SPORT" src="../../item_img/10185_1.jpg"/></div><div class="swiper-slide"><img alt="4x4 DAMPER SPORT" src="../../item_img/10185_2.jpg"/></div><div class="swiper-slide"><img alt="4x4 DAMPER SPORT" src="../../item_img/10185_3.jpg"/></div></div><div class="swiper-button-prev"></div><div class="swiper-button-next"></div></div>
</div>
<div class="item_caution"><p>※写真はイメージ・代表画像です。 </p><p>※実際の商品とカラーやイメージが異なる場合がございます。</p></div>
</div>
<div class="set_menu_n_cell col-md-6 col-sm-12 col-xs-12">
<a class="set-sale-switch" href="../../sale/item/10185.php">メニュー内容・物販へのリンク</a><div class="tab_wrap">
