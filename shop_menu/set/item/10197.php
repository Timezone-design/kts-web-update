...
<title>KTS-web 工賃セットメニュー TEIN SUPER RACING</title>
...
<div class="mc_nav">
<a class="link" href="https://www.kts-web.com/">HOME</a> &gt; <a class="link" href="../../index.html">SHOP MENU</a> &gt; <a class="link" href="../index.html">工賃セットメニュー</a> &gt; <a class="link" href="../cat/100.html">足回り</a> &gt; <a class="link" href="../cat/116.html">車高調/セッティングパーツ</a> &gt; <a class="link" href="../br/1104-116.html">TEIN</a> &gt; <a class="link" href="10197.php">SUPER RACING</a></div>
<div class="space3px"></div>
<div class="set_sale_back">
<div class="space3px"></div>
<div class="set_menu_n">
<div class="set_menu_n_330">
<div><img src="../../brand/img/1104.gif" alt="SUPER RACING"></div></div>
<div class="set_menu_n_cell">
<div class="item_info_text_middle">
<p>TEIN[テイン]</p></div>
<div class="item_info_text_middle_b">
<p>SUPER RACING[スーパーレーシング]</p></div>
</div></div>
...
<div class="swiper-slide"><img src="../../item_img/10197_1.jpg" alt="SUPER RACING"></div>
<div class="swiper-slide"><img src="../../item_img/10197_2.jpg" alt="SUPER RACING"></div>
<div class="swiper-slide"><img src="../../item_img/10197_3.jpg" alt="SUPER RACING"></div>
</div>
...
<p>本格スポーツユーザーに贈るタイムアタック重視のフラッグシップ車高調。『TYPE N1』の血統を受け継いだストリートバージョン！無限大のセッティングを実現。</p>
</div>
<div id="panel2" class="tab_panel">
<p>・タイムアタック重視のレーシングスペック<br>・単筒式構造<br>・全長調整式<br>・調整式ピロボールアッパーマウント<br>・減衰力16段調整<br>・高剛性スチールシェルケース※ストラットタイプ<br>・EDFCシリーズ対応<br>・オーバーホール時に3WAY調整機構へアップグレードが可能</p>
</div>
</div>
</div>
</div>
...
<p class="search_category">**********【適合検索】**********&nbsp;&nbsp;<a class="change_button" href="../../sale/item/10197.php"><img src="../../img/sale_button.jpg" alt="単品販売の価格表はコチラ"></a></p>
</tr>
<tr>
<td>
<!-- 車両メーカー検索ココから -->
<p class="search_category">【自動車メーカー】</p>
<form method="post" action="10197.php">
...
if($data[0] == '10197') $position = explode(";", $data[1]);
}
array_pop($position);
fclose($fp_position);
...
<form name="make" method="post" action="10197.php">
