              ...
              <div class="set_sale_back">
                    ...
                    <div class="tab_wrap">
                      ...
                      <div class="tab-content">
                        <div id="home" class="tab-pane fade in active show">
                          <p>エンドレスの独自技術「ミニマムスチール製法」の採用により、ブレーキダストの大幅なカットに成功した「プレミアム コンパウンド」。わずかに排出されるダストも色が目立たず、欧州車の純正パッドのようにホイールを汚しません。また、低ダストパッドにおける摩擦係数の引き上げに注力し、十分な制動力も確保されています。</p>
                        </div>
                        <div id="menu2" class="tab-pane fade">
                          <p>・ローター適正温度域：0～500℃<br/>・平均摩擦係数：0.30～0.40<br/>・材質：ノンアスベスト<br/>・フィールド：ストリート-ワインディング<br/>・タイヤ：ラジアル-ハイグリップラジアル</p>
                        </div>
                      </div>
                      <script>
                ...
                <table style="table-layout:fixed;" width="100%">
                  ...
                  <tr>
                    ...
                    <p class="search_category">**********【商品検索】**********&nbsp;&nbsp;<a class="change_button" href="../../sale/item/10305.php"><img src="../../img/sale_button.jpg" alt="単品販売の価格表はコチラ"></a></p>
                  </tr>
                </table>
                  <?php
    							$root_dir = __DIR__.'/../../..';
