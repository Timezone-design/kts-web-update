	              ...
	              <div class="set_sale_back">
	                    ...
	                    <div class="tab_wrap">
	                      ...
	                      <div class="tab-content">
	                        <div id="home" class="tab-pane fade in active show">
	                          <p>独自の熱処理加工により、ディスク内部の金属結合組織を安定化させ、装着初期にありがちなひずみや熱倒れを徹底的に防止しています。表面硬度も最適化され、ペダルタッチも向上。<br/>サーキット対応のＺタイプやＲシリーズなどとの併用により、より高い相乗効果を実現します。</p>
	                        </div>
	                        <div id="menu2" class="tab-pane fade">
	                          <p>・サーキット向けモデル<br/>・熱処理加工<br/>・防錆コーティング</p>
	                        </div>
	                      </div>
	                      <script>
	                ...
	                <table style="table-layout:fixed;" width="100%">
	                  ...
	                  <tr>
	                    ...
	                    <p class="search_category">**********【商品検索】**********&nbsp;&nbsp;<a class="change_button" href="../../sale/item/10369.php"><img src="../../img/sale_button.jpg" alt="単品販売の価格表はコチラ"></a></p>
	                  </tr>
	                </table>
	                  <?php
	                  	$root_dir = __DIR__.'/../../..';
