 <html>
								<head>
								<meta content="高剛性を優先し、アルミよりスチール、2ピースでなく1ピース。&lt;br&gt;また、ボディとの接合部となるブラケットに筒状のリブを設けることで十分な強度を持たせ、全てのスタッドボルトと共締めにしてボディとの一体性を強化した。さらに、ボディとの接合面に加わる圧力の均一化を図るべく、ツインガセット（補強プレート）を配置。タワーバーとしては、最高レベルの高剛性を確保。" name="description"/>
<meta content="text/html; charset=utf-8" http-equiv="Content-Type"><meta content="width=device-width, user-scalable=yes, initial-scale=1, maximum-scale=1" name="viewport"/><meta content="width=device-width" name="viewport"/><title>KTS-web 工賃セットメニュー AutoExe ストラットタワーバー</title><script type="application/ld+json">{@context: "http://schema.org",@type: "BreadcrumbList",itemListElement:[{@type: "ListItem",position: 1,item:{@id: "/shop_menu/",name: "SHOP MENU"}},{@type: "ListItem",position: 2,item:{@id: "/set/",name: "工賃セットメニュー"}},{@type: "ListItem",position: 3,item:{@id: "/item/10780.php",name: "ストラットタワーバー"}}]}</script><script src="https://ajax.googleapis.com/ajax/libs/jquery/3.1.1/jquery.min.js"></script>
<meta content="width=device-width, user-scalable=yes, initial-scale=1, maximum-scale=1" name="viewport"/>
<meta content="width=device-width" name="viewport"/>
<title>KTS-web 工賃セットメニュー AutoExe ストラットタワーバー</title>
	              ...
	              <div class="set_sale_back">
	                ...
	                <div class="set_menu_n row">
	                  <div class="set_menu_n_330 col-md-6 col-sm-12 col-xs-12">
	                    <div><img alt="ストラットタワーバー" src="../../brand/img/1042.gif"/></div>
	                  </div>
	                  <div class="set_menu_n_cell col-md-6 col-sm-12 col-xs-12">
	                    <div class="item_info_text_middle"><p>AutoExe[オートエグゼ]</p></div><div class="item_info_text_middle_b"><p>ストラットタワーバー</p></div>
	                  </div>
	                </div>
	                <div class="set_menu_n row">
	                  <div class="set_menu_n_330 col-md-6 col-sm-12 col-xs-12">
	                    <div>
	                      <div class="swiper-container"><div class="swiper-wrapper"><div class="swiper-slide"><img alt="ストラットタワーバー" src="../../item_img/10780_1.jpg"/></div><div class="swiper-slide"><img alt="ストラットタワーバー" src="../../item_img/10780_2.jpg"/></div><div class="swiper-slide"><img alt="ストラットタワーバー" src="../../item_img/10780_3.jpg"/></div></div><div class="swiper-button-prev"></div><div class="swiper-button-next"></div></div>
	                    </div>
	                    ...
	                    <div class="tab_wrap">
	                      ...
	                      <div class="tab-content">
	                        <div id="home" class="tab-pane fade in active show">
	                          <p>高剛性を優先し、アルミよりスチール、2ピースでなく1ピース。<br/>また、ボディとの接合部となるブラケットに筒状のリブを設けることで十分な強度を持たせ、全てのスタッドボルトと共締めにしてボディとの一体性を強化した。さらに、ボディとの接合面に加わる圧力の均一化を図るべく、ツインガセット（補強プレート）を配置。タワーバーとしては、最高レベルの高剛性を確保。</p>
	                        </div>
	                ...
	                <table style="table-layout:fixed;" width="100%">
	                  ...
	                  <tr>
	                    ...
	                    <p class="search_category">**********【商品検索】**********&nbsp;&nbsp;<a class="change_button" href="../../sale/item/10780.php"><img src="../../img/sale_button.jpg" alt="単品販売の価格表はコチラ"></a></p>
	                  </tr>
	                </table>
	                  <?php
	                  	$root_dir = __DIR__.'/../../..';
