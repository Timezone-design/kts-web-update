              ...
              <div class="set_sale_back">
                    ...
                    <div class="tab_wrap">
                      ...
                      <div class="tab-content">
                        <div id="home" class="tab-pane fade in active show">
                          <p>タイヤが左右に常時動いている為、ボディのフロント側はより捻じれ、歪みやすい。<br/>フロントの剛性を高くすることによりロールや捻じれ歪みを抑制し、アライメントも変化しにくくなります。ウルトラレーシングのフロントメンバーブレースは車種により支持点を変えることで最適な操舵性能を引き出すことが出来ます。</p>
                        </div>
                ...
                <table style="table-layout:fixed;" width="100%">
                  ...
                  <tr>
                    ...
                    <p class="search_category">**********【商品検索】**********&nbsp;&nbsp;<a class="change_button" href="../../sale/item/10560.php"><img src="../../img/sale_button.jpg" alt="単品販売の価格表はコチラ"></a></p>
                  </tr>
                </table>
                  <?php
    							$root_dir = __DIR__.'/../../..';
