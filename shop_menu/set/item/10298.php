	              ...
	              <div class="set_sale_back">
	                    ...
	                    <div class="tab_wrap">
	                      ...
	                      <div class="tab-content">
	                        <div id="home" class="tab-pane fade in active show">
	                          <p>MX72は、セミメタリック材ながらダストや鳴きを極力抑え低温での制動力をアップさせました。また、高温時の制動安定性を向上させるとともに、ローター攻撃性の低減を実現。さらにはセミメタリック材の長所であるペダルタッチの良さに磨きを掛けました。</p>
	                        </div>
	                        <div id="menu2" class="tab-pane fade">
	                          <p>・ローター適正温度域：50～700℃<br/>・平均摩擦係数：0.37～0.47<br/>・材質：セラミックカーボンメタル<br/>・フィールド：ストリート-サーキット<br/>・タイヤ：ラジアル-ハイグリップラジアル</p>
	                        </div>
	                      </div>
	                      <script>
	                ...
	                <table style="table-layout:fixed;" width="100%">
	                  ...
	                  <tr>
	                    ...
	                    <p class="search_category">**********【商品検索】**********&nbsp;&nbsp;<a class="change_button" href="../../sale/item/10298.php"><img src="../../img/sale_button.jpg" alt="単品販売の価格表はコチラ"></a></p>
	                  </tr>
	                </table>
	                  <?php
	                  	$root_dir = __DIR__.'/../../..';
