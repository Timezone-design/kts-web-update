...
<title>KTS-web 工賃セットメニュー LARGUS 直巻スプリング</title>
...
<div class="mc_nav">
<a class="link" href="https://www.kts-web.com/">HOME</a> &gt; <a class="link" href="../../index.html">SHOP MENU</a> &gt; <a class="link" href="../index.html">工賃セットメニュー</a> &gt; <a class="link" href="../cat/100.html">足回り</a> &gt; <a class="link" href="../cat/116.html">車高調/セッティングパーツ</a> &gt; <a class="link" href="../br/1156-116.html">LARGUS</a> &gt; <a class="link" href="10435.php">直巻スプリング</a></div>
<div class="space3px"></div>
<div class="set_sale_back">
<div class="space3px"></div>
<div class="set_menu_n">
<div class="set_menu_n_330">
<div><img src="../../brand/img/1156.gif" alt="直巻スプリング"></div></div>
...
<div class="swiper-slide"><img src="../../item_img/10435_1.jpg" alt="直巻スプリング"></div>
<div class="swiper-slide"><img src="../../item_img/10435_2.jpg" alt="直巻スプリング"></div>
<div class="swiper-slide"><img src="../../item_img/10435_3.jpg" alt="直巻スプリング"></div>
</div>
...
<p>SAE9254材を冷間成形したヘタリづらい高品質なスプリング。車の状態や好みに合わせてスプリングを変更したいというユーザーの声に応え、ID62φの直巻スプリングをラインナップ。抜き取りで10万回のヘタリ試験を行っている為、ロットごとのヘタリに対する耐久性のバラつきもなく、安心して使用することが出来ます。</p>
</div>
<div id="panel2" class="tab_panel">
<p>・2本1セット<br>・ID:62<br>・自由長:120mm～260mm<br>・スプリングレート:2k～20k(自由長により展開が異なります)</p>
</div>
</div>
</div>
</div>
...
<p class="search_category">**********【商品検索】**********&nbsp;&nbsp;<a class="change_button" href="../../sale/item/10435.php"><img src="../../img/sale_button.jpg" alt="単品販売の価格表はコチラ"></a></p>
</tr>
<tr>
<td>
<!-- スプリング検索ココから -->
<p class="search_category">【ID(内径)】</p>
<form method="post" action="10435.php">
...
if($data[0] == '10435') $position = explode(";", $data[1]);
}
array_pop($position);
fclose($fp_position);
...
<form name="make" method="post" action="10435.php">
