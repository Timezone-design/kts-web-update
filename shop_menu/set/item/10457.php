<html>
 <head>
  ...
  <title>
   KTS-web 工賃セットメニュー nismo GT L.S.D. Pro Carbon
  </title>
  <script type="application/ld+json">
   {@context: "http://schema.org",@type: "BreadcrumbList",itemListElement:[{@type: "ListItem",position: 1,item:{@id: "/shop_menu/",name: "SHOP MENU"}},{@type: "ListItem",position: 2,item:{@id: "/set/",name: "工賃セットメニュー"}},{@type: "ListItem",position: 3,item:{@id: "/item/10457.php",name: "GT L.S.D. Pro Carbon"}}]}
  </script>
     ...
     <div id="content-wrapper">
      ...
      <div class="main_c row grey-wrapper">
       <div class="mc_nav">
        ...
        &gt;
        <a class="link" href="../cat/122.html">
         LSD
        </a>
        &gt;
        <a class="link" href="../br/1122-122.html">
         nismo
        </a>
        &gt;
        <a class="link" href="10457.php">
         GT L.S.D. Pro Carbon
        </a>
       </div>
       <div class="clearfix">
       ...
       <div class="set_sale_back">
        ...
        <div class="set_menu_n row">
         <div class="set_menu_n_330 col-md-6 col-sm-12 col-xs-12">
          <div>
           <img alt="GT L.S.D. Pro Carbon" src="../../brand/img/1122.gif"/>
          </div>
         </div>
         <div class="set_menu_n_cell col-md-6 col-sm-12 col-xs-12">
          ...
          <div class="item_info_text_middle_b">
           <p>
            GT L.S.D. Pro Carbon[GT LSD プロ カーボン]
           </p>
          </div>
         </div>
        </div>
           ...
           <div class="swiper-container">
            <div class="swiper-wrapper">
             <div class="swiper-slide">
              <img alt="GT L.S.D. Pro Carbon" src="../../item_img/10457_1.jpg"/>
             </div>
             <div class="swiper-slide">
              <img alt="GT L.S.D. Pro Carbon" src="../../item_img/10457_2.jpg"/>
             </div>
             <div class="swiper-slide">
              <img alt="GT L.S.D. Pro Carbon" src="../../item_img/10457_3.jpg"/>
             </div>
            </div>
         ...
         <details>
          <summary>
           <div class="change_button">
            <img alt="インプットシャフトオイルシール交換" src="../../img/option_button.jpg"/>
           </div>
          </summary>
          <div class="set_menu_text">
           <span class="item_info_text_middle_b">
            FF/4WD/MR車向けドライブシャフトオイルシール交換
           </span>
          </div>
          <div class="set_menu_n">
           <div class="set_menu_n_200">
            <img alt="オイルシール" src="../img/oil_seal.jpg"/>
           </div>
           <div class="set_menu_n_cell">
            <div class="option_menu_text">
             <div>
              FF・4WD・MRなどの横向きエンジンはクラッチ交換・LSD交換時に必ずドライブシャフトを脱着します。
              <br/>
              ついでに経年劣化しているオイルシールを交換しませんか？
              <br/>
              インプットシャフト部はミッション分解しないと交換ができません。分解作業時は交換をお勧めします。
             </div>
            </div>
