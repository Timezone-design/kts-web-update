	              ...
	              <div class="set_sale_back">
	                    ...
	                    <div class="tab_wrap">
	                      ...
	                      <div class="tab-content">
	                        <div id="home" class="tab-pane fade in active show">
	                          <p>湿式専用に開発されたカーボンファイバークロス素材を採用。LSD内部のフリクションディスク面にLSDオイルとの併用を前提に開発されたカーボンファイバークロス素材を採用。μ-V特性に優れたカーボンフェーシングにより、スティックスリップを抑制し、駆動特性と操安性の向上を図りました。GT LSD Pro同様イニシャルトルク切り替え機能付きです。</p>
	                        </div>
	                        <div id="menu2" class="tab-pane fade">
	                          <p>・イニシャルトルク内圧式可変機能付き<br/>・設定[LOW-MIDDLE-HIGH:6.5-8.5-14.0kgf・m ]<br/>・フリクションディスク面:カーボン素材採用<br/>・2WAYのみ設定</p>
	                        </div>
	                      </div>
	                      <script>
	                ...
	                <table style="table-layout:fixed;" width="100%">
	                  ...
	                  <tr>
	                    ...
	                    <p class="search_category">**********【商品検索】**********&nbsp;&nbsp;<a class="change_button" href="../../sale/item/10457.php"><img src="../../img/sale_button.jpg" alt="単品販売の価格表はコチラ"></a></p>
	                  </tr>
	                </table>
	                  <?php
	                  	$root_dir = __DIR__.'/../../..';
