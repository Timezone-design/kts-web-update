<html>
 <head>
  ...
  <title>
   KTS-web 工賃セットメニュー STRIKE エアコンフィルター
  </title>
  <script type="application/ld+json">
   {@context: "http://schema.org",@type: "BreadcrumbList",itemListElement:[{@type: "ListItem",position: 1,item:{@id: "/shop_menu/",name: "SHOP MENU"}},{@type: "ListItem",position: 2,item:{@id: "/set/",name: "工賃セットメニュー"}},{@type: "ListItem",position: 3,item:{@id: "/item/10667.php",name: "エアコンフィルター"}}]}
  </script>
       ...
       <div class="set_sale_back">
        ...
        <div class="set_menu_n row">
         <div class="set_menu_n_330 col-md-6 col-sm-12 col-xs-12">
          <div>
           <img alt="エアコンフィルター" src="../../brand/img/1180.gif"/>
          </div>
         </div>
           ...
           <div class="swiper-container">
            <div class="swiper-wrapper">
             <div class="swiper-slide">
              <img alt="エアコンフィルター" src="../../item_img/10667_1.jpg"/>
             </div>
             <div class="swiper-slide">
              <img alt="エアコンフィルター" src="../../item_img/10667_2.jpg"/>
             </div>
             <div class="swiper-slide">
              <img alt="エアコンフィルター" src="../../item_img/10667_3.jpg"/>
             </div>
            </div>
