 <html>
<head>
<meta content="幅広い用途にも対応するスタンダードタイプのディスクローター&lt;br&gt;全品防錆コーティングを行っている、ロングセラー商品です。平行度、厚み偏差などの精度を高レベルで設定し、鳴きや振動の抑制に成功。FC材にカーボン、シリコンなどの各種添加剤を絶妙に配合し、強度、耐熱性、耐クラック性を向上しています。" name="description"/>
<meta content="text/html; charset=utf-8" http-equiv="Content-Type"/><meta content="width=device-width, user-scalable=yes, initial-scale=1, maximum-scale=1" name="viewport"><meta content="width=device-width" name="viewport"/><title>KTS-web 工賃セットメニュー DIXCEL PD type</title><script type="application/ld+json">{@context: "http://schema.org",@type: "BreadcrumbList",itemListElement:[{@type: "ListItem",position: 1,item:{@id: "/shop_menu/",name: "SHOP MENU"}},{@type: "ListItem",position: 2,item:{@id: "/set/",name: "工賃セットメニュー"}},{@type: "ListItem",position: 3,item:{@id: "/item/10367.php",name: "PD type"}}]}</script><script src="https://ajax.googleapis.com/ajax/libs/jquery/3.1.1/jquery.min.js"></script>
<meta content="width=device-width, user-scalable=yes, initial-scale=1, maximum-scale=1" name="viewport"/>
<meta content="width=device-width" name="viewport"/>
<title>KTS-web 工賃セットメニュー DIXCEL PD type</title>
...
<div><img alt="PD type" src="../../brand/img/1103.gif"/></div>
</div>
<div class="set_menu_n_cell col-md-6 col-sm-12 col-xs-12">
<div class="item_info_text_middle"><p>DIXCEL[ディクセル]</p></div><div class="item_info_text_middle_b"><p>PD type[PDタイプ]</p></div>
</div>
</div>
<div class="set_menu_n row">
<div class="set_menu_n_330 col-md-6 col-sm-12 col-xs-12">
<div>
<div class="swiper-container"><div class="swiper-wrapper"><div class="swiper-slide"><img alt="PD type" src="../../item_img/10367_1.jpg"/></div><div class="swiper-slide"><img alt="PD type" src="../../item_img/10367_2.jpg"/></div><div class="swiper-slide"><img alt="PD type" src="../../item_img/10367_3.jpg"/></div></div><div class="swiper-button-prev"></div><div class="swiper-button-next"></div></div>
</div>
<div class="item_caution"><p>※写真はイメージ・代表画像です。 </p><p>※実際の商品とカラーやイメージが異なる場合がございます。</p></div>
</div>
<div class="set_menu_n_cell col-md-6 col-sm-12 col-xs-12">
<a class="set-sale-switch" href="../../sale/item/10367.php">メニュー内容・物販へのリンク</a><div class="tab_wrap">
