	              ...
	              <div class="set_sale_back">
	                    ...
	                    <div class="tab_wrap">
	                      ...
	                      <div class="tab-content">
	                        <div id="home" class="tab-pane fade in active show">
	                          <p>幅広い用途にも対応するスタンダードタイプのディスクローター<br/>全品防錆コーティングを行っている、ロングセラー商品です。平行度、厚み偏差などの精度を高レベルで設定し、鳴きや振動の抑制に成功。FC材にカーボン、シリコンなどの各種添加剤を絶妙に配合し、強度、耐熱性、耐クラック性を向上しています。</p>
	                        </div>
	                        <div id="menu2" class="tab-pane fade">
	                          <p>・スタンダードタイプ<br/>・防錆コーティング<br/>・幅広いラインアップ</p>
	                        </div>
	                      </div>
	                      <script>
	                ...
	                <table style="table-layout:fixed;" width="100%">
	                  ...
	                  <tr>
	                    ...
	                    <p class="search_category">**********【商品検索】**********&nbsp;&nbsp;<a class="change_button" href="../../sale/item/10367.php"><img src="../../img/sale_button.jpg" alt="単品販売の価格表はコチラ"></a></p>
	                  </tr>
	                </table>
	                  <?php
	                  	$root_dir = __DIR__.'/../../..';
