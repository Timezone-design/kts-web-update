              ...
              <div class="set_sale_back">
                ...
                <div class="set_menu_n row">
                  <div class="set_menu_n_330 col-md-6 col-sm-12 col-xs-12">
                    <div><img alt="フロントロアコントロールアーム+テンションロッド" src="../../brand/img/1181.gif"/></div>
                  </div>
                  <div class="set_menu_n_cell col-md-6 col-sm-12 col-xs-12">
                    <div class="item_info_text_middle"><p>MEGAN RACING[メーガンレーシング]</p></div><div class="item_info_text_middle_b"><p>フロントロアコントロールアーム+テンションロッド</p></div>
                  </div>
                </div>
                <div class="set_menu_n row">
                  <div class="set_menu_n_330 col-md-6 col-sm-12 col-xs-12">
                    <div>
                      <div class="swiper-container"><div class="swiper-wrapper"><div class="swiper-slide"><img alt="フロントロアコントロールアーム+テンションロッド" src="../../item_img/10717_1.jpg"/></div><div class="swiper-slide"><img alt="フロントロアコントロールアーム+テンションロッド" src="../../item_img/10717_2.jpg"/></div><div class="swiper-slide"><img alt="フロントロアコントロールアーム+テンションロッド" src="../../item_img/10717_3.jpg"/></div></div><div class="swiper-button-prev"></div><div class="swiper-button-next"></div></div>
                    </div>
                    ...
                    <div class="tab_wrap">
                      ...
                      <div class="tab-content">
                        <div id="home" class="tab-pane fade in active show">
                          <p>メーガンレーシングは「ポテンシャルの高い商品開発」を志に1,000を超えるラインナップをご用意。<br/>日本車はもちろんのこと、ヨーロッパ車やUSカスタム系など多方面の車両向けに展開しています。。<br/>開発と同時に材料や加工方法を吟味し、最先端技術を導入しパーツの安全性、潜在能力を高めています。</p>
                        </div>
                ...
                <table style="table-layout:fixed;" width="100%">
                  ...
                  <tr>
                    ...
                    <p class="search_category">**********【商品検索】**********&nbsp;&nbsp;<a class="change_button" href="../../sale/item/10717.php"><img src="../../img/sale_button.jpg" alt="単品販売の価格表はコチラ"></a></p>
                  </tr>
                </table>
                  <?php
    							$root_dir = __DIR__.'/../../..';
