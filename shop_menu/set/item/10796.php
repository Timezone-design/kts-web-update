              ...
              <div class="set_sale_back">
                ...
                <div class="set_menu_n row">
                  <div class="set_menu_n_330 col-md-6 col-sm-12 col-xs-12">
                    <div><img alt="フレッシュエアガイド" src="../../brand/img/1042.gif"/></div>
                  </div>
                  <div class="set_menu_n_cell col-md-6 col-sm-12 col-xs-12">
                    <div class="item_info_text_middle"><p>AutoExe[オートエグゼ]</p></div><div class="item_info_text_middle_b"><p>フレッシュエアガイド</p></div>
                  </div>
                </div>
                <div class="set_menu_n row">
                  <div class="set_menu_n_330 col-md-6 col-sm-12 col-xs-12">
                    <div>
                      <div class="swiper-container"><div class="swiper-wrapper"><div class="swiper-slide"><img alt="フレッシュエアガイド" src="../../item_img/10796_1.jpg"/></div><div class="swiper-slide"><img alt="フレッシュエアガイド" src="../../item_img/10796_2.jpg"/></div><div class="swiper-slide"><img alt="フレッシュエアガイド" src="../../item_img/10796_3.jpg"/></div></div><div class="swiper-button-prev"></div><div class="swiper-button-next"></div></div>
                    </div>
                    ...
                    <div class="tab_wrap">
                      ...
                      <div class="tab-content">
                        <div id="home" class="tab-pane fade in active show">
                          <p>車体前面からの走行風を直接捉えることで、吸入効率の向上をサポートするアイテム。量産車では明確な吸気経路が存在しないフロントグリルからコアサポート上部に設置されたエア吸入口までを専用エアガイドで直結することで、ラジエターなどの排熱の影響を最小限に、フレッシュエアをエアクリーナーボックスに導入し、充填効率の向上を図っている。</p>
                        </div>
                        <div id="menu2" class="tab-pane fade">
                          <p>・FRP製<br/>・レッドゲルコート仕上げ</p>
                        </div>
                      </div>
                      <script>
                ...
                <table style="table-layout:fixed;" width="100%">
                  ...
                  <tr>
                    ...
                    <p class="search_category">**********【商品検索】**********&nbsp;&nbsp;<a class="change_button" href="../../sale/item/10796.php"><img src="../../img/sale_button.jpg" alt="単品販売の価格表はコチラ"></a></p>
                  </tr>
                </table>
                  <?php
    							$root_dir = __DIR__.'/../../..';
