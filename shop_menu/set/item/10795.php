              ...
              <div class="set_sale_back">
                ...
                <div class="set_menu_n row">
                  <div class="set_menu_n_330 col-md-6 col-sm-12 col-xs-12">
                    <div><img alt="トーションビームスティフナー" src="../../brand/img/1042.gif"/></div>
                  </div>
                  <div class="set_menu_n_cell col-md-6 col-sm-12 col-xs-12">
                    <div class="item_info_text_middle"><p>AutoExe[オートエグゼ]</p></div><div class="item_info_text_middle_b"><p>トーションビームスティフナー</p></div>
                  </div>
                </div>
                <div class="set_menu_n row">
                  <div class="set_menu_n_330 col-md-6 col-sm-12 col-xs-12">
                    <div>
                      <div class="swiper-container"><div class="swiper-wrapper"><div class="swiper-slide"><img alt="トーションビームスティフナー" src="../../item_img/10795_1.jpg"/></div><div class="swiper-slide"><img alt="トーションビームスティフナー" src="../../item_img/10795_2.jpg"/></div><div class="swiper-slide"><img alt="トーションビームスティフナー" src="../../item_img/10795_3.jpg"/></div></div><div class="swiper-button-prev"></div><div class="swiper-button-next"></div></div>
                    </div>
                    ...
                    <div class="tab_wrap">
                      ...
                      <div class="tab-content">
                        <div id="home" class="tab-pane fade in active show">
                          <p>コーナリング時など高負荷が掛かるリアサスペンション左右のトーションビーム取付け部に装着する高剛性スチール製ガセット（補強プレート）。同部分に標準装備される量産プレートと交換装着。無用な歪みを抑制し、正確なハンドリングを支援。フロント用ロアアームバーとの併用を推奨。</p>
                        </div>
                        <div id="menu2" class="tab-pane fade">
                          <p>・スチール製<br/>・2ピース構造2点式</p>
                        </div>
                      </div>
                      <script>
                ...
                <table style="table-layout:fixed;" width="100%">
                  ...
                  <tr>
                    ...
                    <p class="search_category">**********【商品検索】**********&nbsp;&nbsp;<a class="change_button" href="../../sale/item/10795.php"><img src="../../img/sale_button.jpg" alt="単品販売の価格表はコチラ"></a></p>
                  </tr>
                </table>
                  <?php
    							$root_dir = __DIR__.'/../../..';
