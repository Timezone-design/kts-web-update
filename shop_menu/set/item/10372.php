	              ...
	              <div class="set_sale_back">
	                    ...
	                    <div class="tab_wrap">
	                      ...
	                      <div class="tab-content">
	                        <div id="home" class="tab-pane fade in active show">
	                          <p>カーボンの含有量を従来より20％増量。網目のように絡まりあった炭素粒子が分子間の結合を強化しています。<br/>熱処理加工により安定した強度を実現し、耐ひずみ性能、耐クラック性能を大幅に向上させたプロスペックモデルです。</p>
	                        </div>
	                        <div id="menu2" class="tab-pane fade">
	                          <p>・サーキット向けモデル<br/>・6本スリットローター<br/>・熱処理加工<br/>・ハイカーボン材採用<br/>・防錆コーティング</p>
	                        </div>
	                      </div>
	                      <script>
	                ...
	                <table style="table-layout:fixed;" width="100%">
	                  ...
	                  <tr>
	                    ...
	                    <p class="search_category">**********【商品検索】**********&nbsp;&nbsp;<a class="change_button" href="../../sale/item/10372.php"><img src="../../img/sale_button.jpg" alt="単品販売の価格表はコチラ"></a></p>
	                  </tr>
	                </table>
	                  <?php
	                  	$root_dir = __DIR__.'/../../..';
