 <html>
<head>
<meta content="TYPE-E[コンフォートコンセプト]はストリート性能を優先した信頼の乗り味のベーシックモデルです。街乗りからワインディングをターゲットに乗り心地とスポーツ性を高次元両立。専用パーツが初期減衰特性を向上させ路面の轍、舗装の繋ぎ目も包み込むようなフラット性能を実現しました。ローダウン派にも最適です。" name="description"/>
<meta content="text/html; charset=utf-8" http-equiv="Content-Type"/><meta content="width=device-width, user-scalable=yes, initial-scale=1, maximum-scale=1" name="viewport"><meta content="width=device-width" name="viewport"/><title>KTS-web 工賃セットメニュー Aragosta TYPE-E</title><script type="application/ld+json">{@context: "http://schema.org",@type: "BreadcrumbList",itemListElement:[{@type: "ListItem",position: 1,item:{@id: "/shop_menu/",name: "SHOP MENU"}},{@type: "ListItem",position: 2,item:{@id: "/set/",name: "工賃セットメニュー"}},{@type: "ListItem",position: 3,item:{@id: "/item/10006.php",name: "TYPE-E"}}]}</script><script src="https://ajax.googleapis.com/ajax/libs/jquery/3.1.1/jquery.min.js"></script>
<meta content="width=device-width, user-scalable=yes, initial-scale=1, maximum-scale=1" name="viewport"/>
<meta content="width=device-width" name="viewport"/>
<title>KTS-web 工賃セットメニュー Aragosta TYPE-E</title>
...
<div><img alt="TYPE-E" src="../../brand/img/1010.gif"/></div>
</div>
<div class="set_menu_n_cell col-md-6 col-sm-12 col-xs-12">
<div class="item_info_text_middle"><p>Aragosta[アラゴスタ]</p></div><div class="item_info_text_middle_b"><p>TYPE-E[タイプE]</p></div>
</div>
</div>
<div class="set_menu_n row">
<div class="set_menu_n_330 col-md-6 col-sm-12 col-xs-12">
<div>
<div class="swiper-container"><div class="swiper-wrapper"><div class="swiper-slide"><img alt="TYPE-E" src="../../item_img/10006_1.jpg"/></div><div class="swiper-slide"><img alt="TYPE-E" src="../../item_img/10006_2.jpg"/></div><div class="swiper-slide"><img alt="TYPE-E" src="../../item_img/10006_3.jpg"/></div></div><div class="swiper-button-prev"></div><div class="swiper-button-next"></div></div>
</div>
<div class="item_caution"><p>※写真はイメージ・代表画像です。 </p><p>※実際の商品とカラーやイメージが異なる場合がございます。</p></div>
</div>
<div class="set_menu_n_cell col-md-6 col-sm-12 col-xs-12">
<a class="set-sale-switch" href="../../sale/item/10006.php">メニュー内容・物販へのリンク</a><div class="tab_wrap">
