 <html>
<head>
<meta content="ストロークが確保しやすく反発力が少ないので、荒れた路面では凹凸をしっかり捉えて低速ではしなやかに、高速では安定感のある走りを実現。高性能ダンパーオイルにより低温から高温まで安定した減衰力を発生しスムーズなストロークで全てにおいて快適な乗り心地です。また、全長調整式フルタップショックなので車高を上下しても乗り心地に影響がありません。" name="description"/>
<meta content="text/html; charset=utf-8" http-equiv="Content-Type"/><meta content="width=device-width, user-scalable=yes, initial-scale=1, maximum-scale=1" name="viewport"><meta content="width=device-width" name="viewport"/><title>KTS-web 工賃セットメニュー AXIS STYLING PERFECT DAMPER 3</title><script type="application/ld+json">{@context: "http://schema.org",@type: "BreadcrumbList",itemListElement:[{@type: "ListItem",position: 1,item:{@id: "/shop_menu/",name: "SHOP MENU"}},{@type: "ListItem",position: 2,item:{@id: "/set/",name: "工賃セットメニュー"}},{@type: "ListItem",position: 3,item:{@id: "/item/10012.php",name: "PERFECT DAMPER 3"}}]}</script><script src="https://ajax.googleapis.com/ajax/libs/jquery/3.1.1/jquery.min.js"></script>
<meta content="width=device-width, user-scalable=yes, initial-scale=1, maximum-scale=1" name="viewport"/>
<meta content="width=device-width" name="viewport"/>
<title>KTS-web 工賃セットメニュー AXIS STYLING PERFECT DAMPER 3</title>
...
<div><img alt="PERFECT DAMPER 3" src="../../brand/img/1163.gif"/></div>
</div>
<div class="set_menu_n_cell col-md-6 col-sm-12 col-xs-12">
<div class="item_info_text_middle"><p>AXIS STYLING[アクシススタイリング]</p></div><div class="item_info_text_middle_b"><p>PERFECT DAMPER 3[パーフェクトダンパー3]</p></div>
</div>
</div>
<div class="set_menu_n row">
<div class="set_menu_n_330 col-md-6 col-sm-12 col-xs-12">
<div>
<div class="swiper-container"><div class="swiper-wrapper"><div class="swiper-slide"><img alt="PERFECT DAMPER 3" src="../../item_img/10012_1.jpg"/></div><div class="swiper-slide"><img alt="PERFECT DAMPER 3" src="../../item_img/10012_2.jpg"/></div><div class="swiper-slide"><img alt="PERFECT DAMPER 3" src="../../item_img/10012_3.jpg"/></div></div><div class="swiper-button-prev"></div><div class="swiper-button-next"></div></div>
</div>
<div class="item_caution"><p>※写真はイメージ・代表画像です。 </p><p>※実際の商品とカラーやイメージが異なる場合がございます。</p></div>
</div>
<div class="set_menu_n_cell col-md-6 col-sm-12 col-xs-12">
<a class="set-sale-switch" href="../../sale/item/10012.php">メニュー内容・物販へのリンク</a><div class="tab_wrap">
