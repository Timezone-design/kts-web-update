	              ...
	              <div class="set_sale_back">
	                    ...
	                    <div class="tab_wrap">
	                      ...
	                      <div class="tab-content">
	                        <div id="home" class="tab-pane fade in active show">
	                          <p>初期制動を重視したヨーロッパフィーリングを継承したモデル。<br/>ストリートでの使用を重視し摩擦係数を高めに設定することにより初期の効きを高めています。<br/>レッドシムパッドに比べ摩擦係数が高い為、ダスト量は少し多めですが水洗いで流せるレベルとなっています。</p>
	                        </div>
	                        <div id="menu2" class="tab-pane fade">
	                          <p>・ストリート向け<br/>・初期制動を重視した仕様<br/>・適正温度0～600℃</p>
	                        </div>
	                      </div>
	                      <script>
	                ...
	                <table style="table-layout:fixed;" width="100%">
	                  ...
	                  <tr>
	                    ...
	                    <p class="search_category">**********【商品検索】**********&nbsp;&nbsp;<a class="change_button" href="../../sale/item/10293.php"><img src="../../img/sale_button.jpg" alt="単品販売の価格表はコチラ"></a></p>
	                  </tr>
	                </table>
	                  <?php
	                  	$root_dir = __DIR__.'/../../..';
