 <html>
<head>
<meta content="サーキットではなく、時として条件がより過酷な高速道路、峠道を気持ちよく走ることを目指し開発。減衰力の応答性を最大限に引き出す大口径ピストンの採用(一部車種を除く)。タイヤの浮き上がりを抑えるリバウンドスプリングを装備。ショックアブソーバのチューニングに合わせ、スプリングも最適値に設定。必要な時に瞬時に減衰力を発生し、ゴツゴツとした乗り心地を解消するとともにキビキビ感を両立しています。" name="description"/>
<meta content="text/html; charset=utf-8" http-equiv="Content-Type"/><meta content="width=device-width, user-scalable=yes, initial-scale=1, maximum-scale=1" name="viewport"><meta content="width=device-width" name="viewport"/><title>KTS-web 工賃セットメニュー SHOWA SPORTS</title><script type="application/ld+json">{@context: "http://schema.org",@type: "BreadcrumbList",itemListElement:[{@type: "ListItem",position: 1,item:{@id: "/shop_menu/",name: "SHOP MENU"}},{@type: "ListItem",position: 2,item:{@id: "/set/",name: "工賃セットメニュー"}},{@type: "ListItem",position: 3,item:{@id: "/item/10153.php",name: "SPORTS"}}]}</script><script src="https://ajax.googleapis.com/ajax/libs/jquery/3.1.1/jquery.min.js"></script>
<meta content="width=device-width, user-scalable=yes, initial-scale=1, maximum-scale=1" name="viewport"/>
<meta content="width=device-width" name="viewport"/>
<title>KTS-web 工賃セットメニュー SHOWA SPORTS</title>
...
<div><img alt="SPORTS" src="../../brand/img/1086.gif"/></div>
</div>
<div class="set_menu_n_cell col-md-6 col-sm-12 col-xs-12">
<div class="item_info_text_middle"><p>SHOWA[ショーワ]</p></div><div class="item_info_text_middle_b"><p>SPORTS[スポーツ]</p></div>
</div>
</div>
<div class="set_menu_n row">
<div class="set_menu_n_330 col-md-6 col-sm-12 col-xs-12">
<div>
<div class="swiper-container"><div class="swiper-wrapper"><div class="swiper-slide"><img alt="SPORTS" src="../../item_img/10153_1.jpg"/></div><div class="swiper-slide"><img alt="SPORTS" src="../../item_img/10153_2.jpg"/></div><div class="swiper-slide"><img alt="SPORTS" src="../../item_img/10153_3.jpg"/></div></div><div class="swiper-button-prev"></div><div class="swiper-button-next"></div></div>
</div>
<div class="item_caution"><p>※写真はイメージ・代表画像です。 </p><p>※実際の商品とカラーやイメージが異なる場合がございます。</p></div>
</div>
<div class="set_menu_n_cell col-md-6 col-sm-12 col-xs-12">
<a class="set-sale-switch" href="../../sale/item/10153.php">メニュー内容・物販へのリンク</a><div class="tab_wrap">
