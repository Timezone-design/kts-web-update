<html>
 <head>
  ...
  <title>
   KTS-web 工賃セットメニュー MEGAN RACING リアタワーバー レーシングタイプ
  </title>
  <script type="application/ld+json">
   {@context: "http://schema.org",@type: "BreadcrumbList",itemListElement:[{@type: "ListItem",position: 1,item:{@id: "/shop_menu/",name: "SHOP MENU"}},{@type: "ListItem",position: 2,item:{@id: "/set/",name: "工賃セットメニュー"}},{@type: "ListItem",position: 3,item:{@id: "/item/10736.php",name: "リアタワーバー レーシングタイプ"}}]}
  </script>
...
<!-- <header class="site-header">
      ...
      <div class="main_c row grey-wrapper">
       <div class="mc_nav">
        ...
        &gt;
        <a class="link" href="../cat/104.html">
         ボディ・シャーシ
        </a>
        &gt;
        <a class="link" href="../cat/134.html">
         タワーバー/サブフレーム
        </a>
        &gt;
        <a class="link" href="../br/1181-134.html">
         MEGAN RACING
        </a>
        &gt;
        <a class="link" href="10736.php">
         リアタワーバー レーシングタイプ
        </a>
       </div>
       <div class="clearfix">
       ...
       <div class="set_sale_back">
        ...
        <div class="set_menu_n row">
         <div class="set_menu_n_330 col-md-6 col-sm-12 col-xs-12">
          <div>
           <img alt="リアタワーバー レーシングタイプ" src="../../brand/img/1181.gif"/>
          </div>
         </div>
           ...
           <div class="swiper-container">
            <div class="swiper-wrapper">
             <div class="swiper-slide">
              <img alt="リアタワーバー レーシングタイプ" src="../../item_img/10736_1.jpg"/>
             </div>
             <div class="swiper-slide">
              <img alt="リアタワーバー レーシングタイプ" src="../../item_img/10736_2.jpg"/>
             </div>
             <div class="swiper-slide">
              <img alt="リアタワーバー レーシングタイプ" src="../../item_img/10736_3.jpg"/>
             </div>
            </div>
