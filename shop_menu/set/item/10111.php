 <html>
<head>
<meta content="スーパーローダウンを実現しながら実走行可能な調整範囲を確保。ショート化されたロアブラケットとショックアブソーバー、ハイレートなショートスプリングなどの専用部品を用いて、従来の車高調では不可能なダウン量を確保しています。全下げ状態にすることで迫力のローダウンを実現し、全長を調整する事で自走する事も可能。" name="description"/>
<meta content="text/html; charset=utf-8" http-equiv="Content-Type"/><meta content="width=device-width, user-scalable=yes, initial-scale=1, maximum-scale=1" name="viewport"><meta content="width=device-width" name="viewport"/><title>KTS-web 工賃セットメニュー LARGUS SpecD</title><script type="application/ld+json">{@context: "http://schema.org",@type: "BreadcrumbList",itemListElement:[{@type: "ListItem",position: 1,item:{@id: "/shop_menu/",name: "SHOP MENU"}},{@type: "ListItem",position: 2,item:{@id: "/set/",name: "工賃セットメニュー"}},{@type: "ListItem",position: 3,item:{@id: "/item/10111.php",name: "SpecD"}}]}</script><script src="https://ajax.googleapis.com/ajax/libs/jquery/3.1.1/jquery.min.js"></script>
<meta content="width=device-width, user-scalable=yes, initial-scale=1, maximum-scale=1" name="viewport"/>
<meta content="width=device-width" name="viewport"/>
<title>KTS-web 工賃セットメニュー LARGUS SpecD</title>
...
<div><img alt="SpecD" src="../../brand/img/1156.gif"/></div>
</div>
<div class="set_menu_n_cell col-md-6 col-sm-12 col-xs-12">
<div class="item_info_text_middle"><p>LARGUS[ラルグス]</p></div><div class="item_info_text_middle_b"><p>SpecD[スペックD]</p></div>
</div>
</div>
<div class="set_menu_n row">
<div class="set_menu_n_330 col-md-6 col-sm-12 col-xs-12">
<div>
<div class="swiper-container"><div class="swiper-wrapper"><div class="swiper-slide"><img alt="SpecD" src="../../item_img/10111_1.jpg"/></div><div class="swiper-slide"><img alt="SpecD" src="../../item_img/10111_2.jpg"/></div><div class="swiper-slide"><img alt="SpecD" src="../../item_img/10111_3.jpg"/></div></div><div class="swiper-button-prev"></div><div class="swiper-button-next"></div></div>
</div>
<div class="item_caution"><p>※写真はイメージ・代表画像です。 </p><p>※実際の商品とカラーやイメージが異なる場合がございます。</p></div>
</div>
<div class="set_menu_n_cell col-md-6 col-sm-12 col-xs-12">
<a class="set-sale-switch" href="../../sale/item/10111.php">メニュー内容・物販へのリンク</a><div class="tab_wrap">
