<html>
<head>
<meta name="description" content="「N-ONE OWNER'S CUP」において最大限のポテンシャルを発揮できるよう、サーキットでの走行テストにより徹底的にセッティング。フロントのキャンバー角を始め、スプリングレートおよび減衰力をサーキット走行向けに最適化することで、ハイグリップタイヤを履かなくても確実なメカニカルグリップを引き出すとともに、サーキットでのスポーツ走行を存分に楽しめる車高調です。">
...
<title>KTS-web 工賃セットメニュー TEIN RACING FLEX</title>
...
<div class="mc_nav">
<a class="link" href="https://www.kts-web.com/">HOME</a> &gt; <a class="link" href="../../index.html">SHOP MENU</a> &gt; <a class="link" href="../index.html">工賃セットメニュー</a> &gt; <a class="link" href="../cat/100.html">足回り</a> &gt; <a class="link" href="../cat/116.html">車高調/セッティングパーツ</a> &gt; <a class="link" href="../br/1104-116.html">TEIN</a> &gt; <a class="link" href="10199.php">RACING FLEX</a></div>
<div class="space3px"></div>
<div class="set_sale_back">
<div class="space3px"></div>
<div class="set_menu_n">
<div class="set_menu_n_330">
<div><img src="../../brand/img/1104.gif" alt="RACING FLEX"></div></div>
<div class="set_menu_n_cell">
<div class="item_info_text_middle">
<p>TEIN[テイン]</p></div>
<div class="item_info_text_middle_b">
<p>RACING FLEX[レーシングフレックス]</p></div>
</div></div>
...
<div class="swiper-slide"><img src="../../item_img/10199_1.jpg" alt="RACING FLEX"></div>
<div class="swiper-slide"><img src="../../item_img/10199_2.jpg" alt="RACING FLEX"></div>
<div class="swiper-slide"><img src="../../item_img/10199_3.jpg" alt="RACING FLEX"></div>
</div>
...
<p>「N-ONE OWNER'S CUP」において最大限のポテンシャルを発揮できるよう、サーキットでの走行テストにより徹底的にセッティング。フロントのキャンバー角を始め、スプリングレートおよび減衰力をサーキット走行向けに最適化することで、ハイグリップタイヤを履かなくても確実なメカニカルグリップを引き出すとともに、サーキットでのスポーツ走行を存分に楽しめる車高調です。</p>
</div>
<div id="panel2" class="tab_panel">
<p>・全長調整式<br>・減衰力16段調整式<br>・複筒式<br>・EDFCシリーズ対応<br>・防錆コーティング<br>・1年1万キロ+固着保証<br>・オーバーホール/仕様変更可能</p>
</div>
</div>
</div>
</div>
...
<p class="search_category">**********【適合検索】**********&nbsp;&nbsp;<a class="change_button" href="../../sale/item/10199.php"><img src="../../img/sale_button.jpg" alt="単品販売の価格表はコチラ"></a></p>
</tr>
<tr>
<td>
<!-- 車両メーカー検索ココから -->
<p class="search_category">【自動車メーカー】</p>
<form method="post" action="10199.php">
...
if($data[0] == '10199') $position = explode(";", $data[1]);
}
array_pop($position);
fclose($fp_position);
...
<form name="make" method="post" action="10199.php">
