              ...
              <div class="set_sale_back">
                ...
                <div class="set_menu_n row">
                  <div class="set_menu_n_330 col-md-6 col-sm-12 col-xs-12">
                    <div><img alt="ローダウンスプリング" src="../../brand/img/1042.gif"/></div>
                  </div>
                  <div class="set_menu_n_cell col-md-6 col-sm-12 col-xs-12">
                    <div class="item_info_text_middle"><p>AutoExe[オートエグゼ]</p></div><div class="item_info_text_middle_b"><p>ローダウンスプリング</p></div>
                  </div>
                </div>
                <div class="set_menu_n row">
                  <div class="set_menu_n_330 col-md-6 col-sm-12 col-xs-12">
                    <div>
                      <div class="swiper-container"><div class="swiper-wrapper"><div class="swiper-slide"><img alt="ローダウンスプリング" src="../../item_img/10802_1.jpg"/></div><div class="swiper-slide"><img alt="ローダウンスプリング" src="../../item_img/10802_2.jpg"/></div><div class="swiper-slide"><img alt="ローダウンスプリング" src="../../item_img/10802_3.jpg"/></div></div><div class="swiper-button-prev"></div><div class="swiper-button-next"></div></div>
                    </div>
                    ...
                    <div class="tab_wrap">
                      ...
                      <div class="tab-content">
                        <div id="home" class="tab-pane fade in active show">
                          <p>タイヤチェーンの装着やロードクリアランスへの配慮など、不特定多数を対象に設計された量産車の腰高感は致し方ない。できれば乗り心地感はそのままに、タイヤとフェンダーの隙間を詰めて低く魅せたい・・・そんなオーナーに向けて、スタイルと乗り味を両立させたのがオートエグゼのローダウンスプリング。</p>
                        </div>
                        <div id="menu2" class="tab-pane fade">
                          <p>・1台分のセット<br/>・基本ダウン量：-20mm</p>
                        </div>
                      </div>
                      <script>
                ...
                <table style="table-layout:fixed;" width="100%">
                  ...
                  <tr>
                    ...
                    <p class="search_category">**********【商品検索】**********&nbsp;&nbsp;<a class="change_button" href="../../sale/item/10802.php"><img src="../../img/sale_button.jpg" alt="単品販売の価格表はコチラ"></a></p>
                  </tr>
                </table>
                  <?php
    							$root_dir = __DIR__.'/../../..';
