 <html>
							<head>
							<meta content="量産車のスタビライザーエンド部のリンクの長さは、量産車高を基準に設計されているため、ロアアームの角度が変化する車高ダウン時には、スタビライザー本体とスタビライザーリンクのアーム角が適正値より鋭角となり、本来のスタビライザー効果をスポイルしてしまう傾向にある。アジャスタブル（調整式）スタビライザーリンクはリンク長さを調整することで、アーム角を適正化し、スタビライザー本来の機能を復活させるアイテム。" name="description"/>
<meta content="text/html; charset=utf-8" http-equiv="Content-Type"/>
<meta content="width=device-width, user-scalable=yes, initial-scale=1, maximum-scale=1" name="viewport"/>
<meta content="width=device-width" name="viewport"><link href="../../../web_r.css" rel="stylesheet" type="text/css"/><link href="../../../header_r.css" rel="stylesheet" type="text/css"/><link href="../../../pc_left_menu.css" rel="stylesheet" type="text/css"/><link href="../../../sp_menu.css" rel="stylesheet" type="text/css"/><link href="../../shop_menu.css" rel="stylesheet" type="text/css"/><link href="../../set/set.css" rel="stylesheet" type="text/css"/><link href="../../set_sale.css" rel="stylesheet" type="text/css"/><link href="../../../product/product.css" rel="stylesheet" type="text/css"/><link href="../../script/swiper/css/swiper.css" rel="stylesheet"/><title>KTS-web 工賃セットメニュー AutoExe アジャスタブルスタビライザーリンク</title><script type="application/ld+json">{@context: "http://schema.org",@type: "BreadcrumbList",itemListElement:[{@type: "ListItem",position: 1,item:{@id: "/shop_menu/",name: "SHOP MENU"}},{@type: "ListItem",position: 2,item:{@id: "/set/",name: "工賃セットメニュー"}},{@type: "ListItem",position: 3,item:{@id: "/item/10771.php",name: "アジャスタブルスタビライザーリンク"}}]}</script><script src="https://ajax.googleapis.com/ajax/libs/jquery/3.1.1/jquery.min.js"></script><script type="text/javascript">$(function(){$("#toggle").click(function(){$("#menu").slideToggle();return false;});$(window).resize(function(){var win = $(window).width();var p = 480 ;if(win > p){$("#menu").show();}else {$("#menu").hide();}});});</script><script>(function(i,s,o,g,r,a,m){i['GoogleAnalyticsObject']=r;i[r]=i[r]||function(){(i[r].q=i[r].q||[]).push(arguments)},i[r].l=1*newDate();a=s.createElement(o),m=s.getElementsByTagName(o)[0];a.async=1;a.src=g;m.parentNode.insertBefore(a,m)})(window,document,'script','//www.google-analytics.com/analytics.js','ga');ga('create', 'UA-73570160-3', 'auto');ga('send', 'pageview');</script><script type="text/javascript">jQuery(function($) {$('tr[data-href]').addClass('clickable').click(function(e) {if(!$(e.target).is('a')){let href=$(e.target).closest('tr').data('href');window.open(href, "_blank");};});});</script></meta>
<title>KTS-web 工賃セットメニュー AutoExe アジャスタブルスタビライザーリンク</title>
              ...
              <div class="set_sale_back">
                ...
                <div class="set_menu_n row">
                  <div class="set_menu_n_330 col-md-6 col-sm-12 col-xs-12">
                    <div><img alt="アジャスタブルスタビライザーリンク" src="../../brand/img/1042.gif"/></div>
                  </div>
                  <div class="set_menu_n_cell col-md-6 col-sm-12 col-xs-12">
                    <div class="item_info_text_middle"><p>AutoExe[オートエグゼ]</p></div><div class="item_info_text_middle_b"><p>アジャスタブルスタビライザーリンク</p></div>
                  </div>
                </div>
                <div class="set_menu_n row">
                  <div class="set_menu_n_330 col-md-6 col-sm-12 col-xs-12">
                    <div>
                      <div class="swiper-container"><div class="swiper-wrapper"><div class="swiper-slide"><img alt="アジャスタブルスタビライザーリンク" src="../../item_img/10771_1.jpg"/></div><div class="swiper-slide"><img alt="アジャスタブルスタビライザーリンク" src="../../item_img/10771_2.jpg"/></div><div class="swiper-slide"><img alt="アジャスタブルスタビライザーリンク" src="../../item_img/10771_3.jpg"/></div></div><div class="swiper-button-prev"></div><div class="swiper-button-next"></div></div>
                    </div>
                    ...
                    <div class="tab_wrap">
                      ...
                      <div class="tab-content">
                        <div id="home" class="tab-pane fade in active show">
                          <p>量産車のスタビライザーエンド部のリンクの長さは、量産車高を基準に設計されているため、ロアアームの角度が変化する車高ダウン時には、スタビライザー本体とスタビライザーリンクのアーム角が適正値より鋭角となり、本来のスタビライザー効果をスポイルしてしまう傾向にある。アジャスタブル（調整式）スタビライザーリンクはリンク長さを調整することで、アーム角を適正化し、スタビライザー本来の機能を復活させるアイテム。</p>
                        </div>
                        <div id="menu2" class="tab-pane fade">
                          <p>・調整式<br/>・プッシュ式<br/>→RX-8/ロードスター/MPV(LY)用など<br/>・プル式<br/>→MAZDA2/MAZDA3/CX-5用など</p>
                        </div>
                      </div>
                      <script>
                ...
                <table style="table-layout:fixed;" width="100%">
                  ...
                  <tr>
                    ...
                    <p class="search_category">**********【商品検索】**********&nbsp;&nbsp;<a class="change_button" href="../../sale/item/10771.php"><img src="../../img/sale_button.jpg" alt="単品販売の価格表はコチラ"></a></p>
                  </tr>
                </table>
                  <?php
    							$root_dir = __DIR__.'/../../..';
                  ...
                  <form action="<?=$uri?>" method="post" class="row ja">
                    <div class="search-select col-md-4 col-sm-4">
                      <select class="custom-select-lg" name="car_manu" onchange="this.form.car_model_cat=''; this.form.product_name = ''; submit(this.form)">
                        ...
                        <option value="<?=$value?>" <?php if($car_manu==$value) echo 'selected' ; ?>>
                          <?=$value?>
                        </option>
                        <?php }} ?>
                      </select>
                    ...
                    <div class="search-select col-md-4 col-sm-4">
                      <select class="custom-select-lg" name="car_model_cat" onchange="this.form.product_name = ''; submit(this.form)">
                        ...
                        <option value="<?=$value?>" <?php if($car_model_cat==$value) echo 'selected' ; ?>>
                          <?=$value?>
                        </option>
                        <?php }} ?>
                      </select>
                    ...
                    <div class="search-select col-md-4 col-sm-4">
                      <select class="custom-select-lg" name="product_name">
                        ...
                        <option value="<?=$value?>" <?php if($product_name==$value) echo 'selected' ; ?>>
                          <?=$value?>
                        </option>
                        <?php }} ?>
                      </select>
                    ...
                    <br>
                    <div class="clearfix"></div>
                    <button type="submit" class="btn-search">検索
                    </button>
                  </form>
