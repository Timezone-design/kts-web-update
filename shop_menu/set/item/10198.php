...
<title>KTS-web 工賃セットメニュー TEIN SUPER DRIFT</title>
...
<div class="mc_nav">
<a class="link" href="https://www.kts-web.com/">HOME</a> &gt; <a class="link" href="../../index.html">SHOP MENU</a> &gt; <a class="link" href="../index.html">工賃セットメニュー</a> &gt; <a class="link" href="../cat/100.html">足回り</a> &gt; <a class="link" href="../cat/116.html">車高調/セッティングパーツ</a> &gt; <a class="link" href="../br/1104-116.html">TEIN</a> &gt; <a class="link" href="10198.php">SUPER DRIFT</a></div>
<div class="space3px"></div>
<div class="set_sale_back">
<div class="space3px"></div>
<div class="set_menu_n">
<div class="set_menu_n_330">
<div><img src="../../brand/img/1104.gif" alt="SUPER DRIFT"></div></div>
<div class="set_menu_n_cell">
<div class="item_info_text_middle">
<p>TEIN[テイン]</p></div>
<div class="item_info_text_middle_b">
<p>SUPER DRIFT[スーパードリフト]</p></div>
</div></div>
...
<div class="swiper-slide"><img src="../../item_img/10198_1.jpg" alt="SUPER DRIFT"></div>
<div class="swiper-slide"><img src="../../item_img/10198_2.jpg" alt="SUPER DRIFT"></div>
<div class="swiper-slide"><img src="../../item_img/10198_3.jpg" alt="SUPER DRIFT"></div>
</div>
...
<p>走行会専用に限定し、車高を下げた時のバンブストロークを確保、ドリフト時のコントロール性を極限まで高めています。多様な機能を使ってセッティングすることで、グリップ走行においても性能を十分に発揮することが可能。ユーザーの使用頻度が高いインチアップサイズでの設定。</p>
</div>
<div id="panel2" class="tab_panel">
<p>・全長調整式<br>・減衰力16段調整式<br>・ピロボールアッパーマウント<br>・複筒式構造<br>・防錆コーティング<br>・EDFCシリーズ対応</p>
</div>
</div>
</div>
</div>
...
<p class="search_category">**********【適合検索】**********&nbsp;&nbsp;<a class="change_button" href="../../sale/item/10198.php"><img src="../../img/sale_button.jpg" alt="単品販売の価格表はコチラ"></a></p>
</tr>
<tr>
<td>
<!-- 車両メーカー検索ココから -->
<p class="search_category">【自動車メーカー】</p>
<form method="post" action="10198.php">
...
if($data[0] == '10198') $position = explode(";", $data[1]);
}
array_pop($position);
fclose($fp_position);
...
<form name="make" method="post" action="10198.php">
