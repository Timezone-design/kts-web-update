	              ...
	              <div class="set_sale_back">
	                    ...
	                    <div class="tab_wrap">
	                      ...
	                      <div class="tab-content">
	                        <div id="home" class="tab-pane fade in active show">
	                          <p>より軽く、よりダイレクトに。勝つためだけに存在するピュアレーシングクラッチ。<br/>スーパー耐久など、タイトなレースシーンにおいて勝つ為に生まれたレーシングコンセプト。限界までに軽量化されたフライホイールが今までに体感したことのない吹け上がりを実現。超攻撃的な走りを可能とするサーキットスペック超軽量クラッチです。</p>
	                        </div>
	                        <div id="menu2" class="tab-pane fade">
	                          <p>・超軽量フライホイール採用<br/>・専用超軽量クラッチカバー採用<br/>・ツインプレートはダンパーレス</p>
	                        </div>
	                      </div>
	                      <script>
	                ...
	                <table style="table-layout:fixed;" width="100%">
	                  ...
	                  <tr>
	                    ...
	                    <p class="search_category">**********【商品検索】**********&nbsp;&nbsp;<a class="change_button" href="../../sale/item/10528.php"><img src="../../img/sale_button.jpg" alt="単品販売の価格表はコチラ"></a></p>
	                  </tr>
	                </table>
	                  <?php
	                  	$root_dir = __DIR__.'/../../..';
