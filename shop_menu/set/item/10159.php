<html>
 <head>
  ...
  <title>
   KTS-web 工賃セットメニュー Street Ride TYPE-K2 MODEL COMFORT
  </title>
  <script type="application/ld+json">
   {@context: "http://schema.org",@type: "BreadcrumbList",itemListElement:[{@type: "ListItem",position: 1,item:{@id: "/shop_menu/",name: "SHOP MENU"}},{@type: "ListItem",position: 2,item:{@id: "/set/",name: "工賃セットメニュー"}},{@type: "ListItem",position: 3,item:{@id: "/item/10159.php",name: "TYPE-K2 MODEL COMFORT"}}]}
  </script>
       ...
       <div class="set_sale_back">
        ...
        <div class="set_menu_n row">
         <div class="set_menu_n_330 col-md-6 col-sm-12 col-xs-12">
          <div>
           <img alt="TYPE-K2 MODEL COMFORT" src="../../brand/img/1090.gif"/>
          </div>
         </div>
         <div class="set_menu_n_cell col-md-6 col-sm-12 col-xs-12">
          ...
          <div class="item_info_text_middle_b">
           <p>
            TYPE-K2 MODEL COMFORT[タイプK2 モデル コンフォート]
           </p>
          </div>
         </div>
        </div>
           ...
           <div class="swiper-container">
            <div class="swiper-wrapper">
             <div class="swiper-slide">
              <img alt="TYPE-K2 MODEL COMFORT" src="../../item_img/10159_1.jpg"/>
             </div>
             <div class="swiper-slide">
              <img alt="TYPE-K2 MODEL COMFORT" src="../../item_img/10159_2.jpg"/>
             </div>
             <div class="swiper-slide">
              <img alt="TYPE-K2 MODEL COMFORT" src="../../item_img/10159_3.jpg"/>
             </div>
            </div>
