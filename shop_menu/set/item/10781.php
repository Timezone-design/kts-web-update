              ...
              <div class="set_sale_back">
                ...
                <div class="set_menu_n row">
                  <div class="set_menu_n_330 col-md-6 col-sm-12 col-xs-12">
                    <div><img alt="ストリートスポーツ サスキット" src="../../brand/img/1042.gif"/></div>
                  </div>
                  <div class="set_menu_n_cell col-md-6 col-sm-12 col-xs-12">
                    <div class="item_info_text_middle"><p>AutoExe[オートエグゼ]</p></div><div class="item_info_text_middle_b"><p>ストリートスポーツ サスキット</p></div>
                  </div>
                </div>
                <div class="set_menu_n row">
                  <div class="set_menu_n_330 col-md-6 col-sm-12 col-xs-12">
                    <div>
                      <div class="swiper-container"><div class="swiper-wrapper"><div class="swiper-slide"><img alt="ストリートスポーツ サスキット" src="../../item_img/10781_1.jpg"/></div><div class="swiper-slide"><img alt="ストリートスポーツ サスキット" src="../../item_img/10781_2.jpg"/></div><div class="swiper-slide"><img alt="ストリートスポーツ サスキット" src="../../item_img/10781_3.jpg"/></div></div><div class="swiper-button-prev"></div><div class="swiper-button-next"></div></div>
                    </div>
                    ...
                    <div class="tab_wrap">
                      ...
                      <div class="tab-content">
                        <div id="home" class="tab-pane fade in active show">
                          <p>AutoExeが考えるストリートベストな乗り味を追求した車高調整式キット。<br/>マツダ(株)在籍中にサスペンションの権威として数々のスポーツカーの開発に携わった貴島孝雄氏が提唱する「動的感性工学」に基づき誕生したモデル。ダンパーとスプリングを自在に組み合わせる一体設計のアドバンテージを存分に活かし、単に絶対性能や限界の高さではない、乗り味の奥深さを具現化している。</p>
                        </div>
                        <div id="menu2" class="tab-pane fade">
                          <p>・高精度ツインチューブダンパー<br/>・専用スプリング<br/>・全長調整式車高調整機構<br/>・量産アッパーマウントを活用</p>
                        </div>
                      </div>
                      <script>
                ...
                <table style="table-layout:fixed;" width="100%">
                  ...
                  <tr>
                    ...
                    <p class="search_category">**********【商品検索】**********&nbsp;&nbsp;<a class="change_button" href="../../sale/item/10781.php"><img src="../../img/sale_button.jpg" alt="単品販売の価格表はコチラ"></a></p>
                  </tr>
                </table>
                  <?php
    							$root_dir = __DIR__.'/../../..';
