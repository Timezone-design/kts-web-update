	              ...
	              <div class="set_sale_back">
	                    ...
	                    <div class="tab_wrap">
	                      ...
	                      <div class="tab-content">
	                        <div id="home" class="tab-pane fade in active show">
	                          <p>STREETシリーズよりさらに上を求める方へ。サーキットなどのスポーツ走行をメインに使用されるユーザー向けのサスペンションです。<br/>専用シリンダーや高設定のバネレートなど「熱い走り」を求める方向け。STREETシリーズをより日本のサーキット走行＆ドリフト走行などのハードなスポーツ色へ強調したモデルです。</p>
	                        </div>
	                        <div id="menu2" class="tab-pane fade">
	                          <p>・全長調整(フルタップ)式<br/>・減衰力32段調整<br/>・アッパーマウント標準装備(一部車両を除く)<br/>・ダストブーツ標準装備<br/>・アルミ製ブラケット標準装備<br/>・安心の1年保証<br/>・単筒式(モノチューブ)ショックアブソーバー採用<br/></p>
	                        </div>
	                      </div>
	                      <script>
	                ...
	                <table style="table-layout:fixed;" width="100%">
	                  ...
	                  <tr>
	                    ...
	                    <p class="search_category">**********【商品検索】**********&nbsp;&nbsp;<a class="change_button" href="../../sale/item/10679.php"><img src="../../img/sale_button.jpg" alt="単品販売の価格表はコチラ"></a></p>
	                  </tr>
	                </table>
	                  <?php
	                  	$root_dir = __DIR__.'/../../..';
