 <html>
								<head>
								<meta content="タワーバーの進化形。ボディ前後をダブルで強化。スチール製オーバルシャフトを基本に、2方向応力分散構造や面圧分散構造など、マウントポイントに応力が集中しないよう各車種の特性を見据えた専用レイアウトを採用。ボルトオン装着によるボディ補強パーツとして最大限の効果を狙った設計。" name="description"/>
<meta content="text/html; charset=utf-8" http-equiv="Content-Type"><meta content="width=device-width, user-scalable=yes, initial-scale=1, maximum-scale=1" name="viewport"/><meta content="width=device-width" name="viewport"/><title>KTS-web 工賃セットメニュー AutoExe タワーブレースセット</title><script type="application/ld+json">{@context: "http://schema.org",@type: "BreadcrumbList",itemListElement:[{@type: "ListItem",position: 1,item:{@id: "/shop_menu/",name: "SHOP MENU"}},{@type: "ListItem",position: 2,item:{@id: "/set/",name: "工賃セットメニュー"}},{@type: "ListItem",position: 3,item:{@id: "/item/10794.php",name: "タワーブレースセット"}}]}</script><script src="https://ajax.googleapis.com/ajax/libs/jquery/3.1.1/jquery.min.js"></script>
<meta content="width=device-width, user-scalable=yes, initial-scale=1, maximum-scale=1" name="viewport"/>
<meta content="width=device-width" name="viewport"/>
<title>KTS-web 工賃セットメニュー AutoExe タワーブレースセット</title>
	              ...
	              <div class="set_sale_back">
	                ...
	                <div class="set_menu_n row">
	                  <div class="set_menu_n_330 col-md-6 col-sm-12 col-xs-12">
	                    <div><img alt="タワーブレースセット" src="../../brand/img/1042.gif"/></div>
	                  </div>
	                  <div class="set_menu_n_cell col-md-6 col-sm-12 col-xs-12">
	                    <div class="item_info_text_middle"><p>AutoExe[オートエグゼ]</p></div><div class="item_info_text_middle_b"><p>タワーブレースセット</p></div>
	                  </div>
	                </div>
	                <div class="set_menu_n row">
	                  <div class="set_menu_n_330 col-md-6 col-sm-12 col-xs-12">
	                    <div>
	                      <div class="swiper-container"><div class="swiper-wrapper"><div class="swiper-slide"><img alt="タワーブレースセット" src="../../item_img/10794_1.jpg"/></div><div class="swiper-slide"><img alt="タワーブレースセット" src="../../item_img/10794_2.jpg"/></div><div class="swiper-slide"><img alt="タワーブレースセット" src="../../item_img/10794_3.jpg"/></div></div><div class="swiper-button-prev"></div><div class="swiper-button-next"></div></div>
	                    </div>
	                    ...
	                    <div class="tab_wrap">
	                      ...
	                      <div class="tab-content">
	                        <div id="home" class="tab-pane fade in active show">
	                          <p>タワーバーの進化形。ボディ前後をダブルで強化。スチール製オーバルシャフトを基本に、2方向応力分散構造や面圧分散構造など、マウントポイントに応力が集中しないよう各車種の特性を見据えた専用レイアウトを採用。ボルトオン装着によるボディ補強パーツとして最大限の効果を狙った設計。</p>
	                        </div>
	                ...
	                <table style="table-layout:fixed;" width="100%">
	                  ...
	                  <tr>
	                    ...
	                    <p class="search_category">**********【商品検索】**********&nbsp;&nbsp;<a class="change_button" href="../../sale/item/10794.php"><img src="../../img/sale_button.jpg" alt="単品販売の価格表はコチラ"></a></p>
	                  </tr>
	                </table>
	                  <?php
	                  	$root_dir = __DIR__.'/../../..';
