 <html>
<head>
<meta content="発売当初より、セミメタルブレーキパッドの定番であるMX72から正統進化を遂げた「MX72 PLUS」はMX72に比べ集会を重ねた際に起こる熱ダレを遅らせることで、更なるサーキット向けセミメタルブレーキパッドへと進化しました。&lt;br&gt;さらにはコントロール性を重視し、圧倒的な初期制動ではないコントローラブルな効きは、小排気量から大排気量を中心とした車種に置いて最適なブレーキパッドとなります。" name="description"/>
<meta content="text/html; charset=utf-8" http-equiv="Content-Type"/><meta content="width=device-width, user-scalable=yes, initial-scale=1, maximum-scale=1" name="viewport"><meta content="width=device-width" name="viewport"/><title>KTS-web 工賃セットメニュー ENDLESS MX72PLUS</title><script type="application/ld+json">{@context: "http://schema.org",@type: "BreadcrumbList",itemListElement:[{@type: "ListItem",position: 1,item:{@id: "/shop_menu/",name: "SHOP MENU"}},{@type: "ListItem",position: 2,item:{@id: "/set/",name: "工賃セットメニュー"}},{@type: "ListItem",position: 3,item:{@id: "/item/10300.php",name: "MX72PLUS"}}]}</script><script src="https://ajax.googleapis.com/ajax/libs/jquery/3.1.1/jquery.min.js"></script>
<meta content="width=device-width, user-scalable=yes, initial-scale=1, maximum-scale=1" name="viewport"/>
<meta content="width=device-width" name="viewport"/>
<title>KTS-web 工賃セットメニュー ENDLESS MX72PLUS</title>
...
<div><img alt="MX72PLUS" src="../../brand/img/1038.gif"/></div>
</div>
<div class="set_menu_n_cell col-md-6 col-sm-12 col-xs-12">
<div class="item_info_text_middle"><p>ENDLESS[エンドレス]</p></div><div class="item_info_text_middle_b"><p>MX72PLUS[MX72プラス]</p></div>
</div>
</div>
<div class="set_menu_n row">
<div class="set_menu_n_330 col-md-6 col-sm-12 col-xs-12">
<div>
<div class="swiper-container"><div class="swiper-wrapper"><div class="swiper-slide"><img alt="MX72PLUS" src="../../item_img/10300_1.jpg"/></div><div class="swiper-slide"><img alt="MX72PLUS" src="../../item_img/10300_2.jpg"/></div><div class="swiper-slide"><img alt="MX72PLUS" src="../../item_img/10300_3.jpg"/></div></div><div class="swiper-button-prev"></div><div class="swiper-button-next"></div></div>
</div>
<div class="item_caution"><p>※写真はイメージ・代表画像です。 </p><p>※実際の商品とカラーやイメージが異なる場合がございます。</p></div>
</div>
<div class="set_menu_n_cell col-md-6 col-sm-12 col-xs-12">
<a class="set-sale-switch" href="../../sale/item/10300.php">メニュー内容・物販へのリンク</a><div class="tab_wrap">
