	              ...
	              <div class="set_sale_back">
	                    ...
	                    <div class="tab_wrap">
	                      ...
	                      <div class="tab-content">
	                        <div id="home" class="tab-pane fade in active show">
	                          <p>発売当初より、セミメタルブレーキパッドの定番であるMX72から正統進化を遂げた「MX72 PLUS」はMX72に比べ集会を重ねた際に起こる熱ダレを遅らせることで、更なるサーキット向けセミメタルブレーキパッドへと進化しました。<br/>さらにはコントロール性を重視し、圧倒的な初期制動ではないコントローラブルな効きは、小排気量から大排気量を中心とした車種に置いて最適なブレーキパッドとなります。</p>
	                        </div>
	                        <div id="menu2" class="tab-pane fade">
	                          <p>・ローター適正温度域：50～750℃<br/>・平均摩擦係数：0.39～0.47<br/>・材質：セラミックカーボンメタル<br/>・フィールド：ストリート-サーキット<br/>・タイヤ：ラジアル-ハイグリップラジアル</p>
	                        </div>
	                      </div>
	                      <script>
	                ...
	                <table style="table-layout:fixed;" width="100%">
	                  ...
	                  <tr>
	                    ...
	                    <p class="search_category">**********【商品検索】**********&nbsp;&nbsp;<a class="change_button" href="../../sale/item/10300.php"><img src="../../img/sale_button.jpg" alt="単品販売の価格表はコチラ"></a></p>
	                  </tr>
	                </table>
	                  <?php
	                  	$root_dir = __DIR__.'/../../..';
