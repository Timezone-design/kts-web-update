	              ...
	              <div class="set_sale_back">
	                    ...
	                    <div class="tab_wrap">
	                      ...
	                      <div class="tab-content">
	                        <div id="home" class="tab-pane fade in active show">
	                          <p>通常FF車は、ブレーキング時にリヤが浮き上がり、十分な荷重が得られず、リヤに効きの高いパッドを装着するとロックしてしまう傾向があります。そこでRNタイプは初期ミューと全体ミューをバランスフルに整えることを最大のテーマにすえて開発に着手。その結果、初期ミューはしっかりと立ち上がらせながら、かつ全体ミューを低く抑えた特性のコンペティションパッドが誕生しました。</p>
	                        </div>
	                        <div id="menu2" class="tab-pane fade">
	                          <p>・材質:ノンアスベスト<br/>・ステージ:N1レース/サーキット走行</p>
	                        </div>
	                      </div>
	                      <script>
	                ...
	                <table style="table-layout:fixed;" width="100%">
	                  ...
	                  <tr>
	                    ...
	                    <p class="search_category">**********【商品検索】**********&nbsp;&nbsp;<a class="change_button" href="../../sale/item/10355.php"><img src="../../img/sale_button.jpg" alt="単品販売の価格表はコチラ"></a></p>
	                  </tr>
	                </table>
	                  <?php
	                  	$root_dir = __DIR__.'/../../..';
