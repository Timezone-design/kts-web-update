              ...
              <div class="set_sale_back">
                ...
                <div class="set_menu_n row">
                  <div class="set_menu_n_330 col-md-6 col-sm-12 col-xs-12">
                    <div><img alt="スポーツダンパー" src="../../brand/img/1042.gif"/></div>
                  </div>
                  <div class="set_menu_n_cell col-md-6 col-sm-12 col-xs-12">
                    <div class="item_info_text_middle"><p>AutoExe[オートエグゼ]</p></div><div class="item_info_text_middle_b"><p>スポーツダンパー</p></div>
                  </div>
                </div>
                <div class="set_menu_n row">
                  <div class="set_menu_n_330 col-md-6 col-sm-12 col-xs-12">
                    <div>
                      <div class="swiper-container"><div class="swiper-wrapper"><div class="swiper-slide"><img alt="スポーツダンパー" src="../../item_img/10789_1.jpg"/></div><div class="swiper-slide"><img alt="スポーツダンパー" src="../../item_img/10789_2.jpg"/></div><div class="swiper-slide"><img alt="スポーツダンパー" src="../../item_img/10789_3.jpg"/></div></div><div class="swiper-button-prev"></div><div class="swiper-button-next"></div></div>
                    </div>
                    ...
                    <div class="tab_wrap">
                      ...
                      <div class="tab-content">
                        <div id="home" class="tab-pane fade in active show">
                          <p>車高を下げずに意のままのハンドリングへ。量産形状品。内部のピストンにダンパーが動き始める瞬間から精密な減衰力を発生させる｢高精度微低速バルブ｣を採用。0.05m/sec以下の微低速域から減衰力を急カーブで立ち上げることで、ステアリング操作に対して、素早く反応する特性を狙っている。反面、突き上げの原因となる0.1m/sec以降の減衰力をなだらかに、また縮み側の減衰力を低めに抑えることで乗り心地に配慮。</p>
                        </div>
                        <div id="menu2" class="tab-pane fade">
                          <p>・量産形状品<br/>・ツインチューブ<br/>・減衰力固定式<br/>・1台分のセット</p>
                        </div>
                      </div>
                      <script>
                ...
                <table style="table-layout:fixed;" width="100%">
                  ...
                  <tr>
                    ...
                    <p class="search_category">**********【商品検索】**********&nbsp;&nbsp;<a class="change_button" href="../../sale/item/10789.php"><img src="../../img/sale_button.jpg" alt="単品販売の価格表はコチラ"></a></p>
                  </tr>
                </table>
                  <?php
    							$root_dir = __DIR__.'/../../..';
