 <html>
<head>
<meta content="SPORT Rの設計思想・スペックをそのままに、より多くのユーザーを対象とするストリート向けに減衰力・バネレート・ストロークをセッティング。スポーツラジアルタイヤでのスポーツ走行をターゲットとしたセットアップ。さらに伸側24段、圧側24段の減衰力完全独立制御により、コーナー進入時、旋回時、立ち上がり時のアンダーステア、オーバーステアの修正や、スプリングレート変更時の細かなセットアップを可能としています。ストリートでの使用を考慮し(音、乗り心地など)リヤアッパーマウントには強化ゴムアッパーマウントを採用(ウイッシュボーン車は前後共に採用)。大きな入力にもしっかり対応する為、大口径ピストンを使用し安定した減衰力を発生。" name="description"/>
<meta content="text/html; charset=utf-8" http-equiv="Content-Type"/><meta content="width=device-width, user-scalable=yes, initial-scale=1, maximum-scale=1" name="viewport"><meta content="width=device-width" name="viewport"/><title>KTS-web 工賃セットメニュー CUSCO SPORT TN_S</title><script type="application/ld+json">{@context: "http://schema.org",@type: "BreadcrumbList",itemListElement:[{@type: "ListItem",position: 1,item:{@id: "/shop_menu/",name: "SHOP MENU"}},{@type: "ListItem",position: 2,item:{@id: "/set/",name: "工賃セットメニュー"}},{@type: "ListItem",position: 3,item:{@id: "/item/10021.php",name: "SPORT TN_S"}}]}</script><script src="https://ajax.googleapis.com/ajax/libs/jquery/3.1.1/jquery.min.js"></script>
...
<div><img alt="SPORT TN_S" src="../../brand/img/1059.gif"/></div>
</div>
<div class="set_menu_n_cell col-md-6 col-sm-12 col-xs-12">
<div class="item_info_text_middle"><p>CUSCO[クスコ]</p></div><div class="item_info_text_middle_b"><p>SPORT TN_S[スポーツTN_S]</p></div>
</div>
</div>
<div class="set_menu_n row">
<div class="set_menu_n_330 col-md-6 col-sm-12 col-xs-12">
<div>
<div class="swiper-container"><div class="swiper-wrapper"><div class="swiper-slide"><img alt="SPORT TN_S" src="../../item_img/10021_1.jpg"/></div><div class="swiper-slide"><img alt="SPORT TN_S" src="../../item_img/10021_2.jpg"/></div><div class="swiper-slide"><img alt="SPORT TN_S" src="../../item_img/10021_3.jpg"/></div></div><div class="swiper-button-prev"></div><div class="swiper-button-next"></div></div>
</div>
<div class="item_caution"><p>※写真はイメージ・代表画像です。 </p><p>※実際の商品とカラーやイメージが異なる場合がございます。</p></div>
</div>
<div class="set_menu_n_cell col-md-6 col-sm-12 col-xs-12">
<a class="set-sale-switch" href="../../sale/item/10021.php">メニュー内容・物販へのリンク</a><div class="tab_wrap">
