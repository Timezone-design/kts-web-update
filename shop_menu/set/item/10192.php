<html>
 <head>
  ...
  <title>
   KTS-web 工賃セットメニュー TEIN MONO SPORT TURING
  </title>
  <script type="application/ld+json">
   {@context: "http://schema.org",@type: "BreadcrumbList",itemListElement:[{@type: "ListItem",position: 1,item:{@id: "/shop_menu/",name: "SHOP MENU"}},{@type: "ListItem",position: 2,item:{@id: "/set/",name: "工賃セットメニュー"}},{@type: "ListItem",position: 3,item:{@id: "/item/10192.php",name: "MONO SPORT TURING"}}]}
  </script>
...
<!-- <header class="site-header">
       ...
       <div id="top-carousel">
        <div class="header-banner-wrapper">
         <div class="row">
          ...
          <div class="col-md-3 col-sm-6 col-xs-6">
           <a href="/shop_menu/sale/ch_ma/liqui_moly_dpf.html">
            <span>
             詳しく見る
            </span>
      ...
      <div class="main_c row grey-wrapper">
       <div class="mc_nav">
        ...
        &gt;
        <a class="link" href="../cat/100.html">
         足回り
        </a>
        &gt;
        <a class="link" href="../cat/116.html">
         車高調/セッティングパーツ
        </a>
        &gt;
        <a class="link" href="../br/1104-116.html">
         TEIN
        </a>
        &gt;
        <a class="link" href="10192.php">
         MONO SPORT TURING
        </a>
       </div>
       <div class="clearfix">
       ...
       <div class="set_sale_back">
        ...
        <div class="set_menu_n row">
         <div class="set_menu_n_330 col-md-6 col-sm-12 col-xs-12">
          <div>
           <img alt="MONO SPORT TURING" src="../../brand/img/1104.gif"/>
          </div>
         </div>
        ...
        <div class="set_menu_n row">
           ...
           <div class="swiper-container">
            <div class="swiper-wrapper">
             <div class="swiper-slide">
              <img alt="MONO SPORT TURING" src="../../item_img/10192_1.jpg"/>
             </div>
             <div class="swiper-slide">
              <img alt="MONO SPORT TURING" src="../../item_img/10192_2.jpg"/>
             </div>
             <div class="swiper-slide">
              <img alt="MONO SPORT TURING" src="../../item_img/10192_3.jpg"/>
             </div>
            </div>
         ...
         <div class="set_menu_n_cell col-md-6 col-sm-12 col-xs-12">
          <div class="menu_content_heading">
           メニュー内容
          </div>
          <div class="menu_content_text">
          </div>
          <a href="../../sale/item/10192.php">
           <img alt="物販へのリンク" src="../img/itemlead_to_mono.jpg"/>
          </a>
         </div>
         <details>
          <summary>
           <div class="change_button">
            <img alt="TEIN EDFC ACTIVE" src="../../img/option_button.jpg"/>
           </div>
          </summary>
          <div class="set_menu_text">
           <span class="item_info_text_middle_b">
            ・TEIN EDFC ACTIVE
           </span>
          </div>
          <div class="set_menu_n">
           <div class="set_menu_n_200">
            <img alt="TEIN EDFC ACTIVE" src="../img/tein_edfc_active.jpg"/>
           </div>
           <div class="set_menu_n_cell">
            <div class="option_menu_text">
             <div>
              EDFCの機能に加え、内蔵されたGセンサにより走行中の加減速Gに応じた減衰力の自動調整が可能。
             </div>
             <div>
              別売りのGPSキットを追加することで車速に応じた減衰力の自動調整も可能とします。
             </div>
            </div>
            <div class="set_price_left">
             取付工賃込み価格：
             <span class="font_f00">
              ￥73,000
             </span>
            </div>
            <div class="option_caution">
             ※GPSキットの追加はプラス￥10,300
            </div>
           </div>
          </div>
          ...
          <div class="set_menu_n">
           <div class="set_menu_n_200">
            <img alt="TEIN EDFC ACTIVE" src="../img/tein_edfc_active_pro.jpg"/>
           </div>
           <div class="set_menu_n_cell">
            <div class="option_menu_text">
             <div>
              EDFC ACTIVEの機能に加え、4輪独立減衰力調整、旋回G感応調整、車速信号の入力機能など様々な新機能が追加されたハイスペックバージョンです。
             </div>
             <div>
              別売りのGPSキットを追加することで車速に応じた減衰力の自動調整も可能とします。
             </div>
          ...
          <div class="option_caution">
           ※価格はKTSにて対応のTEIN製品をご購入・お取付のお客様に限ります。
          </div>
          <div class="option_caution">
           ※車種によってエクステンションキットなど別途オプションパーツが必要となり追加料金が発生する場合があります。
           <br/>
           該当車種などについてはメーカーHPをご覧頂くか、最寄のKTS店舗までお問合せ下さい。
          </div>
         </details>
        </div>
        <div class="clearfix">
