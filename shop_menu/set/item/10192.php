<html>
<head>
<meta name="description" content="車種ごとのニーズに応える、こだわりのセッティング！MONO SPORTは、すべての人に「走るよろこび」を提供することをコンセプトに開発。サーキットでのスポーツ走行を楽しむような車種には、スポーツ走行を考慮したセッティングとし、ドライバーのスポーツマインドを高める正確なステアリングフィールに加え、しなやかさも兼ね揃えています。サーキット走行やワインディング走行を愉しんで頂けることは勿論のこと、減衰力の調整により、普段使いの街乗りも問題無く使用可能です。">
...
<title>KTS-web 工賃セットメニュー TEIN MONO SPORT TURING</title>
...
<div class="mc_nav">
<a class="link" href="https://www.kts-web.com/">HOME</a> &gt; <a class="link" href="../../index.html">SHOP MENU</a> &gt; <a class="link" href="../index.html">工賃セットメニュー</a> &gt; <a class="link" href="../cat/100.html">足回り</a> &gt; <a class="link" href="../cat/116.html">車高調/セッティングパーツ</a> &gt; <a class="link" href="../br/1104-116.html">TEIN</a> &gt; <a class="link" href="10192.php">MONO SPORT TURING</a></div>
<div class="space3px"></div>
<div class="set_sale_back">
<div class="space3px"></div>
<div class="set_menu_n">
<div class="set_menu_n_330">
<div><img src="../../brand/img/1104.gif" alt="MONO SPORT TURING"></div></div>
<div class="set_menu_n_cell">
<div class="item_info_text_middle">
<p>TEIN[テイン]</p></div>
<div class="item_info_text_middle_b">
<p>MONO SPORT TURING[モノスポーツツーリング]</p></div>
</div></div>
...
<div class="swiper-slide"><img src="../../item_img/10192_1.jpg" alt="MONO SPORT TURING"></div>
<div class="swiper-slide"><img src="../../item_img/10192_2.jpg" alt="MONO SPORT TURING"></div>
<div class="swiper-slide"><img src="../../item_img/10192_3.jpg" alt="MONO SPORT TURING"></div>
</div>
...
<p>車種ごとのニーズに応える、こだわりのセッティング！MONO SPORTは、すべての人に「走るよろこび」を提供することをコンセプトに開発。サーキットでのスポーツ走行を楽しむような車種には、スポーツ走行を考慮したセッティングとし、ドライバーのスポーツマインドを高める正確なステアリングフィールに加え、しなやかさも兼ね揃えています。サーキット走行やワインディング走行を愉しんで頂けることは勿論のこと、減衰力の調整により、普段使いの街乗りも問題無く使用可能です。</p>
</div>
<div id="panel2" class="tab_panel">
<p>・全長調整式<br>・単筒式<br>・減衰力16段調整式<br>・マウント付※一部車種を除く<br>・EDFCシリーズ対応<br>・防錆コーティング<br>・3年6万キロ保証<br>・オーバーホール/仕様変更可能</p>
</div>
</div>
</div>
</div>
...
<div class="item_info_text_middle_b">
<p>MONO SPORT TURING [モノスポーツツーリング]</p>
</div>
<div class="tab_wrap">
...
<!--ココからOP-->
    <div class="space3px"></div>
<details><summary><div class="change_button"><img src="../../img/option_button.jpg" alt="TEIN EDFC ACTIVE"></div></summary>
...
<p class="search_category">**********【適合検索】**********&nbsp;&nbsp;<a class="change_button" href="../../sale/item/10192.php"><img src="../../img/sale_button.jpg" alt="単品販売の価格表はコチラ"></a></p>
</tr>
<tr>
<td>
<!-- 車両メーカー検索ココから -->
<p class="search_category">【自動車メーカー】</p>
<form method="post" action="10192.php">
...
if($data[0] == '10192') $position = explode(";", $data[1]);
}
array_pop($position);
fclose($fp_position);
...
<form name="make" method="post" action="10192.php">
