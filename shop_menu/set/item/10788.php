              ...
              <div class="set_sale_back">
                ...
                <div class="set_menu_n row">
                  <div class="set_menu_n_330 col-md-6 col-sm-12 col-xs-12">
                    <div><img alt="スポーツタイロッドエンド" src="../../brand/img/1042.gif"/></div>
                  </div>
                  <div class="set_menu_n_cell col-md-6 col-sm-12 col-xs-12">
                    <div class="item_info_text_middle"><p>AutoExe[オートエグゼ]</p></div><div class="item_info_text_middle_b"><p>スポーツタイロッドエンド</p></div>
                  </div>
                </div>
                <div class="set_menu_n row">
                  <div class="set_menu_n_330 col-md-6 col-sm-12 col-xs-12">
                    <div>
                      <div class="swiper-container"><div class="swiper-wrapper"><div class="swiper-slide"><img alt="スポーツタイロッドエンド" src="../../item_img/10788_1.jpg"/></div><div class="swiper-slide"><img alt="スポーツタイロッドエンド" src="../../item_img/10788_2.jpg"/></div><div class="swiper-slide"><img alt="スポーツタイロッドエンド" src="../../item_img/10788_3.jpg"/></div></div><div class="swiper-button-prev"></div><div class="swiper-button-next"></div></div>
                    </div>
                    ...
                    <div class="tab_wrap">
                      ...
                      <div class="tab-content">
                        <div id="home" class="tab-pane fade in active show">
                          <p>ローダウン時のタイロッド角を補正し、ステア特性を復活。<br/>「スポーツタイロッドエンド」は、ボールジョイント部の長さを変更することで、ローダウン時のタイロッド角を適正値に補正し本来のステア特性を復活させる。きめ細やかな“乗り味”を求めるユーザーにお勧めしたいアイテム。素材に高強度な鍛造炭素鋼（S45C）を採用。</p>
                        </div>
                        <div id="menu2" class="tab-pane fade">
                          <p>・炭素鋼製(S45C鍛造)<br/>・左右2本セット</p>
                        </div>
                      </div>
                      <script>
                ...
                <table style="table-layout:fixed;" width="100%">
                  ...
                  <tr>
                    ...
                    <p class="search_category">**********【商品検索】**********&nbsp;&nbsp;<a class="change_button" href="../../sale/item/10788.php"><img src="../../img/sale_button.jpg" alt="単品販売の価格表はコチラ"></a></p>
                  </tr>
                </table>
                  <?php
    							$root_dir = __DIR__.'/../../..';
