 <html>
<head>
<meta content="ストリートからスポーツ走行まで対応するマルチプレイヤー。20段階の減衰調整システムを採用し、ストリートからワインディング、サーキットまで幅広く対応するマルチプレーヤーとして開発されました。リニアな特性をもつ専用ピストンバルブを採用し、剛性感のある走りが楽しめます。スプリングレートは走行フィールドにあわせ、「SOFT」「HARD」からお選びいただけます。防錆に優れる特殊メッキを施したシェルケースを採用すると同時に、軽量化と腐食性の強化のため、アルマイト処理を施したアルミ製パーツも随所に採用しております。" name="description"/>
<meta content="text/html; charset=utf-8" http-equiv="Content-Type"/><meta content="width=device-width, user-scalable=yes, initial-scale=1, maximum-scale=1" name="viewport"><meta content="width=device-width" name="viewport"/><title>KTS-web 工賃セットメニュー ENDLESS Function Xプラス</title><script type="application/ld+json">{@context: "http://schema.org",@type: "BreadcrumbList",itemListElement:[{@type: "ListItem",position: 1,item:{@id: "/shop_menu/",name: "SHOP MENU"}},{@type: "ListItem",position: 2,item:{@id: "/set/",name: "工賃セットメニュー"}},{@type: "ListItem",position: 3,item:{@id: "/item/10042.php",name: "Function Xプラス"}}]}</script><script src="https://ajax.googleapis.com/ajax/libs/jquery/3.1.1/jquery.min.js"></script>
<meta content="width=device-width, user-scalable=yes, initial-scale=1, maximum-scale=1" name="viewport"/>
<meta content="width=device-width" name="viewport"/>
<title>KTS-web 工賃セットメニュー ENDLESS Function Xプラス</title>
...
<div><img alt="Function Xプラス" src="../../brand/img/1038.gif"/></div>
</div>
<div class="set_menu_n_cell col-md-6 col-sm-12 col-xs-12">
<div class="item_info_text_middle"><p>ENDLESS[エンドレス]</p></div><div class="item_info_text_middle_b"><p>Function Xプラス[ファンクション Xプラス]</p></div>
</div>
</div>
<div class="set_menu_n row">
<div class="set_menu_n_330 col-md-6 col-sm-12 col-xs-12">
<div>
<div class="swiper-container"><div class="swiper-wrapper"><div class="swiper-slide"><img alt="Function Xプラス" src="../../item_img/10042_1.jpg"/></div><div class="swiper-slide"><img alt="Function Xプラス" src="../../item_img/10042_2.jpg"/></div><div class="swiper-slide"><img alt="Function Xプラス" src="../../item_img/10042_3.jpg"/></div></div><div class="swiper-button-prev"></div><div class="swiper-button-next"></div></div>
</div>
<div class="item_caution"><p>※写真はイメージ・代表画像です。 </p><p>※実際の商品とカラーやイメージが異なる場合がございます。</p></div>
</div>
<div class="set_menu_n_cell col-md-6 col-sm-12 col-xs-12">
<a class="set-sale-switch" href="../../sale/item/10042.php">メニュー内容・物販へのリンク</a><div class="tab_wrap">
