<html>
<head>
<meta name="description" content="クスコの直巻スプリングは、センターシート、アッパーシートに接するスプリングの両端を平滑処理されています。サスペンションキットに装着した時にサスペンションキットとの密着性が高くぴったりフィットするので誤差がなく、ミリ単位の車高調整セッティングを可能にします。">
...
<title>KTS-web 工賃セットメニュー CUSCO 直巻スプリング</title>
...
<div class="mc_nav">
<a class="link" href="https://www.kts-web.com/">HOME</a> &gt; <a class="link" href="../../index.html">SHOP MENU</a> &gt; <a class="link" href="../index.html">工賃セットメニュー</a> &gt; <a class="link" href="../cat/100.html">足回り</a> &gt; <a class="link" href="../cat/116.html">車高調/セッティングパーツ</a> &gt; <a class="link" href="../br/1059-116.html">CUSCO</a> &gt; <a class="link" href="10621.php">直巻スプリング</a></div>
<div class="space3px"></div>
<div class="set_sale_back">
<div class="space3px"></div>
<div class="set_menu_n">
<div class="set_menu_n_330">
<div><img src="../../brand/img/1059.gif" alt="直巻スプリング"></div></div>
...
<div class="swiper-slide"><img src="../../item_img/10621_1.jpg" alt="直巻スプリング"></div>
<div class="swiper-slide"><img src="../../item_img/10621_2.jpg" alt="直巻スプリング"></div>
<div class="swiper-slide"><img src="../../item_img/10621_3.jpg" alt="直巻スプリング"></div>
</div>
...
<p>クスコの直巻スプリングは、センターシート、アッパーシートに接するスプリングの両端を平滑処理されています。サスペンションキットに装着した時にサスペンションキットとの密着性が高くぴったりフィットするので誤差がなく、ミリ単位の車高調整セッティングを可能にします。</p>
</div>
...
<p class="search_category">**********【商品検索】**********&nbsp;&nbsp;<a class="change_button" href="../../sale/item/10621.php"><img src="../../img/sale_button.jpg" alt="単品販売の価格表はコチラ"></a></p>
</tr>
<tr>
<td>
<!-- スプリング検索ココから -->
<p class="search_category">【ID(内径)】</p>
<form method="post" action="10621.php">
...
if($data[0] == '10621') $position = explode(";", $data[1]);
}
array_pop($position);
fclose($fp_position);
...
<form name="make" method="post" action="10621.php">
