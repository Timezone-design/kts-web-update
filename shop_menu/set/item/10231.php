 <html>
<head>
<meta content="規格汎用スプリングは、引張り強度200kgf/mm2以上の素材を採用し、高張力かつ耐ヘタリ性に優れています(一部線径を除く)。&lt;br&gt;冷間成形により抜群の品質安定性と耐久性、高性能を実現。ストレートタイプスプリングは、すべて内径を基準にしてありますので、内径指定のスプリングシートをご用意ください。外径は、線径により変化します" name="description"/>
<meta content="text/html; charset=utf-8" http-equiv="Content-Type"/><meta content="width=device-width, user-scalable=yes, initial-scale=1, maximum-scale=1" name="viewport"><meta content="width=device-width" name="viewport"/><title>KTS-web 工賃セットメニュー TEIN ストレートタイプ 規格汎用スプリング</title><script type="application/ld+json">{@context: "http://schema.org",@type: "BreadcrumbList",itemListElement:[{@type: "ListItem",position: 1,item:{@id: "/shop_menu/",name: "SHOP MENU"}},{@type: "ListItem",position: 2,item:{@id: "/set/",name: "工賃セットメニュー"}},{@type: "ListItem",position: 3,item:{@id: "/item/10231.php",name: "ストレートタイプ 規格汎用スプリング"}}]}</script><script src="https://ajax.googleapis.com/ajax/libs/jquery/3.1.1/jquery.min.js"></script>
<meta content="width=device-width, user-scalable=yes, initial-scale=1, maximum-scale=1" name="viewport"/>
<meta content="width=device-width" name="viewport"/>
<title>KTS-web 工賃セットメニュー TEIN ストレートタイプ 規格汎用スプリング</title>
...
<div><img alt="ストレートタイプ 規格汎用スプリング" src="../../brand/img/1104.gif"/></div>
</div>
<div class="set_menu_n_cell col-md-6 col-sm-12 col-xs-12">
<div class="item_info_text_middle"><p>TEIN[テイン]</p></div><div class="item_info_text_middle_b"><p>ストレートタイプ 規格汎用スプリング</p></div>
</div>
</div>
<div class="set_menu_n row">
<div class="set_menu_n_330 col-md-6 col-sm-12 col-xs-12">
<div>
<div class="swiper-container"><div class="swiper-wrapper"><div class="swiper-slide"><img alt="ストレートタイプ 規格汎用スプリング" src="../../item_img/10231_1.jpg"/></div><div class="swiper-slide"><img alt="ストレートタイプ 規格汎用スプリング" src="../../item_img/10231_2.jpg"/></div><div class="swiper-slide"><img alt="ストレートタイプ 規格汎用スプリング" src="../../item_img/10231_3.jpg"/></div></div><div class="swiper-button-prev"></div><div class="swiper-button-next"></div></div>
</div>
<div class="item_caution"><p>※写真はイメージ・代表画像です。 </p><p>※実際の商品とカラーやイメージが異なる場合がございます。</p></div>
</div>
<div class="set_menu_n_cell col-md-6 col-sm-12 col-xs-12">
<a class="set-sale-switch" href="../../sale/item/10231.php">メニュー内容・物販へのリンク</a><div class="tab_wrap">
