<html>
 <head>
  ...
  <title>
   KTS-web 工賃セットメニュー HKS HIPERMAX IV GT Spec-A
  </title>
  <script type="application/ld+json">
   {@context: "http://schema.org",@type: "BreadcrumbList",itemListElement:[{@type: "ListItem",position: 1,item:{@id: "/shop_menu/",name: "SHOP MENU"}},{@type: "ListItem",position: 2,item:{@id: "/set/",name: "工賃セットメニュー"}},{@type: "ListItem",position: 3,item:{@id: "/item/10079.php",name: "HIPERMAX IV GT Spec-A"}}]}
  </script>
...
<!-- <header class="site-header">
      ...
      <div class="main_c row grey-wrapper">
       <div class="mc_nav">
        ...
        &gt;
        <a class="link" href="../br/1032-116.html">
         HKS
        </a>
        &gt;
        <a class="link" href="10079.php">
         HIPERMAX IV GT Spec-A
        </a>
       </div>
       <div class="clearfix">
       </div>
       <div class="set_sale_back">
        ...
        <div class="set_menu_n row">
         <div class="set_menu_n_330 col-md-6 col-sm-12 col-xs-12">
          <div>
           <img alt="HIPERMAX IV GT Spec-A" src="../../brand/img/1032.gif"/>
          </div>
         </div>
         <div class="set_menu_n_cell col-md-6 col-sm-12 col-xs-12">
          ...
          <div class="item_info_text_middle_b">
           <p>
            HIPERMAX IV GT Spec-A[ハイパーマックス4 GT スペックA]
           </p>
          </div>
         </div>
        </div>
           ...
           <div class="swiper-container">
            <div class="swiper-wrapper">
             <div class="swiper-slide">
              <img alt="HIPERMAX IV GT Spec-A" src="../../item_img/10079_1.jpg"/>
             </div>
             <div class="swiper-slide">
              <img alt="HIPERMAX IV GT Spec-A" src="../../item_img/10079_2.jpg"/>
             </div>
             <div class="swiper-slide">
              <img alt="HIPERMAX IV GT Spec-A" src="../../item_img/10079_3.jpg"/>
             </div>
            </div>
