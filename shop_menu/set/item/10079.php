 <html>
<head>
<meta content="MAX IV GTをベースに最新理論でリセッティングした究極のストリートサスペンション。「アフターマーケットにおけるスポーツサスペンションはこういうもの」。そういった概念をリセットし、現時点でストリートスポーツサスペンションとして最もふさわしいものは何かを考え、形としたのがこの「MAX IV GT Spec-A」です。走り出した瞬間から感じられるマイルドな当たりと奥深い乗り味を是非体感してください。" name="description"/>
<meta content="text/html; charset=utf-8" http-equiv="Content-Type"/><meta content="width=device-width, user-scalable=yes, initial-scale=1, maximum-scale=1" name="viewport"><meta content="width=device-width" name="viewport"/><title>KTS-web 工賃セットメニュー HKS HIPERMAX IV GT Spec-A</title><script type="application/ld+json">{@context: "http://schema.org",@type: "BreadcrumbList",itemListElement:[{@type: "ListItem",position: 1,item:{@id: "/shop_menu/",name: "SHOP MENU"}},{@type: "ListItem",position: 2,item:{@id: "/set/",name: "工賃セットメニュー"}},{@type: "ListItem",position: 3,item:{@id: "/item/10079.php",name: "HIPERMAX IV GT Spec-A"}}]}</script><script src="https://ajax.googleapis.com/ajax/libs/jquery/3.1.1/jquery.min.js"></script>
<meta content="width=device-width, user-scalable=yes, initial-scale=1, maximum-scale=1" name="viewport"/>
<meta content="width=device-width" name="viewport"/>
<title>KTS-web 工賃セットメニュー HKS HIPERMAX IV GT Spec-A</title>
...
<div><img alt="HIPERMAX IV GT Spec-A" src="../../brand/img/1032.gif"/></div>
</div>
<div class="set_menu_n_cell col-md-6 col-sm-12 col-xs-12">
<div class="item_info_text_middle"><p>HKS[エッチケーエス]</p></div><div class="item_info_text_middle_b"><p>HIPERMAX IV GT Spec-A[ハイパーマックス4 GT スペックA]</p></div>
</div>
</div>
<div class="set_menu_n row">
<div class="set_menu_n_330 col-md-6 col-sm-12 col-xs-12">
<div>
<div class="swiper-container"><div class="swiper-wrapper"><div class="swiper-slide"><img alt="HIPERMAX IV GT Spec-A" src="../../item_img/10079_1.jpg"/></div><div class="swiper-slide"><img alt="HIPERMAX IV GT Spec-A" src="../../item_img/10079_2.jpg"/></div><div class="swiper-slide"><img alt="HIPERMAX IV GT Spec-A" src="../../item_img/10079_3.jpg"/></div></div><div class="swiper-button-prev"></div><div class="swiper-button-next"></div></div>
</div>
<div class="item_caution"><p>※写真はイメージ・代表画像です。 </p><p>※実際の商品とカラーやイメージが異なる場合がございます。</p></div>
</div>
<div class="set_menu_n_cell col-md-6 col-sm-12 col-xs-12">
<a class="set-sale-switch" href="../../sale/item/10079.php">メニュー内容・物販へのリンク</a><div class="tab_wrap">
