	              ...
	              <div class="set_sale_back">
	                ...
	                <div class="set_menu_n row">
	                  <div class="set_menu_n_330 col-md-6 col-sm-12 col-xs-12">
	                    <div><img alt="クラブスポーツ ブレーキパッド" src="../../brand/img/1042.gif"/></div>
	                  </div>
	                  <div class="set_menu_n_cell col-md-6 col-sm-12 col-xs-12">
	                    <div class="item_info_text_middle"><p>AutoExe[オートエグゼ]</p></div><div class="item_info_text_middle_b"><p>クラブスポーツ ブレーキパッド</p></div>
	                  </div>
	                </div>
	                <div class="set_menu_n row">
	                  <div class="set_menu_n_330 col-md-6 col-sm-12 col-xs-12">
	                    <div>
	                      <div class="swiper-container"><div class="swiper-wrapper"><div class="swiper-slide"><img alt="クラブスポーツ ブレーキパッド" src="../../item_img/10779_1.jpg"/></div><div class="swiper-slide"><img alt="クラブスポーツ ブレーキパッド" src="../../item_img/10779_2.jpg"/></div><div class="swiper-slide"><img alt="クラブスポーツ ブレーキパッド" src="../../item_img/10779_3.jpg"/></div></div><div class="swiper-button-prev"></div><div class="swiper-button-next"></div></div>
	                    </div>
	                    ...
	                    <div class="tab_wrap">
	                      ...
	                      <div class="tab-content">
	                        <div id="home" class="tab-pane fade in active show">
	                          <p>ドライバーの感性にシンクロした「意のままの減速」。その方向性はストリート用ブレーキパッドと同一だが、違いは想定する走行シチュエーションにある。ワインディングやサーキットにおける連続したS字カーブや、ストレートからのフルブレーキングといった過酷な高負荷領域おいてコントロール性に秀でた特性を目指し、摩擦材（摩材)を厳選し調合。</p>
	                        </div>
	                        <div id="menu2" class="tab-pane fade">
	                          <p>・グラファイトメタル摩材<br/>・ローター適正温度：50～800℃</p>
	                        </div>
	                      </div>
	                      <script>
	                ...
	                <table style="table-layout:fixed;" width="100%">
	                  ...
	                  <tr>
	                    ...
	                    <p class="search_category">**********【商品検索】**********&nbsp;&nbsp;<a class="change_button" href="../../sale/item/10779.php"><img src="../../img/sale_button.jpg" alt="単品販売の価格表はコチラ"></a></p>
	                  </tr>
	                </table>
	                  <?php
	                  	$root_dir = __DIR__.'/../../..';
