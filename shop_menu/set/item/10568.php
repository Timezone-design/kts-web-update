	              ...
	              <div class="set_sale_back">
	                    ...
	                    <div class="tab_wrap">
	                      ...
	                      <div class="tab-content">
	                        <div id="home" class="tab-pane fade in active show">
	                          <p>ウルトラレーシングは2002年に設立したシャーシやチューニングパーツの専門メーカーです。ヨーロッパやアジアなど世界14ヶ国以上の国々へ拠点を置き、世界中で信頼されているブランドです。<br/>ウルトラレーシングのバーは従来のバーに対して優れた性能を発揮し、剛性を高めることができます。</p>
	                        </div>
	                ...
	                <table style="table-layout:fixed;" width="100%">
	                  ...
	                  <tr>
	                    ...
	                    <p class="search_category">**********【商品検索】**********&nbsp;&nbsp;<a class="change_button" href="../../sale/item/10568.php"><img src="../../img/sale_button.jpg" alt="単品販売の価格表はコチラ"></a></p>
	                  </tr>
	                </table>
	                  <?php
	                  	$root_dir = __DIR__.'/../../..';
