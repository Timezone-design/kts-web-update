 <html>
<head>
<meta content="NEW SR SPECIALは純正ショックアブソーバと同等の形状を採用、耐久性など品質はそのままに減衰力特性を最適化することで、「硬くないけどシッカリ！」普段使いの軽快なカジュアルシューズを履いた感覚で安心して走れる、なんか運転がうまくなった？と思わせるショックアブソーバに仕上げられています。" name="description"/>
<meta content="text/html; charset=utf-8" http-equiv="Content-Type"/><meta content="width=device-width, user-scalable=yes, initial-scale=1, maximum-scale=1" name="viewport"><meta content="width=device-width" name="viewport"/><title>KTS-web 工賃セットメニュー KYB NEW SR SPECIAL</title><script type="application/ld+json">{@context: "http://schema.org",@type: "BreadcrumbList",itemListElement:[{@type: "ListItem",position: 1,item:{@id: "/shop_menu/",name: "SHOP MENU"}},{@type: "ListItem",position: 2,item:{@id: "/set/",name: "工賃セットメニュー"}},{@type: "ListItem",position: 3,item:{@id: "/item/10106.php",name: "NEW SR SPECIAL"}}]}</script><script src="https://ajax.googleapis.com/ajax/libs/jquery/3.1.1/jquery.min.js"></script>
<meta content="width=device-width, user-scalable=yes, initial-scale=1, maximum-scale=1" name="viewport"/>
<meta content="width=device-width" name="viewport"/>
<title>KTS-web 工賃セットメニュー KYB NEW SR SPECIAL</title>
...
<div><img alt="NEW SR SPECIAL" src="../../brand/img/1054.gif"/></div>
</div>
<div class="set_menu_n_cell col-md-6 col-sm-12 col-xs-12">
<div class="item_info_text_middle"><p>KYB[カヤバ]</p></div><div class="item_info_text_middle_b"><p>NEW SR SPECIAL[ニューSR スペシャル]</p></div>
</div>
</div>
<div class="set_menu_n row">
<div class="set_menu_n_330 col-md-6 col-sm-12 col-xs-12">
<div>
<div class="swiper-container"><div class="swiper-wrapper"><div class="swiper-slide"><img alt="NEW SR SPECIAL" src="../../item_img/10106_1.jpg"/></div><div class="swiper-slide"><img alt="NEW SR SPECIAL" src="../../item_img/10106_2.jpg"/></div><div class="swiper-slide"><img alt="NEW SR SPECIAL" src="../../item_img/10106_3.jpg"/></div></div><div class="swiper-button-prev"></div><div class="swiper-button-next"></div></div>
</div>
<div class="item_caution"><p>※写真はイメージ・代表画像です。 </p><p>※実際の商品とカラーやイメージが異なる場合がございます。</p></div>
</div>
<div class="set_menu_n_cell col-md-6 col-sm-12 col-xs-12">
<a class="set-sale-switch" href="../../sale/item/10106.php">メニュー内容・物販へのリンク</a><div class="tab_wrap">
