<html>
<head>
<meta name="description" content="オーリンズ専用に開発された高剛性軽量スプリングです。軽量化と十分なストローク量を確保しながら、過酷な使用条件下でも極めてへたりの少ないスプリングに仕上がっています。">
...
<title>KTS-web 工賃セットメニュー OHLINS 直巻きスプリング</title>
...
<div class="mc_nav">
<a class="link" href="https://www.kts-web.com/">HOME</a> &gt; <a class="link" href="../../index.html">SHOP MENU</a> &gt; <a class="link" href="../index.html">工賃セットメニュー</a> &gt; <a class="link" href="../cat/100.html">足回り</a> &gt; <a class="link" href="../cat/116.html">車高調/セッティングパーツ</a> &gt; <a class="link" href="../br/1046-116.html">OHLINS</a> &gt; <a class="link" href="10226.php">直巻きスプリング</a></div>
<div class="space3px"></div>
<div class="set_sale_back">
<div class="space3px"></div>
<div class="set_menu_n">
<div class="set_menu_n_330">
<div><img src="../../brand/img/1046.gif" alt="直巻きスプリング"></div></div>
...
<div class="swiper-slide"><img src="../../item_img/10226_1.jpg" alt="直巻きスプリング"></div>
<div class="swiper-slide"><img src="../../item_img/10226_2.jpg" alt="直巻きスプリング"></div>
<div class="swiper-slide"><img src="../../item_img/10226_3.jpg" alt="直巻きスプリング"></div>
</div>
...
<p>オーリンズ専用に開発された高剛性軽量スプリングです。軽量化と十分なストローク量を確保しながら、過酷な使用条件下でも極めてへたりの少ないスプリングに仕上がっています。</p>
</div>
<div id="panel2" class="tab_panel">
<p>・ID：φ60/φ65<br>・レート：3.5~18kgf(自由長による)<br>・自由長：180/200/230/250mm</p>
</div>
</div>
</div>
</div>
...
<p class="search_category">**********【商品検索】**********&nbsp;&nbsp;<a class="change_button" href="../../sale/item/10226.php"><img src="../../img/sale_button.jpg" alt="単品販売の価格表はコチラ"></a></p>
</tr>
<tr>
<td>
<!-- スプリング検索ココから -->
<p class="search_category">【ID(内径)】</p>
<form method="post" action="10226.php">
...
if($data[0] == '10226') $position = explode(";", $data[1]);
}
array_pop($position);
fclose($fp_position);
...
<form name="make" method="post" action="10226.php">
