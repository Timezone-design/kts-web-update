	              ...
	              <div class="set_sale_back">
	                    ...
	                    <div class="tab_wrap">
	                      ...
	                      <div class="tab-content">
	                        <div id="home" class="tab-pane fade in active show">
	                          <p>近年高性能ストリートブレーキパッドの条件として、低ダストは必須条件でした。そして新たなるユーザービリティに応えるため、”Super Street S-sports”は音鳴きを極限まで抑え、初期制動を高めることに成功し、低温走行時に踏み始めからダイレクトに減速を感じることが出来ます。初期制動重視のストリートユーザーにお勧めです。</p>
	                        </div>
	                        <div id="menu2" class="tab-pane fade">
	                          <p>・ローター適正温度域：0～480℃<br/>・平均摩擦係数：0.38～0.45<br/>・材質：ノンアスベスト<br/>・フィールド：ストリート-ワインディング</p>
	                        </div>
	                      </div>
	                      <script>
	                ...
	                <table style="table-layout:fixed;" width="100%">
	                  ...
	                  <tr>
	                    ...
	                    <p class="search_category">**********【商品検索】**********&nbsp;&nbsp;<a class="change_button" href="../../sale/item/10302.php"><img src="../../img/sale_button.jpg" alt="単品販売の価格表はコチラ"></a></p>
	                  </tr>
	                </table>
	                  <?php
	                  	$root_dir = __DIR__.'/../../..';
