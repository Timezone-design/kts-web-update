              ...
              <div class="set_sale_back">
                ...
                <div class="set_menu_n row">
                  <div class="set_menu_n_330 col-md-6 col-sm-12 col-xs-12">
                    <div><img alt="スポーツスタビライザー" src="../../brand/img/1042.gif"/></div>
                  </div>
                  <div class="set_menu_n_cell col-md-6 col-sm-12 col-xs-12">
                    <div class="item_info_text_middle"><p>AutoExe[オートエグゼ]</p></div><div class="item_info_text_middle_b"><p>スポーツスタビライザー</p></div>
                  </div>
                </div>
                <div class="set_menu_n row">
                  <div class="set_menu_n_330 col-md-6 col-sm-12 col-xs-12">
                    <div>
                      <div class="swiper-container"><div class="swiper-wrapper"><div class="swiper-slide"><img alt="スポーツスタビライザー" src="../../item_img/10787_1.jpg"/></div><div class="swiper-slide"><img alt="スポーツスタビライザー" src="../../item_img/10787_2.jpg"/></div><div class="swiper-slide"><img alt="スポーツスタビライザー" src="../../item_img/10787_3.jpg"/></div></div><div class="swiper-button-prev"></div><div class="swiper-button-next"></div></div>
                    </div>
                    ...
                    <div class="tab_wrap">
                      ...
                      <div class="tab-content">
                        <div id="home" class="tab-pane fade in active show">
                          <p>乗り心地感を損なわずにロール量を抑制。SUV/ミニバンにも効果大。<br/>左右のサスペンションアームを結合し、そのバネ効果でロール量を抑制するのがスタビライザー。無論、多くの量産車に標準装備されているが、そのバネ定数は標準装着されるタイヤのグリップを基準に設計されているため、ハイグリップタイヤ装着時やインチアップ時の為のパイプ径を適度に太めた仕様。</p>
                        </div>
                        <div id="menu2" class="tab-pane fade">
                          <p>・バネ定数:量産状態の110～200％程度</p>
                        </div>
                      </div>
                      <script>
                ...
                <table style="table-layout:fixed;" width="100%">
                  ...
                  <tr>
                    ...
                    <p class="search_category">**********【商品検索】**********&nbsp;&nbsp;<a class="change_button" href="../../sale/item/10787.php"><img src="../../img/sale_button.jpg" alt="単品販売の価格表はコチラ"></a></p>
                  </tr>
                </table>
                  <?php
    							$root_dir = __DIR__.'/../../..';
