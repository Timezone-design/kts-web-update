<html>
 <head>
  ...
  <title>
   KTS-web 工賃セットメニュー OS技研 Super Single series
  </title>
  <script type="application/ld+json">
   {@context: "http://schema.org",@type: "BreadcrumbList",itemListElement:[{@type: "ListItem",position: 1,item:{@id: "/shop_menu/",name: "SHOP MENU"}},{@type: "ListItem",position: 2,item:{@id: "/set/",name: "工賃セットメニュー"}},{@type: "ListItem",position: 3,item:{@id: "/item/10499.php",name: "Super Single series"}}]}
  </script>
     ...
     <div id="content-wrapper">
      ...
      <div class="main_c row grey-wrapper">
       <div class="mc_nav">
        ...
        &gt;
        <a class="link" href="../br/1040-124.html">
         OS技研
        </a>
        &gt;
        <a class="link" href="10499.php">
         Super Single series
        </a>
       </div>
       <div class="clearfix">
       ...
       <div class="set_sale_back">
        ...
        <div class="set_menu_n row">
         <div class="set_menu_n_330 col-md-6 col-sm-12 col-xs-12">
          <div>
           <img alt="Super Single series" src="../../brand/img/1040.gif"/>
          </div>
         </div>
         <div class="set_menu_n_cell col-md-6 col-sm-12 col-xs-12">
          ...
          <div class="item_info_text_middle_b">
           <p>
            Super Single series[スーパーシングルシリーズ]
           </p>
          </div>
         </div>
        </div>
           ...
           <div class="swiper-container">
            <div class="swiper-wrapper">
             <div class="swiper-slide">
              <img alt="Super Single series" src="../../item_img/10499_1.jpg"/>
             </div>
             <div class="swiper-slide">
              <img alt="Super Single series" src="../../item_img/10499_2.jpg"/>
             </div>
             <div class="swiper-slide">
              <img alt="Super Single series" src="../../item_img/10499_3.jpg"/>
             </div>
            </div>
