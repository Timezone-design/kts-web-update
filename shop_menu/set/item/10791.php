              ...
              <div class="set_sale_back">
                ...
                <div class="set_menu_n row">
                  <div class="set_menu_n_330 col-md-6 col-sm-12 col-xs-12">
                    <div><img alt="スポーツブレーキローター" src="../../brand/img/1042.gif"/></div>
                  </div>
                  <div class="set_menu_n_cell col-md-6 col-sm-12 col-xs-12">
                    <div class="item_info_text_middle"><p>AutoExe[オートエグゼ]</p></div><div class="item_info_text_middle_b"><p>スポーツブレーキローター</p></div>
                  </div>
                </div>
                <div class="set_menu_n row">
                  <div class="set_menu_n_330 col-md-6 col-sm-12 col-xs-12">
                    <div>
                      <div class="swiper-container"><div class="swiper-wrapper"><div class="swiper-slide"><img alt="スポーツブレーキローター" src="../../item_img/10791_1.jpg"/></div><div class="swiper-slide"><img alt="スポーツブレーキローター" src="../../item_img/10791_2.jpg"/></div><div class="swiper-slide"><img alt="スポーツブレーキローター" src="../../item_img/10791_3.jpg"/></div></div><div class="swiper-button-prev"></div><div class="swiper-button-next"></div></div>
                    </div>
                    ...
                    <div class="tab_wrap">
                      ...
                      <div class="tab-content">
                        <div id="home" class="tab-pane fade in active show">
                          <p>耐フェード性、耐クラック性など強度を向上させた2ピース構造により剛性感ある制動力を実現。<br/>放熱に優れたベンチレーションフィンやパッド表面を整えるクリーニングスリット、ローターの錆を防止するブラックメッキ処理など機能を追求。レッドアルマイトを施した軽量ジュラルミン製ベルハウジングはバネ下重量低減によるハンドリング改善効果も期待できる。消耗時は、ディスクローター部のみの交換が可能。</p>
                        </div>
                ...
                <table style="table-layout:fixed;" width="100%">
                  ...
                  <tr>
                    ...
                    <p class="search_category">**********【商品検索】**********&nbsp;&nbsp;<a class="change_button" href="../../sale/item/10791.php"><img src="../../img/sale_button.jpg" alt="単品販売の価格表はコチラ"></a></p>
                  </tr>
                </table>
                  <?php
    							$root_dir = __DIR__.'/../../..';
