...
<div class="mc_nav">
<a class="link" href="https://www.kts-web.com/">HOME</a> &gt; <a class="link" href="../../index.html">SHOP MENU</a> &gt; <a class="link" href="../index.html">工賃セットメニュー</a> &gt; <a class="link" href="../cat/100.html">足回り</a> &gt; <a class="link" href="../cat/116.html">車高調/セッティングパーツ</a> &gt; <a class="link" href="../br/1104-116.html">TEIN</a> &gt; <a class="link" href="10230.php">レーシングスプリング</a></div>
<div class="space3px"></div>
<div class="set_sale_back">
<div class="space3px"></div>
<div class="set_menu_n">
<div class="set_menu_n_330">
<div><img src="../../brand/img/1104.gif" alt="レーシングスプリング"></div></div>
...
<div class="swiper-slide"><img src="../../item_img/10230_1.jpg" alt="レーシングスプリング"></div>
<div class="swiper-slide"><img src="../../item_img/10230_2.jpg" alt="レーシングスプリング"></div>
<div class="swiper-slide"><img src="../../item_img/10230_3.jpg" alt="レーシングスプリング"></div>
</div>
...
<p>レーシングスプリングは、すべて引張り強度200kgf/mm2以上の素材を採用し、高張力かつ耐ヘタリ性に優れています。冷間成形により抜群の品質安定性と耐久性、高性能を実現。</p>
</div>
<div id="panel2" class="tab_panel">
<p>・ID(内径)：φ58/φ65/φ70<br>・引張り強度200kgf/mm2以上<br>・両端研削</p>
</div>
</div>
</div>
</div>
...
<p class="search_category">**********【商品検索】**********&nbsp;&nbsp;<a class="change_button" href="../../sale/item/10230.php"><img src="../../img/sale_button.jpg" alt="単品販売の価格表はコチラ"></a></p>
</tr>
<tr>
<td>
<!-- スプリング検索ココから -->
<p class="search_category">【ID(内径)】</p>
<form method="post" action="10230.php">
...
if($data[0] == '10230') $position = explode(";", $data[1]);
}
array_pop($position);
fclose($fp_position);
...
<form name="make" method="post" action="10230.php">
