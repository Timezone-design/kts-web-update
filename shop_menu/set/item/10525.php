	              ...
	              <div class="set_sale_back">
	                    ...
	                    <div class="tab_wrap">
	                      ...
	                      <div class="tab-content">
	                        <div id="home" class="tab-pane fade in active show">
	                          <p>強化クラッチのイメージをひっくり返す、走ることが楽しくなる新感覚クラッチ!!<br/>ライトクラッチシリーズはエンジンが軽やかに回りスポーティーなフィーリングにもかかわらず、シフトチェンジが楽しく、半クラッチのフィーリングや良い、そんなクラッチです。</p>
	                        </div>
	                        <div id="menu2" class="tab-pane fade">
	                          <p>標準カバー時<br/>・→クラッチ踏力:純正クラッチ並み<br/><br/>高圧着カバー使用時<br/>・→クラッチ踏力:純正比3割アップ程度</p>
	                        </div>
	                      </div>
	                      <script>
	                ...
	                <table style="table-layout:fixed;" width="100%">
	                  ...
	                  <tr>
	                    ...
	                    <p class="search_category">**********【商品検索】**********&nbsp;&nbsp;<a class="change_button" href="../../sale/item/10525.php"><img src="../../img/sale_button.jpg" alt="単品販売の価格表はコチラ"></a></p>
	                  </tr>
	                </table>
	                  <?php
	                  	$root_dir = __DIR__.'/../../..';
