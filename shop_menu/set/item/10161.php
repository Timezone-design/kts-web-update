<html>
 <head>
  ...
  <title>
   KTS-web 工賃セットメニュー Street Ride TYPE-SEDAN MODEL COMFORT
  </title>
  <script type="application/ld+json">
   {@context: "http://schema.org",@type: "BreadcrumbList",itemListElement:[{@type: "ListItem",position: 1,item:{@id: "/shop_menu/",name: "SHOP MENU"}},{@type: "ListItem",position: 2,item:{@id: "/set/",name: "工賃セットメニュー"}},{@type: "ListItem",position: 3,item:{@id: "/item/10161.php",name: "TYPE-SEDAN MODEL COMFORT"}}]}
  </script>
...
<!-- <header class="site-header">
      ...
      <div class="main_c row grey-wrapper">
       <div class="mc_nav">
        ...
        &gt;
        <a class="link" href="../br/1090-116.html">
         Street Ride
        </a>
        &gt;
        <a class="link" href="10161.php">
         TYPE-SEDAN MODEL COMFORT
        </a>
       </div>
       <div class="clearfix">
       </div>
       <div class="set_sale_back">
        ...
        <div class="set_menu_n row">
         <div class="set_menu_n_330 col-md-6 col-sm-12 col-xs-12">
          <div>
           <img alt="TYPE-SEDAN MODEL COMFORT" src="../../brand/img/1090.gif"/>
          </div>
         </div>
         <div class="set_menu_n_cell col-md-6 col-sm-12 col-xs-12">
          ...
          <div class="item_info_text_middle_b">
           <p>
            TYPE-SEDAN MODEL COMFORT[タイプセダン モデル コンフォート]
           </p>
          </div>
         </div>
        </div>
           ...
           <div class="swiper-container">
            <div class="swiper-wrapper">
             <div class="swiper-slide">
              <img alt="TYPE-SEDAN MODEL COMFORT" src="../../item_img/10161_1.jpg"/>
             </div>
             <div class="swiper-slide">
              <img alt="TYPE-SEDAN MODEL COMFORT" src="../../item_img/10161_2.jpg"/>
             </div>
             <div class="swiper-slide">
              <img alt="TYPE-SEDAN MODEL COMFORT" src="../../item_img/10161_3.jpg"/>
             </div>
            </div>
