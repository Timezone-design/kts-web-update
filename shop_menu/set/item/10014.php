 <html>
<head>
<meta content="リーズナブルな価格ながら、全調整式/32段減衰力調整。アルミ製パーツを採用したサスペンションキットフロントストラット車にはキャンバー調整式ピロボールアッパーマウントを採用しダイレクトな操舵感とコントロールを実現しています。フロントストラット式以外の車種とリアには全社強化ゴムアッパーマウントを採用することで走行時の不快な異音を低減します(一部車種を除く)。" name="description"/>
<meta content="text/html; charset=utf-8" http-equiv="Content-Type"/><meta content="width=device-width, user-scalable=yes, initial-scale=1, maximum-scale=1" name="viewport"><meta content="width=device-width" name="viewport"/><title>KTS-web 工賃セットメニュー BLITZ DAMPER ZZ-R</title><script type="application/ld+json">{@context: "http://schema.org",@type: "BreadcrumbList",itemListElement:[{@type: "ListItem",position: 1,item:{@id: "/shop_menu/",name: "SHOP MENU"}},{@type: "ListItem",position: 2,item:{@id: "/set/",name: "工賃セットメニュー"}},{@type: "ListItem",position: 3,item:{@id: "/item/10014.php",name: "DAMPER ZZ-R"}}]}</script><script src="https://ajax.googleapis.com/ajax/libs/jquery/3.1.1/jquery.min.js"></script>
<meta content="width=device-width, user-scalable=yes, initial-scale=1, maximum-scale=1" name="viewport"/>
<meta content="width=device-width" name="viewport"/>
<title>KTS-web 工賃セットメニュー BLITZ DAMPER ZZ-R</title>
...
<div><img alt="DAMPER ZZ-R" src="../../brand/img/1144.gif"/></div>
</div>
<div class="set_menu_n_cell col-md-6 col-sm-12 col-xs-12">
<div class="item_info_text_middle"><p>BLITZ[ブリッツ]</p></div><div class="item_info_text_middle_b"><p>DAMPER ZZ-R[ダンパーZZ-R]</p></div>
</div>
</div>
<div class="set_menu_n row">
<div class="set_menu_n_330 col-md-6 col-sm-12 col-xs-12">
<div>
<div class="swiper-container"><div class="swiper-wrapper"><div class="swiper-slide"><img alt="DAMPER ZZ-R" src="../../item_img/10014_1.jpg"/></div><div class="swiper-slide"><img alt="DAMPER ZZ-R" src="../../item_img/10014_2.jpg"/></div><div class="swiper-slide"><img alt="DAMPER ZZ-R" src="../../item_img/10014_3.jpg"/></div></div><div class="swiper-button-prev"></div><div class="swiper-button-next"></div></div>
</div>
<div class="item_caution"><p>※写真はイメージ・代表画像です。 </p><p>※実際の商品とカラーやイメージが異なる場合がございます。</p></div>
</div>
<div class="set_menu_n_cell col-md-6 col-sm-12 col-xs-12">
<a class="set-sale-switch" href="../../sale/item/10014.php">メニュー内容・物販へのリンク</a><div class="tab_wrap">
