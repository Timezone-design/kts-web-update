 <html>
<head>
<meta content="ローダウンスプリングの決定版!!スタイリッシュ&amp;コンフォータブル&lt;br&gt;後部座席評価を含めた実走行テストにて納得のいくまでセッティング。Gセンサー、ストロークセンサーといった計測器を使用し、あらゆる角度から快適性を追求。&lt;br&gt;※突き上げ感を低減するため、車種により純正バンプラバーの加工が必要な場合があります。" name="description"/>
<meta content="text/html; charset=utf-8" http-equiv="Content-Type"/><meta content="width=device-width, user-scalable=yes, initial-scale=1, maximum-scale=1" name="viewport"><meta content="width=device-width" name="viewport"/><title>KTS-web 工賃セットメニュー TEIN HIGH.TECH</title><script type="application/ld+json">{@context: "http://schema.org",@type: "BreadcrumbList",itemListElement:[{@type: "ListItem",position: 1,item:{@id: "/shop_menu/",name: "SHOP MENU"}},{@type: "ListItem",position: 2,item:{@id: "/set/",name: "工賃セットメニュー"}},{@type: "ListItem",position: 3,item:{@id: "/item/10202.php",name: "HIGH.TECH"}}]}</script><script src="https://ajax.googleapis.com/ajax/libs/jquery/3.1.1/jquery.min.js"></script>
<meta content="width=device-width, user-scalable=yes, initial-scale=1, maximum-scale=1" name="viewport"/>
<meta content="width=device-width" name="viewport"/>
<title>KTS-web 工賃セットメニュー TEIN HIGH.TECH</title>
...
<div><img alt="HIGH.TECH" src="../../brand/img/1104.gif"/></div>
</div>
<div class="set_menu_n_cell col-md-6 col-sm-12 col-xs-12">
<div class="item_info_text_middle"><p>TEIN[テイン]</p></div><div class="item_info_text_middle_b"><p>HIGH.TECH[ハイテク]</p></div>
</div>
</div>
<div class="set_menu_n row">
<div class="set_menu_n_330 col-md-6 col-sm-12 col-xs-12">
<div>
<div class="swiper-container"><div class="swiper-wrapper"><div class="swiper-slide"><img alt="HIGH.TECH" src="../../item_img/10202_1.jpg"/></div><div class="swiper-slide"><img alt="HIGH.TECH" src="../../item_img/10202_2.jpg"/></div><div class="swiper-slide"><img alt="HIGH.TECH" src="../../item_img/10202_3.jpg"/></div></div><div class="swiper-button-prev"></div><div class="swiper-button-next"></div></div>
</div>
<div class="item_caution"><p>※写真はイメージ・代表画像です。 </p><p>※実際の商品とカラーやイメージが異なる場合がございます。</p></div>
</div>
<div class="set_menu_n_cell col-md-6 col-sm-12 col-xs-12">
<a class="set-sale-switch" href="../../sale/item/10202.php">メニュー内容・物販へのリンク</a><div class="tab_wrap">
