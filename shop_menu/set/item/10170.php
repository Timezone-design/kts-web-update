 <html>
<head>
<meta content="セッティングテーマは「妥協なき、しなやかさ」。運動性能を高めつつも、スポーツタイプのダンパーに見られがちな「不快な硬さ」を徹底して抑え込んでいます。そのフィーリングは、アスファルトをランニングシューズで駆けるような感触。さらに、ハンドリングやライド感は、搭載する多彩なアジャスト機能によって、自由にコントロール可能。走りの性能を高めつつ大切な人とのドライブも、気持ちよく楽しく＝FUN TOにこなせます。" name="description"/>
<meta content="text/html; charset=utf-8" http-equiv="Content-Type"/><meta content="width=device-width, user-scalable=yes, initial-scale=1, maximum-scale=1" name="viewport"><meta content="width=device-width" name="viewport"/><title>KTS-web 工賃セットメニュー TANABE GT FUNTORIDE DAMPER</title><script type="application/ld+json">{@context: "http://schema.org",@type: "BreadcrumbList",itemListElement:[{@type: "ListItem",position: 1,item:{@id: "/shop_menu/",name: "SHOP MENU"}},{@type: "ListItem",position: 2,item:{@id: "/set/",name: "工賃セットメニュー"}},{@type: "ListItem",position: 3,item:{@id: "/item/10170.php",name: "GT FUNTORIDE DAMPER"}}]}</script><script src="https://ajax.googleapis.com/ajax/libs/jquery/3.1.1/jquery.min.js"></script>
...
<div><img alt="GT FUNTORIDE DAMPER" src="../../brand/img/1095.gif"/></div>
</div>
<div class="set_menu_n_cell col-md-6 col-sm-12 col-xs-12">
<div class="item_info_text_middle"><p>TANABE[タナベ]</p></div><div class="item_info_text_middle_b"><p>GT FUNTORIDE DAMPER[GTファントライド ダンパー]</p></div>
</div>
</div>
<div class="set_menu_n row">
<div class="set_menu_n_330 col-md-6 col-sm-12 col-xs-12">
<div>
<div class="swiper-container"><div class="swiper-wrapper"><div class="swiper-slide"><img alt="GT FUNTORIDE DAMPER" src="../../item_img/10170_1.jpg"/></div><div class="swiper-slide"><img alt="GT FUNTORIDE DAMPER" src="../../item_img/10170_2.jpg"/></div><div class="swiper-slide"><img alt="GT FUNTORIDE DAMPER" src="../../item_img/10170_3.jpg"/></div></div><div class="swiper-button-prev"></div><div class="swiper-button-next"></div></div>
</div>
<div class="item_caution"><p>※写真はイメージ・代表画像です。 </p><p>※実際の商品とカラーやイメージが異なる場合がございます。</p></div>
</div>
<div class="set_menu_n_cell col-md-6 col-sm-12 col-xs-12">
<a class="set-sale-switch" href="../../sale/item/10170.php">メニュー内容・物販へのリンク</a><div class="tab_wrap">
