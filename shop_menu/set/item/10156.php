<html>
 <head>
  ...
  <title>
   KTS-web 工賃セットメニュー SHOWA COMFORT EVOLUTION 柔
  </title>
  <script type="application/ld+json">
   {@context: "http://schema.org",@type: "BreadcrumbList",itemListElement:[{@type: "ListItem",position: 1,item:{@id: "/shop_menu/",name: "SHOP MENU"}},{@type: "ListItem",position: 2,item:{@id: "/set/",name: "工賃セットメニュー"}},{@type: "ListItem",position: 3,item:{@id: "/item/10156.php",name: "COMFORT EVOLUTION 柔"}}]}
  </script>
...
<!-- <header class="site-header">
      ...
      <div class="main_c row grey-wrapper">
       <div class="mc_nav">
        ...
        &gt;
        <a class="link" href="../br/1086-119.html">
         SHOWA
        </a>
        &gt;
        <a class="link" href="10156.php">
         COMFORT EVOLUTION 柔
        </a>
       </div>
       <div class="clearfix">
       ...
       <div class="set_sale_back">
        ...
        <div class="set_menu_n row">
         <div class="set_menu_n_330 col-md-6 col-sm-12 col-xs-12">
          <div>
           <img alt="COMFORT EVOLUTION 柔" src="../../brand/img/1086.gif"/>
          </div>
         </div>
         <div class="set_menu_n_cell col-md-6 col-sm-12 col-xs-12">
          ...
          <div class="item_info_text_middle_b">
           <p>
            COMFORT EVOLUTION 柔[コンフォートエボリューション 柔]
           </p>
          </div>
         </div>
        </div>
           ...
           <div class="swiper-container">
            <div class="swiper-wrapper">
             <div class="swiper-slide">
              <img alt="COMFORT EVOLUTION 柔" src="../../item_img/10156_1.jpg"/>
             </div>
             <div class="swiper-slide">
              <img alt="COMFORT EVOLUTION 柔" src="../../item_img/10156_2.jpg"/>
             </div>
             <div class="swiper-slide">
              <img alt="COMFORT EVOLUTION 柔" src="../../item_img/10156_3.jpg"/>
             </div>
            </div>
