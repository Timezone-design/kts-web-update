 <html>
<head>
<meta content="「Super Function」は、グリップ力の高いタイヤの装着を前提とした、サーキットスペックモデルです。本体を20段調整とし、より細かな減衰設定ができるようになりました。アッパーマウントにはピロボールを標準採用。シェルケースには軽量で放熱性に優れるアルミ素材を採用しております。ダイレクトなドライブフィールとバネ下重量の軽減を実現する。まさにタイムアタックマシン御用達のサスペンションキットです。" name="description"/>
<meta content="text/html; charset=utf-8" http-equiv="Content-Type"/><meta content="width=device-width, user-scalable=yes, initial-scale=1, maximum-scale=1" name="viewport"><meta content="width=device-width" name="viewport"/><title>KTS-web 工賃セットメニュー ENDLESS Super Function</title><script type="application/ld+json">{@context: "http://schema.org",@type: "BreadcrumbList",itemListElement:[{@type: "ListItem",position: 1,item:{@id: "/shop_menu/",name: "SHOP MENU"}},{@type: "ListItem",position: 2,item:{@id: "/set/",name: "工賃セットメニュー"}},{@type: "ListItem",position: 3,item:{@id: "/item/10043.php",name: "Super Function"}}]}</script><script src="https://ajax.googleapis.com/ajax/libs/jquery/3.1.1/jquery.min.js"></script>
<meta content="width=device-width, user-scalable=yes, initial-scale=1, maximum-scale=1" name="viewport"/>
<meta content="width=device-width" name="viewport"/>
<title>KTS-web 工賃セットメニュー ENDLESS Super Function</title>
...
<div><img alt="Super Function" src="../../brand/img/1038.gif"/></div>
</div>
<div class="set_menu_n_cell col-md-6 col-sm-12 col-xs-12">
<div class="item_info_text_middle"><p>ENDLESS[エンドレス]</p></div><div class="item_info_text_middle_b"><p>Super Function[スーパーファンクション]</p></div>
</div>
</div>
<div class="set_menu_n row">
<div class="set_menu_n_330 col-md-6 col-sm-12 col-xs-12">
<div>
<div class="swiper-container"><div class="swiper-wrapper"><div class="swiper-slide"><img alt="Super Function" src="../../item_img/10043_1.jpg"/></div><div class="swiper-slide"><img alt="Super Function" src="../../item_img/10043_2.jpg"/></div><div class="swiper-slide"><img alt="Super Function" src="../../item_img/10043_3.jpg"/></div></div><div class="swiper-button-prev"></div><div class="swiper-button-next"></div></div>
</div>
<div class="item_caution"><p>※写真はイメージ・代表画像です。 </p><p>※実際の商品とカラーやイメージが異なる場合がございます。</p></div>
</div>
<div class="set_menu_n_cell col-md-6 col-sm-12 col-xs-12">
<a class="set-sale-switch" href="../../sale/item/10043.php">メニュー内容・物販へのリンク</a><div class="tab_wrap">
