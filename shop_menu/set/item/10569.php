	              ...
	              <div class="set_sale_back">
	                    ...
	                    <div class="tab_wrap">
	                      ...
	                      <div class="tab-content">
	                        <div id="home" class="tab-pane fade in active show">
	                          <p>ウルトラレーシングのリアメンバーブレースはボディとリアメンバーを補強し、剛性を上げることでリア全体の一体感ができ、コーナリングなどにおいてボディの捻じれを抑制し走行性能を安定させます。リアサスペンションの余計なバタつきを抑制し、安定したストロークに近づくことが出来ます。</p>
	                        </div>
	                ...
	                <table style="table-layout:fixed;" width="100%">
	                  ...
	                  <tr>
	                    ...
	                    <p class="search_category">**********【商品検索】**********&nbsp;&nbsp;<a class="change_button" href="../../sale/item/10569.php"><img src="../../img/sale_button.jpg" alt="単品販売の価格表はコチラ"></a></p>
	                  </tr>
	                </table>
	                  <?php
	                  	$root_dir = __DIR__.'/../../..';
