              ...
              <div class="set_sale_back">
                ...
                <div class="set_menu_n row">
                  <div class="set_menu_n_330 col-md-6 col-sm-12 col-xs-12">
                    <div><img alt="エグゾーストチャンバーキット" src="../../brand/img/1042.gif"/></div>
                  </div>
                  <div class="set_menu_n_cell col-md-6 col-sm-12 col-xs-12">
                    <div class="item_info_text_middle"><p>AutoExe[オートエグゼ]</p></div><div class="item_info_text_middle_b"><p>エグゾーストチャンバーキット</p></div>
                  </div>
                </div>
                <div class="set_menu_n row">
                  <div class="set_menu_n_330 col-md-6 col-sm-12 col-xs-12">
                    <div>
                      <div class="swiper-container"><div class="swiper-wrapper"><div class="swiper-slide"><img alt="エグゾーストチャンバーキット" src="../../item_img/10775_1.jpg"/></div><div class="swiper-slide"><img alt="エグゾーストチャンバーキット" src="../../item_img/10775_2.jpg"/></div><div class="swiper-slide"><img alt="エグゾーストチャンバーキット" src="../../item_img/10775_3.jpg"/></div></div><div class="swiper-button-prev"></div><div class="swiper-button-next"></div></div>
                    </div>
                    ...
                    <div class="tab_wrap">
                      ...
                      <div class="tab-content">
                        <div id="home" class="tab-pane fade in active show">
                          <p>「エグゾーストチャンバーキット」は、ミドルパイプの途中にチャンバー（膨張管）を設置することで吸い出し効果を高めている。セッティングの鍵となるのは、負圧波の発生ポイントであるチャンバーのレイアウト。<br/>ストリートベストを目指し常用域におけるアクセルレスポンスの向上を目的にレイアウトとしている。</p>
                        </div>
                        <div id="menu2" class="tab-pane fade">
                          <p>・ステンレス製<br/>・チャンバー構造</p>
                        </div>
                      </div>
                      <script>
                ...
                <table style="table-layout:fixed;" width="100%">
                  ...
                  <tr>
                    ...
                    <p class="search_category">**********【商品検索】**********&nbsp;&nbsp;<a class="change_button" href="../../sale/item/10775.php"><img src="../../img/sale_button.jpg" alt="単品販売の価格表はコチラ"></a></p>
                  </tr>
                </table>
                  <?php
    							$root_dir = __DIR__.'/../../..';
