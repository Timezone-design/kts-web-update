              ...
              <div class="set_sale_back">
                ...
                <div class="set_menu_n row">
                  <div class="set_menu_n_330 col-md-6 col-sm-12 col-xs-12">
                    <div><img alt="ターボパイプ" src="../../brand/img/1042.gif"/></div>
                  </div>
                  <div class="set_menu_n_cell col-md-6 col-sm-12 col-xs-12">
                    <div class="item_info_text_middle"><p>AutoExe[オートエグゼ]</p></div><div class="item_info_text_middle_b"><p>ターボパイプ</p></div>
                  </div>
                </div>
                <div class="set_menu_n row">
                  <div class="set_menu_n_330 col-md-6 col-sm-12 col-xs-12">
                    <div>
                      <div class="swiper-container"><div class="swiper-wrapper"><div class="swiper-slide"><img alt="ターボパイプ" src="../../item_img/10793_1.jpg"/></div><div class="swiper-slide"><img alt="ターボパイプ" src="../../item_img/10793_2.jpg"/></div><div class="swiper-slide"><img alt="ターボパイプ" src="../../item_img/10793_3.jpg"/></div></div><div class="swiper-button-prev"></div><div class="swiper-button-next"></div></div>
                    </div>
                    ...
                    <div class="tab_wrap">
                      ...
                      <div class="tab-content">
                        <div id="home" class="tab-pane fade in active show">
                          <p>レイアウトを最適化し内壁部を極力鏡面化したアルミ製エルボーパイプと変形抑制効果の高い4層ポリスターシリコンを組み合わせることで、加圧によるホースの膨張とエア流路の抵抗を抑制。結果、過給圧の上昇を早め、ターボラグを低減。アクセル踏み始めからのレスポンスを向上させる。製品には取付けに必要なガスケットを付属。</p>
                        </div>
                        <div id="menu2" class="tab-pane fade">
                          <p>・アルミ製パイプ(アルマイト仕上げ)＋シリコンホース/バンド/ガスケット付属</p>
                        </div>
                      </div>
                      <script>
                ...
                <table style="table-layout:fixed;" width="100%">
                  ...
                  <tr>
                    ...
                    <p class="search_category">**********【商品検索】**********&nbsp;&nbsp;<a class="change_button" href="../../sale/item/10793.php"><img src="../../img/sale_button.jpg" alt="単品販売の価格表はコチラ"></a></p>
                  </tr>
                </table>
                  <?php
    							$root_dir = __DIR__.'/../../..';
