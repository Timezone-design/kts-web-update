 <html>
<head>
<meta content="増大したパワーとトルクをドライバーのコントロールの範囲に過不足無く適応されたクラッチキット&lt;br&gt;は純正品よりも大容量で、ディスク径、レバー比等の再設計により、踏力が同じで半クラッチのオン/オフの感覚が判りやすく、ギヤボックスに負担を掛けない、更に大人の左足に負担を掛けない、「特別な日」を必要としない快適なクラッチキットです。ただし大出力には適応しません。" name="description"/>
<meta content="text/html; charset=utf-8" http-equiv="Content-Type"/><meta content="width=device-width, user-scalable=yes, initial-scale=1, maximum-scale=1" name="viewport"><meta content="width=device-width" name="viewport"/><title>KTS-web 工賃セットメニュー 戸田レーシング OJISAMAスポーツクラッチKIT</title><script type="application/ld+json">{@context: "http://schema.org",@type: "BreadcrumbList",itemListElement:[{@type: "ListItem",position: 1,item:{@id: "/shop_menu/",name: "SHOP MENU"}},{@type: "ListItem",position: 2,item:{@id: "/set/",name: "工賃セットメニュー"}},{@type: "ListItem",position: 3,item:{@id: "/item/10477.php",name: "OJISAMAスポーツクラッチKIT"}}]}</script><script src="https://ajax.googleapis.com/ajax/libs/jquery/3.1.1/jquery.min.js"></script>
<meta content="width=device-width, user-scalable=yes, initial-scale=1, maximum-scale=1" name="viewport"/>
<meta content="width=device-width" name="viewport"/>
<title>KTS-web 工賃セットメニュー 戸田レーシング OJISAMAスポーツクラッチKIT</title>
...
<div><img alt="OJISAMAスポーツクラッチKIT" src="../../brand/img/1111.gif"/></div>
</div>
<div class="set_menu_n_cell col-md-6 col-sm-12 col-xs-12">
<div class="item_info_text_middle"><p>戸田レーシング[トダレーシング]</p></div><div class="item_info_text_middle_b"><p>OJISAMAスポーツクラッチKIT</p></div>
</div>
</div>
<div class="set_menu_n row">
<div class="set_menu_n_330 col-md-6 col-sm-12 col-xs-12">
<div>
<div class="swiper-container"><div class="swiper-wrapper"><div class="swiper-slide"><img alt="OJISAMAスポーツクラッチKIT" src="../../item_img/10477_1.jpg"/></div><div class="swiper-slide"><img alt="OJISAMAスポーツクラッチKIT" src="../../item_img/10477_2.jpg"/></div><div class="swiper-slide"><img alt="OJISAMAスポーツクラッチKIT" src="../../item_img/10477_3.jpg"/></div></div><div class="swiper-button-prev"></div><div class="swiper-button-next"></div></div>
</div>
<div class="item_caution"><p>※写真はイメージ・代表画像です。 </p><p>※実際の商品とカラーやイメージが異なる場合がございます。</p></div>
</div>
<div class="set_menu_n_cell col-md-6 col-sm-12 col-xs-12">
<a class="set-sale-switch" href="../../sale/item/10477.php">メニュー内容・物販へのリンク</a><div class="tab_wrap">
