	              ...
	              <div class="set_sale_back">
	                    ...
	                    <div class="tab_wrap">
	                      ...
	                      <div class="tab-content">
	                        <div id="home" class="tab-pane fade in active show">
	                          <p>サーキットでのスポーツ走行がメインのモデル。STREET-Rシリーズより上を求めるユーザーに送る別タンク式のサスペンションです。減衰力伸び側独立調整式を採用。<br/>別タンク方式により十分なオイル量を確保しながらもセッティング幅が無限に広がるバネレート設定。アメリカフォーミュラＤからのフィードバックを直接継承したMEGAN RACING車高調シリーズのフラッグシップモデルです。</p>
	                        </div>
	                        <div id="menu2" class="tab-pane fade">
	                          <p>・全長調整(フルタップ)式<br/>・減衰力32段調整<br/>・アッパーマウント標準装備(一部車両を除く)<br/>・ダストブーツ標準装備<br/>・アルミ製ブラケット標準装備<br/>・安心の1年保証<br/>・減衰力独立伸び側独立調整機構付<br/>・単筒式(モノチューブ)ショックアブソーバー採用</p>
	                        </div>
	                      </div>
	                      <script>
	                ...
	                <table style="table-layout:fixed;" width="100%">
	                  ...
	                  <tr>
	                    ...
	                    <p class="search_category">**********【商品検索】**********&nbsp;&nbsp;<a class="change_button" href="../../sale/item/10677.php"><img src="../../img/sale_button.jpg" alt="単品販売の価格表はコチラ"></a></p>
	                  </tr>
	                </table>
	                  <?php
	                  	$root_dir = __DIR__.'/../../..';
