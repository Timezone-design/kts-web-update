 <html>
<head>
<meta content="鋭い切れ味とレスポンスを生む、極限まで薄くしたクラッチディスク。クラッチディスクとクラッチカバーのセット開発によって、極限までの薄さ、軽さを追求。イナーシャ（回転方向に働く力）を抑えてシンクロ同期時間を短縮。素早いシフトチェンジを可能にします。過酷なクラッチワークにも耐える高強度設計。超薄型で耐熱性、耐久性に優れたクラッチディスクとクラッチカバーのプレッシャープレートを強度アップ。" name="description"/>
<meta content="text/html; charset=utf-8" http-equiv="Content-Type"/><meta content="width=device-width, user-scalable=yes, initial-scale=1, maximum-scale=1" name="viewport"><meta content="width=device-width" name="viewport"/><title>KTS-web 工賃セットメニュー CUSCO 薄型メタルディスク</title><script type="application/ld+json">{@context: "http://schema.org",@type: "BreadcrumbList",itemListElement:[{@type: "ListItem",position: 1,item:{@id: "/shop_menu/",name: "SHOP MENU"}},{@type: "ListItem",position: 2,item:{@id: "/set/",name: "工賃セットメニュー"}},{@type: "ListItem",position: 3,item:{@id: "/item/10469.php",name: "薄型メタルディスク"}}]}</script><script src="https://ajax.googleapis.com/ajax/libs/jquery/3.1.1/jquery.min.js"></script>
<meta content="width=device-width, user-scalable=yes, initial-scale=1, maximum-scale=1" name="viewport"/>
<meta content="width=device-width" name="viewport"/>
<title>KTS-web 工賃セットメニュー CUSCO 薄型メタルディスク</title>
...
<div><img alt="薄型メタルディスク" src="../../brand/img/1059.gif"/></div>
</div>
<div class="set_menu_n_cell col-md-6 col-sm-12 col-xs-12">
<div class="item_info_text_middle"><p>CUSCO[クスコ]</p></div><div class="item_info_text_middle_b"><p>薄型メタルディスク</p></div>
</div>
</div>
<div class="set_menu_n row">
<div class="set_menu_n_330 col-md-6 col-sm-12 col-xs-12">
<div>
<div class="swiper-container"><div class="swiper-wrapper"><div class="swiper-slide"><img alt="薄型メタルディスク" src="../../item_img/10469_1.jpg"/></div><div class="swiper-slide"><img alt="薄型メタルディスク" src="../../item_img/10469_2.jpg"/></div><div class="swiper-slide"><img alt="薄型メタルディスク" src="../../item_img/10469_3.jpg"/></div></div><div class="swiper-button-prev"></div><div class="swiper-button-next"></div></div>
</div>
<div class="item_caution"><p>※写真はイメージ・代表画像です。 </p><p>※実際の商品とカラーやイメージが異なる場合がございます。</p></div>
</div>
<div class="set_menu_n_cell col-md-6 col-sm-12 col-xs-12">
<a class="set-sale-switch" href="../../sale/item/10469.php">メニュー内容・物販へのリンク</a><div class="tab_wrap">
