	              ...
	              <div class="set_sale_back">
	                    ...
	                    <div class="tab_wrap">
	                      ...
	                      <div class="tab-content">
	                        <div id="home" class="tab-pane fade in active show">
	                          <p>鋭い切れ味とレスポンスを生む、極限まで薄くしたクラッチディスク。クラッチディスクとクラッチカバーのセット開発によって、極限までの薄さ、軽さを追求。イナーシャ（回転方向に働く力）を抑えてシンクロ同期時間を短縮。素早いシフトチェンジを可能にします。過酷なクラッチワークにも耐える高強度設計。超薄型で耐熱性、耐久性に優れたクラッチディスクとクラッチカバーのプレッシャープレートを強度アップ。</p>
	                        </div>
	                        <div id="menu2" class="tab-pane fade">
	                          <p>・シンクロ同期時間を短縮<br/>・圧着力は、1000kgf 前後設計<br/>・ターンオーバータイプを採用<br/>・極限まで軽量化</p>
	                        </div>
	                      </div>
	                      <script>
	                ...
	                <table style="table-layout:fixed;" width="100%">
	                  ...
	                  <tr>
	                    ...
	                    <p class="search_category">**********【商品検索】**********&nbsp;&nbsp;<a class="change_button" href="../../sale/item/10469.php"><img src="../../img/sale_button.jpg" alt="単品販売の価格表はコチラ"></a></p>
	                  </tr>
	                </table>
	                  <?php
	                  	$root_dir = __DIR__.'/../../..';
