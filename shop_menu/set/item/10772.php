 <html>
								<head>
								<meta content="純正品は蛇腹形状ゆえ吸入空気の乱流を招き抵抗を増大させてしまう傾向にあるためフレキシブルジョイントを廃し、有効流路面積を最大限確保した仕様。各エンジン別に専用デザインされたホースの素材には、吸入負圧による変形抑制効果が高い多層ポリスターシリコンやFRPを採用。結果、アクセルレスポンスの向上を実現。真紅に統一されたカラーリングはエンジンルームにアクセントを添える。" name="description"/>
<meta content="text/html; charset=utf-8" http-equiv="Content-Type"><meta content="width=device-width, user-scalable=yes, initial-scale=1, maximum-scale=1" name="viewport"/><meta content="width=device-width" name="viewport"/><title>KTS-web 工賃セットメニュー AutoExe インテークサクションキット</title><script type="application/ld+json">{@context: "http://schema.org",@type: "BreadcrumbList",itemListElement:[{@type: "ListItem",position: 1,item:{@id: "/shop_menu/",name: "SHOP MENU"}},{@type: "ListItem",position: 2,item:{@id: "/set/",name: "工賃セットメニュー"}},{@type: "ListItem",position: 3,item:{@id: "/item/10772.php",name: "インテークサクションキット"}}]}</script><script src="https://ajax.googleapis.com/ajax/libs/jquery/3.1.1/jquery.min.js"></script>
<meta content="width=device-width, user-scalable=yes, initial-scale=1, maximum-scale=1" name="viewport"/>
<meta content="width=device-width" name="viewport"/>
<title>KTS-web 工賃セットメニュー AutoExe インテークサクションキット</title>
	              ...
	              <div class="set_sale_back">
	                ...
	                <div class="set_menu_n row">
	                  <div class="set_menu_n_330 col-md-6 col-sm-12 col-xs-12">
	                    <div><img alt="インテークサクションキット" src="../../brand/img/1042.gif"/></div>
	                  </div>
	                  <div class="set_menu_n_cell col-md-6 col-sm-12 col-xs-12">
	                    <div class="item_info_text_middle"><p>AutoExe[オートエグゼ]</p></div><div class="item_info_text_middle_b"><p>インテークサクションキット</p></div>
	                  </div>
	                </div>
	                <div class="set_menu_n row">
	                  <div class="set_menu_n_330 col-md-6 col-sm-12 col-xs-12">
	                    <div>
	                      <div class="swiper-container"><div class="swiper-wrapper"><div class="swiper-slide"><img alt="インテークサクションキット" src="../../item_img/10772_1.jpg"/></div><div class="swiper-slide"><img alt="インテークサクションキット" src="../../item_img/10772_2.jpg"/></div><div class="swiper-slide"><img alt="インテークサクションキット" src="../../item_img/10772_3.jpg"/></div></div><div class="swiper-button-prev"></div><div class="swiper-button-next"></div></div>
	                    </div>
	                    ...
	                    <div class="tab_wrap">
	                      ...
	                      <div class="tab-content">
	                        <div id="home" class="tab-pane fade in active show">
	                          <p>純正品は蛇腹形状ゆえ吸入空気の乱流を招き抵抗を増大させてしまう傾向にあるためフレキシブルジョイントを廃し、有効流路面積を最大限確保した仕様。各エンジン別に専用デザインされたホースの素材には、吸入負圧による変形抑制効果が高い多層ポリスターシリコンやFRPを採用。結果、アクセルレスポンスの向上を実現。真紅に統一されたカラーリングはエンジンルームにアクセントを添える。</p>
	                        </div>
	                        <div id="menu2" class="tab-pane fade">
	                          <p>・Aタイプ<br/>→FRP製パイプ＋シリコン製ホース<br/><br/>・Bタイプ<br/>→シリコン製ホース</p>
	                        </div>
	                      </div>
	                      <script>
	                ...
	                <table style="table-layout:fixed;" width="100%">
	                  ...
	                  <tr>
	                    ...
	                    <p class="search_category">**********【商品検索】**********&nbsp;&nbsp;<a class="change_button" href="../../sale/item/10772.php"><img src="../../img/sale_button.jpg" alt="単品販売の価格表はコチラ"></a></p>
	                  </tr>
	                </table>
	                  <?php
	                  	$root_dir = __DIR__.'/../../..';
