 <html>
<head>
<meta content="重量車、ハイパワー車の高温、高負荷時の走行でも変わらないハイミュー安定性&lt;br&gt;ペダル踏力に呼応するかのように立ち上がるリニアな効き&lt;br&gt;抜群に高い初期制動を誇りながらも、非常にコントローラブル！&lt;br&gt;周回数を重ねても変化しない剛性感のあるペダルタッチ&lt;br&gt;Ｓタイヤをはじめとし、スリックタイヤ、ハイグリップラジアルが対象&lt;br&gt;VWシロッコカップチャイナシリーズの公式指定パッドに選定！" name="description"/>
<meta content="text/html; charset=utf-8" http-equiv="Content-Type"/><meta content="width=device-width, user-scalable=yes, initial-scale=1, maximum-scale=1" name="viewport"><meta content="width=device-width" name="viewport"/><title>KTS-web 工賃セットメニュー DIXCEL RA type</title><script type="application/ld+json">{@context: "http://schema.org",@type: "BreadcrumbList",itemListElement:[{@type: "ListItem",position: 1,item:{@id: "/shop_menu/",name: "SHOP MENU"}},{@type: "ListItem",position: 2,item:{@id: "/set/",name: "工賃セットメニュー"}},{@type: "ListItem",position: 3,item:{@id: "/item/10353.php",name: "RA type"}}]}</script><script src="https://ajax.googleapis.com/ajax/libs/jquery/3.1.1/jquery.min.js"></script>
<meta content="width=device-width, user-scalable=yes, initial-scale=1, maximum-scale=1" name="viewport"/>
<meta content="width=device-width" name="viewport"/>
<title>KTS-web 工賃セットメニュー DIXCEL RA type</title>
...
<div><img alt="RA type" src="../../brand/img/1103.gif"/></div>
</div>
<div class="set_menu_n_cell col-md-6 col-sm-12 col-xs-12">
<div class="item_info_text_middle"><p>DIXCEL[ディクセル]</p></div><div class="item_info_text_middle_b"><p>RA type</p></div>
</div>
</div>
<div class="set_menu_n row">
<div class="set_menu_n_330 col-md-6 col-sm-12 col-xs-12">
<div>
<div class="swiper-container"><div class="swiper-wrapper"><div class="swiper-slide"><img alt="RA type" src="../../item_img/10353_1.jpg"/></div><div class="swiper-slide"><img alt="RA type" src="../../item_img/10353_2.jpg"/></div><div class="swiper-slide"><img alt="RA type" src="../../item_img/10353_3.jpg"/></div></div><div class="swiper-button-prev"></div><div class="swiper-button-next"></div></div>
</div>
<div class="item_caution"><p>※写真はイメージ・代表画像です。 </p><p>※実際の商品とカラーやイメージが異なる場合がございます。</p></div>
</div>
<div class="set_menu_n_cell col-md-6 col-sm-12 col-xs-12">
<a class="set-sale-switch" href="../../sale/item/10353.php">メニュー内容・物販へのリンク</a><div class="tab_wrap">
