	              ...
	              <div class="set_sale_back">
	                    ...
	                    <div class="tab_wrap">
	                      ...
	                      <div class="tab-content">
	                        <div id="home" class="tab-pane fade in active show">
	                          <p>重量車、ハイパワー車の高温、高負荷時の走行でも変わらないハイミュー安定性<br/>ペダル踏力に呼応するかのように立ち上がるリニアな効き<br/>抜群に高い初期制動を誇りながらも、非常にコントローラブル！<br/>周回数を重ねても変化しない剛性感のあるペダルタッチ<br/>Ｓタイヤをはじめとし、スリックタイヤ、ハイグリップラジアルが対象<br/>VWシロッコカップチャイナシリーズの公式指定パッドに選定！</p>
	                        </div>
	                        <div id="menu2" class="tab-pane fade">
	                          <p>・材質:カーボンセミメタル<br/>・適正温度:200～900℃<br/>・初期μ:0.51<br/>・平均μ:0.40～0.45<br/>・ステージ:レース/ラリー/サーキット走行</p>
	                        </div>
	                      </div>
	                      <script>
	                ...
	                <table style="table-layout:fixed;" width="100%">
	                  ...
	                  <tr>
	                    ...
	                    <p class="search_category">**********【商品検索】**********&nbsp;&nbsp;<a class="change_button" href="../../sale/item/10353.php"><img src="../../img/sale_button.jpg" alt="単品販売の価格表はコチラ"></a></p>
	                  </tr>
	                </table>
	                  <?php
	                  	$root_dir = __DIR__.'/../../..';
