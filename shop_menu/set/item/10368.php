	              ...
	              <div class="set_sale_back">
	                    ...
	                    <div class="tab_wrap">
	                      ...
	                      <div class="tab-content">
	                        <div id="home" class="tab-pane fade in active show">
	                          <p>プラス20％の制動力がもたらす安全性<br/>PDタイプに比べ、摩擦係数が最大20％アップしていることで車輌の安全性が向上＆ ゆとりのあるドライビングが可能になります。スリット本数は鳴き、摩耗、ガスの除去効果など様々な事案を考慮し6本となっています。</p>
	                        </div>
	                        <div id="menu2" class="tab-pane fade">
	                          <p>・20％摩擦係数向上(PDタイプ比)<br/>・スリットローター<br/>・防錆コーティング</p>
	                        </div>
	                      </div>
	                      <script>
	                ...
	                <table style="table-layout:fixed;" width="100%">
	                  ...
	                  <tr>
	                    ...
	                    <p class="search_category">**********【商品検索】**********&nbsp;&nbsp;<a class="change_button" href="../../sale/item/10368.php"><img src="../../img/sale_button.jpg" alt="単品販売の価格表はコチラ"></a></p>
	                  </tr>
	                </table>
	                  <?php
	                  	$root_dir = __DIR__.'/../../..';
