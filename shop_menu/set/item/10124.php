 <html>
								<head>
								<meta content="全長の短いショックアブソーバーに対してホースで別体タンクを連結することで余裕ある容量を実現したモデル。別体タンク部には圧縮側減衰調整、ショック本体のエンド部分には伸び側減衰調整をそれぞれ装備。シチュエーションにあわせたより細かなセッティングが可能です。" name="description"/>
<meta content="text/html; charset=utf-8" http-equiv="Content-Type"><meta content="width=device-width, user-scalable=yes, initial-scale=1, maximum-scale=1" name="viewport"/><meta content="width=device-width" name="viewport"/><title>KTS-web 工賃セットメニュー OHLINS Type PB</title><script type="application/ld+json">{@context: "http://schema.org",@type: "BreadcrumbList",itemListElement:[{@type: "ListItem",position: 1,item:{@id: "/shop_menu/",name: "SHOP MENU"}},{@type: "ListItem",position: 2,item:{@id: "/set/",name: "工賃セットメニュー"}},{@type: "ListItem",position: 3,item:{@id: "/item/10124.php",name: "Type PB"}}]}</script><script src="https://ajax.googleapis.com/ajax/libs/jquery/3.1.1/jquery.min.js"></script>
<meta content="width=device-width, user-scalable=yes, initial-scale=1, maximum-scale=1" name="viewport"/>
<meta content="width=device-width" name="viewport"/>
<title>KTS-web 工賃セットメニュー OHLINS Type PB</title>
	              ...
	              <div class="set_sale_back">
	                ...
	                <div class="set_menu_n row">
	                  <div class="set_menu_n_330 col-md-6 col-sm-12 col-xs-12">
	                    <div><img alt="Type PB" src="../../brand/img/1046.gif"/></div>
	                  </div>
	                  <div class="set_menu_n_cell col-md-6 col-sm-12 col-xs-12">
	                    <div class="item_info_text_middle"><p>OHLINS[オーリンズ]</p></div><div class="item_info_text_middle_b"><p>Type PB[タイプPB]</p></div>
	                  </div>
	                </div>
	                <div class="set_menu_n row">
	                  <div class="set_menu_n_330 col-md-6 col-sm-12 col-xs-12">
	                    <div>
	                      <div class="swiper-container"><div class="swiper-wrapper"><div class="swiper-slide"><img alt="Type PB" src="../../item_img/10124_1.jpg"/></div><div class="swiper-slide"><img alt="Type PB" src="../../item_img/10124_2.jpg"/></div><div class="swiper-slide"><img alt="Type PB" src="../../item_img/10124_3.jpg"/></div></div><div class="swiper-button-prev"></div><div class="swiper-button-next"></div></div>
	                    </div>
	                    ...
	                    <div class="tab_wrap">
	                      ...
	                      <div class="tab-content">
	                        <div id="home" class="tab-pane fade in active show">
	                          <p>全長の短いショックアブソーバーに対してホースで別体タンクを連結することで余裕ある容量を実現したモデル。別体タンク部には圧縮側減衰調整、ショック本体のエンド部分には伸び側減衰調整をそれぞれ装備。シチュエーションにあわせたより細かなセッティングが可能です。</p>
	                        </div>
	                        <div id="menu2" class="tab-pane fade">
	                          <p>・ネジ式車高調整別タンクモデル<br/>・圧側/伸側双方の減衰力調整可</p>
	                        </div>
	                      </div>
	                      <script>
	                ...
	                <table style="table-layout:fixed;" width="100%">
	                  ...
	                  <tr>
	                    ...
	                    <p class="search_category">**********【商品検索】**********&nbsp;&nbsp;<a class="change_button" href="../../sale/item/10124.php"><img src="../../img/sale_button.jpg" alt="単品販売の価格表はコチラ"></a></p>
	                  </tr>
	                </table>
	                  <?php
	                  	$root_dir = __DIR__.'/../../..';
