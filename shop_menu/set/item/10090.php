 <html>
<head>
<meta content="車高調シリーズのハイエンドモデルとして位置づけられるハイパーフット。 36段階の減衰力調整機能に加えて、クイックなハンドリングを楽しめるピロアッパーマウントを全車に標準装備。 またスライド調整機構も採用しているため、ショートナックルを装着した際に発生しがちなスプリングとの干渉を防げます。 ショックの全長を短くし、スプリングも低車高での走行を想定したハイレート＆超ショートタイプ。" name="description"/>
<meta content="text/html; charset=utf-8" http-equiv="Content-Type"/><meta content="width=device-width, user-scalable=yes, initial-scale=1, maximum-scale=1" name="viewport"><meta content="width=device-width" name="viewport"/><title>KTS-web 工賃セットメニュー IDEAL HYPER FOOT</title><script type="application/ld+json">{@context: "http://schema.org",@type: "BreadcrumbList",itemListElement:[{@type: "ListItem",position: 1,item:{@id: "/shop_menu/",name: "SHOP MENU"}},{@type: "ListItem",position: 2,item:{@id: "/set/",name: "工賃セットメニュー"}},{@type: "ListItem",position: 3,item:{@id: "/item/10090.php",name: "HYPER FOOT"}}]}</script><script src="https://ajax.googleapis.com/ajax/libs/jquery/3.1.1/jquery.min.js"></script>
<meta content="width=device-width, user-scalable=yes, initial-scale=1, maximum-scale=1" name="viewport"/>
<meta content="width=device-width" name="viewport"/>
<title>KTS-web 工賃セットメニュー IDEAL HYPER FOOT</title>
...
<div><img alt="HYPER FOOT" src="../../brand/img/1012.gif"/></div>
</div>
<div class="set_menu_n_cell col-md-6 col-sm-12 col-xs-12">
<div class="item_info_text_middle"><p>IDEAL[イデアル]</p></div><div class="item_info_text_middle_b"><p>HYPER FOOT[ハイパーフット]</p></div>
</div>
</div>
<div class="set_menu_n row">
<div class="set_menu_n_330 col-md-6 col-sm-12 col-xs-12">
<div>
<div class="swiper-container"><div class="swiper-wrapper"><div class="swiper-slide"><img alt="HYPER FOOT" src="../../item_img/10090_1.jpg"/></div><div class="swiper-slide"><img alt="HYPER FOOT" src="../../item_img/10090_2.jpg"/></div><div class="swiper-slide"><img alt="HYPER FOOT" src="../../item_img/10090_3.jpg"/></div></div><div class="swiper-button-prev"></div><div class="swiper-button-next"></div></div>
</div>
<div class="item_caution"><p>※写真はイメージ・代表画像です。 </p><p>※実際の商品とカラーやイメージが異なる場合がございます。</p></div>
</div>
<div class="set_menu_n_cell col-md-6 col-sm-12 col-xs-12">
<a class="set-sale-switch" href="../../sale/item/10090.php">メニュー内容・物販へのリンク</a><div class="tab_wrap">
