<html>
 <head>
  ...
  <title>
   KTS-web 工賃セットメニュー ESPELIR Super DOWNSUS Type-2
  </title>
  <script type="application/ld+json">
   {@context: "http://schema.org",@type: "BreadcrumbList",itemListElement:[{@type: "ListItem",position: 1,item:{@id: "/shop_menu/",name: "SHOP MENU"}},{@type: "ListItem",position: 2,item:{@id: "/set/",name: "工賃セットメニュー"}},{@type: "ListItem",position: 3,item:{@id: "/item/10047.php",name: "Super DOWNSUS Type-2"}}]}
  </script>
     ...
     <div id="content-wrapper">
      ...
      <div class="main_c row grey-wrapper">
       <div class="mc_nav">
        ...
        &gt;
        <a class="link" href="../br/1030-117.html">
         ESPELIR
        </a>
        &gt;
        <a class="link" href="10047.php">
       ...
       <div class="set_sale_back">
        ...
        <div class="set_menu_n row">
         <div class="set_menu_n_330 col-md-6 col-sm-12 col-xs-12">
          <div>
           <img alt="Super DOWNSUS Type-2" src="../../brand/img/1030.gif"/>
          </div>
         </div>
         <div class="set_menu_n_cell col-md-6 col-sm-12 col-xs-12">
          ...
          <div class="item_info_text_middle_b">
           <p>
            Super DOWNSUS Type-2[スーパーダウンサス タイプ2]
           </p>
          </div>
         </div>
        </div>
           ...
           <div class="swiper-container">
            <div class="swiper-wrapper">
             <div class="swiper-slide">
              <img alt="Super DOWNSUS Type-2" src="../../item_img/10047_1.jpg"/>
             </div>
             <div class="swiper-slide">
              <img alt="Super DOWNSUS Type-2" src="../../item_img/10047_2.jpg"/>
             </div>
             <div class="swiper-slide">
              <img alt="Super DOWNSUS Type-2" src="../../item_img/10047_3.jpg"/>
             </div>
            </div>
