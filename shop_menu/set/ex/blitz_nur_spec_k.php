<?php
	...
	/* 各種項目設定 */
		...
		/* ファイル名 */
		$file_name = "blitz_nur_spec_k.php";

		/* SETメニュー名 */
		$set_name = "BLITZ NUR-SPEC K取付SETメニュー";

		/* DBパス */
		$set_db = "db/blitz/nur_spec_k.csv";
...
<?php
	...
	for($cnt = 1; $cnt < $i; $cnt++){
		...
		if($db_data[$cnt][0] == $maker){
			/* ECリンク解除 print "			<tr data-href=https://www.kts-web.com/ec_shop/products/detail/"; */
			/* ECリンク解除 print_r($db_data[$cnt][9]); */
			/* ECリンク解除 print ">\n"; */
			print "			<tr>\n";
