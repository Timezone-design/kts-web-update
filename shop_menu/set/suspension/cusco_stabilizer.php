<?php
	...
	/* 各種項目設定 */
		...
		/* ファイル名 */
		$file_name = "cusco_stabilizer.php";

		/* SETメニュー名 */
		$set_name = "CUSCO スタビライザー取付SETメニュー";

		/* DBパス */
		$set_db = "db/cusco/stabilizer.csv";
...
?>
		...
		<div class="footer_text_t">
			<div class="footer_text_c1">※：</div>
			<div class="footer_text_c2">リヤスタビバー等の関連オプションパーツについては別途お問合せ下さい。</div>
		</div>
		<div class="footer_text_t">
			<div class="footer_text_c1">※：</div>
