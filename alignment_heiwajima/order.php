				...
				<td>
					...
					<table width="98%" align="center">
						...
						<tr>
							...
							<td><input type="radio" name="wheel" value="13">13インチ　<input type="radio" name="wheel" value="14">14インチ　<input type="radio" name="wheel" value="15">15インチ　<input type="radio" name="wheel" value="16">16インチ　<input type="radio" name="wheel" value="17">17インチ　<input type="radio" name="wheel" value="18">18インチ　<input type="radio" name="wheel" value="19">19インチ<br><input type="radio" name="wheel" value="20">20インチ　<input type=radio name=wheel value=21>21インチ　<input type=radio name=wheel value=22>22インチ</td>
						</tr>
						<tr><td></td></tr>
						<tr><td valign="top"><div align="right"><b>その他：</b></div></td><td><b>当てはまる項目にチェックを入れて下さい（複数選択可）</b><br><font color="#FF0000">※下記項目に該当する場合、作業が行えない可能性がございますので予めご了承下さい。</font><br><input type="checkbox" name="syakou" value="1">車高が極端に低い状態<br><input type="checkbox" name="fender" value="1">フェンダーがリムにかぶる状態<br><input type="checkbox" name="camber" value="1">キャンバー角が5度以上ついている<br><input type="checkbox" name="lift1" value="1">ジャッキアップポイントにLED、ネオン管等が付いている<br><input type="checkbox" name="lift2" value="1">ジャッキアップポイントがサイドステップ等で隠れている</td></tr>
					</table>
				</td>
			</tr>
