<?php
	...
	/* その他項目のチェック */
	if($syakou == 1){$sheet_check = 3;}
	if($fender == 1){$sheet_check = 3;}
	if($camber == 1){$sheet_check = 3;}
	if($lift1 == 1){$sheet_check = 3;}
	if($lift2 == 1){$sheet_check =3;}
...
<?php if($sheet_check == 3):?>
		<div>大変申し訳ございませんが「その他」の項目にて選択頂いた状態の車輌についてはオンラインでのご予約はお受けできません。</div>
		<div>お手数ですが店舗までお電話にてご連絡頂き、車輛状態の詳細をお伝え頂いた上でご予約をお願い致します。</div>
		<div><br><b>KTS平和島店</b>　TEL：03-5767-5832<br>（営業時間：午前11時～午後20時　定休日：毎週木曜日、第3水曜日）</div>
		<table width="700">
			<tr>
				<td>
					<div align="right"><a href="alignment.php"><img src="yoyaku_jokyou.gif" border="0"></a></div>
...
<?php if($sheet_check == 3){exit();} ?>
		...
		<table width="700" border="0">
			...
			<tr>
				<td><b><font size=3 color="#000000"><a href="http://www.kts-web.com/shop_menu/tenpo/heiwajima.html" target="_blank">KTS平和島店</a> TEL: 03-5767-5832</font></b></td>
			</tr>
		</table>
		<table width="700">
				...
				<td>
					...
					<table width="100%">
						<tr>
							...
							<td><b><font color="#FF0000">ホイールのリムにフェンダーが被っている車輌、極端に車高が下がっている車輌、キャンバー角が過度に付き過ぎている車輌については測定ができない為、作業をお断りさせて頂きます。</font></b></td>
						</tr>
						<tr>
							<td valign="top"><div align="right"><b>・</b></td>
							<td>
								<b>輸入車の作業をご希望の場合は直接お電話にてお問合せ下さい。</b><br>
								<font color="#FF0000">※輸入車料金は基本￥20,000～になります。</font><br>
...
<?php if($check_all == 1 and $mail_c != 1):?><tr><td><div align="right"><b>メールアドレス：</b></div></td><td><input type="text" name="mail" size="50" value=<?php print "$mail"; ?>>※半角英数</td></tr><?php endif;?>
						...
						<tr><td><div align="right"><b>　</b></div></td><td><font color="#FF0000">携帯アドレスをご利用される場合は「alignment-heiwajima@kts-web.com」から受信可能か確認して下さい。</font></td></tr>
...
<?php if($check_all == 0 and $wheel == 22):?><tr><input type="hidden" name="wheel" value=<?php print "$wheel"; ?>><td><div align="right"><b>装着ホイールサイズ：</b></div></td><td>22インチ</td></tr><?php endif;?>
...
<?php if($check_all == 1 and $wheel_c != 1 and $wheel == 13):?><tr><td valign="top"><div align="right"><b>装着ホイールサイズ：</b></div></td><td><input type="radio" name="wheel" value="13" checked>13インチ　<input type="radio" name="wheel" value=14>14インチ　<input type="radio" name="wheel" value="15">15インチ　<input type="radio" name="wheel" value="16">16インチ　<input type="radio" name="wheel" value="17">17インチ　<input type="radio" name="wheel" value="18">18インチ　<input type="radio" name="wheel" value="19">19インチ<br><input type="radio" name="wheel" value="20">20インチ　<input type="radio" name="wheel" value="21">21インチ　<input type="radio" name="wheel" value="22">22インチ</td></tr><?php endif;?>
...
<?php if($check_all == 1 and $wheel_c != 1 and $wheel == 16):?><tr><td valign="top"><div align="right"><b>装着ホイールサイズ：</b></div></td><td><input type="radio" name="wheel" value="13">13インチ　<input type="radio" name="wheel" value=14>14インチ　<input type="radio" name="wheel" value="15">15インチ　<input type="radio" name="wheel" value="16" checked>16インチ　<input type="radio" name="wheel" value="17">17インチ　<input type="radio" name="wheel" value="18">18インチ　<input type="radio" name="wheel" value="19">19インチ<br><input type="radio" name="wheel" value="20">20インチ　<input type="radio" name="wheel" value="21">21インチ　<input type="radio" name="wheel" value="22">22インチ</td></tr><?php endif;?>
<?php if($check_all == 1 and $wheel_c != 1 and $wheel == 17):?><tr><td valign="top"><div align="right"><b>装着ホイールサイズ：</b></div></td><td><input type="radio" name="wheel" value="13">13インチ　<input type="radio" name="wheel" value=14>14インチ　<input type="radio" name="wheel" value="15">15インチ　<input type="radio" name="wheel" value="16">16インチ　<input type="radio" name="wheel" value="17" checked>17インチ　<input type="radio" name="wheel" value="18">18インチ　<input type="radio" name="wheel" value="19">19インチ<br><input type="radio" name="wheel" value="20">20インチ　<input type="radio" name="wheel" value="21">21インチ　<input type="radio" name="wheel" value="22">22インチ</td></tr><?php endif;?>
<?php if($check_all == 1 and $wheel_c != 1 and $wheel == 18):?><tr><td valign="top"><div align="right"><b>装着ホイールサイズ：</b></div></td><td><input type="radio" name="wheel" value="13">13インチ　<input type="radio" name="wheel" value=14>14インチ　<input type="radio" name="wheel" value="15">15インチ　<input type="radio" name="wheel" value="16">16インチ　<input type="radio" name="wheel" value="17">17インチ　<input type="radio" name="wheel" value="18" checked>18インチ　<input type="radio" name="wheel" value="19">19インチ<br><input type="radio" name="wheel" value="20">20インチ　<input type="radio" name="wheel" value="21">21インチ　<input type="radio" name="wheel" value="22">22インチ</td></tr><?php endif;?>
<?php if($check_all == 1 and $wheel_c != 1 and $wheel == 19):?><tr><td valign="top"><div align="right"><b>装着ホイールサイズ：</b></div></td><td><input type="radio" name="wheel" value="13">13インチ　<input type="radio" name="wheel" value=14>14インチ　<input type="radio" name="wheel" value="15">15インチ　<input type="radio" name="wheel" value="16">16インチ　<input type="radio" name="wheel" value="17">17インチ　<input type="radio" name="wheel" value="18">18インチ　<input type="radio" name="wheel" value="19" checked>19インチ<br><input type="radio" name="wheel" value="20">20インチ　<input type="radio" name="wheel" value="21">21インチ　<input type="radio" name="wheel" value="22">22インチ</td></tr><?php endif;?>
<?php if($check_all == 1 and $wheel_c != 1 and $wheel == 20):?><tr><td valign="top"><div align="right"><b>装着ホイールサイズ：</b></div></td><td><input type="radio" name="wheel" value="13">13インチ　<input type="radio" name="wheel" value=14>14インチ　<input type="radio" name="wheel" value="15">15インチ　<input type="radio" name="wheel" value="16">16インチ　<input type="radio" name="wheel" value="17">17インチ　<input type="radio" name="wheel" value="18">18インチ　<input type="radio" name="wheel" value="19">19インチ<br><input type="radio" name="wheel" value="20" checked>20インチ　<input type="radio" name="wheel" value="21">21インチ　<input type="radio" name="wheel" value="22">22インチ</td></tr><?php endif;?>
<?php if($check_all == 1 and $wheel_c != 1 and $wheel == 21):?><tr><td valign="top"><div align="right"><b>装着ホイールサイズ：</b></div></td><td><input type="radio" name="wheel" value="13">13インチ　<input type="radio" name="wheel" value=14>14インチ　<input type="radio" name="wheel" value="15">15インチ　<input type="radio" name="wheel" value="16">16インチ　<input type="radio" name="wheel" value="17">17インチ　<input type="radio" name="wheel" value="18">18インチ　<input type="radio" name="wheel" value="19">19インチ<br><input type="radio" name="wheel" value="20">20インチ　<input type="radio" name="wheel" value="21" checked>21インチ　<input type="radio" name="wheel" value="22">22インチ</td></tr><?php endif;?>
<?php if($check_all == 1 and $wheel_c != 1 and $wheel == 22):?><tr><td valign="top"><div align="right"><b>装着ホイールサイズ：</b></div></td><td><input type="radio" name="wheel" value="13">13インチ　<input type="radio" name="wheel" value=14>14インチ　<input type="radio" name="wheel" value="15">15インチ　<input type="radio" name="wheel" value="16">16インチ　<input type="radio" name="wheel" value="17">17インチ　<input type="radio" name="wheel" value="18">18インチ　<input type="radio" name="wheel" value="19">19インチ<br><input type="radio" name="wheel" value="20">20インチ　<input type="radio" name="wheel" value="21">21インチ　<input type="radio" name="wheel" value="22" checked>22インチ</td></tr><?php endif;?>
...
<?php
	if($check_all == 0){
		$no_check = 0;
		if($syakou == 1){print "<input type=hidden name=syakou value=1>"; $no_check = 1;}
		...
		print "<td>";
		if($syakou == 1){print "<div>車高が極端に低い状態</div>";}
	...
	if($check_all == 1){
		...
		if($syakou == 1){print "<div><input type=checkbox name=syakou value=1 checked>車高が極端に低い状態</div>";}
		if($syakou != 1){print "<div><input type=checkbox name=syakou value=1>車高が極端に低い状態</div>";}
