<?php
	...
	/* 各種項目設定 */
		...
		/* ファイル名 */
		$file_name = "high_power_clutch.php";

		/* 商品名 */
		$set_name = "戸田レーシング ハイパワーシングルクラッチKIT";

		/* DBパス */
		$set_db = "db/high_power_clutch.csv";
...
<?php
	...
	if($camp_b_switch == 3){print "			<div class=camp_b><img src=../img/mcamp_koni.gif></div>\n";}
	/* メーカーアイコン処理（PC） */
	$icon_pc_cnt = 1;
