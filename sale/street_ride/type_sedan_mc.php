<?php
	...
	/* 各種項目設定 */
		...
		/* ファイル名 */
		$file_name = "type_sedan_mc.php";

		/* 商品名 */
		$set_name = "Street Ride TYPE-SEDAN MODEL COMFORT";

		/* DBパス */
		$set_db = "db/type_sedan_mc.csv";

		/* Campスイッチ 0：通常　1：バナー1　2：バナー2 　3：バナーM */
		$camp_b_switch = 0;
...
<?php
	...
	if($camp_b_switch == 3){print "			<div class=camp_b><img src=../img/mcamp_street_ride.gif></div>\n";}
	/* メーカーアイコン処理（PC） */
	$icon_pc_cnt = 1;
