...
?>
	...
	<body bgcolor="#FFFFFF" text="#000000">
		...
		<div class="center_900">下記内容でお客様にメールを送信します。追加コメントがある場合は入力して下さい。</div>
		<div class="space5px"></div>
		<div class="center_900"><span class="font_b_110">◆送信メール内容</div>
		<div class="space5px"></div>
		<div class="center_900">
			<form method="post" action="alignment_check.php">
				<input type="hidden" name="send_check" value="2">
				<input type="hidden" name="year" value="<?php print "$year"; ?>">
				<input type="hidden" name="mon" value="<?php print "$mon"; ?>">
				<input type="hidden" name="day" value="<?php print "$day"; ?>">
				<input type="hidden" name="sheet_file" value="<?php print "$sheet_file"; ?>">
				<input type="submit" value="メール送信を行わずパラメーターのみ変更する">
			</form>
		</div>
		<div class="space5px"></div>
		<table class="center_900" cellspacing="0" border="1" bordercolor="#00FFFF">
			...
			<tr>
				<td>
					...
					<div>■作業日時： <?php print "$year"; ?>年<?php print "$mon"; ?>月<?php print "$day"; ?>日（<?php print "$wday"; ?>）<?php print "$time_sf"; ?></di>
		...
		<div class="space5px"></div>
		<div class="center_900">お客様に別途連絡事項がある場合は下記に入力して下さい。</div>
		<div class="space5px"></div>
		<div class="center_900">
			<form method="post" action="alignment_check.php">
				...
				<input type="hidden" name="day" value="<?php print "$day"; ?>">
				<input type="hidden" name="sheet_file" value="<?php print "$sheet_file"; ?>">
				<input type="text" name="tenpo_comment" size="50">
				<input type="button" value="戻る" onClick="history.back()">　<input type="submit" value="確認">
			</form>
		</div>
		<div class="space5px"></div>
