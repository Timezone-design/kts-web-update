...
<title>KTS-web タイヤ・ホイール館 KENDA（ケンダ）</title>
              ...
              <div class="th_back row">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                   <div class="th_title_730"><img alt="ミニバン・バン・ライトトラック用" src="img/b_logo/minivan.gif"/></div> <hr class="th_hr" noshade=""/> <div class="th_comm_bar_00f"> <div class="th_comm_bar_3px">KR201</div> </div> <div class="th_table"> <div class="th_table_photo_350"><img alt="KENDA KR201" class="th_tire_img" src="img/minivan/kr201.jpg"/></div> <div class="th_table_cell"> <div class="th_table_comm">for Minivan Style - ミニバンならKENDA。</div> <div class="th_tire_price"><form action="../maker_item.php" method="post" target="_blank"><input name="maker" type="hidden" value="KENDA"/><input name="brand" type="hidden" value="ミニバン・バン・ライトトラック用"/><input name="item" type="hidden" value="KR201"/><input name="image" src="../img/price.gif" type="image"/></form></div> </div> </div> 
                </div>
                <div class="col-md-6 col-sm-6 col-xs-12">
