...
<title>KTS-web タイヤ・ホイール館 KENDA（ケンダ）</title>
              ...
              <div class="th_back row">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                   <div class="th_title_730"><img alt="スポーツタイヤ" src="img/b_logo/sport.gif"/></div> <hr class="th_hr" noshade=""/> <div class="th_comm_bar_00f"> <div class="th_comm_bar_3px">KR20A</div> </div> <div class="th_table"> <div class="th_table_photo_350"><img alt="KENDA KR20A" class="th_tire_img" src="img/sport/kr20a.jpg"/></div> <div class="th_table_cell"> <div class="th_table_comm">ハイグリップ・コンパウンドを採用した、KR20のアドバンスト・モデル。</div> <div class="th_table_comm">思いのままのライン取りとレース展開を可能にする、リアルスポーツタイヤです。</div> <div class="th_tire_price"><form action="../maker_item.php" method="post" target="_blank"><input name="maker" type="hidden" value="KENDA"/><input name="brand" type="hidden" value="スポーツタイヤ"/><input name="item" type="hidden" value="KR20A"/><input name="image" src="../img/price.gif" type="image"/></form></div> </div> </div> <hr class="th_hr" noshade=""/> <div class="th_comm_bar_00f"> <div class="th_comm_bar_3px">KR20</div> </div> <div class="th_table"> <div class="th_table_photo_350"><img alt="KENDA KR20" class="th_tire_img" src="img/sport/kr20.jpg"/></div> <div class="th_table_cell"> <div class="th_table_comm">独自のトレッドデザインによって、振動の抑制とロードノイズの軽減を実現した高性能なラジアルタイヤ。</div> <div class="th_table_comm">優れたコーナリングとハンドリング、トラクションによって、より一体感のあるスポーツドライビングが楽しめます。</div> <div class="th_tire_price"><form action="../maker_item.php" method="post" target="_blank"><input name="maker" type="hidden" value="KENDA"/><input name="brand" type="hidden" value="スポーツタイヤ"/><input name="item" type="hidden" value="KR20"/><input name="image" src="../img/price.gif" type="image"/></form></div> </div> </div> 
                </div>
                <div class="col-md-6 col-sm-6 col-xs-12">
