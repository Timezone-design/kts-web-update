 <html>
							<head>
							<meta content="KENDA,ケンダ,タイヤ,販売,装着,脱着,アライメント" name="keywords"/>
<meta content="KENDA製タイヤ販売中！取付・バランス取りも特価で承っております！" name="description"/>
<meta content="text/html; charset=utf-8" http-equiv="Content-Type"/>
<meta content="width=device-width, user-scalable=yes, initial-scale=1, maximum-scale=1" name="viewport"/>
<meta content="width=device-width" name="viewport"/>
<title>KTS-web タイヤ・ホイール館 KENDA（ケンダ）</title>
              ...
              <div class="th_back row">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                   <div class="th_title_730"><img alt="乗用車用" src="img/b_logo/std.gif"/></div> <hr class="th_hr" noshade=""/> <div class="th_comm_bar_00f"> <div class="th_comm_bar_3px">KR32</div> </div> <div class="th_table"> <div class="th_table_photo_350"><img alt="KENDA KR32" class="th_tire_img" src="img/std/kr32.jpg"/></div> <div class="th_table_cell"> <div class="th_table_comm">進化しつづける、人にも地球にもやさしいエコタイヤ。</div> <div class="th_table_comm">ドライビング性能と静粛性を両立しながら、ウェットな路面でも転がり抵抗を減らすとともに、ロードノイズも軽減しています。</div> <div class="th_tire_price"><form action="../maker_item.php" method="post" target="_blank"><input name="maker" type="hidden" value="KENDA"/><input name="brand" type="hidden" value="乗用車用"/><input name="item" type="hidden" value="KR32"/><input name="image" src="../img/price.gif" type="image"/></form></div> </div> </div> <hr class="th_hr" noshade=""/> <div class="th_comm_bar_00f"> <div class="th_comm_bar_3px">KR23A</div> </div> <div class="th_table"> <div class="th_table_photo_350"><img alt="KENDA KR23A" class="th_tire_img" src="img/std/kr23a.jpg"/></div> <div class="th_table_cell"> <div class="th_table_comm">KENDAのNMAテクノロジーによって進化した革命的なトレッドデザインが、もっとも静粛性の高いツーリング用ラジアルタイヤを実現。</div> <div class="th_table_comm">センターリブを配置したトレッドパターンが、より高いコントロール性を発揮します。</div> <div class="th_tire_price"><form action="../maker_item.php" method="post" target="_blank"><input name="maker" type="hidden" value="KENDA"/><input name="brand" type="hidden" value="乗用車用"/><input name="item" type="hidden" value="KR23A"/><input name="image" src="../img/price.gif" type="image"/></form></div> </div> </div> <hr class="th_hr" noshade=""/> <div class="th_comm_bar_00f"> <div class="th_comm_bar_3px">KR20</div> </div> <div class="th_table"> <div class="th_table_photo_350"><img alt="KENDA KR23" class="th_tire_img" src="img/std/kr23.jpg"/></div> <div class="th_table_cell"> <div class="th_table_comm">KENDAのNMAテクノロジーによって進化したトレッドデザインが静粛性の高いコンフォートタイヤを実現。</div> <div class="th_table_comm">センターリブを配置したトレッドパターンが、より高いコントロール性を発揮します。</div> <div class="th_tire_price"><form action="../maker_item.php" method="post" target="_blank"><input name="maker" type="hidden" value="KENDA"/><input name="brand" type="hidden" value="乗用車用"/><input name="item" type="hidden" value="KR23"/><input name="image" src="../img/price.gif" type="image"/></form></div> </div> </div> 
                </div>
                <div class="col-md-6 col-sm-6 col-xs-12">
