...
<title>KTS-web タイヤ・ホイール館 KENDA（ケンダ）</title>
              ...
              <div class="th_back row">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                   <div class="th_title_730"><img alt="SUV・4×4用" src="img/b_logo/suv.gif"/></div> <hr class="th_hr" noshade=""/> <div class="th_comm_bar_00f"> <div class="th_comm_bar_3px">KR50</div> </div> <div class="th_table"> <div class="th_table_photo_350"><img alt="KENDA KR50" class="th_tire_img" src="img/suv/kr50.jpg"/></div> <div class="th_table_cell"> <div class="th_table_comm">低燃費、耐摩耗性、低ノイズを実現。</div> <div class="th_tire_price"><form action="../maker_item.php" method="post" target="_blank"><input name="maker" type="hidden" value="KENDA"/><input name="brand" type="hidden" value="SUV・4×4用"/><input name="item" type="hidden" value="KR50"/><input name="image" src="../img/price.gif" type="image"/></form></div> </div> </div> 
                </div>
                <div class="col-md-6 col-sm-6 col-xs-12">
