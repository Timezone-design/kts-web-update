 <html>
							<head>
							<meta content="FALKEN,ファルケン,ZIEX,ジークス,販売,装着,脱着,アライメント" name="keywords"/>
...
<title>KTS-web タイヤ・ホイール館 FALKEN（ファルケン）ZIEX</title>
              ...
              <div class="th_back row">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                   <div class="th_title_730"><img alt="ZIEX" src="img/b_logo/ziex.gif"/></div> <hr class="th_hr" noshade=""/> <div class="th_comm_bar_00f"> <div class="th_comm_bar_3px">S/TZ05（エスティゼットゼロゴ）</div> </div> <div class="th_table"> <div class="th_table_photo_350"><img alt="FALKEN ZIEX S/TZ05" class="th_tire_img" src="img/ziex/s_tz05.jpg"/></div> <div class="th_table_cell"> <div class="th_table_comm"><span class="font_3fc_b">街中でも高速路でも優雅なドライブに欠かせないSUV専用タイヤ</span></div> <div class="th_table_comm">高速走行時のウエット性能を確保しながらも、高い静粛性能を実現。高級SUVやスポーツトラック等をドレスアップします。</div> <div class="th_tire_price"><form action="../maker_item.php" method="post" target="_blank"><input name="maker" type="hidden" value="FALKEN"/><input name="brand" type="hidden" value="ZIEX"/><input name="item" type="hidden" value="S/TZ05"/><input name="image" src="../img/price.gif" type="image"/></form></div> </div> </div> <hr class="th_hr" noshade=""/> <div class="th_comm_bar_00f"> <div class="th_comm_bar_3px">ZE914F（ゼットイーキューイチヨンエフ）</div> </div> <div class="th_table"> <div class="th_table_photo_350"><img alt="FALKEN ZIEX ZE914F" class="th_tire_img" src="img/ziex/ze914f.jpg"/></div> <div class="th_table_cell"> <div class="th_table_comm"><span class="font_3fc_b">操縦性、低燃費、乗り心地など万能性を追求した高品質タイヤ</span></div> <div class="th_table_comm">スポーツ性と快適性をハイレベルに引き上げることで安定したハンドリングを実現。幅広いユーザーにフィットします。</div> <div class="th_tire_price"><form action="../maker_item.php" method="post" target="_blank"><input name="maker" type="hidden" value="FALKEN"/><input name="brand" type="hidden" value="ZIEX"/><input name="item" type="hidden" value="ZE914F"/><input name="image" src="../img/price.gif" type="image"/></form></div> </div> </div> <hr class="th_hr" noshade=""/> <div class="th_comm_bar_00f"> <div class="th_comm_bar_3px">従来モデル・その他商品</div> </div> <div class="th_maker_top_list"> <div class="th_maker_top_list_cell"> <div class="th_maker_top_list2"> <div class="th_maker_top_list_cell2"><form action="../maker_item.php" method="post" target="_blank"><input name="maker" type="hidden" value="FALKEN"/><input name="brand" type="hidden" value="ZIEX"/><input name="item" type="hidden" value="ZE914 RUNFLAT"/><input class="th_form_180" name="image" src="img/ziex/ze914_runflat.gif" type="image"/></form></div> <div class="th_maker_top_list_cell2"></div> </div> </div> <div class="th_maker_top_list_cell"> <div class="th_maker_top_list2"> <div class="th_maker_top_list_cell2"></div> <div class="th_maker_top_list_cell2"></div> </div> </div> </div> 
                </div>
                <div class="col-md-6 col-sm-6 col-xs-12">
