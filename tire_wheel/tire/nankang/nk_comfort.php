...
<title>KTS-web タイヤ・ホイール館 NANKANG（ナンカン）</title>
              ...
              <div class="th_back row">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                   <div class="th_title_730"><img alt="NK COMFORT" src="img/b_logo/nk_comfort.gif"/></div> <hr class="th_hr" noshade=""/> <div class="th_comm_bar_00f"> <div class="th_comm_bar_3px">AS-1</div> </div> <div class="th_table"> <div class="th_table_photo_350"><img alt="NANKANG AS-1" class="th_tire_img" src="img/nk_comfort/as_1.jpg"/></div> <div class="th_table_cell"> <div class="th_table_comm">排水性を向上させるため、外側には幅広い直線溝デザイン。更に中間サブ溝でウェット路面での走行安全性を向上。</div> <div class="th_table_comm">ベストの静粛性を得るため、トレッドパターンには「2in1」マルチピッチデザインを採用。</div> <div class="th_tire_price"><form action="../maker_item.php" method="post" target="_blank"><input name="maker" type="hidden" value="NANKANG"/><input name="brand" type="hidden" value="NK COMFORT"/><input name="item" type="hidden" value="AS-1"/><input name="image" src="../img/price.gif" type="image"/></form></div> </div> </div> <div class="th_table"> <div class="th_review_main"><img src="../img/review/main_4.gif"/>4.25点</div> <div class="th_review_mini"> <div class="th_review_mini_cell"><img src="../img/review/mini_1/4.gif"/>4.4</div> <div class="th_review_mini_cell"><img src="../img/review/mini_2/4.gif"/>4.3</div> </div> <div class="th_review_mini"> <div class="th_review_mini_cell"><img src="../img/review/mini_3/4.gif"/>4.3</div> <div class="th_review_mini_cell"><img src="../img/review/mini_4/4.gif"/>4.4</div> </div> <div class="th_review_mini"> <div class="th_review_mini_cell"><img src="../img/review/mini_5/4.gif"/>4.3</div> <div class="th_review_mini_cell"><img src="../img/review/mini_6/4.gif"/>4.0</div> </div> </div> <hr class="th_hr" noshade=""/> <div class="th_comm_bar_00f"> <div class="th_comm_bar_3px">RX-615</div> </div> <div class="th_table"> <div class="th_table_photo_350"><img alt="NANKANG RX-615" class="th_tire_img" src="img/nk_comfort/rx_615.jpg"/></div> <div class="th_table_cell"> <div class="th_table_comm">4本の主溝が排水性を向上させ、ウェット路面での安全性をレベルアップ。</div> <div class="th_table_comm">ショルダー部にほぼ直角に溝を入れることで、非塗装路における牽引力・制動力が向上。</div> <div class="th_tire_price"><form action="../maker_item.php" method="post" target="_blank"><input name="maker" type="hidden" value="NANKANG"/><input name="brand" type="hidden" value="NK COMFORT"/><input name="item" type="hidden" value="RX-615"/><input name="image" src="../img/price.gif" type="image"/></form></div> </div> </div> <div class="th_table"> <div class="th_review_main"><img src="../img/review/main_4.gif"/>4.38点</div> <div class="th_review_mini"> <div class="th_review_mini_cell"><img src="../img/review/mini_1/4h.gif"/>4.6</div> <div class="th_review_mini_cell"><img src="../img/review/mini_2/4.gif"/>4.4</div> </div> <div class="th_review_mini"> <div class="th_review_mini_cell"><img src="../img/review/mini_3/4h.gif"/>4.5</div> <div class="th_review_mini_cell"><img src="../img/review/mini_4/4h.gif"/>4.5</div> </div> <div class="th_review_mini"> <div class="th_review_mini_cell"><img src="../img/review/mini_5/4.gif"/>4.3</div> <div class="th_review_mini_cell"><img src="../img/review/mini_6/4.gif"/>4.3</div> </div> </div> <hr class="th_hr" noshade=""/> <div class="th_comm_bar_00f"> <div class="th_comm_bar_3px">XR-611</div> </div> <div class="th_table"> <div class="th_table_photo_350"><img alt="NANKANG XR-611" class="th_tire_img" src="img/nk_comfort/xr_611.jpg"/></div> <div class="th_table_cell"> <div class="th_table_comm">ストレート溝がウェット路面での排水性と操縦性を向上。</div> <div class="th_table_comm">コンピューターシミュレーション計算したピッチパターンが騒音の発生を抑制。</div> <div class="th_tire_price"><form action="../maker_item.php" method="post" target="_blank"><input name="maker" type="hidden" value="NANKANG"/><input name="brand" type="hidden" value="NK COMFORT"/><input name="item" type="hidden" value="XR-611"/><input name="image" src="../img/price.gif" type="image"/></form></div> </div> </div> <div class="th_table"> <div class="th_review_main"><img src="../img/review/main_4.gif"/>4.39点</div> <div class="th_review_mini"> <div class="th_review_mini_cell"><img src="../img/review/mini_1/4h.gif"/>4.5</div> <div class="th_review_mini_cell"><img src="../img/review/mini_2/4.gif"/>4.3</div> </div> <div class="th_review_mini"> <div class="th_review_mini_cell"><img src="../img/review/mini_3/4.gif"/>4.3</div> <div class="th_review_mini_cell"><img src="../img/review/mini_4/4h.gif"/>4.5</div> </div> <div class="th_review_mini"> <div class="th_review_mini_cell"><img src="../img/review/mini_5/4.gif"/>4.3</div> <div class="th_review_mini_cell"><img src="../img/review/mini_6/4.gif"/>4.3</div> </div> </div> 
                </div>
                <div class="col-md-6 col-sm-6 col-xs-12">
