...
<title>KTS-web タイヤ・ホイール館 NANKANG（ナンカン）</title>
              ...
              <div class="th_back row">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                   <div class="th_title_730"><img alt="RACING" src="img/b_logo/racing.gif"/></div> <hr class="th_hr" noshade=""/> <div class="th_comm_bar_00f"> <div class="th_comm_bar_3px">AR-1</div> </div> <div class="th_table"> <div class="th_table_photo_350"><img alt="NANKANG AR-1" class="th_tire_img" src="img/racing/ar_1.jpg"/></div> <div class="th_table_cell"> <div class="th_table_comm">タイヤ幅の設計を最適化することで高速走行時の安定性を向上。</div> <div class="th_table_comm">特殊セミスリックコンパウンドを配合することでウォームアップ時間を有効に短縮でき、タイヤを素早く有効作業温度へと上げ、グリップ性能を向上。</div> <div class="th_tire_price"><form action="../maker_item.php" method="post" target="_blank"><input name="maker" type="hidden" value="NANKANG"/><input name="brand" type="hidden" value="RACING"/><input name="item" type="hidden" value="AR-1"/><input name="image" src="../img/price.gif" type="image"/></form></div> </div> </div> <div class="th_table"> <div class="th_review_main"><img src="../img/review/main_3.gif"/>3.47点</div> <div class="th_review_mini"> <div class="th_review_mini_cell"><img src="../img/review/mini_1/4h.gif"/>4.8</div> <div class="th_review_mini_cell"><img src="../img/review/mini_2/4.gif"/>4.1</div> </div> <div class="th_review_mini"> <div class="th_review_mini_cell"><img src="../img/review/mini_3/1h.gif"/>1.7</div> <div class="th_review_mini_cell"><img src="../img/review/mini_4/3.gif"/>3.1</div> </div> <div class="th_review_mini"> <div class="th_review_mini_cell"><img src="../img/review/mini_5/3.gif"/>3.1</div> <div class="th_review_mini_cell"><img src="../img/review/mini_6/2h.gif"/>2.7</div> </div> </div> <hr class="th_hr" noshade=""/> <div class="th_comm_bar_00f"> <div class="th_comm_bar_3px">NS-2R</div> </div> <div class="th_table"> <div class="th_table_photo_350"><img alt="NANKANG NS-2R" class="th_tire_img" src="img/racing/ns_2r.jpg"/></div> <div class="th_table_cell"> <div class="th_table_comm">あえて複数の特性を備えることで、ただ単に高速ドライビングを実現するだけでなく、コース上においてどのような天候条件であっても一貫した安定性のある高速ドライビングを実現する事を目指したタイヤ。</div> <div class="th_table_comm">ドライバーは晴れの日でも雨の日でもタイヤを交換することなく、確かな走りでサーキットやコースを訪れることができます。</div> <div class="th_tire_price"><form action="../maker_item.php" method="post" target="_blank"><input name="maker" type="hidden" value="NANKANG"/><input name="brand" type="hidden" value="RACING"/><input name="item" type="hidden" value="NS-2R"/><input name="image" src="../img/price.gif" type="image"/></form></div> </div> </div> <div class="th_table"> <div class="th_review_main"><img src="../img/review/main_3h.gif"/>3.76点</div> <div class="th_review_mini"> <div class="th_review_mini_cell"><img src="../img/review/mini_1/4h.gif"/>4.6</div> <div class="th_review_mini_cell"><img src="../img/review/mini_2/4.gif"/>4.0</div> </div> <div class="th_review_mini"> <div class="th_review_mini_cell"><img src="../img/review/mini_3/2h.gif"/>2.7</div> <div class="th_review_mini_cell"><img src="../img/review/mini_4/3h.gif"/>3.5</div> </div> <div class="th_review_mini"> <div class="th_review_mini_cell"><img src="../img/review/mini_5/3h.gif"/>3.5</div> <div class="th_review_mini_cell"><img src="../img/review/mini_6/3h.gif"/>3.5</div> </div> </div> 
                </div>
                <div class="col-md-6 col-sm-6 col-xs-12">
