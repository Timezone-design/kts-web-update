      ...
      <div class="main_c row grey-wrapper">
       ...
       <div class="th_back row">
        ...
        <div class="col-md-6 col-sm-6 col-xs-12">
         <div class="th_title_730">
          <img alt="Rollnex" src="img/b_logo/rollnex.gif"/>
         </div>
         <div class="clearfix-s">
         </div>
           ...
           <div class="tab-content">
            ...
            <div class="tab-pane fade" id="_2">
             <div class="th_table">
              ...
              <div class="th_table_cell">
               <div class="th_table_comm">
                ユニークで高強度なショルダーとサイドウォールがでこぼこ道での振動を吸収し、車のガタ揺れを抑制。
               </div>
               <div class="th_table_comm">
            ...
            <div class="tab-pane fade" id="_3">
             <div class="th_table">
              ...
              <div class="th_table_cell">
               <div class="th_table_comm">
                4本のストレートな溝により、濡れた路面条件でのタイヤ排水効率および操縦性が向上。
               </div>
               <div class="th_table_comm">
