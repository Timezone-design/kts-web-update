 <html>
							<head>
							<meta content="BRIDGESTONE,ブリヂストン,ブリジストン,タイヤ,NEXTRY,ネクストリー,販売,装着,脱着,アライメント" name="keywords"/>
...
<title>KTS-web タイヤ・ホイール館 BRIDGESTONE（ブリヂストン） NEXTRY</title>
              ...
              <div class="th_back row">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                   <div class="th_title_730"><img alt="NEXTRY" src="img/b_logo/nextry.gif"/></div> <hr class="th_hr" noshade=""/> <div class="th_comm_bar_00f"> <div class="th_comm_bar_3px">NEXTRY（ネクストリー）</div> </div> <div class="th_table"> <div class="th_table_photo_350"><img alt="ブリヂストン NEXTRY" class="th_tire_img" src="img/nextry/nextry.jpg"/></div> <div class="th_table_cell"> <div class="th_table_comm"><span class="font_3fc_b">これがブリヂストンの低燃費ベーシックタイヤ</span></div> <div class="th_table_comm">ブリヂストンの先進技術であるナノプロ・テックを採用したトレッドゴムにより、基本性能を犠牲にすることなく、転がり抵抗を低減。</div> <div class="th_table_comm">「ウェット性能」「ドライ性能」「乗り心地」といった基本性能を確保。</div> <div class="th_table_comm">セダンから軽・コンパクトカーまで豊富なサイズラインアップ。幅広い車種に対応。</div> <div class="th_tire_price"><form action="../maker_item.php" method="post" target="_blank"><input name="maker" type="hidden" value="BRIDGESTONE"/><input name="brand" type="hidden" value="NEXTRY"/><input name="item" type="hidden" value="NEXTRY"/><input name="image" src="../img/price.gif" type="image"/></form></div> </div> </div> <hr class="th_hr" noshade=""/> <div class="th_comm_bar_00f"> <div class="th_comm_bar_3px">SNEAKER SNK2（スニーカー エスエヌケーツー）</div> </div> <div class="th_table"> <div class="th_table_photo_350"><img alt="ブリヂストン NEXTRY SNEAKER SNK2" class="th_tire_img" src="img/nextry/sneaker_snk2.jpg"/></div> <div class="th_table_cell"> <div class="th_table_comm"><span class="font_3fc_b">基本性能を充実させたスタンダードタイヤ</span></div> <div class="th_table_comm">「ウェット性能」「ドライ性能」「乗り心地」といった基本性能を充実。</div> <div class="th_table_comm">水平接地形状と偏摩耗配慮ブロックの採用で偏摩耗を抑制し、ライフ性能にも配慮。</div> <div class="th_tire_price"><form action="../maker_item.php" method="post" target="_blank"><input name="maker" type="hidden" value="BRIDGESTONE"/><input name="brand" type="hidden" value="NEXTRY"/><input name="item" type="hidden" value="SNEAKER SNK2"/><input name="image" src="../img/price.gif" type="image"/></form></div> </div> </div> <hr class="th_hr" noshade=""/> <div class="th_comm_bar_00f"> <div class="th_comm_bar_3px">SNEAKER SNK2 ecopia（スニーカー エスエヌケーツー エコピア）</div> </div> <div class="th_table"> <div class="th_table_photo_350"><img alt="ブリヂストン NEXTRY SNEAKER SNK2 ecopia" class="th_tire_img" src="img/nextry/sneaker_snk2_ecopia.jpg"/></div> <div class="th_table_cell"> <div class="th_table_comm"><span class="font_3fc_b">低燃費性能を向上させたベーシックタイヤ</span></div> <div class="th_table_comm">「ウェット性能」「ドライ性能」「乗り心地」といった基本性能を追求しながら、低燃費性能を向上。</div> <div class="th_table_comm">コンパウンドは、独自の配合技術によってシリカが分配しトレッドゴムの発熱を抑え、エネルギーロスを低減。</div> <div class="th_table_comm">従来の「SNEAKER SNK2」との性能比較では、転がり抵抗を18％低減。</div> <div class="th_tire_price"><form action="../maker_item.php" method="post" target="_blank"><input name="maker" type="hidden" value="BRIDGESTONE"/><input name="brand" type="hidden" value="NEXTRY"/><input name="item" type="hidden" value="SNEAKER SNK2 ecopia"/><input name="image" src="../img/price.gif" type="image"/></form></div> </div> </div> 
                </div>
                <div class="col-md-6 col-sm-6 col-xs-12">
