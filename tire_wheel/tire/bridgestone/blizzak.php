<html>
 <head>
  ...
  <title>
   KTS-web タイヤ・ホイール館 BRIDGESTONE（ブリヂストン） BLIZZAK
  </title>
      ...
      <div class="main_c row grey-wrapper">
       ...
       <div class="th_back row">
        ...
        <div class="col-md-6 col-sm-6 col-xs-12">
         <div class="th_title_730">
          <img alt="BLIZZAK" src="img/b_logo/blizzak.gif"/>
         </div>
         <div class="clearfix-s">
         </div>
            ...
            <div class="tab-pane fade in active show" id="_0">
             <div class="th_table">
              ...
              <div class="th_table_cell">
               ...
               <div class="th_table_comm">
                水路の表面を親水性素材でコーティングし、気泡の内壁に沿って水を入り込みやすくすることで、タイヤが滑る原因である路面の水膜を積極的に除去する「アクティブ発泡ゴム」がさらに進化。
               </div>
               <div class="th_table_comm">
            ...
            <div class="tab-pane fade" id="_1">
             <div class="th_table">
              ...
              <div class="th_table_cell">
               ...
               <div class="th_table_comm">
                「アクティブ発泡ゴム」は水路の表面を親水性素材でコーティング。
               </div>
               <div class="th_table_comm">
                気泡の内壁に沿って水を入りやすくすることで、すべりの原因「路面の水膜」を積極的に除去。
               </div>
               <div class="th_table_comm">
                氷上でのグリップ力を格段に高めました。
               </div>
            ...
            <div class="tab-pane fade" id="_4">
             <div class="th_table">
              ...
              <div class="th_table_cell">
               ...
               <div class="th_table_comm">
                タイヤサイズをこれまでに無かった狭幅・大径サイズ化することでタイヤが受ける空気抵抗の低減・転がり抵抗低減を実現。
               </div>
               <div class="th_table_comm">
                さらに使用空気圧を高内圧化へと変更することで、より一層の転がり抵抗低減に貢献し、車両の燃費向上を通じたCO2排出量の削減に貢献します。
               </div>
               <div class="th_table_comm">
                また、ologic技術搭載タイヤに最適化された新開発の専用パタン技術や専用コンパウンドを適用することで、従来とは別次元の技術イノベーションにより、転がり抵抗の低減とウェットグリップ性能の向上を実現しました。
               </div>
               <div class="th_table_comm">
