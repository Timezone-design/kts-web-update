<html>
 <head>
  ...
  <title>
   KTS-web タイヤ・ホイール館 BRIDGESTONE（ブリヂストン） POTENZA
  </title>
      ...
      <div class="main_c row grey-wrapper">
       ...
       <div class="th_back row">
        ...
        <div class="col-md-6 col-sm-6 col-xs-12">
         <div class="th_title_730">
          <img alt="POTENZA" src="img/b_logo/potenza.gif"/>
         </div>
         <div class="clearfix-s">
         </div>
           ...
           <ul class="nav nav-tabs">
            ...
            <li>
             <a data-toggle="tab" href="#_2">
              <div class="th_comm_bar_00f">
               <div class="th_comm_bar_3px">
                Adrenalin RE004（アドレナリン・アールイー・ゼロ・ゼロ・フォー）
               </div>
              </div>
             </a>
            </li>
            ...
            <div class="tab-pane fade in active show" id="_0">
             <div class="th_table">
              ...
              <div class="th_table_cell">
               ...
               <div class="th_table_comm">
                その系譜を受け継ぎ、更なる「最速」へのあくなき追求から生まれたPOTENZA RE-71RS。
               </div>
               <div class="th_table_comm">
                サーキット走行で想定されるタイヤと路面との接地面を見直し、車両旋回中でも最大限の接地面積を確保し、更に路面に深く食い込むパタンとハイグリップポリマーを採用。
               </div>
               <div class="th_table_comm">
                ローアングルグルーブ、パタン配列最適化によりスポーツタイヤに相応しいハンドリング初期のレスポンスを向上。
               </div>
               <div class="th_table_comm">
            ...
            <div class="tab-pane fade" id="_5">
             <div class="th_table">
              ...
              <div class="th_table_cell">
               ...
               <div class="th_table_comm">
                従来品の技術を踏襲し、新たに接地性の改良によるグリップ力の向上とサイド剛性の最適化により、DRY性能とWET性能をさらに高いレベルで両立することで、サーキットでのあらゆる場面に対応可能なスポーツタイヤ。
               </div>
               <div class="th_table_comm">
