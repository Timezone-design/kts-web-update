...
<title>KTS-web タイヤ・ホイール館 BRIDGESTONE（ブリヂストン） REGNO</title>
              ...
              <div class="th_back row">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                   <div class="th_title_730"><img alt="REGNO" src="img/b_logo/regno.gif"/></div> <hr class="th_hr" noshade=""/> <div class="th_comm_bar_00f"> <div class="th_comm_bar_3px">GR-X2（ジーアール・クロスツー）</div> </div> <div class="th_table"> <div class="th_table_photo_350"><img alt="ブリヂストン REGNO GR-X2" class="th_tire_img" src="img/regno/gr_x2.jpg"/></div> <div class="th_table_cell"> <div class="th_table_comm"><span class="font_3fc_b">進化を遂げた、グレートバランス。</span></div> <div class="th_table_comm">REGNOは静かで快適な車内空間を追求するため、「路面ごと」の音の違いに着目。進化したサイレントテクノロジーにより、荒れた路面と滑らかな路面、それぞれのノイズ抑制を実現し、静粛性を向上。さらに、通常はタイヤの摩耗度に比例して大きくなるノイズに対し、REGNO GR-X2は摩耗時でも高い静粛性を維持するために、新たなトレッドパターン技術を開発。飽くなき技術の探求により、REGNOは更に上のステージへ。</div> <div class="th_tire_price"><form action="../maker_item.php" method="post" target="_blank"><input name="maker" type="hidden" value="BRIDGESTONE"/><input name="brand" type="hidden" value="REGNO"/><input name="item" type="hidden" value="GR-X2"/><input name="image" src="../img/price.gif" type="image"/></form></div> </div> </div> <hr class="th_hr" noshade=""/> <div class="th_comm_bar_00f"> <div class="th_comm_bar_3px">GRV2（ジーアールブイツー）</div> </div> <div class="th_table"> <div class="th_table_photo_350"><img alt="ブリヂストン REGNO GRV2" class="th_tire_img" src="img/regno/grv2.jpg"/></div> <div class="th_table_cell"> <div class="th_table_comm"><span class="font_3fc_b">より上質で快適な車内空間へ。</span></div> <div class="th_table_comm">車内空間が広く、特にリアタイヤの上に位置しているサードシート（後席）でのノイズが大きくなる傾向があるミニバンの特性。</div> <div class="th_table_comm">さらなる進化を遂げたサイレントテクノロジーが、車内のすべてのシートで音楽、映画、そして会話を楽しめる上質な車内空間を実現。</div> <div class="th_tire_price"><form action="../maker_item.php" method="post" target="_blank"><input name="maker" type="hidden" value="BRIDGESTONE"/><input name="brand" type="hidden" value="REGNO"/><input name="item" type="hidden" value="GRV2"/><input name="image" src="../img/price.gif" type="image"/></form></div> </div> </div> <hr class="th_hr" noshade=""/> <div class="th_comm_bar_00f"> <div class="th_comm_bar_3px">GR-Leggera（ジーアール・レジェーラ）</div> </div> <div class="th_table"> <div class="th_table_photo_350"><img alt="ブリヂストン REGNO GR-Leggera" class="th_tire_img" src="img/regno/gr_leggera.jpg"/></div> <div class="th_table_cell"> <div class="th_table_comm"><span class="font_3fc_b">軽自動車にワンランク上の快適性。</span></div> <div class="th_table_comm">街乗りから高速走行まで様々な場面で使用される軽自動車。</div> <div class="th_table_comm">REGNOで培われたサイレントテクノロジーを軽自動車専用にチューニングすることで様々な速度域でのノイズを抑制し、高い静粛性を実現。</div> <div class="th_table_comm">GR-Leggeraは、REGNOのサイレントテクノロジーを採用することでロードノイズを抑制し、上質な静粛性を実現。</div> <div class="th_tire_price"><form action="../maker_item.php" method="post" target="_blank"><input name="maker" type="hidden" value="BRIDGESTONE"/><input name="brand" type="hidden" value="REGNO"/><input name="item" type="hidden" value="GR-Leggera"/><input name="image" src="../img/price.gif" type="image"/></form></div> </div> </div> <hr class="th_hr" noshade=""/> <div class="th_comm_bar_00f"> <div class="th_comm_bar_3px">旧モデル商品</div> </div> <div class="th_maker_top_list"> <div class="th_maker_top_list_cell"> <div class="th_maker_top_list2"> <div class="th_maker_top_list_cell2"><form action="../maker_item.php" method="post" target="_blank"><input name="maker" type="hidden" value="BRIDGESTONE"/><input name="brand" type="hidden" value="REGNO"/><input name="item" type="hidden" value="GR-X1"/><input class="th_form_180" name="image" src="img/regno/gr_x1.gif" type="image"/></form></div> <div class="th_maker_top_list_cell2"></div> </div> </div> <div class="th_maker_top_list_cell"> <div class="th_maker_top_list2"> <div class="th_maker_top_list_cell2"></div> <div class="th_maker_top_list_cell2"></div> </div> </div> </div> 
                </div>
                <div class="col-md-6 col-sm-6 col-xs-12">
