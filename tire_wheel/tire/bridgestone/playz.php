            ...
            <div class="main_c row grey-wrapper">
              ...
              <div class="th_back row">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                  <div class="th_title_730"><img alt="Playz" src="img/b_logo/playz.gif" /></div>
                  <div class="clearfix-s"></div>
                    ...
                    <div class="container">
                      <ul class="nav nav-tabs">
                        <li class="active"><a data-toggle="tab" href="#_0">
                            <div class="th_comm_bar_00f">
                              <div class="th_comm_bar_3px">PX2（ピーエックスツー）</div>
                            </div>
                          </a></li>
                        <li><a data-toggle="tab" href="#_1">
                            <div class="th_comm_bar_00f">
                              <div class="th_comm_bar_3px">PX-RV2（ピーエック アールブイツー）</div>
                            </div>
                          </a></li>
                      </ul>
                      <br>
                      <div class="tab-content">
                        <div id="_0" class="tab-pane fade in active show">
                          <div class="th_table">
                            <div class="th_table_photo_350"><img class="th_tire_img" src="img/playz/px_2.jpg" alt="ブリヂストン Playz PX2" data-nsfw-filter-status="sfw" style="visibility: visible;"></div>
                            <div class="th_table_cell">
                              <div class="th_table_comm"><span class="font_3fc_b" data-nsfw-filter-status="swf">雨に強い、長く強い。疲れにくいだけじゃない。</span></div>
                              <div class="th_table_comm">接地形状の適正化とシリカ配合ウェット重視ゴムの組み合わせにより高いウェット性能を発揮。</div>
                              <div class="th_table_comm">セダン専用高剛性パタンと、耐摩耗向上に寄与するシリカを配合したゴムとの組み合わせによりライフ性能向上を実現。</div>
                              <div class="th_tire_price">
                                <form method="post" action="../maker_item.php" target="_blank"><input type="hidden" name="maker" value="BRIDGESTONE"><input type="hidden" name="brand" value="Playz"><input type="hidden" name="item" value="PX-2"><input type="image" src="../img/price.gif" name="image"></form>
                              </div>
                            </div>
                          </div>
                        </div>
                        <div id="_1" class="tab-pane fade">
                          <div class="th_table">
                            <div class="th_table_photo_350"><img class="th_tire_img" src="img/playz/px_rv2.jpg" alt="ブリヂストン Playz PX-RV2" data-nsfw-filter-status="sfw" style="visibility: visible;"></div>
                            <div class="th_table_cell">
                              <div class="th_table_comm"><span class="font_3fc_b" data-nsfw-filter-status="swf">雨に強い、長く強い。疲れにくいだけじゃない。</span></div>
                              <div class="th_table_comm">接地形状の適正化とシリカ配合ウェット重視ゴムの組み合わせにより高いウェット性能を発揮。</div>
                              <div class="th_table_comm">ミニバン専用高剛性パタンと、耐摩耗向上に寄与するシリカを配合したゴムとの組み合わせによりライフ性能向上を実現。</div>
                              <div class="th_tire_price">
                                <form method="post" action="../maker_item.php" target="_blank"><input type="hidden" name="maker" value="BRIDGESTONE"><input type="hidden" name="brand" value="Playz"><input type="hidden" name="item" value="PX-RV2"><input type="image" src="../img/price.gif" name="image"></form>
                              </div>
                            </div>
                          </div>
                        </div>
