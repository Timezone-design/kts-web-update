 <html>
							<head>
							<meta content="BRIDGESTONE,ブリヂストン,ブリジストン,タイヤ,Playz,プレイズ,販売,装着,脱着,アライメント" name="keywords"/>
...
<title>KTS-web タイヤ・ホイール館 BRIDGESTONE（ブリヂストン） Playz</title>
              ...
              <div class="th_back row">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                   <div class="th_title_730"><img alt="Playz" src="img/b_logo/playz.gif"/></div> <hr class="th_hr" noshade=""/> <div class="th_comm_bar_00f"> <div class="th_comm_bar_3px">PX2（ピーエックスツー）</div> </div> <div class="th_table"> <div class="th_table_photo_350"><img alt="ブリヂストン Playz PX2" class="th_tire_img" src="img/playz/px_2.jpg"/></div> <div class="th_table_cell"> <div class="th_table_comm"><span class="font_3fc_b">雨に強い、長く強い。疲れにくいだけじゃない。</span></div> <div class="th_table_comm">接地形状の適正化とシリカ配合ウェット重視ゴムの組み合わせにより高いウェット性能を発揮。</div> <div class="th_table_comm">セダン専用高剛性パタンと、耐摩耗向上に寄与するシリカを配合したゴムとの組み合わせによりライフ性能向上を実現。</div> <div class="th_tire_price"><form action="../maker_item.php" method="post" target="_blank"><input name="maker" type="hidden" value="BRIDGESTONE"/><input name="brand" type="hidden" value="Playz"/><input name="item" type="hidden" value="PX-2"/><input name="image" src="../img/price.gif" type="image"/></form></div> </div> </div> <hr class="th_hr" noshade=""/> <div class="th_comm_bar_00f"> <div class="th_comm_bar_3px">PX-RV2（ピーエック アールブイツー）</div> </div> <div class="th_table"> <div class="th_table_photo_350"><img alt="ブリヂストン Playz PX-RV2" class="th_tire_img" src="img/playz/px_rv2.jpg"/></div> <div class="th_table_cell"> <div class="th_table_comm"><span class="font_3fc_b">雨に強い、長く強い。疲れにくいだけじゃない。</span></div> <div class="th_table_comm">接地形状の適正化とシリカ配合ウェット重視ゴムの組み合わせにより高いウェット性能を発揮。</div> <div class="th_table_comm">ミニバン専用高剛性パタンと、耐摩耗向上に寄与するシリカを配合したゴムとの組み合わせによりライフ性能向上を実現。</div> <div class="th_tire_price"><form action="../maker_item.php" method="post" target="_blank"><input name="maker" type="hidden" value="BRIDGESTONE"/><input name="brand" type="hidden" value="Playz"/><input name="item" type="hidden" value="PX-RV2"/><input name="image" src="../img/price.gif" type="image"/></form></div> </div> </div> <hr class="th_hr" noshade=""/> <div class="th_comm_bar_00f"> <div class="th_comm_bar_3px">旧モデル商品</div> </div> <div class="th_maker_top_list"> <div class="th_maker_top_list_cell"> <div class="th_maker_top_list2"> <div class="th_maker_top_list_cell2"><form action="../maker_item.php" method="post" target="_blank"><input name="maker" type="hidden" value="BRIDGESTONE"/><input name="brand" type="hidden" value="Playz"/><input name="item" type="hidden" value="PX"/><input class="th_form_180" name="image" src="img/playz/px.gif" type="image"/></form></div> <div class="th_maker_top_list_cell2"><form action="../maker_item.php" method="post" target="_blank"><input name="maker" type="hidden" value="BRIDGESTONE"/><input name="brand" type="hidden" value="Playz"/><input name="item" type="hidden" value="PX-C"/><input class="th_form_180" name="image" src="img/playz/px_c.gif" type="image"/></form></div> </div> </div> <div class="th_maker_top_list_cell"> <div class="th_maker_top_list2"> <div class="th_maker_top_list_cell2"><form action="../maker_item.php" method="post" target="_blank"><input name="maker" type="hidden" value="BRIDGESTONE"/><input name="brand" type="hidden" value="Playz"/><input name="item" type="hidden" value="PZ-X"/><input class="th_form_180" name="image" src="img/playz/pz_x.gif" type="image"/></form></div> <div class="th_maker_top_list_cell2"><form action="../maker_item.php" method="post" target="_blank"><input name="maker" type="hidden" value="BRIDGESTONE"/><input name="brand" type="hidden" value="Playz"/><input name="item" type="hidden" value="PZ-XC"/><input class="th_form_180" name="image" src="img/playz/pz_xc.gif" type="image"/></form></div> </div> </div> </div> <div class="th_maker_top_list"> <div class="th_maker_top_list_cell"> <div class="th_maker_top_list2"> <div class="th_maker_top_list_cell2"><form action="../maker_item.php" method="post" target="_blank"><input name="maker" type="hidden" value="BRIDGESTONE"/><input name="brand" type="hidden" value="Playz"/><input name="item" type="hidden" value="PX-RV"/><input class="th_form_180" name="image" src="img/playz/px_rv.gif" type="image"/></form></div> <div class="th_maker_top_list_cell2"></div> </div> </div> <div class="th_maker_top_list_cell"> <div class="th_maker_top_list2"> <div class="th_maker_top_list_cell2"></div> <div class="th_maker_top_list_cell2"></div> </div> </div> </div> 
                </div>
                <div class="col-md-6 col-sm-6 col-xs-12">
