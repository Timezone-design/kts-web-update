<html>
 <head>
  ...
  <title>
   KTS-web タイヤ・ホイール館 BRIDGESTONE（ブリヂストン） ECOPIA
  </title>
      ...
      <div class="main_c row grey-wrapper">
       ...
       <div class="th_back row">
        ...
        <div class="col-md-6 col-sm-6 col-xs-12">
         <div class="th_title_730">
          <img alt="ECOPIA" src="img/b_logo/ecopia.gif"/>
         </div>
         <div class="clearfix-s">
         </div>
           ...
           <ul class="nav nav-tabs">
            ...
            <li>
             <a data-toggle="tab" href="#_3">
              <div class="th_comm_bar_00f">
               <div class="th_comm_bar_3px">
                EX20C TYPE H（イーエックス ニーマルシー タイプエイチ）
               </div>
              </div>
             </a>
            </li>
            ...
            <div class="tab-pane fade in active show" id="_0">
             <div class="th_table">
              ...
              <div class="th_table_cell">
               ...
               <div class="th_table_comm">
                「エコ効きもちゴム」、「剛性コントロールシート」、耐摩耗最適化形状とブリヂストン独自技術ULTIMAT EYE（アルティメット アイ）により、ウェット性能・ライフ性能と低燃費性能を高次元で実現。
               </div>
               <div class="th_table_comm">
            ...
            <div class="tab-pane fade" id="_1">
             <div class="th_table">
              ...
              <div class="th_table_cell">
               ...
               <div class="th_table_comm">
                「3D-M字サイプ」のブロック倒れ込み抑制効果により、高い耐偏摩耗性を実現すると共に、定員乗車時のふらつきを抑制し、「みんなで乗ってもふらつきにくい」を実現。
               </div>
               <div class="th_table_comm">
            ...
            <div class="tab-pane fade" id="_3">
             <div class="th_table">
              ...
              <div class="th_table_cell">
               ...
               <div class="th_table_comm">
                高い低燃費性能を維持しつつ、「ウェット向上ポリマー」とブリヂストン独自技術ULTIMAT EYE（アルティメット アイ）により、雨の日でも安心感のあるウェット性能を実現。
               </div>
               <div class="th_table_comm">
                すり減りにくい「名のプロ・テック ゴム」、EX20水平接地形状による耐摩耗性向上により、ライフ性能に配慮。
               </div>
               <div class="th_table_comm">
            ...
            <div class="tab-pane fade" id="_5">
             <div class="th_table">
              ...
              <div class="th_table_cell">
               ...
               <div class="th_table_comm">
                ナノプロ・テック等の採用により転がり抵抗を低減し、ガソリン車と比較して転がり抵抗の影響度が大きいEV車の燃費（電費）向上に貢献。
               </div>
               <div class="th_table_comm">
