<html>
  ...
  <head>
    <meta content="YOKOHAMA,ヨコハマ,横浜ゴム,PARADA,パラダ,販売,装着,脱着,アライメント" name="keywords" />
    ...
    <title>KTS-web タイヤ・ホイール館 YOKOHAMA（ヨコハマ）PARADA</title>
            ...
            <div class="main_c row grey-wrapper">
              ...
              <div class="th_back row">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                  <div class="th_title_730"><img alt="PARADA" src="img/b_logo/parada.gif" /></div>
                  <div class="clearfix-s"></div>
                    ...
                    <div class="container">
                      <ul class="nav nav-tabs">
                        <li class="active"><a data-toggle="tab" href="#_0">
                            <div class="th_comm_bar_00f">
                              <div class="th_comm_bar_3px">Spec-X PA02（スペックエックス）</div>
                            </div>
                          </a></li>
                        <li><a data-toggle="tab" href="#_1">
                            <div class="th_comm_bar_00f">
                              <div class="th_comm_bar_3px">PA03（ピーエーゼロサン）</div>
                            </div>
                          </a></li>
                      </ul>
                      <br>
                      <div class="tab-content">
                        <div id="_0" class="tab-pane fade in active show">
                          <div class="th_table">
                            <div class="th_table_photo_350"><img class="th_tire_img" src="img/parada/spec_x_pa02.jpg" alt="YOKOHAMA PARADA Spec-X PA02" data-nsfw-filter-status="sfw" style="visibility: visible;"></div>
                            <div class="th_table_cell">
                              <div class="th_table_comm"><span class="font_3fc_b" data-nsfw-filter-status="swf">ドレスアップ志向のインチアップに最適</span></div>
                              <div class="th_table_comm">シリカの混合比率を高くしたコンパウンドを採用。転がり抵抗を低減させながら、高いウェット性能を発揮します。</div>
                              <div class="th_tire_price">
                                <form method="post" action="../maker_item.php" target="_blank"><input type="hidden" name="maker" value="YOKOHAMA"><input type="hidden" name="brand" value="PARADA"><input type="hidden" name="item" value="Spec-X PA02"><input type="image" src="../img/price.gif" name="image"></form>
                              </div>
                            </div>
                          </div>
                        </div>
                        <div id="_1" class="tab-pane fade">
                          <div class="th_table">
                            <div class="th_table_photo_350"><img class="th_tire_img" src="img/parada/pa03.jpg" alt="YOKOHAMA PARADA PA03" data-nsfw-filter-status="sfw" style="visibility: visible;"></div>
                            <div class="th_table_cell">
                              <div class="th_table_comm"><span class="font_3fc_b" data-nsfw-filter-status="swf">ホワイトレターが際立つバン・小型トラック用ドレスアップタイヤ</span></div>
                              <div class="th_table_comm">トレッド部は左右非対称パターンを採用、ドライはもちろんウェット時においても安定した走行性能を発揮。</div>
                              <div class="th_table_comm">静粛性においても高い性能を持ち合わせた商用車用の新しいドレスアップアイテムです。</div>
                              <div class="th_tire_price">
                                <form method="post" action="../maker_item.php" target="_blank"><input type="hidden" name="maker" value="YOKOHAMA"><input type="hidden" name="brand" value="PARADA"><input type="hidden" name="item" value="PA03"><input type="image" src="../img/price.gif" name="image"></form>
                              </div>
                            </div>
                          </div>
                        </div>
