...
<title>KTS-web タイヤ・ホイール館 YOKOHAMA（ヨコハマ）PARADA</title>
              ...
              <div class="th_back row">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                   <div class="th_title_730"><img alt="PARADA" src="img/b_logo/parada.gif"/></div> <hr class="th_hr" noshade=""/> <div class="th_comm_bar_00f"> <div class="th_comm_bar_3px">Spec-X PA02（スペックエックス）</div> </div> <div class="th_table"> <div class="th_table_photo_350"><img alt="YOKOHAMA PARADA Spec-X PA02" class="th_tire_img" src="img/parada/spec_x_pa02.jpg"/></div> <div class="th_table_cell"> <div class="th_table_comm"><span class="font_3fc_b">ドレスアップ志向のインチアップに最適</span></div> <div class="th_table_comm">シリカの混合比率を高くしたコンパウンドを採用。転がり抵抗を低減させながら、高いウェット性能を発揮します。</div> <div class="th_tire_price"><form action="../maker_item.php" method="post" target="_blank"><input name="maker" type="hidden" value="YOKOHAMA"/><input name="brand" type="hidden" value="PARADA"/><input name="item" type="hidden" value="Spec-X PA02"/><input name="image" src="../img/price.gif" type="image"/></form></div> </div> </div> <hr class="th_hr" noshade=""/> <div class="th_comm_bar_00f"> <div class="th_comm_bar_3px">PA03（ピーエーゼロサン）</div> </div> <div class="th_table"> <div class="th_table_photo_350"><img alt="YOKOHAMA PARADA PA03" class="th_tire_img" src="img/parada/pa03.jpg"/></div> <div class="th_table_cell"> <div class="th_table_comm"><span class="font_3fc_b">ホワイトレターが際立つバン・小型トラック用ドレスアップタイヤ</span></div> <div class="th_table_comm">トレッド部は左右非対称パターンを採用、ドライはもちろんウェット時においても安定した走行性能を発揮。</div> <div class="th_table_comm">静粛性においても高い性能を持ち合わせた商用車用の新しいドレスアップアイテムです。</div> <div class="th_tire_price"><form action="../maker_item.php" method="post" target="_blank"><input name="maker" type="hidden" value="YOKOHAMA"/><input name="brand" type="hidden" value="PARADA"/><input name="item" type="hidden" value="PA03"/><input name="image" src="../img/price.gif" type="image"/></form></div> </div> </div> 
                </div>
                <div class="col-md-6 col-sm-6 col-xs-12">
