<html>
 <head>
  ...
  <title>
   KTS-web タイヤ・ホイール館 YOKOHAMA（ヨコハマ）BluEarth
  </title>
      ...
      <div class="main_c row grey-wrapper">
       ...
       <div class="th_back row">
        ...
        <div class="col-md-6 col-sm-6 col-xs-12">
         <div class="th_title_730">
          <img alt="BluEarth" src="img/b_logo/bluearth.gif"/>
         </div>
         <div class="clearfix-s">
         </div>
            ...
            <div class="tab-pane fade" id="_2">
             <div class="th_table">
              ...
              <div class="th_table_cell">
               ...
               <div class="th_table_comm">
                「低燃費タイヤをもっと身近なものにしたい」という考え方はそのままに、最高グレードの低燃費性能へグレードアップ。「AAA/c」を獲得した低燃費タイヤです。
               </div>
               <div class="th_table_comm">
            ...
            <div class="tab-pane fade" id="_4">
             <div class="th_table">
              ...
              <div class="th_table_cell">
               ...
               <div class="th_table_comm">
                ハンドリング性能、耐偏磨耗性、静粛性、3つの性能を高いレベルでバランスさせる専用非対称トレッドパターン採用。
               </div>
               <div class="th_table_comm">
            ...
            <div class="tab-pane fade" id="_5">
             <div class="th_table">
              ...
              <div class="th_table_cell">
               ...
               <div class="th_table_comm">
                タイヤの寿命を長持ちさせるために、重心の高いミニバン/SUVで発生しがちな「偏磨耗」を制御。
               </div>
               <div class="th_table_comm">
