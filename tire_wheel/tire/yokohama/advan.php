<html>
 <head>
  ...
  <title>
   KTS-web タイヤ・ホイール館 YOKOHAMA（ヨコハマ）ADVAN
  </title>
      ...
      <div class="main_c row grey-wrapper">
       ...
       <div class="th_back row">
        ...
        <div class="col-md-6 col-sm-6 col-xs-12">
         <div class="th_title_730">
          <img alt="ADVAN" src="img/b_logo/advan.gif"/>
         </div>
         <div class="clearfix-s">
         </div>
           ...
           <ul class="nav nav-tabs">
            ...
            <li>
             <a data-toggle="tab" href="#_2">
              <div class="th_comm_bar_00f">
               <div class="th_comm_bar_3px">
                Sport V105（スポーツ・ブイ・イチマルゴ・ゼット・ピー・エス）
               </div>
              </div>
             </a>
            </li>
            <li>
             <a data-toggle="tab" href="#_3">
              <div class="th_comm_bar_00f">
               <div class="th_comm_bar_3px">
                Sport V103（スポーツ・ブイ・イチマルサン・ゼット・ピー・エス）
               </div>
              </div>
             </a>
            </li>
            <li>
             <a data-toggle="tab" href="#_4">
              <div class="th_comm_bar_00f">
               <div class="th_comm_bar_3px">
                dB V552（デシベル・ブイゴーゴーニ）
               </div>
              </div>
             </a>
            </li>
            <li>
             <a data-toggle="tab" href="#_5">
              <div class="th_comm_bar_00f">
               <div class="th_comm_bar_3px">
                FLEVA V701（フレバ・ブイナナマルイチ）
               </div>
              </div>
             </a>
            </li>
            <li>
             <a data-toggle="tab" href="#_6">
              <div class="th_comm_bar_00f">
               <div class="th_comm_bar_3px">
                NEOVA AD08R（ネオバ・エイディー・ゼロハチ・アール）
               </div>
              </div>
             </a>
            </li>
            <li>
             <a data-toggle="tab" href="#_7">
              <div class="th_comm_bar_00f">
               <div class="th_comm_bar_3px">
                NEOVA AD07（ネオバ・エイディー・ゼロナナ）
               </div>
              </div>
             </a>
            </li>
            <li>
             <a data-toggle="tab" href="#_8">
              <div class="th_comm_bar_00f">
               <div class="th_comm_bar_3px">
                A052（エイ・ゼロゴーニ）
               </div>
            ...
            <div class="tab-pane fade" id="_5">
             <div class="th_table">
              ...
              <div class="th_table_cell">
               ...
               <div class="th_table_comm">
                フラッグシップタイヤで採用した技術も継承しつつ、より多彩な車種へ対応。
               </div>
               <div class="th_table_comm">
            ...
            <div class="tab-pane fade" id="_6">
             <div class="th_table">
              ...
              <div class="th_table_cell">
               ...
               <div class="th_table_comm">
                ADVAN最強のストリートスポーツタイヤが新たなコンパウンドを身にまとい進化を遂げました。
               </div>
               <div class="th_table_comm">
            ...
            <div class="tab-pane fade" id="_7">
             <div class="th_table">
              ...
              <div class="th_table_cell">
               ...
               <div class="th_table_comm">
                スポーツカーの運動性能を十分に発揮できるよう、ドライ・ウェット性能と耐久性の向上、走行時の性能維持をテーマに開発。
               </div>
               <div class="th_table_comm">
                温度の高い真夏の路面から冷たいウェット路面までさまざまな状況で優れた走行性能を発揮。
               </div>
               <div class="th_table_comm">
            ...
            <div class="tab-pane fade" id="_9">
             <div class="th_table">
              ...
              <div class="th_table_cell">
               ...
               <div class="th_table_comm">
                「ADVAN Sport V105」と「ADVAN NEOVA AD08R」のテクノロジーを応用して開発。
               </div>
               <div class="th_table_comm">
