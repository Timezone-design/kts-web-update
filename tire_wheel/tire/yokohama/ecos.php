 <html>
							<head>
							<meta content="YOKOHAMA,ヨコハマ,横浜ゴム,ECOS,エコス,販売,装着,脱着,アライメント" name="keywords"/>
...
<title>KTS-web タイヤ・ホイール館 YOKOHAMA（ヨコハマ）ECOS</title>
              ...
              <div class="th_back row">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                   <div class="th_title_730"><img alt="ECOS" src="img/b_logo/ecos.gif"/></div> <hr class="th_hr" noshade=""/> <div class="th_comm_bar_00f"> <div class="th_comm_bar_3px">ECOS ES31（エコス・イーエスサンイチ）</div> </div> <div class="th_table"> <div class="th_table_photo_350"><img alt="YOKOHAMA ECOS ES31" class="th_tire_img" src="img/ecos/es31.jpg"/></div> <div class="th_table_cell"> <div class="th_table_comm"><span class="font_3fc_b">タイヤの基本性能に低燃費性能を追加した新たなスタンダードタイヤ</span></div> <div class="th_table_comm">低燃費性能とウェット性能という相反する性能を共に向上。耐偏摩耗性、静粛性にも配慮。</div> <div class="th_table_comm">数多くの実車評価やシミュレーションを行い、ベストな性能バランスを追求しました。</div> <div class="th_tire_price"><form action="../maker_item.php" method="post" target="_blank"><input name="maker" type="hidden" value="YOKOHAMA"/><input name="brand" type="hidden" value="ECOS"/><input name="item" type="hidden" value="ES31"/><input name="image" src="../img/price.gif" type="image"/></form></div> </div> </div> <hr class="th_hr" noshade=""/> <div class="th_comm_bar_00f"> <div class="th_comm_bar_3px">DNA ECOS ES300（ディーエヌエー・エコス）</div> </div> <div class="th_table"> <div class="th_table_photo_350"><img alt="YOKOHAMA ECOS DNA ECOS ES300" class="th_tire_img" src="img/ecos/dna_ecos_es300.jpg"/></div> <div class="th_table_cell"> <div class="th_table_comm"><span class="font_3fc_b">DNAのスタンダードタイヤ</span></div> <div class="th_table_comm">ロングライフで定評のある従来品A200をベースに、シリカ入りコンパウンド「合体ゴムTM」を採用することで、燃費悪化の要因であるころがり抵抗を同タイヤに比べ約14％低減。</div> <div class="th_table_comm">A200と同等のロングライフ性を維持しながら省燃費を実現することで、さらに環境にやさしいたいやとなりました。</div> <div class="th_tire_price"><form action="../maker_item.php" method="post" target="_blank"><input name="maker" type="hidden" value="YOKOHAMA"/><input name="brand" type="hidden" value="ECOS"/><input name="item" type="hidden" value="DNA ECOS ES300"/><input name="image" src="../img/price.gif" type="image"/></form></div> </div> </div> 
                </div>
                <div class="col-md-6 col-sm-6 col-xs-12">
