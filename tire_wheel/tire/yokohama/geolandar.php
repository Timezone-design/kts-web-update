<html>
 <head>
  ...
  <title>
   KTS-web タイヤ・ホイール館 YOKOHAMA（ヨコハマ）GEOLANDAR
  </title>
      ...
      <div class="main_c row grey-wrapper">
       ...
       <div class="th_back row">
        ...
        <div class="col-md-6 col-sm-6 col-xs-12">
         <div class="th_title_730">
          <img alt="GEOLANDAR" src="img/b_logo/geolandar.gif"/>
         </div>
         <div class="clearfix-s">
         </div>
            ...
            <div class="tab-pane fade in active show" id="_0">
             <div class="th_table">
              ...
              <div class="th_table_cell">
               ...
               <div class="th_table_comm">
                快適なロングドライブのために静粛性、耐摩耗性も向上させた専用パターンを採用。
               </div>
               <div class="th_table_comm">
            ...
            <div class="tab-pane fade" id="_1">
             <div class="th_table">
              ...
              <div class="th_table_cell">
               ...
               <div class="th_table_comm">
                重量級SUVを支えつつ、静粛性を求めるトレッドパターンを新開発。優れたトラクション性能と快適性能を両立させました。
               </div>
               <div class="th_table_comm">
            ...
            <div class="tab-pane fade" id="_2">
             <div class="th_table">
              ...
              <div class="th_table_cell">
               ...
               <div class="th_table_comm">
                高速走行時の安定感とウェット性能を高める非対称トレッドパターンを採用。
               </div>
               <div class="th_table_comm">
            ...
            <div class="tab-pane fade" id="_3">
             <div class="th_table">
              ...
              <div class="th_table_cell">
               ...
               <div class="th_table_comm">
                より長く使えるタフなタイヤを追求。不整地や未塗装路での耐カット性、耐チッピング性も確保しつつ、オンロードでの耐摩耗性を向上させました。
               </div>
               <div class="th_table_comm">
