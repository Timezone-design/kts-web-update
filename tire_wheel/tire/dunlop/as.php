...
<title>KTS-web タイヤ・ホイール館 DUNLOP（ダンロップ）</title>
              ...
              <div class="th_back row">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                   <div class="th_title_730"><img alt="AS" src="img/b_logo/as.gif"/></div> <hr class="th_hr" noshade=""/> <div class="th_comm_bar_00f"> <div class="th_comm_bar_3px">ALL SEASON MAXX AS1（オールシーズンマックス エーエスワン）</div> </div> <div class="th_table"> <div class="th_table_photo_350"><img alt="DUNLOP ALL SEASON MAXX AS1" class="th_tire_img" src="img/all/maxx_as1.jpg"/></div> <div class="th_table_cell"> <div class="th_table_comm"><span class="font_3fc_b">急な雪にも慌てない オールシーズンタイヤ</span></div> <div class="th_table_comm">突然の降雪でも慌てることのない、高い走行性能とブレーキ性能。夏タイヤ感覚で走れるそうは性能と静粛性能。雨でも安心感のあるウエット性能。さらに夏タイヤよりも長く使えるライフ性能を兼ね備えたオールシーズンタイヤです。</div> <div class="th_tire_price"><form action="../maker_item.php" method="post" target="_blank"><input name="maker" type="hidden" value="DUNLOP"/><input name="brand" type="hidden" value="ALL SEASON"/><input name="item" type="hidden" value="MAXX AS1"/><input name="image" src="../img/price.gif" type="image"/></form></div> </div> </div> 
                </div>
                <div class="col-md-6 col-sm-6 col-xs-12">
