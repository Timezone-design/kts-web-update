<html>
 <head>
  <meta content="タイヤ,ホイール,販売,取り付け,脱着,バランス,アライメント" name="keywords"/>
  <meta content="KTSでは各有名メーカー製タイヤの販売を行っております。アライメント調整を含むお得なセットメニューもございます。" name="description"/>
  ...
  <meta content="KTS-web タイヤ・ホイール館" property="og:title"/>
  <meta content="KTSでは各有名メーカー製タイヤの販売を行っております。アライメント調整を含むお得なセットメニューもございます。" property="og:description"/>
       ...
       <div class="white-wrapper">
        <div>
         ...
         <div class="banner-wrapper row">
          <div class="small-category-top-img col-md-2 col-sm-2 col-xs-3">
           <img alt="placeholder" src="/assets/img/200placeholder.svg" srcset=""/>
          </div>
          <div class="small-category-top-text col-md-10 col-sm-10 col-xs-9">
           <p class="ja">
            Placeholder
           </p>
          </div>
        ...
        <div class="row">
         <div class="col-md-3 col-sm-3 col-xs-4">
          <div>
           <a href="/tire_wheel/tire/bridgestone/index.html">
            <img alt="Bridgestone" class="img-thumbnail" src="/tire_wheel/tire/img/maker/bridgestone_logo.gif"/>
           </a>
          </div>
         </div>
         <div class="col-md-3 col-sm-3 col-xs-4">
          <div>
           <a href="/tire_wheel/tire/dunlop/index.html">
            <img alt="Dunlop" class="img-thumbnail" src="/tire_wheel/tire/img/maker/dunlop.gif"/>
           </a>
          </div>
         </div>
         <div class="col-md-3 col-sm-3 col-xs-4">
          <div>
           <a href="/tire_wheel/tire/falken/index.html">
            <img alt="Falken" class="img-thumbnail" src="/tire_wheel/tire/img/maker/falken.gif"/>
           </a>
          </div>
         </div>
         <div class="col-md-3 col-sm-3 col-xs-4">
          <div>
           <a href="/tire_wheel/tire/federal/index.html">
            <img alt="Federal" class="img-thumbnail" src="/tire_wheel/tire/img/maker/federal_logo.gif"/>
           </a>
          </div>
         </div>
         <div class="col-md-3 col-sm-3 col-xs-4">
          <div>
           <a href="/tire_wheel/tire/nankang/index.html">
            <img alt="Nankang" class="img-thumbnail" src="/tire_wheel/tire/img/maker/nankang_logo.gif"/>
           </a>
          </div>
         </div>
         <div class="col-md-3 col-sm-3 col-xs-4">
          <div>
           <a href="/tire_wheel/tire/kenda/index.html">
            <img alt="Kenda" class="img-thumbnail" src="/tire_wheel/tire/img/maker/kenda.gif"/>
           </a>
          </div>
         </div>
         <div class="col-md-3 col-sm-3 col-xs-4">
          <div>
           <a href="/tire_wheel/tire/toyo_tires/index.html">
            <img alt="ToyoTire" class="img-thumbnail" src="/tire_wheel/tire/img/maker/toyo_tire_logo.gif"/>
           </a>
          </div>
         </div>
         <div class="col-md-3 col-sm-3 col-xs-4">
          <div>
           <a href="/tire_wheel/tire/yokohama/index.html">
            <img alt="Yokohama" class="img-thumbnail" src="/tire_wheel/tire/img/maker/yokohama_logo.gif"/>
           </a>
          </div>
         </div>
         <div class="col-md-3 col-sm-3 col-xs-4">
          <div>
           <a href="/tire_wheel/tire/goodyear/index.html">
            <img alt="Goodyear" class="img-thumbnail" src="/tire_wheel/tire/img/maker/goodyear.gif"/>
           </a>
          </div>
         </div>
         <div class="col-md-3 col-sm-3 col-xs-4">
          <div>
           <a href="/tire_wheel/tire/michelin/index.html">
            <img alt="Michelin" class="img-thumbnail" src="/tire_wheel/tire/img/maker/michelin.gif"/>
           </a>
          </div>
         </div>
        </div>
