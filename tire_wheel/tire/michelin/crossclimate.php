 <html>
							<head>
							<meta content="MICHELIN,ミシュラン,CROSSCLIMATE,クロスクライメート,販売,装着,脱着,アライメント" name="keywords"/>
...
<title>KTS-web タイヤ・ホイール館 MICHELIN（ミシュラン） CROSSCLIMATE</title>
              ...
              <div class="th_back row">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                   <div class="th_title_730"><img alt="CROSSCLIMATE" src="img/b_logo/crossclimate.gif"/></div> <hr class="th_hr" noshade=""/> <div class="th_comm_bar_00f"> <div class="th_comm_bar_3px">CROSSCLIMATE</div> </div> <div class="th_table"> <div class="th_table_photo_350"><img alt="MICHELIN CROSSCLIMATE" class="th_tire_img" src="img/crossclimate/crossclimate.jpg"/></div> <div class="th_table_cell"> <div class="th_table_comm"><span class="font_3fc_b">雪も走れる夏タイヤ</span></div> <div class="th_table_comm">サマータイヤとして求められるドライ路面、ウェット路面での高いブレーキング性能を有しながら雪上を走ることができる新しいコンセプトのサマータイヤです。</div> <div class="th_table_comm">また、ロングライフ性能はENERGY SAVER＋よりさらに向上。</div> <div class="th_table_comm"><span class="font_ff0">※冬季における運転環境等、ご使用の状況をご確認の上ご使用下さい。凍結路面でのご使用の可能性がある場合は、スタッドレスタイヤのご使用をお勧め致します。</span></div> <div class="th_tire_price"><form action="../maker_item.php" method="post" target="_blank"><input name="maker" type="hidden" value="MICHELIN"/><input name="brand" type="hidden" value="CROSSCLIMATEシリーズ"/><input name="item" type="hidden" value="CROSSCLIMATE"/><input name="image" src="../img/price.gif" type="image"/></form></div> </div> </div> <hr class="th_hr" noshade=""/> <div class="th_comm_bar_00f"> <div class="th_comm_bar_3px">CROSSCLIMATE＋</div> </div> <div class="th_table"> <div class="th_table_photo_350"><img alt="MICHELIN CROSSCLIMATE＋" class="th_tire_img" src="img/crossclimate/crossclimate_plus.jpg"/></div> <div class="th_table_cell"> <div class="th_table_comm"><span class="font_3fc_b">雪も走れる夏タイヤ</span></div> <div class="th_table_comm">サマータイヤとして求められるドライ路面、ウェット路面での高いブレーキング性能を有しながら雪上を走ることができる新しいコンセプトのサマータイヤです。</div> <div class="th_table_comm">また、ロングライフ性能はENERGY SAVER＋よりさらに向上。</div> <div class="th_table_comm"><span class="font_ff0">※冬季における運転環境等、ご使用の状況をご確認の上ご使用下さい。凍結路面でのご使用の可能性がある場合は、スタッドレスタイヤのご使用をお勧め致します。</span></div> <div class="th_tire_price"><form action="../maker_item.php" method="post" target="_blank"><input name="maker" type="hidden" value="MICHELIN"/><input name="brand" type="hidden" value="CROSSCLIMATEシリーズ"/><input name="item" type="hidden" value="CROSSCLIMATE＋"/><input name="image" src="../img/price.gif" type="image"/></form></div> </div> </div><!--	<hr class="th_hr" noshade>	<div class="th_comm_bar_00f">		<div class="th_comm_bar_3px">CROSSCLIMATE SUV</div>	</div>	<div class="th_table">		<div class="th_table_photo_350"><img class="th_tire_img" src="img/crossclimate/crossclimate_suv.jpg" alt="MICHELIN CROSSCLIMATE SUV"></div>		<div class="th_table_cell">			<div class="th_table_comm"><span class="font_3fc_b">雪も走れる夏タイヤ</span></div>			<div class="th_table_comm">サマータイヤとして求められるドライ路面、ウェット路面での高いブレーキング性能を有しながら雪上を走ることができる新しいコンセプトのサマータイヤです。</div>			<div class="th_table_comm">また、ロングライフ性能はENERGY SAVER＋よりさらに向上。</div>			<div class="th_table_comm"><span class="font_ff0">※冬季における運転環境等、ご使用の状況をご確認の上ご使用下さい。凍結路面でのご使用の可能性がある場合は、スタッドレスタイヤのご使用をお勧め致します。</span></div>			<div class="th_tire_price"><form method="post" action="../maker_item.php" target="_blank"><input type="hidden" name="maker" value="MICHELIN"><input type="hidden" name="brand" value="CROSSCLIMATEシリーズ"><input type="hidden" name="item" value="CROSSCLIMATE SUV"><input type="image" src="../img/price.gif" name="image"></form></div>		</div>	</div>--> 
                </div>
                <div class="col-md-6 col-sm-6 col-xs-12">
