 <html>
							<head>
							<meta content="MICHELIN,ミシュラン,ENERGY,販売,装着,脱着,アライメント" name="keywords"/>
...
<title>KTS-web タイヤ・ホイール館 MICHELIN（ミシュラン） ENERGY</title>
              ...
              <div class="th_back row">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                   <div class="th_title_730"><img alt="ENERGYシリーズ" src="img/b_logo/energy.gif"/></div> <hr class="th_hr" noshade=""/> <div class="th_comm_bar_00f"> <div class="th_comm_bar_3px">ENERGY SAVER 4</div> </div> <div class="th_table"> <div class="th_table_photo_350"><img alt="MICHELIN ENERGY SAVER 4" class="th_tire_img" src="img/energy/energy_saver_4.jpg"/></div> <div class="th_table_cell"> <div class="th_table_comm"><span class="font_3fc_b">雨の日の安心感と快適性を両立した低燃費タイヤ</span></div> <div class="th_table_comm">新配合コンパウンドの採用により、ウェット路面でのグリップ性能を向上。低燃費性能とウェット性能のバランスを高レベルで達成。</div> <div class="th_table_comm">縦溝幅の最適化により、パターンノイズの低減を実現、アンダートレッドラバーを採用することでロードノイズを低減し静粛性を向上。</div> <div class="th_table_comm">アンダートレッドラバーにより、他の性能を犠牲にすることなく、低転がり抵抗を実現、燃費性能の向上を実現。</div> <div class="th_tire_price"><form action="../maker_item.php" method="post" target="_blank"><input name="maker" type="hidden" value="MICHELIN"/><input name="brand" type="hidden" value="ENERGYシリーズ"/><input name="item" type="hidden" value="ENERGY SAVER 4"/><input name="image" src="../img/price.gif" type="image"/></form></div> </div> </div> <hr class="th_hr" noshade=""/> <div class="th_comm_bar_00f"> <div class="th_comm_bar_3px">ENERGY SAVER＋</div> </div> <div class="th_table"> <div class="th_table_photo_350"><img alt="MICHELIN ENERGY SAVER＋" class="th_tire_img" src="img/energy/energy_saver_plus.jpg"/></div> <div class="th_table_cell"> <div class="th_table_comm"><span class="font_3fc_b">進化した安全性で安心感がプレスされた、低燃費タイヤ。</span></div> <div class="th_table_comm">より安全なドライブのためにワイドな接地面を採用しています。ブレーキ・ハンドリング・高速走行などに半を感じる場面でもワイドな接地面がしっかりとしたグリップをもたらします。</div> <div class="th_table_comm">接地面圧がより均一になり、確実に路面を捉えることが可能に。さらに、接地面圧の均一化によってトレッド部の極端な温度上昇を防ぐことで転がり抵抗性能のロスを回避。</div> <div class="th_tire_price"><form action="../maker_item.php" method="post" target="_blank"><input name="maker" type="hidden" value="MICHELIN"/><input name="brand" type="hidden" value="ENERGYシリーズ"/><input name="item" type="hidden" value="ENERGY SAVER＋"/><input name="image" src="../img/price.gif" type="image"/></form></div> </div> </div> <hr class="th_hr" noshade=""/> <div class="th_comm_bar_00f"> <div class="th_comm_bar_3px">ENERGY SAVER</div> </div> <div class="th_table"> <div class="th_table_photo_350"><img alt="MICHELIN ENERGY SAVER" class="th_tire_img" src="img/energy/energy_saver.jpg"/></div> <div class="th_table_cell"> <div class="th_table_comm"><span class="font_3fc_b">高い安全性と耐久性を兼ね備えた低燃費タイヤ</span></div> <div class="th_table_comm">確かな安全性と省燃費性を備えながら、優れた耐摩耗性能を実現。低ランニングコストかつ省資源にも貢献する、環境にもドライバーにも優しいモデルです。</div> <div class="th_tire_price"><form action="../maker_item.php" method="post" target="_blank"><input name="maker" type="hidden" value="MICHELIN"/><input name="brand" type="hidden" value="ENERGYシリーズ"/><input name="item" type="hidden" value="ENERGY SAVER"/><input name="image" src="../img/price.gif" type="image"/></form></div> </div> </div> 
                </div>
                <div class="col-md-6 col-sm-6 col-xs-12">
