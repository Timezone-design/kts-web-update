...
<title>KTS-web タイヤ・ホイール館 MICHELIN（ミシュラン） PRIMACY</title>
              ...
              <div class="th_back row">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                   <div class="th_title_730"><img alt="PRIMACY" src="img/b_logo/primacy.gif"/></div> <hr class="th_hr" noshade=""/> <div class="th_comm_bar_00f"> <div class="th_comm_bar_3px">PRIMACY4</div> </div> <div class="th_table"> <div class="th_table_photo_350"><img alt="MICHELIN PRIMACY4" class="th_tire_img" src="img/primacy/primacy_4.jpg"/></div> <div class="th_table_cell"> <div class="th_table_comm"><span class="font_3fc_b">濡れた路面にも強い、プレミアムコンフォートタイヤ</span></div> <div class="th_table_comm">PRIMACY3と比較して、履き替え時のウェットブレーキング性能が約13.3％アップ。履き始めから、履き替えの時まで安心感が長く続きます。</div> <div class="th_tire_price"><form action="../maker_item.php" method="post" target="_blank"><input name="maker" type="hidden" value="MICHELIN"/><input name="brand" type="hidden" value="PRIMACYシリーズ"/><input name="item" type="hidden" value="PRIMACY4"/><input name="image" src="../img/price.gif" type="image"/></form></div> </div> </div> <hr class="th_hr" noshade=""/> <div class="th_comm_bar_00f"> <div class="th_comm_bar_3px">PRIMACY3</div> </div> <div class="th_table"> <div class="th_table_photo_350"><img alt="MICHELIN PRIMACY3" class="th_tire_img" src="img/primacy/primacy_3.jpg"/></div> <div class="th_table_cell"> <div class="th_table_comm"><span class="font_3fc_b">快適性と高速安定性を融合したアクティブコンフォートタイヤ</span></div> <div class="th_table_comm">パターンノイズを抑制するため、接地面形状とサイプのデザインを全体的に見直しました。</div> <div class="th_table_comm">ビード部の設計も見直し最適化することで、高速走行時の突き上げなどを素早く吸収。疲れにくく、より安定した乗り心地を提供します。</div> <div class="th_tire_price"><form action="../maker_item.php" method="post" target="_blank"><input name="maker" type="hidden" value="MICHELIN"/><input name="brand" type="hidden" value="PRIMACYシリーズ"/><input name="item" type="hidden" value="PRIMACY3"/><input name="image" src="../img/price.gif" type="image"/></form></div> </div> </div> 
                </div>
                <div class="col-md-6 col-sm-6 col-xs-12">
