<html>
  ...
  <head>
    <meta content="MICHELIN,ミシュラン,PRIMACY,プライマシー,販売,装着,脱着,アライメント" name="keywords" />
    ...
    <title>KTS-web タイヤ・ホイール館 MICHELIN（ミシュラン） PRIMACY</title>
            ...
            <div class="main_c row grey-wrapper">
              ...
              <div class="th_back row">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                  <div class="th_title_730"><img alt="PRIMACY" src="img/b_logo/primacy.gif" /></div>
                  <div class="clearfix-s"></div>
                    ...
                    <div class="container">
                      <ul class="nav nav-tabs">
                        <li class="active"><a data-toggle="tab" href="#_0">
                            <div class="th_comm_bar_00f">
                              <div class="th_comm_bar_3px">PRIMACY4</div>
                            </div>
                          </a></li>
                        <li><a data-toggle="tab" href="#_1">
                            <div class="th_comm_bar_00f">
                              <div class="th_comm_bar_3px">PRIMACY3</div>
                            </div>
                          </a></li>
                      </ul>
                      <br>
                      <div class="tab-content">
                        <div id="_0" class="tab-pane fade in active show">
                          <div class="th_table">
                            <div class="th_table_photo_350"><img class="th_tire_img" src="img/primacy/primacy_4.jpg" alt="MICHELIN PRIMACY4" data-nsfw-filter-status="sfw" style="visibility: visible;"></div>
                            <div class="th_table_cell">
                              <div class="th_table_comm"><span class="font_3fc_b" data-nsfw-filter-status="swf">濡れた路面にも強い、プレミアムコンフォートタイヤ</span></div>
                              <div class="th_table_comm">PRIMACY3と比較して、履き替え時のウェットブレーキング性能が約13.3％アップ。履き始めから、履き替えの時まで安心感が長く続きます。</div>
                              <div class="th_tire_price">
                                <form method="post" action="../maker_item.php" target="_blank"><input type="hidden" name="maker" value="MICHELIN"><input type="hidden" name="brand" value="PRIMACYシリーズ"><input type="hidden" name="item" value="PRIMACY4"><input type="image" src="../img/price.gif" name="image"></form>
                              </div>
                            </div>
                          </div>
                        </div>
                        <div id="_1" class="tab-pane fade">
                          <div class="th_table">
                            <div class="th_table_photo_350"><img class="th_tire_img" src="img/primacy/primacy_3.jpg" alt="MICHELIN PRIMACY3" data-nsfw-filter-status="sfw" style="visibility: visible;"></div>
                            <div class="th_table_cell">
                              <div class="th_table_comm"><span class="font_3fc_b" data-nsfw-filter-status="swf">快適性と高速安定性を融合したアクティブコンフォートタイヤ</span></div>
                              <div class="th_table_comm">パターンノイズを抑制するため、接地面形状とサイプのデザインを全体的に見直しました。</div>
                              <div class="th_table_comm">ビード部の設計も見直し最適化することで、高速走行時の突き上げなどを素早く吸収。疲れにくく、より安定した乗り心地を提供します。</div>
                              <div class="th_tire_price">
                                <form method="post" action="../maker_item.php" target="_blank"><input type="hidden" name="maker" value="MICHELIN"><input type="hidden" name="brand" value="PRIMACYシリーズ"><input type="hidden" name="item" value="PRIMACY3"><input type="image" src="../img/price.gif" name="image"></form>
                              </div>
                            </div>
                          </div>
                        </div>
