<html>
 <head>
  ...
  <title>
   KTS-web タイヤ・ホイール館 MICHELIN（ミシュラン） PILOT
  </title>
      ...
      <div class="main_c row grey-wrapper">
       ...
       <div class="th_back row">
        ...
        <div class="col-md-6 col-sm-6 col-xs-12">
         <div class="th_title_730">
          <img alt="PILOT" src="img/b_logo/pilot.gif"/>
         </div>
         <div class="clearfix-s">
         </div>
            ...
            <div class="tab-pane fade" id="_1">
             <div class="th_table">
              ...
              <div class="th_table_cell">
               ...
               <div class="th_table_comm">
                ドライでも、ウェットでも、最適なグリッピ性能を発揮するデュアル・コンパウンド2.0採用。
               </div>
               <div class="th_table_comm">
            ...
            <div class="tab-pane fade" id="_3">
             <div class="th_table">
              ...
              <div class="th_table_cell">
               ...
               <div class="th_table_comm">
                PILOT SPORT CUP 2の高性能仕様として、スーパースポーツカーを操縦しサーキット走行を愉しむドライバーのために設計。
               </div>
               <div class="th_table_comm">
            ...
            <div class="tab-pane fade" id="_4">
             <div class="th_table">
              ...
              <div class="th_table_cell">
               ...
               <div class="th_table_comm">
                3つの技術の融合による優れたグリップ力、接地面の温度に配慮しハンドリングを安定化。
               </div>
               <div class="th_table_comm">
            ...
            <div class="tab-pane fade" id="_5">
             <div class="th_table">
              ...
              <div class="th_table_cell">
               ...
               <div class="th_table_comm">
                アシンメトリック（非対称）トレッドパターンを採用し、ウェット時でもスポーティーな走りを実現。
               </div>
               <div class="th_table_comm">
            ...
            <div class="tab-pane fade" id="_7">
             <div class="th_table">
              ...
              <div class="th_table_cell">
               ...
               <div class="th_table_comm">
                インサイドとアウトサイドで異なるコンパウンドを採用。サーキットにおいて高いパフォーマンスを発揮します。
               </div>
               <div class="th_table_comm">
