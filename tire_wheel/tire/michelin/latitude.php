...
<title>KTS-web タイヤ・ホイール館 MICHELIN（ミシュラン） LATITUDE</title>
              ...
              <div class="th_back row">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                   <div class="th_title_730"><img alt="LATITUDEシリーズ" src="img/b_logo/latitude.gif"/></div> <hr class="th_hr" noshade=""/> <div class="th_comm_bar_00f"> <div class="th_comm_bar_3px">LATITUDE SPORT 3</div> </div> <div class="th_table"> <div class="th_table_photo_350"><img alt="MICHELIN LATITUDE SPORT 3" class="th_tire_img" src="img/latitude/latitude_sport_3.jpg"/></div> <div class="th_table_cell"> <div class="th_table_comm"><span class="font_3fc_b">走りの楽しみを妥協しないスポーツSUVタイヤ</span></div> <div class="th_table_comm">連続したセンターリブ形状を採用し、ドライ路面でもウェット路面でもブレーキングや発進時のトルクをしっかりと路面に伝えます。</div> <div class="th_table_comm">SUVスポーツパワーコンパウンド採用。引っ張り強度の高い長寿命なエラストマーが加減速時にも破壊されず、耐摩耗性能が向上。ロングライフを実現します。</div> <div class="th_tire_price"><form action="../maker_item.php" method="post" target="_blank"><input name="maker" type="hidden" value="MICHELIN"/><input name="brand" type="hidden" value="LATITUDEシリーズ"/><input name="item" type="hidden" value="LATITUDE SPORT 3"/><input name="image" src="../img/price.gif" type="image"/></form></div> </div> </div> <hr class="th_hr" noshade=""/> <div class="th_comm_bar_00f"> <div class="th_comm_bar_3px">LATITUDE SPORT</div> </div> <div class="th_table"> <div class="th_table_photo_350"><img alt="MICHELIN LATITUDE SPORT" class="th_tire_img" src="img/latitude/latitude_sport.jpg"/></div> <div class="th_table_cell"> <div class="th_table_comm"><span class="font_3fc_b">ミシュランのスピリットを継承する、リアル・スポーツSUVタイヤ。</span></div> <div class="th_table_comm">ミシュランのスポーツモデル「MICHELIN Pilot Sport PS2」のトレッドパターンを踏襲し、的確なグリップ力と優れたウェット性能を兼備。</div> <div class="th_table_comm">荷重の大きなSUVでも躍動的なパフォーマンスを堪能でき、高性能SUV本来の性能を余すところなく引き出します。</div> <div class="th_tire_price"><form action="../maker_item.php" method="post" target="_blank"><input name="maker" type="hidden" value="MICHELIN"/><input name="brand" type="hidden" value="LATITUDEシリーズ"/><input name="item" type="hidden" value="LATITUDE SPORT"/><input name="image" src="../img/price.gif" type="image"/></form></div> </div> </div> <hr class="th_hr" noshade=""/> <div class="th_comm_bar_00f"> <div class="th_comm_bar_3px">LATITUDE TOUR HP</div> </div> <div class="th_table"> <div class="th_table_photo_350"><img alt="MICHELIN LATITUDE TOUR HP" class="th_tire_img" src="img/latitude/latitude_tour_hp.jpg"/></div> <div class="th_table_cell"> <div class="th_table_comm"><span class="font_3fc_b">優れた快適性と耐久性をもたらす、オンロードSUVタイヤ。</span></div> <div class="th_table_comm">剛性の高いトレッドパターンとマッチする柔軟なタイヤ構造を採用。広い接地面を確保して走りの安定感を高めると共に、接地面圧の分布を均等化することで変磨耗の抑制を図りました。</div> <div class="th_table_comm">ノイズ低減と優れた居住性を追求したパターンデザインと相まって、くつろぎある走りを堪能できます。</div> <div class="th_tire_price"><form action="../maker_item.php" method="post" target="_blank"><input name="maker" type="hidden" value="MICHELIN"/><input name="brand" type="hidden" value="LATITUDEシリーズ"/><input name="item" type="hidden" value="LATITUDE TOUR HP"/><input name="image" src="../img/price.gif" type="image"/></form></div> </div> </div> <hr class="th_hr" noshade=""/> <div class="th_comm_bar_00f"> <div class="th_comm_bar_3px">LATITUDE TOUR</div> </div> <div class="th_table"> <div class="th_table_photo_350"><img alt="MICHELIN LATITUDE TOUR" class="th_tire_img" src="img/latitude/latitude_tour.jpg"/></div> <div class="th_table_cell"> <div class="th_table_comm"><span class="font_3fc_b">優れた快適性と耐久性をもたらす、オンロードSUVタイヤ。</span></div> <div class="th_table_comm">剛性の高いトレッドパターンとマッチする柔軟なタイヤ構造を採用。広い接地面を確保して走りの安定感を高めると共に、接地面圧の分布を均等化することで変磨耗の抑制を図りました。</div> <div class="th_table_comm">ノイズ低減と優れた居住性を追求したパターンデザインと相まって、くつろぎある走りを堪能できます。</div> <div class="th_tire_price"><form action="../maker_item.php" method="post" target="_blank"><input name="maker" type="hidden" value="MICHELIN"/><input name="brand" type="hidden" value="LATITUDEシリーズ"/><input name="item" type="hidden" value="LATITUDE TOUR"/><input name="image" src="../img/price.gif" type="image"/></form></div> </div> </div> <hr class="th_hr" noshade=""/> <div class="th_comm_bar_00f"> <div class="th_comm_bar_3px">LATITUDE CROSS</div> </div> <div class="th_table"> <div class="th_table_photo_350"><img alt="MICHELIN LATITUDE CROSS" class="th_tire_img" src="img/latitude/latitude_cross.jpg"/></div> <div class="th_table_cell"> <div class="th_table_comm"><span class="font_3fc_b">オフロードもオンロードも自由に走り続ける、オールラウンドSUVタイヤ。</span></div> <div class="th_table_comm">過酷な路面に適した泥はけの良いトレッドデザインが、マッドでのスムーズな発進を可能にし、不安定なラフロードで優れたトラクションを確保します。</div> <div class="th_table_comm">さらにショルダーからサイドウォールにかけて深溝のマッドキャッチャーを配置し、ぬかるみでも高いグリップを発揮します。</div> <div class="th_tire_price"><form action="../maker_item.php" method="post" target="_blank"><input name="maker" type="hidden" value="MICHELIN"/><input name="brand" type="hidden" value="LATITUDEシリーズ"/><input name="item" type="hidden" value="LATITUDE CROSS"/><input name="image" src="../img/price.gif" type="image"/></form></div> </div> </div> 
                </div>
                <div class="col-md-6 col-sm-6 col-xs-12">
