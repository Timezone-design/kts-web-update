<html>
 <head>
  ...
  <title>
   KTS-web タイヤ・ホイール館 MICHELIN（ミシュラン） LATITUDE
  </title>
      ...
      <div class="main_c row grey-wrapper">
       ...
       <div class="th_back row">
        ...
        <div class="col-md-6 col-sm-6 col-xs-12">
         <div class="th_title_730">
          <img alt="LATITUDEシリーズ" src="img/b_logo/latitude.gif"/>
         </div>
         <div class="clearfix-s">
         </div>
            ...
            <div class="tab-pane fade in active show" id="_0">
             <div class="th_table">
              ...
              <div class="th_table_cell">
               ...
               <div class="th_table_comm">
                連続したセンターリブ形状を採用し、ドライ路面でもウェット路面でもブレーキングや発進時のトルクをしっかりと路面に伝えます。
               </div>
               <div class="th_table_comm">
            ...
            <div class="tab-pane fade" id="_1">
             <div class="th_table">
              ...
              <div class="th_table_cell">
               ...
               <div class="th_table_comm">
                ミシュランのスポーツモデル「MICHELIN Pilot Sport PS2」のトレッドパターンを踏襲し、的確なグリップ力と優れたウェット性能を兼備。
               </div>
               <div class="th_table_comm">
            ...
            <div class="tab-pane fade" id="_2">
             <div class="th_table">
              ...
              <div class="th_table_cell">
               ...
               <div class="th_table_comm">
                剛性の高いトレッドパターンとマッチする柔軟なタイヤ構造を採用。広い接地面を確保して走りの安定感を高めると共に、接地面圧の分布を均等化することで変磨耗の抑制を図りました。
               </div>
               <div class="th_table_comm">
            ...
            <div class="tab-pane fade" id="_4">
             <div class="th_table">
              ...
              <div class="th_table_cell">
               ...
               <div class="th_table_comm">
                過酷な路面に適した泥はけの良いトレッドデザインが、マッドでのスムーズな発進を可能にし、不安定なラフロードで優れたトラクションを確保します。
               </div>
               <div class="th_table_comm">
