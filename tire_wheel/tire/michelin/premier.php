...
<title>KTS-web タイヤ・ホイール館 MICHELIN（ミシュラン） PREMIER</title>
              ...
              <div class="th_back row">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                   <div class="th_title_730"><img alt="PREMIER" src="img/b_logo/premier.gif"/></div> <hr class="th_hr" noshade=""/> <div class="th_comm_bar_00f"> <div class="th_comm_bar_3px">PREMIER LTX</div> </div> <div class="th_table"> <div class="th_table_photo_350"><img alt="MICHELIN PREMIER LTX" class="th_tire_img" src="img/premier/premier_ltx.jpg"/></div> <div class="th_table_cell"> <div class="th_table_comm"><span class="font_3fc_b">快適性と高速安定性を融合したアクティブコンフォートSUVタイヤ</span></div> <div class="th_table_comm">エバーグリップテクノロジーの効果により、高速走行時の突き上げや車体の揺れを素早く吸収。</div> <div class="th_table_comm">SUV用タイヤにありがちなふらつきが少なく、快適なフラットライド感を提供します。</div> <div class="th_tire_price"><form action="../maker_item.php" method="post" target="_blank"><input name="maker" type="hidden" value="MICHELIN"/><input name="brand" type="hidden" value="PREMIERシリーズ"/><input name="item" type="hidden" value="PREMIER LTX"/><input name="image" src="../img/price.gif" type="image"/></form></div> </div> </div> 
                </div>
                <div class="col-md-6 col-sm-6 col-xs-12">
