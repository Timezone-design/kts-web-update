 <html>
							<head>
							<meta content="FEDERAL,フェデラル,SUV,4WD,タイヤ,販売,装着,脱着,アライメント" name="keywords"/>
...
<title>KTS-web タイヤ・ホイール館 FEDERAL（フェデラル）</title>
              ...
              <div class="th_back row">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                   <div class="th_title_730"><img alt="SUV/4WDタイヤ" src="img/b_logo/specialty.gif"/></div> <hr class="th_hr" noshade=""/> <div class="th_comm_bar_00f"> <div class="th_comm_bar_3px">COURAGIA F/X</div> </div> <div class="th_table"> <div class="th_table_photo_350"><img alt="FEDERAL COURAGIA F/X" class="th_tire_img" src="img/specialty/couragia_fx.jpg"/></div> <div class="th_table_cell"> <div class="th_table_comm">LSUVの3H（高馬力、高重心、高車高）をターゲットにしたCOURAGIA F/Xは開発され、タイヤの内側と外側それぞれ異なる機能を持たせる非対称パターンという最先端の設計は、ドライバーに操縦性、快適性、そして静粛性による楽しさを体験して頂きます。</div> <div class="th_table_comm">V.I.P.ドライバーに未曾有のグリップ力とハンドリング性能を提供いたします。スーパーカーにもおすすめです。</div> <div class="th_tire_price"><form action="../maker_item.php" method="post" target="_blank"><input name="maker" type="hidden" value="FEDERAL"/><input name="brand" type="hidden" value="SUV/4WD"/><input name="item" type="hidden" value="COURAGIA F/X"/><input name="image" src="../img/price.gif" type="image"/></form></div> </div> </div> <hr class="th_hr" noshade=""/> <div class="th_comm_bar_00f"> <div class="th_comm_bar_3px">COURAGIA XUV</div> </div> <div class="th_table"> <div class="th_table_photo_350"><img alt="FEDERAL COURAGIA XUV" class="th_tire_img" src="img/specialty/couragia_xuv.jpg"/></div> <div class="th_table_cell"> <div class="th_table_comm">この新しいSUVツーリングタイヤは安定性に優れ、最先端技術による快適性が楽しめます。</div> <div class="th_tire_price"><form action="../maker_item.php" method="post" target="_blank"><input name="maker" type="hidden" value="FEDERAL"/><input name="brand" type="hidden" value="SUV/4WD"/><input name="item" type="hidden" value="COURAGIA XUV"/><input name="image" src="../img/price.gif" type="image"/></form></div> </div> </div> <hr class="th_hr" noshade=""/> <div class="th_comm_bar_00f"> <div class="th_comm_bar_3px">COURAGIA M/T</div> </div> <div class="th_table"> <div class="th_table_photo_350"><img alt="FEDERAL COURAGIA M/T" class="th_tire_img" src="img/specialty/couragia_mt.jpg"/></div> <div class="th_table_cell"> <div class="th_table_comm">4×4のアグレッシブな走破性を追求。マッド性能を特化させたスポーツギア！！</div> <div class="th_tire_price"><form action="../maker_item.php" method="post" target="_blank"><input name="maker" type="hidden" value="FEDERAL"/><input name="brand" type="hidden" value="SUV/4WD"/><input name="item" type="hidden" value="COURAGIA M/T"/><input name="image" src="../img/price.gif" type="image"/></form></div> </div> </div> 
                </div>
                <div class="col-md-6 col-sm-6 col-xs-12">
