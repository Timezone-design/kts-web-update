 <html>
							<head>
							<meta content="FEDERAL,フェデラル,ラグジュアリー,スポーツ,タイヤ,販売,装着,脱着,アライメント" name="keywords"/>
...
<title>KTS-web タイヤ・ホイール館 FEDERAL（フェデラル）</title>
              ...
              <div class="th_back row">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                   <div class="th_title_730"><img alt="ラグジュアリースポーツ" src="img/b_logo/luxury_sports.gif"/></div> <hr class="th_hr" noshade=""/> <div class="th_comm_bar_00f"> <div class="th_comm_bar_3px">595RPM</div> </div> <div class="th_table"> <div class="th_table_photo_350"><img alt="FEDERAL 595RPM" class="th_tire_img" src="img/luxury_sports/595rpm.jpg"/></div> <div class="th_table_cell"> <div class="th_table_comm">595RPMの新開発したコンパウンドと非対称パターンは快適性とパフォーマンスを完璧に融合。</div> <div class="th_table_comm">V.I.P.ドライバーに未曾有のグリップ力とハンドリング性能を提供いたします。スーパーカーにもおすすめです。</div> <div class="th_tire_price"><form action="../maker_item.php" method="post" target="_blank"><input name="maker" type="hidden" value="FEDERAL"/><input name="brand" type="hidden" value="LUXURY SPORTS"/><input name="item" type="hidden" value="595RPM"/><input name="image" src="../img/price.gif" type="image"/></form></div> </div> </div> 
                </div>
                <div class="col-md-6 col-sm-6 col-xs-12">
