 <html>
							<head>
							<meta content="FEDERAL,フェデラル,スポーツ,タイヤ,販売,装着,脱着,アライメント" name="keywords"/>
<meta content="FEDERAL製タイヤ販売中！取付・バランス取りも特価で承っております！" name="description"/>
<meta content="text/html; charset=utf-8" http-equiv="Content-Type"/>
<meta content="width=device-width, user-scalable=yes, initial-scale=1, maximum-scale=1" name="viewport"/>
<meta content="width=device-width" name="viewport"/>
<title>KTS-web タイヤ・ホイール館 FEDERAL（フェデラル）</title>
              ...
              <div class="th_back row">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                   <div class="th_title_730"><img alt="スポーツ" src="img/b_logo/sports.gif"/></div> <hr class="th_hr" noshade=""/> <div class="th_comm_bar_00f"> <div class="th_comm_bar_3px">595RS-PRO</div> </div> <div class="th_table"> <div class="th_table_photo_350"><img alt="FEDERAL 595RS-PRO" class="th_tire_img" src="img/sports/595rs_pro.jpg"/></div> <div class="th_table_cell"> <div class="th_table_comm">595RS-PROは、積極的なパフォーマンスに対するドライバーの望みとスタイルを満たすように設計された、EURO R117認定のストリートタイヤです。</div> <div class="th_tire_price"><form action="../maker_item.php" method="post" target="_blank"><input name="maker" type="hidden" value="FEDERAL"/><input name="brand" type="hidden" value="SPORTS"/><input name="item" type="hidden" value="595RS-PRO"/><input name="image" src="../img/price.gif" type="image"/></form></div> </div> </div> <hr class="th_hr" noshade=""/> <div class="th_comm_bar_00f"> <div class="th_comm_bar_3px">EVOLUZION ST-1</div> </div> <div class="th_table"> <div class="th_table_photo_350"><img alt="FEDERAL EVOLUZION ST-1" class="th_tire_img" src="img/sports/evoluzion_st_1.jpg"/></div> <div class="th_table_cell"> <div class="th_table_comm">完璧な制御、究極の乗り心地。595から「進化」した、新時代のストリートタイヤ。</div> <div class="th_tire_price"><form action="../maker_item.php" method="post" target="_blank"><input name="maker" type="hidden" value="FEDERAL"/><input name="brand" type="hidden" value="SPORTS"/><input name="item" type="hidden" value="EVOLUZION ST-1"/><input name="image" src="../img/price.gif" type="image"/></form></div> </div> </div> <hr class="th_hr" noshade=""/> <div class="th_comm_bar_00f"> <div class="th_comm_bar_3px">595RS-RR</div> </div> <div class="th_table"> <div class="th_table_photo_350"><img alt="FEDERAL 595RS-RR" class="th_tire_img" src="img/sports/595rs_rr.jpg"/></div> <div class="th_table_cell"> <div class="th_table_comm">数々の伝説を生んだ595RS-Rの次世代製品として、フェデラルの最新技術を結集した史上最強のハイグリップタイヤ。</div> <div class="th_tire_price"><form action="../maker_item.php" method="post" target="_blank"><input name="maker" type="hidden" value="FEDERAL"/><input name="brand" type="hidden" value="SPORTS"/><input name="item" type="hidden" value="595RS-RR"/><input name="image" src="../img/price.gif" type="image"/></form></div> </div> </div> <hr class="th_hr" noshade=""/> <div class="th_comm_bar_00f"> <div class="th_comm_bar_3px">595RS-R</div> </div> <div class="th_table"> <div class="th_table_photo_350"><img alt="FEDERAL 595RS-R" class="th_tire_img" src="img/sports/595rs_r.jpg"/></div> <div class="th_table_cell"> <div class="th_table_comm">サーキット走行で鍛えた、ドライ＆ウェットグリップ。スポーツドライビングを楽しむためのハイパフォーマンス・ストリートタイヤ。</div> <div class="th_tire_price"><form action="../maker_item.php" method="post" target="_blank"><input name="maker" type="hidden" value="FEDERAL"/><input name="brand" type="hidden" value="SPORTS"/><input name="item" type="hidden" value="595RS-R"/><input name="image" src="../img/price.gif" type="image"/></form></div> </div> </div> <hr class="th_hr" noshade=""/> <div class="th_comm_bar_00f"> <div class="th_comm_bar_3px">595</div> </div> <div class="th_table"> <div class="th_table_photo_350"><img alt="FEDERAL 595" class="th_tire_img" src="img/sports/595.jpg"/></div> <div class="th_table_cell"> <div class="th_table_comm">SS595は、ハイスピード走行を要求される高性能スポーツカーのために開発されたハイパフォーマンスタイヤです。</div> <div class="th_table_comm">TTIC技術理論から誕生したドライ＆ウェット、どちらの路面状況でも抜群の走行性能を発揮するスーパースポーツタイヤです。</div> <div class="th_tire_price"><form action="../maker_item.php" method="post" target="_blank"><input name="maker" type="hidden" value="FEDERAL"/><input name="brand" type="hidden" value="SPORTS"/><input name="item" type="hidden" value="595"/><input name="image" src="../img/price.gif" type="image"/></form></div> </div> </div> 
                </div>
                <div class="col-md-6 col-sm-6 col-xs-12">
