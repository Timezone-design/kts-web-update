 <html>
							<head>
							<meta content="FEDERAL,フェデラル,コンフォート,スポーツ,タイヤ,販売,装着,脱着,アライメント" name="keywords"/>
...
<title>KTS-web タイヤ・ホイール館 FEDERAL（フェデラル）</title>
              ...
              <div class="th_back row">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                   <div class="th_title_730"><img alt="コンフォート" src="img/b_logo/comfort.gif"/></div> <hr class="th_hr" noshade=""/> <div class="th_comm_bar_00f"> <div class="th_comm_bar_3px">FORMOZA AZ01</div> </div> <div class="th_table"> <div class="th_table_photo_350"><img alt="FEDERAL FORMOZA AZ01" class="th_tire_img" src="img/comfort/formoza_az01.jpg"/></div> <div class="th_table_cell"> <div class="th_table_comm">毎日の運転を快適に。</div> <div class="th_table_comm">ウェットグリップに優れ、安定した静かな走りを実現する低燃費タイヤ。</div> <div class="th_tire_price"><form action="../maker_item.php" method="post" target="_blank"><input name="maker" type="hidden" value="FEDERAL"/><input name="brand" type="hidden" value="COMFORT"/><input name="item" type="hidden" value="FORMOZA AZ01"/><input name="image" src="../img/price.gif" type="image"/></form></div> </div> </div> <hr class="th_hr" noshade=""/> <div class="th_comm_bar_00f"> <div class="th_comm_bar_3px">FORMOZA FD2</div> </div> <div class="th_table"> <div class="th_table_photo_350"><img alt="FEDERAL FORMOZA FD2" class="th_tire_img" src="img/comfort/formoza_fd2.jpg"/></div> <div class="th_table_cell"> <div class="th_table_comm">快適性・静粛性、全てが進化。</div> <div class="th_table_comm">セダンからミニバンと幅広く対応の最上級コンフォートタイヤ。</div> <div class="th_tire_price"><form action="../maker_item.php" method="post" target="_blank"><input name="maker" type="hidden" value="FEDERAL"/><input name="brand" type="hidden" value="COMFORT"/><input name="item" type="hidden" value="FORMOZA FD2"/><input name="image" src="../img/price.gif" type="image"/></form></div> </div> </div> 
                </div>
                <div class="col-md-6 col-sm-6 col-xs-12">
