...
<title>KTS-web タイヤ・ホイール館 GOODYEAR（グッドイヤー）</title>
              ...
              <div class="th_back row">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                   <div class="th_title_730"><img alt="ALL SEASON（オールシーズン）" src="img/b_logo/all.gif"/></div> <hr class="th_hr" noshade=""/> <div class="th_comm_bar_00f"> <div class="th_comm_bar_3px">Vector 4Seasons Hybrid（ベクター フォーシーズンズ ハイブリッド）</div> </div> <div class="th_table"> <div class="th_table_photo_350"><img alt="GOODYEAR Vector 4Seasons Hybrid" class="th_tire_img" src="img/all/vecter_4seasons_hybrid.jpg"/></div> <div class="th_table_cell"> <div class="th_table_comm">突然の降雪、さまざまな天候や路面コンディションに左右されず、四季を通じて安定した走りを可能にするタイヤです。年間を通じ履き替えなしでご利用いただけます。</div> <div class="th_tire_price"><form action="../maker_item.php" method="post" target="_blank"><input name="maker" type="hidden" value="GOODYEAR"/><input name="brand" type="hidden" value="オールシーズン"/><input name="item" type="hidden" value="Vector 4Seasons Hybrid"/><input name="image" src="../img/price.gif" type="image"/></form></div> </div> </div> <hr class="th_hr" noshade=""/> <div class="th_comm_bar_00f"> <div class="th_comm_bar_3px">Assurance WeatherReady（アシュアランスウェザーレディ）</div> </div> <div class="th_table"> <div class="th_table_photo_350"><img alt="GOODYEAR Assurance WeatherReady" class="th_tire_img" src="img/all/assurance_weatherready.jpg"/></div> <div class="th_table_cell"> <div class="th_table_comm">突然の降雪、さまざまな天候や路面コンディションに左右されず、四季を通じて安定した走りを可能にするミニバン・SUV向けタイヤです。年間を通じ履き替えなしでご利用いただけます。</div> <div class="th_tire_price"><form action="../maker_item.php" method="post" target="_blank"><input name="maker" type="hidden" value="GOODYEAR"/><input name="brand" type="hidden" value="オールシーズン"/><input name="item" type="hidden" value="Assurance WeatherReady"/><input name="image" src="../img/price.gif" type="image"/></form></div> </div> </div> 
                </div>
                <div class="col-md-6 col-sm-6 col-xs-12">
