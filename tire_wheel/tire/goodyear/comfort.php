      ...
      <div class="main_c row grey-wrapper">
       ...
       <div class="th_back row">
        ...
        <div class="col-md-6 col-sm-6 col-xs-12">
         <div class="th_title_730">
          <img alt="COMFORT（コンフォート）" src="img/b_logo/comfort.gif"/>
         </div>
         <div class="clearfix-s">
         </div>
           ...
           <ul class="nav nav-tabs">
             ...
             <a data-toggle="tab" href="#_0">
              <div class="th_comm_bar_00f">
               <div class="th_comm_bar_3px">
                EfficientGrip Performance（エフィシェントグリップ パフォーマンス）
               </div>
              </div>
             </a>
            </li>
            <li>
             <a data-toggle="tab" href="#_1">
              <div class="th_comm_bar_00f">
               <div class="th_comm_bar_3px">
                EfficientGrip Comfort（エフィシェントグリップ コンフォート）
               </div>
              </div>
             </a>
            </li>
             ...
             <div class="th_table">
              ...
              <div class="th_table_cell">
               <div class="th_table_comm">
                最先端技術によって、低燃費性能とそれに相反するウエット性能を高い次元で両立。
               </div>
               <div class="th_table_comm">
