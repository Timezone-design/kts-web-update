...
<title>KTS-web タイヤ・ホイール館 GOODYEAR（グッドイヤー）</title>
              ...
              <div class="th_back row">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                   <div class="th_title_730"><img alt="VAN" src="img/b_logo/van.gif"/></div> <hr class="th_hr" noshade=""/> <div class="th_comm_bar_00f"> <div class="th_comm_bar_3px">CARGO PRO（カーゴ プロ）</div> </div> <div class="th_table"> <div class="th_table_photo_350"><img alt="GOODYEAR CARGO PRO" class="th_tire_img" src="img/van/cargo_pro.jpg"/></div> <div class="th_table_cell"> <div class="th_table_comm">商用車に求められる基本性能を、高いレベルで実現。ロングライフ性能を徹底した、選びのプロのためのVAN用ラジアルタイヤです。</div> <div class="th_tire_price"><form action="../maker_item.php" method="post" target="_blank"><input name="maker" type="hidden" value="GOODYEAR"/><input name="brand" type="hidden" value="VAN"/><input name="item" type="hidden" value="CARGO PRO"/><input name="image" src="../img/price.gif" type="image"/></form></div> </div> </div> 
                </div>
                <div class="col-md-6 col-sm-6 col-xs-12">
