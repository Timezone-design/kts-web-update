...
<title>KTS-web タイヤ・ホイール館 TOYO TIRES（トーヨータイヤ）TRANPATH</title>
              ...
              <div class="th_back row">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                   <div class="th_title_730"><img alt="TRANPATH" src="img/b_logo/tranpath.gif"/></div> <hr class="th_hr" noshade=""/> <div class="th_comm_bar_00f"> <div class="th_comm_bar_3px">mpZ（エムピーゼット）</div> </div> <div class="th_table"> <div class="th_table_photo_350"><img alt="TOYO TIRES TRANPATH mpZ" class="th_tire_img" src="img/tranpath/mpz.jpg"/></div> <div class="th_table_cell"> <div class="th_table_comm"><span class="font_3fc_b">フラつきを抑えてしっかり走り、経済性も兼ね備えたミニバン専用スタンダードタイヤ。</span></div> <div class="th_table_comm">剛性を高めるスーパーハイターンアップ構造と非対称の3本溝タイヤパターンにより、高速でのレーンチェンジでもフラつきを抑制。</div> <div class="th_tire_price"><form action="../maker_item.php" method="post" target="_blank"><input name="maker" type="hidden" value="TOYO TIRES"/><input name="brand" type="hidden" value="TRANPATH"/><input name="item" type="hidden" value="mpZ"/><input name="image" src="../img/price.gif" type="image"/></form></div> </div> </div> <hr class="th_hr" noshade=""/> <div class="th_comm_bar_00f"> <div class="th_comm_bar_3px">ML（エムエル）</div> </div> <div class="th_table"> <div class="th_table_photo_350"><img alt="TOYO TIRES TRANPATH ML" class="th_tire_img" src="img/tranpath/ml.jpg"/></div> <div class="th_table_cell"> <div class="th_table_comm"><span class="font_3fc_b">低燃費タイヤグレード「AA-b」獲得と安定した走りの両立。ミドルクラスミニバン専用タイヤ。</span></div> <div class="th_table_comm">超低燃費ポリマーを採用した新トレッドベース配合などで、シリーズ最高の低燃費グレードを実現。スーパーハイターンアップ構造とワイドトレッド化により、フラつきも抑制します。</div> <div class="th_tire_price"><form action="../maker_item.php" method="post" target="_blank"><input name="maker" type="hidden" value="TOYO TIRES"/><input name="brand" type="hidden" value="TRANPATH"/><input name="item" type="hidden" value="ML"/><input name="image" src="../img/price.gif" type="image"/></form></div> </div> </div> <hr class="th_hr" noshade=""/> <div class="th_comm_bar_00f"> <div class="th_comm_bar_3px">Lu2（エルユーツー）</div> </div> <div class="th_table"> <div class="th_table_photo_350"><img alt="TOYO TIRES TRANPATH Lu2" class="th_tire_img" src="img/tranpath/lu2.jpg"/></div> <div class="th_table_cell"> <div class="th_table_comm"><span class="font_3fc_b">専用設計が創り出す快適な居住空間。ラグジュアリーミニバン専用タイヤ。</span></div> <div class="th_table_comm">タイヤシミュレーションを駆使したパターン・構造設計により、特に高音域においてノイズを大幅に低減。</div> <div class="th_tire_price"><form action="../maker_item.php" method="post" target="_blank"><input name="maker" type="hidden" value="TOYO TIRES"/><input name="brand" type="hidden" value="TRANPATH"/><input name="item" type="hidden" value="Lu2"/><input name="image" src="../img/price.gif" type="image"/></form></div> </div> </div> <hr class="th_hr" noshade=""/> <div class="th_comm_bar_00f"> <div class="th_comm_bar_3px">LuK（エルユーケー）</div> </div> <div class="th_table"> <div class="th_table_photo_350"><img alt="TOYO TIRES TRANPATH LuK" class="th_tire_img" src="img/tranpath/luk.jpg"/></div> <div class="th_table_cell"> <div class="th_table_comm"><span class="font_3fc_b">Luシリーズの魂が宿る軽自動車専用タイヤ。</span></div> <div class="th_table_comm">剛性を高めるスーパーハイターンアップ構造とワイドトレッド化により、安定した走りと上質で快適な乗り心地を実現。</div> <div class="th_table_comm">ワイドトレッドや深溝設計、ナノバランステクノロジーにより、摩耗ライフと転がり抵抗性能を高次元で両立。</div> <div class="th_tire_price"><form action="../maker_item.php" method="post" target="_blank"><input name="maker" type="hidden" value="TOYO TIRES"/><input name="brand" type="hidden" value="TRANPATH"/><input name="item" type="hidden" value="LuK"/><input name="image" src="../img/price.gif" type="image"/></form></div> </div> </div> 
                </div>
                <div class="col-md-6 col-sm-6 col-xs-12">
