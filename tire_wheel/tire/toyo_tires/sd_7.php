...
<title>KTS-web タイヤ・ホイール館 TOYO TIRES（トーヨータイヤ）SD-7</title>
              ...
              <div class="th_back row">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                   <div class="th_title_730"><img alt="SD-7" src="img/b_logo/sd_7.gif"/></div> <hr class="th_hr" noshade=""/> <div class="th_comm_bar_00f"> <div class="th_comm_bar_3px">SD-7（エスディー・セブン）</div> </div> <div class="th_table"> <div class="th_table_photo_350"><img alt="TOYO TIRES SD-7" class="th_tire_img" src="img/sd_7/sd_7.jpg"/></div> <div class="th_table_cell"> <div class="th_table_comm"><span class="font_3fc_b">基本性能にロングライフを加えたスタンダード低燃費タイヤ。</span></div> <div class="th_table_comm">アクティブポリマーを採用し、高い耐摩耗性能と転がり抵抗の低減を両立。さらにグリップポリマーを配合することで高いウェットグリップ性能も実現しました。</div> <div class="th_tire_price"><form action="../maker_item.php" method="post" target="_blank"><input name="maker" type="hidden" value="TOYO TIRES"/><input name="brand" type="hidden" value="SD-7"/><input name="item" type="hidden" value="SD-7"/><input name="image" src="../img/price.gif" type="image"/></form></div> </div> </div> <hr class="th_hr" noshade=""/> <div class="th_comm_bar_00f"> <div class="th_comm_bar_3px">SD-K7（エスディー・ケーセブン）</div> </div> <div class="th_table"> <div class="th_table_photo_350"><img alt="TOYO TIRES SD-K7" class="th_tire_img" src="img/sd_7/sd_k7.jpg"/></div> <div class="th_table_cell"> <div class="th_table_comm"><span class="font_3fc_b">基本性能にロングライフを加えたスタンダード軽・コンパクト用タイヤ。</span></div> <div class="th_table_comm">排水性を高めるワイドグルーブや、パターンノイズを低減するサイレントウォールを採用。さらに操縦安定性を高めてくれるので、バランスのよいドライビングを実現します。</div> <div class="th_tire_price"><form action="../maker_item.php" method="post" target="_blank"><input name="maker" type="hidden" value="TOYO TIRES"/><input name="brand" type="hidden" value="SD-7"/><input name="item" type="hidden" value="SD-K7"/><input name="image" src="../img/price.gif" type="image"/></form></div> </div> </div> 
                </div>
                <div class="col-md-6 col-sm-6 col-xs-12">
