...
<title>KTS-web タイヤ・ホイール館 TOYO TIRES（トーヨータイヤ）ALL SEASON</title>
              ...
              <div class="th_back row">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                   <div class="th_title_730"><img alt="ALL SEASON" src="img/b_logo/all_season.gif"/></div> <hr class="th_hr" noshade=""/> <div class="th_comm_bar_00f"> <div class="th_comm_bar_3px">CELSIUS（セルシアス）</div> </div> <div class="th_table"> <div class="th_table_photo_350"><img alt="TOYO TIRES ALL SEASON CELSIUS" class="th_tire_img" src="img/all_season/celsius.jpg"/></div> <div class="th_table_cell"> <div class="th_table_comm"><span class="font_3fc_b">降雪時などさまざまな路面でしっかりと走れる、全天候型オールシーズンタイヤ。</span></div> <div class="th_table_comm">オールシーズンタイヤとして開発されたトレッドコンパウンドには、シリカの分散を向上させるアクティブポリマーを採用。スノーフレークマークを打刻したスノー性能を持ちながら、夏タイヤに必要なウェット性能向上と転がり抵抗の抑制を実現しました。</div> <div class="th_tire_price"><form action="../maker_item.php" method="post" target="_blank"><input name="maker" type="hidden" value="TOYO TIRES"/><input name="brand" type="hidden" value="ALL SEASON"/><input name="item" type="hidden" value="CELSIUS"/><input name="image" src="../img/price.gif" type="image"/></form></div> </div> </div> 
                </div>
                <div class="col-md-6 col-sm-6 col-xs-12">
