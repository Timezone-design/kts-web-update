...
<title>KTS-web タイヤ・ホイール館 TOYO TIRES（トーヨータイヤ）STUDLESS TIRE</title>
              ...
              <div class="th_back row">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                   <div class="th_title_730"><img alt="スタッドレスタイヤ" src="img/b_logo/studless.gif"/></div> <hr class="th_hr" noshade=""/> <div class="th_comm_bar_00f"> <div class="th_comm_bar_3px">OBSERVE GIZ2（オブザーブ・ギズツー）</div> </div> <div class="th_table"> <div class="th_table_photo_350"><img alt="TOYO TIRES STUDLESS TIRE OVSERVE GIZ2" class="th_tire_img" src="img/studless/observe_giz2.jpg"/></div> <div class="th_table_cell"> <div class="th_table_comm"><span class="font_3fc_b">冬の路面へしなやかに密着し、より高度なアイス性能と持続する効きを実現。進化を遂げたNEWスタッドレス！</span></div> <div class="th_table_comm">独自の設計技術が生み出した非対称パターンや新コンパウンドが、ロングライフの効きを実現。</div> <div class="th_tire_price"><form action="../maker_item.php" method="post" target="_blank"><input name="maker" type="hidden" value="TOYO TIRES"/><input name="brand" type="hidden" value="STUDLESS"/><input name="item" type="hidden" value="OBSERVE GIZ2"/><input name="image" src="../img/price.gif" type="image"/></form></div> </div> </div> <hr class="th_hr" noshade=""/> <div class="th_comm_bar_00f"> <div class="th_comm_bar_3px">Winter TRANPATH TX（ウィンタートランパス・ティーエックス）</div> </div> <div class="th_table"> <div class="th_table_photo_350"><img alt="TOYO TIRES STUDLESS TIRE Winter TRANPATH TX" class="th_tire_img" src="img/studless/winter_tranpath_tx.jpg"/></div> <div class="th_table_cell"> <div class="th_table_comm"><span class="font_3fc_b">ふらつきを抑えた安定感のある走りと、進化したアイス性能をそなえた、ハイト系専用スタッドレス！</span></div> <div class="th_table_comm">ブロック壁面の凹凸を支え合うことによりサイプも倒れ込みを抑制。サイプエッジ端の接地圧を均一化し、制動時に高いエッジ効果を生み出します。</div> <div class="th_tire_price"><form action="../maker_item.php" method="post" target="_blank"><input name="maker" type="hidden" value="TOYO TIRES"/><input name="brand" type="hidden" value="STUDLESS"/><input name="item" type="hidden" value="Winter TRANPATH TX"/><input name="image" src="../img/price.gif" type="image"/></form></div> </div> </div> <hr class="th_hr" noshade=""/> <div class="th_comm_bar_00f"> <div class="th_comm_bar_3px">OBSERVE GSi-5（オブザーブ・ジーエスアイ ファイブ）</div> </div> <div class="th_table"> <div class="th_table_photo_350"><img alt="TOYO TIRES STUDLESS TIRE OBSERVE GSi-5" class="th_tire_img" src="img/studless/observe_gsi_5.jpg"/></div> <div class="th_table_cell"> <div class="th_table_comm"><span class="font_3fc_b">CCV専用設計でアイス・スノー・シャーベットをはじめ多様な路面をしっかりグリップ！</span></div> <div class="th_table_comm">「吸水カーボニックパウダー」を配合し、ミクロの水膜をより効率よく吸水します。またシリカ配合により、低温下での柔軟性も向上。さらに「鬼クルミの殻」が氷をひっかき、高いグリップ力を発揮。アイスバーンの凹凸にしっかりと密着して強力なグリップ力を支えます。</div> <div class="th_tire_price"><form action="../maker_item.php" method="post" target="_blank"><input name="maker" type="hidden" value="TOYO TIRES"/><input name="brand" type="hidden" value="STUDLESS"/><input name="item" type="hidden" value="OBSERVE GSi-5"/><input name="image" src="../img/price.gif" type="image"/></form></div> </div> </div> <hr class="th_hr" noshade=""/> <div class="th_comm_bar_00f"> <div class="th_comm_bar_3px">OBSERVE GARIT GIZ（オブザーブ・ガリットギズ）</div> </div> <div class="th_table"> <div class="th_table_photo_350"><img alt="TOYO TIRES STUDLESS TIRE OBSERVE GARIT GIZ" class="th_tire_img" src="img/studless/observe_garit_giz.jpg"/></div> <div class="th_table_cell"> <div class="th_table_comm"><span class="font_3fc_b">高次元でバランスのとれた氷雪上性能を発揮するメジャースタッドレス！</span></div> <div class="th_table_comm">除水効果・エッジ効果を瞬時に実感。吸着3Dサイプの採用で、アイス路面での青銅製・コーナリング性が向上し、厳しいアイス路面で、信頼のある走りを実現。</div> <div class="th_tire_price"><form action="../maker_item.php" method="post" target="_blank"><input name="maker" type="hidden" value="TOYO TIRES"/><input name="brand" type="hidden" value="STUDLESS"/><input name="item" type="hidden" value="OBSERVE GARIT GIZ"/><input name="image" src="../img/price.gif" type="image"/></form></div> </div> </div> 
                </div>
                <div class="col-md-6 col-sm-6 col-xs-12">
