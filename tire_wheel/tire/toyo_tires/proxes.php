<html>
 <head>
  ...
  <title>
   KTS-web タイヤ・ホイール館 TOYO TIRES（トーヨータイヤ）PROXES
  </title>
      ...
      <div class="main_c row grey-wrapper">
       ...
       <div class="th_back row">
        ...
        <div class="col-md-6 col-sm-6 col-xs-12">
         <div class="th_title_730">
          <img alt="PROXES" src="img/b_logo/proxes.gif"/>
         </div>
         <div class="clearfix-s">
         </div>
            ...
            <div class="tab-pane fade" id="_4">
             <div class="th_table">
              ...
              <div class="th_table_cell">
               ...
               <div class="th_table_comm">
                高剛性リブと高剛性ビードフィラーにより、スムーズなハンドリング性能を実現。
               </div>
               <div class="th_table_comm">
