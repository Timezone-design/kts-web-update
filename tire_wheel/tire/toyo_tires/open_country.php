...
<title>KTS-web タイヤ・ホイール館 TOYO TIRES（トーヨータイヤ）OPEN COUNTRY</title>
              ...
              <div class="th_back row">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                   <div class="th_title_730"><img alt="OPEN COUNTRY" src="img/b_logo/open_country.gif"/></div> <hr class="th_hr" noshade=""/> <div class="th_comm_bar_00f"> <div class="th_comm_bar_3px">M/T（エムティー）</div> </div> <div class="th_table"> <div class="th_table_photo_350"><img alt="TOYO TIRES OPEN COUNTRY M/T" class="th_tire_img" src="img/open_country/m_t.jpg"/></div> <div class="th_table_cell"> <div class="th_table_comm"><span class="font_3fc_b">オフロードを走破するパフォーマンスを実現。タフネス構造のアグレッシブなタイヤ。</span></div> <div class="th_table_comm">アグレッシブで機能的なトレッドデザインを採用。OFF ROAD性能/ON ROAD性能の両立。</div> <div class="th_tire_price"><form action="../maker_item.php" method="post" target="_blank"><input name="maker" type="hidden" value="TOYO TIRES"/><input name="brand" type="hidden" value="OPEN COUNTRY"/><input name="item" type="hidden" value="M/T"/><input name="image" src="../img/price.gif" type="image"/></form></div> </div> </div> <div class="th_comm_bar_00f"> <div class="th_comm_bar_3px">R/T（アールティー）</div> </div> <div class="th_table"> <div class="th_table_photo_350"><img alt="TOYO TIRES OPEN COUNTRY R/T" class="th_tire_img" src="img/open_country/r_t.jpg"/></div> <div class="th_table_cell"> <div class="th_table_comm"><span class="font_3fc_b">オフロード性能とオンロードタイヤ性能を両立する新カテゴリータイヤ</span></div> <div class="th_table_comm">オフロードでのトラクション性能と、オンロードでの耐摩耗性能や走行安定性を両立した「遊び心」ある新カテゴリータイヤ。</div> <div class="th_tire_price"><form action="../maker_item.php" method="post" target="_blank"><input name="maker" type="hidden" value="TOYO TIRES"/><input name="brand" type="hidden" value="OPEN COUNTRY"/><input name="item" type="hidden" value="R/T"/><input name="image" src="../img/price.gif" type="image"/></form></div> </div> </div> <div class="th_comm_bar_00f"> <div class="th_comm_bar_3px">A/T plus（エーティープラス）</div> </div> <div class="th_table"> <div class="th_table_photo_350"><img alt="TOYO TIRES OPEN COUNTRY A/T plus" class="th_tire_img" src="img/open_country/a_t_plus.jpg"/></div> <div class="th_table_cell"> <div class="th_table_comm"><span class="font_3fc_b">ドライ・マッドをスマートに走り抜けるオールラウンドSUV・CCV専用タイヤ</span></div> <div class="th_table_comm">ヨーロッパでも人気になったアクティブなデザイン性とドライ・マッドを走破するオールテレインタイヤならではの高い性能を実現しました。</div> <div class="th_tire_price"><form action="../maker_item.php" method="post" target="_blank"><input name="maker" type="hidden" value="TOYO TIRES"/><input name="brand" type="hidden" value="OPEN COUNTRY"/><input name="item" type="hidden" value="A/T plus"/><input name="image" src="../img/price.gif" type="image"/></form></div> </div> </div> <div class="th_comm_bar_00f"> <div class="th_comm_bar_3px">U/T（ユーティー）</div> </div> <div class="th_table"> <div class="th_table_photo_350"><img alt="TOYO TIRES OPEN COUNTRY U/T" class="th_tire_img" src="img/open_country/u_t.jpg"/></div> <div class="th_table_cell"> <div class="th_table_comm"><span class="font_3fc_b">静かで快適な乗り心地を実現する都市型仕様のSUV・CCV専用タイヤ。</span></div> <div class="th_table_comm">タイヤパターンに「サイレントウォール」「5バリアブルピッチ」等の技術を採用。オンロードにおける静粛性と快適な乗り心地を確保し、ノイズ低減を実現しました。</div> <div class="th_tire_price"><form action="../maker_item.php" method="post" target="_blank"><input name="maker" type="hidden" value="TOYO TIRES"/><input name="brand" type="hidden" value="OPEN COUNTRY"/><input name="item" type="hidden" value="U/T"/><input name="image" src="../img/price.gif" type="image"/></form></div> </div> </div> 
                </div>
                <div class="col-md-6 col-sm-6 col-xs-12">
