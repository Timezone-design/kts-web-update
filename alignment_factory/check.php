...
<?php if($sheet_check == 3):?>
		...
		<div><br><b>KTS FACTORY</b>　TEL：048-285-8906<br>（営業時間：午前11時～午後20時　定休日：毎週木曜日、第3水曜日）</div>
		<table width="700">
			<tr>
				<td>
					<div align="right"><a href="alignment.php"><img src="yoyaku_jokyou.gif" border="0"></a></div>
...
<?php if($check_all == 0 and $wagon_check != 1):?><tr><td></td><td><b><font color="#FF0000">ワゴン・ミニバン・SUV以外の車輌での予約申請</font><b></td></tr><?php endif;?>
<?php if($check_all == 0 and $wagon_check == 1):?><tr><td></td><td><input type="hidden" name="wagon_check" value="1"><b><font color="#FF0000">ワゴン・ミニバン・SUV車輌での予約申請</font><b></td></tr><?php endif;?>
<?php if($check_all == 1 and $wagon_check != 1):?><tr><td></td><td><input type="checkbox" name="wagon_check" value="1"><b><font color="#FF0000">※ワゴン・ミニバン・SUV車輌に該当する場合はチェックして下さい</font><b></td></tr><?php endif;?>
<?php if($check_all == 1 and $wagon_check == 1):?><tr><td></td><td><input type="checkbox" name="wagon_check" value="1" checked><b><font color="#FF0000">※ワゴン・ミニバン・SUV車輌に該当する場合はチェックして下さい</font><b></td></tr><?php endif;?>
...
<?php
	if($check_all == 0){
		$no_check = 0;
		if($rimguard == 1){print "<input type=hidden name=rimguard value=1>"; $no_check = 1;}
		...
		print "<td>";
		if($rimguard == 1){print "<div>社外リムガードが装着されている</div>";}
	...
	if($check_all == 1){
		...
		if($rimguard == 1){print "<div><input type=checkbox name=rimguard value=1 checked>社外リムガードが装着されている</div>";}
		if($rimguard != 1){print "<div><input type=checkbox name=rimguard value=1>社外リムガードが装着されている</div>";}
