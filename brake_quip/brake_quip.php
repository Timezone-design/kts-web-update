<?php
	...
	/* 各種項目設定 */
		...
		/* 商品名 */
		$set_name = "BrakeQuip ステンメッシュ製ブレーキラインシステム";

		/* DBパス */
		$set_db = "db/brake_quip.csv";
...
?>
	<head>
		...
		<link rel="stylesheet" href="brake_quip_php.css" type="text/css" />
...
?>
		...
		<div class="footer_text_t">
			<div class="footer_text_c1">※：</div>
			<div class="footer_text_c2">ホース・アルミジャケットのカラー変更はプラス2,000円（税抜）の追加料金が掛かります。</div>
		</div>
		<div class="footer_text_t">
			<div class="footer_text_c1">※：</div>
			<div class="footer_text_c2">本ページ掲載価格は商品単体の販売価格となり、取付工賃等は含まれておりません。取付ご希望の場合は別途お問い合わせ下さい。</div>
		</div>
		<div class="footer_text_t">
			<div class="footer_text_c1">※：</div>
